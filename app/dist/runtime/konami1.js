...
export function konami1Decrypt(addr, byte) {
    switch (addr & 0x0a) {
...
export class Konami1 extends M6809 {
    constructor(bus, encryptionBoundary = 0x0000) {
        super(bus, {
            opcodeFetch: (addr, byte) => addr < encryptionBoundary ? byte : konami1Decrypt(addr, byte),
        });
    }
}
