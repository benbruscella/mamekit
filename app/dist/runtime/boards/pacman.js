...
import { PacmanVideo } from "../video/pacman.js";
...
const WSG_VOLUME_REGS = [0x15, 0x1a, 0x1f];
export class PacmanBoard {
    ...
    irqMask = 0;
    irqVector = 0; // pacman_interrupt_vector_w, fed back as the IM2 vector byte
    irqHeld = false; // line asserted, waiting for the CPU to accept
    ...
    constructor(config, regions, inputs, sinks) {
        ...
        const registry = {
            ...
            write: {
                ...
                'pacman_state.pacman_videoram_w': () => { },
                'pacman_state.pacman_colorram_w': () => { },
