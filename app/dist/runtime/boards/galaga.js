...
import { GalagaVideo } from "../video/galaga.js";
export class GalagaBoard {
    ...
    constructor(config, regions, inputs, sinks) {
        ...
        this.n06 = new Namco06(config.clocks.namco06, mainClock, () => this.main.nmi(), [
            { read: () => this.n51.read(), write: d => this.n51.write(d), chipSelect: () => { } },
            null,
            null,
        ...
        const registry = {
            read: {
                'galaga_state.bosco_dsw_r': (_a, off) => ((this.inputs.read('DSWB') >> off) & 1) | (((this.inputs.read('DSWA') >> off) & 1) << 1),
                '06xx.data_r': () => this.n06.dataRead(),
                '06xx.ctrl_r': () => this.n06.ctrlRead(),
            },
            write: {
                'galaga_state.galaga_videoram_w': () => { },
