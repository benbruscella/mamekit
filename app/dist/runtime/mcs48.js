...
export class Mcs48 {
    ...
    ram; // internal RAM: r0-r7 at 0/24 (bank 0/1), stack 0x08-0x17
    irqInProgress = false;
    ...
    bus;
    ramMask;
    irqState = false; // level of the INT line
    irqPolled = false; // last instruction was a not-taken JNI
    t1History = 0;
    mc = 0; // machine cycles consumed by the current step()
    ...
    exec(op) {
        ...
        switch (op) {
            ...
            case 0x24:
            case 0x44:
            case 0x64: // JMP page 0-7
            case 0x84:
            case 0xa4:
            case 0xc4:
            case 0xe4:
                this.burn(2);
                this.jmp(this.fetch() | ((op & 0xe0) << 3));
                break;
            case 0x05:
                this.burn(1);
                this.xirqEnabled = true;
                break; // EN I
            case 0x07:
                this.burn(1);
            ...
            case 0x08:
                this.burn(2);
                this.a = (this.bus.readBus?.() ?? 0xff) & 0xff;
                break; // INS A,BUS
            case 0x09:
                this.burn(2);
                this.a = this.bus.readPort(1) & this.p1;
                break; // IN A,P1
            case 0x0a:
                this.burn(2);
                this.a = this.bus.readPort(2) & this.p2;
                break; // IN A,P2
            case 0x0c:
            case 0x0d:
            case 0x0e:
            case 0x0f:
                this.burn(2);
                break; // MOVD A,Pp (8243 — unimplemented)
            case 0x10:
            case 0x11: { // INC @Rr
                const ad = this.reg(r);
                this.burn(1);
                this.ramW(ad, this.ramR(ad) + 1);
                break;
            }
            case 0x12:
            case 0x32:
            ...
            case 0xf2:
                this.burn(2);
                this.jcc(((this.a >> ((op >> 5) & 7)) & 1) !== 0);
                break;
            case 0x13:
                this.burn(2);
                this.addc(this.fetch());
                break; // ADC A,#n
            case 0x14:
            case 0x34:
            case 0x54:
            case 0x74: // CALL page 0-7
            case 0x94:
            case 0xb4:
            case 0xd4:
            case 0xf4:
                this.burn(2);
                this.call(this.fetch() | ((op & 0xe0) << 3));
                break;
            case 0x15:
                this.burn(1);
                this.xirqEnabled = false;
            ...
            case 0x25:
                this.burn(1);
                this.tirqEnabled = true;
                break; // EN TCNTI
            case 0x26:
                this.burn(2);
                this.jcc(this.test(0) === 0);
                break; // JNT0
            case 0x27:
                this.burn(1);
                this.a = 0;
            ...
            case 0x31: { // XCHD A,@Rr
                ...
                this.a = (this.a & 0xf0) | (oldram & 0x0f);
                break;
            }
            case 0x35:
                this.burn(1);
            ...
            case 0x39:
                this.burn(2);
                this.bus.writePort(1, this.p1 = this.a);
                break; // OUTL P1,A
            case 0x3a:
                this.burn(2);
                this.bus.writePort(2, this.p2 = this.a);
                break; // OUTL P2,A
            case 0x3c:
            case 0x3d:
            case 0x3e:
            case 0x3f:
                this.burn(2);
                break; // MOVD Pp,A (unimplemented)
            case 0x40:
            case 0x41:
                this.burn(1);
                this.a |= this.ramR(this.reg(r));
                break; // ORL A,@Rr
            case 0x42:
                this.burn(1);
                this.a = this.timer;
            ...
            case 0x45: // STRT CNT
                this.burn(1);
                if ((this.timecountEnabled & COUNTER_ENABLED) === 0)
                    this.t1History = this.test(1);
                this.timecountEnabled = COUNTER_ENABLED;
                break;
            case 0x46:
                this.burn(2);
                this.jcc(this.test(1) === 0);
                break; // JNT1
            case 0x47:
                this.burn(1);
            ...
            case 0x55:
                this.burn(1);
                this.timecountEnabled = TIMER_ENABLED;
                this.prescaler = 0;
                break; // STRT T
            case 0x56:
                this.burn(2);
            ...
            case 0x67: { // RRC A
                ...
                this.psw = (this.psw & ~C_FLAG) | newc;
                break;
            }
            case 0x70:
            case 0x71:
                this.burn(1);
                this.addc(this.ramR(this.reg(r)));
                break; // ADC A,@Rr
            case 0x75:
                this.burn(1);
                break; // ENT0 CLK (unimplemented — no T0 clock consumer)
            case 0x76:
                this.burn(2);
                this.jcc(this.f1);
                break; // JF1
            ...
            case 0x81:
                this.burn(2);
                this.a = this.bus.readIo(this.reg(r)) & 0xff;
                break; // MOVX A,@Rr
            case 0x83:
                this.burn(2);
                this.pullPc();
            ...
            case 0x86:
                this.burn(2);
                this.irqPolled = !this.irqState;
                this.jcc(this.irqState);
                break; // JNI
            case 0x88:
                this.burn(2);
                this.bus.writeBus?.((this.bus.readBus?.() ?? 0xff) | this.fetch());
                break; // ORL BUS,#n
            case 0x89:
                this.burn(2);
                this.bus.writePort(1, this.p1 |= this.fetch());
                break; // ORL P1,#n
            case 0x8a:
                this.burn(2);
                this.bus.writePort(2, this.p2 |= this.fetch());
                break; // ORL P2,#n
            case 0x8c:
            case 0x8d:
            case 0x8e:
            case 0x8f:
                this.burn(2);
                break; // ORLD Pp,A (unimplemented)
            case 0x90:
            case 0x91:
                this.burn(2);
                this.bus.writeIo(this.reg(r), this.a);
                break; // MOVX @Rr,A
            case 0x93:
                this.burn(2);
                this.irqInProgress = false;
            ...
            case 0x9f:
                this.burn(2);
                break; // ANLD Pp,A (unimplemented)
            case 0xa0:
            case 0xa1:
                this.burn(1);
                this.ramW(this.reg(r), this.a);
                break; // MOV @Rr,A
            case 0xa3:
                this.burn(2);
                this.a = this.bus.readProgram(((this.pc & 0xf00) | this.a) & 0xfff) & 0xff;
                break; // MOVP A,@A
            case 0xa5:
                this.burn(1);
                this.f1 = false;
            ...
            case 0xd7:
                this.burn(1);
                this.psw = this.a & ~0x08;
                break; // MOV PSW,A
            case 0xe3:
                this.burn(2);
                this.a = this.bus.readProgram(0x300 | this.a) & 0xff;
                break; // MOVP3 A,@A
            case 0xe5:
                this.burn(1);
                this.a11 = 0x000;
            ...
            default:
                ...
                switch (op & 0xf8) {
                    ...
                    case 0x78:
                        this.burn(1);
                        this.addc(this.reg(r));
                        break; // ADC A,Rr
                    case 0xa8:
                        this.burn(1);
                        this.setReg(r, this.a);
                        break; // MOV Rr,A
                    case 0xb8:
                        this.burn(2);
                        this.setReg(r, this.fetch());
                        break; // MOV Rr,#n
                    case 0xc8:
                        this.burn(1);
                        this.setReg(r, this.reg(r) - 1);
                    ...
                    default:
                        this.burn(1);
                        break; // illegal: 1 cycle, no effect (MAME logs only)
                }
                break;
        }
    }
