...
const SPEED_X_CYCLE_COUNT_OFFSET = [0, 1, 2, 3, -4, -3, -2, -1];
const PRE_VIS_CYCLE_COUNT_VALUES = [
...
const POST_VIS_CYCLE_COUNT_VALUES = [
 ...
 */
export function getNextLfsrState(lfsr) {
...
export class Starfield05xx {
    ...
    setColorTable(colors) {
        if (colors.length < 64)
            throw new Error('starfield: color table must have 64 entries');
        this.colors = colors;
    }
