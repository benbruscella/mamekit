...
export class M6502 {
    ...
    irqCount = 0;
    bus;
    bcd; // decimal mode implemented? (false on RP2A03/NES)
    irqLine = false;
    nmiPending = false;
    extra = 0; // page-cross / branch penalty cycles for the current op
    ...
    adc(m) {
        ...
        if (this.bcd && (this.p & FD) !== 0) {
            ...
            if (((this.a + m + c) & 0xff) === 0)
                f |= FZ;
            if ((sum & 0x80) !== 0)
                f |= FN;
            if ((~(this.a ^ m) & (this.a ^ sum) & 0x80) !== 0)
                f |= FV;
            if (sum >= 0xa0)
                sum += 0x60;
            if (sum >= 0x100)
    ...
    sbc(m) {
        ...
        if (diff >= 0)
            f |= FC;
        if (((this.a ^ m) & (this.a ^ diff) & 0x80) !== 0)
            f |= FV;
        f |= NZ[diff & 0xff];
        if (this.bcd && (this.p & FD) !== 0) {
            let al = (this.a & 0x0f) - (m & 0x0f) - c;
    ...
    exec(op) {
        switch (op) {
            // ---------------------------------------------------------- loads
            case 0xa9:
                this.a = this.nz(this.fetch());
                break;
            case 0xa5:
                this.a = this.nz(this.rd(this.fetch()));
                break;
            case 0xb5:
                this.a = this.nz(this.rd(this.zpx()));
                break;
            case 0xad:
                this.a = this.nz(this.rd(this.fetch16()));
                break;
            case 0xbd:
                this.a = this.nz(this.rd(this.absx(true)));
                break;
            case 0xb9:
                this.a = this.nz(this.rd(this.absy(true)));
                break;
            case 0xa1:
                this.a = this.nz(this.rd(this.izx()));
                break;
            case 0xb1:
                this.a = this.nz(this.rd(this.izy(true)));
                break;
            case 0xa2:
                this.x = this.nz(this.fetch());
                break;
            case 0xa6:
                this.x = this.nz(this.rd(this.fetch()));
                break;
            case 0xb6:
                this.x = this.nz(this.rd(this.zpy()));
                break;
            case 0xae:
                this.x = this.nz(this.rd(this.fetch16()));
                break;
            case 0xbe:
                this.x = this.nz(this.rd(this.absy(true)));
                break;
            case 0xa0:
                this.y = this.nz(this.fetch());
                break;
            case 0xa4:
                this.y = this.nz(this.rd(this.fetch()));
                break;
            case 0xb4:
                this.y = this.nz(this.rd(this.zpx()));
                break;
            case 0xac:
                this.y = this.nz(this.rd(this.fetch16()));
                break;
            case 0xbc:
                this.y = this.nz(this.rd(this.absx(true)));
                break;
            // --------------------------------------------------------- stores
            case 0x85:
                ...
                break;
            case 0x95:
                this.wr(this.zpx(), this.a);
                break;
            case 0x8d:
                this.wr(this.fetch16(), this.a);
                break;
            case 0x9d:
                this.wr(this.absx(false), this.a);
                break;
            case 0x99:
                this.wr(this.absy(false), this.a);
                break;
            case 0x81:
                this.wr(this.izx(), this.a);
                break;
            case 0x91:
                this.wr(this.izy(false), this.a);
                break;
            case 0x86:
                this.wr(this.fetch(), this.x);
                break;
            case 0x96:
                this.wr(this.zpy(), this.x);
                break;
            case 0x8e:
            ...
            case 0x29:
                ...
                break;
            case 0x25:
                this.a = this.nz(this.a & this.rd(this.fetch()));
                break;
            case 0x35:
                this.a = this.nz(this.a & this.rd(this.zpx()));
                break;
            case 0x2d:
                this.a = this.nz(this.a & this.rd(this.fetch16()));
                break;
            case 0x3d:
                this.a = this.nz(this.a & this.rd(this.absx(true)));
                break;
            case 0x39:
                this.a = this.nz(this.a & this.rd(this.absy(true)));
                break;
            case 0x21:
                this.a = this.nz(this.a & this.rd(this.izx()));
                break;
            case 0x31:
                this.a = this.nz(this.a & this.rd(this.izy(true)));
                break;
            case 0x09:
                this.a = this.nz(this.a | this.fetch());
                break;
            ...
            case 0x51:
                ...
                break;
            case 0x24:
                this.bit(this.rd(this.fetch()));
                break;
            case 0x2c:
                this.bit(this.rd(this.fetch16()));
                break;
            // ----------------------------------------------------- arithmetic
            case 0x69:
                this.adc(this.fetch());
            ...
            case 0x65:
                ...
                break;
            case 0x75:
                this.adc(this.rd(this.zpx()));
                break;
            case 0x6d:
                this.adc(this.rd(this.fetch16()));
                break;
            case 0x7d:
                this.adc(this.rd(this.absx(true)));
                break;
            case 0x79:
                this.adc(this.rd(this.absy(true)));
                break;
            case 0x61:
                this.adc(this.rd(this.izx()));
                break;
            case 0x71:
                this.adc(this.rd(this.izy(true)));
                break;
            case 0xe9:
            case 0xeb:
                this.sbc(this.fetch());
                break; // $EB = unofficial SBC imm
            case 0xe5:
                this.sbc(this.rd(this.fetch()));
                break;
            case 0xf5:
                this.sbc(this.rd(this.zpx()));
                break;
            case 0xed:
                this.sbc(this.rd(this.fetch16()));
                break;
            case 0xfd:
                this.sbc(this.rd(this.absx(true)));
                break;
            case 0xf9:
                this.sbc(this.rd(this.absy(true)));
                break;
            case 0xe1:
                this.sbc(this.rd(this.izx()));
                break;
            case 0xf1:
                this.sbc(this.rd(this.izy(true)));
                break;
            // ------------------------------------------------------- compares
            case 0xc9:
                this.cp(this.a, this.fetch());
                break;
            case 0xc5:
                this.cp(this.a, this.rd(this.fetch()));
                break;
            case 0xd5:
                this.cp(this.a, this.rd(this.zpx()));
                break;
            case 0xcd:
                this.cp(this.a, this.rd(this.fetch16()));
                break;
            case 0xdd:
                this.cp(this.a, this.rd(this.absx(true)));
                break;
            case 0xd9:
                this.cp(this.a, this.rd(this.absy(true)));
                break;
            case 0xc1:
                this.cp(this.a, this.rd(this.izx()));
                break;
            case 0xd1:
                this.cp(this.a, this.rd(this.izy(true)));
                break;
            case 0xe0:
                this.cp(this.x, this.fetch());
                break;
            case 0xe4:
                this.cp(this.x, this.rd(this.fetch()));
                break;
            case 0xec:
                this.cp(this.x, this.rd(this.fetch16()));
                break;
            case 0xc0:
                this.cp(this.y, this.fetch());
                break;
            case 0xc4:
                this.cp(this.y, this.rd(this.fetch()));
                break;
            case 0xcc:
                this.cp(this.y, this.rd(this.fetch16()));
                break;
            // ---------------------------------------------- increment/decrement
            case 0xe6: {
                const ea = this.fetch();
                this.wr(ea, this.nz(this.rd(ea) + 1));
                break;
            }
            case 0xf6: {
                const ea = this.zpx();
            ...
            case 0x06: {
                const ea = this.fetch();
                this.wr(ea, this.asl(this.rd(ea)));
                break;
            }
            case 0x16: {
                const ea = this.zpx();
            ...
            case 0x46: {
                const ea = this.fetch();
                this.wr(ea, this.lsr(this.rd(ea)));
                break;
            }
            case 0x56: {
                const ea = this.zpx();
            ...
            case 0x26: {
                const ea = this.fetch();
                this.wr(ea, this.rol(this.rd(ea)));
                break;
            }
            case 0x36: {
                const ea = this.zpx();
            ...
            case 0x66: {
                const ea = this.fetch();
                this.wr(ea, this.ror(this.rd(ea)));
                break;
            }
            case 0x76: {
                const ea = this.zpx();
            ...
            case 0xa7:
                this.a = this.x = this.nz(this.rd(this.fetch()));
                break;
            case 0xb7:
                this.a = this.x = this.nz(this.rd(this.zpy()));
                break;
            case 0xaf:
                this.a = this.x = this.nz(this.rd(this.fetch16()));
                break;
            case 0xbf:
                this.a = this.x = this.nz(this.rd(this.absy(true)));
                break;
            case 0xa3:
                this.a = this.x = this.nz(this.rd(this.izx()));
                break;
            case 0xb3:
                this.a = this.x = this.nz(this.rd(this.izy(true)));
                break;
            ...
            case 0x87:
                ...
                break; // SAX zp
            case 0x97:
                this.wr(this.zpy(), this.a & this.x);
                break; // SAX zp,Y
            case 0x8f:
                this.wr(this.fetch16(), this.a & this.x);
                break; // SAX abs
            case 0x83:
                this.wr(this.izx(), this.a & this.x);
                break; // SAX (zp,X)
            // ------------------------------------- unofficial: RMW + ALU combos
            // DCP = DEC then CMP
            case 0xc7: {
                const ea = this.fetch();
                const r = (this.rd(ea) - 1) & 0xff;
                this.wr(ea, r);
                this.cp(this.a, r);
                break;
            }
            ...
            case 0x07: {
                const ea = this.fetch();
                const r = this.asl(this.rd(ea));
                this.wr(ea, r);
                this.a = this.nz(this.a | r);
                break;
            }
            case 0x17: {
                const ea = this.zpx();
