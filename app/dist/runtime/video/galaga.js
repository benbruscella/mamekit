...
import { Starfield05xx } from "../starfield05xx.js";
...
export function buildGalagaPalette(proms) {
...
export class GalagaVideo {
    ...
    constructor(deps) {
        ...
        if (!gfx1 || !gfx2 || !proms)
            throw new Error('galaga video: missing gfx1/gfx2/proms region');
        if (proms.length < 0x220)
            throw new Error('galaga video: proms region too small');
