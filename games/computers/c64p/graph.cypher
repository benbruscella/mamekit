...
// generated 2026-09-24T02:31:47.436Z
...
MERGE (n:KG {id: 'game:c64p'}) SET n:Game SET n += {name: 'c64p', year: '1982', company: 'Commodore Business Machines', fullname: 'Commodore 64 (PAL)', monitor: 'ROT0', cls: 'c64_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'computer', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 2296, sourceColumn: 1, sourceEndLine: 2296, classConstants: '{"m_loram":1,"m_hiram":1,"m_charen":1,"m_va14":1,"m_va15":1,"m_cass_rd":1,"m_iec_srq":1}'};
...
MERGE (n:KG {id: 'romset:c64p'}) SET n:RomSet SET n += {name: 'c64p'};
MERGE (n:KG {id: 'region:c64p/basic'}) SET n:RomRegion SET n += {tag: 'basic', size: 8192, flags: '0', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1950, sourceColumn: 2, sourceEndLine: 1950};
MERGE (n:KG {id: 'rom:c64p/basic/901226-01.u3'}) SET n:Rom SET n += {file: '901226-01.u3', offset: 0, size: 8192, crc: 'f833d117', sha1: '79015323128650c742a3694c9429aa91f355905e', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1951, sourceColumn: 2, sourceEndLine: 1951};
MERGE (n:KG {id: 'region:c64p/kernal'}) SET n:RomRegion SET n += {tag: 'kernal', size: 8192, flags: '0', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1953, sourceColumn: 2, sourceEndLine: 1953};
MERGE (n:KG {id: 'rom:c64p/kernal/901227-03.u4'}) SET n:Rom SET n += {file: '901227-03.u4', offset: 0, size: 8192, crc: 'dbe3e7c7', sha1: '1d503e56df85a62fee696e7618dc5b4e781df1bb'};
MERGE (n:KG {id: 'region:c64p/charom'}) SET n:RomRegion SET n += {tag: 'charom', size: 4096, flags: '0', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 2016, sourceColumn: 2, sourceEndLine: 2016};
MERGE (n:KG {id: 'rom:c64p/charom/901225-01.u5'}) SET n:Rom SET n += {file: '901225-01.u5', offset: 0, size: 4096, crc: 'ec4272ee', sha1: 'adc7c31e18c7c7413d54802ef2f4193da14711aa', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 2017, sourceColumn: 2, sourceEndLine: 2017};
MERGE (n:KG {id: 'region:c64p/u17'}) SET n:RomRegion SET n += {tag: 'u17', size: 245, flags: '0'};
MERGE (n:KG {id: 'rom:c64p/u17/906114-01.u17'}) SET n:Rom SET n += {file: '906114-01.u17', offset: 0, size: 245, crc: '54c89351', sha1: 'efb315f560b6f72444b8f0b2ca4b0ccbcd144a1b', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 2020, sourceColumn: 2, sourceEndLine: 2020};
...
MERGE (n:KG {id: 'machine:c64_state.pal'}) SET n:MachineConfig SET n += {cls: 'c64_state', name: 'pal', calls: [], stateMembers: ['{"name":"m_loram","bits":32,"signed":true,"initial":1}', '{"name":"m_hiram","bits":32,"signed":true,"initial":1}', '{"name":"m_charen","bits":32,"signed":true,"initial":1}', '{"name":"m_va14","bits":32,"signed":true,"initial":1}', '{"name":"m_va15","bits":32,"signed":true,"initial":1}', '{"name":"m_exp_dma","bits":32,"signed":true}', '{"name":"m_cass_rd","bits":32,"signed":true,"initial":1}', '{"name":"m_iec_srq","bits":32,"signed":true,"initial":1}', '{"name":"m_user_pa2","bits":32,"signed":true}', '{"name":"m_user_pb","bits":32,"signed":true}'], perfectQuantum: true, resetHandlers: ['c64_state.machine_reset'], sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1668, sourceColumn: 1, sourceEndLine: 1779};
MERGE (n:KG {id: 'softlist:c64_state.pal/vic10'}) SET n:SoftwareList SET n += {name: 'vic10', tag: 'cart_list_vic10', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'softlist:c64_state.pal/c64_cart'}) SET n:SoftwareList SET n += {name: 'c64_cart', tag: 'cart_list_c64', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'softlist:c64_state.pal/c64_cass'}) SET n:SoftwareList SET n += {name: 'c64_cass', tag: 'cass_list', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'softlist:c64_state.pal/c64_flop_orig'}) SET n:SoftwareList SET n += {name: 'c64_flop_orig', tag: 'flop525_orig', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'softlist:c64_state.pal/c64_flop_misc'}) SET n:SoftwareList SET n += {name: 'c64_flop_misc', tag: 'flop525_misc', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'softlist:c64_state.pal/c64_quik'}) SET n:SoftwareList SET n += {name: 'c64_quik', tag: 'quik_list', status: 'original', filter: 'PAL'};
MERGE (n:KG {id: 'device:c64_state.pal/u7'}) SET n:Device SET n += {type: 'M6510', tag: 'u7', clock: 985248.4444444445, config: ['M6510(config, m_maincpu, XTAL(17\'734\'472)/18)', 'm_maincpu->set_addrmap(AS_PROGRAM, &c64_state::c64_mem)', 'm_maincpu->read_callback().set(FUNC(c64_state::cpu_r))', 'm_maincpu->write_callback().set(FUNC(c64_state::cpu_w))', 'm_maincpu->set_pulls(0x17, 0xc8)', 'm_maincpu->set_dasm_override(FUNC(c64_state::dasm_override))', 'config.set_perfect_quantum(m_maincpu)'], member: 'm_maincpu', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1671, sourceColumn: 2, sourceEndLine: 1671, configCalls: ['set_pulls(23,200)', 'set_perfect_quantum("u7")']};
MERGE (n:KG {id: 'device:c64_state.pal/u7/callback:u7:0'}) SET n:Callback SET n += {signal: 'read_callback', operation: 'set', raw: 'm_maincpu->read_callback().set(FUNC(c64_state::cpu_r))', ownerTag: 'u7', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1673, sourceColumn: 2, sourceEndLine: 1673, targetClass: 'c64_state', targetMethod: 'cpu_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u7/callback:u7:1'}) SET n:Callback SET n += {signal: 'write_callback', operation: 'set', raw: 'm_maincpu->write_callback().set(FUNC(c64_state::cpu_w))', ownerTag: 'u7', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1674, sourceColumn: 2, sourceEndLine: 1674, targetClass: 'c64_state', targetMethod: 'cpu_w'};
MERGE (n:KG {id: 'device:c64_state.pal/irq'}) SET n:Device SET n += {type: 'INPUT_MERGER_ANY_HIGH', tag: 'irq', clock: null, config: ['input_merger_device &irq(INPUT_MERGER_ANY_HIGH(config, "irq"))', 'irq.output_handler().set_inputline(m_maincpu, m6510_device::IRQ_LINE)'], sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1679, sourceColumn: 2, sourceEndLine: 1679};
MERGE (n:KG {id: 'device:c64_state.pal/irq/callback:irq:0'}) SET n:Callback SET n += {signal: 'output_handler', operation: 'set_inputline', raw: 'irq.output_handler().set_inputline(m_maincpu, m6510_device::IRQ_LINE)', ownerTag: 'irq', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1680, sourceColumn: 2, sourceEndLine: 1680, inputLine: 'm6510_device::IRQ_LINE', targetTag: 'u7'};
MERGE (n:KG {id: 'device:c64_state.pal/nmi'}) SET n:Device SET n += {type: 'INPUT_MERGER_ANY_HIGH', tag: 'nmi', clock: null, config: ['INPUT_MERGER_ANY_HIGH(config, m_nmi)', 'm_nmi->output_handler().set_inputline(m_maincpu, m6510_device::NMI_LINE)'], member: 'm_nmi', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1682, sourceColumn: 2, sourceEndLine: 1682};
MERGE (n:KG {id: 'device:c64_state.pal/nmi/callback:nmi:0'}) SET n:Callback SET n += {signal: 'output_handler', operation: 'set_inputline', raw: 'm_nmi->output_handler().set_inputline(m_maincpu, m6510_device::NMI_LINE)', ownerTag: 'nmi', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1683, sourceColumn: 2, sourceEndLine: 1683, inputLine: 'm6510_device::NMI_LINE', targetTag: 'u7'};
MERGE (n:KG {id: 'device:c64_state.pal/u19'}) SET n:Device SET n += {type: 'MOS6569', tag: 'u19', clock: 985248.4444444445, config: ['mos6569_device &mos6569(MOS6569(config, MOS6569_TAG, XTAL(17\'734\'472)/18))', 'mos6569.set_cpu(m_maincpu)', 'mos6569.irq_callback().set("irq", FUNC(input_merger_device::in_w<1>))', 'mos6569.set_screen(SCREEN_TAG)', 'mos6569.set_addrmap(0, &c64_state::vic_videoram_map)', 'mos6569.set_addrmap(1, &c64_state::vic_colorram_map)'], member: 'm_vic', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1686, sourceColumn: 2, sourceEndLine: 1686, configCalls: ['set_cpu("u7")']};
MERGE (n:KG {id: 'device:c64_state.pal/u19/callback:u19:0'}) SET n:Callback SET n += {signal: 'irq_callback', operation: 'set', raw: 'mos6569.irq_callback().set("irq", FUNC(input_merger_device::in_w<1>))', ownerTag: 'u19', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1688, sourceColumn: 2, sourceEndLine: 1688, targetTag: 'irq', targetClass: 'input_merger_device', targetMethod: 'in_w_1'};
MERGE (n:KG {id: 'device:c64_state.pal/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, SCREEN_TAG, SCREEN_TYPE_RASTER))', 'screen.set_refresh_hz(VIC6569_VRETRACERATE)', 'screen.set_size(VIC6569_COLUMNS, VIC6569_LINES)', 'screen.set_visarea(0, VIC6569_VISIBLECOLUMNS - 1, 0, VIC6569_VISIBLELINES - 1)', 'screen.set_screen_update(MOS6569_TAG, FUNC(mos6569_device::screen_update))'], sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1693, sourceColumn: 2, sourceEndLine: 1693, configCalls: ['set_refresh_hz(50.12456473567585)', 'set_size(504,312)', 'set_visarea(0,402,0,283)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRefreshHz: 50.12456473567585, screenSize: [504, 312], screenVisarea: [0, 402, 0, 283]};
MERGE (n:KG {id: 'device:c64_state.pal/screen/callback:screen:0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'screen.set_screen_update(MOS6569_TAG, FUNC(mos6569_device::screen_update))', ownerTag: 'screen', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1697, sourceColumn: 2, sourceEndLine: 1697, targetClass: 'mos6569_device', targetMethod: 'screen_update', targetTag: 'u19'};
MERGE (n:KG {id: 'handler:mos6569_device.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'mos6569_device', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1697, sourceColumn: 2, sourceEndLine: 1697};
MERGE (n:KG {id: 'device:c64_state.pal/mono'}) SET n:Device SET n += {type: 'SPEAKER', tag: 'mono', clock: null, config: ['SPEAKER(config, "mono").front_center()'], sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1700, sourceColumn: 2, sourceEndLine: 1700};
MERGE (n:KG {id: 'device:c64_state.pal/u18'}) SET n:Device SET n += {type: 'MOS6581', tag: 'u18', clock: 985248.4444444445, config: ['MOS6581(config, m_sid, XTAL(17\'734\'472)/18)', 'm_sid->potx().set(FUNC(c64_state::sid_potx_r))', 'm_sid->poty().set(FUNC(c64_state::sid_poty_r))', 'm_sid->add_route(ALL_OUTPUTS, "mono", 1.00)'], member: 'm_sid', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1701, sourceColumn: 2, sourceEndLine: 1701};
MERGE (n:KG {id: 'audioroute:device:c64_state.pal/u18/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: 'mono', gain: 1, raw: 'm_sid->add_route(ALL_OUTPUTS, "mono", 1.00)', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1704, sourceColumn: 2, sourceEndLine: 1704};
MERGE (n:KG {id: 'device:c64_state.pal/u18/callback:u18:0'}) SET n:Callback SET n += {signal: 'potx', operation: 'set', raw: 'm_sid->potx().set(FUNC(c64_state::sid_potx_r))', ownerTag: 'u18', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1702, sourceColumn: 2, sourceEndLine: 1702, targetClass: 'c64_state', targetMethod: 'sid_potx_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u18/callback:u18:1'}) SET n:Callback SET n += {signal: 'poty', operation: 'set', raw: 'm_sid->poty().set(FUNC(c64_state::sid_poty_r))', ownerTag: 'u18', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1703, sourceColumn: 2, sourceEndLine: 1703, targetClass: 'c64_state', targetMethod: 'sid_poty_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u17'}) SET n:Device SET n += {type: 'PLS100', tag: 'u17', clock: null, config: ['PLS100(config, m_pla)'], member: 'm_pla', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1707, sourceColumn: 2, sourceEndLine: 1707};
MERGE (n:KG {id: 'device:c64_state.pal/u1'}) SET n:Device SET n += {type: 'MOS6526', tag: 'u1', clock: 985248.4444444445, config: ['MOS6526(config, m_cia1, XTAL(17\'734\'472)/18)', 'm_cia1->set_tod_clock(50)', 'm_cia1->irq_wr_callback().set("irq", FUNC(input_merger_device::in_w<0>))', 'm_cia1->cnt_wr_callback().set(m_user, FUNC(pet_user_port_device::write_4))', 'm_cia1->sp_wr_callback().set(m_user, FUNC(pet_user_port_device::write_5))', 'm_cia1->pa_rd_callback().set(FUNC(c64_state::cia1_pa_r))', 'm_cia1->pb_rd_callback().set(FUNC(c64_state::cia1_pb_r))', 'm_cia1->pb_wr_callback().set(FUNC(c64_state::cia1_pb_w))'], member: 'm_cia1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1709, sourceColumn: 2, sourceEndLine: 1709, configCalls: ['set_tod_clock(50)']};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:0'}) SET n:Callback SET n += {signal: 'irq_wr_callback', operation: 'set', raw: 'm_cia1->irq_wr_callback().set("irq", FUNC(input_merger_device::in_w<0>))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1711, sourceColumn: 2, sourceEndLine: 1711, targetTag: 'irq', targetClass: 'input_merger_device', targetMethod: 'in_w_0'};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:1'}) SET n:Callback SET n += {signal: 'cnt_wr_callback', operation: 'set', raw: 'm_cia1->cnt_wr_callback().set(m_user, FUNC(pet_user_port_device::write_4))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1712, sourceColumn: 2, sourceEndLine: 1712, targetClass: 'pet_user_port_device', targetMethod: 'write_4', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:2'}) SET n:Callback SET n += {signal: 'sp_wr_callback', operation: 'set', raw: 'm_cia1->sp_wr_callback().set(m_user, FUNC(pet_user_port_device::write_5))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1713, sourceColumn: 2, sourceEndLine: 1713, targetClass: 'pet_user_port_device', targetMethod: 'write_5', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:3'}) SET n:Callback SET n += {signal: 'pa_rd_callback', operation: 'set', raw: 'm_cia1->pa_rd_callback().set(FUNC(c64_state::cia1_pa_r))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1714, sourceColumn: 2, sourceEndLine: 1714, targetClass: 'c64_state', targetMethod: 'cia1_pa_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:4'}) SET n:Callback SET n += {signal: 'pb_rd_callback', operation: 'set', raw: 'm_cia1->pb_rd_callback().set(FUNC(c64_state::cia1_pb_r))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1715, sourceColumn: 2, sourceEndLine: 1715, targetClass: 'c64_state', targetMethod: 'cia1_pb_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u1/callback:u1:5'}) SET n:Callback SET n += {signal: 'pb_wr_callback', operation: 'set', raw: 'm_cia1->pb_wr_callback().set(FUNC(c64_state::cia1_pb_w))', ownerTag: 'u1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1716, sourceColumn: 2, sourceEndLine: 1716, targetClass: 'c64_state', targetMethod: 'cia1_pb_w'};
MERGE (n:KG {id: 'device:c64_state.pal/u2'}) SET n:Device SET n += {type: 'MOS6526', tag: 'u2', clock: 985248.4444444445, config: ['MOS6526(config, m_cia2, XTAL(17\'734\'472)/18)', 'm_cia2->set_tod_clock(50)', 'm_cia2->irq_wr_callback().set(m_nmi, FUNC(input_merger_device::in_w<0>))', 'm_cia2->cnt_wr_callback().set(m_user, FUNC(pet_user_port_device::write_6))', 'm_cia2->sp_wr_callback().set(m_user, FUNC(pet_user_port_device::write_7))', 'm_cia2->pa_rd_callback().set(FUNC(c64_state::cia2_pa_r))', 'm_cia2->pa_wr_callback().set(FUNC(c64_state::cia2_pa_w))', 'm_cia2->pb_rd_callback().set(FUNC(c64_state::cia2_pb_r))', 'm_cia2->pb_wr_callback().set(FUNC(c64_state::cia2_pb_w))', 'm_cia2->pc_wr_callback().set(m_user, FUNC(pet_user_port_device::write_8))'], member: 'm_cia2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1718, sourceColumn: 2, sourceEndLine: 1718, configCalls: ['set_tod_clock(50)']};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:0'}) SET n:Callback SET n += {signal: 'irq_wr_callback', operation: 'set', raw: 'm_cia2->irq_wr_callback().set(m_nmi, FUNC(input_merger_device::in_w<0>))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1720, sourceColumn: 2, sourceEndLine: 1720, targetClass: 'input_merger_device', targetMethod: 'in_w_0', targetTag: 'nmi'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:1'}) SET n:Callback SET n += {signal: 'cnt_wr_callback', operation: 'set', raw: 'm_cia2->cnt_wr_callback().set(m_user, FUNC(pet_user_port_device::write_6))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1721, sourceColumn: 2, sourceEndLine: 1721, targetClass: 'pet_user_port_device', targetMethod: 'write_6', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:2'}) SET n:Callback SET n += {signal: 'sp_wr_callback', operation: 'set', raw: 'm_cia2->sp_wr_callback().set(m_user, FUNC(pet_user_port_device::write_7))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1722, sourceColumn: 2, sourceEndLine: 1722, targetClass: 'pet_user_port_device', targetMethod: 'write_7', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:3'}) SET n:Callback SET n += {signal: 'pa_rd_callback', operation: 'set', raw: 'm_cia2->pa_rd_callback().set(FUNC(c64_state::cia2_pa_r))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1723, sourceColumn: 2, sourceEndLine: 1723, targetClass: 'c64_state', targetMethod: 'cia2_pa_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:4'}) SET n:Callback SET n += {signal: 'pa_wr_callback', operation: 'set', raw: 'm_cia2->pa_wr_callback().set(FUNC(c64_state::cia2_pa_w))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1724, sourceColumn: 2, sourceEndLine: 1724, targetClass: 'c64_state', targetMethod: 'cia2_pa_w'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:5'}) SET n:Callback SET n += {signal: 'pb_rd_callback', operation: 'set', raw: 'm_cia2->pb_rd_callback().set(FUNC(c64_state::cia2_pb_r))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1725, sourceColumn: 2, sourceEndLine: 1725, targetClass: 'c64_state', targetMethod: 'cia2_pb_r'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:6'}) SET n:Callback SET n += {signal: 'pb_wr_callback', operation: 'set', raw: 'm_cia2->pb_wr_callback().set(FUNC(c64_state::cia2_pb_w))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1726, sourceColumn: 2, sourceEndLine: 1726, targetClass: 'c64_state', targetMethod: 'cia2_pb_w'};
MERGE (n:KG {id: 'device:c64_state.pal/u2/callback:u2:7'}) SET n:Callback SET n += {signal: 'pc_wr_callback', operation: 'set', raw: 'm_cia2->pc_wr_callback().set(m_user, FUNC(pet_user_port_device::write_8))', ownerTag: 'u2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1727, sourceColumn: 2, sourceEndLine: 1727, targetClass: 'pet_user_port_device', targetMethod: 'write_8', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/tape'}) SET n:Device SET n += {type: 'PET_DATASSETTE_PORT', tag: 'tape', clock: null, config: ['PET_DATASSETTE_PORT(config, m_cassette, cbm_datassette_devices, "c1530")', 'm_cassette->read_handler().set(FUNC(c64_state::cass_rd_w))'], member: 'm_cassette', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1729, sourceColumn: 2, sourceEndLine: 1729, slotOptions: 'cbm_datassette_devices', slotDefault: 'c1530'};
MERGE (n:KG {id: 'device:c64_state.pal/tape/callback:tape:0'}) SET n:Callback SET n += {signal: 'read_handler', operation: 'set', raw: 'm_cassette->read_handler().set(FUNC(c64_state::cass_rd_w))', ownerTag: 'tape', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1730, sourceColumn: 2, sourceEndLine: 1730, targetClass: 'c64_state', targetMethod: 'cass_rd_w'};
MERGE (n:KG {id: 'device:c64_state.pal/iec4'}) SET n:Device SET n += {type: 'CBM_IEC_SLOT', tag: 'iec4', clock: 4, config: ['CBM_IEC_SLOT(config, "iec4", 4, cbm_iec_devices, nullptr)']};
MERGE (n:KG {id: 'device:c64_state.pal/iec8'}) SET n:Device SET n += {type: 'CBM_IEC_SLOT', tag: 'iec8', clock: null, config: ['CBM_IEC_SLOT(config, "iec8", 8, cbm_iec_devices, "c1541")'], slotOptions: 'cbm_iec_devices', slotDefault: 'c1541'};
MERGE (n:KG {id: 'device:c64_state.pal/iec9'}) SET n:Device SET n += {type: 'CBM_IEC_SLOT', tag: 'iec9', clock: 9, config: ['CBM_IEC_SLOT(config, "iec9", 9, cbm_iec_devices, nullptr)']};
MERGE (n:KG {id: 'device:c64_state.pal/iec10'}) SET n:Device SET n += {type: 'CBM_IEC_SLOT', tag: 'iec10', clock: 10, config: ['CBM_IEC_SLOT(config, "iec10", 10, cbm_iec_devices, nullptr)']};
MERGE (n:KG {id: 'device:c64_state.pal/iec11'}) SET n:Device SET n += {type: 'CBM_IEC_SLOT', tag: 'iec11', clock: 11, config: ['CBM_IEC_SLOT(config, "iec11", 11, cbm_iec_devices, nullptr)']};
MERGE (n:KG {id: 'device:c64_state.pal/iec_bus'}) SET n:Device SET n += {type: 'CBM_IEC', tag: 'iec_bus', clock: 0, config: ['CBM_IEC(config, m_iec, 0)', 'm_iec->srq_callback().set(FUNC(c64_state::iec_srq_w))', 'm_iec->data_callback().set(m_user, FUNC(pet_user_port_device::write_9))'], member: 'm_iec'};
MERGE (n:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:0'}) SET n:Callback SET n += {signal: 'srq_callback', operation: 'set', raw: 'm_iec->srq_callback().set(FUNC(c64_state::iec_srq_w))', ownerTag: 'iec_bus', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1733, sourceColumn: 2, sourceEndLine: 1733, targetClass: 'c64_state', targetMethod: 'iec_srq_w'};
MERGE (n:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:1'}) SET n:Callback SET n += {signal: 'data_callback', operation: 'set', raw: 'm_iec->data_callback().set(m_user, FUNC(pet_user_port_device::write_9))', ownerTag: 'iec_bus', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1734, sourceColumn: 2, sourceEndLine: 1734, targetClass: 'pet_user_port_device', targetMethod: 'write_9', targetTag: 'user'};
MERGE (n:KG {id: 'device:c64_state.pal/joy1'}) SET n:Device SET n += {type: 'VCS_CONTROL_PORT', tag: 'joy1', clock: null, config: ['VCS_CONTROL_PORT(config, m_joy1, vcs_control_port_devices, nullptr)', 'm_joy1->trigger_wr_callback().set(MOS6569_TAG, FUNC(mos6569_device::lp_w))'], member: 'm_joy1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1736, sourceColumn: 2, sourceEndLine: 1736, clockExpr: 'vcs_control_port_devices'};
MERGE (n:KG {id: 'device:c64_state.pal/joy1/callback:joy1:0'}) SET n:Callback SET n += {signal: 'trigger_wr_callback', operation: 'set', raw: 'm_joy1->trigger_wr_callback().set(MOS6569_TAG, FUNC(mos6569_device::lp_w))', ownerTag: 'joy1', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1737, sourceColumn: 2, sourceEndLine: 1737, targetClass: 'mos6569_device', targetMethod: 'lp_w', targetTag: 'u19'};
MERGE (n:KG {id: 'handler:mos6569_device.lp_w'}) SET n:Handler SET n += {method: 'lp_w', ownerClass: 'mos6569_device', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1885, sourceColumn: 2, sourceEndLine: 1885};
MERGE (n:KG {id: 'device:c64_state.pal/joy2'}) SET n:Device SET n += {type: 'VCS_CONTROL_PORT', tag: 'joy2', clock: null, config: ['VCS_CONTROL_PORT(config, m_joy2, vcs_control_port_devices, "joy")'], member: 'm_joy2', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1738, sourceColumn: 2, sourceEndLine: 1738, slotOptions: 'vcs_control_port_devices', slotDefault: 'joy'};
MERGE (n:KG {id: 'device:c64_state.pal/exp'}) SET n:Device SET n += {type: 'C64_EXPANSION_SLOT', tag: 'exp', clock: 985248.4444444445, config: ['C64_EXPANSION_SLOT(config, m_exp, XTAL(17\'734\'472)/18, c64_expansion_cards, nullptr)', 'm_exp->irq_callback().set("irq", FUNC(input_merger_device::in_w<2>))', 'm_exp->nmi_callback().set(m_nmi, FUNC(input_merger_device::in_w<2>))', 'm_exp->reset_callback().set(FUNC(c64_state::exp_reset_w))', 'm_exp->cd_input_callback().set(FUNC(c64_state::read))', 'm_exp->cd_output_callback().set(FUNC(c64_state::write))', 'm_exp->dma_callback().set(FUNC(c64_state::exp_dma_w))'], member: 'm_exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1740, sourceColumn: 2, sourceEndLine: 1740};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:0'}) SET n:Callback SET n += {signal: 'irq_callback', operation: 'set', raw: 'm_exp->irq_callback().set("irq", FUNC(input_merger_device::in_w<2>))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1741, sourceColumn: 2, sourceEndLine: 1741, targetTag: 'irq', targetClass: 'input_merger_device', targetMethod: 'in_w_2'};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:1'}) SET n:Callback SET n += {signal: 'nmi_callback', operation: 'set', raw: 'm_exp->nmi_callback().set(m_nmi, FUNC(input_merger_device::in_w<2>))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1742, sourceColumn: 2, sourceEndLine: 1742, targetClass: 'input_merger_device', targetMethod: 'in_w_2', targetTag: 'nmi'};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:2'}) SET n:Callback SET n += {signal: 'reset_callback', operation: 'set', raw: 'm_exp->reset_callback().set(FUNC(c64_state::exp_reset_w))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1743, sourceColumn: 2, sourceEndLine: 1743, targetClass: 'c64_state', targetMethod: 'exp_reset_w'};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:3'}) SET n:Callback SET n += {signal: 'cd_input_callback', operation: 'set', raw: 'm_exp->cd_input_callback().set(FUNC(c64_state::read))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1744, sourceColumn: 2, sourceEndLine: 1744, targetClass: 'c64_state', targetMethod: 'read'};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:4'}) SET n:Callback SET n += {signal: 'cd_output_callback', operation: 'set', raw: 'm_exp->cd_output_callback().set(FUNC(c64_state::write))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1745, sourceColumn: 2, sourceEndLine: 1745, targetClass: 'c64_state', targetMethod: 'write'};
MERGE (n:KG {id: 'device:c64_state.pal/exp/callback:exp:5'}) SET n:Callback SET n += {signal: 'dma_callback', operation: 'set', raw: 'm_exp->dma_callback().set(FUNC(c64_state::exp_dma_w))', ownerTag: 'exp', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1746, sourceColumn: 2, sourceEndLine: 1746, targetClass: 'c64_state', targetMethod: 'exp_dma_w'};
MERGE (n:KG {id: 'device:c64_state.pal/user'}) SET n:Device SET n += {type: 'PET_USER_PORT', tag: 'user', clock: null, config: ['PET_USER_PORT(config, m_user, c64_user_port_cards, nullptr)', 'm_user->p3_handler().set(FUNC(c64_state::exp_reset_w))', 'm_user->p4_handler().set(m_cia1, FUNC(mos6526_device::cnt_w))', 'm_user->p5_handler().set(m_cia1, FUNC(mos6526_device::sp_w))', 'm_user->p6_handler().set(m_cia2, FUNC(mos6526_device::cnt_w))', 'm_user->p7_handler().set(m_cia2, FUNC(mos6526_device::sp_w))', 'm_user->p9_handler().set(m_iec, FUNC(cbm_iec_device::host_atn_w))', 'm_user->pb_handler().set(m_cia2, FUNC(mos6526_device::flag_w))', 'm_user->pc_handler().set(FUNC(c64_state::write_user_pb0))', 'm_user->pd_handler().set(FUNC(c64_state::write_user_pb1))', 'm_user->pe_handler().set(FUNC(c64_state::write_user_pb2))', 'm_user->pf_handler().set(FUNC(c64_state::write_user_pb3))', 'm_user->ph_handler().set(FUNC(c64_state::write_user_pb4))', 'm_user->pj_handler().set(FUNC(c64_state::write_user_pb5))', 'm_user->pk_handler().set(FUNC(c64_state::write_user_pb6))', 'm_user->pl_handler().set(FUNC(c64_state::write_user_pb7))', 'm_user->pm_handler().set(FUNC(c64_state::write_user_pa2))'], member: 'm_user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1748, sourceColumn: 2, sourceEndLine: 1748, clockExpr: 'c64_user_port_cards'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:0'}) SET n:Callback SET n += {signal: 'p3_handler', operation: 'set', raw: 'm_user->p3_handler().set(FUNC(c64_state::exp_reset_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1749, sourceColumn: 2, sourceEndLine: 1749, targetClass: 'c64_state', targetMethod: 'exp_reset_w'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:1'}) SET n:Callback SET n += {signal: 'p4_handler', operation: 'set', raw: 'm_user->p4_handler().set(m_cia1, FUNC(mos6526_device::cnt_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1750, sourceColumn: 2, sourceEndLine: 1750, targetClass: 'mos6526_device', targetMethod: 'cnt_w', targetTag: 'u1'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:2'}) SET n:Callback SET n += {signal: 'p5_handler', operation: 'set', raw: 'm_user->p5_handler().set(m_cia1, FUNC(mos6526_device::sp_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1751, sourceColumn: 2, sourceEndLine: 1751, targetClass: 'mos6526_device', targetMethod: 'sp_w', targetTag: 'u1'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:3'}) SET n:Callback SET n += {signal: 'p6_handler', operation: 'set', raw: 'm_user->p6_handler().set(m_cia2, FUNC(mos6526_device::cnt_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1752, sourceColumn: 2, sourceEndLine: 1752, targetClass: 'mos6526_device', targetMethod: 'cnt_w', targetTag: 'u2'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:4'}) SET n:Callback SET n += {signal: 'p7_handler', operation: 'set', raw: 'm_user->p7_handler().set(m_cia2, FUNC(mos6526_device::sp_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1753, sourceColumn: 2, sourceEndLine: 1753, targetClass: 'mos6526_device', targetMethod: 'sp_w', targetTag: 'u2'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:5'}) SET n:Callback SET n += {signal: 'p9_handler', operation: 'set', raw: 'm_user->p9_handler().set(m_iec, FUNC(cbm_iec_device::host_atn_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1754, sourceColumn: 2, sourceEndLine: 1754, targetClass: 'cbm_iec_device', targetMethod: 'host_atn_w', targetTag: 'iec_bus'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:6'}) SET n:Callback SET n += {signal: 'pb_handler', operation: 'set', raw: 'm_user->pb_handler().set(m_cia2, FUNC(mos6526_device::flag_w))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1755, sourceColumn: 2, sourceEndLine: 1755, targetClass: 'mos6526_device', targetMethod: 'flag_w', targetTag: 'u2'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:7'}) SET n:Callback SET n += {signal: 'pc_handler', operation: 'set', raw: 'm_user->pc_handler().set(FUNC(c64_state::write_user_pb0))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1756, sourceColumn: 2, sourceEndLine: 1756, targetClass: 'c64_state', targetMethod: 'write_user_pb0'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:8'}) SET n:Callback SET n += {signal: 'pd_handler', operation: 'set', raw: 'm_user->pd_handler().set(FUNC(c64_state::write_user_pb1))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1757, sourceColumn: 2, sourceEndLine: 1757, targetClass: 'c64_state', targetMethod: 'write_user_pb1'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:9'}) SET n:Callback SET n += {signal: 'pe_handler', operation: 'set', raw: 'm_user->pe_handler().set(FUNC(c64_state::write_user_pb2))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1758, sourceColumn: 2, sourceEndLine: 1758, targetClass: 'c64_state', targetMethod: 'write_user_pb2'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:10'}) SET n:Callback SET n += {signal: 'pf_handler', operation: 'set', raw: 'm_user->pf_handler().set(FUNC(c64_state::write_user_pb3))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1759, sourceColumn: 2, sourceEndLine: 1759, targetClass: 'c64_state', targetMethod: 'write_user_pb3'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:11'}) SET n:Callback SET n += {signal: 'ph_handler', operation: 'set', raw: 'm_user->ph_handler().set(FUNC(c64_state::write_user_pb4))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1760, sourceColumn: 2, sourceEndLine: 1760, targetClass: 'c64_state', targetMethod: 'write_user_pb4'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:12'}) SET n:Callback SET n += {signal: 'pj_handler', operation: 'set', raw: 'm_user->pj_handler().set(FUNC(c64_state::write_user_pb5))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1761, sourceColumn: 2, sourceEndLine: 1761, targetClass: 'c64_state', targetMethod: 'write_user_pb5'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:13'}) SET n:Callback SET n += {signal: 'pk_handler', operation: 'set', raw: 'm_user->pk_handler().set(FUNC(c64_state::write_user_pb6))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1762, sourceColumn: 2, sourceEndLine: 1762, targetClass: 'c64_state', targetMethod: 'write_user_pb6'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:14'}) SET n:Callback SET n += {signal: 'pl_handler', operation: 'set', raw: 'm_user->pl_handler().set(FUNC(c64_state::write_user_pb7))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1763, sourceColumn: 2, sourceEndLine: 1763, targetClass: 'c64_state', targetMethod: 'write_user_pb7'};
MERGE (n:KG {id: 'device:c64_state.pal/user/callback:user:15'}) SET n:Callback SET n += {signal: 'pm_handler', operation: 'set', raw: 'm_user->pm_handler().set(FUNC(c64_state::write_user_pa2))', ownerTag: 'user', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1764, sourceColumn: 2, sourceEndLine: 1764, targetClass: 'c64_state', targetMethod: 'write_user_pa2'};
MERGE (n:KG {id: 'device:c64_state.pal/quickload'}) SET n:Device SET n += {type: 'QUICKLOAD', tag: 'quickload', clock: null, config: ['QUICKLOAD(config, "quickload", "p00,prg,t64", CBM_QUICKLOAD_DELAY).set_load_callback(FUNC(c64_state::quickload_c64))'], sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1766, sourceColumn: 2, sourceEndLine: 1766, clockExpr: '"p00,prg,t64"'};
MERGE (n:KG {id: 'device:c64_state.pal/quickload/callback:quickload:0'}) SET n:Callback SET n += {signal: 'set_load_callback', delegate: 1, operation: 'set_load_callback', raw: 'QUICKLOAD(config, "quickload", "p00,prg,t64", CBM_QUICKLOAD_DELAY).set_load_callback(FUNC(c64_state::quickload_c64))', ownerTag: 'quickload', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1766, sourceColumn: 2, sourceEndLine: 1766, targetClass: 'c64_state', targetMethod: 'quickload_c64'};
MERGE (n:KG {id: 'device:c64_state.pal/ram'}) SET n:Device SET n += {type: 'RAM', tag: 'ram', clock: null, config: ['RAM(config, RAM_TAG).set_default_size("64K")'], member: 'm_ram', sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1778, sourceColumn: 2, sourceEndLine: 1778};
...
MATCH (a:KG {id: 'game:c64p'}), (b:KG {id: 'file:src/mame/commodore/c64.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 2296, sourceColumn: 1, sourceEndLine: 2296};
MATCH (a:KG {id: 'game:c64p'}), (b:KG {id: 'game:c64'}) MERGE (a)-[r:CLONE_OF]->(b);
MATCH (a:KG {id: 'game:c64p'}), (b:KG {id: 'machine:c64_state.pal'}) MERGE (a)-[r:USES_MACHINE]->(b);
MATCH (a:KG {id: 'game:c64p'}), (b:KG {id: 'inputs:c64'}) MERGE (a)-[r:USES_INPUTS]->(b);
MATCH (a:KG {id: 'game:c64p'}), (b:KG {id: 'romset:c64p'}) MERGE (a)-[r:USES_ROMSET]->(b);
...
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'file:src/mame/commodore/c64.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/commodore/c64.cpp', sourceLine: 1668, sourceColumn: 1, sourceEndLine: 1779};
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'handler:c64_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/vic10'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/c64_cart'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/c64_cass'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/c64_flop_orig'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/c64_flop_misc'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'softlist:c64_state.pal/c64_quik'}) MERGE (a)-[r:HAS_SOFTLIST]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u7'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/irq'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/nmi'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u19'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/screen'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/mono'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u18'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u17'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u1'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/u2'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/tape'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec4'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec8'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec9'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec10'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec11'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/iec_bus'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/joy1'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/joy2'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/exp'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/user'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/quickload'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:c64_state.pal'}), (b:KG {id: 'device:c64_state.pal/ram'}) MERGE (a)-[r:HAS_DEVICE]->(b);
...
MATCH (a:KG {id: 'romset:c64p'}), (b:KG {id: 'file:src/mame/commodore/c64.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b);
MATCH (a:KG {id: 'romset:c64p'}), (b:KG {id: 'region:c64p/basic'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:c64p'}), (b:KG {id: 'region:c64p/kernal'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:c64p'}), (b:KG {id: 'region:c64p/charom'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:c64p'}), (b:KG {id: 'region:c64p/u17'}) MERGE (a)-[r:HAS_REGION]->(b);
...
MATCH (a:KG {id: 'device:c64_state.pal/u7'}), (b:KG {id: 'device:c64_state.pal/u7/callback:u7:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u7'}), (b:KG {id: 'device:c64_state.pal/u7/callback:u7:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u7'}), (b:KG {id: 'map:c64_state.c64_mem'}) MERGE (a)-[r:HAS_MAP]->(b) SET r += {space: 'AS_PROGRAM'};
MATCH (a:KG {id: 'device:c64_state.pal/irq'}), (b:KG {id: 'device:c64_state.pal/irq/callback:irq:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/nmi'}), (b:KG {id: 'device:c64_state.pal/nmi/callback:nmi:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u19'}), (b:KG {id: 'device:c64_state.pal/u19/callback:u19:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u19'}), (b:KG {id: 'map:c64_state.vic_videoram_map'}) MERGE (a)-[r:HAS_MAP]->(b) SET r += {space: '0'};
MATCH (a:KG {id: 'device:c64_state.pal/u19'}), (b:KG {id: 'map:c64_state.vic_colorram_map'}) MERGE (a)-[r:HAS_MAP]->(b) SET r += {space: '1'};
MATCH (a:KG {id: 'device:c64_state.pal/screen'}), (b:KG {id: 'device:c64_state.pal/screen/callback:screen:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u18'}), (b:KG {id: 'audioroute:device:c64_state.pal/u18/0'}) MERGE (a)-[r:HAS_AUDIO_ROUTE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u18'}), (b:KG {id: 'device:c64_state.pal/u18/callback:u18:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u18'}), (b:KG {id: 'device:c64_state.pal/u18/callback:u18:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1'}), (b:KG {id: 'device:c64_state.pal/u1/callback:u1:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2'}), (b:KG {id: 'device:c64_state.pal/u2/callback:u2:7'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/tape'}), (b:KG {id: 'device:c64_state.pal/tape/callback:tape:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/iec_bus'}), (b:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/iec_bus'}), (b:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/joy1'}), (b:KG {id: 'device:c64_state.pal/joy1/callback:joy1:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/joy2'}), (b:KG {id: 'inputs:vcs_joystick'}) MERGE (a)-[r:USES_INPUTS]->(b) SET r += {option: 'joy'};
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp'}), (b:KG {id: 'device:c64_state.pal/exp/callback:exp:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:7'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:8'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:9'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:10'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:11'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:12'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:13'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:14'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user'}), (b:KG {id: 'device:c64_state.pal/user/callback:user:15'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/quickload'}), (b:KG {id: 'device:c64_state.pal/quickload/callback:quickload:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'region:c64p/basic'}), (b:KG {id: 'rom:c64p/basic/901226-01.u3'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:c64p/kernal'}), (b:KG {id: 'rom:c64p/kernal/901227-03.u4'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:c64p/charom'}), (b:KG {id: 'rom:c64p/charom/901225-01.u5'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:c64p/u17'}), (b:KG {id: 'rom:c64p/u17/906114-01.u17'}) MERGE (a)-[r:LOADS]->(b);
...
MATCH (a:KG {id: 'device:c64_state.pal/u7/callback:u7:0'}), (b:KG {id: 'handler:c64_state.cpu_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u7/callback:u7:1'}), (b:KG {id: 'handler:c64_state.cpu_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:c64_state.pal/irq/callback:irq:0'}), (b:KG {id: 'device:c64_state.pal/u7'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/nmi/callback:nmi:0'}), (b:KG {id: 'device:c64_state.pal/u7'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u19/callback:u19:0'}), (b:KG {id: 'handler:input_merger_device.in_w_1'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u19/callback:u19:0'}), (b:KG {id: 'device:c64_state.pal/irq'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
...
MATCH (a:KG {id: 'device:c64_state.pal/screen/callback:screen:0'}), (b:KG {id: 'handler:mos6569_device.screen_update'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/screen/callback:screen:0'}), (b:KG {id: 'device:c64_state.pal/u19'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u18/callback:u18:0'}), (b:KG {id: 'handler:c64_state.sid_potx_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u18/callback:u18:1'}), (b:KG {id: 'handler:c64_state.sid_poty_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:0'}), (b:KG {id: 'handler:input_merger_device.in_w_0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:0'}), (b:KG {id: 'device:c64_state.pal/irq'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:1'}), (b:KG {id: 'handler:pet_user_port_device.write_4'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:2'}), (b:KG {id: 'handler:pet_user_port_device.write_5'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:3'}), (b:KG {id: 'handler:c64_state.cia1_pa_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:4'}), (b:KG {id: 'handler:c64_state.cia1_pb_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u1/callback:u1:5'}), (b:KG {id: 'handler:c64_state.cia1_pb_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:0'}), (b:KG {id: 'handler:input_merger_device.in_w_0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:0'}), (b:KG {id: 'device:c64_state.pal/nmi'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:1'}), (b:KG {id: 'handler:pet_user_port_device.write_6'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:2'}), (b:KG {id: 'handler:pet_user_port_device.write_7'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:3'}), (b:KG {id: 'handler:c64_state.cia2_pa_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:4'}), (b:KG {id: 'handler:c64_state.cia2_pa_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:5'}), (b:KG {id: 'handler:c64_state.cia2_pb_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:6'}), (b:KG {id: 'handler:c64_state.cia2_pb_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/u2/callback:u2:7'}), (b:KG {id: 'handler:pet_user_port_device.write_8'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/tape/callback:tape:0'}), (b:KG {id: 'handler:c64_state.cass_rd_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:0'}), (b:KG {id: 'handler:c64_state.iec_srq_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/iec_bus/callback:iec_bus:1'}), (b:KG {id: 'handler:pet_user_port_device.write_9'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/joy1/callback:joy1:0'}), (b:KG {id: 'handler:mos6569_device.lp_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/joy1/callback:joy1:0'}), (b:KG {id: 'device:c64_state.pal/u19'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
...
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:0'}), (b:KG {id: 'handler:input_merger_device.in_w_2'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:0'}), (b:KG {id: 'device:c64_state.pal/irq'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:1'}), (b:KG {id: 'handler:input_merger_device.in_w_2'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:1'}), (b:KG {id: 'device:c64_state.pal/nmi'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:2'}), (b:KG {id: 'handler:c64_state.exp_reset_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:3'}), (b:KG {id: 'handler:c64_state.read'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:4'}), (b:KG {id: 'handler:c64_state.write'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/exp/callback:exp:5'}), (b:KG {id: 'handler:c64_state.exp_dma_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:0'}), (b:KG {id: 'handler:c64_state.exp_reset_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:1'}), (b:KG {id: 'handler:mos6526_device.cnt_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:1'}), (b:KG {id: 'device:c64_state.pal/u1'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:2'}), (b:KG {id: 'handler:mos6526_device.sp_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:2'}), (b:KG {id: 'device:c64_state.pal/u1'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:3'}), (b:KG {id: 'handler:mos6526_device.cnt_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:3'}), (b:KG {id: 'device:c64_state.pal/u2'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:4'}), (b:KG {id: 'handler:mos6526_device.sp_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:4'}), (b:KG {id: 'device:c64_state.pal/u2'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:5'}), (b:KG {id: 'handler:cbm_iec_device.host_atn_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:5'}), (b:KG {id: 'device:c64_state.pal/iec_bus'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:6'}), (b:KG {id: 'handler:mos6526_device.flag_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:6'}), (b:KG {id: 'device:c64_state.pal/u2'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:7'}), (b:KG {id: 'handler:c64_state.write_user_pb0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:8'}), (b:KG {id: 'handler:c64_state.write_user_pb1'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:9'}), (b:KG {id: 'handler:c64_state.write_user_pb2'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:10'}), (b:KG {id: 'handler:c64_state.write_user_pb3'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:11'}), (b:KG {id: 'handler:c64_state.write_user_pb4'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:12'}), (b:KG {id: 'handler:c64_state.write_user_pb5'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:13'}), (b:KG {id: 'handler:c64_state.write_user_pb6'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:14'}), (b:KG {id: 'handler:c64_state.write_user_pb7'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/user/callback:user:15'}), (b:KG {id: 'handler:c64_state.write_user_pa2'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:c64_state.pal/quickload/callback:quickload:0'}), (b:KG {id: 'handler:c64_state.quickload_c64'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
