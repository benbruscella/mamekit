...
![marquee](/artwork/media/marquees/c64p.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/c64p.webp) | ![cabinet](/artwork/media/cabinets/c64p.webp) |

## The machine

| CPU | Type | Clock | Mapped ranges |
| --- | --- | --- | --- |
| `u7` | M6510 | 0.985 MHz | 1 |

- **Sound:** sid @ 0.048 MHz
- **Screen:** 403×284 @ 50.12 Hz
...
- **Credited by MAMEDEV:** Curt Coder (driver header); geecab (4 release notes); AmatCoder (1 release note); Chris Swan (1 release note); Ivan Vangelista (1 release note); Nathan Woods (1 release note); Steven Coomber (1 release note)
...
*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `c64`. Play it at [../../../app/g/c64p/](../../../app/g/c64p/) or [explore the knowledge graph](viewer.html).*
