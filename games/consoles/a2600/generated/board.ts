...
defined.compiledHandlers = {
  ...
  function method_a2600_read_input_port(runtime: any, offset: any) {
    const members = runtime.members;
    switch (offset) {
      case 0:
      {
  ...
  function method_switch_A_r(runtime: any) {
    const members = runtime.members;
    let val: any = ((0) & 0xff);
  ...
  function method_switch_A_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_switch_B_w(runtime: any, data: any) {
    const members = runtime.members;

  }

  function method_irq_callback(runtime: any, state: any) {
    const members = runtime.members;
