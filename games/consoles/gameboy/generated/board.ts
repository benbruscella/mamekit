...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  const __mame_table_0 = [10, 4, 6, 8];
  const __mame_table_1 = [4287101951, 4283346609, 4283334788, 4283321934, 4288794564, 4285371787, 4283659115, 4282466625];
  function method_gb_io_r(runtime: any, offset: any): any {
    ...
    switch (offset) {
      ...
      {
        0;
        return ((runtime.shiftRight((members.m_divcount ?? runtime.member("m_divcount")), 8)) & (255));
      }
      case 0:
      case 1:
      case 2:
  ...
  function method_gb_io_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch (offset) {
      case 0:
      {
        ...
        if (((((data) & (32))) ? 0 : 1)) {
          runtime.writeIndex(runtime.writableMember("m_gb_io"), 0, ((runtime.readIndex(runtime.writableMember("m_gb_io"), 0)) & (((runtime.shiftRight((__l["m_inputs.read"] ? __l["m_inputs.read"]() : (members.m_inputs) != null ? (typeof (runtime.dereference(members.m_inputs)).read === 'function' ? (runtime.dereference(members.m_inputs)).read() : typeof (runtime.dereference(members.m_inputs)).read === 'number' || typeof (runtime.dereference(members.m_inputs)).read === 'boolean' ? (runtime.dereference(members.m_inputs)).read : runtime.container(members.m_inputs, "read")) : (__l["read"]?.() ?? 0)), 4)) | (240)))));
        }
        if (((((data) & (16))) ? 0 : 1)) {
          runtime.writeIndex(runtime.writableMember("m_gb_io"), 0, ((runtime.readIndex(runtime.writableMember("m_gb_io"), 0)) & ((((__l["m_inputs.read"] ? __l["m_inputs.read"]() : (members.m_inputs) != null ? (typeof (runtime.dereference(members.m_inputs)).read === 'function' ? (runtime.dereference(members.m_inputs)).read() : typeof (runtime.dereference(members.m_inputs)).read === 'number' || typeof (runtime.dereference(members.m_inputs)).read === 'boolean' ? (runtime.dereference(members.m_inputs)).read : runtime.container(members.m_inputs, "read")) : (__l["read"]?.() ?? 0))) | (240)))));
        }
        return;
      }
      case 1:
      ...
      case 4:
      {
        if (((runtime.shiftRight((members.m_divcount ?? runtime.member("m_divcount")), (((members.m_shift ?? runtime.member("m_shift"))) - (1)))) & (1))) {
      ...
      case 7:
      {
        ...
        if (((((((((((data) & (4))) ? 0 : 1)) && (((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 7)) & (4)))) ? 1 : 0)) || (((((((((data) & (4))) && (((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 7)) & (4)))) ? 1 : 0)) && (((Number(((data) & (3))) !== Number(((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 7)) & (3)))) ? 1 : 0))) ? 1 : 0))) ? 1 : 0)) {
          if (((Number((((members.m_divcount ?? runtime.member("m_divcount"))) & ((((members.m_shift_cycles ?? runtime.member("m_shift_cycles"))) - (1))))) >= Number(runtime.shiftRight((members.m_shift_cycles ?? runtime.member("m_shift_cycles")), 1))) ? 1 : 0)) {
            (runtime.overrides["gb_timer_increment"] ? runtime.overrides["gb_timer_increment"]() : method_gb_timer_increment(runtime));
          }
        }
        members.m_shift = (((__mame_table_0[(((((data) & (3))) % 4) + 4) % 4] ?? 0)) & 0xff);
      ...
      case 15:
      {
        ...
        (__l["m_maincpu.set_if"] ? __l["m_maincpu.set_if"](data) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).set_if?.(data) ?? 0) : 0);
        break;
      }
    }
  ...
  function method_gb_timer_increment(runtime: any): any {
    const members = runtime.members;
  ...
  function method_gb_timer_check_irq(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((members.m_triggering_irq ?? runtime.member("m_triggering_irq"))) {
      ...
      if (((Number(runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 5)) === Number(0)) ? 1 : 0)) {
        ...
        (__l["m_maincpu.set_input_line"] ? __l["m_maincpu.set_input_line"](2, 1) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).set_input_line?.(2, 1) ?? 0) : 0);
        (__l["m_maincpu.execute_set_input"] ? __l["m_maincpu.execute_set_input"](2, 1) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).execute_set_input?.(2, 1) ?? 0) : 0);
        members.m_reloading = ((1) & 0xff);
      }
    }
  }

  function method_gb_io2_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if (((Number(offset) === Number(16)) ? 1 : 0)) {
      ...
      (__l["m_ppu.video_w"] ? __l["m_ppu.video_w"](offset, data) : (members.m_ppu) != null ? ((runtime.dereference(members.m_ppu)).video_w?.(offset, data) ?? 0) : 0);
    }
  }

  function method_disable_boot(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_boot_view.disable"] ? __l["m_boot_view.disable"]() : (members.m_boot_view) != null ? (typeof (runtime.dereference(members.m_boot_view)).disable === 'function' ? (runtime.dereference(members.m_boot_view)).disable() : typeof (runtime.dereference(members.m_boot_view)).disable === 'number' || typeof (runtime.dereference(members.m_boot_view)).disable === 'boolean' ? (runtime.dereference(members.m_boot_view)).disable : runtime.container(members.m_boot_view, "disable")) : (__l["disable"]?.() ?? 0));
  }

  function method_gb_ie_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    return (__l["m_maincpu.get_ie"] ? __l["m_maincpu.get_ie"]() : (members.m_maincpu) != null ? (typeof (runtime.dereference(members.m_maincpu)).get_ie === 'function' ? (runtime.dereference(members.m_maincpu)).get_ie() : typeof (runtime.dereference(members.m_maincpu)).get_ie === 'number' || typeof (runtime.dereference(members.m_maincpu)).get_ie === 'boolean' ? (runtime.dereference(members.m_maincpu)).get_ie : runtime.container(members.m_maincpu, "get_ie")) : 0);
  }

  function method_gb_ie_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_maincpu.set_ie"] ? __l["m_maincpu.set_ie"](data) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).set_ie?.(data) ?? 0) : 0);
  }

  function method_boot_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_region_boot = members.m_region_boot ?? runtime.member("m_region_boot");
    if ((__l["m_bios_hack.read"] ? __l["m_bios_hack.read"]() : (members.m_bios_hack) != null ? (typeof (runtime.dereference(members.m_bios_hack)).read === 'function' ? (runtime.dereference(members.m_bios_hack)).read() : typeof (runtime.dereference(members.m_bios_hack)).read === 'number' || typeof (runtime.dereference(members.m_bios_hack)).read === 'boolean' ? (runtime.dereference(members.m_bios_hack)).read : runtime.container(members.m_bios_hack, "read")) : (__l["read"]?.() ?? 0))) {
  ...
  function method_gb_timer_callback(runtime: any, data: any): any {
    const members = runtime.members;

    const h_m_internal_serial_frequency = members.m_internal_serial_frequency ?? runtime.member("m_internal_serial_frequency");
    let old_gb_divcount: any = (((members.m_divcount ?? runtime.member("m_divcount"))) & 0xffff);
    let old_internal_serial_clock: any = (((members.m_internal_serial_clock ?? runtime.member("m_internal_serial_clock"))) & 0xffff);
    ...
    if (((Number(runtime.shiftRight(old_gb_divcount, 8)) !== Number(runtime.shiftRight((members.m_divcount ?? runtime.member("m_divcount")), 8))) ? 1 : 0)) {
    }
    (runtime.overrides["gb_timer_check_irq"] ? runtime.overrides["gb_timer_check_irq"]() : method_gb_timer_check_irq(runtime));
    if (((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 7)) & (4))) {
      let old_count: any = ((runtime.shiftRight(old_gb_divcount, (members.m_shift ?? runtime.member("m_shift")))) & 0xffff);
      let new_count: any = ((runtime.shiftRight((members.m_divcount ?? runtime.member("m_divcount")), (members.m_shift ?? runtime.member("m_shift")))) & 0xffff);
  ...
  function method_gb_serial_timer_tick(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if (((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 2)) & (128))) {
      ...
      if (((Number((members.m_sio_count ?? runtime.member("m_sio_count"))) === Number(0)) ? 1 : 0)) {
        ...
        (__l["m_maincpu.execute_set_input"] ? __l["m_maincpu.execute_set_input"](3, 1) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).execute_set_input?.(3, 1) ?? 0) : 0);
      }
    }
  }

  function method_gb_palette(runtime: any, palette: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    for (let i: any = ((0) | 0); ((Number(i) < Number(4)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      (__l["palette.set_pen_color"] ? __l["palette.set_pen_color"](i, (__mame_table_1[((i) & 7)] ?? 0)) : (palette) != null ? ((runtime.dereference(palette)).set_pen_color?.(i, (__mame_table_1[((i) & 7)] ?? 0)) ?? 0) : (__l["set_pen_color"]?.(i, (__mame_table_1[((i) & 7)] ?? 0)) ?? 0));
    }
  }
  return {
...
defined.compiledHandlerLinks = ["disable","m_bios_hack.read","m_boot_view.disable","m_inputs.read","m_maincpu.execute_set_input","m_maincpu.get_ie","m_maincpu.get_if","m_maincpu.set_ie","m_maincpu.set_if","m_maincpu.set_input_line","m_ppu.update_state","m_ppu.video_w","palette.set_pen_color","read","set_pen_color"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
