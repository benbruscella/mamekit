        ...
        const methods = (() => {
            ...
            function method_gb_timer_callback(runtime, data) {
                ...
                if (((runtime.readIndex((members.m_gb_io ?? runtime.member("m_gb_io")), 7)) & (4))) {
                    let old_count = ((runtime.shiftRight(old_gb_divcount, (members.m_shift ?? runtime.member("m_shift")))) & 0xffff);
                    let new_count = ((runtime.shiftRight((members.m_divcount ?? runtime.member("m_divcount")), (members.m_shift ?? runtime.member("m_shift")))) & 0xffff);
