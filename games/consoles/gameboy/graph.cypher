...
// generated 2026-09-17T07:13:27.090Z
...
MERGE (n:KG {id: 'device:gb_state.gameboy/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(gb_state::gb_palette), 4)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1057, sourceColumn: 2, sourceEndLine: 1057, clockExpr: 'FUNC(gb_state::gb_palette)'};
...
MERGE (n:KG {id: 'device:gb_state.gameboy/cartslot'}) SET n:Device SET n += {type: 'GB_CART_SLOT', tag: 'cartslot', clock: null, config: ['GB_CART_SLOT(config, m_cartslot, gameboy_cartridges, nullptr)', 'm_cartslot->set_space(m_maincpu, AS_PROGRAM)'], member: 'm_cartslot', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1069, sourceColumn: 2, sourceEndLine: 1069, clockExpr: 'gameboy_cartridges'};
