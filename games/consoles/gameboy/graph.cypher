...
MERGE (n:KG {id: 'handler:base_state.gb_timer_check_irq'}) SET n:Handler SET n += {method: 'gb_timer_check_irq', ownerClass: 'base_state', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 671, sourceColumn: 1, sourceEndLine: 686, sourceConstants: ['TIM_INT=2', 'lr35902_cpu_device::TIM_INT=2', 'lr35902_cpu_device::TIM_INT=2'], sourceParameters: '', sourceBody: 'm_reloading = 0;
	if (m_triggering_irq)
	{
		m_triggering_irq = 0;
		if (m_gb_io[0x05] == 0)
...
MERGE (n:KG {id: 'handler:base_state.gb_serial_timer_tick'}) SET n:Handler SET n += {method: 'gb_serial_timer_tick', ownerClass: 'base_state', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 646, sourceColumn: 1, sourceEndLine: 668, sourceConstants: ['SIO_INT=3', 'SIO_ENABLED=128', 'lr35902_cpu_device::SIO_INT=3', 'lr35902_cpu_device::SIO_INT=3'], sourceParameters: '', sourceBody: 'if (m_gb_io[0x02] & SIO_ENABLED)
	{
		if (m_sio_count & 1)
		{
...
MERGE (n:KG {id: 'device:gb_state.gameboy/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(gb_state::gb_palette), 4)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1057, sourceColumn: 2, sourceEndLine: 1057, clockExpr: 'FUNC(gb_state::gb_palette)', paletteEntries: 4};
MERGE (n:KG {id: 'device:gb_state.gameboy/ppu'}) SET n:Device SET n += {type: 'DMG_PPU', tag: 'ppu', clock: null, config: ['DMG_PPU(config, m_ppu, m_maincpu)'], member: 'm_ppu', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1059, sourceColumn: 2, sourceEndLine: 1059, clockExpr: 'm_maincpu'};
...
MERGE (n:KG {id: 'device:gb_state.gameboy/apu'}) SET n:Device SET n += {type: 'DMG_APU', tag: 'apu', clock: 4194304, config: ['DMG_APU(config, m_apu, MASTER_CLOCK)', 'm_apu->add_route(0, "speaker", 0.50, 0)', 'm_apu->add_route(1, "speaker", 0.50, 1)'], member: 'm_apu', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1064, sourceColumn: 2, sourceEndLine: 1064, configCalls: ['add_route(0,"speaker",0.5,0)', 'add_route(1,"speaker",0.5,1)']};
...
MERGE (n:KG {id: 'device:gb_state.gameboy/cartslot'}) SET n:Device SET n += {type: 'GB_CART_SLOT', tag: 'cartslot', clock: null, config: ['GB_CART_SLOT(config, m_cartslot, gameboy_cartridges, nullptr)', 'm_cartslot->set_space(m_maincpu, AS_PROGRAM)'], member: 'm_cartslot', sourceFile: 'src/mame/nintendo/gb.cpp', sourceLine: 1069, sourceColumn: 2, sourceEndLine: 1069, configCalls: ['set_space("maincpu",0)'], clockExpr: 'gameboy_cartridges'};
