...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_nes_in0_r(runtime: any) {
  ...
  function method_nes_in0_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_nes_in1_r(runtime: any) {
    const members = runtime.members;
    let ret: any = ((64) & 0xff);
  ...
  function method_screen_update_nes(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
