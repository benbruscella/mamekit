...
// generated 2026-09-24T02:31:52.323Z
...
MERGE (n:KG {id: 'device:coleco_state.coleco/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3579545, config: ['Z80(config, m_maincpu, XTAL(7\'159\'090)/2)', 'm_maincpu->z80_set_m1_cycles(4+1)', 'm_maincpu->set_addrmap(AS_PROGRAM, &coleco_state::coleco_map)', 'm_maincpu->set_addrmap(AS_IO, &coleco_state::coleco_io_map)'], member: 'm_maincpu', sourceFile: 'src/mame/coleco/coleco.cpp', sourceLine: 566, sourceColumn: 2, sourceEndLine: 566, configCalls: ['z80_set_m1_cycles(5)']};
MERGE (n:KG {id: 'device:coleco_state.coleco/tms9928a'}) SET n:Device SET n += {type: 'TMS9928A', tag: 'tms9928a', clock: 10738635, config: ['tms9928a_device &vdp(TMS9928A(config, "tms9928a", XTAL(10\'738\'635)))', 'vdp.set_screen("screen")', 'vdp.set_vram_size(0x4000)', 'vdp.int_callback().set_inputline(m_maincpu, INPUT_LINE_NMI)'], sourceFile: 'src/mame/coleco/coleco.cpp', sourceLine: 572, sourceColumn: 2, sourceEndLine: 572, configCalls: ['set_screen("screen")', 'set_vram_size(16384)']};
...
MERGE (n:KG {id: 'device:coleco_state.coleco/cartslot'}) SET n:Device SET n += {type: 'COLECOVISION_CARTRIDGE_SLOT', tag: 'cartslot', clock: null, config: ['COLECOVISION_CARTRIDGE_SLOT(config, m_cart, colecovision_cartridges, nullptr)'], member: 'm_cart', sourceFile: 'src/mame/coleco/coleco.cpp', sourceLine: 585, sourceColumn: 2, sourceEndLine: 585, clockExpr: 'colecovision_cartridges'};
...
MERGE (n:KG {id: 'device:coleco_state.coleco/exp'}) SET n:Device SET n += {type: 'COLECO_EXPANSION', tag: 'exp', clock: null, config: ['coleco_expansion_device &exp(COLECO_EXPANSION(config, "exp", nullptr))', 'exp.set_program_space(m_maincpu, AS_PROGRAM)', 'exp.set_io_space(m_maincpu, AS_IO)', 'exp.int_handler().set_inputline(m_maincpu, INPUT_LINE_IRQ0)', 'exp.nmi_handler().set_inputline(m_maincpu, INPUT_LINE_NMI)', 'exp.add_route(ALL_OUTPUTS, "mono", 1.00)'], sourceFile: 'src/mame/coleco/coleco.cpp', sourceLine: 593, sourceColumn: 2, sourceEndLine: 593, configCalls: ['set_program_space("maincpu",0)', 'set_io_space("maincpu",2)'], clockExpr: 'nullptr'};
...
MATCH (a:KG {id: 'machine:coleco_state.coleco'}), (b:KG {id: 'device:coleco_state.coleco/cartslot'}) MERGE (a)-[r:HAS_DEVICE]->(b);
