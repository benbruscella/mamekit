    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_coleco_paddle_read(runtime, port, joy_mode, joy_status) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let ctrl_sel = (((__l["m_ctrlsel.read_safe"] ? __l["m_ctrlsel.read_safe"](0) : (members.m_ctrlsel) != null ? ((runtime.dereference(members.m_ctrlsel)).read_safe?.(0) ?? 0) : (__l["read_safe"]?.(0) ?? 0))) & 0xff);
