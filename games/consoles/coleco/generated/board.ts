...
defined.compiledHandlers = {
  ...
  function method_cart_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    return (__l["m_cart.read"] ? __l["m_cart.read"](offset, 0, 0, 0, 0) : (members.m_cart) != null ? ((runtime.dereference(members.m_cart)).read?.(offset, 0, 0, 0, 0) ?? 0) : 0);
  }

  function method_cart_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_cart.write"] ? __l["m_cart.write"](offset, data, 0, 0, 0, 0) : (members.m_cart) != null ? ((runtime.dereference(members.m_cart)).write?.(offset, data, 0, 0, 0, 0) ?? 0) : 0);
  }

  function method_paddle_off_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_joy_mode = ((0) | 0);
  }

  function method_paddle_on_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_joy_mode = ((1) | 0);
  }

  function method_coleco_paddle_read(runtime: any, port: any, joy_mode: any, joy_status: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let ctrl_sel: any = (((__l["m_ctrlsel.read_safe"] ? __l["m_ctrlsel.read_safe"](0) : (members.m_ctrlsel) != null ? ((runtime.dereference(members.m_ctrlsel)).read_safe?.(0) ?? 0) : (__l["read_safe"]?.(0) ?? 0))) & 0xff);
    let ctrl_extra: any = ((((ctrl_sel) & (128))) & 0xff);
    ctrl_sel = ((((runtime.shiftRight(ctrl_sel, ((port) * (4)))) & (7))) & 0xff);
    if (((Number(joy_mode) === Number(0)) ? 1 : 0)) {
      let data: any = ((15) & 0xff);
      let ipt: any = ((65535) & 0xffff);
      if (((Number(ctrl_sel) === Number(0)) ? 1 : 0)) {
        ipt = ((((port) ? ((__l["m_std_keypad2.read"] ? __l["m_std_keypad2.read"]() : (members.m_std_keypad2) != null ? (typeof (runtime.dereference(members.m_std_keypad2)).read === 'function' ? (runtime.dereference(members.m_std_keypad2)).read() : typeof (runtime.dereference(members.m_std_keypad2)).read === 'number' || typeof (runtime.dereference(members.m_std_keypad2)).read === 'boolean' ? (runtime.dereference(members.m_std_keypad2)).read : runtime.container(members.m_std_keypad2, "read")) : (__l["read"]?.() ?? 0))) : ((__l["m_std_keypad1.read"] ? __l["m_std_keypad1.read"]() : (members.m_std_keypad1) != null ? (typeof (runtime.dereference(members.m_std_keypad1)).read === 'function' ? (runtime.dereference(members.m_std_keypad1)).read() : typeof (runtime.dereference(members.m_std_keypad1)).read === 'number' || typeof (runtime.dereference(members.m_std_keypad1)).read === 'boolean' ? (runtime.dereference(members.m_std_keypad1)).read : runtime.container(members.m_std_keypad1, "read")) : (__l["read"]?.() ?? 0))))) & 0xffff);
      } else {
        if (((Number(ctrl_sel) === Number(2)) ? 1 : 0)) {
          ipt = ((((port) ? ((__l["m_sac_keypad2.read"] ? __l["m_sac_keypad2.read"]() : (members.m_sac_keypad2) != null ? (typeof (runtime.dereference(members.m_sac_keypad2)).read === 'function' ? (runtime.dereference(members.m_sac_keypad2)).read() : typeof (runtime.dereference(members.m_sac_keypad2)).read === 'number' || typeof (runtime.dereference(members.m_sac_keypad2)).read === 'boolean' ? (runtime.dereference(members.m_sac_keypad2)).read : runtime.container(members.m_sac_keypad2, "read")) : (__l["read"]?.() ?? 0))) : ((__l["m_sac_keypad1.read"] ? __l["m_sac_keypad1.read"]() : (members.m_sac_keypad1) != null ? (typeof (runtime.dereference(members.m_sac_keypad1)).read === 'function' ? (runtime.dereference(members.m_sac_keypad1)).read() : typeof (runtime.dereference(members.m_sac_keypad1)).read === 'number' || typeof (runtime.dereference(members.m_sac_keypad1)).read === 'boolean' ? (runtime.dereference(members.m_sac_keypad1)).read : runtime.container(members.m_sac_keypad1, "read")) : (__l["read"]?.() ?? 0))))) & 0xffff);
        }
      }
      if (((((ipt) & (1))) ? 0 : 1)) {
...
defined.compiledHandlerLinks = ["m_cart.read","m_cart.write","m_ctrlsel.read_safe","m_driv_pedal1.read","m_driv_pedal2.read","m_sac_joy1.read","m_sac_joy2.read","m_sac_keypad1.read","m_sac_keypad2.read","m_std_joy1.read","m_std_joy2.read","m_std_keypad1.read","m_std_keypad2.read","read","read_safe"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
