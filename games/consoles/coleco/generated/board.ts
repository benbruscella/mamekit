...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_cart_r(runtime: any, offset: any) {
  ...
  function method_cart_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_paddle_off_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_joy_mode = ((0) | 0);
  }

  function method_paddle_on_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_joy_mode = ((1) | 0);
  }

  function method_coleco_paddle_read(runtime: any, port: any, joy_mode: any, joy_status: any) {
    const members = runtime.members;
    let ctrl_sel: any = (((runtime.calls["m_ctrlsel.read_safe"] ? runtime.calls["m_ctrlsel.read_safe"](0) : (members.m_ctrlsel) != null ? ((runtime.dereference(members.m_ctrlsel)).read_safe?.(0) ?? 0) : (runtime.calls["read_safe"]?.(0) ?? 0))) & 0xff);
