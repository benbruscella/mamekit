...
// generated 2026-09-24T02:30:11.489Z
...
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3579545, config: ['Z80(config, m_audiocpu, XTAL(3\'579\'545))', 'm_audiocpu->set_addrmap(AS_PROGRAM, &cps_state::sub_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3918, sourceColumn: 2, sourceEndLine: 3918};
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(CPS_PIXEL_CLOCK, CPS_HTOTAL, CPS_HBEND, CPS_HBSTART, CPS_VTOTAL, CPS_VBEND, CPS_VBSTART)', 'm_screen->set_screen_update(FUNC(cps_state::screen_update_cps1))', 'm_screen->screen_vblank().set(FUNC(cps_state::screen_vblank_cps1))', 'm_screen->screen_vblank().append(FUNC(cps_state::cps1_objram_latch))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', configCalls: ['set_raw(8000000,512,64,448,262,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [8000000, 512, 64, 448, 262, 16, 240], screenRawExpr: ['CPS_PIXEL_CLOCK', 'CPS_HTOTAL', 'CPS_HBEND', 'CPS_HBSTART', 'CPS_VTOTAL', 'CPS_VBEND', 'CPS_VBSTART']};
...
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_cps1)'], member: 'm_gfxdecode', sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3931, sourceColumn: 2, sourceEndLine: 3931, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, palette_device::BLACK).set_entries(0xc00)'], member: 'm_palette', sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3932, sourceColumn: 2, sourceEndLine: 3932, clockExpr: 'palette_device::BLACK', paletteEntries: 3072};
...
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/2151'}) SET n:Device SET n += {type: 'YM2151', tag: '2151', clock: 3579545, config: ['ym2151_device &ym2151(YM2151(config, "2151", XTAL(3\'579\'545)))', 'ym2151.irq_handler().set_inputline(m_audiocpu, 0)', 'ym2151.add_route(0, "mono", 0.35)', 'ym2151.add_route(1, "mono", 0.35)'], sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3940, sourceColumn: 2, sourceEndLine: 3940, configCalls: ['add_route(0,"mono",0.35)', 'add_route(1,"mono",0.35)']};
...
MERGE (n:KG {id: 'device:cps_state.cps1_10MHz/oki'}) SET n:Device SET n += {type: 'OKIM6295', tag: 'oki', clock: 1000000, config: ['OKIM6295(config, m_oki, XTAL(16\'000\'000)/4/4, okim6295_device::PIN7_HIGH).add_route(ALL_OUTPUTS, "mono", 0.30)'], member: 'm_oki', sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3946, sourceColumn: 2, sourceEndLine: 3946};
...
MERGE (n:KG {id: 'machine:cps_state.cps1_12MHz'}) SET n:MachineConfig SET n += {cls: 'cps_state', name: 'cps1_12MHz', calls: ['cps1_10MHz'], stateMembers: ['{"name":"m_sf2ceblp_prot","bits":16}', '{"name":"m_pang3b4_prot","bits":16}', '{"name":"m_raster_counter","bits":16,"arrayLength":3}', '{"name":"m_raster_reload","bits":16,"arrayLength":3}', '{"name":"m_scrollx","bits":32,"signed":true,"arrayLength":3}', '{"name":"m_scrolly","bits":32,"signed":true,"arrayLength":3}', '{"name":"m_stars_enabled","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_starsx","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_starsy","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_last_sprite_offset","bits":32,"signed":true}', '{"name":"m_scroll_size","bits":32,"signed":true}', '{"name":"m_obj_size","bits":32,"signed":true}', '{"name":"m_other_size","bits":32,"signed":true}', '{"name":"m_palette_align","bits":32,"signed":true}', '{"name":"m_palette_size","bits":32,"signed":true}', '{"name":"m_stars_rom_size","bits":32,"signed":true}', '{"name":"m_empty_tile","bits":8}'], startHandlers: ['cps_state.video_start'], devicePatches: ['{"tag":"maincpu","config":["m_maincpu->set_clock(XTAL(12\'000\'000))"],"clock":12000000}'], sourceFile: 'src/mame/capcom/cps1.cpp', sourceLine: 3959, sourceColumn: 1, sourceEndLine: 3965};
...
MATCH (a:KG {id: 'machine:cps_state.cps1_12MHz'}), (b:KG {id: 'machine:cps_state.cps1_10MHz'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
