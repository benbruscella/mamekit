    ...
    ...(() => {
        const methods = (() => {
            function method_paletteram_w(runtime, offset, data) {
                ...
                bit2 = (((((val) >>> (2)) & 1)) | 0);
                bit3 = (((((val) >>> (3)) & 1)) | 0);
                let r = ((runtime.add(runtime.add(runtime.add(((14) * (bit0)), ((31) * (bit1))), ((67) * (bit2))), ((143) * (bit3)))) | 0);
                val = ((runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), ((offset) | (16)))) | 0);
                bit0 = (((((val) >>> (0)) & 1)) | 0);
                bit1 = (((((val) >>> (1)) & 1)) | 0);
                bit2 = (((((val) >>> (2)) & 1)) | 0);
                bit3 = (((((val) >>> (3)) & 1)) | 0);
                let g = ((runtime.add(runtime.add(runtime.add(((14) * (bit0)), ((31) * (bit1))), ((67) * (bit2))), ((143) * (bit3)))) | 0);
                val = ((runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), ((offset) | (32)))) | 0);
                bit0 = (((((val) >>> (0)) & 1)) | 0);
                bit1 = (((((val) >>> (1)) & 1)) | 0);
                bit2 = (((((val) >>> (2)) & 1)) | 0);
                bit3 = (((((val) >>> (3)) & 1)) | 0);
                let b = ((runtime.add(runtime.add(runtime.add(((14) * (bit0)), ((31) * (bit1))), ((67) * (bit2))), ((143) * (bit3)))) | 0);
