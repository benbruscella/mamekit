...
// generated 2026-08-22T05:52:31.706Z
...
MERGE (n:KG {id: 'machine:matmania_state.matmania'}) SET n:MachineConfig SET n += {cls: 'matmania_state', name: 'matmania', calls: [], startHandlers: ['matmania_state.video_start'], sourceFile: 'src/mame/technos/matmania.cpp', sourceLine: 635, sourceColumn: 1, sourceEndLine: 665};
...
MERGE (n:KG {id: 'device:matmania_state.matmania/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(12_MHz_XTAL / 2, 384, 0, 256, 272, 8, 248)', 'm_screen->set_screen_update(FUNC(matmania_state::screen_update))', 'm_screen->set_palette(m_palette)'], sourceFile: 'src/mame/technos/matmania.cpp', sourceLine: 648, sourceColumn: 2, sourceEndLine: 648, configCalls: ['set_raw(6000000,384,0,256,272,8,248)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 272, 8, 248]};
...
MERGE (n:KG {id: 'inputs:matmania/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:matmania/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:matmania/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:matmania/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:matmania/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:matmania/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:matmania/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2', modifiers: ['PORT_IMPULSE(1)']};
MERGE (n:KG {id: 'inputs:matmania/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_IMPULSE(1)']};
MERGE (n:KG {id: 'inputs:matmania/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:matmania/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:matmania/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:matmania/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:matmania/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Coin A', defaultValue: 3, location: 'SW1:1,2', settings: ['0=2C 1C', '3=1C 1C', '2=1C 2C', '1=1C 3C']};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, name: 'Coin B', defaultValue: 12, location: 'SW1:3,4', settings: ['0=2C 1C', '12=1C 1C', '8=1C 2C', '4=1C 3C']};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Demo Sounds', defaultValue: 16, location: 'SW1:5', settings: ['0=Off', '16=On']};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Cabinet', defaultValue: 0, location: 'SW1:6', settings: ['0=Upright', '32=Cocktail']};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f4'}) SET n:PortField SET n += {kind: 'service', mask: 64, activeLow: true, defaultValue: 64};
MERGE (n:KG {id: 'inputs:matmania/DSW1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_DEVICE_MEMBER("screen", FUNC(screen_device::vblank))']};
MERGE (n:KG {id: 'inputs:matmania/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Difficulty', defaultValue: 2, location: 'SW2:1,2', settings: ['3=Easy', '2=Medium', '1=Hard', '0=Hardest']};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, name: 'Tournament Time', defaultValue: 12, location: 'SW2:3,4', settings: ['0=2:12', '4=2:24', '8=2:30', '12=2:36']};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Unused'};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Unused'};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Unused'};
MERGE (n:KG {id: 'inputs:matmania/DSW2/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Unused'};
