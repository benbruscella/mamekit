...
// generated 2026-09-24T02:28:31.849Z
...
MERGE (n:KG {id: 'handler:matmania_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'matmania_state', sourceFile: 'src/mame/technos/matmania.cpp', sourceLine: 256, sourceColumn: 1, sourceEndLine: 321, sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: '// Update the tiles in the left tile RAM bank
	...
	return 0;'};
MERGE (n:KG {id: 'device:matmania_state.matmania/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_matmania)'], member: 'm_gfxdecode', sourceFile: 'src/mame/technos/matmania.cpp', sourceLine: 653, sourceColumn: 2, sourceEndLine: 653, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:matmania_state.matmania/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(matmania_state::palette), 64 + 16)'], member: 'm_palette', sourceFile: 'src/mame/technos/matmania.cpp', sourceLine: 654, sourceColumn: 2, sourceEndLine: 654, clockExpr: 'FUNC(matmania_state::palette)', paletteEntries: 80};
