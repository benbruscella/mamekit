...
// generated 2026-09-11T11:44:33.769Z
...
MERGE (n:KG {id: 'device:asteroid_state.asteroid_base/dvg'}) SET n:Device SET n += {type: 'DVG', tag: 'dvg', clock: null, config: ['DVG(config, m_dvg)', 'm_dvg->set_vector("vector")', 'm_dvg->set_memory(m_maincpu, AS_PROGRAM, 0x4000)'], member: 'm_dvg', sourceFile: 'src/mame/atari/asteroid.cpp', sourceLine: 863, sourceColumn: 2, sourceEndLine: 863};
