...
// generated 2026-09-24T02:26:16.023Z
...
MERGE (n:KG {id: 'device:asteroid_state.asteroid_base/dsw_sel'}) SET n:Device SET n += {type: 'TTL153', tag: 'dsw_sel', clock: null, config: ['TTL153(config, m_dsw_sel)'], member: 'm_dsw_sel', sourceFile: 'src/mame/atari/asteroid.cpp', sourceLine: 843, sourceColumn: 2, sourceEndLine: 843};
...
MERGE (n:KG {id: 'device:asteroid_state.asteroid_base/dvg'}) SET n:Device SET n += {type: 'DVG', tag: 'dvg', clock: null, config: ['DVG(config, m_dvg)', 'm_dvg->set_vector("vector")', 'm_dvg->set_memory(m_maincpu, AS_PROGRAM, 0x4000)'], member: 'm_dvg', sourceFile: 'src/mame/atari/asteroid.cpp', sourceLine: 863, sourceColumn: 2, sourceEndLine: 863, configCalls: ['set_vector("vector")', 'set_memory("maincpu",0,16384)']};
