...
// generated 2026-09-24T02:30:35.761Z
...
MERGE (n:KG {id: 'handler:timeplt_audio_device.set_filter'}) SET n:Handler SET n += {method: 'set_filter', ownerClass: 'timeplt_audio_device', sourceFile: 'src/mame/shared/timeplt_a.cpp', sourceLine: 96, sourceColumn: 1, sourceEndLine: 106, sourceConstants: ['LOWPASS_3R=0', 'filter_rc_device::LOWPASS_3R=0'], sourceParameters: 'int no, int ch, int data', sourceBody: 'int C = 0;
...
MERGE (n:KG {id: 'device:timeplt_state.timeplt/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, MASTER_CLOCK / 3 / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &timeplt_state::main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 743, sourceColumn: 2, sourceEndLine: 743};
MERGE (n:KG {id: 'device:timeplt_state.timeplt/mainlatch'}) SET n:Device SET n += {type: 'LS259', tag: 'mainlatch', clock: null, config: ['LS259(config, m_mainlatch)', 'm_mainlatch->q_out_cb<0>().set(FUNC(timeplt_state::nmi_enable_w))', 'm_mainlatch->q_out_cb<1>().set(FUNC(timeplt_state::flip_screen_set)).invert()', 'm_mainlatch->q_out_cb<2>().set("timeplt_audio", FUNC(timeplt_audio_device::sh_irqtrigger_w))', 'm_mainlatch->q_out_cb<3>().set("timeplt_audio", FUNC(timeplt_audio_device::mute_w))', 'm_mainlatch->q_out_cb<4>().set(FUNC(timeplt_state::video_enable_w))', 'm_mainlatch->q_out_cb<5>().set(FUNC(timeplt_state::coin_counter_w<0>))', 'm_mainlatch->q_out_cb<6>().set(FUNC(timeplt_state::coin_counter_w<1>))', 'm_mainlatch->q_out_cb<7>().set_nop()'], member: 'm_mainlatch', sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 746, sourceColumn: 2, sourceEndLine: 746};
...
MERGE (n:KG {id: 'device:timeplt_state.timeplt/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_timeplt)'], member: 'm_gfxdecode', sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 768, sourceColumn: 2, sourceEndLine: 768, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:timeplt_state.timeplt/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(timeplt_state::palette), 32*4 + 64*4)'], member: 'm_palette', sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 769, sourceColumn: 2, sourceEndLine: 769, clockExpr: 'FUNC(timeplt_state::palette)', paletteEntries: 384};
MERGE (n:KG {id: 'device:timeplt_state.timeplt/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, "timeplt_audio")'], cls: 'timeplt_audio_device', clsHierarchy: ['timeplt_audio_device'], sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 772, sourceColumn: 2, sourceEndLine: 772, startHandler: 'timeplt_audio_device.device_start'};
...
MERGE (n:KG {id: 'device:timeplt_audio_device.device_add_mconfig/tpsound'}) SET n:Device SET n += {type: 'Z80', tag: 'tpsound', clock: 1789772.625, config: ['Z80(config, m_soundcpu, DERIVED_CLOCK(1, 8))', 'm_soundcpu->set_addrmap(AS_PROGRAM, &timeplt_audio_device::timeplt_sound_map)'], member: 'm_soundcpu', sourceFile: 'src/mame/shared/timeplt_a.cpp', sourceLine: 192, sourceColumn: 2, sourceEndLine: 192};
...
MERGE (n:KG {id: 'device:timeplt_audio_device.device_add_mconfig/soundlatch'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'soundlatch', clock: null, config: ['GENERIC_LATCH_8(config, m_soundlatch)'], member: 'm_soundlatch', sourceFile: 'src/mame/shared/timeplt_a.cpp', sourceLine: 198, sourceColumn: 2, sourceEndLine: 198};
MERGE (n:KG {id: 'device:timeplt_audio_device.device_add_mconfig/ay1'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay1', clock: 1789772.625, config: ['ay8910_device &ay1(AY8910(config, "ay1", DERIVED_CLOCK(1, 8)))', 'ay1.port_a_read_callback().set(m_soundlatch, FUNC(generic_latch_8_device::read))', 'ay1.port_b_read_callback().set(FUNC(timeplt_audio_device::portB_r))', 'ay1.add_route(0, "filter.0.0", 0.60)', 'ay1.add_route(1, "filter.0.1", 0.60)', 'ay1.add_route(2, "filter.0.2", 0.60)'], sourceFile: 'src/mame/shared/timeplt_a.cpp', sourceLine: 200, sourceColumn: 2, sourceEndLine: 200, configCalls: ['add_route(0,"filter.0.0",0.6)', 'add_route(1,"filter.0.1",0.6)', 'add_route(2,"filter.0.2",0.6)']};
...
MERGE (n:KG {id: 'handler:timeplt_audio_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'timeplt_audio_device', sourceFile: 'src/mame/shared/timeplt_a.cpp', sourceLine: 48, sourceColumn: 1, sourceEndLine: 52, sourceParameters: '', sourceBody: 'm_last_irq_state = 0;
...
MATCH (a:KG {id: 'device:timeplt_state.timeplt/timeplt_audio'}), (b:KG {id: 'handler:timeplt_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
