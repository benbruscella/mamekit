...
// generated 2026-08-22T05:52:47.292Z
...
MERGE (n:KG {id: 'machine:timeplt_state.timeplt'}) SET n:MachineConfig SET n += {cls: 'timeplt_state', name: 'timeplt', calls: [], startHandlers: ['timeplt_state.video_start'], sourceFile: 'src/mame/konami/timeplt.cpp', sourceLine: 738, sourceColumn: 1, sourceEndLine: 773};
