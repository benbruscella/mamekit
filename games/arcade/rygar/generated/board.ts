...
defined.compiledHandlers = {
  ...
  function method_dsw_h_r_0(runtime: any): any {
    ...
    return runtime.shiftRight(port, 4);
  }
  ...
  function method_bankswitch_w(runtime: any, data: any): any {
    ...
    (__l["m_mainbank.set_entry"] ? __l["m_mainbank.set_entry"](runtime.shiftRight(data, 3)) : (members.m_mainbank) != null ? ((runtime.dereference(members.m_mainbank)).set_entry?.(runtime.shiftRight(data, 3)) ?? 0) : (__l["set_entry"]?.(runtime.shiftRight(data, 3)) ?? 0));
  }
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](2, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(2, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0) : (__l["set"]?.(2, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0));
  }
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](1, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(1, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0) : (__l["set"]?.(1, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (7))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0));
  }
  ...
  function method_get_tx_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](0, runtime.add(runtime.readIndex((members.m_txvideoram ?? runtime.member("m_txvideoram")), tile_index), ((((attr) & (3))) << (8))), runtime.shiftRight(attr, 4), 0) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, runtime.add(runtime.readIndex((members.m_txvideoram ?? runtime.member("m_txvideoram")), tile_index), ((((attr) & (3))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0) : (__l["set"]?.(0, runtime.add(runtime.readIndex((members.m_txvideoram ?? runtime.member("m_txvideoram")), tile_index), ((((attr) & (3))) << (8))), runtime.shiftRight(attr, 4), 0) ?? 0));
  }
  ...
  function method_adpcm_int(runtime: any, state: any): any {
    ...
    if ((members.m_adpcm_toggle ?? runtime.member("m_adpcm_toggle"))) {
      ...
      let hi: any = ((runtime.shiftRight((members.m_adpcm_pos ?? runtime.member("m_adpcm_pos")), 8)) & 0xff);
      ...
      (__l["m_msm.data_w"] ? __l["m_msm.data_w"](runtime.shiftRight(data, 4)) : (members.m_msm) != null ? ((runtime.dereference(members.m_msm)).data_w?.(runtime.shiftRight(data, 4)) ?? 0) : 0);
    }
