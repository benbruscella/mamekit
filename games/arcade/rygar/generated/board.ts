...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_txvideoram_w(runtime: any, offset: any, data: any) {
  ...
  function method_dsw_l_r_0(runtime: any) {
    const members = runtime.members;
  ...
  function method_dsw_h_r_0(runtime: any) {
    const members = runtime.members;
    const h_m_dsw = members.m_dsw ?? runtime.member("m_dsw");
    let port: any = ((((runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read?.() ?? runtime.container(runtime.readIndex(h_m_dsw, 0), "read"))) & 0xff);
  ...
  function method_dsw_l_r_1(runtime: any) {
    const members = runtime.members;
    const h_m_dsw = members.m_dsw ?? runtime.member("m_dsw");
  ...
  function method_dsw_h_r_1(runtime: any) {
    const members = runtime.members;
    const h_m_dsw = members.m_dsw ?? runtime.member("m_dsw");
    let port: any = ((((runtime.dereference(runtime.readIndex(h_m_dsw, 1))).read?.() ?? runtime.container(runtime.readIndex(h_m_dsw, 1), "read"))) & 0xff);
    port = ((runtime.andAssign(port, 240)) & 0xff);
  ...
  function method_fgscroll_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_bgscroll_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_flipscreen_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_adpcm_start_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_adpcm_end_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_tx_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
  ...
  function method_pri_cb(runtime: any, pri: any) {
    const members = runtime.members;
    switch (pri) {
      default:
      {
  ...
  function method_adpcm_int(runtime: any, state: any) {
    const members = runtime.members;
