...
// generated 2026-09-24T02:30:03.629Z
...
MERGE (n:KG {id: 'device:tecmo_state.rygar/soundcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'soundcpu', clock: 4000000, config: ['Z80(config, m_soundcpu, 4_MHz_XTAL)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &tecmo_state::rygar_sound_map)'], member: 'm_soundcpu', sourceFile: 'src/mame/tecmo/tecmo.cpp', sourceLine: 1149, sourceColumn: 2, sourceEndLine: 1149};
...
MERGE (n:KG {id: 'device:tecmo_state.rygar/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_tecmo)'], member: 'm_gfxdecode', sourceFile: 'src/mame/tecmo/tecmo.cpp', sourceLine: 1162, sourceColumn: 2, sourceEndLine: 1162, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:tecmo_state.rygar/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::xBRG_444, 1024).set_endianness(ENDIANNESS_BIG)'], member: 'm_palette', sourceFile: 'src/mame/tecmo/tecmo.cpp', sourceLine: 1163, sourceColumn: 2, sourceEndLine: 1163};
MERGE (n:KG {id: 'device:tecmo_state.rygar/spritegen'}) SET n:Device SET n += {type: 'TECMO_SPRITE', tag: 'spritegen', clock: null, config: ['TECMO_SPRITE(config, m_sprgen, m_palette, gfx_tecmo_spr)', 'm_sprgen->set_pri_callback(FUNC(tecmo_state::pri_cb))'], member: 'm_sprgen', cls: 'tecmo_spr_device', clsHierarchy: ['tecmo_spr_device'], sourceFile: 'src/mame/tecmo/tecmo.cpp', sourceLine: 1165, sourceColumn: 2, sourceEndLine: 1165, clockExpr: 'm_palette', startHandler: 'tecmo_spr_device.device_start'};
MERGE (n:KG {id: 'device:tecmo_state.rygar/spritegen/callback:spritegen:0'}) SET n:Callback SET n += {signal: 'set_pri_callback', member: 'm_pri_cb', delegate: 1, operation: 'set_pri_callback', raw: 'm_sprgen->set_pri_callback(FUNC(tecmo_state::pri_cb))', ownerTag: 'spritegen', sourceFile: 'src/mame/tecmo/tecmo.cpp', sourceLine: 1166, sourceColumn: 2, sourceEndLine: 1166, targetClass: 'tecmo_state', targetMethod: 'pri_cb'};
...
MERGE (n:KG {id: 'handler:tecmo_spr_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'tecmo_spr_device', sourceFile: 'src/mame/shared/tecmo_spr.cpp', sourceLine: 31, sourceColumn: 1, sourceEndLine: 34, sourceParameters: '', sourceBody: 'm_pri_cb.resolve_safe(0);'};
...
MATCH (a:KG {id: 'device:tecmo_state.rygar/spritegen'}), (b:KG {id: 'handler:tecmo_spr_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
