...
// generated 2026-09-24T02:27:36.152Z
...
MERGE (n:KG {id: 'device:galaxian_state.galaxian/cust'}) SET n:Device SET n += {type: 'GALAXIAN_SOUND', tag: 'cust', clock: 0, config: ['GALAXIAN_SOUND(config, "cust")'], cls: 'galaxian_sound_device', clsHierarchy: ['galaxian_sound_device'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7661, sourceColumn: 2, sourceEndLine: 7661, startHandler: 'galaxian_sound_device.device_start'};
...
MERGE (n:KG {id: 'handler:galaxian_sound_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'galaxian_sound_device', sourceFile: 'src/mame/galaxian/galaxian_a.cpp', sourceLine: 649, sourceColumn: 1, sourceEndLine: 654, sourceParameters: '', sourceBody: 'm_lfo_val = 0;
...
MATCH (a:KG {id: 'device:galaxian_state.galaxian/cust'}), (b:KG {id: 'handler:galaxian_sound_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
