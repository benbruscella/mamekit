...
// generated 2026-08-22T05:52:28.388Z
...
MERGE (n:KG {id: 'machine:galaxian_state.galaxian'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'galaxian', calls: ['galaxian_base'], startHandlers: ['galaxian_state.video_start'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7657, sourceColumn: 1, sourceEndLine: 7662};
