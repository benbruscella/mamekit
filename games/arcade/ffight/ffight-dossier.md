...
- **Credited by MAMEDEV:** Paul Leaman (driver header); TwistedTom (5 release notes); darq (3 release notes); Osso (3 release notes); Robbbert (3 release notes); Tafoid (3 release notes); Abadede (2 release notes); Vas Crabb (2 release notes); BarbuDreadMon (1 release note); cam900 (1 release note); David Silva (1 release note); geforcefly (1 release note); gmx (1 release note); hap (1 release note); Ivan Vangelista (1 release note); Janniz (1 release note); Sergio Galiano (1 release note); Sonikos (1 release note); The Dumping Union (1 release note)
