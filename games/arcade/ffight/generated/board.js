    ...
    ...(() => {
        const methods = (() => {
                ...
                for (let page = ((0) | 0); ((Number(page) < Number(6)) ? 1 : 0); page = ((((page) + (1))) | 0)) {
                    if ((((ctrl) >>> (page)) & 1)) {
                        for (let offset = ((0) | 0); ((Number(offset) < Number(512)) ? 1 : 0); offset = ((((offset) + (1))) | 0)) {
                            ...
                            let bright = ((runtime.add(15, ((runtime.shiftRight(palette, 12)) << (1)))) | 0);
                            let r = ((runtime.divide(((((((runtime.shiftRight(palette, 8)) & (15))) * (17))) * (bright)), 45)) | 0);
                            let g = ((runtime.divide(((((((runtime.shiftRight(palette, 4)) & (15))) * (17))) * (bright)), 45)) | 0);
                            let b = ((runtime.divide(((((((runtime.shiftRight(palette, 0)) & (15))) * (17))) * (bright)), 45)) | 0);
            ...
            function method_cps1_gfxram_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let page = ((((runtime.shiftRight(offset, 7)) & (960))) | 0);
