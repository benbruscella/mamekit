    ...
    for (let page: any = ((0) | 0); ((Number(page) < Number(6)) ? 1 : 0); page = ((((page) + (1))) | 0)) {
      if ((((ctrl) >>> (page)) & 1)) {
        for (let offset: any = ((0) | 0); ((Number(offset) < Number(512)) ? 1 : 0); offset = ((((offset) + (1))) | 0)) {
          ...
          let bright: any = ((runtime.add(15, ((((palette) >>> (12))) << (1)))) | 0);
          let r: any = ((runtime.divide(((((((((palette) >>> (8))) & (15))) * (17))) * (bright)), 45)) | 0);
          let g: any = ((runtime.divide(((((((((palette) >>> (4))) & (15))) * (17))) * (bright)), 45)) | 0);
          let b: any = ((runtime.divide(((((((((palette) >>> (0))) & (15))) * (17))) * (bright)), 45)) | 0);
