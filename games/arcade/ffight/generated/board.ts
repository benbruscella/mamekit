...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_irqack_r(runtime: any, offset: any) {
  ...
  function method_cps1_dsw_r(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_cps1_cps_a_w(runtime: any, offset: any, data: any, mem_mask: any) {
    const members = runtime.members;
  ...
  function method_cps1_build_palette(runtime: any, palette_base: any) {
    const members = runtime.members;
    ...
    for (let page: any = 0; ((Number(page) < Number(6)) ? 1 : 0); page = ((page) + (1))) {
      if ((((ctrl) >>> (page)) & 1)) {
        for (let offset: any = 0; ((Number(offset) < Number(512)) ? 1 : 0); offset = ((offset) + (1))) {
          ...
          let bright: any = runtime.add(15, ((((palette) >>> (12))) << (1)));
          let r: any = runtime.divide(((((((((palette) >>> (8))) & (15))) * (17))) * (bright)), 45);
          let g: any = runtime.divide(((((((((palette) >>> (4))) & (15))) * (17))) * (bright)), 45);
          let b: any = runtime.divide(((((((((palette) >>> (0))) & (15))) * (17))) * (bright)), 45);
  ...
  function method_cps1_base(runtime: any, offset: any, boundary: any) {
    const members = runtime.members;
    const h_m_gfxram = members.m_gfxram ?? runtime.member("m_gfxram");
    let base: any = ((runtime.readIndex((members.m_cps_a_regs ?? runtime.member("m_cps_a_regs")), offset)) * (256));
    base = runtime.andAssign(base, (~((boundary) - (1))));
    return runtime.addressOf(h_m_gfxram, runtime.divide(((base) & (262143)), 2));
  }

  function method_cps1_gfxram_w(runtime: any, offset: any, data: any, mem_mask: any) {
    const members = runtime.members;
    const h_m_gfxram = members.m_gfxram ?? runtime.member("m_gfxram");
    let page: any = ((((offset) >>> (7))) & (960));
  ...
  function method_cps1_snd_bankswitch_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_cps1_oki_pin7_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_tile0_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 0), ((2) * (tile_index)));
  ...
  function method_gfxrom_bank_mapper(runtime: any, type: any, code: any) {
    const members = runtime.members;
    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    ...
    while (range.type) {
      if ((((((Number(code) >= Number(range.start)) ? 1 : 0)) && (((Number(code) <= Number(range.end)) ? 1 : 0))) ? 1 : 0)) {
        if (((range.type) & (type))) {
          let base: any = 0;
          for (let i: any = 0; ((Number(i) < Number(range.bank)) ? 1 : 0); i = ((i) + (1))) {
  ...
  function method_tilemap0_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any) {
    const members = runtime.members;
    return runtime.add(runtime.add(((row) & (31)), ((((col) & (63))) << (5))), ((((row) & (32))) << (6)));
  }

  function method_get_tile1_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 1), ((2) * (tile_index)));
  ...
  function method_tilemap1_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any) {
    const members = runtime.members;
    return runtime.add(runtime.add(((row) & (15)), ((((col) & (63))) << (4))), ((((row) & (48))) << (6)));
  }

  function method_get_tile2_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 2), ((2) * (tile_index)))) & (16383));
  ...
  function method_tilemap2_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any) {
    const members = runtime.members;
    return runtime.add(runtime.add(((row) & (7)), ((((col) & (63))) << (3))), ((((row) & (56))) << (6)));
  }

  function method_cps1_interrupt(runtime: any, device: any) {
    const members = runtime.members;
  ...
  function method_cps1_get_video_base(runtime: any) {
    const members = runtime.members;
    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    let scroll1xoff: any = 0;
    let scroll2xoff: any = 0;
    let scroll3xoff: any = 0;
  ...
  function method_find_last_sprite(runtime: any) {
    const members = runtime.members;
    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    let offset: any = 0;
    while (((Number(offset) < Number(runtime.divide((members.m_obj_size ?? runtime.member("m_obj_size")), 2))) ? 1 : 0)) {
      if (((Number((((h_m_game_config.bootleg_kludge) >>> (0)) & ((1 << (4)) - 1))) === Number(3)) ? 1 : 0)) {
        let marker: any = runtime.readIndex((members.m_buffered_obj ?? runtime.member("m_buffered_obj")), ((offset) + (1)));
        if (((Number(marker) >= Number(32768)) ? 1 : 0)) {
          members.m_last_sprite_offset = ((((offset) - (4))) | 0);
          return;
        }
      } else {
        let marker: any = runtime.readIndex((members.m_buffered_obj ?? runtime.member("m_buffered_obj")), ((offset) + (3)));
  ...
  function method_cps1_update_transmasks(runtime: any) {
    const members = runtime.members;
    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
  ...
  function method_cps1_render_layer(runtime: any, screen: any, bitmap: any, cliprect: any, layer: any, primask: any) {
    const members = runtime.members;
    switch (layer) {
      case 0:
      {
  ...
  function method_screen_vblank_cps1(runtime: any, state: any) {
    const members = runtime.members;
    if (state) {
  ...
  function method_cps1_objram_latch(runtime: any, state: any) {
    const members = runtime.members;
    if (state) {
