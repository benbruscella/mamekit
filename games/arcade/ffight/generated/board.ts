...
const defined = decodeBoardIr(boardData, 'ffight');
...
defined.compiledHandlers = {
  ...
  function method_irqack_r(runtime: any, offset: any): any {
  ...
  function method_cps1_dsw_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_cps1_cps_a_w(runtime: any, offset: any, data: any, mem_mask: any): any {
    const members = runtime.members;
  ...
  function method_cps1_build_palette(runtime: any, palette_base: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    let palette_ram: any = palette_base;
    let ctrl: any = ((runtime.readIndex((members.m_cps_b_regs ?? runtime.member("m_cps_b_regs")), runtime.divide(h_m_game_config.palette_control, 2))) & 0xffff);
    for (let page: any = ((0) | 0); ((Number(page) < Number(6)) ? 1 : 0); page = ((((page) + (1))) | 0)) {
      if ((((ctrl) >>> (page)) & 1)) {
        for (let offset: any = ((0) | 0); ((Number(offset) < Number(512)) ? 1 : 0); offset = ((((offset) + (1))) | 0)) {
          let palette: any = ((runtime.dereference((() => { const previous = palette_ram; palette_ram = ({ ...(palette_ram), offset: ((palette_ram).offset + (1)) }); return previous; })())) & 0xffff);
          let bright: any = ((runtime.add(15, ((runtime.shiftRight(palette, 12)) << (1)))) | 0);
          let r: any = ((runtime.divide(((((((runtime.shiftRight(palette, 8)) & (15))) * (17))) * (bright)), 45)) | 0);
          let g: any = ((runtime.divide(((((((runtime.shiftRight(palette, 4)) & (15))) * (17))) * (bright)), 45)) | 0);
          let b: any = ((runtime.divide(((((((runtime.shiftRight(palette, 0)) & (15))) * (17))) * (bright)), 45)) | 0);
  ...
  function method_cps1_base(runtime: any, offset: any, boundary: any): any {
    const members = runtime.members;

    let base: any = ((((runtime.readIndex((members.m_cps_a_regs ?? runtime.member("m_cps_a_regs")), offset)) * (256))) | 0);
    base = ((runtime.andAssign(base, (~((boundary) - (1))))) | 0);
    return runtime.addressOf((members.m_gfxram ?? runtime.member("m_gfxram")), runtime.divide(((base) & (262143)), 2));
  }

  function method_cps1_gfxram_w(runtime: any, offset: any, data: any, mem_mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let page: any = ((((runtime.shiftRight(offset, 7)) & (960))) | 0);
    runtime.combineData(runtime.addressOf((members.m_gfxram ?? runtime.member("m_gfxram")), offset), data, mem_mask);
  ...
  function method_cps1_snd_bankswitch_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_cps1_oki_pin7_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_get_tile0_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 0), ((2) * (tile_index)))) | 0);
    let attr: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 0), runtime.add(((2) * (tile_index)), 1))) & 0xffff);
    ...
    let gfxset: any = (((((tile_index) >>> (5)) & 1)) & 0xff);
    (__l["tileinfo.set"] ? __l["tileinfo.set"](gfxset, code, runtime.add(((attr) & (31)), 32), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(gfxset, code, runtime.add(((attr) & (31)), 32), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0) : (__l["set"]?.(gfxset, code, runtime.add(((attr) & (31)), 32), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0));
    tileinfo.group = runtime.shiftRight(((attr) & (384)), 7);
    if (((Number(code) === Number(-1)) ? 1 : 0)) {
      tileinfo.pen_data = h_m_empty_tile;
    }
  }

  function method_gfxrom_bank_mapper(runtime: any, type: any, code: any): any {
    const members = runtime.members;

    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    let range: any = h_m_game_config.bank_mapper;
    let shift: any = ((0) | 0);
    0;
    switch (type) {
      case 1:
    ...
    while (range.type) {
      if ((((((Number(code) >= Number(range.start)) ? 1 : 0)) && (((Number(code) <= Number(range.end)) ? 1 : 0))) ? 1 : 0)) {
        if (((range.type) & (type))) {
          let base: any = ((0) | 0);
          for (let i: any = ((0) | 0); ((Number(i) < Number(range.bank)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
            base = ((((base) + (runtime.readIndex(h_m_game_config.bank_sizes, i)))) | 0);
          }
          return runtime.shiftRight(((base) + (((code) & (((runtime.readIndex(h_m_game_config.bank_sizes, range.bank)) - (1)))))), shift);
        }
      }
  ...
  function method_tilemap0_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any): any {
    const members = runtime.members;

    return runtime.add(runtime.add(((row) & (31)), ((((col) & (63))) << (5))), ((((row) & (32))) << (6)));
  }

  function method_get_tile1_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 1), ((2) * (tile_index)))) | 0);
    let attr: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 1), runtime.add(((2) * (tile_index)), 1))) & 0xffff);
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](2, code, runtime.add(((attr) & (31)), 64), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(2, code, runtime.add(((attr) & (31)), 64), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0) : (__l["set"]?.(2, code, runtime.add(((attr) & (31)), 64), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0));
    tileinfo.group = runtime.shiftRight(((attr) & (384)), 7);
    if (((Number(code) === Number(-1)) ? 1 : 0)) {
      tileinfo.pen_data = h_m_empty_tile;
    }
  ...
  function method_tilemap1_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any): any {
    const members = runtime.members;

    return runtime.add(runtime.add(((row) & (15)), ((((col) & (63))) << (4))), ((((row) & (48))) << (6)));
  }

  function method_get_tile2_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_empty_tile = members.m_empty_tile ?? runtime.member("m_empty_tile");
    let code: any = ((((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 2), ((2) * (tile_index)))) & (16383))) | 0);
    let attr: any = ((runtime.readIndex(runtime.readIndex((members.m_scroll ?? runtime.member("m_scroll")), 2), runtime.add(((2) * (tile_index)), 1))) & 0xffff);
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](3, code, runtime.add(((attr) & (31)), 96), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(3, code, runtime.add(((attr) & (31)), 96), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0) : (__l["set"]?.(3, code, runtime.add(((attr) & (31)), 96), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (96)), 5)))) ?? 0));
    tileinfo.group = runtime.shiftRight(((attr) & (384)), 7);
    if (((Number(code) === Number(-1)) ? 1 : 0)) {
      tileinfo.pen_data = h_m_empty_tile;
    }
  ...
  function method_tilemap2_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any): any {
    const members = runtime.members;

    return runtime.add(runtime.add(((row) & (7)), ((((col) & (63))) << (3))), ((((row) & (56))) << (6)));
  }

  function method_cps1_interrupt(runtime: any, device: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_cps1_get_video_base(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_game_config = members.m_game_config ?? runtime.member("m_game_config");
    let scroll1xoff: any = ((0) | 0);
    let scroll2xoff: any = ((0) | 0);
    let scroll3xoff: any = ((0) | 0);
    ...
    let kludge: any = ((((h_m_game_config.bootleg_kludge) & (15))) & 0xff);
    ...
    let layercontrol: any = ((runtime.readIndex((members.m_cps_b_regs ?? runtime.member("m_cps_b_regs")), runtime.divide(h_m_game_config.layer_control, 2))) & 0xffff);
    let videocontrol: any = ((runtime.readIndex((members.m_cps_a_regs ?? runtime.member("m_cps_a_regs")), 17)) & 0xffff);
  ...
  function method_find_last_sprite(runtime: any): any {
    const members = runtime.members;
    ...
    while (((Number(offset) < Number(runtime.divide((members.m_obj_size ?? runtime.member("m_obj_size")), 2))) ? 1 : 0)) {
      if (((Number((((h_m_game_config.bootleg_kludge) >>> (0)) & ((1 << (4)) - 1))) === Number(3)) ? 1 : 0)) {
        let marker: any = ((runtime.readIndex((members.m_buffered_obj ?? runtime.member("m_buffered_obj")), ((offset) + (1)))) | 0);
        if (((Number(marker) >= Number(32768)) ? 1 : 0)) {
          members.m_last_sprite_offset = ((((offset) - (4))) | 0);
          return;
        }
      } else {
        let marker: any = ((runtime.readIndex((members.m_buffered_obj ?? runtime.member("m_buffered_obj")), ((offset) + (3)))) | 0);
  ...
  function method_cps1_update_transmasks(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_cps1_render_layer(runtime: any, screen: any, bitmap: any, cliprect: any, layer: any, primask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_screen_vblank_cps1(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_cps1_objram_latch(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
