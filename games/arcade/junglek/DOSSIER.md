...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Angelo Salese (2 release notes); David Haywood (2 release notes); CWorks (1 release note); fipppi (1 release note); hap (1 release note); jkburks (1 release note); MetalGod (1 release note); O. Galibert (1 release note)
