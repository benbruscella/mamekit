...
// generated 2026-09-24T02:28:05.560Z
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 4000000, config: ['Z80(config, m_maincpu, 8_MHz_XTAL / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &taitosj_state::main_nomcu_map)'], member: 'm_maincpu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1665, sourceColumn: 2, sourceEndLine: 1665};
