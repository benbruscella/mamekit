...
defined.compiledHandlers = {
  ...
  function method_scramble_background_enable_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_theend_protection_r(runtime: any) {
    const members = runtime.members;
    return (members.m_protection_result ?? runtime.member("m_protection_result"));
  }

  function method_theend_protection_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_scramble_draw_stars(runtime: any, bitmap: any, cliprect: any, maxx: any) {
    ...
    if ((members.m_stars_enabled ?? runtime.member("m_stars_enabled"))) {
      let blink_state: any = (((members.m_stars_blink_state ?? runtime.member("m_stars_blink_state"))) & (3));
      for (let y: any = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
