    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_stars_update_origin(runtime) {
                const members = runtime.members;
                let curframe = (runtime.calls["m_screen.frame_number"] ? runtime.calls["m_screen.frame_number"]() : (members.m_screen) != null ? (typeof (runtime.dereference(members.m_screen)).frame_number === 'function' ? (runtime.dereference(members.m_screen)).frame_number() : typeof (runtime.dereference(members.m_screen)).frame_number === 'number' || typeof (runtime.dereference(members.m_screen)).frame_number === 'boolean' ? (runtime.dereference(members.m_screen)).frame_number : runtime.container(members.m_screen, "frame_number")) : (runtime.calls["frame_number"]?.() ?? 0));
                if (((Number(curframe) !== Number((members.m_star_rng_origin_frame ?? runtime.member("m_star_rng_origin_frame")))) ? 1 : 0)) {
                    let per_frame_delta = (((members.m_flipscreen_x ?? runtime.member("m_flipscreen_x"))) ? (1) : ((-1)));
                    let total_delta = ((per_frame_delta) * (((curframe) - ((members.m_star_rng_origin_frame ?? runtime.member("m_star_rng_origin_frame"))))));
            ...
            function method_bullets_draw(runtime, screen, bitmap, cliprect, base) {
                ...
                for (let y = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
                    ...
                    for (let which = 0; ((Number(which) < Number(3)) ? 1 : 0); which = ((which) + (1))) {
                    ...
                    for (let which = 3; ((Number(which) < Number(8)) ? 1 : 0); which = ((which) + (1))) {
                        if (((Number(((((runtime.readIndex(base, runtime.add(((which) * (4)), 1))) + (effy))) & 0xff)) === Number(255)) ? 1 : 0)) {
            ...
            function method_theend_protection_w(runtime, data) {
                ...
                switch (op) {
                    ...
                    case 9:
                        {
                            members.m_protection_result = (((((runtime.calls["std::min"] ? runtime.calls["std::min"](((num1) + (1)), 15) : runtime.macro("std::min", ((num1) + (1)), 15))) << (4))) & 0xff);
                            break;
                        }
                    case 11:
                        {
                            members.m_protection_result = (((((runtime.calls["std::max"] ? runtime.calls["std::max"](((num2) - (num1)), 0) : runtime.macro("std::max", ((num2) - (num1)), 0))) << (4))) & 0xff);
                            break;
                        }
                    case 10:
                        {
                    ...
                    case 15:
                        {
                            members.m_protection_result = (((((runtime.calls["std::max"] ? runtime.calls["std::max"](((num1) - (num2)), 0) : runtime.macro("std::max", ((num1) - (num2)), 0))) << (4))) & 0xff);
                            break;
                        }
                }
            }
            function method_scramble_draw_stars(runtime, bitmap, cliprect, maxx) {
                ...
                if ((members.m_stars_enabled ?? runtime.member("m_stars_enabled"))) {
                    let blink_state = (((members.m_stars_blink_state ?? runtime.member("m_stars_blink_state"))) & (3));
                    for (let y = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
                        if ((((((Number(blink_state) !== Number(2)) ? 1 : 0)) || (((Number(((y) & (2))) !== Number(0)) ? 1 : 0))) ? 1 : 0)) {
                            (runtime.overrides["stars_draw_row"] ? runtime.overrides["stars_draw_row"](bitmap, maxx, y, ((y) * (512)), ([32, 8, 255, 255][(((blink_state) % 4) + 4) % 4] ?? 0)) : method_stars_draw_row(runtime, bitmap, maxx, y, ((y) * (512)), ([32, 8, 255, 255][(((blink_state) % 4) + 4) % 4] ?? 0)));
                        }
                    }
                }
            }
