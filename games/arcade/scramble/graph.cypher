...
// generated 2026-08-22T05:52:50.297Z
...
MERGE (n:KG {id: 'machine:galaxian_state.konami_sound_2x_ay8910'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'konami_sound_2x_ay8910', calls: [], startHandlers: ['galaxian_state.video_start'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7583, sourceColumn: 1, sourceEndLine: 7637};
...
MERGE (n:KG {id: 'machine:galaxian_state.scramble_base'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'scramble_base', calls: ['konami_base', 'konami_sound_2x_ay8910'], startHandlers: ['galaxian_state.video_start'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7640, sourceColumn: 1, sourceEndLine: 7647};
...
MERGE (n:KG {id: 'machine:galaxian_state.scramble'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'scramble', calls: ['scramble_base'], startHandlers: ['galaxian_state.video_start'], devicePatches: ['{"tag":"ppi8255_1","config":["m_ppi8255[1]->in_pc_callback().set(FUNC(galaxian_state::theend_protection_r))","m_ppi8255[1]->out_pc_callback().set(FUNC(galaxian_state::theend_protection_w))"]}'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 8173, sourceColumn: 1, sourceEndLine: 8182};
...
MERGE (n:KG {id: 'inputs:scramble/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:scramble/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:scramble/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_SERVICE1'};
MERGE (n:KG {id: 'inputs:scramble/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:scramble/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:scramble/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:scramble/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:scramble/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1'};
...
MERGE (n:KG {id: 'inputs:scramble/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:scramble/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:scramble/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:scramble/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:scramble/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:scramble/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:scramble/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:scramble/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
...
MERGE (n:KG {id: 'inputs:scramble/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:scramble/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(galaxian_state::theend_protection_alt_r<0>))']};
MERGE (n:KG {id: 'inputs:scramble/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:scramble/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(galaxian_state::theend_protection_alt_r<1>))']};
MERGE (n:KG {id: 'inputs:scramble/IN3'}) SET n:Port SET n += {tag: 'IN3', modify: false};
MERGE (n:KG {id: 'inputs:scramble/IN3/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 255, activeLow: false, type: 'IPT_UNUSED'};
...
MATCH (a:KG {id: 'machine:galaxian_state.scramble'}), (b:KG {id: 'machine:galaxian_state.scramble_base'}) MERGE (a)-[r:CALLS]->(b);
...
MATCH (a:KG {id: 'machine:galaxian_state.scramble_base'}), (b:KG {id: 'machine:galaxian_state.konami_base'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'machine:galaxian_state.scramble_base'}), (b:KG {id: 'machine:galaxian_state.konami_sound_2x_ay8910'}) MERGE (a)-[r:CALLS]->(b);
