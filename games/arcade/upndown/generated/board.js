    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_tile_get_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let rambase = (__l["tilemap.user_data"] ? __l["tilemap.user_data"]() : (tilemap) != null ? (typeof (runtime.dereference(tilemap)).user_data === 'function' ? (runtime.dereference(tilemap)).user_data() : typeof (runtime.dereference(tilemap)).user_data === 'number' || typeof (runtime.dereference(tilemap)).user_data === 'boolean' ? (runtime.dereference(tilemap)).user_data : runtime.container(tilemap, "user_data")) : (__l["user_data"]?.() ?? 0));
                ...
                let code = ((((((runtime.shiftRight(tiledata, 4)) & (2048))) | (((tiledata) & (2047))))) >>> 0);
                let color = ((((runtime.shiftRight(tiledata, 5)) & (255))) >>> 0);
