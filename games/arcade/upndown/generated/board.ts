...
defined.compiledHandlers = {
  ...
  function method_paletteram_w(runtime: any, offset: any, data: any): any {
    ...
    (__l["m_palette.set_pen_indirect"] ? __l["m_palette.set_pen_indirect"](offset, runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), offset)) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).set_pen_indirect?.(offset, runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), offset)) ?? 0) : 0);
  }
  ...
  function method_mixer_collision_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_mixer_collision_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_mixer_collision_reset_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_sprite_collision_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_sprite_collision_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_sprite_collision_reset_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_tile_get_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let rambase: any = (__l["tilemap.user_data"] ? __l["tilemap.user_data"]() : (tilemap) != null ? (typeof (runtime.dereference(tilemap)).user_data === 'function' ? (runtime.dereference(tilemap)).user_data() : typeof (runtime.dereference(tilemap)).user_data === 'number' || typeof (runtime.dereference(tilemap)).user_data === 'boolean' ? (runtime.dereference(tilemap)).user_data : runtime.container(tilemap, "user_data")) : (__l["user_data"]?.() ?? 0));
    ...
    let code: any = ((((((runtime.shiftRight(tiledata, 4)) & (2048))) | (((tiledata) & (2047))))) >>> 0);
    let color: any = ((((runtime.shiftRight(tiledata, 5)) & (255))) >>> 0);
  ...
  function method_adjust_cycles(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_soundirq_gen(runtime: any, param: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_soundcpu.set_input_line"] ? __l["m_soundcpu.set_input_line"](0, 2) : (members.m_soundcpu) != null ? ((runtime.dereference(members.m_soundcpu)).set_input_line?.(0, 2) ?? 0) : 0);
  }

  function method_common_videomode_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_videoram_bank_w(runtime: any, data: any): any {
    const members = runtime.members;
...
defined.compiledHandlerLinks = ["adjust_icount","cpu.adjust_icount","cpu.total_cycles","flip_screen_set","m_maincpu.adjust_icount","m_palette.set_pen_indirect","m_screen.update_partial","m_screen.vpos","m_soundcpu.set_input_line","machine","machine().side_effects_disabled","set","tileinfo.set","tilemap.user_data","total_cycles","user_data"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
