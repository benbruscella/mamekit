...
// generated 2026-09-05T03:50:21.666Z
...
MERGE (n:KG {id: 'device:system1_state.sys1ppi/soundcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'soundcpu', clock: 2500000, config: ['Z80(config, m_soundcpu, SOUND_CLOCK/2)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &system1_state::sound_map)', 'm_soundcpu->set_clock(MASTER_CLOCK / 8)'], sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 2205, sourceColumn: 2, sourceEndLine: 2205};
