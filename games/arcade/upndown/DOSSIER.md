...
- **Credited by MAMEDEV:** Jarek Parchanski (driver header); Mirko Buffoni (driver header); Nicola Salmoria (driver header); hap (6 release notes); kmg (3 release notes); David Haywood (1 release note); f205v (1 release note); Ivan Vangelista (1 release note); negunma (1 release note); sasuke (1 release note); Wayder (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 361 commits by 43 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
