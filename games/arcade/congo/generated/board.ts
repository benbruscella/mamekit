...
defined.compiledHandlers = {
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any, flipxmask: any, flipymask: any): any {
    ...
    for (offs = ((124) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
      ...
      let flipy: any = ((((((runtime.readIndex(spriteram, ((offs) + (runtime.shiftRight(flipymask, 8))))) ^ (flipmask))) & (flipymask))) | 0);
      let flipx: any = ((((((runtime.readIndex(spriteram, ((offs) + (runtime.shiftRight(flipxmask, 8))))) ^ (flipmask))) & (flipxmask))) | 0);
