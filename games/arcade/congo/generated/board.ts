...
defined.compiledHandlers = {
  ...
  function method_congo_colorram_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_colorram"), offset, data);
    (runtime.calls["m_fg_tilemap.mark_tile_dirty"] ? runtime.calls["m_fg_tilemap.mark_tile_dirty"](offset) : (members.m_fg_tilemap) != null ? ((runtime.dereference(members.m_fg_tilemap)).mark_tile_dirty?.(offset) ?? 0) : (runtime.calls["mark_tile_dirty"]?.(offset) ?? 0));
  }

  function method_congo_sprite_custom_w(runtime: any, space: any, offset: any, data: any) {
    const members = runtime.members;
    ...
    if ((((((Number(offset) === Number(3)) ? 1 : 0)) && (((Number(data) === Number(1)) ? 1 : 0))) ? 1 : 0)) {
      ...
      let count: any = runtime.readIndex((members.m_congo_custom ?? runtime.member("m_congo_custom")), 2);
      ...
      while (((Number((() => { const previous = count; count = ((count) - (1)); return previous; })()) >= Number(0)) ? 1 : 0)) {
        let daddr: any = (((((runtime.calls["space.read_byte"] ? runtime.calls["space.read_byte"](((saddr) + (0))) : (space) != null ? ((runtime.dereference(space)).read_byte?.(((saddr) + (0))) ?? 0) : (runtime.calls["read_byte"]?.(((saddr) + (0))) ?? 0))) * (4))) & 0xff);
  ...
  function method_congo_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let code: any = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), (((members.m_congo_fg_bank ?? runtime.member("m_congo_fg_bank"))) << (8)));
    let color: any = ((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (31));
  ...
  function method_congo_sound_b_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_congo_sound_c_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_congo_fg_bank_w(runtime: any, state: any) {
    const members = runtime.members;
  ...
  function method_congo_color_bank_w(runtime: any, state: any) {
    const members = runtime.members;
    members.m_congo_color_bank = ((state) & 0xff);
    (runtime.calls["m_fg_tilemap.set_palette_offset"] ? runtime.calls["m_fg_tilemap.set_palette_offset"](runtime.add((members.m_fg_color ?? runtime.member("m_fg_color")), (((members.m_congo_color_bank ?? runtime.member("m_congo_color_bank"))) << (8)))) : (members.m_fg_tilemap) != null ? ((runtime.dereference(members.m_fg_tilemap)).set_palette_offset?.(runtime.add((members.m_fg_color ?? runtime.member("m_fg_color")), (((members.m_congo_color_bank ?? runtime.member("m_congo_color_bank"))) << (8)))) ?? 0) : (runtime.calls["set_palette_offset"]?.(runtime.add((members.m_fg_color ?? runtime.member("m_fg_color")), (((members.m_congo_color_bank ?? runtime.member("m_congo_color_bank"))) << (8)))) ?? 0));
  }

  function method_screen_update_congo(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
