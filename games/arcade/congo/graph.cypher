...
// generated 2026-09-05T03:49:22.181Z
...
MERGE (n:KG {id: 'device:zaxxon_state.congo_samples/samples'}) SET n:Device SET n += {type: 'SAMPLES', tag: 'samples', clock: null, config: ['SAMPLES(config, m_samples)', 'm_samples->set_channels(5)', 'm_samples->set_samples_names(congo_sample_names)', 'm_samples->add_route(ALL_OUTPUTS, "speaker", 0.25)'], sourceFile: 'src/mame/sega/zaxxon_a.cpp', sourceLine: 198, sourceColumn: 2, sourceEndLine: 198, configCalls: ['set_channels(5)']};
