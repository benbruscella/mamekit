...
**Williams · 1980** — transpiled from the MAME driver `src/mame/williams/williams.cpp` by mamekit.

![marquee](/artwork/media/marquees/defender.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/defender.webp) | ![cabinet](/artwork/media/cabinets/defender.webp) |

## The machine

| CPU | Type | Clock | Mapped ranges |
| --- | --- | --- | --- |
| `maincpu` | MC6809E | 1.000 MHz | 11 |
| `soundcpu` | M6808 | 3.580 MHz | 3 |
...
| --- | --- | --- | --- | --- |
| `maincpu` | `defend.1` | 0x0 | 0x800 | `c3e52d7e` |
| `maincpu` | `defend.4` | 0x800 | 0x800 | `9a72348b` |
| `maincpu` | `defend.2` | 0x1000 | 0x1000 | `89b75984` |
| `maincpu` | `defend.3` | 0x2000 | 0x1000 | `94f51e9b` |
| `banked` | `defend.9` | 0x0 | 0x800 | `6870e8a5` |
| `banked` | `defend.12` | 0x800 | 0x800 | `f1f88938` |
| `banked` | `defend.8` | 0x1000 | 0x800 | `b649e306` |
| `banked` | `defend.11` | 0x1800 | 0x800 | `9deaf6d9` |
| `banked` | `defend.7` | 0x2000 | 0x800 | `339e092e` |
| `banked` | `defend.10` | 0x2800 | 0x800 | `a543b167` |
| `banked` | `defend.6` | 0x6000 | 0x800 | `65f4efd1` |
| `soundcpu` | `video_sound_rom_1.ic12` | 0xf800 | 0x800 | `fefd5b48` |
| `proms` | `decoder.2` | 0x0 | 0x200 | `8dd98da5` |
| `proms` | `decoder.3` | 0x200 | 0x200 | `c3f45f70` |

## Controls

| Key | Function | Port | Bit |
| --- | --- | --- | --- |
| X / Space | fire | `IN0` | 0x1 |
| Z | thrust | `IN0` | 0x2 |
| S | smart bomb | `IN0` | 0x4 |
| A | hyperspace | `IN0` | 0x8 |
| 2 | start2 | `IN0` | 0x10 |
| 1 | start1 | `IN0` | 0x20 |
| C | reverse | `IN0` | 0x40 |
| Down | joystick down | `IN0` | 0x80 |
| Up | joystick up | `IN1` | 0x1 |
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/614/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `williams`. Play it at [../../../app/g/defender/](../../../app/g/defender/) or [explore the knowledge graph](viewer.html).*
