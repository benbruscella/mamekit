...
// generated 2026-08-22T05:52:14.208Z
...
MERGE (n:KG {id: 'machine:williams_state.williams_base'}) SET n:MachineConfig SET n += {cls: 'williams_state', name: 'williams_base', calls: [], resetHandlers: ['williams_state.machine_reset'], startHandlers: ['williams_state.video_start'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1534, sourceColumn: 1, sourceEndLine: 1584};
...
MERGE (n:KG {id: 'device:williams_state.williams_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_video_attributes(VIDEO_UPDATE_SCANLINE | VIDEO_ALWAYS_UPDATE)', 'm_screen->set_raw(MASTER_CLOCK*2/3, 512, 6, 298, 260, 7, 247)', 'm_screen->set_screen_update(FUNC(williams_state::screen_update))', 'm_screen->set_visarea(12, 304-1, 7, 247-1)'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1554, sourceColumn: 2, sourceEndLine: 1554, configCalls: ['set_raw(8000000,512,6,298,260,7,247)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [8000000, 512, 6, 298, 260, 7, 247], screenVideoAttributes: ['VIDEO_UPDATE_SCANLINE', 'VIDEO_ALWAYS_UPDATE']};
...
MERGE (n:KG {id: 'machine:defender_state.defender'}) SET n:MachineConfig SET n += {cls: 'defender_state', name: 'defender', calls: ['williams_base'], resetHandlers: ['defender_state.machine_reset'], startHandlers: ['williams_state.video_start'], devicePatches: ['{"tag":"screen","config":["m_screen->set_visarea(12, 304-1, 7, 247-1)"]}'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1594, sourceColumn: 1, sourceEndLine: 1602};
...
MERGE (n:KG {id: 'inputs:defender/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_NAME("Fire")']};
MERGE (n:KG {id: 'inputs:defender/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_BUTTON2', modifiers: ['PORT_NAME("Thrust")']};
MERGE (n:KG {id: 'inputs:defender/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_BUTTON3', modifiers: ['PORT_NAME("Smart Bomb")']};
MERGE (n:KG {id: 'inputs:defender/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_BUTTON4', modifiers: ['PORT_NAME("Hyperspace")']};
MERGE (n:KG {id: 'inputs:defender/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:defender/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:defender/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_BUTTON5', modifiers: ['PORT_NAME(DEF_STR( Reverse ))']};
MERGE (n:KG {id: 'inputs:defender/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:defender/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:defender/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:defender/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 254, activeLow: false, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:defender/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:defender/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE1', modifiers: ['PORT_NAME("Auto Up / Manual Down")', 'PORT_TOGGLE']};
MERGE (n:KG {id: 'inputs:defender/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_SERVICE', modifiers: ['PORT_NAME("Advance")']};
MERGE (n:KG {id: 'inputs:defender/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_COIN3'};
MERGE (n:KG {id: 'inputs:defender/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_MEMORY_RESET', modifiers: ['PORT_NAME("High Score Reset")']};
MERGE (n:KG {id: 'inputs:defender/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:defender/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:defender/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_TILT'};
MERGE (n:KG {id: 'inputs:defender/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN'};
...
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'machine:williams_state.williams_base'}) MERGE (a)-[r:CALLS]->(b);
