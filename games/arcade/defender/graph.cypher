...
// generated 2026-09-05T03:49:25.164Z
...
MERGE (n:KG {id: 'game:defender'}) SET n:Game SET n += {name: 'defender', year: '1980', company: 'Williams', fullname: 'Defender (Red label)', monitor: 'ROT0', cls: 'defender_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3968, sourceColumn: 1, sourceEndLine: 3968};
MERGE (n:KG {id: 'romset:defender'}) SET n:RomSet SET n += {name: 'defender', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1985, sourceColumn: 1, sourceEndLine: 1985};
MERGE (n:KG {id: 'region:defender/maincpu'}) SET n:RomRegion SET n += {tag: 'maincpu', size: 12288, flags: 'ROMREGION_BE', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1986, sourceColumn: 2, sourceEndLine: 1986};
MERGE (n:KG {id: 'rom:defender/maincpu/defend.1'}) SET n:Rom SET n += {file: 'defend.1', offset: 0, size: 2048, crc: 'c3e52d7e', sha1: 'a57f5278ffe44248fc73f9925d107f4024ad981a', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1987, sourceColumn: 2, sourceEndLine: 1987};
MERGE (n:KG {id: 'rom:defender/maincpu/defend.4'}) SET n:Rom SET n += {file: 'defend.4', offset: 2048, size: 2048, crc: '9a72348b', sha1: 'ed6ce796702ff32209ced3cb1ba3837dbafa526f', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1988, sourceColumn: 2, sourceEndLine: 1988};
MERGE (n:KG {id: 'rom:defender/maincpu/defend.2'}) SET n:Rom SET n += {file: 'defend.2', offset: 4096, size: 4096, crc: '89b75984', sha1: 'a9481478da38f99efb67f0ecf82d084e14b93b42', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1989, sourceColumn: 2, sourceEndLine: 1989};
MERGE (n:KG {id: 'rom:defender/maincpu/defend.3'}) SET n:Rom SET n += {file: 'defend.3', offset: 8192, size: 4096, crc: '94f51e9b', sha1: 'a24cfc55de56a72758c76fe2a55f1ec6c353b16f', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1990, sourceColumn: 2, sourceEndLine: 1990};
MERGE (n:KG {id: 'region:defender/banked'}) SET n:RomRegion SET n += {tag: 'banked', size: 28672, flags: 'ROMREGION_BE', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1992, sourceColumn: 2, sourceEndLine: 1992};
MERGE (n:KG {id: 'rom:defender/banked/defend.9'}) SET n:Rom SET n += {file: 'defend.9', offset: 0, size: 2048, crc: '6870e8a5', sha1: '67ccc194b1753a18af0c85f5e603355549c4f727', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1993, sourceColumn: 2, sourceEndLine: 1993};
MERGE (n:KG {id: 'rom:defender/banked/defend.12'}) SET n:Rom SET n += {file: 'defend.12', offset: 2048, size: 2048, crc: 'f1f88938', sha1: '26e48dfeefa0766837b1e762695b9532dbc8bc5e', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1994, sourceColumn: 2, sourceEndLine: 1994};
MERGE (n:KG {id: 'rom:defender/banked/defend.8'}) SET n:Rom SET n += {file: 'defend.8', offset: 4096, size: 2048, crc: 'b649e306', sha1: '9d7bc3c89e5a53c575946f06702c722b864b1ff0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1995, sourceColumn: 2, sourceEndLine: 1995};
MERGE (n:KG {id: 'rom:defender/banked/defend.11'}) SET n:Rom SET n += {file: 'defend.11', offset: 6144, size: 2048, crc: '9deaf6d9', sha1: '59b018ba0f3fe6eadfd387dc180ac281460358bc', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1996, sourceColumn: 2, sourceEndLine: 1996};
MERGE (n:KG {id: 'rom:defender/banked/defend.7'}) SET n:Rom SET n += {file: 'defend.7', offset: 8192, size: 2048, crc: '339e092e', sha1: '2f89951dbe55d80df43df8dcf497171f73e726d3', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1997, sourceColumn: 2, sourceEndLine: 1997};
MERGE (n:KG {id: 'rom:defender/banked/defend.10'}) SET n:Rom SET n += {file: 'defend.10', offset: 10240, size: 2048, crc: 'a543b167', sha1: '9292b94b0d74e57e03aada4852ad1997c34122ff', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1998, sourceColumn: 2, sourceEndLine: 1998};
MERGE (n:KG {id: 'rom:defender/banked/defend.6'}) SET n:Rom SET n += {file: 'defend.6', offset: 24576, size: 2048, crc: '65f4efd1', sha1: 'a960fd1559ed74b81deba434391e49fc6ec389ca', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1999, sourceColumn: 2, sourceEndLine: 1999};
MERGE (n:KG {id: 'region:defender/soundcpu'}) SET n:RomRegion SET n += {tag: 'soundcpu', size: 65536, flags: '0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2001, sourceColumn: 2, sourceEndLine: 2001};
MERGE (n:KG {id: 'rom:defender/soundcpu/video_sound_rom_1.ic12'}) SET n:Rom SET n += {file: 'video_sound_rom_1.ic12', offset: 63488, size: 2048, crc: 'fefd5b48', sha1: 'ceb0d18483f0691978c604db94417e6941ad7ff2', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2002, sourceColumn: 2, sourceEndLine: 2002};
MERGE (n:KG {id: 'region:defender/proms'}) SET n:RomRegion SET n += {tag: 'proms', size: 1024, flags: '0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2004, sourceColumn: 2, sourceEndLine: 2004};
MERGE (n:KG {id: 'rom:defender/proms/decoder.2'}) SET n:Rom SET n += {file: 'decoder.2', offset: 0, size: 512, crc: '8dd98da5', sha1: 'da979604f7a2aa8b5a6d4a5debd2e80f77569e35', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2005, sourceColumn: 2, sourceEndLine: 2005};
MERGE (n:KG {id: 'rom:defender/proms/decoder.3'}) SET n:Rom SET n += {file: 'decoder.3', offset: 512, size: 512, crc: 'c3f45f70', sha1: 'd19036cbc46b130548873597b44b8b70758f25c4', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2006, sourceColumn: 2, sourceEndLine: 2006};
MERGE (n:KG {id: 'map:defender_state.defender_main_map'}) SET n:AddressMap SET n += {cls: 'defender_state', name: 'defender_main_map', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 494, sourceColumn: 1, sourceEndLine: 507};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range0'}) SET n:AddressRange SET n += {start: 0, end: 49151, raw: 'map(0x0000, 0xbfff).ram().share(m_videoram)', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 496, sourceColumn: 2, sourceEndLine: 496, ram: true, share: 'videoram'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range1'}) SET n:AddressRange SET n += {start: 49152, end: 53247, raw: 'map(0xc000, 0xcfff).view(m_rom_view)', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 497, sourceColumn: 2, sourceEndLine: 497};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range2'}) SET n:AddressRange SET n += {start: 49152, end: 49167, raw: 'm_rom_view[0](0xc000, 0xc00f).mirror(0x03e0).writeonly().share(m_paletteram)', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 498, sourceColumn: 2, sourceEndLine: 498, mirror: 992, writeonly: true, share: 'paletteram', viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range3'}) SET n:AddressRange SET n += {start: 50175, end: 50175, raw: 'm_rom_view[0](0xc3ff, 0xc3ff).w(FUNC(defender_state::watchdog_reset_w))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 499, sourceColumn: 2, sourceEndLine: 499, viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'handler:defender_state.watchdog_reset_w'}) SET n:Handler SET n += {method: 'watchdog_reset_w', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_m.cpp', sourceLine: 247, sourceColumn: 1, sourceEndLine: 252, sourceParameters: 'u8 data', sourceBody: '// yes, the data bits are checked for this specific value
	if (data == 0x39)
		m_watchdog->watchdog_reset();'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range4'}) SET n:AddressRange SET n += {start: 49168, end: 49183, raw: 'm_rom_view[0](0xc010, 0xc01f).mirror(0x03e0).w(FUNC(defender_state::video_control_w))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 500, sourceColumn: 2, sourceEndLine: 500, mirror: 992, viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'handler:defender_state.video_control_w'}) SET n:Handler SET n += {method: 'video_control_w', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_m.cpp', sourceLine: 335, sourceColumn: 1, sourceEndLine: 338, sourceParameters: 'u8 data', sourceBody: 'm_cocktail = BIT(data, 0);'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range5'}) SET n:AddressRange SET n += {start: 50176, end: 50431, raw: 'm_rom_view[0](0xc400, 0xc4ff).mirror(0x0300).ram().w(FUNC(defender_state::cmos_4bit_w)).share("nvram")', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 501, sourceColumn: 2, sourceEndLine: 501, mirror: 768, ram: true, share: 'nvram', viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'handler:defender_state.cmos_4bit_w'}) SET n:Handler SET n += {method: 'cmos_4bit_w', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_m.cpp', sourceLine: 233, sourceColumn: 1, sourceEndLine: 237, sourceParameters: 'offs_t offset, u8 data', sourceBody: '// only 4 bits are valid
	m_nvram[offset] = data | 0xf0;'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range6'}) SET n:AddressRange SET n += {start: 51200, end: 52223, raw: 'm_rom_view[0](0xc800, 0xcbff).r(FUNC(defender_state::video_counter_r))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 502, sourceColumn: 2, sourceEndLine: 502, viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'handler:defender_state.video_counter_r'}) SET n:Handler SET n += {method: 'video_counter_r', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_v.cpp', sourceLine: 485, sourceColumn: 1, sourceEndLine: 491, sourceParameters: '', sourceBody: 'if (m_screen->vpos() < 0x100)
		return m_screen->vpos() & 0xfc;
	else
		return 0xfc;'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range7'}) SET n:AddressRange SET n += {start: 52224, end: 52227, raw: 'm_rom_view[0](0xcc00, 0xcc03).mirror(0x03e0).rw(m_pia[1], FUNC(pia6821_device::read), FUNC(pia6821_device::write))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 503, sourceColumn: 2, sourceEndLine: 503, mirror: 992, viewTag: 'm_rom_view', viewEntry: 0};
...
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range8'}) SET n:AddressRange SET n += {start: 52228, end: 52231, raw: 'm_rom_view[0](0xcc04, 0xcc07).mirror(0x03e0).rw(m_pia[0], FUNC(pia6821_device::read), FUNC(pia6821_device::write))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 504, sourceColumn: 2, sourceEndLine: 504, mirror: 992, viewTag: 'm_rom_view', viewEntry: 0};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range9'}) SET n:AddressRange SET n += {start: 53248, end: 57343, raw: 'map(0xd000, 0xdfff).w(FUNC(defender_state::bank_select_w))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 505, sourceColumn: 2, sourceEndLine: 505};
MERGE (n:KG {id: 'handler:defender_state.bank_select_w'}) SET n:Handler SET n += {method: 'bank_select_w', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_m.cpp', sourceLine: 341, sourceColumn: 1, sourceEndLine: 344, sourceParameters: 'u8 data', sourceBody: 'm_rom_view.select(data & 0x0f);'};
MERGE (n:KG {id: 'map:defender_state.defender_main_map/range10'}) SET n:AddressRange SET n += {start: 53248, end: 65535, raw: 'map(0xd000, 0xffff).rom().region("maincpu", 0)', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 506, sourceColumn: 2, sourceEndLine: 506, rom: true, region: 'maincpu', regionOffset: 0};
...
MERGE (n:KG {id: 'map:defender_state.defender_sound_map'}) SET n:AddressMap SET n += {cls: 'defender_state', name: 'defender_sound_map', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 676, sourceColumn: 1, sourceEndLine: 681};
MERGE (n:KG {id: 'map:defender_state.defender_sound_map/range0'}) SET n:AddressRange SET n += {start: 0, end: 127, raw: 'map(0x0000, 0x007f).ram()', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 678, sourceColumn: 2, sourceEndLine: 678, ram: true};
MERGE (n:KG {id: 'map:defender_state.defender_sound_map/range1'}) SET n:AddressRange SET n += {start: 1024, end: 1027, raw: 'map(0x0400, 0x0403).mirror(0x8000).rw(m_pia[2], FUNC(pia6821_device::read), FUNC(pia6821_device::write))', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 679, sourceColumn: 2, sourceEndLine: 679, mirror: 32768};
MERGE (n:KG {id: 'map:defender_state.defender_sound_map/range2'}) SET n:AddressRange SET n += {start: 45056, end: 65535, raw: 'map(0xb000, 0xffff).rom()', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 680, sourceColumn: 2, sourceEndLine: 680, rom: true};
...
MERGE (n:KG {id: 'handler:defender_state.machine_reset'}) SET n:Handler SET n += {method: 'machine_reset', ownerClass: 'defender_state', sourceFile: 'src/mame/williams/williams_m.cpp', sourceLine: 327, sourceColumn: 1, sourceEndLine: 332, sourceParameters: '', sourceBody: 'williams_state::machine_reset();
...
MERGE (n:KG {id: 'device:williams_state.williams_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_video_attributes(VIDEO_UPDATE_SCANLINE | VIDEO_ALWAYS_UPDATE)', 'm_screen->set_raw(MASTER_CLOCK*2/3, 512, 6, 298, 260, 7, 247)', 'm_screen->set_screen_update(FUNC(williams_state::screen_update))', 'm_screen->set_visarea(12, 304-1, 7, 247-1)'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1554, sourceColumn: 2, sourceEndLine: 1554, configCalls: ['set_raw(8000000,512,6,298,260,7,247)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [8000000, 512, 6, 298, 260, 7, 247], screenRawExpr: ['MASTER_CLOCK*2/3', '512', '6', '298', '260', '7', '247'], screenVideoAttributes: ['VIDEO_UPDATE_SCANLINE', 'VIDEO_ALWAYS_UPDATE']};
...
MERGE (n:KG {id: 'machine:defender_state.defender'}) SET n:MachineConfig SET n += {cls: 'defender_state', name: 'defender', calls: ['williams_base'], stateMembers: ['{"name":"m_cocktail","bits":8}'], resetHandlers: ['williams_state.machine_reset', 'defender_state.machine_reset'], startHandlers: ['williams_state.video_start'], devicePatches: ['{"tag":"screen","config":["m_screen->set_visarea(12, 304-1, 7, 247-1)"]}'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1594, sourceColumn: 1, sourceEndLine: 1602};
MERGE (n:KG {id: 'inputs:defender'}) SET n:InputPorts SET n += {name: 'defender', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 762, sourceColumn: 8, sourceEndLine: 762};
MERGE (n:KG {id: 'inputs:defender/IN0'}) SET n:Port SET n += {tag: 'IN0', modify: false};
MERGE (n:KG {id: 'inputs:defender/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_NAME("Fire")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_BUTTON2', modifiers: ['PORT_NAME("Thrust")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_BUTTON3', modifiers: ['PORT_NAME("Smart Bomb")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_BUTTON4', modifiers: ['PORT_NAME("Hyperspace")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_BUTTON5', modifiers: ['PORT_NAME(DEF_STR( Reverse ))'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_2WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:defender/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_2WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 254, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:defender/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE1', modifiers: ['PORT_NAME("Auto Up / Manual Down")', 'PORT_TOGGLE'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_SERVICE', modifiers: ['PORT_NAME("Advance")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_COIN3', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_MEMORY_RESET', modifiers: ['PORT_NAME("High Score Reset")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_TILT', defaultValue: 0};
MERGE (n:KG {id: 'inputs:defender/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
...
MATCH (a:KG {id: 'game:defender'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3968, sourceColumn: 1, sourceEndLine: 3968};
MATCH (a:KG {id: 'game:defender'}), (b:KG {id: 'machine:defender_state.defender'}) MERGE (a)-[r:USES_MACHINE]->(b);
MATCH (a:KG {id: 'game:defender'}), (b:KG {id: 'inputs:defender'}) MERGE (a)-[r:USES_INPUTS]->(b);
MATCH (a:KG {id: 'game:defender'}), (b:KG {id: 'romset:defender'}) MERGE (a)-[r:USES_ROMSET]->(b);
...
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1594, sourceColumn: 1, sourceEndLine: 1602};
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'handler:williams_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'handler:defender_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'handler:williams_state.video_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'machine:williams_state.williams_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'map:defender_state.defender_main_map'}) MERGE (a)-[r:PATCHES_MAP]->(b) SET r += {space: 'AS_PROGRAM', deviceTag: 'maincpu'};
MATCH (a:KG {id: 'machine:defender_state.defender'}), (b:KG {id: 'map:defender_state.defender_sound_map'}) MERGE (a)-[r:PATCHES_MAP]->(b) SET r += {space: 'AS_PROGRAM', deviceTag: 'soundcpu'};
MATCH (a:KG {id: 'inputs:defender'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 762, sourceColumn: 8, sourceEndLine: 762};
MATCH (a:KG {id: 'inputs:defender'}), (b:KG {id: 'inputs:defender/IN0'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:defender'}), (b:KG {id: 'inputs:defender/IN1'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:defender'}), (b:KG {id: 'inputs:defender/IN2'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'romset:defender'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1985, sourceColumn: 1, sourceEndLine: 1985};
MATCH (a:KG {id: 'romset:defender'}), (b:KG {id: 'region:defender/maincpu'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:defender'}), (b:KG {id: 'region:defender/banked'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:defender'}), (b:KG {id: 'region:defender/soundcpu'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:defender'}), (b:KG {id: 'region:defender/proms'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'handler:defender_state.machine_reset'}), (b:KG {id: 'handler:williams_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:defender_state.machine_reset'}), (b:KG {id: 'handler:defender_state.bank_select_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 494, sourceColumn: 1, sourceEndLine: 507};
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range0'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range1'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range2'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range3'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range4'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range5'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range6'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range7'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range8'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range9'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map'}), (b:KG {id: 'map:defender_state.defender_main_map/range10'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_sound_map'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 676, sourceColumn: 1, sourceEndLine: 681};
MATCH (a:KG {id: 'map:defender_state.defender_sound_map'}), (b:KG {id: 'map:defender_state.defender_sound_map/range0'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_sound_map'}), (b:KG {id: 'map:defender_state.defender_sound_map/range1'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_sound_map'}), (b:KG {id: 'map:defender_state.defender_sound_map/range2'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f2'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f3'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f4'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f5'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f6'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN0'}), (b:KG {id: 'inputs:defender/IN0/f7'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN1'}), (b:KG {id: 'inputs:defender/IN1/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN1'}), (b:KG {id: 'inputs:defender/IN1/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f2'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f3'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f4'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f5'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f6'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:defender/IN2'}), (b:KG {id: 'inputs:defender/IN2/f7'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'region:defender/maincpu'}), (b:KG {id: 'rom:defender/maincpu/defend.1'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/maincpu'}), (b:KG {id: 'rom:defender/maincpu/defend.4'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/maincpu'}), (b:KG {id: 'rom:defender/maincpu/defend.2'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/maincpu'}), (b:KG {id: 'rom:defender/maincpu/defend.3'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.9'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.12'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.8'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.11'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.7'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.10'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/banked'}), (b:KG {id: 'rom:defender/banked/defend.6'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/soundcpu'}), (b:KG {id: 'rom:defender/soundcpu/video_sound_rom_1.ic12'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/proms'}), (b:KG {id: 'rom:defender/proms/decoder.2'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:defender/proms'}), (b:KG {id: 'rom:defender/proms/decoder.3'}) MERGE (a)-[r:LOADS]->(b);
...
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range3'}), (b:KG {id: 'handler:defender_state.watchdog_reset_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range4'}), (b:KG {id: 'handler:defender_state.video_control_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range5'}), (b:KG {id: 'handler:defender_state.cmos_4bit_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range6'}), (b:KG {id: 'handler:defender_state.video_counter_r'}) MERGE (a)-[r:READS]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range7'}), (b:KG {id: 'handler:pia6821_device.read'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'pia_1'};
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range7'}), (b:KG {id: 'handler:pia6821_device.write'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'pia_1'};
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range8'}), (b:KG {id: 'handler:pia6821_device.read'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'pia_0'};
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range8'}), (b:KG {id: 'handler:pia6821_device.write'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'pia_0'};
MATCH (a:KG {id: 'map:defender_state.defender_main_map/range9'}), (b:KG {id: 'handler:defender_state.bank_select_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:defender_state.defender_sound_map/range1'}), (b:KG {id: 'handler:pia6821_device.read'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'pia_2'};
MATCH (a:KG {id: 'map:defender_state.defender_sound_map/range1'}), (b:KG {id: 'handler:pia6821_device.write'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'pia_2'};
