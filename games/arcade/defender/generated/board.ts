...
defined.compiledHandlers = {
  ...
  function method_bank_select_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_rom_view.select"] ? __l["m_rom_view.select"](((data) & (15))) : (members.m_rom_view) != null ? ((runtime.dereference(members.m_rom_view)).select?.(((data) & (15))) ?? 0) : (__l["select"]?.(((data) & (15))) ?? 0));
  }
