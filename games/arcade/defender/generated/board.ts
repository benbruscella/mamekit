...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_watchdog_reset_w(runtime: any, data: any) {
  ...
  function method_cmos_4bit_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_nvram"), offset, ((data) | (240)));
  }

  function method_video_counter_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_bank_select_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any) {
    ...
    for (let x: any = 0; ((Number(x) < Number(16)) ? 1 : 0); x = ((x) + (1))) {
    ...
    for (let y: any = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
      ...
      for (let x: any = ((cliprect.min_x) & ((~1))); ((Number(x) <= Number(cliprect.max_x)) ? 1 : 0); x = ((x) + (2))) {
  ...
  function method_vram_select_w(runtime: any, data: any) {
    const members = runtime.members;
    if ((((data) >>> (0)) & 1)) {
