...
// generated 2026-08-22T05:52:09.735Z
...
MERGE (n:KG {id: 'machine:bublbobl_state.bublbobl_nomcu'}) SET n:MachineConfig SET n += {cls: 'bublbobl_state', name: 'bublbobl_nomcu', calls: [], sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 944, sourceColumn: 1, sourceEndLine: 989};
...
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_TILT'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_SERVICE1'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_CUSTOM'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_CUSTOM'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_CUSTOM'};
MERGE (n:KG {id: 'inputs:bublbobl/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_CUSTOM'};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0'}) SET n:Port SET n += {tag: 'DSW0', modify: false};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 5, name: 'Mode', defaultValue: 4, location: 'DSW-A:1,3', settings: ['4=Game, English', '5=Game, Japanese', '1=Test (Grid and Inputs)', '0=Test (RAM and Sound)/Pause']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, name: 'Flip Screen', defaultValue: 2, location: 'DSW-A:2', settings: ['2=Off', '0=On']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Demo Sounds', defaultValue: 8, location: 'DSW-A:4', settings: ['0=Off', '8=On']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 48, name: 'Coin A', defaultValue: 48, location: 'DSW-A:5,6', settings: ['16=2C 1C', '48=1C 1C', '0=2C 3C', '32=1C 2C']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW0/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 192, name: 'Coin B', defaultValue: 192, location: 'DSW-A:7,8', settings: ['64=2C 1C', '192=1C 1C', '0=2C 3C', '128=1C 2C']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Difficulty', defaultValue: 3, location: 'DSW-B:1,2', settings: ['2=Easy', '3=Normal', '1=Hard', '0=Very Hard']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, name: 'Bonus Life', defaultValue: 12, location: 'DSW-B:3,4', settings: ['8=20K 80K 300K', '12=30K 100K 400K', '4=40K 200K 500K', '0=50K 250K 500K']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, name: 'Lives', defaultValue: 48, location: 'DSW-B:5,6', settings: ['16=1', '0=2', '48=3', '32=5']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Unknown', defaultValue: 64, location: 'DSW-B:7', settings: ['64=Off', '0=On']};
MERGE (n:KG {id: 'inputs:bublbobl/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'ROM Type', defaultValue: 128, location: 'DSW-B:8', settings: ['128=IC52=512kb, IC53=none', '0=IC52=256kb, IC53=256kb']};
MERGE (n:KG {id: 'inputs:bublbobl/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:bublbobl/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:bublbobl/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:bublbobl/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
...
MATCH (a:KG {id: 'machine:bublbobl_state.bublbobl'}), (b:KG {id: 'machine:bublbobl_state.bublbobl_nomcu'}) MERGE (a)-[r:CALLS]->(b);
