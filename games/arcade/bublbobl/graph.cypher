...
// generated 2026-09-24T02:26:20.939Z
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 6000000, config: ['Z80(config, m_maincpu, MAIN_XTAL/4)', 'm_maincpu->set_addrmap(AS_PROGRAM, &bublbobl_state::bublbobl_maincpu_map)', 'm_maincpu->set_irq_acknowledge_callback(FUNC(bublbobl_state::mcram_vect_r))'], member: 'm_maincpu', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 947, sourceColumn: 2, sourceEndLine: 947};
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/subcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'subcpu', clock: 6000000, config: ['Z80(config, m_subcpu, MAIN_XTAL/4)', 'm_subcpu->set_addrmap(AS_PROGRAM, &bublbobl_state::subcpu_map)', 'm_subcpu->set_vblank_int("screen", FUNC(bublbobl_state::irq0_line_hold))'], member: 'm_subcpu', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 950, sourceColumn: 2, sourceEndLine: 950};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3000000, config: ['Z80(config, m_audiocpu, MAIN_XTAL/8)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &bublbobl_state::sound_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 954, sourceColumn: 2, sourceEndLine: 954};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MAIN_XTAL/4, 384, 0, 256, 264, 16, 240)', 'm_screen->set_screen_update(FUNC(bublbobl_state::screen_update_bublbobl))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set_inputline(m_mcu, M6801_IRQ1_LINE)'], member: 'm_screen', configCalls: ['set_raw(6000000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['MAIN_XTAL/4', '384', '0', '256', '264', '16', '240']};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_bublbobl)'], member: 'm_gfxdecode', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 970, sourceColumn: 2, sourceEndLine: 970, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::RGBx_444, 256).set_endianness(ENDIANNESS_BIG)'], member: 'm_palette', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 971, sourceColumn: 2, sourceEndLine: 971};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/soundnmi'}) SET n:Device SET n += {type: 'INPUT_MERGER_ALL_HIGH', tag: 'soundnmi', clock: null, config: ['INPUT_MERGER_ALL_HIGH(config, m_soundnmi).output_handler().set_inputline(m_audiocpu, INPUT_LINE_NMI)'], member: 'm_soundnmi', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 977, sourceColumn: 2, sourceEndLine: 977};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/sound_to_main'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'sound_to_main', clock: null, config: ['GENERIC_LATCH_8(config, m_sound_to_main)'], member: 'm_sound_to_main', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 980, sourceColumn: 2, sourceEndLine: 980};
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl_nomcu/ym2203'}) SET n:Device SET n += {type: 'YM2203', tag: 'ym2203', clock: 3000000, config: ['YM2203(config, m_ym2203, MAIN_XTAL/8)', 'm_ym2203->irq_handler().set("soundirq", FUNC(input_merger_device::in_w<0>))', 'm_ym2203->add_route(ALL_OUTPUTS, "mono", 0.25)'], member: 'm_ym2203', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 982, sourceColumn: 2, sourceEndLine: 982};
...
MERGE (n:KG {id: 'device:bublbobl_state.bublbobl/mcu'}) SET n:Device SET n += {type: 'M6801U4', tag: 'mcu', clock: 4000000, config: ['auto &mcu(M6801U4(config, "mcu", XTAL(4\'000\'000)))', 'mcu.in_p1_cb().set_ioport("IN0")', 'mcu.out_p1_cb().set(FUNC(bublbobl_state::bublbobl_mcu_port1_w))', 'mcu.out_p2_cb().set(FUNC(bublbobl_state::bublbobl_mcu_port2_w))', 'mcu.out_p3_cb().set(FUNC(bublbobl_state::bublbobl_mcu_port3_w))', 'mcu.in_p3_cb().set(FUNC(bublbobl_state::bublbobl_mcu_port3_r))', 'mcu.out_p4_cb().set(FUNC(bublbobl_state::bublbobl_mcu_port4_w))'], member: 'm_mcu', sourceFile: 'src/mame/taito/bublbobl.cpp', sourceLine: 996, sourceColumn: 2, sourceEndLine: 996};
