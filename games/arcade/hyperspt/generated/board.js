...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.add(runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (128))) << (1))), ((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (64))) << (3)))) | 0);
                let color = ((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (15))) | 0);
                let flags = ((((((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (16))) ? (1) : (0))) | (((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (32))) ? (2) : (0))))) | 0);
            ...
            function method_screen_update(runtime, screen, bitmap, cliprect) {
                ...
                for (let row = ((0) | 0); ((Number(row) < Number(32)) ? 1 : 0); row = ((((row) + (1))) | 0)) {
                    let scrollx = ((runtime.add(runtime.readIndex(h_m_scroll, ((row) * (2))), ((((runtime.readIndex(h_m_scroll, runtime.add(((row) * (2)), 1))) & (1))) * (256)))) | 0);
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (let offs = (((((members.m_spriteram).length) - (4))) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
                    ...
                    let sy = ((((240) - (runtime.readIndex(h_m_spriteram, ((offs) + (1)))))) | 0);
                    let code = ((runtime.add(runtime.readIndex(h_m_spriteram, ((offs) + (2))), ((8) * (((runtime.readIndex(h_m_spriteram, offs)) & (32)))))) | 0);
                    let color = ((((runtime.readIndex(h_m_spriteram, offs)) & (15))) | 0);
                    let flipx = (((((~runtime.readIndex(h_m_spriteram, offs))) & (64))) | 0);
                    let flipy = ((((runtime.readIndex(h_m_spriteram, offs)) & (128))) | 0);
                    if ((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) {
                        sy = ((((240) - (sy))) | 0);
                        flipy = ((((flipy) ? 0 : 1)) | 0);
                    }
    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_konami_sn76489a_latch_w(runtime, data) {
                const members = runtime.members;
                members.m_sn76489a_latch = ((data) & 0xff);
            }
            function method_konami_sn76489a_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
