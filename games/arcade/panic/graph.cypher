...
// generated 2026-08-22T05:52:37.049Z
...
#endif'};
MERGE (n:KG {id: 'machine:cosmic_state.cosmic'}) SET n:MachineConfig SET n += {cls: 'cosmic_state', name: 'cosmic', calls: [], resetHandlers: ['cosmic_state.machine_reset'], sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 808, sourceColumn: 1, sourceEndLine: 817};
...
MERGE (n:KG {id: 'device:cosmic_state.cosmic/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(10.816_MHz_XTAL/2, 44*8, 0*8, 32*8, 32*8+6, 4*8, 28*8)', 'm_screen->set_palette(m_palette)', 'm_screen->set_screen_update(FUNC(cosmic_state::screen_update_panic))'], sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 814, sourceColumn: 2, sourceEndLine: 814, configCalls: ['set_raw(5408000,352,0,256,262,32,224)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5408000, 352, 0, 256, 262, 32, 224]};
MERGE (n:KG {id: 'machine:cosmic_state.panic'}) SET n:MachineConfig SET n += {cls: 'cosmic_state', name: 'panic', calls: ['cosmic'], resetHandlers: ['cosmic_state.machine_reset'], devicePatches: ['{"tag":"screen","config":["m_screen->set_screen_update(FUNC(cosmic_state::screen_update_panic))"]}'], sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 831, sourceColumn: 1, sourceEndLine: 854};
...
MERGE (n:KG {id: 'inputs:panic/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:panic/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:panic/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:panic/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:panic/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:panic/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/P1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:panic/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:panic/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/P2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:panic/DSW'}) SET n:Port SET n += {tag: 'DSW', modify: false};
MERGE (n:KG {id: 'inputs:panic/DSW/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, name: 'Coin A', defaultValue: 0, location: 'SW:6,5,4', settings: ['0=1C 1C', '5=2C 3C', '1=1C 2C', '2=1C 3C', '3=1C 4C', '4=1C 5C']};
MERGE (n:KG {id: 'inputs:panic/DSW/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Cabinet', defaultValue: 0, location: 'SW:3', settings: ['0=Upright', '8=Cocktail']};
MERGE (n:KG {id: 'inputs:panic/DSW/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Bonus Life', defaultValue: 0, location: 'SW:2', settings: ['0=3000', '16=5000']};
MERGE (n:KG {id: 'inputs:panic/DSW/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Lives', defaultValue: 0, location: 'SW:1', settings: ['0=3', '32=4']};
MERGE (n:KG {id: 'inputs:panic/DSW/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 192, name: 'Coin B', defaultValue: 64, location: 'SW:7,8', settings: ['0=2C 1C', '64=1C 1C', '128=1C 2C', '192=1C 3C']};
MERGE (n:KG {id: 'inputs:panic/SYSTEM'}) SET n:Port SET n += {tag: 'SYSTEM', modify: false};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_WRITE_LINE_DEVICE_MEMBER(DEVICE_SELF, FUNC(cosmic_state::panic_coin_inserted))']};
MERGE (n:KG {id: 'inputs:panic/SYSTEM/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN2', modifiers: ['PORT_WRITE_LINE_DEVICE_MEMBER(DEVICE_SELF, FUNC(cosmic_state::panic_coin_inserted))']};
...
MATCH (a:KG {id: 'machine:cosmic_state.panic'}), (b:KG {id: 'machine:cosmic_state.cosmic'}) MERGE (a)-[r:CALLS]->(b);
