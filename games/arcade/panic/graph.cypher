...
// generated 2026-09-24T02:29:07.639Z
...
MERGE (n:KG {id: 'device:cosmic_state.cosmic/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 1802666.6666666667, config: ['Z80(config, m_maincpu, 10.816_MHz_XTAL/6)'], member: 'm_maincpu', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 811, sourceColumn: 2, sourceEndLine: 811};
MERGE (n:KG {id: 'device:cosmic_state.cosmic/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(10.816_MHz_XTAL/2, 44*8, 0*8, 32*8, 32*8+6, 4*8, 28*8)', 'm_screen->set_palette(m_palette)', 'm_screen->set_screen_update(FUNC(cosmic_state::screen_update_panic))'], member: 'm_screen', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 814, sourceColumn: 2, sourceEndLine: 814, configCalls: ['set_raw(5408000,352,0,256,262,32,224)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5408000, 352, 0, 256, 262, 32, 224], screenRawExpr: ['10.816_MHz_XTAL/2', '44*8', '0*8', '32*8', '32*8+6', '4*8', '28*8']};
...
MERGE (n:KG {id: 'device:cosmic_state.panic/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_panic)'], member: 'm_gfxdecode', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 840, sourceColumn: 2, sourceEndLine: 840, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:cosmic_state.panic/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(cosmic_state::panic_palette), 16 + 8*4, 16)'], member: 'm_palette', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 841, sourceColumn: 2, sourceEndLine: 841, clockExpr: 'FUNC(cosmic_state::panic_palette)', paletteEntries: 16};
...
MERGE (n:KG {id: 'device:cosmic_state.panic/samples'}) SET n:Device SET n += {type: 'SAMPLES', tag: 'samples', clock: null, config: ['SAMPLES(config, m_samples)', 'm_samples->set_channels(9)', 'm_samples->set_samples_names(panic_sample_names)', 'm_samples->add_route(ALL_OUTPUTS, "speaker", 0.25)'], member: 'm_samples', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 848, sourceColumn: 2, sourceEndLine: 848, configCalls: ['set_channels(9)']};
...
MERGE (n:KG {id: 'device:cosmic_state.panic/dac'}) SET n:Device SET n += {type: 'DAC_1BIT', tag: 'dac', clock: 0, config: ['DAC_1BIT(config, m_dac, 0).add_route(ALL_OUTPUTS, "speaker", 0.5)'], member: 'm_dac', sourceFile: 'src/mame/universal/cosmic.cpp', sourceLine: 853, sourceColumn: 2, sourceEndLine: 853};
