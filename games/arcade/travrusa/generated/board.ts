...
defined.compiledHandlers = {
  ...
  function method_scroll_x_low_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_set_scroll(runtime: any) {
    const members = runtime.members;
    for (let i: any = 0; ((Number(i) <= Number(2)) ? 1 : 0); i = ((i) + (1))) {
  ...
  function method_scroll_x_high_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    ...
    let flags: any = (runtime.calls["TILE_FLIPXY"] ? runtime.calls["TILE_FLIPXY"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPXY", ((((attr) & (48))) >>> (4))));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = (((members.m_spriteram).length) - (4)); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((offs) - (4))) {
      let sx: any = ((((runtime.add(runtime.readIndex(h_m_spriteram, ((offs) + (3))), 8)) & (255))) - (8));
      let sy: any = ((240) - (runtime.readIndex(h_m_spriteram, offs)));
      let code: any = runtime.readIndex(h_m_spriteram, ((offs) + (2)));
      let attr: any = runtime.readIndex(h_m_spriteram, ((offs) + (1)));
      let flipx: any = ((attr) & (64));
      let flipy: any = ((attr) & (128));
      if ((runtime.calls["flip_screen"] ? runtime.calls["flip_screen"]() : runtime.macro("flip_screen"))) {
        sx = ((240) - (sx));
        sy = ((240) - (sy));
        flipx = ((flipx) ? 0 : 1);
