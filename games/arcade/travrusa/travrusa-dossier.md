...
- **Credited by MAMEDEV:** Lee Taylor (driver header); hap (4 release notes); ClawGrip (1 release note); David Haywood (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 127 commits by 25 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
