...
// generated 2026-08-22T05:52:47.904Z
...
MERGE (n:KG {id: 'machine:travrusa_state.travrusa'}) SET n:MachineConfig SET n += {cls: 'travrusa_state', name: 'travrusa', calls: [], startHandlers: ['travrusa_state.video_start'], sourceFile: 'src/mame/irem/travrusa.cpp', sourceLine: 701, sourceColumn: 1, sourceEndLine: 722};
...
MERGE (n:KG {id: 'device:travrusa_state.travrusa/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(18.432_MHz_XTAL / 3, 384, 8, 248, 282, 0, 256)', 'screen.set_screen_update(FUNC(travrusa_state::screen_update))', 'screen.set_palette(m_palette)', 'screen.screen_vblank().set_inputline(m_maincpu, INPUT_LINE_IRQ0)'], sourceFile: 'src/mame/irem/travrusa.cpp', sourceLine: 708, sourceColumn: 2, sourceEndLine: 708, configCalls: ['set_raw(6144000,384,8,248,282,0,256)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 8, 248, 282, 0, 256]};
...
MERGE (n:KG {id: 'device:travrusa_state.travrusa/irem_audio'}) SET n:Device SET n += {type: 'IREM_M52_SOUNDC_AUDIO', tag: 'irem_audio', clock: 0, config: ['IREM_M52_SOUNDC_AUDIO(config, "irem_audio")'], sourceFile: 'src/mame/irem/travrusa.cpp', sourceLine: 721, sourceColumn: 2, sourceEndLine: 721};
...
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_COIN3', modifiers: ['PORT_IMPULSE(19)']};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/SYSTEM/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P1'}) SET n:Port SET n += {tag: 'P1', modify: false};
MERGE (n:KG {id: 'inputs:travrusa/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:travrusa/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:travrusa/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:travrusa/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:travrusa/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:travrusa/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:travrusa/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:travrusa/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:travrusa/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:travrusa/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:travrusa/P2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:travrusa/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:travrusa/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Fuel Reduced on Collision', defaultValue: 3, location: 'DSW1:1,2', settings: ['3=8/120 Dots', '2=10/120 Dots', '1=12/120 Dots', '0=14/120 Dots']};
MERGE (n:KG {id: 'inputs:travrusa/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Fuel Consumption', defaultValue: 4, location: 'DSW1:3', settings: ['4=Low', '0=High']};
MERGE (n:KG {id: 'inputs:travrusa/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Allow Continue', defaultValue: 0, location: 'DSW1:4', settings: ['8=No', '0=Yes']};
MERGE (n:KG {id: 'inputs:travrusa/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 240, name: 'Coinage', defaultValue: 240, location: 'DSW1:5,6,7,8', settings: ['128=Not Used [if "DSW2", 0x04, EQUALS, 0x04]', '144=Not Used [if "DSW2", 0x04, EQUALS, 0x04]', '160=6C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '176=5C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '192=4C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '208=3C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '224=2C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '240=1C 1C [if "DSW2", 0x04, EQUALS, 0x04]', '112=1C 2C [if "DSW2", 0x04, EQUALS, 0x04]', '96=1C 3C [if "DSW2", 0x04, EQUALS, 0x04]', '80=1C 4C [if "DSW2", 0x04, EQUALS, 0x04]', '64=1C 5C [if "DSW2", 0x04, EQUALS, 0x04]', '48=1C 6C [if "DSW2", 0x04, EQUALS, 0x04]', '32=1C 7C [if "DSW2", 0x04, EQUALS, 0x04]', '16=Not Used [if "DSW2", 0x04, EQUALS, 0x04]', '0=Free Play [if "DSW2", 0x04, EQUALS, 0x04]', '128=Free Play [if "DSW2", 0x04, EQUALS, 0x00]', '144=A 3C_1C / B 1C_3C [if "DSW2", 0x04, EQUALS, 0x00]', '160=A 2C_1C / B 1C_3C [if "DSW2", 0x04, EQUALS, 0x00]', '176=A 1C_1C / B 1C_3C [if "DSW2", 0x04, EQUALS, 0x00]', '192=Free Play [if "DSW2", 0x04, EQUALS, 0x00]', '208=A 3C_1C / B 1C_2C [if "DSW2", 0x04, EQUALS, 0x00]', '224=A 2C_1C / B 1C_2C [if "DSW2", 0x04, EQUALS, 0x00]', '240=A 1C_1C / B 1C_2C [if "DSW2", 0x04, EQUALS, 0x00]', '112=A 1C_1C / B 1C_5C [if "DSW2", 0x04, EQUALS, 0x00]', '96=A 2C_1C / B 1C_5C [if "DSW2", 0x04, EQUALS, 0x00]', '80=A 3C_1C / B 1C_5C [if "DSW2", 0x04, EQUALS, 0x00]', '64=Free Play [if "DSW2", 0x04, EQUALS, 0x00]', '48=A 1C_1C / B 1C_6C [if "DSW2", 0x04, EQUALS, 0x00]', '32=A 2C_1C / B 1C_6C [if "DSW2", 0x04, EQUALS, 0x00]', '16=A 3C_1C / B 1C_6C [if "DSW2", 0x04, EQUALS, 0x00]', '0=Free Play [if "DSW2", 0x04, EQUALS, 0x00]']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, name: 'Flip Screen', defaultValue: 1, location: 'DSW2:1', settings: ['1=Off', '0=On']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, name: 'Cabinet', defaultValue: 0, location: 'DSW2:2', settings: ['0=Upright', '2=Cocktail']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Coin Mode', defaultValue: 4, location: 'DSW2:3', settings: ['4=Mode 1', '0=Mode 2']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Speed Type', defaultValue: 8, location: 'DSW2:4', settings: ['8=mph', '0=km/h']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Stop Mode (Cheat)', defaultValue: 16, location: 'DSW2:5', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Title', defaultValue: 32, location: 'DSW2:6', settings: ['32=Traverse USA', '0=Zippy Race']};
MERGE (n:KG {id: 'inputs:travrusa/DSW2/f6'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Invulnerability (Cheat)', defaultValue: 64, location: 'DSW2:7', settings: ['64=Off', '0=On']};
...
MATCH (a:KG {id: 'machine:m52_soundc_audio_device.device_add_mconfig'}), (b:KG {id: 'file:src/mame/irem/travrusa.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b);
