...
defined.compiledHandlers = {
  ...
  function method_blitter_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    ...
    if (((Number(offset) === Number(3)) ? 1 : 0)) {
      ...
      for (let i: any = 0; ((Number(i) < Number(16)) ? 1 : 0); i = ((i) + (1))) {
        for (let j: any = 0; ((Number(j) < Number(16)) ? 1 : 0); j = ((j) + (1))) {
          let data: any = ((0) & 0xff);
          if ((((src) >>> (0)) & 1)) {
  ...
  function method_i8039_irqen_and_status_w(runtime: any, data: any) {
    const members = runtime.members;
    if (((((~data)) >>> (7)) & 1)) {
  ...
  function method__30hz_irq(runtime: any, state: any) {
    const members = runtime.members;
    if (state) {
