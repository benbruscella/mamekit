...
defined.compiledHandlers = {
  ...
  function method_blitter_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    ...
    if (((Number(offset) === Number(3)) ? 1 : 0)) {
      let src: any = ((((((runtime.readIndex((members.m_blitterdata ?? runtime.member("m_blitterdata")), 2)) << (8))) | (runtime.readIndex((members.m_blitterdata ?? runtime.member("m_blitterdata")), 3)))) & (65532));
      let dest: any = ((((runtime.readIndex((members.m_blitterdata ?? runtime.member("m_blitterdata")), 0)) << (8))) | (runtime.readIndex((members.m_blitterdata ?? runtime.member("m_blitterdata")), 1)));
      let copy: any = (((((runtime.readIndex((members.m_blitterdata ?? runtime.member("m_blitterdata")), 3)) >>> (0)) & 1)) ? 1 : 0);
      for (let i: any = ((0) | 0); ((Number(i) < Number(16)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
        for (let j: any = ((0) | 0); ((Number(j) < Number(16)) ? 1 : 0); j = ((((j) + (1))) | 0)) {
          let data: any = ((0) & 0xff);
          if ((((src) >>> (0)) & 1)) {
            data = ((((runtime.readIndex(h_m_blitrom, runtime.shiftRight(src, 1))) & (15))) & 0xff);
          } else {
            data = ((runtime.shiftRight(runtime.readIndex(h_m_blitrom, runtime.shiftRight(src, 1)), 4)) & 0xff);
          }
          src = ((src) + (1));
          if (data) {
            if (((copy) ? 0 : 1)) {
            ...
            if ((((dest) >>> (0)) & 1)) {
              runtime.writeIndex(runtime.writableMember("m_videoram"), runtime.shiftRight(dest, 1), ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), runtime.shiftRight(dest, 1))) & (15))) | (((data) << (4)))));
            } else {
              runtime.writeIndex(runtime.writableMember("m_videoram"), runtime.shiftRight(dest, 1), ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), runtime.shiftRight(dest, 1))) & (240))) | (data)));
            }
          }
          dest = ((dest) + (1));
        }
  ...
  function method_i8039_irq_w(runtime: any, data: any): any {
    ...
    (__l["m_i8039.set_input_line"] ? __l["m_i8039.set_input_line"](0, 1) : (members.m_i8039) != null ? ((runtime.dereference(members.m_i8039)).set_input_line?.(0, 1) ?? 0) : 0);
  }

  function method_i8039_irqen_and_status_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    if (((((~data)) >>> (7)) & 1)) {
      (__l["m_i8039.set_input_line"] ? __l["m_i8039.set_input_line"](0, 0) : (members.m_i8039) != null ? ((runtime.dereference(members.m_i8039)).set_input_line?.(0, 0) ?? 0) : 0);
    }
    members.m_i8039_status = ((runtime.shiftRight(((data) & (112)), 4)) & 0xff);
  }
  ...
  function method__30hz_irq(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
...
defined.compiledHandlerLinks = ["bitmap.fill","fill","m_audiocpu.set_input_line","m_audiocpu.total_cycles","m_i8039.set_input_line","m_mainbank.set_entry","m_maincpu.set_input_line","rgb_t::black","set_entry"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
