...
// generated 2026-09-24T02:28:12.805Z
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(1, tutankhm_state::raw_to_rgb_func, 16)'], member: 'm_palette', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 415, sourceColumn: 2, sourceEndLine: 415, paletteEntries: 16};
...
MERGE (n:KG {id: 'handler:junofrst_state.portB_w'}) SET n:Handler SET n += {method: 'portB_w', ownerClass: 'junofrst_state', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 222, sourceColumn: 1, sourceEndLine: 236, sourceConstants: ['LOWPASS_3R=0', 'filter_rc_device::LOWPASS_3R=0'], sourceParameters: 'uint8_t data', sourceBody: 'for (int i = 0; i < 3; i++)
	{
		int C = 0;
