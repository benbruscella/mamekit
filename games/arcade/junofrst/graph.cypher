...
// generated 2026-07-30T09:34:03.379Z
...
MERGE (n:KG {id: 'machine:junofrst_state.junofrst'}) SET n:MachineConfig SET n += {cls: 'junofrst_state', name: 'junofrst', calls: [], sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 387, sourceColumn: 1, sourceEndLine: 438};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mcu/callback1'}) SET n:Callback SET n += {signal: 'p2_out_cb', operation: 'set', raw: 'm_i8039->p2_out_cb().set(FUNC(junofrst_state::i8039_irqen_and_status_w))', ownerTag: 'mcu', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 400, sourceColumn: 2, sourceEndLine: 400, targetClass: 'junofrst_state', targetMethod: 'i8039_irqen_and_status_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback0'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<0>().set(FUNC(junofrst_state::irq_enable_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 403, sourceColumn: 2, sourceEndLine: 403, slot: '0', targetClass: 'junofrst_state', targetMethod: 'irq_enable_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback1'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<1>().set(FUNC(junofrst_state::coin_counter_2_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 404, sourceColumn: 2, sourceEndLine: 404, slot: '1', targetClass: 'junofrst_state', targetMethod: 'coin_counter_2_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback2'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<2>().set(FUNC(junofrst_state::coin_counter_1_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 405, sourceColumn: 2, sourceEndLine: 405, slot: '2', targetClass: 'junofrst_state', targetMethod: 'coin_counter_1_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback3'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set_nop', raw: 'mainlatch.q_out_cb<3>().set_nop()', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 406, sourceColumn: 2, sourceEndLine: 406, slot: '3'};
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback4'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<4>().set(FUNC(junofrst_state::flip_screen_x_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 407, sourceColumn: 2, sourceEndLine: 407, slot: '4', targetClass: 'junofrst_state', targetMethod: 'flip_screen_x_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback5'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<5>().set(FUNC(junofrst_state::flip_screen_y_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 408, sourceColumn: 2, sourceEndLine: 408, slot: '5', targetClass: 'junofrst_state', targetMethod: 'flip_screen_y_w'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/screen/callback0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'm_screen->set_screen_update(FUNC(junofrst_state::screen_update_scramble))', ownerTag: 'screen', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 417, sourceColumn: 2, sourceEndLine: 417, targetClass: 'junofrst_state', targetMethod: 'screen_update_scramble'};
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/aysnd/callback1'}) SET n:Callback SET n += {signal: 'port_b_write_callback', operation: 'set', raw: 'aysnd.port_b_write_callback().set(FUNC(junofrst_state::portB_w))', ownerTag: 'aysnd', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 428, sourceColumn: 2, sourceEndLine: 428, targetClass: 'junofrst_state', targetMethod: 'portB_w'};
MERGE (n:KG {id: 'handler:junofrst_state.portB_w'}) SET n:Handler SET n += {method: 'portB_w', ownerClass: 'junofrst_state', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 222, sourceColumn: 1, sourceEndLine: 236, sourceParameters: 'uint8_t data', sourceBody: 'for (int i = 0; i < 3; i++)
	{
		int C = 0;
...
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mcu'}), (b:KG {id: 'device:junofrst_state.junofrst/mcu/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mcu'}), (b:KG {id: 'device:junofrst_state.junofrst/mcu/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch'}), (b:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/screen'}), (b:KG {id: 'device:junofrst_state.junofrst/screen/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/screen'}), (b:KG {id: 'device:junofrst_state.junofrst/screen/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:junofrst_state.junofrst/aysnd'}), (b:KG {id: 'device:junofrst_state.junofrst/aysnd/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/aysnd'}), (b:KG {id: 'device:junofrst_state.junofrst/aysnd/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mcu/callback0'}), (b:KG {id: 'handler:dac_byte_interface.data_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mcu/callback1'}), (b:KG {id: 'handler:junofrst_state.i8039_irqen_and_status_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback0'}), (b:KG {id: 'handler:junofrst_state.irq_enable_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback1'}), (b:KG {id: 'handler:junofrst_state.coin_counter_2_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback2'}), (b:KG {id: 'handler:junofrst_state.coin_counter_1_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback4'}), (b:KG {id: 'handler:junofrst_state.flip_screen_x_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/mainlatch/callback5'}), (b:KG {id: 'handler:junofrst_state.flip_screen_y_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/screen/callback0'}), (b:KG {id: 'handler:junofrst_state.screen_update_scramble'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/screen/callback1'}), (b:KG {id: 'handler:junofrst_state._30hz_irq'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/aysnd/callback0'}), (b:KG {id: 'handler:junofrst_state.portA_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:junofrst_state.junofrst/aysnd/callback1'}), (b:KG {id: 'handler:junofrst_state.portB_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
