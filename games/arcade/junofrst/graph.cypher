...
// generated 2026-09-17T07:12:04.033Z
...
MERGE (n:KG {id: 'device:junofrst_state.junofrst/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(1, tutankhm_state::raw_to_rgb_func, 16)'], member: 'm_palette', sourceFile: 'src/mame/konami/junofrst.cpp', sourceLine: 415, sourceColumn: 2, sourceEndLine: 415};
