...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_wardner_sprite_r(runtime, offset) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let spriteram16 = runtime.packedView((__l["m_spriteram8.live"] ? __l["m_spriteram8.live"]() : (members.m_spriteram8) != null ? (typeof (runtime.dereference(members.m_spriteram8)).live === 'function' ? (runtime.dereference(members.m_spriteram8)).live() : typeof (runtime.dereference(members.m_spriteram8)).live === 'number' || typeof (runtime.dereference(members.m_spriteram8)).live === 'boolean' ? (runtime.dereference(members.m_spriteram8)).live : runtime.container(members.m_spriteram8, "live")) : 0), false);
                let shift = (((((((offset) >>> (0)) & 1)) * (8))) | 0);
                return runtime.shiftRight(runtime.readIndex(spriteram16, runtime.divide(offset, 2)), shift);
            }
            function method_wardner_txlayer_w(runtime, offset, data) {
                const members = runtime.members;
                let shift = (((((((offset) >>> (0)) & 1)) << (3))) | 0);
            ...
            function method_twincobr_txoffs_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                runtime.combineData(({ generatedPointer: true, target: ({ generatedLValue: true, get: () => (members.m_txoffs ?? runtime.member("m_txoffs")), set: (value) => { members.m_txoffs = ((value) | 0); } }), offset: 0 }), data, mem_mask);
                members.m_txoffs = ((((members.m_txoffs) % ((members.m_txvideoram_size ?? runtime.member("m_txvideoram_size"))))) | 0);
            }
            function method_wardner_bglayer_w(runtime, offset, data) {
                const members = runtime.members;
                let shift = (((((((offset) >>> (0)) & 1)) << (3))) | 0);
            ...
            function method_twincobr_bgoffs_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                runtime.combineData(({ generatedPointer: true, target: ({ generatedLValue: true, get: () => (members.m_bgoffs ?? runtime.member("m_bgoffs")), set: (value) => { members.m_bgoffs = ((value) | 0); } }), offset: 0 }), data, mem_mask);
                members.m_bgoffs = ((((members.m_bgoffs) % (runtime.shiftRight((members.m_bgvideoram_size ?? runtime.member("m_bgvideoram_size")), 1)))) | 0);
            }
            function method_wardner_fglayer_w(runtime, offset, data) {
                const members = runtime.members;
                let shift = (((((((offset) >>> (0)) & 1)) << (3))) | 0);
            ...
            function method_twincobr_fgoffs_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                runtime.combineData(({ generatedPointer: true, target: ({ generatedLValue: true, get: () => (members.m_fgoffs ?? runtime.member("m_fgoffs")), set: (value) => { members.m_fgoffs = ((value) | 0); } }), offset: 0 }), data, mem_mask);
                members.m_fgoffs = ((((members.m_fgoffs) % ((members.m_fgvideoram_size ?? runtime.member("m_fgvideoram_size"))))) | 0);
            }
            function method_wardner_exscroll_w(runtime, offset, data) {
                const members = runtime.members;
                switch (offset) {
                    case 1:
                    case 0:
            ...
            function method_wardner_videoram_r(runtime, offset) {
                const members = runtime.members;
                let shift = (((((((offset) >>> (0)) & 1)) << (3))) | 0);
                switch (runtime.divide(offset, 2)) {
                    case 0:
                        {
                            return runtime.shiftRight((runtime.overrides["twincobr_txram_r"] ? runtime.overrides["twincobr_txram_r"]() : method_twincobr_txram_r(runtime)), shift);
                        }
                    case 1:
                        {
                            return runtime.shiftRight((runtime.overrides["twincobr_bgram_r"] ? runtime.overrides["twincobr_bgram_r"]() : method_twincobr_bgram_r(runtime)), shift);
                        }
                    case 2:
                        {
                            return runtime.shiftRight((runtime.overrides["twincobr_fgram_r"] ? runtime.overrides["twincobr_fgram_r"]() : method_twincobr_fgram_r(runtime)), shift);
                        }
                }
                return 0;
            }
            function method_twincobr_txram_r(runtime) {
                const members = runtime.members;
                return runtime.readIndex((members.m_txvideoram16 ?? runtime.member("m_txvideoram16")), (members.m_txoffs ?? runtime.member("m_txoffs")));
            }
            function method_twincobr_bgram_r(runtime) {
                const members = runtime.members;
            ...
            function method_twincobr_txram_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_twincobr_bgram_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_twincobr_fgram_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_wardner_bank_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_dsp_host_addr_cb(runtime, data, seg, addr) {
                const members = runtime.members;
            ...
            function method_bg_ram_bank_w(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_fg_rom_bank_w(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_display_on_w(runtime, state) {
                const members = runtime.members;
                members.m_display_on = ((state) ? 1 : 0);
            }
            function method_log_vram(runtime) {
                const members = runtime.members;
            }
            function method_wardner_vblank_irq(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.readIndex((members.m_bgvideoram16 ?? runtime.member("m_bgvideoram16")), ((tile_index) + ((members.m_bg_ram_bank ?? runtime.member("m_bg_ram_bank")))))) & 0xffff);
                let tile_number = ((((code) & (4095))) >>> 0);
                let color = ((runtime.shiftRight(((code) & (61440)), 12)) >>> 0);
            ...
            function method_get_fg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.readIndex((members.m_fgvideoram16 ?? runtime.member("m_fgvideoram16")), tile_index)) & 0xffff);
                let tile_number = ((((((code) & (4095))) | ((members.m_fg_rom_bank ?? runtime.member("m_fg_rom_bank"))))) >>> 0);
                let color = ((runtime.shiftRight(((code) & (61440)), 12)) >>> 0);
            ...
            function method_get_tx_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.readIndex((members.m_txvideoram16 ?? runtime.member("m_txvideoram16")), tile_index)) & 0xffff);
                let tile_number = ((((code) & (2047))) >>> 0);
                let color = ((runtime.shiftRight(((code) & (63488)), 11)) >>> 0);
