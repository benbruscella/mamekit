...
// generated 2026-09-17T07:12:49.961Z
...
MERGE (n:KG {id: 'device:wardner_state.wardner/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::xBGR_555, 0x1000 / 2)'], member: 'm_palette', sourceFile: 'src/mame/toaplan/wardner.cpp', sourceLine: 495, sourceColumn: 2, sourceEndLine: 495};
