...
// generated 2026-08-22T05:52:49.989Z
...
MERGE (n:KG {id: 'machine:zaxxon_state.root'}) SET n:MachineConfig SET n += {cls: 'zaxxon_state', name: 'root', calls: [], startHandlers: ['zaxxon_state.video_start'], sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 945, sourceColumn: 1, sourceEndLine: 982};
...
MERGE (n:KG {id: 'machine:zaxxon_state.zaxxon'}) SET n:MachineConfig SET n += {cls: 'zaxxon_state', name: 'zaxxon', calls: ['root', 'zaxxon_samples'], startHandlers: ['zaxxon_state.video_start'], sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 985, sourceColumn: 1, sourceEndLine: 992};
...
MERGE (n:KG {id: 'machine:zaxxon_state.zaxxon_samples'}) SET n:MachineConfig SET n += {cls: 'zaxxon_state', name: 'zaxxon_samples', calls: [], startHandlers: ['zaxxon_state.video_start'], sourceFile: 'src/mame/sega/zaxxon_a.cpp', sourceLine: 95, sourceColumn: 1, sourceEndLine: 101};
...
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:zaxxon/SW00/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 224, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:zaxxon/SW01'}) SET n:Port SET n += {tag: 'SW01', modify: false};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:zaxxon/SW01/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 224, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:zaxxon/SW100'}) SET n:Port SET n += {tag: 'SW100', modify: false};
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 3, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(zaxxon_state::zaxxon_coin_r<0>))']};
...
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(zaxxon_state::zaxxon_coin_r<1>))']};
...
MERGE (n:KG {id: 'inputs:zaxxon/SW100/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(zaxxon_state::zaxxon_coin_r<2>))']};
...
MERGE (n:KG {id: 'inputs:zaxxon/COIN/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_COIN1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(zaxxon_state::zaxxon_coin_inserted), 0)']};
MERGE (n:KG {id: 'inputs:zaxxon/COIN/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_COIN2', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(zaxxon_state::zaxxon_coin_inserted), 1)']};
MERGE (n:KG {id: 'inputs:zaxxon/COIN/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_SERVICE1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(zaxxon_state::zaxxon_coin_inserted), 2)']};
...
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Bonus Life', defaultValue: 3, location: 'SW1:!1,!2', settings: ['3=10000', '1=20000', '2=30000', '0=40000']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused', defaultValue: 4, location: 'SW1:!3', settings: ['0=Off', '4=On']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Unused', defaultValue: 8, location: 'SW1:!4', settings: ['0=Off', '8=On']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 48, name: 'Lives', defaultValue: 48, location: 'SW1:!5,!6', settings: ['48=3', '16=4', '32=5', '0=Free Play']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Sound', defaultValue: 64, location: 'SW1:!7', settings: ['0=Off', '64=On']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW02/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Cabinet', defaultValue: 0, location: 'SW1:!8', settings: ['0=Upright', '128=Cocktail']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW03'}) SET n:Port SET n += {tag: 'DSW03', modify: false};
MERGE (n:KG {id: 'inputs:zaxxon/DSW03/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, name: 'DEF_STR ( Coin_B )', defaultValue: 3, location: 'SW2:!1,!2,!3,!4', settings: ['15=DEF_STR ( 4C_1C )', '7=DEF_STR ( 3C_1C )', '11=DEF_STR ( 2C_1C )', '6=2C/1C 5C/3C 6C/4C', '10=2C/1C 3C/2C 4C/3C', '3=DEF_STR ( 1C_1C )', '2=1C/1C 5C/6C', '12=1C/1C 4C/5C', '4=1C/1C 2C/3C', '13=DEF_STR ( 1C_2C )', '8=1C/2C 5C/11C', '0=1C/2C 4C/9C', '5=DEF_STR ( 1C_3C )', '9=DEF_STR ( 1C_4C )', '1=DEF_STR ( 1C_5C )', '14=DEF_STR ( 1C_6C )']};
MERGE (n:KG {id: 'inputs:zaxxon/DSW03/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 240, name: 'DEF_STR ( Coin_A )', defaultValue: 48, location: 'SW2:!5,!6,!7,!8', settings: ['240=DEF_STR ( 4C_1C )', '112=DEF_STR ( 3C_1C )', '176=DEF_STR ( 2C_1C )', '96=2C/1C 5C/3C 6C/4C', '160=2C/1C 3C/2C 4C/3C', '48=DEF_STR ( 1C_1C )', '32=1C/1C 5C/6C', '192=1C/1C 4C/5C', '64=1C/1C 2C/3C', '208=DEF_STR ( 1C_2C )', '128=1C/2C 5C/11C', '0=1C/2C 4C/9C', '80=DEF_STR ( 1C_3C )', '144=DEF_STR ( 1C_4C )', '16=DEF_STR ( 1C_5C )', '224=DEF_STR ( 1C_6C )']};
...
MATCH (a:KG {id: 'machine:zaxxon_state.zaxxon'}), (b:KG {id: 'machine:zaxxon_state.root'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'machine:zaxxon_state.zaxxon'}), (b:KG {id: 'machine:zaxxon_state.zaxxon_samples'}) MERGE (a)-[r:CALLS]->(b);
