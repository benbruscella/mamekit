...
// generated 2026-09-24T02:31:12.590Z
...
MERGE (n:KG {id: 'device:zaxxon_state.root/ppi8255'}) SET n:Device SET n += {type: 'I8255A', tag: 'ppi8255', clock: null, config: ['I8255A(config, m_ppi)', 'm_ppi->out_pa_callback().set(FUNC(zaxxon_state::zaxxon_sound_a_w))', 'm_ppi->out_pb_callback().set(FUNC(zaxxon_state::zaxxon_sound_b_w))', 'm_ppi->out_pc_callback().set(FUNC(zaxxon_state::zaxxon_sound_c_w))', 'm_ppi->tri_pa_callback().set_constant(0)', 'm_ppi->tri_pb_callback().set_constant(0)', 'm_ppi->tri_pc_callback().set_constant(0)'], member: 'm_ppi', sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 951, sourceColumn: 2, sourceEndLine: 951};
...
MERGE (n:KG {id: 'device:zaxxon_state.root/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(zaxxon_state::zaxxon_palette), 256)'], member: 'm_palette', sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 975, sourceColumn: 2, sourceEndLine: 975, clockExpr: 'FUNC(zaxxon_state::zaxxon_palette)', paletteEntries: 256};
MERGE (n:KG {id: 'device:zaxxon_state.root/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(PIXEL_CLOCK, HTOTAL, HBEND, HBSTART, VTOTAL, VBEND, VBSTART)', 'screen.set_screen_update(FUNC(zaxxon_state::screen_update_zaxxon))', 'screen.set_palette(m_palette)', 'screen.screen_vblank().set(FUNC(zaxxon_state::vblank_int))'], sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 977, sourceColumn: 2, sourceEndLine: 977, configCalls: ['set_raw(6082500,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6082500, 384, 0, 256, 264, 16, 240], screenRawExpr: ['PIXEL_CLOCK', 'HTOTAL', 'HBEND', 'HBSTART', 'VTOTAL', 'VBEND', 'VBSTART']};
