...
// generated 2026-09-11T11:45:13.093Z
...
MERGE (n:KG {id: 'device:zaxxon_state.root/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(zaxxon_state::zaxxon_palette), 256)'], member: 'm_palette', sourceFile: 'src/mame/sega/zaxxon.cpp', sourceLine: 975, sourceColumn: 2, sourceEndLine: 975, clockExpr: 'FUNC(zaxxon_state::zaxxon_palette)'};
