    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_zaxxon_get_fg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let sx = ((tile_index) % (32));
                let sy = runtime.divide(tile_index, 32);
                let code = runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index);
                let color = ((runtime.readIndex((members.m_color_codes ?? runtime.member("m_color_codes")), ((sx) + (((32) * (runtime.divide(sy, 4))))))) & (15));
