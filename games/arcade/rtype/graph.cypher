...
// generated 2026-09-17T07:12:24.794Z
...
MERGE (n:KG {id: 'device:m72_state.m72_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(512)'], member: 'm_palette', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1703, sourceColumn: 2, sourceEndLine: 1703};
MERGE (n:KG {id: 'device:m72_state.m72_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/4, 512, 64, 448, 284, 0, 256)', 'm_screen->set_screen_update(FUNC(m72_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1705, sourceColumn: 2, sourceEndLine: 1705, configCalls: ['set_raw(8000000,512,64,448,284,0,256)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [8000000, 512, 64, 448, 284, 0, 256], screenRawExpr: ['MASTER_CLOCK/4', '512', '64', '448', '284', '0', '256']};
