...
// generated 2026-09-24T02:29:53.616Z
...
MERGE (n:KG {id: 'machine:m72_state.m72_audio_chips'}) SET n:MachineConfig SET n += {cls: 'm72_state', name: 'm72_audio_chips', calls: [], stateMembers: ['{"name":"m_raster_irq_position","bits":32,"signed":true}', '{"name":"m_scrollx","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_scrolly","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_video_off","bits":1,"initial":0}', '{"name":"m_fg_source","bits":32,"signed":true}', '{"name":"m_bg_source","bits":32,"signed":true}'], driverTimers: ['m_scanline_timer=m72_state.scanline_interrupt'], resetHandlers: ['m72_state.machine_reset'], devicePatches: ['{"tag":"soundcpu","config":["m_soundcpu->set_irq_acknowledge_callback(\\"soundirq\\", FUNC(rst_neg_buffer_device::inta_cb))"]}'], sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1660, sourceColumn: 1, sourceEndLine: 1682};
...
MERGE (n:KG {id: 'machine:m72_state.m72_base'}) SET n:MachineConfig SET n += {cls: 'm72_state', name: 'm72_base', calls: ['m72_audio_chips'], stateMembers: ['{"name":"m_raster_irq_position","bits":32,"signed":true}', '{"name":"m_scrollx","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_scrolly","bits":32,"signed":true,"arrayLength":2}', '{"name":"m_video_off","bits":1,"initial":0}', '{"name":"m_fg_source","bits":32,"signed":true}', '{"name":"m_bg_source","bits":32,"signed":true}'], driverTimers: ['m_scanline_timer=m72_state.scanline_interrupt'], resetHandlers: ['m72_state.machine_reset'], startHandlers: ['m72_state.video_start_m72'], sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1684, sourceColumn: 1, sourceEndLine: 1713};
...
MERGE (n:KG {id: 'device:m72_state.m72_base/soundcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'soundcpu', clock: 3579545, config: ['Z80(config, m_soundcpu, SOUND_CLOCK)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &m72_state::sound_ram_map)', 'm_soundcpu->set_addrmap(AS_IO, &m72_state::sound_portmap)', 'm_soundcpu->set_irq_acknowledge_callback("soundirq", FUNC(rst_neg_buffer_device::inta_cb))'], member: 'm_soundcpu', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1692, sourceColumn: 2, sourceEndLine: 1692};
MERGE (n:KG {id: 'device:m72_state.m72_base/upd71059c'}) SET n:Device SET n += {type: 'PIC8259', tag: 'upd71059c', clock: null, config: ['PIC8259(config, m_upd71059c)', 'm_upd71059c->out_int_callback().set_inputline(m_maincpu, 0)'], member: 'm_upd71059c', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1696, sourceColumn: 2, sourceEndLine: 1696};
...
MERGE (n:KG {id: 'device:m72_state.m72_base/spriteram'}) SET n:Device SET n += {type: 'BUFFERED_SPRITERAM16', tag: 'spriteram', clock: null, config: ['BUFFERED_SPRITERAM16(config, m_spriteram)'], member: 'm_spriteram', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1700, sourceColumn: 2, sourceEndLine: 1700};
MERGE (n:KG {id: 'device:m72_state.m72_base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_m72)'], member: 'm_gfxdecode', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1702, sourceColumn: 2, sourceEndLine: 1702, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:m72_state.m72_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(512)'], member: 'm_palette', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1703, sourceColumn: 2, sourceEndLine: 1703, paletteEntries: 512};
MERGE (n:KG {id: 'device:m72_state.m72_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/4, 512, 64, 448, 284, 0, 256)', 'm_screen->set_screen_update(FUNC(m72_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/irem/m72.cpp', sourceLine: 1705, sourceColumn: 2, sourceEndLine: 1705, configCalls: ['set_raw(8000000,512,64,448,284,0,256)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [8000000, 512, 64, 448, 284, 0, 256], screenRawExpr: ['MASTER_CLOCK/4', '512', '64', '448', '284', '0', '256']};
...
MERGE (n:KG {id: 'handler:m72_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'm72_state', sourceFile: 'src/mame/irem/m72_v.cpp', sourceLine: 472, sourceColumn: 1, sourceEndLine: 508, sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'if (m_video_off)
	...
	return 0;'};
MERGE (n:KG {id: 'handler:m72_state.draw_sprites'}) SET n:Handler SET n += {method: 'draw_sprites', ownerClass: 'm72_state', sourceFile: 'src/mame/irem/m72_v.cpp', sourceLine: 370, sourceColumn: 1, sourceEndLine: 425, sourceConstants: ['w=1'], sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'u16 *spriteram = m_spriteram->buffer();
