    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_draw_sprites(runtime, screen, bitmap, cliprect) {
                ...
                let spritelist = [];
                for (let i = 0, w = 0; ((Number(i) < Number((members.m_spriteram).length)) ? 1 : 0); i = ((i) + (((w) * (4))))) {
                ...
                for (let i = (((spritelist).length) - (1)); ((Number(i) >= Number(0)) ? 1 : 0); i = ((i) - (1))) {
                    let offs = runtime.readIndex(spritelist, i);
                    let code = runtime.readIndex(spriteram, ((offs) + (1)));
                    let color = ((((runtime.readIndex(spriteram, ((offs) + (2)))) & (15))) >>> 0);
                    let sx = runtime.add((-256), ((runtime.readIndex(spriteram, ((offs) + (3)))) & (1023)));
                    let sy = ((384) - (((runtime.readIndex(spriteram, ((offs) + (0)))) & (511))));
                    let flipx = ((runtime.readIndex(spriteram, ((offs) + (2)))) & (2048));
                    let flipy = ((runtime.readIndex(spriteram, ((offs) + (2)))) & (1024));
                    let w = ((1) << (((((runtime.readIndex(spriteram, ((offs) + (2)))) & (49152))) >>> (14))));
                    let h = ((1) << (((((runtime.readIndex(spriteram, ((offs) + (2)))) & (12288))) >>> (12))));
                    sy = ((sy) - (((16) * (h))));
