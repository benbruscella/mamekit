...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Stefan Lindberg (machine); cam900 (3 release notes); hap (3 release notes); AJR (1 release note); Angelo Salese (1 release note); Brian Troha (1 release note); David Haywood (1 release note); Mamesick (1 release note); Robbbert (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 358 commits by 38 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
