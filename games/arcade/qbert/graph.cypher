...
// generated 2026-09-24T02:29:59.334Z
...
MERGE (n:KG {id: 'handler:gottlieb_sound_p4_device.write'}) SET n:Handler SET n += {method: 'write', ownerClass: 'gottlieb_sound_p4_device', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 768, sourceColumn: 1, sourceEndLine: 771, sourceParameters: 'u8 data', sourceBody: 'machine().scheduler().synchronize(timer_expired_delegate(FUNC(gottlieb_sound_p4_device::write_sync), this), data);'};
MERGE (n:KG {id: 'handler:gottlieb_sound_p4_device.write_sync'}) SET n:Handler SET n += {method: 'write_sync', ownerClass: 'gottlieb_sound_p4_device', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 745, sourceColumn: 1, sourceEndLine: 766, sourceParameters: 's32 param', sourceBody: '// when data is not 0xff, the transparent latch at A3 allows it to pass through unmolested
	if (param != 0xff)
	{
...
MERGE (n:KG {id: 'device:gottlieb_state.qbert_knocker/knocker_sam'}) SET n:Device SET n += {type: 'SAMPLES', tag: 'knocker_sam', clock: null, config: ['SAMPLES(config, m_knocker_sample)', 'm_knocker_sample->set_channels(1)', 'm_knocker_sample->set_samples_names(qbert_knocker_names)', 'm_knocker_sample->add_route(ALL_OUTPUTS, "knocker", 1.0)'], member: 'm_knocker_sample', configCalls: ['set_channels(1)']};
...
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb_core/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(XTAL(20\'000\'000) / 4, GOTTLIEB_VIDEO_HCOUNT, 0, GOTTLIEB_VIDEO_HBLANK, GOTTLIEB_VIDEO_VCOUNT, 0, GOTTLIEB_VIDEO_VBLANK)', 'm_screen->set_screen_update(FUNC(gottlieb_state::screen_update))', 'm_screen->screen_vblank().set_inputline(m_maincpu, INPUT_LINE_NMI)'], member: 'm_screen', sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2166, sourceColumn: 2, sourceEndLine: 2166, configCalls: ['set_raw(5000000,318,0,256,256,0,240)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5000000, 318, 0, 256, 256, 0, 240], screenRawExpr: ['XTAL(20\'000\'000) / 4', 'GOTTLIEB_VIDEO_HCOUNT', '0', 'GOTTLIEB_VIDEO_HBLANK', 'GOTTLIEB_VIDEO_VCOUNT', '0', 'GOTTLIEB_VIDEO_VBLANK']};
...
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb_core/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfxdecode)'], member: 'm_gfxdecode', sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2171, sourceColumn: 2, sourceEndLine: 2171, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb_core/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(16)'], member: 'm_palette', sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2172, sourceColumn: 2, sourceEndLine: 2172, paletteEntries: 16};
...
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb1_votrax/r1sound'}) SET n:Device SET n += {type: 'GOTTLIEB_SOUND_SPEECH_REV1A', tag: 'r1sound', clock: null, config: ['GOTTLIEB_SOUND_SPEECH_REV1A(config, m_r1_sound).add_route(ALL_OUTPUTS, "speaker", 1.0)'], member: 'm_r1_sound', cls: 'gottlieb_sound_speech_r1a_device', clsHierarchy: ['gottlieb_sound_speech_r1a_device', 'gottlieb_sound_speech_r1_device', 'gottlieb_sound_r1_device'], sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2193, sourceColumn: 2, sourceEndLine: 2193, startHandler: 'gottlieb_sound_speech_r1_device.device_start'};
...
MERGE (n:KG {id: 'device:gottlieb_sound_r1_device.device_add_mconfig/dac'}) SET n:Device SET n += {type: 'MC1408', tag: 'dac', clock: 0, config: ['MC1408(config, m_dac, 0).add_route(ALL_OUTPUTS, *this, 0.25)'], member: 'm_dac', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 360, sourceColumn: 2, sourceEndLine: 360};
MERGE (n:KG {id: 'audioroute:device:gottlieb_sound_r1_device.device_add_mconfig/dac/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: '^', gain: 0.25, raw: 'MC1408(config, m_dac, 0).add_route(ALL_OUTPUTS, *this, 0.25)', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 360, sourceColumn: 2, sourceEndLine: 360};
...
MERGE (n:KG {id: 'device:gottlieb_sound_speech_r1_device.device_add_mconfig/votrax'}) SET n:Device SET n += {type: 'VOTRAX_SC01', tag: 'votrax', clock: null, config: ['VOTRAX_SC01(config, m_votrax, convert_speech_clock(0))', 'm_votrax->ar_callback().set("nmi", FUNC(input_merger_device::in_w<1>))', 'm_votrax->add_route(ALL_OUTPUTS, *this, 0.80)'], member: 'm_votrax', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 471, sourceColumn: 2, sourceEndLine: 471, clockExpr: 'convert_speech_clock(0)'};
MERGE (n:KG {id: 'audioroute:device:gottlieb_sound_speech_r1_device.device_add_mconfig/votrax/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: '^', gain: 0.8, raw: 'm_votrax->add_route(ALL_OUTPUTS, *this, 0.80)', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 473, sourceColumn: 2, sourceEndLine: 473};
...
MERGE (n:KG {id: 'handler:gottlieb_sound_r1_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'gottlieb_sound_r1_device', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 368, sourceColumn: 1, sourceEndLine: 370, sourceParameters: '', sourceBody: ''};
MERGE (n:KG {id: 'handler:gottlieb_sound_speech_r1_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'gottlieb_sound_speech_r1_device', sourceFile: 'src/mame/shared/gottlieb_a.cpp', sourceLine: 481, sourceColumn: 1, sourceEndLine: 487, sourceParameters: '', sourceBody: 'gottlieb_sound_r1_device::device_start();
...
MATCH (a:KG {id: 'device:gottlieb_state.gottlieb1_votrax/r1sound'}), (b:KG {id: 'handler:gottlieb_sound_speech_r1_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:gottlieb_sound_speech_r1_device.device_start'}), (b:KG {id: 'handler:gottlieb_sound_r1_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:gottlieb_sound_speech_r1_device.device_add_mconfig/votrax'}), (b:KG {id: 'audioroute:device:gottlieb_sound_speech_r1_device.device_add_mconfig/votrax/0'}) MERGE (a)-[r:HAS_AUDIO_ROUTE]->(b);
...
MATCH (a:KG {id: 'device:gottlieb_sound_r1_device.device_add_mconfig/dac'}), (b:KG {id: 'audioroute:device:gottlieb_sound_r1_device.device_add_mconfig/dac/0'}) MERGE (a)-[r:HAS_AUDIO_ROUTE]->(b);
...
MATCH (a:KG {id: 'handler:gottlieb_state.sound_w'}), (b:KG {id: 'handler:gottlieb_sound_r1_device.write'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_r1_sound.write'};
MATCH (a:KG {id: 'handler:gottlieb_state.sound_w'}), (b:KG {id: 'handler:gottlieb_sound_p4_device.write'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_r2_sound.write'};
...
MATCH (a:KG {id: 'handler:gottlieb_sound_p4_device.write'}), (b:KG {id: 'handler:gottlieb_sound_p4_device.write_sync'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
