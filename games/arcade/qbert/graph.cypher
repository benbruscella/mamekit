...
// generated 2026-09-11T11:45:11.513Z
...
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb1_votrax/r1sound'}) SET n:Device SET n += {type: 'GOTTLIEB_SOUND_SPEECH_REV1A', tag: 'r1sound', clock: null, config: ['GOTTLIEB_SOUND_SPEECH_REV1A(config, m_r1_sound).add_route(ALL_OUTPUTS, "speaker", 1.0)'], member: 'm_r1_sound', cls: 'gottlieb_sound_speech_r1a_device', clsHierarchy: ['gottlieb_sound_speech_r1a_device', 'gottlieb_sound_speech_r1_device', 'gottlieb_sound_r1_device'], sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2193, sourceColumn: 2, sourceEndLine: 2193};
