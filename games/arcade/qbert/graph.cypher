...
// generated 2026-09-17T07:12:50.277Z
...
MERGE (n:KG {id: 'device:gottlieb_state.gottlieb_core/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(16)'], member: 'm_palette', sourceFile: 'src/mame/gottlieb/gottlieb.cpp', sourceLine: 2172, sourceColumn: 2, sourceEndLine: 2172};
