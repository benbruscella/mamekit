    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_palette_w(runtime, offset, data) {
                ...
                let val = runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), ((offset) & ((~1))));
                let g = (runtime.calls["combine_weights"] ? runtime.calls["combine_weights"](h_m_weights, (((val) >>> (4)) & 1), (((val) >>> (5)) & 1), (((val) >>> (6)) & 1), (((val) >>> (7)) & 1)) : runtime.macro("combine_weights", h_m_weights, (((val) >>> (4)) & 1), (((val) >>> (5)) & 1), (((val) >>> (6)) & 1), (((val) >>> (7)) & 1)));
                let b = (runtime.calls["combine_weights"] ? runtime.calls["combine_weights"](h_m_weights, (((val) >>> (0)) & 1), (((val) >>> (1)) & 1), (((val) >>> (2)) & 1), (((val) >>> (3)) & 1)) : runtime.macro("combine_weights", h_m_weights, (((val) >>> (0)) & 1), (((val) >>> (1)) & 1), (((val) >>> (2)) & 1), (((val) >>> (3)) & 1)));
                val = runtime.readIndex((members.m_paletteram ?? runtime.member("m_paletteram")), ((offset) | (1)));
                let r = (runtime.calls["combine_weights"] ? runtime.calls["combine_weights"](h_m_weights, (((val) >>> (0)) & 1), (((val) >>> (1)) & 1), (((val) >>> (2)) & 1), (((val) >>> (3)) & 1)) : runtime.macro("combine_weights", h_m_weights, (((val) >>> (0)) & 1), (((val) >>> (1)) & 1), (((val) >>> (2)) & 1), (((val) >>> (3)) & 1)));
                let a = ((((((members.m_transparent0 ?? runtime.member("m_transparent0"))) && (((Number(runtime.divide(offset, 2)) === Number(0)) ? 1 : 0))) ? 1 : 0)) ? (0) : (255));
