...
**Gottlieb · 1982** — transpiled from the MAME driver `src/mame/gottlieb/gottlieb.cpp` by mamekit.

![marquee](/artwork/media/marquees/qbert.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/qbert.webp) | ![cabinet](/artwork/media/cabinets/qbert.webp) |

## The machine

| CPU | Type | Clock | Mapped ranges |
| --- | --- | --- | --- |
| `maincpu` | I8088 | 5.000 MHz | 17 |
| `r1sound:audiocpu` | M6502 | 0.895 MHz | 13 |

- **Sound:** dac × 1 @ 0.895 MHz
- **Screen:** 256×240 @ 61.42 Hz · rotated 270°

### ROM chips

| Region | Chip | Offset | Size | CRC |
| --- | --- | --- | --- | --- |
| `maincpu` | `qb-rom2.bin` | 0xa000 | 0x2000 | `fe434526` |
| `maincpu` | `qb-rom1.bin` | 0xc000 | 0x2000 | `55635447` |
| `maincpu` | `qb-rom0.bin` | 0xe000 | 0x2000 | `8e318641` |
| `r1sound:audiocpu` | `qb-snd1.bin` | 0x7000 | 0x800 | `15787c07` |
| `r1sound:audiocpu` | `qb-snd2.bin` | 0x7800 | 0x800 | `58437508` |
| `bgtiles` | `qb-bg0.bin` | 0x0 | 0x1000 | `7a9ba824` |
| `bgtiles` | `qb-bg1.bin` | 0x1000 | 0x1000 | `22e5b891` |
| `sprites` | `qb-fg3.bin` | 0x0 | 0x2000 | `dd436d3a` |
| `sprites` | `qb-fg2.bin` | 0x2000 | 0x2000 | `f69b9483` |
| `sprites` | `qb-fg1.bin` | 0x4000 | 0x2000 | `224e8356` |
| `sprites` | `qb-fg0.bin` | 0x6000 | 0x2000 | `2f695b85` |
...
| 5 | coin1 | `IN1` | 0x4 |
| 6 | coin2 | `IN1` | 0x8 |
| 9 | select in service mode | `IN1` | 0x80 |
| Right | p1 right (down-right) | `IN4` | 0x1 |
| Left | p1 left (up-left) | `IN4` | 0x2 |
| Up | p1 up (up-right) | `IN4` | 0x4 |
| Down | p1 down (down-left) | `IN4` | 0x8 |

## DIP switches (factory defaults)

| Setting | Port | Mask | Default |
| --- | --- | --- | --- |
| Demo Sounds | `DSW` | 0x1 | 0x0 |
| Kicker | `DSW` | 0x2 | 0x2 |
| Cabinet | `DSW` | 0x4 | 0x0 |
| Demo Mode (Unlim Lives, Start=Adv (Cheat) | `DSW` | 0x8 | 0x0 |
| Free Play | `DSW` | 0x10 | 0x0 |
| Unused | `DSW` | 0x20 | 0x0 |
| Unused | `DSW` | 0x40 | 0x0 |
| Unused | `DSW` | 0x80 | 0x0 |
| Service Mode | `IN1` | 0x40 | 0x40 |

## The MAME driver — the people who reverse-engineered it

- **Driver source:** `src/mame/gottlieb/gottlieb.cpp`
- **Written by:** Fabrice Frances, Nicola Salmoria, Aaron Giles
- **License:** BSD-3-Clause
- **Credited by MAMEDEV:** Aaron Giles (driver header); Fabrice Frances (driver header); Nicola Salmoria (driver header); AJR (1 release note); cam900 (1 release note); dink (1 release note); Ivan Vangelista (1 release note); JimCarlTay (1 release note); Robbbert (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 274 commits by 37 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
...
### Ports
* CONSOLES:
[US] Magnavox Odyssey 2 (1983)
[EU] Philips Videopac G7000 (1982)
[US] Colecovision (1983) "Q*bert [Model 9800]"  
[JP] Sega SG-1000 (1983) "Q*bert [Model OM-G001]"  
[US] Mattel Intellivision (1983) "Q*bert [Model PB6360]" 
...
[EU] MSX (1987) "Q*bert [Model RC746]" 
[US] Nintendo NES (feb.1989) "Q*bert [Model NES-QB-USA]"  
[US] Sony PlayStation 3 [PSN] (feb.22, 2007) 
[EU] Sony PlayStation 3 [PSN] (may.18, 2007) 
...
[US] [EU] Commodore C64 (1983) "Hexpert" 
[US] Tandy Color Computer (1983) "Cuber" 
[US] Tandy Color Computer (1983) "Cubix" 
[EU] Sinclair ZX-Spectrum (1983) "Pogo" by Ocean.
[EU] Amstrad CPC (1984) "Er*Bert" by Microbyte.
[US] Texas Instruments TI-99/4A (1984) "Q*bert [Model PB1620]"  
[EU] BBC B (1984) "R*THER" by Acornsoft 
[EU] Memotech MTX512 (1985) "Qogo" 
[EU] Tandy Color Computer 3 (1987) "Pyramix"
...
* OTHERS: 
[US] VFD handheld game(1983) by Parker Brothers.
[US] Mobile Phones (june.13, 2003) 
[US] Apple iPhone/iPod (jul.28, 2009) "Q*bert Deluxe [Model 325065512]"
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/2094/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `gottlieb`. Play it at [../../../app/g/qbert/](../../../app/g/qbert/) or [explore the knowledge graph](viewer.html).*
