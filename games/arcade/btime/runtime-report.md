# btime source-generation report

Playability: **executable**

Basis: **source-complete**

MAME source coverage: **92/139 nodes (66.2%)**
...
Screen update: **btime_state.screen_update_btime** (compiled)
...
- `screen.set_screen_update -> btime_state.screen_update_btime` - src/mame/dataeast/btime.cpp:2312
