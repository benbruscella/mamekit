    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_bgvideoram_w(runtime, offset, data) {
                ...
                (__l["m_bg_tilemap.mark_tile_dirty"] ? __l["m_bg_tilemap.mark_tile_dirty"](((((offset) & (15))) | (((runtime.shiftRight(offset, 1)) & (496))))) : (members.m_bg_tilemap) != null ? ((runtime.dereference(members.m_bg_tilemap)).mark_tile_dirty?.(((((offset) & (15))) | (((runtime.shiftRight(offset, 1)) & (496))))) ?? 0) : (__l["mark_tile_dirty"]?.(((((offset) & (15))) | (((runtime.shiftRight(offset, 1)) & (496))))) ?? 0));
            }
            function method_get_fg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.readIndex((members.m_fg_videoram ?? runtime.member("m_fg_videoram")), tile_index)) | 0);
                let color = ((runtime.readIndex((members.m_fg_videoram ?? runtime.member("m_fg_videoram")), ((tile_index) + (1024)))) | 0);
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let code = ((runtime.readIndex((members.m_bg_videoram ?? runtime.member("m_bg_videoram")), tile_index)) | 0);
                let color = ((runtime.readIndex((members.m_bg_videoram ?? runtime.member("m_bg_videoram")), ((tile_index) + (16)))) | 0);
                (__l["tileinfo.set"] ? __l["tileinfo.set"](1, ((code) + (((((color) & (128))) << (1)))), runtime.add(((color) & (31)), ((32) * ((members.m_palette_bank ?? runtime.member("m_palette_bank"))))), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((color) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((color) & (96)), 5)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(1, ((code) + (((((color) & (128))) << (1)))), runtime.add(((color) & (31)), ((32) * ((members.m_palette_bank ?? runtime.member("m_palette_bank"))))), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((color) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((color) & (96)), 5)))) ?? 0) : (__l["set"]?.(1, ((code) + (((((color) & (128))) << (1)))), runtime.add(((color) & (31)), ((32) * ((members.m_palette_bank ?? runtime.member("m_palette_bank"))))), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((color) & (96)), 5)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((color) & (96)), 5)))) ?? 0));
            }
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (let y = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                    ...
                    let v = (((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? ((~((y) - (1)))) : (((y) - (1))))) & 0xff);
                    for (let h = ((496) | 0); ((Number(h) >= Number(128)) ? 1 : 0); h = ((((h) - (16))) | 0)) {
                        let objcnt4 = ((((Number((((h) >>> (8)) & 1)) !== Number(((((~h)) >>> (7)) & 1))) ? 1 : 0)) ? 1 : 0);
                        let objcnt3 = ((((Number(((((((v) >>> (7)) & 1)) && (objcnt4)) ? 1 : 0)) !== Number(((((~h)) >>> (7)) & 1))) ? 1 : 0)) ? 1 : 0);
                        let obj_idx = ((((runtime.shiftRight(h, 4)) & (7))) & 0xff);
                        ...
                        let code = ((((((((runtime.readIndex(objdata, 0)) & (127))) | ((((((runtime.readIndex(objdata, 1)) >>> (5)) & 1)) << (7))))) | ((((((runtime.readIndex(objdata, 0)) >>> (7)) & 1)) << (8))))) | 0);
                        let col = ((((runtime.readIndex(objdata, 1)) & (15))) | 0);
                        let sx = ((((runtime.readIndex(objdata, 3)) - ((((((runtime.readIndex(objdata, 1)) >>> (4)) & 1)) << (8))))) | 0);
                        let sy = ((runtime.readIndex(objdata, 2)) | 0);
                        let dir = ((1) | 0);
                        let valpha = ((((sy) & 0xff)) & 0xff);
                        let v2c = (((((((~v)) & 0xff)) + ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (255))))) & 0xff);
                        let lvbeta = ((((v2c) + (valpha))) & 0xff);
                        let vbeta = (((~lvbeta)) & 0xff);
                        let vleq = ((((Number(vbeta) <= Number((((~valpha)) & (255)))) ? 1 : 0)) ? 1 : 0);
                        let vinlen = ((1) ? 1 : 0);
                        let vlen = ((runtime.shiftRight(runtime.readIndex(objdata, 1), 6)) & 0xff);
                        switch (((vlen) & (3))) {
                            case 0:
                                {
                        ...
                        let row = ((((((Number(vlen) === Number(3)) ? 1 : 0)) ? (16) : (((1) << (vlen))))) | 0);
                        code = ((runtime.andAssign(code, (~((row) - (1))))) | 0);
                        if (((vinzone) ? 0 : 1)) {
                            for (let i = ((0) | 0); ((Number(i) < Number(row)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
