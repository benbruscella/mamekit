...
// generated 2026-09-11T11:44:06.640Z
...
MERGE (n:KG {id: 'device:_1942_state._1942/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(_1942_state::_1942_palette), 64*4+4*32*8+16*16, 256)'], member: 'm_palette', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 607, sourceColumn: 2, sourceEndLine: 607, clockExpr: 'FUNC(_1942_state::_1942_palette)'};
MERGE (n:KG {id: 'device:_1942_state._1942/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/2, 384, 0, 256, 262, 16, 240)', 'm_screen->set_screen_update(FUNC(_1942_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 609, sourceColumn: 2, sourceEndLine: 609, configCalls: ['set_raw(6000000,384,0,256,262,16,240)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 262, 16, 240], screenRawExpr: ['MASTER_CLOCK/2', '384', '0', '256', '262', '16', '240']};
