...
// generated 2026-09-24T02:25:50.016Z
...
MERGE (n:KG {id: 'machine:_1942_state._1942'}) SET n:MachineConfig SET n += {cls: '_1942_state', name: '_1942', calls: [], stateMembers: ['{"name":"m_palette_bank","bits":32,"signed":true}', '{"name":"m_scroll","bits":8,"arrayLength":2}'], resetHandlers: ['_1942_state.machine_reset'], startHandlers: ['_1942_state.video_start'], sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 593, sourceColumn: 1, sourceEndLine: 649};
...
MERGE (n:KG {id: 'device:_1942_state._1942/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3000000, config: ['Z80(config, m_maincpu, MAIN_CPU_CLOCK)', 'm_maincpu->set_addrmap(AS_PROGRAM, &_1942_state::_1942_map)'], member: 'm_maincpu', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 596, sourceColumn: 2, sourceEndLine: 596};
MERGE (n:KG {id: 'device:_1942_state._1942/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3000000, config: ['Z80(config, m_audiocpu, SOUND_CPU_CLOCK)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &_1942_state::sound_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 599, sourceColumn: 2, sourceEndLine: 599};
...
MERGE (n:KG {id: 'device:_1942_state._1942/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_1942)'], member: 'm_gfxdecode', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 605, sourceColumn: 2, sourceEndLine: 605, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:_1942_state._1942/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(_1942_state::_1942_palette), 64*4+4*32*8+16*16, 256)'], member: 'm_palette', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 607, sourceColumn: 2, sourceEndLine: 607, clockExpr: 'FUNC(_1942_state::_1942_palette)', paletteEntries: 256};
MERGE (n:KG {id: 'device:_1942_state._1942/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/2, 384, 0, 256, 262, 16, 240)', 'm_screen->set_screen_update(FUNC(_1942_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 609, sourceColumn: 2, sourceEndLine: 609, configCalls: ['set_raw(6000000,384,0,256,262,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 262, 16, 240], screenRawExpr: ['MASTER_CLOCK/2', '384', '0', '256', '262', '16', '240']};
...
MERGE (n:KG {id: 'device:_1942_state._1942/ay1'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay1', clock: 1500000, config: ['ay8910_device &ay1(AY8910(config, "ay1", AUDIO_CLOCK))', 'ay1.set_flags(AY8910_RESISTOR_OUTPUT)', 'ay1.set_resistors_load(10000.0, 10000.0, 10000.0)', 'ay1.add_route(0, "snd_nl", 1.0, 0)', 'ay1.add_route(1, "snd_nl", 1.0, 1)', 'ay1.add_route(2, "snd_nl", 1.0, 2)'], sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 620, sourceColumn: 2, sourceEndLine: 620, configCalls: ['set_flags(8)', 'set_resistors_load(10000,10000,10000)', 'add_route(0,"snd_nl",1,0)', 'add_route(1,"snd_nl",1,1)', 'add_route(2,"snd_nl",1,2)']};
...
MERGE (n:KG {id: 'device:_1942_state._1942/ay2'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay2', clock: 1500000, config: ['ay8910_device &ay2(AY8910(config, "ay2", AUDIO_CLOCK))', 'ay2.set_flags(AY8910_RESISTOR_OUTPUT)', 'ay2.set_resistors_load(10000.0, 10000.0, 10000.0)', 'ay2.add_route(0, "snd_nl", 1.0, 3)', 'ay2.add_route(1, "snd_nl", 1.0, 4)', 'ay2.add_route(2, "snd_nl", 1.0, 5)'], sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 627, sourceColumn: 2, sourceEndLine: 627, configCalls: ['set_flags(8)', 'set_resistors_load(10000,10000,10000)', 'add_route(0,"snd_nl",1,3)', 'add_route(1,"snd_nl",1,4)', 'add_route(2,"snd_nl",1,5)']};
...
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2', defaultValue: 2};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 12, activeLow: true, type: 'IPT_UNUSED', defaultValue: 12};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_SERVICE1', defaultValue: 16};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNUSED', defaultValue: 32};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:1942/SYSTEM/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1', defaultValue: 128};
MERGE (n:KG {id: 'inputs:1942/P1'}) SET n:Port SET n += {tag: 'P1', modify: false};
MERGE (n:KG {id: 'inputs:1942/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:1942/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:1942/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:1942/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:1942/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 16};
MERGE (n:KG {id: 'inputs:1942/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', defaultValue: 32};
MERGE (n:KG {id: 'inputs:1942/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED', defaultValue: 192};
MERGE (n:KG {id: 'inputs:1942/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:1942/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:1942/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:1942/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:1942/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:1942/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:1942/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:1942/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED', defaultValue: 192};
MERGE (n:KG {id: 'inputs:1942/DSWA'}) SET n:Port SET n += {tag: 'DSWA', modify: false};
MERGE (n:KG {id: 'inputs:1942/DSWA/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, modifiers: ['PORT_DIPLOCATION("SWA:8,7,6")'], name: 'Coin A', defaultValue: 7, location: 'SWA:8,7,6', settings: ['1=4C 1C', '2=3C 1C', '4=2C 1C', '7=1C 1C', '3=2C 3C', '6=1C 2C', '5=1C 4C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:1942/DSWA/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 8, modifiers: ['PORT_DIPLOCATION("SWA:5")'], name: 'Cabinet', defaultValue: 0, location: 'SWA:5', settings: ['0=Upright', '8=Cocktail']};
MERGE (n:KG {id: 'inputs:1942/DSWA/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, modifiers: ['PORT_DIPLOCATION("SWA:4,3")'], name: 'Bonus Life', defaultValue: 48, location: 'SWA:4,3', settings: ['48=20K 80K 80K+', '32=20K 100K 100K+', '16=30K 80K 80K+', '0=30K 100K 100K+']};
MERGE (n:KG {id: 'inputs:1942/DSWA/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("SWA:2,1")'], name: 'Lives', defaultValue: 192, location: 'SWA:2,1', settings: ['128=1', '64=2', '192=3', '0=5']};
MERGE (n:KG {id: 'inputs:1942/DSWB'}) SET n:Port SET n += {tag: 'DSWB', modify: false};
MERGE (n:KG {id: 'inputs:1942/DSWB/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, modifiers: ['PORT_DIPLOCATION("SWB:8,7,6")'], name: 'Coin B', defaultValue: 7, location: 'SWB:8,7,6', settings: ['1=4C 1C', '2=3C 1C', '4=2C 1C', '7=1C 1C', '3=2C 3C', '6=1C 2C', '5=1C 4C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:1942/DSWB/f1'}) SET n:PortField SET n += {kind: 'service', mask: 8, activeLow: true, defaultValue: 8};
MERGE (n:KG {id: 'inputs:1942/DSWB/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, modifiers: ['PORT_DIPLOCATION("SWB:4")'], name: 'Flip Screen', defaultValue: 16, location: 'SWB:4', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:1942/DSWB/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 96, modifiers: ['PORT_DIPLOCATION("SWB:3,2")'], name: 'Difficulty', defaultValue: 96, location: 'SWB:3,2', settings: ['64=Easy', '96=Normal', '32=Difficult', '0=Very Difficult']};
MERGE (n:KG {id: 'inputs:1942/DSWB/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_DIPLOCATION("SWB:1")'], name: 'Screen Stop', defaultValue: 128, location: 'SWB:1', settings: ['128=Off', '0=On']};
...
MERGE (n:KG {id: 'device:_1942_state._1942/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(_1942_state::_1942_palette), 64*4+4*32*8+16*16, 256)', ownerTag: 'palette', targetClass: '_1942_state', targetMethod: '_1942_palette', entries: 256, sourceFile: 'src/mame/capcom/1942.cpp', sourceLine: 607};
MERGE (n:KG {id: 'handler:_1942_state._1942_palette'}) SET n:Handler SET n += {method: '_1942_palette', ownerClass: '_1942_state', sourceFile: 'src/mame/capcom/1942_v.cpp', sourceLine: 58, sourceColumn: 1, sourceEndLine: 84, sourceParameters: 'palette_device &palette', sourceBody: 'create_palette(palette);
...
MERGE (n:KG {id: 'handler:_1942_state.create_palette'}) SET n:Handler SET n += {method: 'create_palette', ownerClass: '_1942_state', sourceFile: 'src/mame/capcom/1942_v.cpp', sourceLine: 29, sourceColumn: 1, sourceEndLine: 56, sourceParameters: 'palette_device &palette', sourceBody: 'const uint8_t *color_prom = memregion("palproms")->base();
...
MATCH (a:KG {id: 'device:_1942_state._1942/palette'}), (b:KG {id: 'device:_1942_state._1942/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:_1942_state._1942/palette/callback:palette_init'}), (b:KG {id: 'handler:_1942_state._1942_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:_1942_state._1942_palette'}), (b:KG {id: 'handler:_1942_state.create_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
