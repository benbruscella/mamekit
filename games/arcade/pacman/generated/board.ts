...
const defined = decodeBoardIr(boardData, 'pacman');
...
defined.compiledHandlerLinks = ["bitmap.fill","draw","fill","m_bg_tilemap.draw","m_bg_tilemap.mark_tile_dirty","m_bg_tilemap.set_flip","m_gfxdecode.gfx","m_maincpu.set_input_line","m_palette.transpen_mask","mark_tile_dirty","rectangle","set","set_flip","tileinfo.set"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
