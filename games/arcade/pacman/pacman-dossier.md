...
**Namco (Midway license) · 1980** — transpiled from the MAME driver `src/mame/pacman/pacman.cpp` by mamekit.

![marquee](/artwork/media/marquees/pacman.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/pacman.webp) | ![cabinet](/artwork/media/cabinets/pacman.webp) |
...
| `gfx1` | `pacman.5e` | 0x0 | 0x1000 | `0c944964` |
| `gfx1` | `pacman.5f` | 0x1000 | 0x1000 | `958fedf9` |
...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Stephane Humbert (driver header); ClawGrip (7 release notes); Robbbert (3 release notes); hap (2 release notes); Recreativas.org (2 release notes); UnclePetros (2 release notes); chaneman (1 release note); Davidc96 (1 release note); Devin Acker (1 release note); Edgar Solé (1 release note); einstein95 (1 release note); Fortuna (1 release note); Ian Eure (1 release note); Ivan Vangelista (1 release note); Jordi Tuells (1 release note); Liron486 (1 release note); Marc Deslauriers (1 release note); Museo Arcade Vintage (1 release note); Tafoid (1 release note); Victor Fernandez (City Game) (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 437 commits by 52 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
...
### Trivia
Pac-Man was released by Midway Manufacturing, under license from Namco, in the USA on October 10, 1980 (Friday). 96,000 units were produced in America. 
...
The game's cult status in the early 80's was such that it inspired a hit single by 'Buckner and Garcia' called 'Pac-Man Fever'. Initially released as a single in December, 1981, it eventually reached #9 on the pop charts.  It was so popular the label encouraged them to record an entire album with video game themed songs.  The album 'Pac-Man Fever' was quickly released in January of 1982 featuring 8 songs based on Donkey Kong, Frogger, Asteroids, Centipede, and other popular games.
...
PC [Booter] (1983) 
PC [Booter] (1983) "Ascii Man" : Part of the "Friendlyware PC Arcade" suite 
PC [MS-DOS] (1983) 
...
PC [MS-DOS] (1997) "Champ Pac-Em" by CHAMProgramming 
...
LCD handheld color game (1999) by Micro Games of America 
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/1914/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `pacman`. Play it at [../../../app/g/pacman/](../../../app/g/pacman/) or [explore the knowledge graph](viewer.html).*
