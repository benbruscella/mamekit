...
// generated 2026-09-24T02:29:04.748Z
...
MERGE (n:KG {id: 'game:puckman'}) SET n:Game SET n += {name: 'puckman', year: '1980', company: 'Namco', fullname: 'Puck Man (Japan, set 1)', monitor: 'ROT90', cls: 'pacman_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9012, sourceColumn: 1, sourceEndLine: 9012};
MERGE (n:KG {id: 'game:pacman'}) SET n:Game SET n += {name: 'pacman', year: '1980', company: 'Namco (Midway license)', fullname: 'Pac-Man (Midway)', monitor: 'ROT90', cls: 'pacman_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9017, sourceColumn: 1, sourceEndLine: 9017};
...
MERGE (n:KG {id: 'handler:pacman_state.pacman_scan_rows'}) SET n:Handler SET n += {method: 'pacman_scan_rows', ownerClass: 'pacman_state', sourceFile: 'src/mame/pacman/pacman_v.cpp', sourceLine: 170, sourceColumn: 1, sourceEndLine: 178, sourceParameters: 'u32 col, u32 row, u32 num_cols, u32 num_rows', sourceBody: 'row += 2;
	...
	if (col & 0x20)
		...
		return col + (row << 5);'};
MERGE (n:KG {id: 'device:pacman_state.pacman/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, 18.432_MHz_XTAL / 6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &pacman_state::pacman_map)', 'm_maincpu->set_addrmap(AS_IO, &pacman_state::writeport)', 'm_maincpu->set_irq_acknowledge_callback(FUNC(pacman_state::interrupt_vector_r))'], member: 'm_maincpu', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3708, sourceColumn: 2, sourceEndLine: 3708};
...
MERGE (n:KG {id: 'device:pacman_state.pacman/watchdog'}) SET n:Device SET n += {type: 'WATCHDOG_TIMER', tag: 'watchdog', clock: null, config: ['WATCHDOG_TIMER(config, m_watchdog)', 'm_watchdog->set_vblank_count("screen", 16)'], member: 'm_watchdog', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3725, sourceColumn: 2, sourceEndLine: 3725, configCalls: ['set_vblank_count("screen",16)']};
MERGE (n:KG {id: 'device:pacman_state.pacman/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_pacman)'], member: 'm_gfxdecode', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3729, sourceColumn: 2, sourceEndLine: 3729, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:pacman_state.pacman/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(pacman_state::pacman_palette), 128 * 4, 32)'], member: 'm_palette', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3731, sourceColumn: 2, sourceEndLine: 3731, clockExpr: 'FUNC(pacman_state::pacman_palette)', paletteEntries: 32};
MERGE (n:KG {id: 'device:pacman_state.pacman/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(18.432_MHz_XTAL / 3, 384, 0, 288, 264, 0  , 224  )', 'm_screen->set_screen_update(FUNC(pacman_state::screen_update_pacman))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set(FUNC(pacman_state::vblank_irq))'], member: 'm_screen', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3733, sourceColumn: 2, sourceEndLine: 3733, configCalls: ['set_raw(6144000,384,0,288,264,0,224)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 0, 288, 264, 0, 224], screenRawExpr: ['18.432_MHz_XTAL / 3', '384', '0', '288', '264', '0', '224']};
...
MERGE (n:KG {id: 'device:pacman_state.pacman/namco'}) SET n:Device SET n += {type: 'NAMCO_WSG', tag: 'namco', clock: 96000, config: ['NAMCO_WSG(config, m_namco_sound, 18.432_MHz_XTAL / 6 / 32)', 'm_namco_sound->add_route(ALL_OUTPUTS, "mono", 1.0)'], member: 'm_namco_sound', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3745, sourceColumn: 2, sourceEndLine: 3745};
...
MERGE (n:KG {id: 'inputs:pacman/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_PLAYER(1)', 'PORT_4WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:pacman/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_PLAYER(1)', 'PORT_4WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:pacman/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_PLAYER(1)', 'PORT_4WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:pacman/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_PLAYER(1)', 'PORT_4WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:pacman/IN0/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 16, modifiers: ['PORT_CODE(KEYCODE_F1)', 'PORT_DIPLOCATION("SW:7")', 'PORT_TOGGLE'], name: 'Rack Test (Cheat)', defaultValue: 16, location: 'SW:7', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:pacman/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN1', defaultValue: 32};
MERGE (n:KG {id: 'inputs:pacman/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:pacman/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_SERVICE1', defaultValue: 128};
MERGE (n:KG {id: 'inputs:pacman/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:pacman/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_PLAYER(2)', 'PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:pacman/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_PLAYER(2)', 'PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:pacman/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_PLAYER(2)', 'PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:pacman/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_PLAYER(2)', 'PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:pacman/IN1/f4'}) SET n:PortField SET n += {kind: 'service', mask: 16, activeLow: true, defaultValue: 16};
MERGE (n:KG {id: 'inputs:pacman/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_START1', defaultValue: 32};
MERGE (n:KG {id: 'inputs:pacman/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2', defaultValue: 64};
...
MERGE (n:KG {id: 'inputs:pacman/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SW:1,2")'], name: 'Coinage', defaultValue: 1, location: 'SW:1,2', settings: ['3=2C 1C', '1=1C 1C', '2=1C 2C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:pacman/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION("SW:3,4")'], name: 'Lives', defaultValue: 8, location: 'SW:3,4', settings: ['0=1', '4=2', '8=3', '12=5']};
MERGE (n:KG {id: 'inputs:pacman/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, modifiers: ['PORT_DIPLOCATION("SW:5,6")'], name: 'Bonus Life', defaultValue: 0, location: 'SW:5,6', settings: ['0=10000', '16=15000', '32=20000', '48=None']};
...
MERGE (n:KG {id: 'inputs:pacman/DSW2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 255, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
...
MATCH (a:KG {id: 'game:pacman'}), (b:KG {id: 'file:src/mame/pacman/pacman.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9017, sourceColumn: 1, sourceEndLine: 9017};
...
MATCH (a:KG {id: 'game:puckman'}), (b:KG {id: 'file:src/mame/pacman/pacman.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9012, sourceColumn: 1, sourceEndLine: 9012};
