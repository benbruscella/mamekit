...
// generated 2026-09-24T02:29:19.226Z
...
MERGE (n:KG {id: 'machine:pengo_state.pengo'}) SET n:MachineConfig SET n += {cls: 'pengo_state', name: 'pengo', calls: ['pacman'], stateMembers: ['{"name":"m_cannonb_bit_to_read","bits":8}', '{"name":"m_counter","bits":8}', '{"name":"m_bigbucks_bank","bits":32,"signed":true}', '{"name":"m_rocktrv2_question_bank","bits":8}', '{"name":"m_charbank","bits":8}', '{"name":"m_spritebank","bits":8}', '{"name":"m_palettebank","bits":8}', '{"name":"m_colortablebank","bits":8}', '{"name":"m_flipscreen","bits":8}', '{"name":"m_bgpriority","bits":8}', '{"name":"m_xoffsethack","bits":32,"signed":true}', '{"name":"m_inv_spr","bits":8}', '{"name":"m_maketrax_counter","bits":8}', '{"name":"m_maketrax_offset","bits":8}', '{"name":"m_maketrax_disable_protection","bits":32,"signed":true}', '{"name":"m_irq_mask","bits":1}', '{"name":"m_interrupt_vector","bits":8}'], startHandlers: ['pacman_state.video_start_pengo'], devicePatches: ['{"tag":"maincpu","config":["m_maincpu->remove_irq_acknowledge_callback()"]}', '{"tag":"mainlatch","config":["m_mainlatch->q_out_cb<2>().set(FUNC(pengo_state::pengo_palettebank_w))","m_mainlatch->q_out_cb<4>().set(FUNC(pengo_state::coin_counter_w<0>))","m_mainlatch->q_out_cb<5>().set(FUNC(pengo_state::coin_counter_w<1>))","m_mainlatch->q_out_cb<6>().set(FUNC(pengo_state::pengo_colortablebank_w))","m_mainlatch->q_out_cb<7>().set(FUNC(pengo_state::pengo_gfxbank_w))"]}'], removedAddrMaps: ['maincpu=AS_IO'], sourceFile: 'src/mame/pacman/pengo.cpp', sourceLine: 350, sourceColumn: 1, sourceEndLine: 370};
...
MERGE (n:KG {id: 'handler:pengo_state.pengo_gfxbank_w'}) SET n:Handler SET n += {method: 'pengo_gfxbank_w', ownerClass: 'pengo_state', sourceFile: 'src/mame/pacman/pacman_v.cpp', sourceLine: 474, sourceColumn: 1, sourceEndLine: 479, sourceParameters: 'int state', sourceBody: 'm_spritebank = state;
	m_charbank = state;
	m_bg_tilemap->mark_all_dirty();'};
MERGE (n:KG {id: 'machine:pengo_state.pengou'}) SET n:MachineConfig SET n += {cls: 'pengo_state', name: 'pengou', calls: ['pengo'], stateMembers: ['{"name":"m_cannonb_bit_to_read","bits":8}', '{"name":"m_counter","bits":8}', '{"name":"m_bigbucks_bank","bits":32,"signed":true}', '{"name":"m_rocktrv2_question_bank","bits":8}', '{"name":"m_charbank","bits":8}', '{"name":"m_spritebank","bits":8}', '{"name":"m_palettebank","bits":8}', '{"name":"m_colortablebank","bits":8}', '{"name":"m_flipscreen","bits":8}', '{"name":"m_bgpriority","bits":8}', '{"name":"m_xoffsethack","bits":32,"signed":true}', '{"name":"m_inv_spr","bits":8}', '{"name":"m_maketrax_counter","bits":8}', '{"name":"m_maketrax_offset","bits":8}', '{"name":"m_maketrax_disable_protection","bits":32,"signed":true}', '{"name":"m_irq_mask","bits":1}', '{"name":"m_interrupt_vector","bits":8}'], removedAddrMaps: ['maincpu=AS_OPCODES'], sourceFile: 'src/mame/pacman/pengo.cpp', sourceLine: 372, sourceColumn: 1, sourceEndLine: 377};
...
MERGE (n:KG {id: 'inputs:pengo/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:pengo/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:pengo/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:pengo/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:pengo/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_IMPULSE(2)'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:pengo/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN2', modifiers: ['PORT_IMPULSE(2)'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:pengo/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN3', modifiers: ['PORT_IMPULSE(2)'], defaultValue: 64};
MERGE (n:KG {id: 'inputs:pengo/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 128};
MERGE (n:KG {id: 'inputs:pengo/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:pengo/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:pengo/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:pengo/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:pengo/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:pengo/IN1/f4'}) SET n:PortField SET n += {kind: 'service', mask: 16, activeLow: true, defaultValue: 16};
MERGE (n:KG {id: 'inputs:pengo/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_START1', defaultValue: 32};
MERGE (n:KG {id: 'inputs:pengo/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:pengo/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 128};
MERGE (n:KG {id: 'inputs:pengo/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW1:1")'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:1', settings: ['0=30000', '1=50000']};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, modifiers: ['PORT_DIPLOCATION("SW1:2")'], name: 'Demo Sounds', defaultValue: 0, location: 'SW1:2', settings: ['2=Off', '0=On']};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, modifiers: ['PORT_DIPLOCATION("SW1:3")'], name: 'Cabinet', defaultValue: 0, location: 'SW1:3', settings: ['0=Upright', '4=Cocktail']};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 24, modifiers: ['PORT_DIPLOCATION("SW1:4,5")'], name: 'Lives', defaultValue: 16, location: 'SW1:4,5', settings: ['24=2', '16=3', '8=4', '0=5']};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 32, modifiers: ['PORT_CODE(KEYCODE_F1)', 'PORT_DIPLOCATION("SW1:6")'], name: 'Rack Test (Cheat)', defaultValue: 32, location: 'SW1:6', settings: ['32=Off', '0=On']};
MERGE (n:KG {id: 'inputs:pengo/DSW1/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("SW1:7,8")'], name: 'Difficulty', defaultValue: 128, location: 'SW1:7,8', settings: ['192=Easy', '128=Medium', '64=Hard', '0=Hardest']};
MERGE (n:KG {id: 'inputs:pengo/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:pengo/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, modifiers: ['PORT_DIPLOCATION("SW2:1,2,3,4")'], name: 'Coin A', defaultValue: 12, location: 'SW2:1,2,3,4', settings: ['0=4C 1C', '8=3C 1C', '4=2C 1C', '9=2 Coins/1 Credit 5/3', '5=2 Coins/1 Credit 4/3', '12=1C 1C', '13=1 Coin/1 Credit 5/6', '3=1 Coin/1 Credit 4/5', '11=1 Coin/1 Credit 2/3', '2=1C 2C', '7=1 Coin/2 Credits 5/11', '15=1 Coin/2 Credits 4/9', '10=1C 3C', '6=1C 4C', '14=1C 5C', '1=1C 6C']};
MERGE (n:KG {id: 'inputs:pengo/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 240, modifiers: ['PORT_DIPLOCATION("SW2:5,6,7,8")'], name: 'Coin B', defaultValue: 192, location: 'SW2:5,6,7,8', settings: ['0=4C 1C', '128=3C 1C', '64=2C 1C', '144=2 Coins/1 Credit 5/3', '80=2 Coins/1 Credit 4/3', '192=1C 1C', '208=1 Coin/1 Credit 5/6', '48=1 Coin/1 Credit 4/5', '176=1 Coin/1 Credit 2/3', '32=1C 2C', '112=1 Coin/2 Credits 5/11', '240=1 Coin/2 Credits 4/9', '160=1C 3C', '96=1C 4C', '224=1C 5C', '16=1C 6C']};
...
MATCH (a:KG {id: 'machine:pengo_state.pengou'}), (b:KG {id: 'machine:pengo_state.pengo'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'machine:pengo_state.pengo'}), (b:KG {id: 'machine:pacman_state.pacman'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
