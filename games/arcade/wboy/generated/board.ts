...
defined.compiledHandlerLinks = ["adjust_icount","cpu.adjust_icount","cpu.total_cycles","flip_screen_set","m_maincpu.adjust_icount","m_palette.set_pen_indirect","m_screen.update_partial","m_screen.vpos","m_soundcpu.set_input_line","set","tileinfo.set","tilemap.user_data","total_cycles","user_data"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
