...
// generated 2026-09-24T02:31:10.286Z
...
MERGE (n:KG {id: 'device:system1_state.sys1ppi/soundcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'soundcpu', clock: 4000000, config: ['Z80(config, m_soundcpu, SOUND_CLOCK/2)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &system1_state::sound_map)'], member: 'm_soundcpu', sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 2205, sourceColumn: 2, sourceEndLine: 2205};
...
MERGE (n:KG {id: 'bank:system1_state.encrypted_sys1pio_maps/bank0d'}) SET n:MemoryBank SET n += {tag: 'bank0d', member: 'm_bank0d', startEntry: 0, entries: 1, entryMember: 'm_banked_decrypted_opcodes', offset: 0, stride: 0, raw: 'm_bank0d->set_base(m_banked_decrypted_opcodes.get())', sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 320, sourceColumn: 1, sourceEndLine: 343};
...
MERGE (n:KG {id: 'bank:system1_state.wboy/bank0d'}) SET n:MemoryBank SET n += {tag: 'bank0d', member: 'm_bank0d', startEntry: 0, entries: 1, entryMember: 'm_banked_decrypted_opcodes', offset: 0, stride: 0, raw: 'm_bank0d->set_base(m_banked_decrypted_opcodes.get())', sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 320, sourceColumn: 1, sourceEndLine: 343};
...
MATCH (a:KG {id: 'machine:system1_state.wboy'}), (b:KG {id: 'bank:system1_state.wboy/bank0d'}) MERGE (a)-[r:HAS_BANK]->(b);
...
MATCH (a:KG {id: 'machine:system1_state.sys1pio'}), (b:KG {id: 'bank:system1_state.sys1pio/bank0d'}) MERGE (a)-[r:HAS_BANK]->(b);
...
MATCH (a:KG {id: 'machine:system1_state.encrypted_sys1pio_maps'}), (b:KG {id: 'bank:system1_state.encrypted_sys1pio_maps/bank0d'}) MERGE (a)-[r:HAS_BANK]->(b);
...
MATCH (a:KG {id: 'bank:system1_state.wboy/bank0d'}), (b:KG {id: 'file:src/mame/sega/system1.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 320, sourceColumn: 1, sourceEndLine: 343};
...
MATCH (a:KG {id: 'bank:system1_state.sys1pio/bank0d'}), (b:KG {id: 'file:src/mame/sega/system1.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 320, sourceColumn: 1, sourceEndLine: 343};
...
MATCH (a:KG {id: 'bank:system1_state.encrypted_sys1pio_maps/bank0d'}), (b:KG {id: 'file:src/mame/sega/system1.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/sega/system1.cpp', sourceLine: 320, sourceColumn: 1, sourceEndLine: 343};
