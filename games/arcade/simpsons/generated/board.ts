...
defined.compiledHandlers = {
  ...
  function method_eeprom_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_video_bank_select(runtime: any, bank: any) {
    const members = runtime.members;
    if ((((bank) >>> (0)) & 1)) {
  ...
  function method_sound_interrupt_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_k052109_r(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_k052109_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_z80_bankswitch_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_banking_callback(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_konami_sortlayers3(runtime: any, layer: any, pri: any) {
    const members = runtime.members;
  ...
  function method_tile_callback(runtime: any, layer: any, bank: any, code: any, color: any, flags: any, priority: any) {
    const members = runtime.members;
  ...
  function method_sprite_callback(runtime: any, code: any, color: any, priority_mask: any) {
    const members = runtime.members;
    let pri: any = ((((color.get()) & (3968))) >>> (6));
