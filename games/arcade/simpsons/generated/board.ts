...
defined.compiledHandlerLinks = ["disable","konami_sortlayers_3","m_audiobank.set_entry","m_audiocpu.set_input_line","m_io_eepromout.write","m_k052109.read","m_k052109.write","m_mainbank.set_entry","m_maincpu.set_input_line","m_palette_view.disable","m_palette_view.select","m_video_view.select","machine","machine().side_effects_disabled","select","set_entry","std::less","write"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
