...
// generated 2026-09-24T02:30:19.501Z
...
MERGE (n:KG {id: 'machine:simpsons_state.simpsons'}) SET n:MachineConfig SET n += {cls: 'simpsons_state', name: 'simpsons', calls: [], stateMembers: ['{"name":"m_sprite_colorbase","bits":32,"signed":true}', '{"name":"m_layer_colorbase","bits":32,"signed":true,"arrayLength":3}', '{"name":"m_layerpri","bits":32,"signed":true,"arrayLength":3}', '{"name":"m_firq_enabled","bits":1}'], driverTimers: ['m_dma_start_timer=simpsons_state.dma_start', 'm_dma_end_timer=simpsons_state.dma_end', 'm_nmi_blocked='], resetHandlers: ['simpsons_state.machine_reset'], sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 638, sourceColumn: 1, sourceEndLine: 690};
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3579545, config: ['Z80(config, m_audiocpu, 3.579545_MHz_XTAL)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &simpsons_state::z80_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 646, sourceColumn: 2, sourceEndLine: 646};
...
MERGE (n:KG {id: 'handler:simpsons_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'simpsons_state', sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 293, sourceColumn: 1, sourceEndLine: 327, sourceConstants: ['CI0=0', 'CI1=1', 'CI2=2', 'CI3=3', 'CI4=4', 'k053251_device::CI0=0', 'k053251_device::CI1=1', 'k053251_device::CI2=2', 'k053251_device::CI3=3', 'k053251_device::CI4=4', 'k053251_device::CI2=2', 'k053251_device::CI3=3', 'k053251_device::CI4=4'], sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: '// update color info and refresh tilemaps
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k052109'}) SET n:Device SET n += {type: 'K052109', tag: 'k052109', clock: 24000000, config: ['K052109(config, m_k052109, 24_MHz_XTAL)', 'm_k052109->set_palette("palette")', 'm_k052109->set_screen("screen")', 'm_k052109->set_tile_callback(FUNC(simpsons_state::tile_callback))', 'm_k052109->irq_handler().set_inputline(m_maincpu, KONAMI_IRQ_LINE)'], member: 'm_k052109', cls: 'k052109_device', clsHierarchy: ['k052109_device'], sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 664, sourceColumn: 2, sourceEndLine: 664, configCalls: ['set_palette("palette")', 'set_screen("screen")'], startHandler: 'k052109_device.device_start', deviceTimers: ['m_firq_scanline=k052109_device.firq_scanline', 'm_nmi_scanline=k052109_device.nmi_scanline']};
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k052109/callback:k052109:0'}) SET n:Callback SET n += {signal: 'set_tile_callback', member: 'm_k052109_cb', delegate: 1, operation: 'set_tile_callback', raw: 'm_k052109->set_tile_callback(FUNC(simpsons_state::tile_callback))', ownerTag: 'k052109', sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 667, sourceColumn: 2, sourceEndLine: 667, targetClass: 'simpsons_state', targetMethod: 'tile_callback'};
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k053246'}) SET n:Device SET n += {type: 'K053246', tag: 'k053246', clock: 24000000, config: ['K053246(config, m_k053246, 24_MHz_XTAL)', 'm_k053246->set_sprite_callback(FUNC(simpsons_state::sprite_callback))', 'm_k053246->set_config(NORMAL_PLANE_ORDER, -43, 23)', 'm_k053246->set_palette("palette")'], member: 'm_k053246', sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 670, sourceColumn: 2, sourceEndLine: 670, configCalls: ['set_config(4,-43,23)', 'set_palette("palette")']};
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k053246/callback:k053246:0'}) SET n:Callback SET n += {signal: 'set_sprite_callback', member: 'm_k053247_cb', delegate: 1, operation: 'set_sprite_callback', raw: 'm_k053246->set_sprite_callback(FUNC(simpsons_state::sprite_callback))', ownerTag: 'k053246', sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 671, sourceColumn: 2, sourceEndLine: 671, targetClass: 'simpsons_state', targetMethod: 'sprite_callback'};
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k053251'}) SET n:Device SET n += {type: 'K053251', tag: 'k053251', clock: 0, config: ['K053251(config, m_k053251)'], member: 'm_k053251', cls: 'k053251_device', clsHierarchy: ['k053251_device'], sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 675, sourceColumn: 2, sourceEndLine: 675, startHandler: 'k053251_device.device_start'};
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/ymsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'ymsnd', clock: 3579545, config: ['ym2151_device &ymsnd(YM2151(config, "ymsnd", 3.579545_MHz_XTAL))', 'ymsnd.add_route(0, "speaker", 0.5, 0)', 'ymsnd.add_route(0, "speaker", 0.5, 1)', 'ymsnd.add_route(1, "speaker", 0.0, 0)', 'ymsnd.add_route(1, "speaker", 0.0, 1)'], sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 680, sourceColumn: 2, sourceEndLine: 680, configCalls: ['add_route(0,"speaker",0.5,0)', 'add_route(0,"speaker",0.5,1)', 'add_route(1,"speaker",0,0)', 'add_route(1,"speaker",0,1)']};
...
MERGE (n:KG {id: 'device:simpsons_state.simpsons/k053260'}) SET n:Device SET n += {type: 'K053260', tag: 'k053260', clock: 3579545, config: ['k053260_device &k053260(K053260(config, "k053260", 3.579545_MHz_XTAL))', 'k053260.add_route(0, "speaker", 0.5, 0)', 'k053260.add_route(1, "speaker", 0.5, 1)', 'k053260.sh1_cb().set(FUNC(simpsons_state::z80_nmi_w))'], sourceFile: 'src/mame/konami/simpsons.cpp', sourceLine: 686, sourceColumn: 2, sourceEndLine: 686, configCalls: ['add_route(0,"speaker",0.5,0)', 'add_route(1,"speaker",0.5,1)']};
...
MERGE (n:KG {id: 'handler:k053251_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'k053251_device', sourceFile: 'src/mame/konami/k053251.cpp', sourceLine: 139, sourceColumn: 1, sourceEndLine: 142, sourceParameters: '', sourceBody: 'save_item(NAME(m_ram));'};
...
MATCH (a:KG {id: 'device:simpsons_state.simpsons/k052109'}), (b:KG {id: 'handler:k052109_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:simpsons_state.simpsons/k053251'}), (b:KG {id: 'handler:k053251_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
