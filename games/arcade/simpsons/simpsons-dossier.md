...
- **Credited by MAMEDEV:** Ernesto Corvi (driver header); hap (machine); Alex Jackson (2 release notes); smf (2 release notes); cam900 (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 209 commits by 31 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
