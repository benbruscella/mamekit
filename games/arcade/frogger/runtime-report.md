# frogger source-generation report

Playability: **executable**

Basis: **source-complete**

MAME source coverage: **140/171 nodes (81.9%)**
...
| Declarative host | 16 | Hardware-neutral browser service configured by generated data |
...
- `ppi8255_1.in_pc_callback -> IN3` - src/mame/galaxian/galaxian.cpp:7538
- `ppi8255_1.out_pc_callback -> galaxian_state.konami_portc_1_w` - src/mame/galaxian/galaxian.cpp:7539
- `8910.0.port_a_read_callback -> soundlatch.read` - src/mame/galaxian/galaxian.cpp:7556
- `8910.0.port_b_read_callback -> galaxian_state.frogger_sound_timer_r` - src/mame/galaxian/galaxian.cpp:7557
