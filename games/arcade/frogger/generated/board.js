...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_konami_portc_1_w(runtime, data) {
                const members = runtime.members;
                0;
            }
            function method_frogger_sound_timer_r(runtime) {
                const members = runtime.members;
                let konami_value = (((runtime.overrides["konami_sound_timer_r"] ? runtime.overrides["konami_sound_timer_r"]() : method_konami_sound_timer_r(runtime))) & 0xff);
