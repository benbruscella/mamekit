...
// generated 2026-09-24T02:27:36.200Z
...
MERGE (n:KG {id: 'handler:galaxian_state.screen_update_galaxian'}) SET n:Handler SET n += {method: 'screen_update_galaxian', ownerClass: 'galaxian_state', sourceFile: 'src/mame/galaxian/galaxian_v.cpp', sourceLine: 460, sourceColumn: 1, sourceEndLine: 477, sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: '/* draw the background layer (including stars) */
	...
	return 0;'};
MERGE (n:KG {id: 'handler:galaxian_state.sprites_draw'}) SET n:Handler SET n += {method: 'sprites_draw', ownerClass: 'galaxian_state', sourceFile: 'src/mame/galaxian/galaxian_v.cpp', sourceLine: 568, sourceColumn: 1, sourceEndLine: 619, sourceConstants: ['hoffset=1'], sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect, const uint8_t *spritebase', sourceBody: 'rectangle clip = cliprect;
...
MERGE (n:KG {id: 'device:galaxian_state.konami_sound_1x_ay8910/konami'}) SET n:Device SET n += {type: 'NETLIST_SOUND', tag: 'konami', clock: 48000, config: ['NETLIST_SOUND(config, "konami", 48000)
		...
		.add_route(ALL_OUTPUTS, "speaker", 1.0)'], member: 'm_netlist', sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7562, sourceColumn: 2, sourceEndLine: 7564};
...
MERGE (n:KG {id: 'machine:galaxian_state.frogger'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'frogger', calls: ['konami_base', 'konami_sound_1x_ay8910'], stateMembers: ['{"name":"m_bullets_base","bits":32,"signed":true}', '{"name":"m_sprites_base","bits":32,"signed":true}', '{"name":"m_numspritegens","bits":32,"signed":true}', '{"name":"m_protection_state","bits":16}', '{"name":"m_protection_result","bits":8}', '{"name":"m_konami_sound_control","bits":8}', '{"name":"m_irq_enabled","bits":8}', '{"name":"m_frogger_adjust","bits":1}', '{"name":"m_x_scale","bits":8}', '{"name":"m_h0_start","bits":8}', '{"name":"m_sfx_adjust","bits":1}', '{"name":"m_flipscreen_x","bits":8}', '{"name":"m_flipscreen_y","bits":8}', '{"name":"m_background_enable","bits":8}', '{"name":"m_background_red","bits":8}', '{"name":"m_background_green","bits":8}', '{"name":"m_background_blue","bits":8}', '{"name":"m_star_rng_origin","bits":32}', '{"name":"m_star_rng_origin_frame","bits":32}', '{"name":"m_stars_enabled","bits":8}', '{"name":"m_stars_blink_state","bits":8}', '{"name":"m_gfxbank","bits":8,"arrayLength":5}'], startHandlers: ['galaxian_state.video_start'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 8054, sourceColumn: 1, sourceEndLine: 8061};
...
MERGE (n:KG {id: 'inputs:frogger/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:frogger/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 2};
MERGE (n:KG {id: 'inputs:frogger/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_SERVICE1', defaultValue: 4};
MERGE (n:KG {id: 'inputs:frogger/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 8};
MERGE (n:KG {id: 'inputs:frogger/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:frogger/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:frogger/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:frogger/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1', defaultValue: 128};
...
MERGE (n:KG {id: 'inputs:frogger/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 4};
MERGE (n:KG {id: 'inputs:frogger/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 8};
MERGE (n:KG {id: 'inputs:frogger/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:frogger/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:frogger/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:frogger/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_START1', defaultValue: 128};
MERGE (n:KG {id: 'inputs:frogger/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:frogger/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 1};
...
MERGE (n:KG {id: 'inputs:frogger/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:frogger/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNUSED', defaultValue: 32};
MERGE (n:KG {id: 'inputs:frogger/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY'], defaultValue: 64};
MERGE (n:KG {id: 'inputs:frogger/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNUSED', defaultValue: 128};
MERGE (n:KG {id: 'inputs:frogger/IN3'}) SET n:Port SET n += {tag: 'IN3', modify: false};
MERGE (n:KG {id: 'inputs:frogger/IN3/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 255, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
...
MERGE (n:KG {id: 'handler:galaxian_state.galaxian_palette'}) SET n:Handler SET n += {method: 'galaxian_palette', ownerClass: 'galaxian_state', sourceFile: 'src/mame/galaxian/galaxian_v.cpp', sourceLine: 238, sourceColumn: 1, sourceEndLine: 359, sourceConstants: ['B=81', 'RGB_MAXIMUM=224'], sourceParameters: 'palette_device &palette', sourceBody: 'const uint8_t *color_prom = memregion("proms")->base();
...
MATCH (a:KG {id: 'machine:galaxian_state.frogger'}), (b:KG {id: 'machine:galaxian_state.konami_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'machine:galaxian_state.frogger'}), (b:KG {id: 'machine:galaxian_state.konami_sound_1x_ay8910'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
