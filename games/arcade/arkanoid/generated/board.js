    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let offs = ((tile_index) * (2));
                let code = runtime.add(runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), ((offs) + (1))), ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), offs)) & (7))) << (8))), ((2048) * ((members.m_gfxbank ?? runtime.member("m_gfxbank")))));
                let color = runtime.add(((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), offs)) & (248))) >>> (3)), ((32) * ((members.m_palettebank ?? runtime.member("m_palettebank")))));
