    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let color = ((runtime.add(((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), offs)) & (248))) >>> (3)), ((32) * ((members.m_palettebank ?? runtime.member("m_palettebank")))))) | 0);
