...
defined.compiledHandlers = {
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let color: any = ((runtime.add(runtime.shiftRight(((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), offs)) & (248)), 3), ((32) * ((members.m_palettebank ?? runtime.member("m_palettebank")))))) | 0);
