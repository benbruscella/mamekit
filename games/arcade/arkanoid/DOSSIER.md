...
- **Credited by MAMEDEV:** Brad Oliver (driver header); Stephane Humbert (driver header); Lord Nightmare (2 release notes); AugiteSoul (1 release note); Robbbert (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 255 commits by 36 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
