...
// generated 2026-09-24T02:25:50.306Z
...
MERGE (n:KG {id: 'device:arkanoid_state.arkanoid/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 6000000, config: ['Z80(config, m_maincpu, 12_MHz_XTAL/2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &arkanoid_state::arkanoid_map)'], member: 'm_maincpu', sourceFile: 'src/mame/taito/arkanoid.cpp', sourceLine: 1359, sourceColumn: 2, sourceEndLine: 1359};
...
MERGE (n:KG {id: 'device:arkanoid_state.arkanoid/mcu'}) SET n:Device SET n += {type: 'ARKANOID_68705P5', tag: 'mcu', clock: 3000000, config: ['ARKANOID_68705P5(config, m_mcuintf, 12_MHz_XTAL / 4)', 'm_mcuintf->portb_r_cb().set(FUNC(arkanoid_state::input_mux_r))'], member: 'm_mcuintf', cls: 'arkanoid_68705p5_device', clsHierarchy: ['arkanoid_68705p5_device', 'arkanoid_mcu_device_base', 'taito68705_mcu_device_base'], sourceFile: 'src/mame/taito/arkanoid.cpp', sourceLine: 1364, sourceColumn: 2, sourceEndLine: 1364, startHandler: 'arkanoid_mcu_device_base.device_start'};
...
MERGE (n:KG {id: 'device:arkanoid_state.arkanoid/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(12_MHz_XTAL/2, 384, 0, 256, 264, 16, 240)', 'm_screen->set_screen_update(FUNC(arkanoid_state::screen_update_arkanoid))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set_inputline(m_maincpu, 0, HOLD_LINE)'], member: 'm_screen', sourceFile: 'src/mame/taito/arkanoid.cpp', sourceLine: 1370, sourceColumn: 2, sourceEndLine: 1370, configCalls: ['set_raw(6000000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['12_MHz_XTAL/2', '384', '0', '256', '264', '16', '240']};
...
MERGE (n:KG {id: 'device:arkanoid_state.arkanoid/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_arkanoid)'], member: 'm_gfxdecode', sourceFile: 'src/mame/taito/arkanoid.cpp', sourceLine: 1376, sourceColumn: 2, sourceEndLine: 1376, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:arkanoid_state.arkanoid/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, palette_device::RGB_444_PROMS, "proms", 512)'], member: 'm_palette', sourceFile: 'src/mame/taito/arkanoid.cpp', sourceLine: 1377, sourceColumn: 2, sourceEndLine: 1377, clockExpr: 'palette_device::RGB_444_PROMS', paletteEntries: 512};
...
MERGE (n:KG {id: 'device:arkanoid_68705p5_device.device_add_mconfig/mcu'}) SET n:Device SET n += {type: 'M68705P5', tag: 'mcu', clock: 3000000, config: ['M68705P5(config, m_mcu, DERIVED_CLOCK(1, 1))', 'm_mcu->portb_r().set(FUNC(arkanoid_68705p5_device::mcu_pb_r))', 'm_mcu->portc_r().set(FUNC(arkanoid_68705p5_device::mcu_pc_r))', 'm_mcu->porta_w().set(FUNC(arkanoid_68705p5_device::mcu_pa_w))', 'm_mcu->portc_w().set(FUNC(arkanoid_68705p5_device::mcu_pc_w))'], member: 'm_mcu', sourceFile: 'src/mame/shared/taito68705.cpp', sourceLine: 344, sourceColumn: 2, sourceEndLine: 344};
...
MERGE (n:KG {id: 'handler:arkanoid_mcu_device_base.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'arkanoid_mcu_device_base', sourceFile: 'src/mame/shared/taito68705.cpp', sourceLine: 304, sourceColumn: 1, sourceEndLine: 311, sourceParameters: '', sourceBody: 'taito68705_mcu_device_base::device_start();

	save_item(NAME(m_pc_output));

	m_pc_output = 0xff;'};
MERGE (n:KG {id: 'handler:taito68705_mcu_device_base.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'taito68705_mcu_device_base', sourceFile: 'src/mame/shared/taito68705.cpp', sourceLine: 113, sourceColumn: 1, sourceEndLine: 128, sourceParameters: '', sourceBody: 'save_item(NAME(m_latch_driven));
...
MATCH (a:KG {id: 'device:arkanoid_state.arkanoid/mcu'}), (b:KG {id: 'handler:arkanoid_mcu_device_base.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:arkanoid_mcu_device_base.device_start'}), (b:KG {id: 'handler:taito68705_mcu_device_base.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
