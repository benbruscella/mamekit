...
// generated 2026-09-24T02:30:12.338Z
...
MERGE (n:KG {id: 'handler:segas16a_state.machine_reset'}) SET n:Handler SET n += {method: 'machine_reset', ownerClass: 'segas16a_state', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 911, sourceColumn: 1, sourceEndLine: 923, sourceParameters: '', sourceBody: '// queue up a timer to either boost interleave or disable the MCU
	...
	m_read_port = 0;
	m_mj_input_num = 0;'};
MERGE (n:KG {id: 'handler:segas16a_state.video_start'}) SET n:Handler SET n += {method: 'video_start', ownerClass: 'segas16a_state', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 370, sourceColumn: 1, sourceEndLine: 374, sourceConstants: ['TILEMAP_16A=1', 'segaic16_video_device::TILEMAP_16A=1'], sourceParameters: '', sourceBody: '// initialize the tile/text layers
...
MERGE (n:KG {id: 'handler:segaic16_video_device.tilemap_16b_alt_tile_info'}) SET n:Handler SET n += {method: 'tilemap_16b_alt_tile_info', ownerClass: 'segaic16_video_device', sourceFile: 'src/mame/sega/segaic16.cpp', sourceLine: 1037, sourceColumn: 1, sourceEndLine: 1048, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'const struct tilemap_callback_info *info = (const struct tilemap_callback_info *)tilemap.user_data();
	...
	tileinfo.set(0, code, color, 0);
	tileinfo.category = (data >> 15) & 1;'};
MERGE (n:KG {id: 'device:segas16a_state.system16a/maincpu'}) SET n:Device SET n += {type: 'M68000', tag: 'maincpu', clock: 10000000, config: ['M68000(config, m_maincpu, 10000000)', 'm_maincpu->set_addrmap(AS_PROGRAM, &segas16a_state::system16a_map)', 'm_maincpu->set_vblank_int("screen", FUNC(segas16a_state::irq4_line_hold))'], member: 'm_maincpu', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2259, sourceColumn: 2, sourceEndLine: 2259};
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/soundcpu'}) SET n:Device SET n += {type: 'Z80', tag: 'soundcpu', clock: 4000000, config: ['Z80(config, m_soundcpu, 4000000)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &segas16a_state::sound_map)', 'm_soundcpu->set_addrmap(AS_IO, &segas16a_state::sound_portmap)'], member: 'm_soundcpu', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2263, sourceColumn: 2, sourceEndLine: 2263};
MERGE (n:KG {id: 'device:segas16a_state.system16a/upd7751'}) SET n:Device SET n += {type: 'UPD7751', tag: 'upd7751', clock: 6000000, config: ['UPD7751(config, m_upd7751, 6000000)', 'm_upd7751->bus_in_cb().set(FUNC(segas16a_state::upd7751_rom_r))', 'm_upd7751->t1_in_cb().set_constant(0)', 'm_upd7751->p1_out_cb().set("dac", FUNC(dac_byte_interface::data_w))', 'm_upd7751->p2_in_cb().set(FUNC(segas16a_state::upd7751_p2_r))', 'm_upd7751->p2_out_cb().set(FUNC(segas16a_state::upd7751_p2_w))', 'm_upd7751->prog_out_cb().set("upd7751_8243", FUNC(i8243_device::prog_w))'], member: 'm_upd7751', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2267, sourceColumn: 2, sourceEndLine: 2267};
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/upd7751_8243'}) SET n:Device SET n += {type: 'I8243', tag: 'upd7751_8243', clock: null, config: ['I8243(config, m_upd7751_i8243)', 'm_upd7751_i8243->p4_out_cb().set(FUNC(segas16a_state::upd7751_rom_offset_w<0>))', 'm_upd7751_i8243->p5_out_cb().set(FUNC(segas16a_state::upd7751_rom_offset_w<4>))', 'm_upd7751_i8243->p6_out_cb().set(FUNC(segas16a_state::upd7751_rom_offset_w<8>))', 'm_upd7751_i8243->p7_out_cb().set(FUNC(segas16a_state::upd7751_rom_offset_w<12>))'], member: 'm_upd7751_i8243', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2275, sourceColumn: 2, sourceEndLine: 2275};
...
MERGE (n:KG {id: 'handler:segas16a_state.upd7751_rom_offset_w_12'}) SET n:Handler SET n += {method: 'upd7751_rom_offset_w_12', ownerClass: 'segas16a_state', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 664, sourceColumn: 1, sourceEndLine: 673, sourceConstants: ['Shift=12'], sourceParameters: 'uint8_t data', sourceBody: '// P4 - address lines 0-3
	...
	int newdata = (data << Shift) & mask;
	m_upd7751_rom_address = (m_upd7751_rom_address & ~mask) | newdata;'};
MERGE (n:KG {id: 'device:segas16a_state.system16a/nvram'}) SET n:Device SET n += {type: 'NVRAM', tag: 'nvram', clock: null, config: ['NVRAM(config, "nvram", nvram_device::DEFAULT_ALL_0)'], member: 'm_nvram', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2281, sourceColumn: 2, sourceEndLine: 2281, clockExpr: 'nvram_device::DEFAULT_ALL_0'};
MERGE (n:KG {id: 'device:segas16a_state.system16a/watchdog'}) SET n:Device SET n += {type: 'WATCHDOG_TIMER', tag: 'watchdog', clock: null, config: ['WATCHDOG_TIMER(config, m_watchdog)'], member: 'm_watchdog', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2283, sourceColumn: 2, sourceEndLine: 2283};
MERGE (n:KG {id: 'device:segas16a_state.system16a/i8255'}) SET n:Device SET n += {type: 'I8255', tag: 'i8255', clock: null, config: ['I8255(config, m_i8255)', 'm_i8255->out_pa_callback().set("soundlatch", FUNC(generic_latch_8_device::write))', 'm_i8255->out_pb_callback().set(FUNC(segas16a_state::misc_control_w))', 'm_i8255->out_pc_callback().set(FUNC(segas16a_state::tilemap_sound_w))', 'm_i8255->tri_pa_callback().set_constant(0)', 'm_i8255->tri_pb_callback().set_constant(0)', 'm_i8255->tri_pc_callback().set_constant(0)'], member: 'm_i8255', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2285, sourceColumn: 2, sourceEndLine: 2285};
...
MERGE (n:KG {id: 'handler:segas16a_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'segas16a_state', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 380, sourceColumn: 1, sourceEndLine: 446, sourceConstants: ['TILEMAP_FOREGROUND=0', 'TILEMAP_BACKGROUND=1', 'TILEMAP_TEXT=2', 'segaic16_video_device::TILEMAP_BACKGROUND=1', 'segaic16_video_device::TILEMAP_BACKGROUND=1', 'segaic16_video_device::TILEMAP_BACKGROUND=1', 'segaic16_video_device::TILEMAP_BACKGROUND=1', 'segaic16_video_device::TILEMAP_FOREGROUND=0', 'segaic16_video_device::TILEMAP_FOREGROUND=0', 'segaic16_video_device::TILEMAP_TEXT=2', 'segaic16_video_device::TILEMAP_TEXT=2'], sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: '// if no drawing is happening, fill with black and get out
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/sprites'}) SET n:Device SET n += {type: 'SEGA_SYS16A_SPRITES', tag: 'sprites', clock: 0, config: ['SEGA_SYS16A_SPRITES(config, m_sprites)'], member: 'm_sprites', cls: 'sega_sys16a_sprite_device', clsHierarchy: ['sega_sys16a_sprite_device', 'sega_16bit_sprite_device'], sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2301, sourceColumn: 2, sourceEndLine: 2301, startHandler: 'sega_16bit_sprite_device.device_start'};
MERGE (n:KG {id: 'device:segas16a_state.system16a/segaic16vid'}) SET n:Device SET n += {type: 'SEGAIC16VID', tag: 'segaic16vid', clock: null, config: ['SEGAIC16VID(config, m_segaic16vid, "gfxdecode")'], member: 'm_segaic16vid', cls: 'segaic16_video_device', clsHierarchy: ['segaic16_video_device'], sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2302, sourceColumn: 2, sourceEndLine: 2302, clockExpr: '"gfxdecode"', startHandler: 'segaic16_video_device.device_start'};
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(2048*2)'], member: 'm_palette', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2305, sourceColumn: 2, sourceEndLine: 2305, paletteEntries: 4096};
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/soundlatch'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'soundlatch', clock: null, config: ['GENERIC_LATCH_8(config, m_soundlatch)'], member: 'm_soundlatch', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2310, sourceColumn: 2, sourceEndLine: 2310};
MERGE (n:KG {id: 'device:segas16a_state.system16a/ymsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'ymsnd', clock: 4000000, config: ['YM2151(config, m_ymsnd, 4000000)', 'm_ymsnd->port_write_handler().set(FUNC(segas16a_state::upd7751_control_w))', 'm_ymsnd->add_route(ALL_OUTPUTS, "speaker", 0.43)'], member: 'm_ymsnd', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2312, sourceColumn: 2, sourceEndLine: 2312};
...
MERGE (n:KG {id: 'handler:sega_16bit_sprite_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'sega_16bit_sprite_device', sourceFile: 'src/mame/sega/sega16sp.cpp', sourceLine: 53, sourceColumn: 1, sourceEndLine: 61, sourceParameters: '', sourceBody: '// let the parent do its work
	sprite16_device_ind16::device_start();

	// save states
	save_item(NAME(m_flip));
	save_item(NAME(m_bank));'};
MERGE (n:KG {id: 'handler:segaic16_video_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'segaic16_video_device', sourceFile: 'src/mame/sega/segaic16.cpp', sourceLine: 542, sourceColumn: 1, sourceEndLine: 550, sourceParameters: '', sourceBody: 'if(!m_gfxdecode->started())
...
MATCH (a:KG {id: 'device:segas16a_state.system16a/sprites'}), (b:KG {id: 'handler:sega_16bit_sprite_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:segas16a_state.system16a/segaic16vid'}), (b:KG {id: 'handler:segaic16_video_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
