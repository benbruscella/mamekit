...
// generated 2026-09-17T07:12:32.822Z
...
MERGE (n:KG {id: 'device:segas16a_state.system16a/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(2048*2)'], member: 'm_palette', sourceFile: 'src/mame/sega/segas16a.cpp', sourceLine: 2305, sourceColumn: 2, sourceEndLine: 2305};
