...
- **Credited by MAMEDEV:** Aaron Giles (driver header); David Haywood (3 release notes); Phil Bennett (2 release notes); Steven Coomber (2 release notes); hap (1 release note); TheLostNinja (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 297 commits by 37 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
