...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_upd7751_p2_r(runtime) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_upd7751_p2_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_upd7751_rom_offset_w_0(runtime, data) {
                const members = runtime.members;
                let mask = ((((((15) << (0))) & (16383))) | 0);
                let newdata = ((((((data) << (0))) & (mask))) | 0);
                members.m_upd7751_rom_address = (((((((members.m_upd7751_rom_address ?? runtime.member("m_upd7751_rom_address"))) & ((~mask)))) | (newdata))) >>> 0);
            }
            function method_upd7751_rom_offset_w_4(runtime, data) {
                const members = runtime.members;
                let mask = ((((((15) << (4))) & (16383))) | 0);
                let newdata = ((((((data) << (4))) & (mask))) | 0);
                members.m_upd7751_rom_address = (((((((members.m_upd7751_rom_address ?? runtime.member("m_upd7751_rom_address"))) & ((~mask)))) | (newdata))) >>> 0);
            }
            function method_upd7751_rom_offset_w_8(runtime, data) {
                const members = runtime.members;
                let mask = ((((((15) << (8))) & (16383))) | 0);
                let newdata = ((((((data) << (8))) & (mask))) | 0);
                members.m_upd7751_rom_address = (((((((members.m_upd7751_rom_address ?? runtime.member("m_upd7751_rom_address"))) & ((~mask)))) | (newdata))) >>> 0);
            }
            function method_upd7751_rom_offset_w_12(runtime, data) {
                const members = runtime.members;
                let mask = ((((((15) << (12))) & (16383))) | 0);
                let newdata = ((((((data) << (12))) & (mask))) | 0);
                members.m_upd7751_rom_address = (((((((members.m_upd7751_rom_address ?? runtime.member("m_upd7751_rom_address"))) & ((~mask)))) | (newdata))) >>> 0);
            }
            function method_tilemap_sound_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_screen_update(runtime, screen, bitmap, cliprect) {
                ...
                let sprites = (__l["m_sprites.bitmap"] ? __l["m_sprites.bitmap"]() : (members.m_sprites) != null ? (typeof (runtime.dereference(members.m_sprites)).bitmap === 'function' ? (runtime.dereference(members.m_sprites)).bitmap() : typeof (runtime.dereference(members.m_sprites)).bitmap === 'number' || typeof (runtime.dereference(members.m_sprites)).bitmap === 'boolean' ? (runtime.dereference(members.m_sprites)).bitmap : runtime.container(members.m_sprites, "bitmap")) : 0);
                (__l["m_sprites.iterate_dirty_rects"] ? __l["m_sprites.iterate_dirty_rects"](cliprect, ((rect) => {
                    for (let y = ((rect.min_y) | 0); ((Number(y) <= Number(rect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                        let dest = bitmap["pix&"](y);
                        let src = sprites["pix&"](y);
                        let pri = (__l["screen.priority"] ? __l["screen.priority"]() : (screen) != null ? (typeof (runtime.dereference(screen)).priority === 'function' ? (runtime.dereference(screen)).priority() : typeof (runtime.dereference(screen)).priority === 'number' || typeof (runtime.dereference(screen)).priority === 'boolean' ? (runtime.dereference(screen)).priority : runtime.container(screen, "priority")) : (__l["priority"]?.() ?? 0))["pix&"](y);
                        for (let x = ((rect.min_x) | 0); ((Number(x) <= Number(rect.max_x)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                            let pix = ((runtime.readIndex(src, x)) & 0xffff);
                            if (((Number(pix) !== Number(65535)) ? 1 : 0)) {
                                let priority = ((runtime.shiftRight(pix, 10)) | 0);
                ...
                })) : (members.m_sprites) != null ? ((runtime.dereference(members.m_sprites)).iterate_dirty_rects?.(cliprect, ((rect) => {
                    for (let y = ((rect.min_y) | 0); ((Number(y) <= Number(rect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                        let dest = bitmap["pix&"](y);
                        let src = sprites["pix&"](y);
                        let pri = (__l["screen.priority"] ? __l["screen.priority"]() : (screen) != null ? (typeof (runtime.dereference(screen)).priority === 'function' ? (runtime.dereference(screen)).priority() : typeof (runtime.dereference(screen)).priority === 'number' || typeof (runtime.dereference(screen)).priority === 'boolean' ? (runtime.dereference(screen)).priority : runtime.container(screen, "priority")) : (__l["priority"]?.() ?? 0))["pix&"](y);
