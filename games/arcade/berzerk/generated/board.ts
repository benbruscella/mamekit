...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_vsync_chain_counter_to_vpos(runtime: any, counter: any, v256: any) {
  ...
  function method_magicram_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_audio_r(runtime: any, offset: any) {
    const members = runtime.members;
    switch (offset) {
      case 4:
      {
  ...
  function method_audio_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    switch (offset) {
      case 4:
      {
        switch (((data) >>> (6))) {
          ...
          case 1:
          {
            ...
            let clock_divisor: any = ((16) - (((data) & (7))));
  ...
  function method_magicram_control_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_nmi_enable_r(runtime: any) {
    const members = runtime.members;
    members.m_nmi_enabled = ((1) & 0xff);
    return 0;
  }

  function method_nmi_enable_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_nmi_enabled = ((1) & 0xff);
  }

  function method_nmi_disable_r(runtime: any) {
    const members = runtime.members;
    members.m_nmi_enabled = ((0) & 0xff);
    return 0;
  }

  function method_nmi_disable_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_nmi_enabled = ((0) & 0xff);
  }

  function method_vpos_to_vsync_chain_counter(runtime: any, vpos: any, counter: any, v256: any) {
    const members = runtime.members;
    runtime.pointerStore(v256, (((((Number(vpos) < Number(32)) ? 1 : 0)) || (((Number(vpos) >= Number(256)) ? 1 : 0))) ? 1 : 0));
    if (runtime.dereference(v256)) {
      let temp: any = runtime.add(((vpos) - (256)), 218);
  ...
  function method_led_off_r(runtime: any) {
    const members = runtime.members;
    members.m_led = 0;
    return 0;
  }

  function method_led_off_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_led = 0;
  }

  function method_led_on_r(runtime: any) {
    const members = runtime.members;
    members.m_led = 1;
    return 0;
  }

  function method_led_on_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_led = 1;
  }

  function method_vector_r(runtime: any, irqline: any) {
    const members = runtime.members;
    return 252;
  }
  return {
