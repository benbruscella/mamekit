...
// generated 2026-09-24T02:25:50.112Z
...
MERGE (n:KG {id: 'callback:timer/berzerk_state.irq_callback'}) SET n:Callback SET n += {ownerTag: 'irq_timer', signal: 'timer', operation: 'adjust', targetClass: 'berzerk_state', targetMethod: 'irq_callback', startClass: 'berzerk_state', startMethod: 'create_irq_timer', scanlines: [128, 256], sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 284, sourceColumn: 1, sourceEndLine: 303};
...
MERGE (n:KG {id: 'machine:berzerk_state.berzerk'}) SET n:MachineConfig SET n += {cls: 'berzerk_state', name: 'berzerk', calls: [], stateMembers: ['{"name":"m_magicram_control","bits":8}', '{"name":"m_last_shift_data","bits":8}', '{"name":"m_intercept","bits":8}', '{"name":"m_irq_enabled","bits":8}', '{"name":"m_nmi_enabled","bits":8}', '{"name":"m_p1_counter_74ls161","bits":32,"signed":true}', '{"name":"m_p1_direction","bits":32,"signed":true}', '{"name":"m_p2_counter_74ls161","bits":32,"signed":true}', '{"name":"m_p2_direction","bits":32,"signed":true}'], driverTimers: ['m_irq_timer=berzerk_state.irq_callback', 'm_nmi_timer=berzerk_state.nmi_callback'], resetHandlers: ['berzerk_state.machine_reset'], startHandlers: ['berzerk_state.video_start'], sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1174, sourceColumn: 1, sourceEndLine: 1200};
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/ls181_10c'}) SET n:Device SET n += {type: 'TTL74181', tag: 'ls181_10c', clock: null, config: ['TTL74181(config, m_ls181_10c)'], member: 'm_ls181_10c', sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1184, sourceColumn: 2, sourceEndLine: 1184};
MERGE (n:KG {id: 'device:berzerk_state.berzerk/ls181_12c'}) SET n:Device SET n += {type: 'TTL74181', tag: 'ls181_12c', clock: null, config: ['TTL74181(config, m_ls181_12c)'], member: 'm_ls181_12c', sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1185, sourceColumn: 2, sourceEndLine: 1185};
MERGE (n:KG {id: 'device:berzerk_state.berzerk/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(PIXEL_CLOCK, HTOTAL, HBEND, HBSTART, VTOTAL, VBEND, VBSTART)', 'm_screen->set_screen_update(FUNC(berzerk_state::screen_update))'], member: 'm_screen', sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1188, sourceColumn: 2, sourceEndLine: 1188, configCalls: ['set_raw(5000000,320,0,256,262,32,256)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5000000, 320, 0, 256, 262, 32, 256], screenRawExpr: ['PIXEL_CLOCK', 'HTOTAL', 'HBEND', 'HBSTART', 'VTOTAL', 'VBEND', 'VBSTART']};
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/speech'}) SET n:Device SET n += {type: 'S14001A', tag: 'speech', clock: 19531.25, config: ['S14001A(config, m_s14001a, S14001_CLOCK/16/8)', 'm_s14001a->add_route(ALL_OUTPUTS, "s14001a_volume", 0.5)'], member: 'm_s14001a', sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1195, sourceColumn: 2, sourceEndLine: 1195};
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/s14001a_volume'}) SET n:Device SET n += {type: 'FILTER_VOLUME', tag: 's14001a_volume', clock: null, config: ['FILTER_VOLUME(config, m_s14001a_volume).add_route(ALL_OUTPUTS, "mono", 1.0)'], member: 'm_s14001a_volume', sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1197, sourceColumn: 2, sourceEndLine: 1197};
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/exidy'}) SET n:Device SET n += {type: 'EXIDY', tag: 'exidy', clock: 0, config: ['EXIDY(config, m_custom).add_route(ALL_OUTPUTS, "mono", 0.33)'], member: 'm_custom', cls: 'exidy_sound_device', clsHierarchy: ['exidy_sound_device'], sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1199, sourceColumn: 2, sourceEndLine: 1199};
...
MERGE (n:KG {id: 'inputs:joystick/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:joystick/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:joystick/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:joystick/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:joystick/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 16};
MERGE (n:KG {id: 'inputs:joystick/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 224, activeLow: true, type: 'IPT_UNUSED', defaultValue: 224};
MERGE (n:KG {id: 'inputs:joystick/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:joystick/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:joystick/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:joystick/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:joystick/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:joystick/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:joystick/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 96, activeLow: true, type: 'IPT_UNUSED', defaultValue: 96};
...
MERGE (n:KG {id: 'inputs:common/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:common/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2', defaultValue: 2};
MERGE (n:KG {id: 'inputs:common/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 28, activeLow: true, type: 'IPT_UNUSED', defaultValue: 28};
MERGE (n:KG {id: 'inputs:common/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN3', defaultValue: 32};
MERGE (n:KG {id: 'inputs:common/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2', defaultValue: 64};
MERGE (n:KG {id: 'inputs:common/SYSTEM/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1', defaultValue: 128};
...
MERGE (n:KG {id: 'inputs:common/MONITOR_TYPE/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 254, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:common/SW2'}) SET n:Port SET n += {tag: 'SW2', modify: false};
MERGE (n:KG {id: 'inputs:common/SW2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE1', modifiers: ['PORT_NAME("Free Game (not logged in bookkeeping)")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:common/SW2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 126, activeLow: true, type: 'IPT_UNUSED', defaultValue: 126};
MERGE (n:KG {id: 'inputs:common/SW2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_SERVICE2', modifiers: ['PORT_NAME("Bookkeeping")', 'PORT_CODE(KEYCODE_F1)'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:berzerk/F2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_CODE(KEYCODE_F5)', 'PORT_TOGGLE', 'PORT_DIPLOCATION("F2:1,2")'], name: 'Color Test', defaultValue: 0, location: 'F2:1,2', settings: ['0=Off', '3=On']};
MERGE (n:KG {id: 'inputs:berzerk/F2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 60, activeLow: true, type: 'IPT_UNUSED', defaultValue: 60};
MERGE (n:KG {id: 'inputs:berzerk/F2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("F2:7,8")'], name: 'Bonus Life', defaultValue: 192, location: 'F2:7,8', settings: ['192=5000 and 10000', '64=5000', '128=10000', '0=None']};
MERGE (n:KG {id: 'inputs:berzerk/F3'}) SET n:Port SET n += {tag: 'F3', modify: false};
MERGE (n:KG {id: 'inputs:berzerk/F3/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_CODE(KEYCODE_F2)', 'PORT_TOGGLE', 'PORT_DIPLOCATION("F3:1")'], name: 'Input Test Mode', defaultValue: 0, location: 'F3:1', settings: ['0=Off', '1=On']};
MERGE (n:KG {id: 'inputs:berzerk/F3/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, modifiers: ['PORT_CODE(KEYCODE_F4)', 'PORT_TOGGLE', 'PORT_DIPLOCATION("F3:2")'], name: 'Crosshair Pattern', defaultValue: 0, location: 'F3:2', settings: ['0=Off', '2=On']};
MERGE (n:KG {id: 'inputs:berzerk/F3/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 60, activeLow: true, type: 'IPT_UNUSED', defaultValue: 60};
MERGE (n:KG {id: 'inputs:berzerk/F3/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("F3:7,8")'], name: 'Language', defaultValue: 0, location: 'F3:7,8', settings: ['0=English', '64=German', '128=French', '192=Spanish']};
MERGE (n:KG {id: 'inputs:berzerk/F4'}) SET n:Port SET n += {tag: 'F4', modify: false};
MERGE (n:KG {id: 'inputs:berzerk/F4/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, modifiers: ['PORT_DIPLOCATION(#F4":1,2,3,4")'], name: '"Coin "#1', defaultValue: 0, location: '#F4":1,2,3,4"', settings: ['9=2C 1C', '13=4C 3C', '0=1C 1C', '14=4C 5C', '10=2C 3C', '15=4C 7C', '1=1C 2C', '11=2C 5C', '2=1C 3C', '12=2C 7C', '3=1C 4C', '4=1C 5C', '5=1C 6C', '6=1C 7C', '7=1C 10C', '8=1 Coin/14 Credits']};
MERGE (n:KG {id: 'inputs:berzerk/F4/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: true, type: 'IPT_UNUSED', defaultValue: 240};
MERGE (n:KG {id: 'inputs:berzerk/F5'}) SET n:Port SET n += {tag: 'F5', modify: false};
MERGE (n:KG {id: 'inputs:berzerk/F5/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, modifiers: ['PORT_DIPLOCATION(#F5":1,2,3,4")'], name: '"Coin "#2', defaultValue: 0, location: '#F5":1,2,3,4"', settings: ['9=2C 1C', '13=4C 3C', '0=1C 1C', '14=4C 5C', '10=2C 3C', '15=4C 7C', '1=1C 2C', '11=2C 5C', '2=1C 3C', '12=2C 7C', '3=1C 4C', '4=1C 5C', '5=1C 6C', '6=1C 7C', '7=1C 10C', '8=1 Coin/14 Credits']};
MERGE (n:KG {id: 'inputs:berzerk/F5/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: true, type: 'IPT_UNUSED', defaultValue: 240};
MERGE (n:KG {id: 'inputs:berzerk/F6'}) SET n:Port SET n += {tag: 'F6', modify: false};
MERGE (n:KG {id: 'inputs:berzerk/F6/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, modifiers: ['PORT_DIPLOCATION(#F6":1,2,3,4")'], name: '"Coin "#3', defaultValue: 0, location: '#F6":1,2,3,4"', settings: ['9=2C 1C', '13=4C 3C', '0=1C 1C', '14=4C 5C', '10=2C 3C', '15=4C 7C', '1=1C 2C', '11=2C 5C', '2=1C 3C', '12=2C 7C', '3=1C 4C', '4=1C 5C', '5=1C 6C', '6=1C 7C', '7=1C 10C', '8=1 Coin/14 Credits']};
MERGE (n:KG {id: 'inputs:berzerk/F6/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: true, type: 'IPT_UNUSED', defaultValue: 240};
