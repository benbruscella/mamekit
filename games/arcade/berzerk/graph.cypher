...
// generated 2026-09-05T03:49:18.041Z
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(PIXEL_CLOCK, HTOTAL, HBEND, HBSTART, VTOTAL, VBEND, VBSTART)', 'm_screen->set_screen_update(FUNC(berzerk_state::screen_update))'], sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1188, sourceColumn: 2, sourceEndLine: 1188, configCalls: ['set_raw(5000000,320,0,256,262,32,256)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5000000, 320, 0, 256, 262, 32, 256], screenRawExpr: ['PIXEL_CLOCK', 'HTOTAL', 'HBEND', 'HBSTART', 'VTOTAL', 'VBEND', 'VBSTART']};
...
MERGE (n:KG {id: 'device:berzerk_state.berzerk/exidy'}) SET n:Device SET n += {type: 'EXIDY', tag: 'exidy', clock: 0, config: ['EXIDY(config, m_custom).add_route(ALL_OUTPUTS, "mono", 0.33)'], cls: 'exidy_sound_device', clsHierarchy: ['exidy_sound_device'], sourceFile: 'src/mame/stern/berzerk.cpp', sourceLine: 1199, sourceColumn: 2, sourceEndLine: 1199};
