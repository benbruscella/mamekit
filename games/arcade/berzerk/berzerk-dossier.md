...
- **Credited by MAMEDEV:** Aaron Giles (driver header); Jonathan Gevaryahu (driver header); R. Belmont (driver header); Zsolt Vasvari (driver header); Kevin Eshbach (machine); The Dumping Union (machine); David Haywood (1 release note); hap (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 209 commits by 33 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
