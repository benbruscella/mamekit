...
defined.compiledHandlers = {
  ...
  function method_trampoline_r(runtime: any, offset: any): any {
    ...
    let data: any = (((__l["m_mainmap.read8"] ? __l["m_mainmap.read8"](offset) : (members.m_mainmap) != null ? ((runtime.dereference(members.m_mainmap)).read8?.(offset) ?? 0) : 0)) & 0xff);
    (runtime.overrides["load_madsel"] ? runtime.overrides["load_madsel"](data) : method_load_madsel(runtime, data));
    return data;
  }

  function method_get_madsel(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let madsel: any = ((0) ? 1 : 0);
  ...
  function method_vram_mad_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let vramaddr: any = 0;
    let vramdata: any = ((0) & 0xff);
    let vrammask: any = ((0) & 0xff);
  ...
  function method_get_bit3_addr(runtime: any, pixaddr: any): any {
    const members = runtime.members;
  ...
  function method_load_madsel(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_trampoline_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_vram_mad_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_trackball_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_palette_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_irqack_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_irq_state = ((0) & 0xff);
  }

  function method_sync_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_screen_update_missile(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    for (let y: any = (((__l["cliprect.top"] ? __l["cliprect.top"]() : (cliprect) != null ? (typeof (runtime.dereference(cliprect)).top === 'function' ? (runtime.dereference(cliprect)).top() : typeof (runtime.dereference(cliprect)).top === 'number' || typeof (runtime.dereference(cliprect)).top === 'boolean' ? (runtime.dereference(cliprect)).top : runtime.container(cliprect, "top")) : (__l["top"]?.() ?? 0))) | 0); ((Number(y) <= Number((__l["cliprect.bottom"] ? __l["cliprect.bottom"]() : (cliprect) != null ? (typeof (runtime.dereference(cliprect)).bottom === 'function' ? (runtime.dereference(cliprect)).bottom() : typeof (runtime.dereference(cliprect)).bottom === 'number' || typeof (runtime.dereference(cliprect)).bottom === 'boolean' ? (runtime.dereference(cliprect)).bottom : runtime.container(cliprect, "bottom")) : (__l["bottom"]?.() ?? 0)))) ? 1 : 0); y = ((((y) + (1))) | 0)) {
      let dst: any = bitmap["pix&"](y);
      let effy: any = (((((members.m_flipscreen ?? runtime.member("m_flipscreen"))) ? (((((280) - (y))) & (255))) : (y))) | 0);
      let src: any = runtime.addressOf((members.m_videoram ?? runtime.member("m_videoram")), ((effy) * (64)));
      let src3: any = 0;
      ...
      for (let x: any = (((__l["cliprect.left"] ? __l["cliprect.left"]() : (cliprect) != null ? (typeof (runtime.dereference(cliprect)).left === 'function' ? (runtime.dereference(cliprect)).left() : typeof (runtime.dereference(cliprect)).left === 'number' || typeof (runtime.dereference(cliprect)).left === 'boolean' ? (runtime.dereference(cliprect)).left : runtime.container(cliprect, "left")) : (__l["left"]?.() ?? 0))) | 0); ((Number(x) <= Number((__l["cliprect.right"] ? __l["cliprect.right"]() : (cliprect) != null ? (typeof (runtime.dereference(cliprect)).right === 'function' ? (runtime.dereference(cliprect)).right() : typeof (runtime.dereference(cliprect)).right === 'number' || typeof (runtime.dereference(cliprect)).right === 'boolean' ? (runtime.dereference(cliprect)).right : runtime.container(cliprect, "right")) : (__l["right"]?.() ?? 0)))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
        let pix: any = ((runtime.shiftRight(runtime.readIndex(src, runtime.divide(x, 4)), ((x) & (3)))) & 0xff);
