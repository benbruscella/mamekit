...
defined.compiledHandlers = {
  ...
  function method_xevious_fg_colorram_w(runtime: any, offset: any, data: any): any {
  ...
  function method_xevious_bg_colorram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_xevious_fg_videoram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_xevious_bg_videoram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_xevious_vh_latch_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let reg: any = ((0) | 0);
    let scroll: any = ((((data) + (((((offset) & (1))) << (8))))) | 0);
    reg = ((runtime.shiftRight(((offset) & (240)), 4)) | 0);
    switch (reg) {
      case 0:
      {
  ...
  function method_xevious_bs_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let color: any = ((((((runtime.shiftRight(((attr) & (60)), 2)) | (runtime.shiftRight(((code) & (128)), 3)))) | (((((attr) & (3))) << (5))))) & 0xff);
    (__l["tileinfo.set"] ? __l["tileinfo.set"](1, ((code) + (((((attr) & (1))) << (8)))), color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(1, ((code) + (((((attr) & (1))) << (8)))), color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ?? 0) : (__l["set"]?.(1, ((code) + (((((attr) & (1))) << (8)))), color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ?? 0));
  }
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let color: any = ((((((((attr) & (3))) << (4))) | (runtime.shiftRight(((attr) & (60)), 2)))) & 0xff);
    (__l["tileinfo.set"] ? __l["tileinfo.set"](0, ((runtime.readIndex((members.m_xevious_fg_videoram ?? runtime.member("m_xevious_fg_videoram")), tile_index)) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (256) : (0)))), color, (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ^ ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, ((runtime.readIndex((members.m_xevious_fg_videoram ?? runtime.member("m_xevious_fg_videoram")), tile_index)) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (256) : (0)))), color, (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ^ ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))))) ?? 0) : (__l["set"]?.(0, ((runtime.readIndex((members.m_xevious_fg_videoram ?? runtime.member("m_xevious_fg_videoram")), tile_index)) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (256) : (0)))), color, (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ^ ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))))) ?? 0));
  }

  function method_screen_update_xevious(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
