...
// generated 2026-09-24T02:31:11.526Z
...
MERGE (n:KG {id: 'machine:xevious_state.xevious'}) SET n:MachineConfig SET n += {cls: 'xevious_state', name: 'xevious', calls: [], stateMembers: ['{"name":"m_galaga_gfxbank","bits":32,"initial":0}', '{"name":"m_main_irq_mask","bits":8,"initial":0}', '{"name":"m_sub_irq_mask","bits":8,"initial":0}', '{"name":"m_sub2_nmi_mask","bits":8,"initial":0}', '{"name":"m_xevious_bs","bits":32,"signed":true,"arrayLength":2}'], driverTimers: ['m_cpu3_interrupt_timer=galaga_state.cpu3_interrupt_callback'], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['xevious_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1766, sourceColumn: 1, sourceEndLine: 1838};
MERGE (n:KG {id: 'device:xevious_state.xevious/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, MASTER_CLOCK/6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &xevious_state::xevious_map)'], member: 'm_maincpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1769, sourceColumn: 2, sourceEndLine: 1769};
MERGE (n:KG {id: 'device:xevious_state.xevious/sub'}) SET n:Device SET n += {type: 'Z80', tag: 'sub', clock: 3072000, config: ['Z80(config, m_subcpu, MASTER_CLOCK/6)', 'm_subcpu->set_addrmap(AS_PROGRAM, &xevious_state::xevious_map)'], member: 'm_subcpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1772, sourceColumn: 2, sourceEndLine: 1772};
MERGE (n:KG {id: 'device:xevious_state.xevious/sub2'}) SET n:Device SET n += {type: 'Z80', tag: 'sub2', clock: 3072000, config: ['Z80(config, m_subcpu2, MASTER_CLOCK/6)', 'm_subcpu2->set_addrmap(AS_PROGRAM, &xevious_state::xevious_map)'], member: 'm_subcpu2', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1775, sourceColumn: 2, sourceEndLine: 1775};
...
MERGE (n:KG {id: 'device:xevious_state.xevious/50xx'}) SET n:Device SET n += {type: 'NAMCO_50XX', tag: '50xx', clock: 1536000, config: ['NAMCO_50XX(config, "50xx", MASTER_CLOCK/6/2)'], cls: 'namco_50xx_device', clsHierarchy: ['namco_50xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1788, sourceColumn: 2, sourceEndLine: 1788, startHandler: 'namco_50xx_device.device_start'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx'}) SET n:Device SET n += {type: 'NAMCO_51XX', tag: '51xx', clock: 1536000, config: ['namco_51xx_device &n51xx(NAMCO_51XX(config, "51xx", MASTER_CLOCK/6/2))', 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', 'n51xx.output_callback().set(FUNC(galaga_state::out))', 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))'], cls: 'namco_51xx_device', clsHierarchy: ['namco_51xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1790, sourceColumn: 2, sourceEndLine: 1790, startHandler: 'namco_51xx_device.device_start'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:0'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1791, sourceColumn: 2, sourceEndLine: 1791, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:1'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1792, sourceColumn: 2, sourceEndLine: 1792, slot: '1', transforms: ['rshift(4)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:2'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1793, sourceColumn: 2, sourceEndLine: 1793, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:3'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1794, sourceColumn: 2, sourceEndLine: 1794, slot: '3', transforms: ['rshift(4)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:4'}) SET n:Callback SET n += {signal: 'output_callback', member: 'm_out', operation: 'set', raw: 'n51xx.output_callback().set(FUNC(galaga_state::out))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1795, sourceColumn: 2, sourceEndLine: 1795, targetClass: 'galaga_state', targetMethod: 'out'};
MERGE (n:KG {id: 'device:xevious_state.xevious/51xx/callback:51xx:5'}) SET n:Callback SET n += {signal: 'lockout_callback', member: 'm_lockout', operation: 'set', raw: 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1796, sourceColumn: 2, sourceEndLine: 1796, targetClass: 'galaga_state', targetMethod: 'lockout'};
MERGE (n:KG {id: 'device:xevious_state.xevious/54xx'}) SET n:Device SET n += {type: 'NAMCO_54XX', tag: '54xx', clock: 1536000, config: ['namco_54xx_device &n54xx(NAMCO_54XX(config, "54xx", MASTER_CLOCK/6/2))', 'n54xx.set_discrete("discrete")', 'n54xx.set_basenote(NODE_01)'], cls: 'namco_54xx_device', clsHierarchy: ['namco_54xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1798, sourceColumn: 2, sourceEndLine: 1798, configCalls: ['set_discrete("discrete")'], startHandler: 'namco_54xx_device.device_start'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx'}) SET n:Device SET n += {type: 'NAMCO_06XX', tag: '06xx', clock: 48000, config: ['namco_06xx_device &n06xx(NAMCO_06XX(config, "06xx", MASTER_CLOCK/6/64))', 'n06xx.set_maincpu(m_maincpu)', 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', 'n06xx.chip_select_callback<2>().set("50xx", FUNC(namco_50xx_device::chip_select))', 'n06xx.rw_callback<2>().set("50xx", FUNC(namco_50xx_device::rw))', 'n06xx.read_callback<2>().set("50xx", FUNC(namco_50xx_device::read))', 'n06xx.write_callback<2>().set("50xx", FUNC(namco_50xx_device::write))', 'n06xx.write_callback<3>().set("54xx", FUNC(namco_54xx_device::write))', 'n06xx.chip_select_callback<3>().set("54xx", FUNC(namco_54xx_device::chip_select))'], cls: 'namco_06xx_device', clsHierarchy: ['namco_06xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1802, sourceColumn: 2, sourceEndLine: 1802, configCalls: ['set_maincpu("maincpu")'], startHandler: 'namco_06xx_device.device_start', deviceTimers: ['m_nmi_timer=namco_06xx_device.nmi_generate']};
...
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:1'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1804, sourceColumn: 2, sourceEndLine: 1804, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:2'}) SET n:Callback SET n += {signal: 'rw_callback', member: 'm_rw', operation: 'set', raw: 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1805, sourceColumn: 2, sourceEndLine: 1805, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'rw'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:3'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1806, sourceColumn: 2, sourceEndLine: 1806, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'read'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:4'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1807, sourceColumn: 2, sourceEndLine: 1807, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:5'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<2>().set("50xx", FUNC(namco_50xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1808, sourceColumn: 2, sourceEndLine: 1808, slot: '2', targetTag: '50xx', targetClass: 'namco_50xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:6'}) SET n:Callback SET n += {signal: 'rw_callback', member: 'm_rw', operation: 'set', raw: 'n06xx.rw_callback<2>().set("50xx", FUNC(namco_50xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1809, sourceColumn: 2, sourceEndLine: 1809, slot: '2', targetTag: '50xx', targetClass: 'namco_50xx_device', targetMethod: 'rw'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:7'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<2>().set("50xx", FUNC(namco_50xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1810, sourceColumn: 2, sourceEndLine: 1810, slot: '2', targetTag: '50xx', targetClass: 'namco_50xx_device', targetMethod: 'read'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:8'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<2>().set("50xx", FUNC(namco_50xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1811, sourceColumn: 2, sourceEndLine: 1811, slot: '2', targetTag: '50xx', targetClass: 'namco_50xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:9'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<3>().set("54xx", FUNC(namco_54xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1812, sourceColumn: 2, sourceEndLine: 1812, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:xevious_state.xevious/06xx/callback:06xx:10'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<3>().set("54xx", FUNC(namco_54xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1813, sourceColumn: 2, sourceEndLine: 1813, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:xevious_state.xevious/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_xevious)'], member: 'm_gfxdecode', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1827, sourceColumn: 2, sourceEndLine: 1827, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:xevious_state.xevious/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(xevious_state::xevious_palette), 128*4 + 64*8 + 64*2, 128+1)'], member: 'm_palette', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1828, sourceColumn: 2, sourceEndLine: 1828, clockExpr: 'FUNC(xevious_state::xevious_palette)', paletteEntries: 129};
...
MERGE (n:KG {id: 'device:namco_50xx_device.device_add_mconfig/mcu'}) SET n:Device SET n += {type: 'MB8842', tag: 'mcu', clock: 1536000, config: ['MB8842(config, m_cpu, DERIVED_CLOCK(1,1))', 'm_cpu->read_k().set(FUNC(namco_50xx_device::K_r))', 'm_cpu->read_r<0>().set(FUNC(namco_50xx_device::R0_r))', 'm_cpu->read_r<2>().set(FUNC(namco_50xx_device::R2_r))', 'm_cpu->write_o().set(FUNC(namco_50xx_device::O_w))'], member: 'm_cpu', sourceFile: 'src/mame/namco/namco50.cpp', sourceLine: 240, sourceColumn: 2, sourceEndLine: 240};
...
MERGE (n:KG {id: 'handler:namco_50xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_50xx_device', sourceFile: 'src/mame/namco/namco50.cpp', sourceLine: 227, sourceColumn: 1, sourceEndLine: 232, sourceParameters: '', sourceBody: 'save_item(NAME(m_rw));
...
MATCH (a:KG {id: 'device:xevious_state.xevious/50xx'}), (b:KG {id: 'handler:namco_50xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:xevious_state.xevious/51xx'}), (b:KG {id: 'handler:namco_51xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:xevious_state.xevious/54xx'}), (b:KG {id: 'machine:namco_54xx_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:xevious_state.xevious/54xx'}), (b:KG {id: 'handler:namco_54xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:xevious_state.xevious/06xx'}), (b:KG {id: 'handler:namco_06xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
