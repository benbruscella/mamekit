...
![marquee](/artwork/media/marquees/xevious.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/xevious.webp) | ![cabinet](/artwork/media/cabinets/xevious.webp) |
...
| `sub` | Z80 | 3.072 MHz | 17 |
| `sub2` | Z80 | 3.072 MHz | 17 |
...
| --- | --- | --- | --- | --- |
| `maincpu` | `xvi_1.3p` | 0x0 | 0x1000 | `09964dda` |
| `maincpu` | `xvi_2.3m` | 0x1000 | 0x1000 | `60ecce84` |
| `maincpu` | `xvi_3.2m` | 0x2000 | 0x1000 | `79754b7d` |
| `maincpu` | `xvi_4.2l` | 0x3000 | 0x1000 | `c7d4bbf0` |
| `sub` | `xvi_5.3f` | 0x0 | 0x1000 | `c85b703f` |
| `sub` | `xvi_6.3j` | 0x1000 | 0x1000 | `e18cdaad` |
| `sub2` | `xvi_7.2c` | 0x0 | 0x1000 | `dd35cf1c` |
| `gfx1` | `xvi_12.3b` | 0x0 | 0x1000 | `088c8b26` |
| `gfx2` | `xvi_13.3c` | 0x0 | 0x1000 | `de60ba25` |
| `gfx2` | `xvi_14.3d` | 0x1000 | 0x1000 | `535cdbbc` |
| `gfx3` | `xvi_15.4m` | 0x0 | 0x2000 | `dc2c0ecb` |
| `gfx3` | `xvi_17.4p` | 0x2000 | 0x2000 | `dfb587ce` |
| `gfx3` | `xvi_16.4n` | 0x4000 | 0x1000 | `605ca889` |
| `gfx3` | `xvi_18.4r` | 0x5000 | 0x2000 | `02417d19` |
| `gfx4` | `xvi_9.2a` | 0x0 | 0x1000 | `57ed9879` |
| `gfx4` | `xvi_10.2b` | 0x1000 | 0x2000 | `ae3ba9e5` |
| `gfx4` | `xvi_11.2c` | 0x3000 | 0x1000 | `31e244dd` |
| `proms` | `xvi-8.6a` | 0x0 | 0x100 | `5cc2727f` |
| `proms` | `xvi-9.6d` | 0x100 | 0x100 | `5c8796cc` |
| `proms` | `xvi-10.6e` | 0x200 | 0x100 | `3cb60975` |
| `proms` | `xvi-7.4h` | 0x300 | 0x200 | `22d98032` |
| `proms` | `xvi-6.4f` | 0x500 | 0x200 | `3a7599f0` |
| `proms` | `xvi-4.3l` | 0x700 | 0x200 | `fd8b9d91` |
| `proms` | `xvi-5.3m` | 0x900 | 0x200 | `bf906d82` |
| `pals_vidbd` | `xvi-3.1f` | 0x0 | 0x117 | `9192d57a` |
| `namco` | `xvi-2.7n` | 0x0 | 0x100 | `550f06bc` |
| `namco` | `xvi-1.5n` | 0x100 | 0x100 | `77245b66` |
| `50xx:mcu` | `50xx.bin` | 0x0 | 0x800 | `a0acbaf7` |
...
| Coin A | `DSWA` | 0x3 | 0x3 |
| Bonus Life | `DSWA` | 0x1c | 0x1c |
| Lives | `DSWA` | 0x60 | 0x60 |
| Cabinet | `DSWA` | 0x80 | 0x80 |
| Flags Award Bonus Life | `DSWB` | 0x2 | 0x2 |
| Coin B | `DSWB` | 0xc | 0xc |
| Difficulty | `DSWB` | 0x60 | 0x60 |
| Freeze | `DSWB` | 0x80 | 0x80 |
...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); hackbar (4 release notes); hap (4 release notes); AJR (1 release note); Alex Jackson (1 release note); ClawGrip (1 release note); neSneSgB (1 release note); Osso (1 release note); Recreativas.org (1 release note); s.ronco (1 release note); Xavier Panadero (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 283 commits by 37 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
...
### Trivia
Xevious was released on December 22, 1982 (Wednesday) in Japan.
...
Marco Borroni holds the official record for this game with 7,009,560 points (!) on August 16, 1984. 
...
[JP] Nintendo Famicom Disk (may.18, 1990) "Xevious [Model NDS-XEV]"
...
[EU] [AU] [JP] [KO] Microsoft XBOX 360 [XBLA] (may.23, 2007) 
...
[JP] Nintendo Wii [Virtual Console Arcade] (sept.1, 2009) 
...
[JP] Nintendo 3DS [3DSWare] (june.7, 2011) "3D Classics: Xevious [Model CTR-SABJ-JPN]": Re-mastered version, featuring 3D effects.
[EU] Nintendo 3DS [3DSWare] (jul.21, 2011) "3D Classics: Xevious [Model CTR-SABP-EUR]": Re-mastered version, featuring 3D effects.
[AU] Nintendo 3DS [3DSWare] (jul.21, 2011) "3D Classics: Xevious [Model CTR-SABP-AUS]": Re-mastered version, featuring 3D effects.

* COMPUTERS: 
[JP] Sharp MZ2500 (1982) 
Atari 800 (1984) 
Apple II (1984) 
Tandy Color Computer (1984) "Devious" 
[JP] Fujitsu FM-7 (1984) 
[JP] NEC PC9801 (1985) by Enix Corporation 
[EU] Commodore C64 (1986) 
[EU] Amstrad CPC (1986) 
[EU] Atari ST (1987) 
[EU] Sinclair ZX Spectrum (1987) 
[JP] MSX 2 (dec.23, 1988) "Xevious Fardraut Densetsu" 
[JP] PC [MS Windows, CD-ROM] (apr.25, 1997) "Namco History Vol.1" 
...
* OTHERS: 
[JP] Let's! TV play classic series - Namco Nostalgia 1
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/3217/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `galaga`. Play it at [../../../app/g/xevious/](../../../app/g/xevious/) or [explore the knowledge graph](viewer.html).*
