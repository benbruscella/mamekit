...
const defined = decodeBoardIr(boardData, 'crush');
...
defined.compiledHandlers = {
  ...
  function method_maketrax_protection_w(runtime: any, data: any): any {
    const members = runtime.members;

    if (((Number(data) === Number(0)) ? 1 : 0)) {
      members.m_maketrax_counter = ((0) & 0xff);
      members.m_maketrax_offset = ((0) & 0xff);
      members.m_maketrax_disable_protection = ((1) | 0);
      return;
    }
    if (((Number(data) === Number(1)) ? 1 : 0)) {
      members.m_maketrax_disable_protection = ((0) | 0);
      members.m_maketrax_counter = ((((members.m_maketrax_counter) + (1))) & 0xff);
      if (((Number((members.m_maketrax_counter ?? runtime.member("m_maketrax_counter"))) === Number(60)) ? 1 : 0)) {
        members.m_maketrax_counter = ((0) & 0xff);
        members.m_maketrax_offset = ((((members.m_maketrax_offset) + (1))) & 0xff);
        if (((Number((members.m_maketrax_offset ?? runtime.member("m_maketrax_offset"))) === Number(30)) ? 1 : 0)) {
          members.m_maketrax_offset = ((0) & 0xff);
        }
      }
    }
  ...
  function method_maketrax_special_port2_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_dsw = members.m_dsw ?? runtime.member("m_dsw");
    let protdata: any = [0, 192, 0, 64, 192, 64, 0, 192, 0, 64, 0, 192, 0, 64, 192, 64, 0, 192, 0, 64, 0, 192, 0, 64, 192, 64, 0, 192, 0, 64];
    let data: any = (((((__l["m_dsw[0].read"] ? __l["m_dsw[0].read"]() : (runtime.readIndex(h_m_dsw, 0)) != null ? (typeof (runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read === 'function' ? (runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read() : typeof (runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read === 'number' || typeof (runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read === 'boolean' ? (runtime.dereference(runtime.readIndex(h_m_dsw, 0))).read : runtime.container(runtime.readIndex(h_m_dsw, 0), "read")) : (__l["read"]?.() ?? 0))) & (63))) & 0xff);
    if (((Number((members.m_maketrax_disable_protection ?? runtime.member("m_maketrax_disable_protection"))) === Number(0)) ? 1 : 0)) {
      return ((runtime.readIndex(protdata, (members.m_maketrax_offset ?? runtime.member("m_maketrax_offset")))) | (data));
    }
    switch (offset) {
      case 1:
      case 4:
  ...
  function method_maketrax_special_port3_r(runtime: any, offset: any): any {
    const members = runtime.members;

    let protdata: any = [31, 63, 47, 47, 15, 15, 15, 63, 15, 15, 28, 60, 44, 44, 12, 12, 12, 60, 12, 12, 17, 49, 33, 33, 1, 1, 1, 49, 1, 1];
    if (((Number((members.m_maketrax_disable_protection ?? runtime.member("m_maketrax_disable_protection"))) === Number(0)) ? 1 : 0)) {
      return runtime.readIndex(protdata, (members.m_maketrax_offset ?? runtime.member("m_maketrax_offset")));
    }
    switch (offset) {
      case 0:
      {
  ...
  function method_pacman_videoram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_pacman_colorram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_pacman_read_nop(runtime: any): any {
    const members = runtime.members;

    return 191;
  }

  function method_pacman_interrupt_vector_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_interrupt_vector = ((data) & 0xff);
  }

  function method_pacman_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let code: any = ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index)) | ((((members.m_charbank ?? runtime.member("m_charbank"))) << (8))))) | 0);
    let attr: any = ((((((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (31))) | ((((members.m_colortablebank ?? runtime.member("m_colortablebank"))) << (5))))) | ((((members.m_palettebank ?? runtime.member("m_palettebank"))) << (6))))) | 0);
  ...
  function method_pacman_scan_rows(runtime: any, col: any, row: any, num_cols: any, num_rows: any): any {
    const members = runtime.members;
  ...
  function method_interrupt_vector_r(runtime: any, irqline: any): any {
    const members = runtime.members;
  ...
  function method_screen_update_pacman(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_draw_sprites(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    let spriteclip: any = Object.assign(Object.create(Object.getPrototypeOf((__l["rectangle"] ? __l["rectangle"](16, 271, 0, 223) : runtime.macro("rectangle", 16, 271, 0, 223)))), (__l["rectangle"] ? __l["rectangle"](16, 271, 0, 223) : runtime.macro("rectangle", 16, 271, 0, 223)));
    spriteclip = runtime.andAssign(spriteclip, cliprect);
    for (let offs: any = (((((members.m_spriteram).length) - (2))) | 0); ((Number(offs) > Number(4)) ? 1 : 0); offs = ((((offs) - (2))) | 0)) {
      let color: any = ((0) | 0);
      let sx: any = ((0) | 0);
      let sy: any = ((0) | 0);
      let fx: any = ((0) & 0xff);
    ...
    for (let offs: any = ((4) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (2))) | 0)) {
      let color: any = ((0) | 0);
      let sx: any = ((0) | 0);
      let sy: any = ((0) | 0);
      let fx: any = ((0) & 0xff);
  ...
  return {
    "maketrax_protection_w": method_maketrax_protection_w,
    "maketrax_special_port2_r": method_maketrax_special_port2_r,
    "maketrax_special_port3_r": method_maketrax_special_port3_r,
    ...
    return {
      "pacman_state.maketrax_protection_w": methods["maketrax_protection_w"],
      "pacman_state.maketrax_special_port2_r": methods["maketrax_special_port2_r"],
      "pacman_state.maketrax_special_port3_r": methods["maketrax_special_port3_r"],
...
defined.compiledHandlerLinks = ["bitmap.fill","draw","fill","m_bg_tilemap.draw","m_bg_tilemap.mark_tile_dirty","m_bg_tilemap.set_flip","m_dsw[0].read","m_gfxdecode.gfx","m_maincpu.set_input_line","m_palette.transpen_mask","mark_tile_dirty","read","rectangle","set","set_flip","tileinfo.set"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
