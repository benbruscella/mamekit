...
// generated 2026-08-22T05:52:10.818Z
...
MERGE (n:KG {id: 'game:crush'}) SET n:Game SET n += {name: 'crush', year: '1981', company: 'Alpha Denshi Co. / Kural Samno Electric, Ltd.', fullname: 'Crush Roller (set 1)', monitor: 'ROT90', cls: 'pacman_state', init: 'init_maketrax', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9087, sourceColumn: 1, sourceEndLine: 9087, installedHandlers: ['{"space":"AS_PROGRAM","kind":"write","start":20484,"end":20484,"className":"pacman_state","method":"maketrax_protection_w"}', '{"space":"AS_PROGRAM","kind":"read","start":20608,"end":20671,"className":"pacman_state","method":"maketrax_special_port2_r"}', '{"space":"AS_PROGRAM","kind":"read","start":20672,"end":20735,"className":"pacman_state","method":"maketrax_special_port3_r"}']};
...
MERGE (n:KG {id: 'romset:crush'}) SET n:RomSet SET n += {name: 'crush', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6852, sourceColumn: 1, sourceEndLine: 6852};
...
MERGE (n:KG {id: 'rom:crush/maincpu/crushkrl.6e'}) SET n:Rom SET n += {file: 'crushkrl.6e', offset: 0, size: 4096, crc: 'a8dd8f54', sha1: '4e3a973ea74a9e145c6997513b98fc80aa478442', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6854, sourceColumn: 2, sourceEndLine: 6854};
MERGE (n:KG {id: 'rom:crush/maincpu/crushkrl.6f'}) SET n:Rom SET n += {file: 'crushkrl.6f', offset: 4096, size: 4096, crc: '91387299', sha1: '3ad8c28e02c45667e32860953b157832445a82c8', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6855, sourceColumn: 2, sourceEndLine: 6855};
MERGE (n:KG {id: 'rom:crush/maincpu/crushkrl.6h'}) SET n:Rom SET n += {file: 'crushkrl.6h', offset: 8192, size: 4096, crc: 'd4455f27', sha1: '53f8ffc28be664fa8a2d756b4c70045a3f041bea', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6856, sourceColumn: 2, sourceEndLine: 6856};
MERGE (n:KG {id: 'rom:crush/maincpu/crushkrl.6j'}) SET n:Rom SET n += {file: 'crushkrl.6j', offset: 12288, size: 4096, crc: 'd59fc251', sha1: '024605e4485b0ac826217256e5356ed9a6c8ef34', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6857, sourceColumn: 2, sourceEndLine: 6857};
...
MERGE (n:KG {id: 'rom:crush/gfx1/maketrax.5e'}) SET n:Rom SET n += {file: 'maketrax.5e', offset: 0, size: 4096, crc: '91bad2da', sha1: '096197d0cb6d55bf72b5be045224f4bd6a9cfa1b', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6860, sourceColumn: 2, sourceEndLine: 6860};
MERGE (n:KG {id: 'rom:crush/gfx1/maketrax.5f'}) SET n:Rom SET n += {file: 'maketrax.5f', offset: 4096, size: 4096, crc: 'aea79f55', sha1: '279021e6771dfa5bd0b7c557aae44434286d91b7', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6861, sourceColumn: 2, sourceEndLine: 6861};
...
MERGE (n:KG {id: 'rom:crush/proms/2s140.4a'}) SET n:Rom SET n += {file: '2s140.4a', offset: 32, size: 256, crc: '63efb927', sha1: '5c144a613fc4960a1dfd7ead89e7fee258a63171', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6865, sourceColumn: 2, sourceEndLine: 6865};
...
MERGE (n:KG {id: 'machine:pacman_state.korosuke'}) SET n:MachineConfig SET n += {cls: 'pacman_state', name: 'korosuke', calls: ['pacman'], devicePatches: ['{"tag":"mainlatch","config":["m_mainlatch->q_out_cb<7>().set_nop()"]}'], sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 3756, sourceColumn: 1, sourceEndLine: 3764};
...
MERGE (n:KG {id: 'inputs:maketrax/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:maketrax/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:maketrax/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY']};
MERGE (n:KG {id: 'inputs:maketrax/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY']};
...
MERGE (n:KG {id: 'inputs:maketrax/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:maketrax/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:maketrax/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_SERVICE1'};
MERGE (n:KG {id: 'inputs:maketrax/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:maketrax/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNUSED'};
...
MERGE (n:KG {id: 'inputs:maketrax/DSW1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: false, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:maketrax/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:maketrax/DSW2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 255, activeLow: false, type: 'IPT_UNUSED'};
...
MATCH (a:KG {id: 'game:crush'}), (b:KG {id: 'file:src/mame/pacman/pacman.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9087, sourceColumn: 1, sourceEndLine: 9087};
...
MATCH (a:KG {id: 'machine:pacman_state.korosuke'}), (b:KG {id: 'machine:pacman_state.pacman'}) MERGE (a)-[r:CALLS]->(b);
...
MATCH (a:KG {id: 'romset:crush'}), (b:KG {id: 'file:src/mame/pacman/pacman.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 6852, sourceColumn: 1, sourceEndLine: 6852};
