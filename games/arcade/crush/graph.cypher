...
// generated 2026-09-24T02:26:22.158Z
...
MERGE (n:KG {id: 'game:crush'}) SET n:Game SET n += {name: 'crush', year: '1981', company: 'Alpha Denshi Co. / Kural Samno Electric, Ltd.', fullname: 'Crush Roller (set 1)', monitor: 'ROT90', cls: 'pacman_state', init: 'init_maketrax', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/pacman/pacman.cpp', sourceLine: 9109, sourceColumn: 1, sourceEndLine: 9109, installedHandlers: ['{"space":"AS_PROGRAM","kind":"write","target":"m_maincpu","start":20484,"end":20484,"className":"pacman_state","method":"maketrax_protection_w","cpu":"maincpu"}', '{"space":"AS_PROGRAM","kind":"read","target":"m_maincpu","start":20608,"end":20671,"className":"pacman_state","method":"maketrax_special_port2_r","cpu":"maincpu"}', '{"space":"AS_PROGRAM","kind":"read","target":"m_maincpu","start":20672,"end":20735,"className":"pacman_state","method":"maketrax_special_port3_r","cpu":"maincpu"}']};
