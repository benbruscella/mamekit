...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Stephane Humbert (driver header); ClawGrip (7 release notes); hap (2 release notes); Ivan Vangelista (2 release notes); Recreativas.org (2 release notes); Robbbert (2 release notes); UnclePetros (2 release notes); chaneman (1 release note); Davidc96 (1 release note); Devin Acker (1 release note); Edgar Solé (1 release note); einstein95 (1 release note); Fabio Priuli (1 release note); Fortuna (1 release note); Ian Eure (1 release note); Jordi Tuells (1 release note); Liron486 (1 release note); Marc Deslauriers (1 release note); Museo Arcade Vintage (1 release note); Tafoid (1 release note); Victor Fernandez (City Game) (1 release note)
