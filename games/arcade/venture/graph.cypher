...
// generated 2026-09-24T02:30:52.611Z
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range0'}) SET n:AddressRange SET n += {start: 0, end: 127, raw: 'map(0x0000, 0x007f).mirror(0x0780).m(m_riot, FUNC(mos6532_device::ram_map)) -> map(0x00, 0x7f).rw(FUNC(mos6532_device::ram_r), FUNC(mos6532_device::ram_w))', mirror: 1920};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range1'}) SET n:AddressRange SET n += {start: 2048, end: 2048, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x00, 0x00).mirror(0x18).rw(FUNC(mos6532_device::pa_data_r), FUNC(mos6532_device::pa_data_w))', mirror: 2040};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range2'}) SET n:AddressRange SET n += {start: 2049, end: 2049, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x01, 0x01).mirror(0x18).rw(FUNC(mos6532_device::pa_ddr_r), FUNC(mos6532_device::pa_ddr_w))', mirror: 2040};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range3'}) SET n:AddressRange SET n += {start: 2050, end: 2050, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x02, 0x02).mirror(0x18).rw(FUNC(mos6532_device::pb_data_r), FUNC(mos6532_device::pb_data_w))', mirror: 2040};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range4'}) SET n:AddressRange SET n += {start: 2051, end: 2051, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x03, 0x03).mirror(0x18).rw(FUNC(mos6532_device::pb_ddr_r), FUNC(mos6532_device::pb_ddr_w))', mirror: 2040};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range5'}) SET n:AddressRange SET n += {start: 2068, end: 2071, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x14, 0x17).w(FUNC(mos6532_device::timer_off_w))', mirror: 2016};
MERGE (n:KG {id: 'handler:mos6532_device.timer_off_w'}) SET n:Handler SET n += {method: 'timer_off_w', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range6'}) SET n:AddressRange SET n += {start: 2076, end: 2079, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x1c, 0x1f).w(FUNC(mos6532_device::timer_on_w))', mirror: 2016};
MERGE (n:KG {id: 'handler:mos6532_device.timer_on_w'}) SET n:Handler SET n += {method: 'timer_on_w', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range7'}) SET n:AddressRange SET n += {start: 2052, end: 2052, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x04, 0x04).mirror(0x12).r(FUNC(mos6532_device::timer_off_r))', mirror: 2034};
MERGE (n:KG {id: 'handler:mos6532_device.timer_off_r'}) SET n:Handler SET n += {method: 'timer_off_r', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range8'}) SET n:AddressRange SET n += {start: 2060, end: 2060, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x0c, 0x0c).mirror(0x12).r(FUNC(mos6532_device::timer_on_r))', mirror: 2034};
MERGE (n:KG {id: 'handler:mos6532_device.timer_on_r'}) SET n:Handler SET n += {method: 'timer_on_r', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range9'}) SET n:AddressRange SET n += {start: 2053, end: 2053, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x05, 0x05).mirror(0x1a).r(FUNC(mos6532_device::irq_r))', mirror: 2042};
MERGE (n:KG {id: 'handler:mos6532_device.irq_r'}) SET n:Handler SET n += {method: 'irq_r', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range10'}) SET n:AddressRange SET n += {start: 2052, end: 2055, raw: 'map(0x0800, 0x081f).mirror(0x07e0).m(m_riot, FUNC(mos6532_device::io_map)) -> map(0x04, 0x07).mirror(0x8).w(FUNC(mos6532_device::edge_w))', mirror: 2024};
MERGE (n:KG {id: 'handler:mos6532_device.edge_w'}) SET n:Handler SET n += {method: 'edge_w', ownerClass: 'mos6532_device'};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range11'}) SET n:AddressRange SET n += {start: 4096, end: 4099, raw: 'map(0x1000, 0x1003).mirror(0x07fc).rw(m_pia, FUNC(pia6821_device::read), FUNC(pia6821_device::write))', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 567, sourceColumn: 2, sourceEndLine: 567, mirror: 2044};
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range12'}) SET n:AddressRange SET n += {start: 6144, end: 6147, raw: 'map(0x1800, 0x1803).mirror(0x07fc).w(FUNC(venture_sound_device::sh8253_w)).nopr()', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 568, sourceColumn: 2, sourceEndLine: 568, mirror: 2044, nopr: true};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range13'}) SET n:AddressRange SET n += {start: 8192, end: 8192, raw: 'map(0x2000, 0x2000).mirror(0x07ff).w(FUNC(venture_sound_device::filter_w))', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 569, sourceColumn: 2, sourceEndLine: 569, mirror: 2047};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range14'}) SET n:AddressRange SET n += {start: 10240, end: 10247, raw: 'map(0x2800, 0x2807).mirror(0x07f8).rw(FUNC(venture_sound_device::sh6840_r), FUNC(venture_sound_device::sh6840_w))', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 570, sourceColumn: 2, sourceEndLine: 570, mirror: 2040};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range15'}) SET n:AddressRange SET n += {start: 12288, end: 12291, raw: 'map(0x3000, 0x3003).mirror(0x07fc).w(FUNC(venture_sound_device::sfxctrl_w))', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 571, sourceColumn: 2, sourceEndLine: 571, mirror: 2044};
...
MERGE (n:KG {id: 'map:venture_sound_device.venture_audio_map/range16'}) SET n:AddressRange SET n += {start: 22528, end: 32767, raw: 'map(0x5800, 0x7fff).rom()', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 572, sourceColumn: 2, sourceEndLine: 572, rom: true};
MERGE (n:KG {id: 'machine:exidy_state.base'}) SET n:MachineConfig SET n += {cls: 'exidy_state', name: 'base', calls: [], stateMembers: ['{"name":"m_collision_mask","bits":8}', '{"name":"m_collision_invert","bits":8}', '{"name":"m_is_2bpp","bits":32,"signed":true}', '{"name":"m_int_condition","bits":8}'], startHandlers: ['exidy_state.video_start'], sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1506, sourceColumn: 1, sourceEndLine: 1521};
...
MERGE (n:KG {id: 'device:exidy_state.base/maincpu'}) SET n:Device SET n += {type: 'M6502', tag: 'maincpu', clock: 705562.5, config: ['M6502(config, m_maincpu, EXIDY_CPU_CLOCK)', 'm_maincpu->set_vblank_int("screen", FUNC(exidy_state::exidy_vblank_interrupt))'], member: 'm_maincpu', sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1509, sourceColumn: 2, sourceEndLine: 1509};
...
MERGE (n:KG {id: 'device:exidy_state.base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_exidy)'], member: 'm_gfxdecode', sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1513, sourceColumn: 2, sourceEndLine: 1513, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:exidy_state.base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(8)'], member: 'm_palette', sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1514, sourceColumn: 2, sourceEndLine: 1514, paletteEntries: 8};
MERGE (n:KG {id: 'device:exidy_state.base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_video_attributes(VIDEO_ALWAYS_UPDATE)', 'm_screen->set_raw(EXIDY_PIXEL_CLOCK, EXIDY_HTOTAL, EXIDY_HBEND, EXIDY_HBSTART, EXIDY_VTOTAL, EXIDY_VBEND, EXIDY_VBSTART)', 'm_screen->set_screen_update(FUNC(exidy_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1516, sourceColumn: 2, sourceEndLine: 1516, configCalls: ['set_raw(5644500,336,0,256,280,0,256)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5644500, 336, 0, 256, 280, 0, 256], screenRawExpr: ['EXIDY_PIXEL_CLOCK', 'EXIDY_HTOTAL', 'EXIDY_HBEND', 'EXIDY_HBSTART', 'EXIDY_VTOTAL', 'EXIDY_VBEND', 'EXIDY_VBSTART'], screenVideoAttributes: ['VIDEO_ALWAYS_UPDATE']};
...
MERGE (n:KG {id: 'machine:exidy_state.venture'}) SET n:MachineConfig SET n += {cls: 'exidy_state', name: 'venture', calls: ['base'], stateMembers: ['{"name":"m_collision_mask","bits":8}', '{"name":"m_collision_invert","bits":8}', '{"name":"m_is_2bpp","bits":32,"signed":true}', '{"name":"m_int_condition","bits":8}'], startHandlers: ['exidy_state.video_start'], sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1598, sourceColumn: 1, sourceEndLine: 1622};
...
MERGE (n:KG {id: 'device:exidy_state.venture/soundbd'}) SET n:Device SET n += {type: 'EXIDY_VENTURE', tag: 'soundbd', clock: 0, config: ['venture_sound_device &soundbd(EXIDY_VENTURE(config, "soundbd"))', 'soundbd.pa_callback().set("pia", FUNC(pia6821_device::portb_w))', 'soundbd.pb_callback().set("pia", FUNC(pia6821_device::porta_w))', 'soundbd.ca2_callback().set("pia", FUNC(pia6821_device::cb1_w))', 'soundbd.cb2_callback().set("pia", FUNC(pia6821_device::ca1_w))'], cls: 'venture_sound_device', clsHierarchy: ['venture_sound_device', 'exidy_sh8253_sound_device', 'exidy_sound_device'], sourceFile: 'src/mame/exidy/exidy.cpp', sourceLine: 1617, sourceColumn: 2, sourceEndLine: 1617, startHandler: 'exidy_sh8253_sound_device.device_start'};
...
MERGE (n:KG {id: 'machine:exidy_sh8253_sound_device.device_add_mconfig'}) SET n:MachineConfig SET n += {cls: 'exidy_sh8253_sound_device', name: 'device_add_mconfig', calls: ['exidy_sound_device::device_add_mconfig'], stateMembers: ['{"name":"cr","bits":8}', '{"name":"state","bits":8}', '{"name":"leftovers","bits":8}', '{"name":"timer","bits":16}', '{"name":"clocks","bits":32}', '{"name":"w","bits":16}', '{"name":"m_sh6840_volume","bits":16,"signed":true,"arrayLength":3}', '{"name":"m_sh6840_MSB_latch","bits":8}', '{"name":"m_sh6840_LSB_latch","bits":8}', '{"name":"m_sh6840_LFSR_oldxor","bits":8}', '{"name":"m_sh6840_LFSR_0","bits":32}', '{"name":"m_sh6840_LFSR_1","bits":32}', '{"name":"m_sh6840_LFSR_2","bits":32}', '{"name":"m_sh6840_LFSR_3","bits":32}', '{"name":"m_sh6840_clocks_per_sample","bits":32}', '{"name":"m_sh6840_clock_count","bits":32}', '{"name":"m_sfxctrl","bits":8}', '{"name":"m_pit_out","bits":8}'], sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 182, sourceColumn: 1, sourceEndLine: 205};
MERGE (n:KG {id: 'device:exidy_sh8253_sound_device.device_add_mconfig/riot'}) SET n:Device SET n += {type: 'MOS6532', tag: 'riot', clock: 894886.25, config: ['MOS6532(config, m_riot, SH6532_CLOCK)', 'm_riot->irq_wr_callback().set("audioirq", FUNC(input_merger_device::in_w<0>))'], member: 'm_riot', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 186, sourceColumn: 2, sourceEndLine: 186};
...
MERGE (n:KG {id: 'device:exidy_sh8253_sound_device.device_add_mconfig/pit'}) SET n:Device SET n += {type: 'PIT8253', tag: 'pit', clock: 894886.25, config: ['PIT8253(config, m_pit, SH6532_CLOCK)', 'm_pit->set_clk<0>(SH8253_CLOCK)', 'm_pit->set_clk<1>(SH8253_CLOCK)', 'm_pit->set_clk<2>(SH8253_CLOCK)', 'm_pit->out_handler<0>().set(FUNC(exidy_sh8253_sound_device::pit_out<0>))', 'm_pit->out_handler<1>().set(FUNC(exidy_sh8253_sound_device::pit_out<1>))', 'm_pit->out_handler<2>().set(FUNC(exidy_sh8253_sound_device::pit_out<2>))'], member: 'm_pit', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 192, sourceColumn: 2, sourceEndLine: 192};
...
MERGE (n:KG {id: 'handler:exidy_sh8253_sound_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'exidy_sh8253_sound_device', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 534, sourceColumn: 1, sourceEndLine: 545, sourceParameters: '', sourceBody: 'exidy_sound_device::device_start();
	...
	m_pit->write_gate1(1);
	m_pit->write_gate2(1);'};
MERGE (n:KG {id: 'handler:exidy_sound_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'exidy_sound_device', sourceFile: 'src/mame/shared/exidysound.cpp', sourceLine: 212, sourceColumn: 1, sourceEndLine: 240, sourceConstants: ['SH8253_CLOCK=1789772.5', 'SH6840_CLOCK=894886.25'], sourceParameters: '', sourceBody: 'int sample_rate = SH8253_CLOCK.value();
...
MERGE (n:KG {id: 'inputs:venture/DSW/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_COIN2', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(exidy_state::coin_count_w), 1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:venture/DSW/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 6, modifiers: ['PORT_DIPLOCATION("SW1:2,3")'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:2,3', settings: ['0=20000', '2=30000', '4=40000', '6=50000']};
MERGE (n:KG {id: 'inputs:venture/DSW/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 152, modifiers: ['PORT_DIPLOCATION("SW1:4,5,8")'], name: 'Coinage', defaultValue: 144, location: 'SW1:4,5,8', settings: ['136=2C 1C', '128=1C 1C', '144=1C 1C', '152=1C 2C', '0=Pence: A 2C/1C B 1C/3C', '24=Pence: A 1C/1C B 1C/6C']};
MERGE (n:KG {id: 'inputs:venture/DSW/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 96, modifiers: ['PORT_DIPLOCATION("SW1:6,7")'], name: 'Lives', defaultValue: 32, location: 'SW1:6,7', settings: ['0=2', '32=3', '64=4', '96=5']};
MERGE (n:KG {id: 'inputs:venture/IN0'}) SET n:Port SET n += {tag: 'IN0', modify: false};
MERGE (n:KG {id: 'inputs:venture/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:venture/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2', defaultValue: 2};
MERGE (n:KG {id: 'inputs:venture/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:venture/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:venture/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 16};
MERGE (n:KG {id: 'inputs:venture/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:venture/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 64};
MERGE (n:KG {id: 'inputs:venture/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(exidy_state::coin_count_w), 0)'], defaultValue: 128};
MERGE (n:KG {id: 'inputs:venture/INTSOURCE'}) SET n:Port SET n += {tag: 'INTSOURCE', modify: false};
MERGE (n:KG {id: 'inputs:venture/INTSOURCE/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 31, activeLow: false, type: 'IPT_CUSTOM', defaultValue: 0};
MERGE (n:KG {id: 'inputs:venture/INTSOURCE/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 96, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(exidy_state::intsource_coins_r))'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:venture/INTSOURCE/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_DEVICE_MEMBER("screen", FUNC(screen_device::vblank))'], defaultValue: 128};
MERGE (n:KG {id: 'inputs:venture/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:venture/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 255, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 255};
...
MATCH (a:KG {id: 'machine:exidy_state.venture'}), (b:KG {id: 'machine:exidy_state.base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:exidy_state.venture/soundbd'}), (b:KG {id: 'handler:exidy_sh8253_sound_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'machine:venture_sound_device.device_add_mconfig'}), (b:KG {id: 'machine:exidy_sh8253_sound_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'handler:exidy_sh8253_sound_device.device_start'}), (b:KG {id: 'handler:exidy_sound_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range8'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range9'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range10'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range11'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range12'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range13'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range14'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range15'}) MERGE (a)-[r:HAS_RANGE]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map'}), (b:KG {id: 'map:venture_sound_device.venture_audio_map/range16'}) MERGE (a)-[r:HAS_RANGE]->(b);
...
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range0'}), (b:KG {id: 'handler:mos6532_device.ram_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range0'}), (b:KG {id: 'handler:mos6532_device.ram_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range1'}), (b:KG {id: 'handler:mos6532_device.pa_data_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range1'}), (b:KG {id: 'handler:mos6532_device.pa_data_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range2'}), (b:KG {id: 'handler:mos6532_device.pa_ddr_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range2'}), (b:KG {id: 'handler:mos6532_device.pa_ddr_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range3'}), (b:KG {id: 'handler:mos6532_device.pb_data_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range3'}), (b:KG {id: 'handler:mos6532_device.pb_data_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range4'}), (b:KG {id: 'handler:mos6532_device.pb_ddr_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range4'}), (b:KG {id: 'handler:mos6532_device.pb_ddr_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range5'}), (b:KG {id: 'handler:mos6532_device.timer_off_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range6'}), (b:KG {id: 'handler:mos6532_device.timer_on_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range7'}), (b:KG {id: 'handler:mos6532_device.timer_off_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range8'}), (b:KG {id: 'handler:mos6532_device.timer_on_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range9'}), (b:KG {id: 'handler:mos6532_device.irq_r'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range10'}), (b:KG {id: 'handler:mos6532_device.edge_w'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'riot'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range11'}), (b:KG {id: 'handler:pia6821_device.read'}) MERGE (a)-[r:READS]->(b) SET r += {deviceTag: 'pia'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range11'}), (b:KG {id: 'handler:pia6821_device.write'}) MERGE (a)-[r:WRITES]->(b) SET r += {deviceTag: 'pia'};
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range12'}), (b:KG {id: 'handler:venture_sound_device.sh8253_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range13'}), (b:KG {id: 'handler:venture_sound_device.filter_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range14'}), (b:KG {id: 'handler:venture_sound_device.sh6840_r'}) MERGE (a)-[r:READS]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range14'}), (b:KG {id: 'handler:venture_sound_device.sh6840_w'}) MERGE (a)-[r:WRITES]->(b);
MATCH (a:KG {id: 'map:venture_sound_device.venture_audio_map/range15'}), (b:KG {id: 'handler:venture_sound_device.sfxctrl_w'}) MERGE (a)-[r:WRITES]->(b);
