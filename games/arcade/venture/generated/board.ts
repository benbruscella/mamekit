...
defined.compiledHandlers = {
  ...
  function method_exidy_interrupt_r(runtime: any): any {
  ...
  function method_sh8253_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_stream.update"] ? __l["m_stream.update"]() : (members.m_stream) != null ? (typeof (runtime.dereference(members.m_stream)).update === 'function' ? (runtime.dereference(members.m_stream)).update() : typeof (runtime.dereference(members.m_stream)).update === 'number' || typeof (runtime.dereference(members.m_stream)).update === 'boolean' ? (runtime.dereference(members.m_stream)).update : runtime.container(members.m_stream, "update")) : (__l["update"]?.() ?? 0));
    (__l["m_pit.write"] ? __l["m_pit.write"](offset, data) : (members.m_pit) != null ? ((runtime.dereference(members.m_pit)).write?.(offset, data) ?? 0) : 0);
  }

  function method_sfxctrl_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch (offset) {
      ...
      case 3:
      {
        runtime.writeIndex(runtime.writableMember("m_sh6840_volume"), ((offset) - (1)), runtime.divide(((((data) & (7))) * (5461.166666666667)), 7));
        break;
      }
    }
  }

  function method_set_colors(runtime: any): any {
    const members = runtime.members;
  ...
  function method_set_1_color(runtime: any, index: any, which: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_color_latch = members.m_color_latch ?? runtime.member("m_color_latch");
    (__l["m_palette.set_pen_color"] ? __l["m_palette.set_pen_color"](index, (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 2), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 2), which))), (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 1), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 1), which))), (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 0), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 0), which)))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).set_pen_color?.(index, (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 2), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 2), which))), (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 1), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 1), which))), (__l["pal1bit"] ? __l["pal1bit"](runtime.shiftRight(runtime.readIndex(h_m_color_latch, 0), which)) : runtime.macro("pal1bit", runtime.shiftRight(runtime.readIndex(h_m_color_latch, 0), which)))) ?? 0) : 0);
  }
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    let sprite_set_2: any = ((((Number(((runtime.dereference(h_m_sprite_enable)) & (64))) !== Number(0)) ? 1 : 0)) | 0);
    let sx: any = ((((((236) - (runtime.dereference(h_m_sprite2_xpos)))) - (4))) | 0);
    let sy: any = ((((((244) - (runtime.dereference(h_m_sprite2_ypos)))) - (4))) | 0);
    ((runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](0) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(0) ?? 0) : 0))).transpen?.(bitmap, cliprect, runtime.add(runtime.add(((runtime.shiftRight(runtime.dereference(h_m_spriteno), 4)) & (15)), 32), ((16) * (sprite_set_2))), 1, 0, 0, sx, sy, 0) ?? 0);
    if ((runtime.overrides["sprite_1_enabled"] ? runtime.overrides["sprite_1_enabled"]() : method_sprite_1_enabled(runtime))) {
      let sprite_set_1: any = ((((Number(((runtime.dereference(h_m_sprite_enable)) & (32))) !== Number(0)) ? 1 : 0)) | 0);
      sx = ((((((236) - (runtime.dereference(h_m_sprite1_xpos)))) - (4))) | 0);
      sy = ((((((244) - (runtime.dereference(h_m_sprite1_ypos)))) - (4))) | 0);
      if (((Number(sy) < Number(0)) ? 1 : 0)) {
        sy = ((0) | 0);
      }
      ((runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](0) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(0) ?? 0) : 0))).transpen?.(bitmap, cliprect, runtime.add(((runtime.dereference(h_m_spriteno)) & (15)), ((16) * (sprite_set_1))), 0, 0, 0, sx, sy, 0) ?? 0);
    }
  }

  function method_sprite_1_enabled(runtime: any): any {
    const members = runtime.members;
  ...
  return {
    ...
    "sh8253_w": method_sh8253_w,
    "sfxctrl_w": method_sfxctrl_w,
...
defined.compiledHandlerLinks = ["m_gfxdecode.gfx","m_maincpu.set_input_line","m_palette.set_pen_color","m_pit.write","m_stream.update","machine","machine().side_effects_disabled","pal1bit","update"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
