...
defined.compiledHandlers = {
  ...
  function method_set_1_color(runtime: any, index: any, which: any): any {
    ...
    (__l["m_palette.set_pen_color"] ? __l["m_palette.set_pen_color"](index, (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 2)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 2)) >>> (which)))), (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 1)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 1)) >>> (which)))), (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 0)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 0)) >>> (which))))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).set_pen_color?.(index, (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 2)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 2)) >>> (which)))), (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 1)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 1)) >>> (which)))), (__l["pal1bit"] ? __l["pal1bit"](((runtime.readIndex(h_m_color_latch, 0)) >>> (which))) : runtime.macro("pal1bit", ((runtime.readIndex(h_m_color_latch, 0)) >>> (which))))) ?? 0) : 0);
  }
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    ((runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](0) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(0) ?? 0) : 0))).transpen?.(bitmap, cliprect, runtime.add(runtime.add(((((runtime.dereference(h_m_spriteno)) >>> (4))) & (15)), 32), ((16) * (sprite_set_2))), 1, 0, 0, sx, sy, 0) ?? 0);
