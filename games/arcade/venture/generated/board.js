    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                let sprite_set_2 = ((Number(((runtime.dereference(h_m_sprite_enable)) & (64))) !== Number(0)) ? 1 : 0);
                let sx = ((((236) - (runtime.dereference(h_m_sprite2_xpos)))) - (4));
                let sy = ((((244) - (runtime.dereference(h_m_sprite2_ypos)))) - (4));
                ...
                if ((runtime.overrides["sprite_1_enabled"] ? runtime.overrides["sprite_1_enabled"]() : method_sprite_1_enabled(runtime))) {
                    let sprite_set_1 = ((Number(((runtime.dereference(h_m_sprite_enable)) & (32))) !== Number(0)) ? 1 : 0);
