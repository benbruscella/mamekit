...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_scrollx_w(runtime: any, offset: any, data: any) {
  ...
  function method_scrolly_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let attr: any = runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 0), tile_index);
    let code: any = runtime.add(runtime.readIndex(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), 0), tile_index), ((((attr) & (192))) << (2)));
    let color: any = ((attr) & (15));
    let flags: any = (runtime.calls["TILE_FLIPYX"] ? runtime.calls["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))));
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let attr: any = runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 1), tile_index);
    let code: any = runtime.add(runtime.readIndex(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), 1), tile_index), ((((attr) & (192))) << (2)));
    let color: any = ((attr) & (15));
    let flags: any = (runtime.calls["TILE_FLIPYX"] ? runtime.calls["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = (((members.m_spriteram).length) - (4)); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((offs) - (4))) {
      let attr: any = runtime.readIndex(spriteram, ((offs) + (1)));
      let bank: any = ((((attr) & (192))) >>> (6));
      let code: any = runtime.add(runtime.readIndex(spriteram, offs), ((256) * (bank)));
      let color: any = ((((attr) & (48))) >>> (4));
      let flipx: any = ((attr) & (4));
      let flipy: any = ((attr) & (8));
      let sx: any = ((runtime.readIndex(spriteram, ((offs) + (3)))) - (((((attr) & (1))) << (8))));
      let sy: any = runtime.readIndex(spriteram, ((offs) + (2)));
