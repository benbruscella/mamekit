    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let flags = (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((runtime.readIndex(h_m_colorram, tile_index)) >>> (6))) : runtime.macro("TILE_FLIPYX", ((runtime.readIndex(h_m_colorram, tile_index)) >>> (6))))) | 0);
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (let offs = ((188) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
                    ...
                    let code = ((((((((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((offs) + (2)))) & (32))) << (2))) | (((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((offs) + (1)))) >>> (1))))) | 0);
