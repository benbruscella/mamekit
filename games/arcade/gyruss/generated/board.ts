...
defined.compiledHandlers = {
  ...
  function method_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let flags: any = (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((runtime.readIndex(h_m_colorram, tile_index)) >>> (6))) : runtime.macro("TILE_FLIPYX", ((runtime.readIndex(h_m_colorram, tile_index)) >>> (6))))) | 0);
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    for (let offs: any = ((188) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
      ...
      let code: any = ((((((((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((offs) + (2)))) & (32))) << (2))) | (((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((offs) + (1)))) >>> (1))))) | 0);
