...
![marquee](/artwork/media/marquees/gng.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/gng.webp) | ![cabinet](/artwork/media/cabinets/gng.webp) |
...
- **Credited by MAMEDEV:** Pierpaolo Prazzoli (driver header); Tailsnic Retroworks (machine); ClawGrip (2 release notes); AJR (1 release note); BarbuDreadMon (1 release note); Corrado Tomaselli (1 release note); Jordi Beltrán (1 release note); Jordi Tuells (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 162 commits by 32 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
