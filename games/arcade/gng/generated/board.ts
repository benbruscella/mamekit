...
defined.compiledHandlers = {
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](0, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (15)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (15)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) ?? 0) : (__l["set"]?.(0, runtime.add(runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (15)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) ?? 0));
  }
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](1, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(1, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) ?? 0) : (__l["set"]?.(1, runtime.add(runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), tile_index), ((((attr) & (192))) << (2))), ((attr) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](((((attr) & (48))) >>> (4))) : runtime.macro("TILE_FLIPYX", ((((attr) & (48))) >>> (4))))) ?? 0));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    for (let offs: any = (((((members.m_spriteram).length) - (4))) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
      ...
      (__l["gfx.transpen"] ? __l["gfx.transpen"](bitmap, cliprect, runtime.add(runtime.readIndex(spriteram, offs), ((((attributes) << (2))) & (768))), ((((attributes) >>> (4))) & (3)), flipx, flipy, sx, sy, 15) : (gfx) != null ? ((runtime.dereference(gfx)).transpen?.(bitmap, cliprect, runtime.add(runtime.readIndex(spriteram, offs), ((((attributes) << (2))) & (768))), ((((attributes) >>> (4))) & (3)), flipx, flipy, sx, sy, 15) ?? 0) : (__l["transpen"]?.(bitmap, cliprect, runtime.add(runtime.readIndex(spriteram, offs), ((((attributes) << (2))) & (768))), ((((attributes) >>> (4))) & (3)), flipx, flipy, sx, sy, 15) ?? 0));
    }
  }
  return {
