...
- **Credited by MAMEDEV:** Zsolt Vasvari (driver header); David Haywood (3 release notes); hap (3 release notes); Steven Coomber (3 release notes); ClawGrip (2 release notes); Jordi Tuells (2 release notes); Robbbert (2 release notes); AJR (1 release note); beta-tester (1 release note); Jordi Beltrán (1 release note); M.A.S.H. (1 release note); SNESNESCUBE64 (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 255 commits by 35 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
