...
MAME source coverage: **76/110 nodes (69.1%)**
...
Screen update: **vicdual_state.screen_update_color** (compiled)
...
- `coinstate.configure_generic -> vicdual_state.clear_coin_status` - src/mame/sega/vicdual.cpp:923
