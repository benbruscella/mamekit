...
// generated 2026-08-22T05:52:10.917Z
...
MERGE (n:KG {id: 'handler:carnival_state.carnival_audio_2_w'}) SET n:Handler SET n += {method: 'carnival_audio_2_w', ownerClass: 'carnival_state', sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 210, sourceColumn: 1, sourceEndLine: 234, sourceConstants: ['OUT_CARNIVAL_PORT_2_BEAR=4', 'OUT_CARNIVAL_PORT_2_RANKING=32'], sourceParameters: 'uint8_t data', sourceBody: 'int bitsChanged;
	//int bitsGoneHigh;
	int bitsGoneLow;
...
MERGE (n:KG {id: 'machine:carnival_state.carnivala_audio'}) SET n:MachineConfig SET n += {cls: 'carnival_state', name: 'carnivala_audio', calls: [], sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 282, sourceColumn: 1, sourceEndLine: 298};
...
MERGE (n:KG {id: 'machine:vicdual_state.vicdual_root'}) SET n:MachineConfig SET n += {cls: 'vicdual_state', name: 'vicdual_root', calls: [], sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 918, sourceColumn: 1, sourceEndLine: 928};
...
MERGE (n:KG {id: 'device:vicdual_state.vicdual_root/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(VICDUAL_PIXEL_CLOCK, VICDUAL_HTOTAL, VICDUAL_HBEND, VICDUAL_HBSTART, VICDUAL_VTOTAL, VICDUAL_VBEND, VICDUAL_VBSTART)', 'm_screen->set_screen_update(FUNC(vicdual_state::screen_update_color))'], sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 926, sourceColumn: 2, sourceEndLine: 926, configCalls: ['set_raw(5156160,328,0,256,262,0,224)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [5156160, 328, 0, 256, 262, 0, 224]};
...
MERGE (n:KG {id: 'machine:vicdual_state.vicdual_dualgame_root'}) SET n:MachineConfig SET n += {cls: 'vicdual_state', name: 'vicdual_dualgame_root', calls: ['vicdual_root'], devicePatches: ['{"tag":"screen","config":["m_screen->set_screen_update(FUNC(vicdual_state::screen_update_color))"]}'], sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 2971, sourceColumn: 1, sourceEndLine: 2980};
...
MERGE (n:KG {id: 'machine:carnival_state.carnival'}) SET n:MachineConfig SET n += {cls: 'carnival_state', name: 'carnival', calls: ['vicdual_dualgame_root', 'carnivala_audio'], sourceFile: 'src/mame/sega/vicdual.cpp', sourceLine: 3043, sourceColumn: 1, sourceEndLine: 3055};
...
MERGE (n:KG {id: 'inputs:carnival/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN0/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused', defaultValue: 0, location: 'SW1:1', settings: ['4=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN0/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Unused', defaultValue: 0, location: 'SW1:5', settings: ['8=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN0/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Demo Sounds', defaultValue: 0, location: 'DOOR:1', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:carnival/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:carnival/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused', defaultValue: 0, location: 'SW1:2', settings: ['4=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(vicdual_state::cblank_comp_r))']};
MERGE (n:KG {id: 'inputs:carnival/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:carnival/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:carnival/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:carnival/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:carnival/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused', defaultValue: 0, location: 'SW1:3', settings: ['4=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(vicdual_state::timer_value_r))']};
MERGE (n:KG {id: 'inputs:carnival/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:carnival/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:carnival/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:carnival/IN3'}) SET n:Port SET n += {tag: 'IN3', modify: false};
MERGE (n:KG {id: 'inputs:carnival/IN3/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN3/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN3/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused', defaultValue: 0, location: 'SW1:4', settings: ['4=Off', '0=On']};
MERGE (n:KG {id: 'inputs:carnival/IN3/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(vicdual_state::coin_status_r))']};
MERGE (n:KG {id: 'inputs:carnival/IN3/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:carnival/IN3/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:carnival/IN3/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:carnival/COIN'}) SET n:Port SET n += {tag: 'COIN', modify: false};
MERGE (n:KG {id: 'inputs:carnival/COIN/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_COIN1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(vicdual_state::coin_changed), 0)']};
...
MATCH (a:KG {id: 'machine:carnival_state.carnival'}), (b:KG {id: 'machine:vicdual_state.vicdual_dualgame_root'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'machine:carnival_state.carnival'}), (b:KG {id: 'machine:carnival_state.carnivala_audio'}) MERGE (a)-[r:CALLS]->(b);
...
MATCH (a:KG {id: 'machine:vicdual_state.vicdual_dualgame_root'}), (b:KG {id: 'machine:vicdual_state.vicdual_root'}) MERGE (a)-[r:CALLS]->(b);
