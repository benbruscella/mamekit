...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_characterram_w(runtime, offset, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                (__l["m_screen.update_partial"] ? __l["m_screen.update_partial"]((__l["m_screen.vpos"] ? __l["m_screen.vpos"]() : (members.m_screen) != null ? (typeof (runtime.dereference(members.m_screen)).vpos === 'function' ? (runtime.dereference(members.m_screen)).vpos() : typeof (runtime.dereference(members.m_screen)).vpos === 'number' || typeof (runtime.dereference(members.m_screen)).vpos === 'boolean' ? (runtime.dereference(members.m_screen)).vpos : runtime.container(members.m_screen, "vpos")) : 0)) : (members.m_screen) != null ? ((runtime.dereference(members.m_screen)).update_partial?.((__l["m_screen.vpos"] ? __l["m_screen.vpos"]() : (members.m_screen) != null ? (typeof (runtime.dereference(members.m_screen)).vpos === 'function' ? (runtime.dereference(members.m_screen)).vpos() : typeof (runtime.dereference(members.m_screen)).vpos === 'number' || typeof (runtime.dereference(members.m_screen)).vpos === 'boolean' ? (runtime.dereference(members.m_screen)).vpos : runtime.container(members.m_screen, "vpos")) : 0)) ?? 0) : 0);
                runtime.writeIndex(runtime.writableMember("m_characterram"), offset, data);
            }
            function method_carnival_io_w(runtime, offset, data) {
                const members = runtime.members;
                if (((offset) & (1))) {
            ...
            function method_carnival_audio_1_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                const h_m_samples = members.m_samples ?? runtime.member("m_samples");
                let bitsChanged = ((0) | 0);
                let bitsGoneHigh = ((0) | 0);
                let bitsGoneLow = ((0) | 0);
            ...
            function method_carnival_audio_2_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                const h_m_samples = members.m_samples ?? runtime.member("m_samples");
                let bitsChanged = ((0) | 0);
            ...
            function method_assert_coin_status(runtime) {
                const members = runtime.members;
            ...
            function method_clear_coin_status(runtime, param) {
                const members = runtime.members;
    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_carnivala_music_port_1_w(runtime, data) {
                const members = runtime.members;
            ...
            function method_carnival_psg_latch(runtime) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_carnivala_music_port_2_w(runtime, data) {
                const members = runtime.members;
                members.m_musicbus = ((((runtime.shiftRight(data, 6)) & (3))) | 0);
                (runtime.overrides["carnival_psg_latch"] ? runtime.overrides["carnival_psg_latch"]() : method_carnival_psg_latch(runtime));
            }
            function method_carnival_music_port_t1_r(runtime) {
                const members = runtime.members;
