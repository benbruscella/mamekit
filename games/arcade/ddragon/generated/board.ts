...
defined.compiledHandlers = {
  ...
  function method_sub_port6_w(runtime: any, data: any) {
    const members = runtime.members;
    const h_m_sprite_irq = members.m_sprite_irq ?? runtime.member("m_sprite_irq");
  ...
  function method_ddragon_adpcm_status_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_background_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any) {
    const members = runtime.members;
  ...
  function method_scanline(runtime: any, param: any) {
    ...
    let screen_height: any = (runtime.calls["m_screen.height"] ? runtime.calls["m_screen.height"]() : (members.m_screen) != null ? (typeof (runtime.dereference(members.m_screen)).height === 'function' ? (runtime.dereference(members.m_screen)).height() : typeof (runtime.dereference(members.m_screen)).height === 'number' || typeof (runtime.dereference(members.m_screen)).height === 'boolean' ? (runtime.dereference(members.m_screen)).height : runtime.container(members.m_screen, "height")) : (runtime.calls["height"]?.() ?? 0));
    let vcount_old: any = (runtime.overrides["scanline_to_vcount"] ? runtime.overrides["scanline_to_vcount"](((((Number(scanline) === Number(0)) ? 1 : 0)) ? (((screen_height) - (1))) : (((scanline) - (1))))) : method_scanline_to_vcount(runtime, ((((Number(scanline) === Number(0)) ? 1 : 0)) ? (((screen_height) - (1))) : (((scanline) - (1))))));
    let vcount: any = (runtime.overrides["scanline_to_vcount"] ? runtime.overrides["scanline_to_vcount"](scanline) : method_scanline_to_vcount(runtime, scanline));
  ...
  function method_scanline_to_vcount(runtime: any, scanline: any) {
    const members = runtime.members;
    let vcount: any = ((scanline) + (8));
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any) {
    ...
    let scrollx: any = (((((members.m_scrollx_hi ?? runtime.member("m_scrollx_hi"))) << (8))) | (runtime.dereference(h_m_scrollx_lo)));
    let scrolly: any = (((((members.m_scrolly_hi ?? runtime.member("m_scrolly_hi"))) << (8))) | (runtime.dereference(h_m_scrolly_lo)));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    let gfx: any = (runtime.calls["m_gfxdecode.gfx"] ? runtime.calls["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : (runtime.calls["gfx"]?.(1) ?? 0));
    let src: any = h_m_spriteram;
    let bytes: any = (((members.m_spriteram).length) >>> 0);
    for (let i: any = ((0) >>> 0); ((Number(i) < Number(bytes)) ? 1 : 0); i = ((((i) + (5))) >>> 0)) {
      let attr: any = runtime.readIndex(src, ((i) + (1)));
      if (((attr) & (128))) {
        let sx: any = runtime.add(((240) - (runtime.readIndex(src, ((i) + (4))))), ((((attr) & (2))) << (7)));
        let sy: any = runtime.add(((232) - (runtime.readIndex(src, ((i) + (0))))), ((((attr) & (1))) << (8)));
        let size: any = ((((attr) & (48))) >>> (4));
        let flipx: any = ((attr) & (8));
        let flipy: any = ((attr) & (4));
        let dx: any = (-16);
        let dy: any = (-16);
        let which: any = 0;
        let color: any = 0;
