...
defined.compiledHandlers = {
  ...
  function method_fgvideoram_w(runtime: any, offset: any, data: any): any {
    ...
    (__l["m_fg_tilemap.mark_tile_dirty"] ? __l["m_fg_tilemap.mark_tile_dirty"](runtime.shiftRight(offset, 1)) : (members.m_fg_tilemap) != null ? ((runtime.dereference(members.m_fg_tilemap)).mark_tile_dirty?.(runtime.shiftRight(offset, 1)) ?? 0) : (__l["mark_tile_dirty"]?.(runtime.shiftRight(offset, 1)) ?? 0));
  }
  ...
  function method_bgvideoram_w(runtime: any, offset: any, data: any): any {
    ...
    (__l["m_bg_tilemap.mark_tile_dirty"] ? __l["m_bg_tilemap.mark_tile_dirty"](runtime.shiftRight(offset, 1)) : (members.m_bg_tilemap) != null ? ((runtime.dereference(members.m_bg_tilemap)).mark_tile_dirty?.(runtime.shiftRight(offset, 1)) ?? 0) : (__l["mark_tile_dirty"]?.(runtime.shiftRight(offset, 1)) ?? 0));
  }

  function method_interrupt_r(runtime: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_interrupt_ack(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_interrupt_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bankswitch_w(runtime: any, data: any): any {
    ...
    members.m_scrolly_hi = ((runtime.shiftRight(((data) & (2)), 1)) & 0xff);
    ...
    (__l["m_mainbank.set_entry"] ? __l["m_mainbank.set_entry"](runtime.shiftRight(((data) & (224)), 5)) : (members.m_mainbank) != null ? ((runtime.dereference(members.m_mainbank)).set_entry?.(runtime.shiftRight(((data) & (224)), 5)) ?? 0) : (__l["set_entry"]?.(runtime.shiftRight(((data) & (224)), 5)) ?? 0));
  }

  function method_sub_port6_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_ddragon_adpcm_status_r(runtime: any): any {
    const members = runtime.members;
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](2, ((runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), ((runtime.shiftRight(attr, 3)) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(2, ((runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), ((runtime.shiftRight(attr, 3)) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ?? 0) : (__l["set"]?.(2, ((runtime.readIndex((members.m_bgvideoram ?? runtime.member("m_bgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), ((runtime.shiftRight(attr, 3)) & (7)), (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (192)), 6)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (192)), 6)))) ?? 0));
  }

  function method_background_scan(runtime: any, col: any, row: any, num_cols: any, num_rows: any): any {
    const members = runtime.members;
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    (__l["tileinfo.set"] ? __l["tileinfo.set"](0, ((runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), runtime.shiftRight(attr, 5), 0) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, ((runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), runtime.shiftRight(attr, 5), 0) ?? 0) : (__l["set"]?.(0, ((runtime.readIndex((members.m_fgvideoram ?? runtime.member("m_fgvideoram")), ((tile_index) | (1)))) | (((((attr) & (7))) << (8)))), runtime.shiftRight(attr, 5), 0) ?? 0));
  }
  ...
  function method_scanline(runtime: any, param: any): any {
    ...
    let screen_height: any = (((__l["m_screen.height"] ? __l["m_screen.height"]() : (members.m_screen) != null ? (typeof (runtime.dereference(members.m_screen)).height === 'function' ? (runtime.dereference(members.m_screen)).height() : typeof (runtime.dereference(members.m_screen)).height === 'number' || typeof (runtime.dereference(members.m_screen)).height === 'boolean' ? (runtime.dereference(members.m_screen)).height : runtime.container(members.m_screen, "height")) : 0)) | 0);
    let vcount_old: any = (((runtime.overrides["scanline_to_vcount"] ? runtime.overrides["scanline_to_vcount"](((((Number(scanline) === Number(0)) ? 1 : 0)) ? (((screen_height) - (1))) : (((scanline) - (1))))) : method_scanline_to_vcount(runtime, ((((Number(scanline) === Number(0)) ? 1 : 0)) ? (((screen_height) - (1))) : (((scanline) - (1))))))) | 0);
    let vcount: any = (((runtime.overrides["scanline_to_vcount"] ? runtime.overrides["scanline_to_vcount"](scanline) : method_scanline_to_vcount(runtime, scanline))) | 0);
  ...
  function method_scanline_to_vcount(runtime: any, scanline: any): any {
    const members = runtime.members;

    let vcount: any = ((((scanline) + (8))) | 0);
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    let scrollx: any = (((((((members.m_scrollx_hi ?? runtime.member("m_scrollx_hi"))) << (8))) | (runtime.dereference(h_m_scrollx_lo)))) | 0);
    let scrolly: any = (((((((members.m_scrolly_hi ?? runtime.member("m_scrolly_hi"))) << (8))) | (runtime.dereference(h_m_scrolly_lo)))) | 0);
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    let gfx: any = (__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : 0);
    let src: any = h_m_spriteram;
    let bytes: any = (((members.m_spriteram).length) >>> 0);
    for (let i: any = ((0) >>> 0); ((Number(i) < Number(bytes)) ? 1 : 0); i = ((((i) + (5))) >>> 0)) {
      let attr: any = ((runtime.readIndex(src, ((i) + (1)))) | 0);
      if (((attr) & (128))) {
        let sx: any = ((runtime.add(((240) - (runtime.readIndex(src, ((i) + (4))))), ((((attr) & (2))) << (7)))) | 0);
        let sy: any = ((runtime.add(((232) - (runtime.readIndex(src, ((i) + (0))))), ((((attr) & (1))) << (8)))) | 0);
        let size: any = ((runtime.shiftRight(((attr) & (48)), 4)) | 0);
        let flipx: any = ((((attr) & (8))) | 0);
        let flipy: any = ((((attr) & (4))) | 0);
        let dx: any = ((-16) | 0);
        let dy: any = ((-16) | 0);
        let which: any = ((0) | 0);
        let color: any = ((0) | 0);
        if (((Number(h_m_technos_video_hw) === Number(2)) ? 1 : 0)) {
          color = ((runtime.shiftRight(runtime.readIndex(src, ((i) + (2))), 5)) | 0);
          ...
          color = ((runtime.shiftRight(runtime.readIndex(src, ((i) + (2))), 4)) | 0);
