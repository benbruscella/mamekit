...
// generated 2026-09-11T11:44:11.177Z
...
MERGE (n:KG {id: 'device:ddragon_state.ddragon/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::xBGR_444, 512)'], member: 'm_palette', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 959, sourceColumn: 2, sourceEndLine: 959};
MERGE (n:KG {id: 'device:ddragon_state.ddragon/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(PIXEL_CLOCK, 384, 0, 256, 272, 0, 240)', 'm_screen->set_screen_update(FUNC(ddragon_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 961, sourceColumn: 2, sourceEndLine: 961, configCalls: ['set_raw(6000000,384,0,256,272,0,240)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 272, 0, 240], screenRawExpr: ['PIXEL_CLOCK', '384', '0', '256', '272', '0', '240']};
