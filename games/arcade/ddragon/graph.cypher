...
// generated 2026-09-24T02:26:52.997Z
...
MERGE (n:KG {id: 'device:ddragon_state.ddragon/maincpu'}) SET n:Device SET n += {type: 'HD6309E', tag: 'maincpu', clock: 3000000, config: ['HD6309E(config, m_maincpu, MAIN_CLOCK / 4)', 'm_maincpu->set_addrmap(AS_PROGRAM, &ddragon_state::ddragon_main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 944, sourceColumn: 2, sourceEndLine: 944};
...
MERGE (n:KG {id: 'device:ddragon_state.ddragon/soundcpu'}) SET n:Device SET n += {type: 'MC6809', tag: 'soundcpu', clock: 6000000, config: ['MC6809(config, m_soundcpu, MAIN_CLOCK / 2)', 'm_soundcpu->set_addrmap(AS_PROGRAM, &ddragon_state::ddragon_sound_map)'], member: 'm_soundcpu', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 952, sourceColumn: 2, sourceEndLine: 952};
MERGE (n:KG {id: 'device:ddragon_state.ddragon/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_ddragon)'], member: 'm_gfxdecode', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 958, sourceColumn: 2, sourceEndLine: 958, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:ddragon_state.ddragon/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::xBGR_444, 512)'], member: 'm_palette', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 959, sourceColumn: 2, sourceEndLine: 959, paletteEntries: 512};
MERGE (n:KG {id: 'device:ddragon_state.ddragon/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(PIXEL_CLOCK, 384, 0, 256, 272, 0, 240)', 'm_screen->set_screen_update(FUNC(ddragon_state::screen_update))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 961, sourceColumn: 2, sourceEndLine: 961, configCalls: ['set_raw(6000000,384,0,256,272,0,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 272, 0, 240], screenRawExpr: ['PIXEL_CLOCK', '384', '0', '256', '272', '0', '240']};
...
MERGE (n:KG {id: 'device:ddragon_state.ddragon/soundlatch'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'soundlatch', clock: null, config: ['GENERIC_LATCH_8(config, m_soundlatch)', 'm_soundlatch->data_pending_callback().set_inputline(m_soundcpu, M6809_IRQ_LINE)'], member: 'm_soundlatch', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 969, sourceColumn: 2, sourceEndLine: 969};
...
MERGE (n:KG {id: 'device:ddragon_state.ddragon/fmsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'fmsnd', clock: 3579545, config: ['ym2151_device &fmsnd(YM2151(config, "fmsnd", SOUND_CLOCK))', 'fmsnd.irq_handler().set_inputline(m_soundcpu, M6809_FIRQ_LINE)', 'fmsnd.add_route(0, "mono", 0.35)', 'fmsnd.add_route(1, "mono", 0.35)'], sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 972, sourceColumn: 2, sourceEndLine: 972, configCalls: ['add_route(0,"mono",0.35)', 'add_route(1,"mono",0.35)']};
