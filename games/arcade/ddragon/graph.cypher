...
// generated 2026-08-22T05:52:14.001Z
...
MERGE (n:KG {id: 'machine:ddragon_state.ddragon'}) SET n:MachineConfig SET n += {cls: 'ddragon_state', name: 'ddragon', calls: [], resetHandlers: ['ddragon_state.machine_reset'], startHandlers: ['ddragon_state.video_start'], sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 941, sourceColumn: 1, sourceEndLine: 986};
...
MERGE (n:KG {id: 'inputs:ddragon/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:ddragon/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:ddragon/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:ddragon/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:ddragon/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:ddragon/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:ddragon/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:ddragon/P1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:ddragon/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:ddragon/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:ddragon/P2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:ddragon/DSW0'}) SET n:Port SET n += {tag: 'DSW0', modify: false};
MERGE (n:KG {id: 'inputs:ddragon/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, name: 'Coin A', defaultValue: 7, location: 'SW1:1,2,3', settings: ['0=4C 1C', '1=3C 1C', '2=2C 1C', '7=1C 1C', '6=1C 2C', '5=1C 3C', '4=1C 4C', '3=1C 5C']};
MERGE (n:KG {id: 'inputs:ddragon/DSW0/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 56, name: 'Coin B', defaultValue: 56, location: 'SW1:4,5,6', settings: ['0=4C 1C', '8=3C 1C', '16=2C 1C', '56=1C 1C', '48=1C 2C', '40=1C 3C', '32=1C 4C', '24=1C 5C']};
MERGE (n:KG {id: 'inputs:ddragon/DSW0/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Cabinet', defaultValue: 64, location: 'SW1:7', settings: ['64=Upright', '0=Cocktail']};
MERGE (n:KG {id: 'inputs:ddragon/DSW0/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Flip Screen', defaultValue: 128, location: 'SW1:8', settings: ['128=Off', '0=On']};
MERGE (n:KG {id: 'inputs:ddragon/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:ddragon/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Difficulty', defaultValue: 3, location: 'SW2:1,2', settings: ['1=Easy', '3=Medium', '2=Hard', '0=Hardest']};
MERGE (n:KG {id: 'inputs:ddragon/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Demo Sounds', defaultValue: 4, location: 'SW2:3', settings: ['0=Off', '4=On']};
MERGE (n:KG {id: 'inputs:ddragon/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ddragon/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 48, name: 'Bonus Life', defaultValue: 48, location: 'SW2:5,6', settings: ['16=20k', '0=40k', '48=30k and every 60k', '32=40k and every 80k']};
MERGE (n:KG {id: 'inputs:ddragon/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 192, name: 'Lives', defaultValue: 192, location: 'SW2:7,8', settings: ['192=2', '128=3', '64=4', '0=Infinite (Cheat)']};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA'}) SET n:Port SET n += {tag: 'EXTRA', modify: false};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_SERVICE1'};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_BUTTON3'};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_BUTTON3', modifiers: ['PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_DEVICE_MEMBER("screen", FUNC(screen_device::vblank))']};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(ddragon_state::subcpu_bus_free_r))']};
MERGE (n:KG {id: 'handler:ddragon_state.subcpu_bus_free_r'}) SET n:Handler SET n += {method: 'subcpu_bus_free_r', ownerClass: 'ddragon_state', sourceFile: 'src/mame/technos/ddragon.cpp', sourceLine: 330, sourceColumn: 1, sourceEndLine: 337, sourceParameters: '', sourceBody: '// Corresponds to BA (Bus Available) on the HD63701
	if (m_subcpu)
		...
		return 0;'};
MERGE (n:KG {id: 'inputs:ddragon/EXTRA/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 224, activeLow: false, type: 'IPT_UNUSED'};
