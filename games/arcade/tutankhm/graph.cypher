...
// generated 2026-09-24T02:30:46.320Z
...
MERGE (n:KG {id: 'device:tutankhm_state.tutankhm/maincpu'}) SET n:Device SET n += {type: 'MC6809E', tag: 'maincpu', clock: 1536000, config: ['MC6809E(config, m_maincpu, XTAL(18\'432\'000)/12)', 'm_maincpu->set_addrmap(AS_PROGRAM, &tutankhm_state::main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/konami/tutankhm.cpp', sourceLine: 286, sourceColumn: 2, sourceEndLine: 286};
...
MERGE (n:KG {id: 'device:tutankhm_state.tutankhm/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(1, tutankhm_state::raw_to_rgb_func, 16)'], member: 'm_palette', sourceFile: 'src/mame/konami/tutankhm.cpp', sourceLine: 304, sourceColumn: 2, sourceEndLine: 304, paletteEntries: 16};
MERGE (n:KG {id: 'device:tutankhm_state.tutankhm/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, m_timeplt_audio)'], member: 'm_timeplt_audio', cls: 'timeplt_audio_device', clsHierarchy: ['timeplt_audio_device'], sourceFile: 'src/mame/konami/tutankhm.cpp', sourceLine: 310, sourceColumn: 2, sourceEndLine: 310, startHandler: 'timeplt_audio_device.device_start'};
...
MATCH (a:KG {id: 'device:tutankhm_state.tutankhm/timeplt_audio'}), (b:KG {id: 'handler:timeplt_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:tutankhm_state.sound_on_w'}), (b:KG {id: 'handler:timeplt_audio_device.sh_irqtrigger_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_timeplt_audio.sh_irqtrigger_w'};
