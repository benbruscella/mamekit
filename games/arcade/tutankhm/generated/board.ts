...
defined.compiledHandlers = {
  ...
  function method_bankselect_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_mainbank.set_entry"] ? __l["m_mainbank.set_entry"](((data) & (15))) : (members.m_mainbank) != null ? ((runtime.dereference(members.m_mainbank)).set_entry?.(((data) & (15))) ?? 0) : (__l["set_entry"]?.(((data) & (15))) ?? 0));
  }

  function method_sound_on_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_timeplt_audio.sh_irqtrigger_w"] ? __l["m_timeplt_audio.sh_irqtrigger_w"](0) : (members.m_timeplt_audio) != null ? ((runtime.dereference(members.m_timeplt_audio)).sh_irqtrigger_w?.(0) ?? 0) : 0);
    (__l["m_timeplt_audio.sh_irqtrigger_w"] ? __l["m_timeplt_audio.sh_irqtrigger_w"](1) : (members.m_timeplt_audio) != null ? ((runtime.dereference(members.m_timeplt_audio)).sh_irqtrigger_w?.(1) ?? 0) : 0);
  }

  function method_irq_enable_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_stars_enable_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_flip_screen_x_w(runtime: any, state: any): any {
    const members = runtime.members;

    members.m_flipscreen_x = ((state) & 0xff);
  }

  function method_flip_screen_y_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    let mode: any = (((__l["m_stars_config.read_safe"] ? __l["m_stars_config.read_safe"]((members.m_star_mode ?? runtime.member("m_star_mode"))) : (members.m_stars_config) != null ? ((runtime.dereference(members.m_stars_config)).read_safe?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0) : (__l["read_safe"]?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0))) & 0xff);
  ...
  function method_stars_init(runtime: any): any {
    const members = runtime.members;
  ...
  function method_stars_init_scramble(runtime: any): any {
    const members = runtime.members;

    members.m_stars = (runtime.overrides["ALLOC"] ? runtime.overrides["ALLOC"](131071) : new Uint8Array(Math.max(0, Number(131071))));
    let shiftreg: any = ((0) >>> 0);
    for (let i: any = ((0) | 0); ((Number(i) < Number(131071)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      let shift: any = ((12) & 0xff);
      let enabled: any = ((((Number(((shiftreg) & (130561))) === Number(130560)) ? 1 : 0)) | 0);
      let color: any = ((runtime.shiftRight((((~shiftreg)) & (504)), 3)) | 0);
      runtime.writeIndex(runtime.writableMember("m_stars"), i, ((color) | (((enabled) << (7)))));
      shiftreg = ((((runtime.shiftRight(shiftreg, 1)) | (((((((runtime.shiftRight(shiftreg, shift)) ^ ((~shiftreg)))) & (1))) << (16))))) >>> 0);
    }
  }

  function method_stars_init_bootleg(runtime: any): any {
    const members = runtime.members;
    ...
    let shiftreg: any = ((0) >>> 0);
    for (let i: any = ((0) | 0); ((Number(i) < Number(131071)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      let newbit: any = ((((((runtime.shiftRight(shiftreg, 12)) ^ ((~shiftreg)))) & (1))) | 0);
      let enabled: any = (((((((Number(((shiftreg) & (130560))) === Number(130560)) ? 1 : 0)) && (((Number(newbit) === Number(0)) ? 1 : 0))) ? 1 : 0)) | 0);
      let color: any = ((runtime.shiftRight((((~shiftreg)) & (504)), 3)) | 0);
      runtime.writeIndex(runtime.writableMember("m_stars"), i, ((color) | (((enabled) << (7)))));
      shiftreg = ((((runtime.shiftRight(shiftreg, 1)) | (((newbit) << (16))))) >>> 0);
    }
  }

  function method_screen_update_scramble(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    let xorx: any = (((((members.m_flipscreen_x ?? runtime.member("m_flipscreen_x"))) ? (255) : (0))) | 0);
    let xory: any = (((((members.m_flipscreen_y ?? runtime.member("m_flipscreen_y"))) ? (255) : (0))) | 0);
    for (let y: any = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
      let dst: any = bitmap["pix&"](y);
      for (let x: any = ((runtime.divide(cliprect.min_x, 3)) | 0); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
        let effx: any = ((((x) ^ (xorx))) & 0xff);
        let yscroll: any = (((((((((Number(effx) < Number(192)) ? 1 : 0)) && ((__l["m_scroll.found"] ? __l["m_scroll.found"]() : (members.m_scroll) != null ? (typeof (runtime.dereference(members.m_scroll)).found === 'function' ? (runtime.dereference(members.m_scroll)).found() : typeof (runtime.dereference(members.m_scroll)).found === 'number' || typeof (runtime.dereference(members.m_scroll)).found === 'boolean' ? (runtime.dereference(members.m_scroll)).found : runtime.container(members.m_scroll, "found")) : (__l["found"]?.() ?? 0)))) ? 1 : 0)) ? (runtime.dereference(h_m_scroll)) : (0))) & 0xff);
        let effy: any = ((((((y) ^ (xory))) + (yscroll))) & 0xff);
        let vrambyte: any = ((runtime.readIndex(h_m_videoram, runtime.add(((effy) * (128)), runtime.divide(effx, 2)))) & 0xff);
        let shifted: any = ((runtime.shiftRight(vrambyte, ((4) * (((effx) & (1)))))) & 0xff);
        let color: any = (__l["m_palette.pen_color"] ? __l["m_palette.pen_color"](((shifted) & (15))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).pen_color?.(((shifted) & (15))) ?? 0) : 0);
        let dbase: any = runtime.addressOf(dst, ((x) * (3)));
  ...
  function method_scramble_draw_background(runtime: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["bitmap.fill"] ? __l["bitmap.fill"]((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) : (bitmap) != null ? ((runtime.dereference(bitmap)).fill?.((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) ?? 0) : (__l["fill"]?.((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) ?? 0));
  ...
  function method_stars_draw_row(runtime: any, bitmap: any, maxx: any, y: any, star_offs: any): any {
    const members = runtime.members;

    let flipxor: any = (((((members.m_flipscreen_x ?? runtime.member("m_flipscreen_x"))) ? (192) : (0))) & 0xff);
    star_offs = ((((star_offs) % (131071))) >>> 0);
    for (let x: any = ((0) | 0); ((Number(x) < Number(maxx)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
      let h8q: any = ((((((~x)) >>> (3)) & 1)) & 0xff);
      let enable_star: any = (((((((y) ^ (h8q))) >>> (0)) & 1)) ? 1 : 0);
      let blink_state: any = (((((members.m_stars_blink_state ?? runtime.member("m_stars_blink_state"))) & (3))) & 0xff);
      let enab: any = ((0) ? 1 : 0);
      switch (blink_state) {
        case 0:
        {
  ...
  function method_screen_update_bootleg(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    for (let y: any = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
      ...
      for (let x: any = ((runtime.divide(cliprect.min_x, 3)) | 0); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
        ...
        let offset: any = ((runtime.add(((((y) * (384))) + (x)), 84)) | 0);
        let star: any = ((runtime.readIndex((members.m_stars ?? runtime.member("m_stars")), ((offset) % (131071)))) & 0xff);
...
defined.compiledHandlerLinks = ["bitmap.fill","fill","found","m_mainbank.set_entry","m_maincpu.set_input_line","m_palette.pen_color","m_screen.update_partial","m_screen.vpos","m_scroll.found","m_stars_config.read_safe","m_timeplt_audio.sh_irqtrigger_w","read_safe","rgb_t::black","set_entry"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
