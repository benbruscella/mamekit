...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_bankselect_w(runtime: any, data: any) {
  ...
  function method_sound_on_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_stars_enable_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_flip_screen_x_w(runtime: any, state: any) {
    const members = runtime.members;
    members.m_flipscreen_x = ((state) & 0xff);
  }

  function method_flip_screen_y_w(runtime: any, state: any) {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
    let mode: any = (((runtime.calls["m_stars_config.read_safe"] ? runtime.calls["m_stars_config.read_safe"]((members.m_star_mode ?? runtime.member("m_star_mode"))) : (members.m_stars_config) != null ? ((runtime.dereference(members.m_stars_config)).read_safe?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0) : (runtime.calls["read_safe"]?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0))) & 0xff);
  ...
  function method_stars_init(runtime: any) {
    const members = runtime.members;
    if ((members.m_star_mode ?? runtime.member("m_star_mode"))) {
  ...
  function method_stars_init_scramble(runtime: any) {
    const members = runtime.members;
    ...
    for (let i: any = 0; ((Number(i) < Number(131071)) ? 1 : 0); i = ((i) + (1))) {
      let shift: any = ((12) & 0xff);
      let enabled: any = ((Number(((shiftreg) & (130561))) === Number(130560)) ? 1 : 0);
      let color: any = (((((~shiftreg)) & (504))) >>> (3));
      runtime.writeIndex(runtime.writableMember("m_stars"), i, ((color) | (((enabled) << (7)))));
      shiftreg = ((((((shiftreg) >>> (1))) | (((((((((shiftreg) >>> (shift))) ^ ((~shiftreg)))) & (1))) << (16))))) >>> 0);
    }
  }

  function method_stars_init_bootleg(runtime: any) {
    const members = runtime.members;
    ...
    let shiftreg: any = ((0) >>> 0);
    for (let i: any = 0; ((Number(i) < Number(131071)) ? 1 : 0); i = ((i) + (1))) {
      let newbit: any = ((((((shiftreg) >>> (12))) ^ ((~shiftreg)))) & (1));
      let enabled: any = (((((Number(((shiftreg) & (130560))) === Number(130560)) ? 1 : 0)) && (((Number(newbit) === Number(0)) ? 1 : 0))) ? 1 : 0);
      let color: any = (((((~shiftreg)) & (504))) >>> (3));
      runtime.writeIndex(runtime.writableMember("m_stars"), i, ((color) | (((enabled) << (7)))));
  ...
  function method_screen_update_scramble(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
    ...
    for (let y: any = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
      ...
      for (let x: any = runtime.divide(cliprect.min_x, 3); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((x) + (1))) {
        ...
        let color: any = (runtime.calls["m_palette.pen_color"] ? runtime.calls["m_palette.pen_color"](((shifted) & (15))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).pen_color?.(((shifted) & (15))) ?? 0) : (runtime.calls["pen_color"]?.(((shifted) & (15))) ?? 0));
  ...
  function method_scramble_draw_background(runtime: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
  ...
  function method_scramble_draw_stars(runtime: any, bitmap: any, cliprect: any, maxx: any) {
    const members = runtime.members;
  ...
  function method_stars_draw_row(runtime: any, bitmap: any, maxx: any, y: any, star_offs: any) {
    const members = runtime.members;
  ...
  function method_screen_update_bootleg(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
    const h_m_scroll = members.m_scroll ?? runtime.member("m_scroll");
    const h_m_videoram = members.m_videoram ?? runtime.member("m_videoram");
    (runtime.calls["bitmap.fill"] ? runtime.calls["bitmap.fill"]((runtime.calls["rgb_t::black"] ? runtime.calls["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) : (bitmap) != null ? ((runtime.dereference(bitmap)).fill?.((runtime.calls["rgb_t::black"] ? runtime.calls["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) ?? 0) : (runtime.calls["fill"]?.((runtime.calls["rgb_t::black"] ? runtime.calls["rgb_t::black"]() : runtime.macro("rgb_t::black")), cliprect) ?? 0));
    ...
    for (let y: any = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
      ...
      for (let x: any = runtime.divide(cliprect.min_x, 3); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((x) + (1))) {
        ...
        let offset: any = runtime.add(((((y) * (384))) + (x)), 84);
