    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_screen_update(runtime, screen, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let mode = (((__l["m_stars_config.read_safe"] ? __l["m_stars_config.read_safe"]((members.m_star_mode ?? runtime.member("m_star_mode"))) : (members.m_stars_config) != null ? ((runtime.dereference(members.m_stars_config)).read_safe?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0) : (__l["read_safe"]?.((members.m_star_mode ?? runtime.member("m_star_mode"))) ?? 0))) & 0xff);
            ...
            function method_stars_init_scramble(runtime) {
                ...
                let shiftreg = ((0) >>> 0);
                for (let i = ((0) | 0); ((Number(i) < Number(131071)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                    let shift = ((12) & 0xff);
                    let enabled = ((((Number(((shiftreg) & (130561))) === Number(130560)) ? 1 : 0)) | 0);
                    let color = ((runtime.shiftRight((((~shiftreg)) & (504)), 3)) | 0);
            ...
            function method_stars_init_bootleg(runtime) {
                ...
                let shiftreg = ((0) >>> 0);
                for (let i = ((0) | 0); ((Number(i) < Number(131071)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                    let newbit = ((((((runtime.shiftRight(shiftreg, 12)) ^ ((~shiftreg)))) & (1))) | 0);
                    let enabled = (((((((Number(((shiftreg) & (130560))) === Number(130560)) ? 1 : 0)) && (((Number(newbit) === Number(0)) ? 1 : 0))) ? 1 : 0)) | 0);
                    let color = ((runtime.shiftRight((((~shiftreg)) & (504)), 3)) | 0);
                    runtime.writeIndex(runtime.writableMember("m_stars"), i, ((color) | (((enabled) << (7)))));
            ...
            function method_screen_update_scramble(runtime, screen, bitmap, cliprect) {
                ...
                let xorx = (((((members.m_flipscreen_x ?? runtime.member("m_flipscreen_x"))) ? (255) : (0))) | 0);
                let xory = (((((members.m_flipscreen_y ?? runtime.member("m_flipscreen_y"))) ? (255) : (0))) | 0);
                for (let y = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                    let dst = bitmap["pix&"](y);
                    for (let x = ((runtime.divide(cliprect.min_x, 3)) | 0); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                        let effx = ((((x) ^ (xorx))) & 0xff);
                        let yscroll = (((((((((Number(effx) < Number(192)) ? 1 : 0)) && ((__l["m_scroll.found"] ? __l["m_scroll.found"]() : (members.m_scroll) != null ? (typeof (runtime.dereference(members.m_scroll)).found === 'function' ? (runtime.dereference(members.m_scroll)).found() : typeof (runtime.dereference(members.m_scroll)).found === 'number' || typeof (runtime.dereference(members.m_scroll)).found === 'boolean' ? (runtime.dereference(members.m_scroll)).found : runtime.container(members.m_scroll, "found")) : (__l["found"]?.() ?? 0)))) ? 1 : 0)) ? (runtime.dereference(h_m_scroll)) : (0))) & 0xff);
                        let effy = ((((((y) ^ (xory))) + (yscroll))) & 0xff);
                        let vrambyte = ((runtime.readIndex(h_m_videoram, runtime.add(((effy) * (128)), runtime.divide(effx, 2)))) & 0xff);
                        let shifted = ((runtime.shiftRight(vrambyte, ((4) * (((effx) & (1)))))) & 0xff);
                        let color = (__l["m_palette.pen_color"] ? __l["m_palette.pen_color"](((shifted) & (15))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).pen_color?.(((shifted) & (15))) ?? 0) : 0);
            ...
            function method_screen_update_bootleg(runtime, screen, bitmap, cliprect) {
                ...
                for (let y = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                    ...
                    for (let x = ((runtime.divide(cliprect.min_x, 3)) | 0); ((Number(x) <= Number(runtime.divide(cliprect.max_x, 3))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                        ...
                        let offset = ((runtime.add(((((y) * (384))) + (x)), 84)) | 0);
