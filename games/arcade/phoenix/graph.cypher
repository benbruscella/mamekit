...
// generated 2026-08-22T05:52:38.907Z
...
MERGE (n:KG {id: 'machine:phoenix_state.phoenix'}) SET n:MachineConfig SET n += {cls: 'phoenix_state', name: 'phoenix', calls: [], startHandlers: ['phoenix_state.video_start'], sourceFile: 'src/mame/phoenix/phoenix.cpp', sourceLine: 455, sourceColumn: 1, sourceEndLine: 482};
...
MERGE (n:KG {id: 'handler:phoenix_state.get_bg_tile_info'}) SET n:Handler SET n += {method: 'get_bg_tile_info', ownerClass: 'phoenix_state', sourceFile: 'src/mame/phoenix/phoenix_v.cpp', sourceLine: 147, sourceColumn: 1, sourceEndLine: 158, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'int code, col;
	...
	tileinfo.set(0,
			...
			col,
			0);'};
MERGE (n:KG {id: 'bank:phoenix_state.phoenix/bank1/0'}) SET n:MemoryBank SET n += {tag: 'bank1', member: 'bank1', startEntry: 0, entries: 1, entryMember: 'm_videoram_pg[0]', offset: 0, stride: 0, raw: 'membank("bank1")->configure_entry(0, m_videoram_pg[0].get())', sourceFile: 'src/mame/phoenix/phoenix_v.cpp', sourceLine: 166, sourceColumn: 1, sourceEndLine: 206};
MERGE (n:KG {id: 'bank:phoenix_state.phoenix/bank1/1'}) SET n:MemoryBank SET n += {tag: 'bank1', member: 'bank1', startEntry: 1, entries: 1, entryMember: 'm_videoram_pg[1]', offset: 1, stride: 0, raw: 'membank("bank1")->configure_entry(1, m_videoram_pg[1].get())', sourceFile: 'src/mame/phoenix/phoenix_v.cpp', sourceLine: 166, sourceColumn: 1, sourceEndLine: 206};
...
MERGE (n:KG {id: 'device:phoenix_state.phoenix/cust'}) SET n:Device SET n += {type: 'PHOENIX_SOUND', tag: 'cust', clock: 0, config: ['PHOENIX_SOUND(config, "cust").add_route(ALL_OUTPUTS, "mono", 0.4)'], sourceFile: 'src/mame/phoenix/phoenix.cpp', sourceLine: 479, sourceColumn: 2, sourceEndLine: 479};
...
MERGE (n:KG {id: 'inputs:phoenix/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:phoenix/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:phoenix/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:phoenix/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNUSED'};
MERGE (n:KG {id: 'inputs:phoenix/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(phoenix_state::player_input_r))']};
...
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Lives', defaultValue: 0, location: 'SW1:1,2', settings: ['0=3', '1=4', '2=5', '3=6']};
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, name: 'Bonus Life', defaultValue: 0, location: 'SW1:3,4', settings: ['0=3K 30K', '4=4K 40K', '8=5K 50K', '12=6K 60K']};
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Coinage', defaultValue: 0, location: 'SW1:5', settings: ['16=2C 1C', '0=1C 1C']};
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Unknown', defaultValue: 32, location: 'SW1:6', settings: ['32=Off', '0=On']};
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Unknown', defaultValue: 64, location: 'SW1:7', settings: ['64=Off', '0=On']};
MERGE (n:KG {id: 'inputs:phoenix/DSW0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_DEVICE_MEMBER("screen", FUNC(screen_device::vblank))']};
MERGE (n:KG {id: 'inputs:phoenix/CAB'}) SET n:Port SET n += {tag: 'CAB', modify: false};
MERGE (n:KG {id: 'inputs:phoenix/CAB/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, name: 'Cabinet', defaultValue: 0, location: 'SW1:!8', settings: ['0=Upright', '1=Cocktail']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL'}) SET n:Port SET n += {tag: 'CTRL', modify: false};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL', 'PORT_CONDITION("CAB",0x01,EQUALS,0x01)']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL', 'PORT_CONDITION("CAB",0x01,EQUALS,0x01)']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL', 'PORT_CONDITION("CAB",0x01,EQUALS,0x01)']};
MERGE (n:KG {id: 'inputs:phoenix/CTRL/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL', 'PORT_CONDITION("CAB",0x01,EQUALS,0x01)']};
