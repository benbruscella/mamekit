...
// generated 2026-09-17T07:12:15.316Z
...
MERGE (n:KG {id: 'device:phoenix_state.phoenix/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(phoenix_state::phoenix_palette), 256)'], member: 'm_palette', sourceFile: 'src/mame/phoenix/phoenix.cpp', sourceLine: 468, sourceColumn: 2, sourceEndLine: 468, clockExpr: 'FUNC(phoenix_state::phoenix_palette)'};
