...
- **Credited by MAMEDEV:** Richard Davies (driver header); ClawGrip (8 release notes); Jordi Tuells (2 release notes); Recreativas.org (2 release notes); Retromaniacs (2 release notes); Robbbert (2 release notes); David Bosque (1 release note); David Haywood (1 release note); Dillweed (1 release note); Jose Gil Boria (1 release note); Museo del Recreativo (1 release note); Osso (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 192 commits by 33 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
