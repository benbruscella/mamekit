...
**Namco · 1981** — transpiled from the MAME driver `src/mame/namco/galaga.cpp` by mamekit.

![marquee](/artwork/media/marquees/galaga.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/galaga.webp) | ![cabinet](/artwork/media/cabinets/galaga.webp) |
...
| `sub` | Z80 | 3.072 MHz | 12 |
| `sub2` | Z80 | 3.072 MHz | 12 |
...
| --- | --- | --- | --- | --- |
| `maincpu` | `gg1_1b.3p` | 0x0 | 0x1000 | `ab036c9f` |
| `maincpu` | `gg1_2b.3m` | 0x1000 | 0x1000 | `d9232240` |
| `maincpu` | `gg1_3.2m` | 0x2000 | 0x1000 | `753ce503` |
| `maincpu` | `gg1_4b.2l` | 0x3000 | 0x1000 | `499fcc76` |
| `sub` | `gg1_5b.3f` | 0x0 | 0x1000 | `bb5caae3` |
| `sub2` | `gg1_7b.2c` | 0x0 | 0x1000 | `d016686b` |
| `gfx1` | `gg1_9.4l` | 0x0 | 0x1000 | `58b2f47c` |
| `gfx2` | `gg1_11.4d` | 0x0 | 0x1000 | `ad447c80` |
| `gfx2` | `gg1_10.4f` | 0x1000 | 0x1000 | `dd6f1afc` |
| `proms` | `prom-5.5n` | 0x0 | 0x20 | `54603c6b` |
| `proms` | `prom-4.2n` | 0x20 | 0x100 | `59b6edab` |
| `proms` | `prom-3.1c` | 0x120 | 0x100 | `4a04bb6b` |
| `namco` | `prom-1.1d` | 0x0 | 0x100 | `7a2815b4` |
| `namco` | `prom-2.5c` | 0x100 | 0x100 | `77245b66` |
...
| Difficulty | `DSWA` | 0x3 | 0x3 |
| Unused | `DSWA` | 0x4 | 0x4 |
| Demo Sounds | `DSWA` | 0x8 | 0x0 |
| Freeze | `DSWA` | 0x10 | 0x10 |
| Rack Test | `DSWA` | 0x20 | 0x20 |
| Unused | `DSWA` | 0x40 | 0x40 |
| Cabinet | `DSWA` | 0x80 | 0x80 |
| Coinage | `DSWB` | 0x7 | 0x7 |
| Bonus Life | `DSWB` | 0x38 | 0x10 |
| Lives | `DSWB` | 0xc0 | 0x80 |
...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); hap (7 release notes); hackbar (4 release notes); Aaron Giles (2 release notes); AJR (1 release note); Angelo Salese (1 release note); ClawGrip (1 release note); neSneSgB (1 release note); Osso (1 release note); Recreativas.org (1 release note); s.ronco (1 release note); Xavier Panadero (1 release note)
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/898/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `galaga`. Play it at [../../../app/g/galaga/](../../../app/g/galaga/) or [explore the knowledge graph](viewer.html).*
