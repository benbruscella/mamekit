...
// generated 2026-09-24T02:27:27.592Z
...
MERGE (n:KG {id: 'machine:galaga_state.galaga'}) SET n:MachineConfig SET n += {cls: 'galaga_state', name: 'galaga', calls: [], stateMembers: ['{"name":"m_galaga_gfxbank","bits":32,"initial":0}', '{"name":"m_main_irq_mask","bits":8,"initial":0}', '{"name":"m_sub_irq_mask","bits":8,"initial":0}', '{"name":"m_sub2_nmi_mask","bits":8,"initial":0}'], driverTimers: ['m_cpu3_interrupt_timer=galaga_state.cpu3_interrupt_callback'], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['galaga_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1653, sourceColumn: 1, sourceEndLine: 1727};
...
MERGE (n:KG {id: 'handler:galaga_state.tilemap_scan'}) SET n:Handler SET n += {method: 'tilemap_scan', ownerClass: 'galaga_state', sourceFile: 'src/mame/namco/galaga_v.cpp', sourceLine: 120, sourceColumn: 1, sourceEndLine: 128, sourceParameters: 'u32 col, u32 row, u32 num_cols, u32 num_rows', sourceBody: 'row += 2;
	...
	if (col & 0x20)
		...
		return col + (row << 5);'};
MERGE (n:KG {id: 'device:galaga_state.galaga/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, MASTER_CLOCK/6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &galaga_state::galaga_map)'], member: 'm_maincpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1656, sourceColumn: 2, sourceEndLine: 1656};
MERGE (n:KG {id: 'device:galaga_state.galaga/sub'}) SET n:Device SET n += {type: 'Z80', tag: 'sub', clock: 3072000, config: ['Z80(config, m_subcpu, MASTER_CLOCK/6)', 'm_subcpu->set_addrmap(AS_PROGRAM, &galaga_state::galaga_map)'], member: 'm_subcpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1659, sourceColumn: 2, sourceEndLine: 1659};
MERGE (n:KG {id: 'device:galaga_state.galaga/sub2'}) SET n:Device SET n += {type: 'Z80', tag: 'sub2', clock: 3072000, config: ['Z80(config, m_subcpu2, MASTER_CLOCK/6)', 'm_subcpu2->set_addrmap(AS_PROGRAM, &galaga_state::galaga_map)'], member: 'm_subcpu2', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1662, sourceColumn: 2, sourceEndLine: 1662};
...
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx'}) SET n:Device SET n += {type: 'NAMCO_51XX', tag: '51xx', clock: 1536000, config: ['namco_51xx_device &n51xx(NAMCO_51XX(config, "51xx", MASTER_CLOCK/6/2))', 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', 'n51xx.output_callback().set(FUNC(galaga_state::out))', 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))'], cls: 'namco_51xx_device', clsHierarchy: ['namco_51xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1674, sourceColumn: 2, sourceEndLine: 1674, startHandler: 'namco_51xx_device.device_start'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:0'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1675, sourceColumn: 2, sourceEndLine: 1675, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:1'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1676, sourceColumn: 2, sourceEndLine: 1676, slot: '1', transforms: ['rshift(4)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:2'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1677, sourceColumn: 2, sourceEndLine: 1677, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:3'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1678, sourceColumn: 2, sourceEndLine: 1678, slot: '3', transforms: ['rshift(4)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:4'}) SET n:Callback SET n += {signal: 'output_callback', member: 'm_out', operation: 'set', raw: 'n51xx.output_callback().set(FUNC(galaga_state::out))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1679, sourceColumn: 2, sourceEndLine: 1679, targetClass: 'galaga_state', targetMethod: 'out'};
MERGE (n:KG {id: 'device:galaga_state.galaga/51xx/callback:51xx:5'}) SET n:Callback SET n += {signal: 'lockout_callback', member: 'm_lockout', operation: 'set', raw: 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1680, sourceColumn: 2, sourceEndLine: 1680, targetClass: 'galaga_state', targetMethod: 'lockout'};
MERGE (n:KG {id: 'device:galaga_state.galaga/54xx'}) SET n:Device SET n += {type: 'NAMCO_54XX', tag: '54xx', clock: 1536000, config: ['namco_54xx_device &n54xx(NAMCO_54XX(config, "54xx", MASTER_CLOCK/6/2))', 'n54xx.set_discrete("discrete")', 'n54xx.set_basenote(NODE_01)'], cls: 'namco_54xx_device', clsHierarchy: ['namco_54xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1682, sourceColumn: 2, sourceEndLine: 1682, configCalls: ['set_discrete("discrete")'], startHandler: 'namco_54xx_device.device_start'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx'}) SET n:Device SET n += {type: 'NAMCO_06XX', tag: '06xx', clock: 48000, config: ['namco_06xx_device &n06xx(NAMCO_06XX(config, "06xx", MASTER_CLOCK/6/64))', 'n06xx.set_maincpu(m_maincpu)', 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', 'n06xx.write_callback<3>().set("54xx", FUNC(namco_54xx_device::write))', 'n06xx.chip_select_callback<3>().set("54xx", FUNC(namco_54xx_device::chip_select))'], cls: 'namco_06xx_device', clsHierarchy: ['namco_06xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1686, sourceColumn: 2, sourceEndLine: 1686, configCalls: ['set_maincpu("maincpu")'], startHandler: 'namco_06xx_device.device_start', deviceTimers: ['m_nmi_timer=namco_06xx_device.nmi_generate']};
...
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:1'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1688, sourceColumn: 2, sourceEndLine: 1688, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:2'}) SET n:Callback SET n += {signal: 'rw_callback', member: 'm_rw', operation: 'set', raw: 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1689, sourceColumn: 2, sourceEndLine: 1689, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'rw'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:3'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1690, sourceColumn: 2, sourceEndLine: 1690, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'read'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:4'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1691, sourceColumn: 2, sourceEndLine: 1691, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:5'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<3>().set("54xx", FUNC(namco_54xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1692, sourceColumn: 2, sourceEndLine: 1692, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:galaga_state.galaga/06xx/callback:06xx:6'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<3>().set("54xx", FUNC(namco_54xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1693, sourceColumn: 2, sourceEndLine: 1693, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:galaga_state.galaga/videolatch'}) SET n:Device SET n += {type: 'LS259', tag: 'videolatch', clock: null, config: ['LS259(config, m_videolatch)', 'm_videolatch->q_out_cb<7>().set(FUNC(galaga_state::flip_screen_set))'], member: 'm_videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1695, sourceColumn: 2, sourceEndLine: 1695};
...
MERGE (n:KG {id: 'handler:galaga_state.screen_vblank_galaga'}) SET n:Handler SET n += {method: 'screen_vblank_galaga', ownerClass: 'galaga_state', sourceFile: 'src/mame/namco/galaga_v.cpp', sourceLine: 252, sourceColumn: 1, sourceEndLine: 268, sourceConstants: ['speed_index_Y=0'], sourceParameters: 'int state', sourceBody: '// falling edge
	if (!state)
	{
...
MERGE (n:KG {id: 'device:galaga_state.galaga/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_galaga)'], member: 'm_gfxdecode', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1713, sourceColumn: 2, sourceEndLine: 1713, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:galaga_state.galaga/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(galaga_state::galaga_palette), 64*4 + 64*4 + 4 + 64, 32+64)'], member: 'm_palette', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1714, sourceColumn: 2, sourceEndLine: 1714, clockExpr: 'FUNC(galaga_state::galaga_palette)', paletteEntries: 96};
MERGE (n:KG {id: 'device:galaga_state.galaga/starfield'}) SET n:Device SET n += {type: 'STARFIELD_05XX', tag: 'starfield', clock: 0, config: ['STARFIELD_05XX(config, m_starfield)', 'm_starfield->set_starfield_config(STARFIELD_X_OFFSET_GALAGA, 0, STARFIELD_X_LIMIT_GALAGA)'], member: 'm_starfield', cls: 'starfield_05xx_device', clsHierarchy: ['starfield_05xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1716, sourceColumn: 2, sourceEndLine: 1716, configCalls: ['set_starfield_config(16,0,272)'], startHandler: 'starfield_05xx_device.device_start'};
...
MERGE (n:KG {id: 'handler:starfield_05xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'starfield_05xx_device', sourceFile: 'src/mame/namco/starfield_05xx.cpp', sourceLine: 662, sourceColumn: 1, sourceEndLine: 674, sourceParameters: '', sourceBody: 'save_item(NAME(m_enable));
...
MATCH (a:KG {id: 'device:galaga_state.galaga/51xx'}), (b:KG {id: 'handler:namco_51xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:galaga_state.galaga/54xx'}), (b:KG {id: 'machine:namco_54xx_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:galaga_state.galaga/54xx'}), (b:KG {id: 'handler:namco_54xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:galaga_state.galaga/06xx'}), (b:KG {id: 'handler:namco_06xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:galaga_state.galaga/starfield'}), (b:KG {id: 'handler:starfield_05xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
