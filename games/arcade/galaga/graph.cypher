...
// generated 2026-09-11T11:44:21.437Z
...
MERGE (n:KG {id: 'machine:galaga_state.galaga'}) SET n:MachineConfig SET n += {cls: 'galaga_state', name: 'galaga', calls: [], stateMembers: ['{"name":"m_galaga_gfxbank","bits":32,"initial":0}', '{"name":"m_main_irq_mask","bits":8,"initial":0}', '{"name":"m_sub_irq_mask","bits":8,"initial":0}', '{"name":"m_sub2_nmi_mask","bits":8,"initial":0}'], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['galaga_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1653, sourceColumn: 1, sourceEndLine: 1727};
