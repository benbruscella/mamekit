...
// generated 2026-09-17T07:11:51.791Z
...
MERGE (n:KG {id: 'device:galaga_state.galaga/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(galaga_state::galaga_palette), 64*4 + 64*4 + 4 + 64, 32+64)'], member: 'm_palette', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1714, sourceColumn: 2, sourceEndLine: 1714, clockExpr: 'FUNC(galaga_state::galaga_palette)'};
