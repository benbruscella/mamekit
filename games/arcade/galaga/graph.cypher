...
// generated 2026-08-22T05:52:21.584Z
...
MERGE (n:KG {id: 'machine:galaga_state.galaga'}) SET n:MachineConfig SET n += {cls: 'galaga_state', name: 'galaga', calls: [], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['galaga_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1653, sourceColumn: 1, sourceEndLine: 1727};
