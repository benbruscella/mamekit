...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_galaga_videoram_w(runtime: any, offset: any, data: any) {
  ...
  function method_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let color: any = ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), ((tile_index) + (1024)))) & (63));
  ...
  function method_screen_update_galaga(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = 0; ((Number(offs) < Number(128)) ? 1 : 0); offs = ((offs) + (2))) {
      let sprite: any = ((runtime.readIndex(spriteram, offs)) & (127));
      let color: any = ((runtime.readIndex(spriteram, ((offs) + (1)))) & (63));
      let sx: any = runtime.add(((runtime.readIndex(spriteram_2, ((offs) + (1)))) - (40)), ((256) * (((runtime.readIndex(spriteram_3, ((offs) + (1)))) & (3)))));
      ...
      let sizex: any = ((((runtime.readIndex(spriteram_3, offs)) & (4))) >>> (2));
      let sizey: any = ((((runtime.readIndex(spriteram_3, offs)) & (8))) >>> (3));
      sy = ((sy) - (((16) * (sizey))));
      sy = ((((sy) & (255))) - (32));
