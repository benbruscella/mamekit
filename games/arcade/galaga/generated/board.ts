...
defined.compiledHandlers = {
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    let spriteram: any = runtime.addressOf((members.m_galaga_ram1 ?? runtime.member("m_galaga_ram1")), 896);
    let spriteram_2: any = runtime.addressOf((members.m_galaga_ram2 ?? runtime.member("m_galaga_ram2")), 896);
    let spriteram_3: any = runtime.addressOf((members.m_galaga_ram3 ?? runtime.member("m_galaga_ram3")), 896);
    for (let offs: any = ((0) | 0); ((Number(offs) < Number(128)) ? 1 : 0); offs = ((((offs) + (2))) | 0)) {
      ...
      let sizex: any = ((runtime.shiftRight(((runtime.readIndex(spriteram_3, offs)) & (4)), 2)) | 0);
      let sizey: any = ((runtime.shiftRight(((runtime.readIndex(spriteram_3, offs)) & (8)), 3)) | 0);
      sy = ((((sy) - (((16) * (sizey))))) | 0);
      sy = ((((((sy) & (255))) - (32))) | 0);
