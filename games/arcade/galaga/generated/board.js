    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let color = ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), ((tile_index) + (1024)))) & (63))) | 0);
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let spriteram = runtime.addressOf((members.m_galaga_ram1 ?? runtime.member("m_galaga_ram1")), 896);
                let spriteram_2 = runtime.addressOf((members.m_galaga_ram2 ?? runtime.member("m_galaga_ram2")), 896);
                let spriteram_3 = runtime.addressOf((members.m_galaga_ram3 ?? runtime.member("m_galaga_ram3")), 896);
                for (let offs = ((0) | 0); ((Number(offs) < Number(128)) ? 1 : 0); offs = ((((offs) + (2))) | 0)) {
                    let sprite = ((((runtime.readIndex(spriteram, offs)) & (127))) | 0);
                    let color = ((((runtime.readIndex(spriteram, ((offs) + (1)))) & (63))) | 0);
                    let sx = ((runtime.add(((runtime.readIndex(spriteram_2, ((offs) + (1)))) - (40)), ((256) * (((runtime.readIndex(spriteram_3, ((offs) + (1)))) & (3)))))) | 0);
                    ...
                    let sizex = ((runtime.shiftRight(((runtime.readIndex(spriteram_3, offs)) & (4)), 2)) | 0);
                    let sizey = ((runtime.shiftRight(((runtime.readIndex(spriteram_3, offs)) & (8)), 3)) | 0);
                    sy = ((((sy) - (((16) * (sizey))))) | 0);
                    sy = ((((((sy) & (255))) - (32))) | 0);
