    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_paletteram_w(runtime, offset, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let old_data = (((__l["m_palette.read8"] ? __l["m_palette.read8"](offset) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).read8?.(offset) ?? 0) : 0)) & 0xff);
