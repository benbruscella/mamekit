...
**Taito America · 1981** — transpiled from the MAME driver `src/mame/taito/qix.cpp` by mamekit.

![marquee](/artwork/media/marquees/qix.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/qix.webp) | ![cabinet](/artwork/media/cabinets/qix.webp) |

## The machine

| CPU | Type | Clock | Mapped ranges |
| --- | --- | --- | --- |
| `maincpu` | MC6809E | 1.250 MHz | 10 |
| `videocpu` | MC6809E | 1.250 MHz | 13 |
| `audiocpu` | M6802 | 3.686 MHz | 3 |

- **Sound:** discrete @ 1.250 MHz
- **Screen:** 256×256 @ 55.84 Hz · rotated 270°

### ROM chips

| Region | Chip | Offset | Size | CRC |
| --- | --- | --- | --- | --- |
| `maincpu` | `qq12_rev2.u12` | 0xc000 | 0x800 | `aad35508` |
| `maincpu` | `qq13_rev2.u13` | 0xc800 | 0x800 | `46c13504` |
| `maincpu` | `qq14_rev2.u14` | 0xd000 | 0x800 | `5115e896` |
| `maincpu` | `qq15_rev2.u15` | 0xd800 | 0x800 | `ccd52a1b` |
| `maincpu` | `qq16_rev2.u16` | 0xe000 | 0x800 | `cd1c36ee` |
| `maincpu` | `qq17_rev2.u17` | 0xe800 | 0x800 | `1acb682d` |
| `maincpu` | `qq18_rev2.u18` | 0xf000 | 0x800 | `de77728b` |
| `maincpu` | `qq19_rev2.u19` | 0xf800 | 0x800 | `c0994776` |
| `videocpu` | `qq4_rev2.u4` | 0xc800 | 0x800 | `5b906a09` |
| `videocpu` | `qq5_rev2.u5` | 0xd000 | 0x800 | `254a3587` |
| `videocpu` | `qq6_rev2.u6` | 0xd800 | 0x800 | `ace30389` |
| `videocpu` | `qq7_rev2.u7` | 0xe000 | 0x800 | `8ebcfa7c` |
| `videocpu` | `qq8_rev2.u8` | 0xe800 | 0x800 | `b8a3c8f9` |
| `videocpu` | `qq9_rev2.u9` | 0xf000 | 0x800 | `26cbcd55` |
| `videocpu` | `qq10_rev2.u10` | 0xf800 | 0x800 | `568be942` |
| `audiocpu` | `qq27.u27` | 0xf800 | 0x800 | `f3782bd0` |
...
| Left | joystick left | `P1` | 0x8 |
| Z | button2 | `P1` | 0x10 |
| 2 | start2 | `P1` | 0x20 |
| 1 | start1 | `P1` | 0x40 |
| Space / X | button1 | `P1` | 0x80 |
| 9 | test advance | `COIN` | 0x1 |
| 8 | test next line | `COIN` | 0x2 |
| 7 | test slew up | `COIN` | 0x4 |
| 0 | test slew down | `COIN` | 0x8 |
| 5 | coin1 | `COIN` | 0x10 |
| 6 | coin2 | `COIN` | 0x20 |

## The MAME driver — the people who reverse-engineered it

- **Driver source:** `src/mame/taito/qix.cpp`
- **Written by:** Aaron Giles, Zsolt Vasvari
- **License:** BSD-3-Clause
- **Credited by MAMEDEV:** Aaron Giles (driver header); Zsolt Vasvari (driver header); OzFalcon (2 release notes); AJR (1 release note); cam900 (1 release note); Ivan Vangelista (1 release note); O. Galibert (1 release note); Phil Bennett (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 146 commits by 31 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
...
* HANDHELDS: 
[AU] Nintendo Game Boy (1990) "Qix [Model DMG-QX-AUS]" 
...
[US] Atari Lynx (1991) "Qix [Model LX102]" by Telegames, Inc. 
...
[EU] BBC B (1983) "Stix" by Supersoft 
[US] Commodore C64 [EU] (1983) "Stix" by Supersoft 
[US] Atari 800 (1983) "Qix [Model CXL4027]" 
[JP] Sharp MZ-700 (1983) by Carry Lab
[US] Tandy Color Computer (1984) "Qiks" 
[US] Tandy Color Computer (1984) "Quix" 
[US] Commodore Amiga (1989) 
[US] Commodore C64 (1989) 
[US] Apple II (1989) 
[US] PC [MS-DOS] (1989) 
[US] Apple IIGS (1990) 
[US] Oric (2004) "4kQix" : PD / Shareware by Stephane Geley
...
[US] "Arcade Legends: Space Invaders TV Game" (2004) by Radica Games : Also inlcudes Lunar Rescue, Colony 7, Qix and Phoenix.
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/2096/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `qix`. Play it at [../../../app/g/qix/](../../../app/g/qix/) or [explore the knowledge graph](viewer.html).*
