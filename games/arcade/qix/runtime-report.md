...
MAME source coverage: **140/170 nodes (82.4%)**

| Stage | Count | Meaning |
|---|---:|---|
| Executable | 26 | Hardware lowered from MAME source to executable IR |
| Generated | 44 | Wiring, handlers, schedules and composition emitted from source/KG |
...
- `vid_u18.set_begin_update_callback -> qix_state.crtc_begin_update` - src/mame/taito/qix_v.cpp:378
- `vid_u18.set_update_row_callback -> qix_state.crtc_update_row` - src/mame/taito/qix_v.cpp:379
