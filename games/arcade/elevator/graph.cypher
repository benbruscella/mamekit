...
// generated 2026-09-24T02:26:58.025Z
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 4000000, config: ['Z80(config, m_maincpu, 8_MHz_XTAL / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &taitosj_state::main_nomcu_map)', 'm_maincpu->busack_cb().set(m_mcu, FUNC(taito_sj_security_mcu_device::busak_w))'], member: 'm_maincpu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1665, sourceColumn: 2, sourceEndLine: 1665};
MERGE (n:KG {id: 'device:taitosj_state.nomcu/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3000000, config: ['Z80(config, m_audiocpu, 12_MHz_XTAL / 4)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &taitosj_state::taitosj_audio_map)', 'm_audiocpu->set_periodic_int(FUNC(taitosj_state::irq0_line_hold), attotime::from_hz(12_MHz_XTAL / (2*4*16*16*10*16)))'], member: 'm_audiocpu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1668, sourceColumn: 2, sourceEndLine: 1668};
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(12_MHz_XTAL / 2, 384, 0, 256, 264, 16, 240)', 'm_screen->set_screen_update(FUNC(taitosj_state::screen_update))', 'm_screen->set_video_attributes(VIDEO_ALWAYS_UPDATE)', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set_inputline(m_maincpu, INPUT_LINE_IRQ0, HOLD_LINE)'], member: 'm_screen', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1677, sourceColumn: 2, sourceEndLine: 1677, configCalls: ['set_raw(6000000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['12_MHz_XTAL / 2', '384', '0', '256', '264', '16', '240'], screenVideoAttributes: ['VIDEO_ALWAYS_UPDATE']};
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_taitosj)'], member: 'm_gfxdecode', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1684, sourceColumn: 2, sourceEndLine: 1684, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:taitosj_state.nomcu/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(64)'], member: 'm_palette', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1685, sourceColumn: 2, sourceEndLine: 1685, paletteEntries: 64};
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/dac'}) SET n:Device SET n += {type: 'DAC_8BIT_R2R', tag: 'dac', clock: null, config: ['DAC_8BIT_R2R(config, m_dac).add_route(ALL_OUTPUTS, "speaker", 0.15)'], member: 'm_dac', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1720, sourceColumn: 2, sourceEndLine: 1720};
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/dacvol'}) SET n:Device SET n += {type: 'DISCRETE', tag: 'dacvol', clock: null, config: ['DISCRETE(config, m_dacvol, taitosj_dacvol_discrete)', 'm_dacvol->set_clock(48000 * 32)', 'm_dacvol->add_route(0, "dac", 1.0, DAC_INPUT_RANGE_HI)', 'm_dacvol->add_route(0, "dac", -1.0, DAC_INPUT_RANGE_LO)'], member: 'm_dacvol', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1721, sourceColumn: 2, sourceEndLine: 1721, configCalls: ['set_clock(1536000)', 'add_route(0,"dac",1,0)', 'add_route(0,"dac",-1,1)'], clockExpr: 'taitosj_dacvol_discrete'};
...
MERGE (n:KG {id: 'device:taitosj_state.mcu/mcu'}) SET n:Device SET n += {type: 'TAITO_SJ_SECURITY_MCU', tag: 'mcu', clock: 3000000, config: ['TAITO_SJ_SECURITY_MCU(config, m_mcu, 3_MHz_XTAL)', 'm_mcu->set_int_mode(taito_sj_security_mcu_device::int_mode::LATCH)', 'm_mcu->m68read_cb().set(FUNC(taitosj_state::mcu_mem_r))', 'm_mcu->m68write_cb().set(FUNC(taitosj_state::mcu_mem_w))', 'm_mcu->m68intrq_cb().set(FUNC(taitosj_state::mcu_intrq_w))', 'm_mcu->busrq_cb().set_inputline(m_maincpu, Z80_INPUT_LINE_BUSREQ)'], member: 'm_mcu', cls: 'taito_sj_security_mcu_device', clsHierarchy: ['taito_sj_security_mcu_device'], sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1737, sourceColumn: 2, sourceEndLine: 1737, startHandler: 'taito_sj_security_mcu_device.device_start'};
MERGE (n:KG {id: 'device:taitosj_state.mcu/mcu/callback:mcu:0'}) SET n:Callback SET n += {signal: 'm68read_cb', member: 'm_68read_cb', operation: 'set', raw: 'm_mcu->m68read_cb().set(FUNC(taitosj_state::mcu_mem_r))', ownerTag: 'mcu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1739, sourceColumn: 2, sourceEndLine: 1739, targetClass: 'taitosj_state', targetMethod: 'mcu_mem_r'};
...
MERGE (n:KG {id: 'device:taitosj_state.mcu/mcu/callback:mcu:1'}) SET n:Callback SET n += {signal: 'm68write_cb', member: 'm_68write_cb', operation: 'set', raw: 'm_mcu->m68write_cb().set(FUNC(taitosj_state::mcu_mem_w))', ownerTag: 'mcu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1740, sourceColumn: 2, sourceEndLine: 1740, targetClass: 'taitosj_state', targetMethod: 'mcu_mem_w'};
...
MERGE (n:KG {id: 'device:taitosj_state.mcu/mcu/callback:mcu:2'}) SET n:Callback SET n += {signal: 'm68intrq_cb', member: 'm_68intrq_cb', operation: 'set', raw: 'm_mcu->m68intrq_cb().set(FUNC(taitosj_state::mcu_intrq_w))', ownerTag: 'mcu', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1741, sourceColumn: 2, sourceEndLine: 1741, targetClass: 'taitosj_state', targetMethod: 'mcu_intrq_w'};
...
MERGE (n:KG {id: 'device:taito_sj_security_mcu_device.device_add_mconfig/mcu'}) SET n:Device SET n += {type: 'M68705P5', tag: 'mcu', clock: 3000000, config: ['M68705P5(config, m_mcu, DERIVED_CLOCK(1, 1))', 'm_mcu->porta_r().set(FUNC(taito_sj_security_mcu_device::mcu_pa_r))', 'm_mcu->portc_r().set(FUNC(taito_sj_security_mcu_device::mcu_pc_r))', 'm_mcu->porta_w().set(FUNC(taito_sj_security_mcu_device::mcu_pa_w))', 'm_mcu->portb_w().set(FUNC(taito_sj_security_mcu_device::mcu_pb_w))'], member: 'm_mcu', sourceFile: 'src/mame/taito/taitosjsec.cpp', sourceLine: 123, sourceColumn: 2, sourceEndLine: 123};
...
MERGE (n:KG {id: 'handler:taito_sj_security_mcu_device.do_mcu_write'}) SET n:Handler SET n += {method: 'do_mcu_write', ownerClass: 'taito_sj_security_mcu_device', sourceFile: 'src/mame/taito/taitosjsec.cpp', sourceLine: 213, sourceColumn: 1, sourceEndLine: 218, sourceParameters: 'int param', sourceBody: 'm_mcu_data = u8(param);
	if (!m_reset)
		m_zaccept = false;'};
MERGE (n:KG {id: 'handler:taito_sj_security_mcu_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'taito_sj_security_mcu_device', sourceFile: 'src/mame/taito/taitosjsec.cpp', sourceLine: 91, sourceColumn: 1, sourceEndLine: 111, sourceParameters: '', sourceBody: 'save_item(NAME(m_addr));
...
MATCH (a:KG {id: 'device:taitosj_state.mcu/mcu'}), (b:KG {id: 'handler:taito_sj_security_mcu_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
