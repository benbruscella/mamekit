...
// generated 2026-08-22T05:52:14.989Z
...
MERGE (n:KG {id: 'machine:taitosj_state.nomcu'}) SET n:MachineConfig SET n += {cls: 'taitosj_state', name: 'nomcu', calls: [], resetHandlers: ['taitosj_state.machine_reset'], startHandlers: ['taitosj_state.video_start'], sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1662, sourceColumn: 1, sourceEndLine: 1725};
...
MERGE (n:KG {id: 'machine:taito_sj_security_mcu_device.device_add_mconfig'}) SET n:MachineConfig SET n += {cls: 'taito_sj_security_mcu_device', name: 'device_add_mconfig', calls: [], sourceFile: 'src/mame/taito/taitosjsec.cpp', sourceLine: 121, sourceColumn: 1, sourceEndLine: 128};
...
MERGE (n:KG {id: 'inputs:elevator/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:elevator/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:elevator/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:elevator/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY']};
MERGE (n:KG {id: 'inputs:elevator/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1'};
MERGE (n:KG {id: 'inputs:elevator/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2'};
MERGE (n:KG {id: 'inputs:elevator/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:elevator/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL']};
MERGE (n:KG {id: 'inputs:elevator/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:elevator/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_COIN2'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN1'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_START1'};
MERGE (n:KG {id: 'inputs:elevator/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_START2'};
MERGE (n:KG {id: 'inputs:elevator/IN3'}) SET n:Port SET n += {tag: 'IN3', modify: false};
MERGE (n:KG {id: 'inputs:elevator/IN3/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_SERVICE1'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_TILT'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN3/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN4'}) SET n:Port SET n += {tag: 'IN4', modify: false};
MERGE (n:KG {id: 'inputs:elevator/IN4/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 15, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:elevator/IN4/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(taitosj_state::input_port_4_f0_r))']};
MERGE (n:KG {id: 'inputs:elevator/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:elevator/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Bonus Life', defaultValue: 3, location: 'SWA:1,2', settings: ['3=10000', '2=15000', '1=20000', '0=25000']};
MERGE (n:KG {id: 'inputs:elevator/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Free Play', defaultValue: 4, location: 'SWA:3', settings: ['4=Off', '0=On']};
MERGE (n:KG {id: 'inputs:elevator/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 24, name: 'Lives', defaultValue: 24, location: 'SWA:4,5', settings: ['24=3', '16=4', '8=5', '0=6']};
MERGE (n:KG {id: 'inputs:elevator/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Flip Screen', defaultValue: 64, location: 'SWA:7', settings: ['64=Off', '0=On']};
MERGE (n:KG {id: 'inputs:elevator/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Cabinet', defaultValue: 0, location: 'SWA:8', settings: ['0=Upright', '128=Cocktail']};
MERGE (n:KG {id: 'inputs:elevator/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:elevator/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, name: 'Coin A', defaultValue: 0, location: 'SWB:1,2,3,4', settings: ['15=9C 1C', '14=8C 1C', '13=7C 1C', '12=6C 1C', '11=5C 1C', '10=4C 1C', '9=3C 1C', '8=2C 1C', '0=1C 1C', '1=1C 2C', '2=1C 3C', '3=1C 4C', '4=1C 5C', '5=1C 6C', '6=1C 7C', '7=1C 8C']};
MERGE (n:KG {id: 'inputs:elevator/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 240, name: 'Coin B', defaultValue: 0, location: 'SWB:5,6,7,8', settings: ['240=9C 1C', '224=8C 1C', '208=7C 1C', '192=6C 1C', '176=5C 1C', '160=4C 1C', '144=3C 1C', '128=2C 1C', '0=1C 1C', '16=1C 2C', '32=1C 3C', '48=1C 4C', '64=1C 5C', '80=1C 6C', '96=1C 7C', '112=1C 8C']};
MERGE (n:KG {id: 'inputs:elevator/DSW3'}) SET n:Port SET n += {tag: 'DSW3', modify: false};
MERGE (n:KG {id: 'inputs:elevator/DSW3/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Difficulty', defaultValue: 3, location: 'SWC:1,2', settings: ['3=Easiest', '2=Easy', '1=Normal', '0=Hard']};
MERGE (n:KG {id: 'inputs:elevator/DSW3/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Coinage Display', defaultValue: 16, location: 'SWC:5', settings: ['16=Coins/Credits', '0=Insert Coin']};
MERGE (n:KG {id: 'inputs:elevator/DSW3/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Year Display', defaultValue: 32, location: 'SWC:6', settings: ['0=No', '32=Yes']};
MERGE (n:KG {id: 'inputs:elevator/DSW3/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Hit Detection', defaultValue: 64, location: 'SWC:7', settings: ['64=Normal Game', '0=No Hit']};
MERGE (n:KG {id: 'inputs:elevator/DSW3/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Coin Slots', defaultValue: 128, location: 'SWC:8', settings: ['128=A and B', '0=A only']};
...
MATCH (a:KG {id: 'machine:taitosj_state.mcu'}), (b:KG {id: 'machine:taitosj_state.nomcu'}) MERGE (a)-[r:CALLS]->(b);
