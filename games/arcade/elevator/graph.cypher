...
// generated 2026-09-17T07:11:47.479Z
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(64)'], member: 'm_palette', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1685, sourceColumn: 2, sourceEndLine: 1685};
...
MERGE (n:KG {id: 'device:taitosj_state.nomcu/dacvol'}) SET n:Device SET n += {type: 'DISCRETE', tag: 'dacvol', clock: null, config: ['DISCRETE(config, m_dacvol, taitosj_dacvol_discrete)', 'm_dacvol->set_clock(48000 * 32)', 'm_dacvol->add_route(0, "dac", 1.0, DAC_INPUT_RANGE_HI)', 'm_dacvol->add_route(0, "dac", -1.0, DAC_INPUT_RANGE_LO)'], member: 'm_dacvol', sourceFile: 'src/mame/taito/taitosj.cpp', sourceLine: 1721, sourceColumn: 2, sourceEndLine: 1721, configCalls: ['set_clock(1536000)'], clockExpr: 'taitosj_dacvol_discrete'};
