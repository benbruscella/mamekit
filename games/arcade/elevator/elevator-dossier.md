...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); David Haywood (3 release notes); hap (3 release notes); Angelo Salese (1 release note); CWorks (1 release note); fipppi (1 release note); jkburks (1 release note); MetalGod (1 release note); O. Galibert (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 218 commits by 32 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
