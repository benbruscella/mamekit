...
const defined = decodeBoardIr(boardData, 'elevator');
...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_fake_data_r(runtime) {
                const members = runtime.members;
                0;
                return 0;
            }
            function method_fake_data_w(runtime, data) {
                const members = runtime.members;
                0;
            }
            function method_fake_status_r(runtime) {
                const members = runtime.members;
                0;
                return 255;
            }
            function method_gfxrom_r(runtime) {
                const members = runtime.members;
                const h_m_gfx = members.m_gfx ?? runtime.member("m_gfx");
                let ret = ((0) & 0xff);
                let offs = ((runtime.readIndex((members.m_gfxpointer ?? runtime.member("m_gfxpointer")), 0)) | (((runtime.readIndex((members.m_gfxpointer ?? runtime.member("m_gfxpointer")), 1)) << (8))));
                ...
                runtime.writeIndex(runtime.writableMember("m_gfxpointer"), 1, runtime.shiftRight(offs, 8));
                return ret;
            }
            function method_collision_reg_clear_w(runtime, data) {
                const members = runtime.members;
            ...
            function method_soundlatch_flags_r(runtime) {
                const members = runtime.members;
            ...
            function method_input_port_4_f0_w(runtime, data) {
                const members = runtime.members;
                members.m_input_port_4_f0 = ((runtime.shiftRight(data, 4)) & 0xff);
            }
            function method_mcu_intrq_w(runtime, state) {
                const members = runtime.members;
                if (((Number(0) !== Number(state)) ? 1 : 0)) {
                    0;
                }
            }
            return {
                ...
                "mcu_intrq_w": method_mcu_intrq_w
            };
        })();
        return {
            ...
            "taitosj_state.mcu_intrq_w": methods["mcu_intrq_w"],
        };
    })(),
};
