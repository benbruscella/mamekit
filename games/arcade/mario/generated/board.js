    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let code = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((256) * ((members.m_gfx_bank ?? runtime.member("m_gfx_bank")))));
                let color = runtime.add(runtime.add(8, ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index)) >>> (5))), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))));
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                let flip = (((((runtime.calls["flip_screen"] ? runtime.calls["flip_screen"]() : runtime.macro("flip_screen"))) ? (255) : (0))) & 0xff);
                let offs = 0;
                while (((Number(offs) !== Number((members.m_spriteram).length)) ? 1 : 0)) {
                    if (runtime.readIndex(h_m_spriteram, offs)) {
                        let y = ((runtime.add(runtime.add(runtime.readIndex(h_m_spriteram, ((offs) + (0))), ((flip) ? (247) : (249))), 1)) & (255));
                        let x = runtime.readIndex(h_m_spriteram, ((offs) + (3)));
                        y = ((240) - (y));
                        y = ((y) ^ (flip));
                        x = ((x) ^ (flip));
                        let code = runtime.readIndex(h_m_spriteram, ((offs) + (2)));
                        let color = runtime.add(((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))));
                        let flipx = ((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (128));
                        let flipy = ((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (64));
                        if (flip) {
                            y = ((y) - (14));
                            x = ((x) - (7));
                            flipx = ((flipx) ? 0 : 1);
