    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let color = ((runtime.add(runtime.add(8, ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index)) >>> (5))), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))))) | 0);
