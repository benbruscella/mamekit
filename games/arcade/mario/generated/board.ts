...
defined.compiledHandlers = {
  ...
  function method_scroll_w(runtime: any, data: any): any {
    ...
    (__l["m_bg_tilemap.set_scrolly"] ? __l["m_bg_tilemap.set_scrolly"](0, ((data) + (17))) : (members.m_bg_tilemap) != null ? ((runtime.dereference(members.m_bg_tilemap)).set_scrolly?.(0, ((data) + (17))) ?? 0) : (__l["set_scrolly"]?.(0, ((data) + (17))) ?? 0));
  }
  ...
  function method_dac_w(runtime: any, data: any): any {
    ...
    (__l["m_audio_dac.write"] ? __l["m_audio_dac.write"](data) : (members.m_audio_dac) != null ? ((runtime.dereference(members.m_audio_dac)).write?.(data) ?? 0) : 0);
  }
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let code: any = ((runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((256) * ((members.m_gfx_bank ?? runtime.member("m_gfx_bank")))))) | 0);
    let color: any = ((runtime.add(runtime.add(8, runtime.shiftRight(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), 5)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))))) | 0);
  ...
  function method_nmi_mask_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    let flip: any = (((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (255) : (0))) & 0xff);
    let offs: any = ((0) | 0);
    while (((Number(offs) !== Number((members.m_spriteram).length)) ? 1 : 0)) {
      if (runtime.readIndex(h_m_spriteram, offs)) {
        let y: any = ((((runtime.add(runtime.add(runtime.readIndex(h_m_spriteram, ((offs) + (0))), ((flip) ? (247) : (249))), 1)) & (255))) | 0);
        let x: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (3)))) | 0);
        y = ((((240) - (y))) | 0);
        y = ((((y) ^ (flip))) | 0);
        x = ((((x) ^ (flip))) | 0);
        let code: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (2)))) | 0);
        let color: any = ((runtime.add(((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))))) | 0);
        let flipx: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (128))) | 0);
        let flipy: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (64))) | 0);
        if (flip) {
          y = ((((y) - (14))) | 0);
          x = ((((x) - (7))) | 0);
          flipx = ((((flipx) ? 0 : 1)) | 0);
...
defined.compiledHandlerLinks = ["draw","flip_screen","m_audio_dac.write","m_bg_tilemap.draw","m_bg_tilemap.mark_tile_dirty","m_bg_tilemap.set_scrolly","m_gfxdecode.gfx","m_maincpu.set_input_line","mark_tile_dirty","set","set_scrolly","tileinfo.set"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
