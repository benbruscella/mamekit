...
// generated 2026-09-11T11:44:34.974Z
...
MERGE (n:KG {id: 'device:mario_state.mario_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(mario_state::palette), 256)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 865, sourceColumn: 2, sourceEndLine: 865, clockExpr: 'FUNC(mario_state::palette)'};
