...
// generated 2026-09-24T02:28:31.570Z
...
MERGE (n:KG {id: 'machine:mario_state.mario_base'}) SET n:MachineConfig SET n += {cls: 'mario_state', name: 'mario_base', calls: [], stateMembers: ['{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_nmi_mask","bits":1}', '{"name":"m_z80_sync","bits":1}'], resetHandlers: ['mario_state.machine_reset'], startHandlers: ['mario_state.video_start'], sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 831, sourceColumn: 1, sourceEndLine: 866};
...
MERGE (n:KG {id: 'device:mario_state.mario_base/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 4000000, config: ['Z80(config, m_maincpu, 8_MHz_XTAL / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &mario_state::mario_map)', 'm_maincpu->set_addrmap(AS_IO, &mario_state::mario_io_map)', 'm_maincpu->busack_cb().set(m_z80dma, FUNC(z80dma_device::bai_w))'], member: 'm_maincpu', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 834, sourceColumn: 2, sourceEndLine: 834};
...
MERGE (n:KG {id: 'device:mario_state.mario_base/z80dma'}) SET n:Device SET n += {type: 'Z80DMA', tag: 'z80dma', clock: 4000000, config: ['Z80DMA(config, m_z80dma, 8_MHz_XTAL / 2)', 'm_z80dma->out_busreq_callback().set_inputline(m_maincpu, Z80_INPUT_LINE_BUSREQ)', 'm_z80dma->in_mreq_callback().set(FUNC(mario_state::memory_read_byte))', 'm_z80dma->out_mreq_callback().set(FUNC(mario_state::memory_write_byte))'], member: 'm_z80dma', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 840, sourceColumn: 2, sourceEndLine: 840};
...
MERGE (n:KG {id: 'device:mario_state.mario_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(24_MHz_XTAL / 4, 384, 0, 256, 264, 16, 240)', 'screen.set_screen_update(FUNC(mario_state::screen_update))', 'screen.set_palette(m_palette)', 'screen.screen_vblank().set(FUNC(mario_state::vblank_irq))'], sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 858, sourceColumn: 2, sourceEndLine: 858, configCalls: ['set_raw(6000000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['24_MHz_XTAL / 4', '384', '0', '256', '264', '16', '240']};
...
MERGE (n:KG {id: 'device:mario_state.mario_base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_mario)'], member: 'm_gfxdecode', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 864, sourceColumn: 2, sourceEndLine: 864, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:mario_state.mario_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(mario_state::palette), 256)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 865, sourceColumn: 2, sourceEndLine: 865, clockExpr: 'FUNC(mario_state::palette)', paletteEntries: 256};
MERGE (n:KG {id: 'machine:mario_state.mario'}) SET n:MachineConfig SET n += {cls: 'mario_state', name: 'mario', calls: ['mario_base'], stateMembers: ['{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_nmi_mask","bits":1}', '{"name":"m_z80_sync","bits":1}'], resetHandlers: ['mario_state.machine_reset'], startHandlers: ['mario_state.video_start'], sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 868, sourceColumn: 1, sourceEndLine: 896};
MERGE (n:KG {id: 'device:mario_state.mario/audiocpu'}) SET n:Device SET n += {type: 'M58715', tag: 'audiocpu', clock: 11000000, config: ['m58715_device &audiocpu(M58715(config, m_audiocpu, 11_MHz_XTAL))', 'audiocpu.set_addrmap(AS_PROGRAM, &mario_state::mario_sound_map)', 'audiocpu.set_addrmap(AS_IO, &mario_state::mario_sound_io_map)', 'audiocpu.p1_in_cb().set(m_soundlatch[1], FUNC(generic_latch_8_device::read))', 'audiocpu.p2_in_cb().set(m_soundlatch[2], FUNC(generic_latch_8_device::read)).mask(0xef)', 'audiocpu.p2_out_cb().set(m_soundlatch[2], FUNC(generic_latch_8_device::write))', 'audiocpu.p2_out_cb().append_inputline(m_audiocpu, MCS48_INPUT_EA).bit(5).invert()', 'audiocpu.t0_in_cb().set(m_soundlatch[3], FUNC(generic_latch_8_device::read)).bit(0)', 'audiocpu.t1_in_cb().set(m_soundlatch[3], FUNC(generic_latch_8_device::read)).bit(1)'], member: 'm_audiocpu', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 873, sourceColumn: 2, sourceEndLine: 873};
...
MERGE (n:KG {id: 'device:mario_state.mario/snd_nl:dac'}) SET n:Device SET n += {type: 'NETLIST_INT_INPUT', tag: 'snd_nl:dac', clock: null, config: ['NETLIST_INT_INPUT(config, m_audio_dac, "DAC.VAL", 0, 255)'], member: 'm_audio_dac', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 893, sourceColumn: 2, sourceEndLine: 893, clockExpr: '"DAC.VAL"'};
...
MERGE (n:KG {id: 'inputs:mario/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_START2', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:mario/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:mario/DSW'}) SET n:Port SET n += {tag: 'DSW', modify: false};
MERGE (n:KG {id: 'inputs:mario/DSW/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SW1:!1,!2")'], name: 'Lives', defaultValue: 0, location: 'SW1:!1,!2', settings: ['0=3', '1=4', '2=5', '3=6']};
MERGE (n:KG {id: 'inputs:mario/DSW/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION("SW1:!3,!4")'], name: 'Coinage', defaultValue: 0, location: 'SW1:!3,!4', settings: ['4=2C 1C', '0=1C 1C', '8=1C 2C', '12=1C 3C']};
MERGE (n:KG {id: 'inputs:mario/DSW/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, modifiers: ['PORT_DIPLOCATION("SW1:!5,!6")'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:!5,!6', settings: ['0=20k only', '16=30k only', '32=40k only', '48=None']};
MERGE (n:KG {id: 'inputs:mario/DSW/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("SW1:!7,!8")'], name: 'Difficulty', defaultValue: 0, location: 'SW1:!7,!8', settings: ['0=Easy', '128=Medium', '64=Hard', '192=Hardest']};
MERGE (n:KG {id: 'inputs:mario/MONITOR'}) SET n:Port SET n += {tag: 'MONITOR', modify: false};
MERGE (n:KG {id: 'inputs:mario/MONITOR/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(mario_state::adjust_palette), 0)'], name: 'Monitor', defaultValue: 0, settings: ['0=Nintendo', '1=Std 15.72Khz']};
...
MERGE (n:KG {id: 'device:mario_state.mario_base/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(mario_state::palette), 256)', ownerTag: 'palette', targetClass: 'mario_state', targetMethod: 'palette', entries: 256, sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 865};
MERGE (n:KG {id: 'handler:mario_state.palette'}) SET n:Handler SET n += {method: 'palette', ownerClass: 'mario_state', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 490, sourceColumn: 1, sourceEndLine: 493, sourceParameters: 'palette_device &palette', sourceBody: 'set_palette(0);'};
MERGE (n:KG {id: 'handler:mario_state.set_palette'}) SET n:Handler SET n += {method: 'set_palette', ownerClass: 'mario_state', sourceFile: 'src/mame/nintendo/mario.cpp', sourceLine: 476, sourceColumn: 1, sourceEndLine: 488, sourceParameters: 'int monitor', sourceBody: 'uint8_t const *const color_prom = memregion("proms")->base();
...
MATCH (a:KG {id: 'machine:mario_state.mario'}), (b:KG {id: 'machine:mario_state.mario_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:mario_state.mario_base/palette'}), (b:KG {id: 'device:mario_state.mario_base/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:mario_state.mario_base/palette/callback:palette_init'}), (b:KG {id: 'handler:mario_state.palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:mario_state.palette'}), (b:KG {id: 'handler:mario_state.set_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:mario_state.set_palette'}), (b:KG {id: 'handler:mario_state.palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
