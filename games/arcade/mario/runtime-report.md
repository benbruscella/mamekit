...
MAME source coverage: **119/152 nodes (78.3%)**

| Stage | Count | Meaning |
|---|---:|---|
| Executable | 9 | Hardware lowered from MAME source to executable IR |
| Generated | 32 | Wiring, handlers, schedules and composition emitted from source/KG |
...
- `palette.palette_init -> mario_state.palette` - src/mame/nintendo/mario.cpp:865
