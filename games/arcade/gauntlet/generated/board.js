...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            function method_video_int_ack_w(runtime, data) {
            ...
            function method_yscroll_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                const h_m_yscroll = members.m_yscroll ?? runtime.member("m_yscroll");
                let oldyscroll = ((runtime.dereference(h_m_yscroll)) & 0xffff);
                ...
                if (((Number(runtime.dereference(h_m_yscroll)) !== Number(oldyscroll)) ? 1 : 0)) {
                    ...
                    (__l["m_playfield_tilemap.set_scrolly"] ? __l["m_playfield_tilemap.set_scrolly"](0, ((runtime.dereference(h_m_yscroll)) >>> (7))) : (members.m_playfield_tilemap) != null ? ((runtime.dereference(members.m_playfield_tilemap)).set_scrolly?.(0, ((runtime.dereference(h_m_yscroll)) >>> (7))) ?? 0) : 0);
                    (__l["m_mob.set_yscroll"] ? __l["m_mob.set_yscroll"](((((runtime.dereference(h_m_yscroll)) >>> (7))) & (511))) : (members.m_mob) != null ? ((runtime.dereference(members.m_mob)).set_yscroll?.(((((runtime.dereference(h_m_yscroll)) >>> (7))) & (511))) ?? 0) : 0);
                }
            }
            function method_xscroll_w(runtime, offset, data, mem_mask) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                const h_m_xscroll = members.m_xscroll ?? runtime.member("m_xscroll");
                let oldxscroll = ((runtime.dereference(h_m_xscroll)) & 0xffff);
            ...
            function method_switch_6502_r(runtime) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let temp = ((48) | 0);
            ...
            function method_sound_irq_ack_r(runtime) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_sound_irq_ack_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                (__l["m_audiocpu.set_input_line"] ? __l["m_audiocpu.set_input_line"](0, 0) : (members.m_audiocpu) != null ? ((runtime.dereference(members.m_audiocpu)).set_input_line?.(0, 0) ?? 0) : 0);
            }
            function method_scanline_update(runtime, param) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                if (((param) & (32))) {
            ...
            function method_get_playfield_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let data = (((__l["m_playfield_tilemap.basemem_read"] ? __l["m_playfield_tilemap.basemem_read"](tile_index) : (members.m_playfield_tilemap) != null ? ((runtime.dereference(members.m_playfield_tilemap)).basemem_read?.(tile_index) ?? 0) : 0)) & 0xffff);
                let code = ((((runtime.add((((members.m_playfield_tile_bank ?? runtime.member("m_playfield_tile_bank"))) * (4096)), ((data) & (4095)))) ^ (2048))) | 0);
                let color = ((runtime.add(runtime.add(16, (((members.m_playfield_color_bank ?? runtime.member("m_playfield_color_bank"))) * (8))), ((((data) >>> (12))) & (7)))) | 0);
                (__l["tileinfo.set"] ? __l["tileinfo.set"](0, code, color, ((((data) >>> (15))) & (1))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, code, color, ((((data) >>> (15))) & (1))) ?? 0) : (__l["set"]?.(0, code, color, ((((data) >>> (15))) & (1))) ?? 0));
            }
            function method_get_alpha_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let data = (((__l["m_alpha_tilemap.basemem_read"] ? __l["m_alpha_tilemap.basemem_read"](tile_index) : (members.m_alpha_tilemap) != null ? ((runtime.dereference(members.m_alpha_tilemap)).basemem_read?.(tile_index) ?? 0) : 0)) & 0xffff);
                let code = ((((data) & (1023))) | 0);
                let color = ((((((((data) >>> (10))) & (15))) | (((((data) >>> (9))) & (32))))) | 0);
                let opaque = ((((data) & (32768))) | 0);
            ...
            function method_screen_update(runtime, screen, bitmap, cliprect) {
                ...
                let mobitmap = (__l["m_mob.bitmap"] ? __l["m_mob.bitmap"]() : (members.m_mob) != null ? (typeof (runtime.dereference(members.m_mob)).bitmap === 'function' ? (runtime.dereference(members.m_mob)).bitmap() : typeof (runtime.dereference(members.m_mob)).bitmap === 'number' || typeof (runtime.dereference(members.m_mob)).bitmap === 'boolean' ? (runtime.dereference(members.m_mob)).bitmap : runtime.container(members.m_mob, "bitmap")) : 0);
                (__l["m_mob.iterate_dirty_rects"] ? __l["m_mob.iterate_dirty_rects"](cliprect, ((rect) => {
                    for (let y = (((__l["rect.top"] ? __l["rect.top"]() : (rect) != null ? (typeof (runtime.dereference(rect)).top === 'function' ? (runtime.dereference(rect)).top() : typeof (runtime.dereference(rect)).top === 'number' || typeof (runtime.dereference(rect)).top === 'boolean' ? (runtime.dereference(rect)).top : runtime.container(rect, "top")) : (__l["top"]?.() ?? 0))) | 0); ((Number(y) <= Number((__l["rect.bottom"] ? __l["rect.bottom"]() : (rect) != null ? (typeof (runtime.dereference(rect)).bottom === 'function' ? (runtime.dereference(rect)).bottom() : typeof (runtime.dereference(rect)).bottom === 'number' || typeof (runtime.dereference(rect)).bottom === 'boolean' ? (runtime.dereference(rect)).bottom : runtime.container(rect, "bottom")) : (__l["bottom"]?.() ?? 0)))) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                        let mo = mobitmap["pix&"](y);
                        let pf = bitmap["pix&"](y);
                        for (let x = (((__l["rect.left"] ? __l["rect.left"]() : (rect) != null ? (typeof (runtime.dereference(rect)).left === 'function' ? (runtime.dereference(rect)).left() : typeof (runtime.dereference(rect)).left === 'number' || typeof (runtime.dereference(rect)).left === 'boolean' ? (runtime.dereference(rect)).left : runtime.container(rect, "left")) : (__l["left"]?.() ?? 0))) | 0); ((Number(x) <= Number((__l["rect.right"] ? __l["rect.right"]() : (rect) != null ? (typeof (runtime.dereference(rect)).right === 'function' ? (runtime.dereference(rect)).right() : typeof (runtime.dereference(rect)).right === 'number' || typeof (runtime.dereference(rect)).right === 'boolean' ? (runtime.dereference(rect)).right : runtime.container(rect, "right")) : (__l["right"]?.() ?? 0)))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                ...
                })) : (members.m_mob) != null ? ((runtime.dereference(members.m_mob)).iterate_dirty_rects?.(cliprect, ((rect) => {
                    for (let y = (((__l["rect.top"] ? __l["rect.top"]() : (rect) != null ? (typeof (runtime.dereference(rect)).top === 'function' ? (runtime.dereference(rect)).top() : typeof (runtime.dereference(rect)).top === 'number' || typeof (runtime.dereference(rect)).top === 'boolean' ? (runtime.dereference(rect)).top : runtime.container(rect, "top")) : (__l["top"]?.() ?? 0))) | 0); ((Number(y) <= Number((__l["rect.bottom"] ? __l["rect.bottom"]() : (rect) != null ? (typeof (runtime.dereference(rect)).bottom === 'function' ? (runtime.dereference(rect)).bottom() : typeof (runtime.dereference(rect)).bottom === 'number' || typeof (runtime.dereference(rect)).bottom === 'boolean' ? (runtime.dereference(rect)).bottom : runtime.container(rect, "bottom")) : (__l["bottom"]?.() ?? 0)))) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                        let mo = mobitmap["pix&"](y);
                        let pf = bitmap["pix&"](y);
                        for (let x = (((__l["rect.left"] ? __l["rect.left"]() : (rect) != null ? (typeof (runtime.dereference(rect)).left === 'function' ? (runtime.dereference(rect)).left() : typeof (runtime.dereference(rect)).left === 'number' || typeof (runtime.dereference(rect)).left === 'boolean' ? (runtime.dereference(rect)).left : runtime.container(rect, "left")) : (__l["left"]?.() ?? 0))) | 0); ((Number(x) <= Number((__l["rect.right"] ? __l["rect.right"]() : (rect) != null ? (typeof (runtime.dereference(rect)).right === 'function' ? (runtime.dereference(rect)).right() : typeof (runtime.dereference(rect)).right === 'number' || typeof (runtime.dereference(rect)).right === 'boolean' ? (runtime.dereference(rect)).right : runtime.container(rect, "right")) : (__l["right"]?.() ?? 0)))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
            ...
            function method_speech_squeak_w(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let data = ((((5) | (((state) ? (2) : (0))))) & 0xff);
            ...
            function method_compute_log(runtime, value) {
                const members = runtime.members;
                let log = ((0) | 0);
            ...
            function method_round_to_powerof2(runtime, value) {
                const members = runtime.members;
                let log = ((0) | 0);
                if (((Number(value) === Number(0)) ? 1 : 0)) {
                    return 1;
