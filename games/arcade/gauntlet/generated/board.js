    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_playfield_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let data = (((runtime.calls["m_playfield_tilemap.basemem_read"] ? runtime.calls["m_playfield_tilemap.basemem_read"](tile_index) : (members.m_playfield_tilemap) != null ? ((runtime.dereference(members.m_playfield_tilemap)).basemem_read?.(tile_index) ?? 0) : (runtime.calls["basemem_read"]?.(tile_index) ?? 0))) & 0xffff);
                let code = ((runtime.add((((members.m_playfield_tile_bank ?? runtime.member("m_playfield_tile_bank"))) * (4096)), ((data) & (4095)))) ^ (2048));
                let color = runtime.add(runtime.add(16, (((members.m_playfield_color_bank ?? runtime.member("m_playfield_color_bank"))) * (8))), ((((data) >>> (12))) & (7)));
