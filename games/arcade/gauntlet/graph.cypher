...
// generated 2026-09-24T02:27:27.130Z
...
MERGE (n:KG {id: 'device:gauntlet_state.base/maincpu'}) SET n:Device SET n += {type: 'M68010', tag: 'maincpu', clock: 7159090.5, config: ['M68010(config, m_maincpu, 14.318181_MHz_XTAL / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &gauntlet_state::main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 747, sourceColumn: 2, sourceEndLine: 747};
MERGE (n:KG {id: 'device:gauntlet_state.base/audiocpu'}) SET n:Device SET n += {type: 'M6502', tag: 'audiocpu', clock: 1789772.625, config: ['M6502(config, m_audiocpu, 14.318181_MHz_XTAL / 8)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &gauntlet_state::sound_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 750, sourceColumn: 2, sourceEndLine: 750};
...
MERGE (n:KG {id: 'device:gauntlet_state.base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, "palette", gfx_gauntlet)'], member: 'm_gfxdecode', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 767, sourceColumn: 2, sourceEndLine: 767, clockExpr: '"palette"'};
MERGE (n:KG {id: 'device:gauntlet_state.base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, "palette").set_format(palette_device::IRGB_4444, 1024)'], sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 769, sourceColumn: 2, sourceEndLine: 769, paletteEntries: 1024};
MERGE (n:KG {id: 'device:gauntlet_state.base/playfield'}) SET n:Device SET n += {type: 'TILEMAP', tag: 'playfield', clock: null, config: ['TILEMAP(config, m_playfield_tilemap, m_gfxdecode, 2, 8, 8, TILEMAP_SCAN_COLS, 64, 64).set_info_callback(FUNC(gauntlet_state::get_playfield_tile_info))'], member: 'm_playfield_tilemap', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 771, sourceColumn: 2, sourceEndLine: 771, clockExpr: 'm_gfxdecode'};
...
MERGE (n:KG {id: 'device:gauntlet_state.base/alpha'}) SET n:Device SET n += {type: 'TILEMAP', tag: 'alpha', clock: null, config: ['TILEMAP(config, m_alpha_tilemap, m_gfxdecode, 2, 8, 8, TILEMAP_SCAN_ROWS, 64, 31, 0).set_info_callback(FUNC(gauntlet_state::get_alpha_tile_info))'], member: 'm_alpha_tilemap', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 772, sourceColumn: 2, sourceEndLine: 772, clockExpr: 'm_gfxdecode'};
...
MERGE (n:KG {id: 'device:gauntlet_state.base/mob'}) SET n:Device SET n += {type: 'ATARI_MOTION_OBJECTS', tag: 'mob', clock: null, config: ['ATARI_MOTION_OBJECTS(config, m_mob, m_screen, gauntlet_state::s_mob_config)', 'm_mob->set_gfxdecode(m_gfxdecode)'], member: 'm_mob', cls: 'atari_motion_objects_device', clsHierarchy: ['atari_motion_objects_device', 'atari_motion_objects_config'], sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 774, sourceColumn: 2, sourceEndLine: 774, configCalls: ['set_gfxdecode("gfxdecode")'], clockExpr: 'm_screen', startHandler: 'atari_motion_objects_device.device_start', deviceTimers: ['m_force_update_timer=atari_motion_objects_device.force_update']};
MERGE (n:KG {id: 'device:gauntlet_state.base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_video_attributes(VIDEO_UPDATE_BEFORE_VBLANK)', 'm_screen->set_raw(14.318181_MHz_XTAL / 2, 456, 0, 336, 262, 0, 240)', 'm_screen->set_screen_update(FUNC(gauntlet_state::screen_update))', 'm_screen->set_palette("palette")', 'm_screen->screen_vblank().set_inputline(m_maincpu, M68K_IRQ_4, ASSERT_LINE)'], member: 'm_screen', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 777, sourceColumn: 2, sourceEndLine: 777, configCalls: ['set_raw(7159090.5,456,0,336,262,0,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [7159090.5, 456, 0, 336, 262, 0, 240], screenRawExpr: ['14.318181_MHz_XTAL / 2', '456', '0', '336', '262', '0', '240'], screenVideoAttributes: ['VIDEO_UPDATE_BEFORE_VBLANK']};
...
MERGE (n:KG {id: 'device:gauntlet_state.base/mainlatch'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'mainlatch', clock: null, config: ['GENERIC_LATCH_8(config, m_mainlatch)', 'm_mainlatch->data_pending_callback().set_inputline(m_maincpu, M68K_IRQ_6)'], member: 'm_mainlatch', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 793, sourceColumn: 2, sourceEndLine: 793};
...
MERGE (n:KG {id: 'device:gauntlet_state.base/ymsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'ymsnd', clock: 3579545.25, config: ['YM2151(config, m_ym2151, 14.318181_MHz_XTAL / 4)', 'm_ym2151->add_route(1, "speaker", 0.48, 0)', 'm_ym2151->add_route(0, "speaker", 0.48, 1)'], member: 'm_ym2151', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 796, sourceColumn: 2, sourceEndLine: 796, configCalls: ['add_route(1,"speaker",0.48,0)', 'add_route(0,"speaker",0.48,1)']};
...
MERGE (n:KG {id: 'device:gauntlet_state.gauntlet/slapstic'}) SET n:Device SET n += {type: 'SLAPSTIC', tag: 'slapstic', clock: 104, config: ['SLAPSTIC(config, m_slapstic, 104)', 'm_slapstic->set_range(m_maincpu, AS_PROGRAM, 0x38000, 0x3ffff, 0x280000)', 'm_slapstic->set_bank(m_slapstic_bank)'], member: 'm_slapstic', cls: 'atari_slapstic_device', clsHierarchy: ['atari_slapstic_device'], sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 821, sourceColumn: 2, sourceEndLine: 821, configCalls: ['set_range("maincpu",0,229376,262143,2621440)', 'set_bank("slapstic_bank")']};
...
MATCH (a:KG {id: 'handler:gauntlet_state.video_start'}), (b:KG {id: 'handler:atari_motion_objects_device.code_lookup'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:gauntlet_state.base/mob'}), (b:KG {id: 'handler:atari_motion_objects_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
