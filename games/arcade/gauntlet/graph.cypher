...
// generated 2026-09-17T07:11:53.170Z
...
MERGE (n:KG {id: 'device:gauntlet_state.base/ymsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'ymsnd', clock: 3579545.25, config: ['YM2151(config, m_ym2151, 14.318181_MHz_XTAL / 4)', 'm_ym2151->add_route(1, "speaker", 0.48, 0)', 'm_ym2151->add_route(0, "speaker", 0.48, 1)'], member: 'm_ym2151', sourceFile: 'src/mame/atari/gauntlet.cpp', sourceLine: 796, sourceColumn: 2, sourceEndLine: 796};
