...
// generated 2026-09-24T02:30:37.779Z
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/maincpu'}) SET n:Device SET n += {type: 'M68000', tag: 'maincpu', clock: 8000000, config: ['M68000(config, m_maincpu, 24_MHz_XTAL / 3)', 'm_maincpu->set_addrmap(AS_PROGRAM, &tmnt_state::tmnt_main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 929, sourceColumn: 2, sourceEndLine: 929};
MERGE (n:KG {id: 'device:tmnt_state.tmnt/audiocpu'}) SET n:Device SET n += {type: 'Z80', tag: 'audiocpu', clock: 3579545, config: ['Z80(config, m_audiocpu, 3.579545_MHz_XTAL)', 'm_audiocpu->set_addrmap(AS_PROGRAM, &tmnt_state::tmnt_audio_map)'], member: 'm_audiocpu', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 932, sourceColumn: 2, sourceEndLine: 932};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_format(palette_device::xBGR_555, 1024)', 'm_palette->set_membits(8)', 'm_palette->enable_shadows()', 'm_palette->enable_highlights()'], member: 'm_palette', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 946, sourceColumn: 2, sourceEndLine: 946, configCalls: ['set_membits(8)', 'enable_shadows()', 'enable_highlights()'], paletteEntries: 1024};
MERGE (n:KG {id: 'device:tmnt_state.tmnt/k052109'}) SET n:Device SET n += {type: 'K052109', tag: 'k052109', clock: 24000000, config: ['K052109(config, m_k052109, 24_MHz_XTAL)', 'm_k052109->set_palette(m_palette)', 'm_k052109->set_screen("screen")', 'm_k052109->set_tile_callback(FUNC(tmnt_state::tmnt_tile_callback))'], member: 'm_k052109', cls: 'k052109_device', clsHierarchy: ['k052109_device'], configCalls: ['set_palette("palette")', 'set_screen("screen")'], startHandler: 'k052109_device.device_start', deviceTimers: ['m_firq_scanline=k052109_device.firq_scanline', 'm_nmi_scanline=k052109_device.nmi_scanline']};
MERGE (n:KG {id: 'device:tmnt_state.tmnt/k052109/callback:k052109:0'}) SET n:Callback SET n += {signal: 'set_tile_callback', member: 'm_k052109_cb', delegate: 1, operation: 'set_tile_callback', raw: 'm_k052109->set_tile_callback(FUNC(tmnt_state::tmnt_tile_callback))', ownerTag: 'k052109', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 956, sourceColumn: 2, sourceEndLine: 956, targetClass: 'tmnt_state', targetMethod: 'tmnt_tile_callback'};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/k051960'}) SET n:Device SET n += {type: 'K051960', tag: 'k051960', clock: 24000000, config: ['K051960(config, m_k051960, 24_MHz_XTAL)', 'm_k051960->set_palette(m_palette)', 'm_k051960->set_screen("screen")', 'm_k051960->set_sprite_callback(FUNC(tmnt_state::tmnt_sprite_callback))', 'm_k051960->set_plane_order(K051960_PLANEORDER_MIA)'], member: 'm_k051960', cls: 'k051960_device', clsHierarchy: ['k051960_device'], sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 958, sourceColumn: 2, sourceEndLine: 958, configCalls: ['set_palette("palette")', 'set_screen("screen")', 'set_plane_order(1)'], startHandler: 'k051960_device.device_start', deviceTimers: ['m_firq_scanline=k051960_device.firq_scanline', 'm_nmi_scanline=k051960_device.nmi_scanline']};
MERGE (n:KG {id: 'device:tmnt_state.tmnt/k051960/callback:k051960:0'}) SET n:Callback SET n += {signal: 'set_sprite_callback', member: 'm_k051960_cb', delegate: 1, operation: 'set_sprite_callback', raw: 'm_k051960->set_sprite_callback(FUNC(tmnt_state::tmnt_sprite_callback))', ownerTag: 'k051960', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 961, sourceColumn: 2, sourceEndLine: 961, targetClass: 'tmnt_state', targetMethod: 'tmnt_sprite_callback'};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/ymsnd'}) SET n:Device SET n += {type: 'YM2151', tag: 'ymsnd', clock: 3579545, config: ['ym2151_device &ymsnd(YM2151(config, "ymsnd", 3.579545_MHz_XTAL))', 'ymsnd.add_route(0, "mono", 0.40)', 'ymsnd.add_route(1, "mono", 0.40)'], sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 969, sourceColumn: 2, sourceEndLine: 969, configCalls: ['add_route(0,"mono",0.4)', 'add_route(1,"mono",0.4)']};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/k007232'}) SET n:Device SET n += {type: 'K007232', tag: 'k007232', clock: 3579545, config: ['K007232(config, m_k007232, 3.579545_MHz_XTAL)', 'm_k007232->port_write().set(FUNC(tmnt_state::volume_callback))', 'm_k007232->add_route(0, "mono", 0.15)', 'm_k007232->add_route(1, "mono", 0.15)'], member: 'm_k007232', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 973, sourceColumn: 2, sourceEndLine: 973, configCalls: ['add_route(0,"mono",0.15)', 'add_route(1,"mono",0.15)']};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/upd'}) SET n:Device SET n += {type: 'UPD7759', tag: 'upd', clock: 640000, config: ['UPD7759(config, "upd", 640_kHz_XTAL).add_route(ALL_OUTPUTS, "mono", 0.30)'], member: 'm_upd7759', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 978, sourceColumn: 2, sourceEndLine: 978};
...
MERGE (n:KG {id: 'device:tmnt_state.tmnt/samples'}) SET n:Device SET n += {type: 'SAMPLES', tag: 'samples', clock: null, config: ['SAMPLES(config, m_samples)', 'm_samples->set_channels(1)', 'm_samples->add_route(ALL_OUTPUTS, "mono", 0.25)'], member: 'm_samples', sourceFile: 'src/mame/konami/tmnt.cpp', sourceLine: 980, sourceColumn: 2, sourceEndLine: 980, configCalls: ['set_channels(1)']};
...
MERGE (n:KG {id: 'handler:k052109_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 217, sourceColumn: 1, sourceEndLine: 289, sourceParameters: '', sourceBody: '// assumes it can make an address mask with m_char_rom.length() - 1
...
MERGE (n:KG {id: 'handler:k052109_device.firq_scanline'}) SET n:Handler SET n += {method: 'firq_scanline', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 323, sourceColumn: 1, sourceEndLine: 330, sourceParameters: 'int param', sourceBody: '// FIRQ every other scanline
	if (BIT(m_irq_control, 1))
		m_firq_handler(ASSERT_LINE);

	m_firq_scanline->adjust(screen().time_until_pos(screen().vpos() + 2));'};
MERGE (n:KG {id: 'handler:k052109_device.nmi_scanline'}) SET n:Handler SET n += {method: 'nmi_scanline', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 332, sourceColumn: 1, sourceEndLine: 339, sourceParameters: 'int param', sourceBody: '// NMI every 32 scanlines (not on 16V)
	if (BIT(m_irq_control, 0))
		m_nmi_handler(ASSERT_LINE);

	m_nmi_scanline->adjust(screen().time_until_pos(screen().vpos() + 32));'};
MERGE (n:KG {id: 'handler:k052109_device.get_tile_info0'}) SET n:Handler SET n += {method: 'get_tile_info0', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 715, sourceColumn: 1, sourceEndLine: 718, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'get_tile_info(tileinfo, tile_index, 0, m_colorram_F, m_videoram_F, m_videoram2_F);'};
MERGE (n:KG {id: 'handler:k052109_device.get_tile_info'}) SET n:Handler SET n += {method: 'get_tile_info', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 684, sourceColumn: 1, sourceEndLine: 713, sourceParameters: 'tile_data &tileinfo, int tile_index, int layer, u8 *cram, u8 *vram1, u8 *vram2', sourceBody: 'int flipy = 0;
...
MERGE (n:KG {id: 'handler:k052109_device.get_tile_info1'}) SET n:Handler SET n += {method: 'get_tile_info1', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 720, sourceColumn: 1, sourceEndLine: 723, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'get_tile_info(tileinfo, tile_index, 1, m_colorram_A, m_videoram_A, m_videoram2_A);'};
MERGE (n:KG {id: 'handler:k052109_device.get_tile_info2'}) SET n:Handler SET n += {method: 'get_tile_info2', ownerClass: 'k052109_device', sourceFile: 'src/mame/konami/k052109.cpp', sourceLine: 725, sourceColumn: 1, sourceEndLine: 728, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'get_tile_info(tileinfo, tile_index, 2, m_colorram_B, m_videoram_B, m_videoram2_B);'};
MERGE (n:KG {id: 'handler:k051960_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'k051960_device', sourceFile: 'src/mame/konami/k051960.cpp', sourceLine: 183, sourceColumn: 1, sourceEndLine: 231, sourceConstants: ['VERBOSE=0'], sourceParameters: '', sourceBody: '// assumes it can make an address mask with m_sprite_rom.length() - 1
...
MERGE (n:KG {id: 'handler:k051960_device.firq_scanline'}) SET n:Handler SET n += {method: 'firq_scanline', ownerClass: 'k051960_device', sourceFile: 'src/mame/konami/k051960.cpp', sourceLine: 275, sourceColumn: 1, sourceEndLine: 282, sourceParameters: 'int param', sourceBody: '// FIRQ every other scanline
	if (BIT(m_control, 1))
		m_firq_handler(ASSERT_LINE);

	m_firq_scanline->adjust(screen().time_until_pos(screen().vpos() + 2));'};
MERGE (n:KG {id: 'handler:k051960_device.nmi_scanline'}) SET n:Handler SET n += {method: 'nmi_scanline', ownerClass: 'k051960_device', sourceFile: 'src/mame/konami/k051960.cpp', sourceLine: 284, sourceColumn: 1, sourceEndLine: 291, sourceParameters: 'int param', sourceBody: '// NMI every 32 scanlines (not on 16V)
	if (BIT(m_control, 2))
		m_nmi_handler(ASSERT_LINE);
...
MATCH (a:KG {id: 'device:tmnt_state.tmnt/k052109'}), (b:KG {id: 'handler:k052109_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:tmnt_state.tmnt/k051960'}), (b:KG {id: 'handler:k051960_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:k052109_device.device_start'}), (b:KG {id: 'handler:k052109_device.firq_scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.device_start'}), (b:KG {id: 'handler:k052109_device.nmi_scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.device_start'}), (b:KG {id: 'handler:k052109_device.get_tile_info0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.device_start'}), (b:KG {id: 'handler:k052109_device.get_tile_info1'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.device_start'}), (b:KG {id: 'handler:k052109_device.get_tile_info2'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:k051960_device.device_start'}), (b:KG {id: 'handler:k051960_device.firq_scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k051960_device.device_start'}), (b:KG {id: 'handler:k051960_device.nmi_scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:k052109_device.get_tile_info0'}), (b:KG {id: 'handler:k052109_device.get_tile_info'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.get_tile_info1'}), (b:KG {id: 'handler:k052109_device.get_tile_info'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:k052109_device.get_tile_info2'}), (b:KG {id: 'handler:k052109_device.get_tile_info'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
