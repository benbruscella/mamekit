...
MAME source coverage: **145/191 nodes (75.9%)**

| Stage | Count | Meaning |
|---|---:|---|
| Executable | 9 | Hardware lowered from MAME source to executable IR |
| Generated | 25 | Wiring, handlers, schedules and composition emitted from source/KG |
| Declarative host | 21 | Hardware-neutral browser service configured by generated data |
...
- `chr_palette.palette_init -> m62_state.m62_chr` - src/mame/irem/m62.cpp:947
- `spr_palette.palette_init -> m62_state.m62_spr` - src/mame/irem/m62.cpp:948
