...
// generated 2026-09-24T02:28:15.228Z
...
MERGE (n:KG {id: 'machine:m62_state.ldrun'}) SET n:MachineConfig SET n += {cls: 'm62_state', name: 'ldrun', calls: [], stateMembers: ['{"name":"m_kidniki_background_bank","bits":8}', '{"name":"m_flipscreen","bits":32,"signed":true}', '{"name":"m_m62_background_hscroll","bits":32,"signed":true}', '{"name":"m_m62_background_vscroll","bits":32,"signed":true}', '{"name":"m_kidniki_text_vscroll","bits":32,"signed":true}', '{"name":"m_ldrun3_topbottom_mask","bits":32,"signed":true}', '{"name":"m_spelunkr_palbank","bits":32,"signed":true}', '{"name":"m_ldrun2_bankswap","bits":32,"signed":true}', '{"name":"m_bankcontrol","bits":32,"signed":true,"arrayLength":2}'], resetHandlers: ['m62_state.machine_reset'], startHandlers: ['m62_state.video_start'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 931, sourceColumn: 1, sourceEndLine: 952};
...
MERGE (n:KG {id: 'handler:m62_state.get_ldrun_bg_tile_info'}) SET n:Handler SET n += {method: 'get_ldrun_bg_tile_info', ownerClass: 'm62_state', sourceFile: 'src/mame/irem/m62_v.cpp', sourceLine: 411, sourceColumn: 1, sourceEndLine: 428, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'int code;
	...
	if (((color & 0x1f) >> 1) >= 0x0c)
		...
		tileinfo.group = 0;'};
MERGE (n:KG {id: 'device:m62_state.ldrun/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, 24_MHz_XTAL / 6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &m62_state::ldrun_map)', 'm_maincpu->set_addrmap(AS_IO, &m62_state::kungfum_io_map)', 'm_maincpu->set_vblank_int("screen", FUNC(m62_state::irq0_line_hold))', 'm_maincpu->set_clock(18.432_MHz_XTAL / 6)'], member: 'm_maincpu', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 934, sourceColumn: 2, sourceEndLine: 934};
...
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_decode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'spr_decode', clock: null, config: ['GFXDECODE(config, m_spr_decode, m_spr_palette, gfx_m62_sprites)'], member: 'm_spr_decode', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 944, sourceColumn: 2, sourceEndLine: 944, clockExpr: 'm_spr_palette'};
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_decode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'chr_decode', clock: null, config: ['GFXDECODE(config, m_chr_decode, m_chr_palette, gfx_m62_tiles)'], member: 'm_chr_decode', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 945, sourceColumn: 2, sourceEndLine: 945, clockExpr: 'm_chr_palette'};
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'chr_palette', clock: null, config: ['PALETTE(config, m_chr_palette, FUNC(m62_state::m62_chr), 256)'], member: 'm_chr_palette', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 947, sourceColumn: 2, sourceEndLine: 947, clockExpr: 'FUNC(m62_state::m62_chr)', paletteEntries: 256};
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'spr_palette', clock: null, config: ['PALETTE(config, m_spr_palette, FUNC(m62_state::m62_spr), 256)'], member: 'm_spr_palette', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 948, sourceColumn: 2, sourceEndLine: 948, clockExpr: 'FUNC(m62_state::m62_spr)', paletteEntries: 256};
MERGE (n:KG {id: 'device:m62_state.ldrun/irem_audio'}) SET n:Device SET n += {type: 'IREM_M62_AUDIO', tag: 'irem_audio', clock: 0, config: ['IREM_M62_AUDIO(config, m_audio)'], member: 'm_audio', cls: 'm62_audio_device', clsHierarchy: ['m62_audio_device', 'irem_audio_device'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 951, sourceColumn: 2, sourceEndLine: 951, startHandler: 'irem_audio_device.device_start'};
MERGE (n:KG {id: 'machine:m62_state.kungfum'}) SET n:MachineConfig SET n += {cls: 'm62_state', name: 'kungfum', calls: ['ldrun'], stateMembers: ['{"name":"m_kidniki_background_bank","bits":8}', '{"name":"m_flipscreen","bits":32,"signed":true}', '{"name":"m_m62_background_hscroll","bits":32,"signed":true}', '{"name":"m_m62_background_vscroll","bits":32,"signed":true}', '{"name":"m_kidniki_text_vscroll","bits":32,"signed":true}', '{"name":"m_ldrun3_topbottom_mask","bits":32,"signed":true}', '{"name":"m_spelunkr_palbank","bits":32,"signed":true}', '{"name":"m_ldrun2_bankswap","bits":32,"signed":true}', '{"name":"m_bankcontrol","bits":32,"signed":true,"arrayLength":2}'], resetHandlers: ['m62_state.machine_reset'], startHandlers: ['m62_state.video_start_kungfum'], devicePatches: ['{"tag":"maincpu","config":["m_maincpu->set_clock(18.432_MHz_XTAL / 6)"],"clock":3072000}', '{"tag":"screen","config":["subdevice<screen_device>(\\"screen\\")->set_raw(18.432_MHz_XTAL / 3, 384, 128, 384, 284, 0, 256)","subdevice<screen_device>(\\"screen\\")->set_screen_update(FUNC(m62_state::screen_update_kungfum))"],"screenRaw":{"pixclock":6144000,"htotal":384,"hbend":128,"hbstart":384,"vtotal":284,"vbend":0,"vbstart":256}}'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 955, sourceColumn: 1, sourceEndLine: 969};
...
MERGE (n:KG {id: 'handler:m62_state.screen_update_kungfum'}) SET n:Handler SET n += {method: 'screen_update_kungfum', ownerClass: 'm62_state', sourceFile: 'src/mame/irem/m62_v.cpp', sourceLine: 393, sourceColumn: 1, sourceEndLine: 408, sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: 'int i;
	...
	return 0;'};
MERGE (n:KG {id: 'machine:m62_audio_device.device_add_mconfig'}) SET n:MachineConfig SET n += {cls: 'm62_audio_device', name: 'device_add_mconfig', calls: [], stateMembers: ['{"name":"m_port1","bits":8}', '{"name":"m_port2","bits":8}', '{"name":"m_soundlatch","bits":8}'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 400, sourceColumn: 1, sourceEndLine: 464};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}) SET n:Device SET n += {type: 'M6803', tag: 'iremsound', clock: 3579545, config: ['m6803_cpu_device &cpu(M6803(config, m_cpu, XTAL(3\'579\'545)))', 'cpu.set_addrmap(AS_PROGRAM, &m62_audio_device::m62_sound_map)', 'cpu.in_p1_cb().set(FUNC(m62_audio_device::m6803_port1_r))', 'cpu.out_p1_cb().set(FUNC(m62_audio_device::m6803_port1_w))', 'cpu.in_p2_cb().set(FUNC(m62_audio_device::m6803_port2_r))', 'cpu.out_p2_cb().set(FUNC(m62_audio_device::m6803_port2_w))'], member: 'm_cpu', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 403, sourceColumn: 2, sourceEndLine: 403};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45l', clock: 894886.25, config: ['AY8910(config, m_ay_45L, XTAL(3\'579\'545)/4)', 'm_ay_45L->set_flags(AY8910_RESISTOR_OUTPUT)', 'm_ay_45L->set_resistors_load(2000.0, 2000.0, 2000.0)', 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', 'm_ay_45L->add_route(0, "snd_nl", 1.0, 3)', 'm_ay_45L->add_route(1, "snd_nl", 1.0, 4)', 'm_ay_45L->add_route(2, "snd_nl", 1.0, 5)'], member: 'm_ay_45L', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 422, sourceColumn: 2, sourceEndLine: 422, configCalls: ['set_flags(8)', 'set_resistors_load(2000,2000,2000)', 'add_route(0,"snd_nl",1,3)', 'add_route(1,"snd_nl",1,4)', 'add_route(2,"snd_nl",1,5)']};
...
MERGE (n:KG {id: 'handler:msm5205_device.vclk_w'}) SET n:Handler SET n += {method: 'vclk_w', ownerClass: 'msm5205_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 528, sourceColumn: 2, sourceEndLine: 528};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/msm2'}) SET n:Device SET n += {type: 'MSM5205', tag: 'msm2', clock: 384000, config: ['MSM5205(config, m_adpcm2, 384_kHz_XTAL)', 'm_adpcm2->set_prescaler_selector(msm5205_device::SEX_4B)', 'm_adpcm2->add_route(0, "snd_nl", 1.0, 7)'], member: 'm_adpcm2', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 436, sourceColumn: 2, sourceEndLine: 436, configCalls: ['add_route(0,"snd_nl",1,7)']};
...
MERGE (n:KG {id: 'audioroute:device:m62_audio_device.device_add_mconfig/snd_nl/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: 'mono', gain: 1, raw: 'NETLIST_SOUND(config, "snd_nl", 48000)
		.set_source(netlist_kidniki)
		.add_route(ALL_OUTPUTS, "mono", 1.0)', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 442, sourceColumn: 2, sourceEndLine: 444};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ibd'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ibd', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ibd", "I_BD0.IN", 0)'], member: 'm_audio_BD', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 446, sourceColumn: 2, sourceEndLine: 446, clockExpr: '"I_BD0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:isd'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:isd', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:isd", "I_SD0.IN", 0)'], member: 'm_audio_SD', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 447, sourceColumn: 2, sourceEndLine: 447, clockExpr: '"I_SD0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ich'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ich', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ich", "I_CH0.IN", 0)'], member: 'm_audio_CH', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 448, sourceColumn: 2, sourceEndLine: 448, clockExpr: '"I_CH0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ioh'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ioh', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ioh", "I_OH0.IN", 0)'], member: 'm_audio_OH', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 449, sourceColumn: 2, sourceEndLine: 449, clockExpr: '"I_OH0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:sinh'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:sinh', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:sinh", "SINH.IN", 0)'], member: 'm_audio_SINH', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 450, sourceColumn: 2, sourceEndLine: 450, clockExpr: '"SINH.IN"'};
...
MERGE (n:KG {id: 'handler:irem_audio_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'irem_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 58, sourceColumn: 1, sourceEndLine: 63, sourceParameters: '', sourceBody: 'save_item(NAME(m_port1));
...
MERGE (n:KG {id: 'inputs:m62_common/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_START1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:m62_common/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_START2', defaultValue: 2};
MERGE (n:KG {id: 'inputs:m62_common/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_SERVICE1', modifiers: ['PORT_IMPULSE(19)'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:m62_common/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_COIN1', defaultValue: 8};
MERGE (n:KG {id: 'inputs:m62_common/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: true, type: 'IPT_UNUSED', defaultValue: 240};
MERGE (n:KG {id: 'inputs:m62_common/P1'}) SET n:Port SET n += {tag: 'P1', modify: false};
MERGE (n:KG {id: 'inputs:m62_common/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:m62_common/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:m62_common/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:m62_common/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:m62_common/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 16};
MERGE (n:KG {id: 'inputs:m62_common/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', defaultValue: 32};
MERGE (n:KG {id: 'inputs:m62_common/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 64};
MERGE (n:KG {id: 'inputs:m62_common/P1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 128};
MERGE (n:KG {id: 'inputs:m62_common/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:m62_common/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:m62_common/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:m62_common/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:m62_common/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:m62_common/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_COIN2', defaultValue: 16};
MERGE (n:KG {id: 'inputs:m62_common/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:m62_common/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN', defaultValue: 64};
MERGE (n:KG {id: 'inputs:m62_common/P2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 128};
MERGE (n:KG {id: 'inputs:m62_common/DSW2'}) SET n:Port SET n += {tag: 'DSW2', modify: false};
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW2:1")'], name: 'Flip Screen', defaultValue: 1, location: 'SW2:1', settings: ['1=Off', '0=On']};
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, modifiers: ['PORT_DIPLOCATION("SW2:2")'], name: 'Cabinet', defaultValue: 0, location: 'SW2:2', settings: ['0=Upright', '2=Cocktail']};
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 4, modifiers: ['PORT_DIPLOCATION("SW2:3")'], name: 'Coin Mode', defaultValue: 4, location: 'SW2:3', settings: ['4=Mode 1', '0=Mode 2']};
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 56, name: 'Unused', defaultValue: 56};
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 64, modifiers: ['PORT_DIPLOCATION("SW2:7")'], name: 'Invulnerability (Cheat)', defaultValue: 64, location: 'SW2:7', settings: ['64=Off', '0=On']};
...
MERGE (n:KG {id: 'inputs:kungfum/DSW2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 8, modifiers: ['PORT_DIPLOCATION("SW2:4")'], name: 'Slow Motion Mode (Cheat)', defaultValue: 8, location: 'SW2:4', settings: ['8=Off', '0=On']};
MERGE (n:KG {id: 'inputs:kungfum/DSW2/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 16, modifiers: ['PORT_DIPLOCATION("SW2:5")'], name: 'Freeze (Cheat)', defaultValue: 16, location: 'SW2:5', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:kungfum/DSW2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 32, modifiers: ['PORT_DIPLOCATION("SW2:6")'], name: 'Level Selection Mode (Cheat)', defaultValue: 32, location: 'SW2:6', settings: ['32=Off', '0=On']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW1:1")'], name: 'Difficulty', defaultValue: 1, location: 'SW1:1', settings: ['1=Easy', '0=Hard']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, modifiers: ['PORT_DIPLOCATION("SW1:2")'], name: 'Energy Loss', defaultValue: 2, location: 'SW1:2', settings: ['2=Slow', '0=Fast']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION("SW1:3,4")'], name: 'Lives', defaultValue: 12, location: 'SW1:3,4', settings: ['8=2', '12=3', '4=4', '0=5']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 240, modifiers: ['PORT_CONDITION("DSW2", 0x04, NOTEQUALS, 0x00)', 'PORT_DIPLOCATION(#SW1":5,6,7,8")'], name: 'Coinage', defaultValue: 240, location: '#SW1":5,6,7,8"', settings: ['144=7C 1C', '160=6C 1C', '176=5C 1C', '192=4C 1C', '208=3C 1C', '224=2C 1C', '240=1C 1C', '112=1C 2C', '96=1C 3C', '80=1C 4C', '64=1C 5C', '48=1C 6C', '32=1C 7C', '16=1C 8C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 48, modifiers: ['PORT_CONDITION("DSW2", 0x04, EQUALS, 0x00)', 'PORT_DIPLOCATION(#SW1":5,6")'], name: 'Coin A', defaultValue: 48, location: '#SW1":5,6"', settings: ['16=3C 1C', '32=2C 1C', '48=1C 1C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:kungfum/DSW1/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_CONDITION("DSW2", 0x04, EQUALS, 0x00)', 'PORT_DIPLOCATION(#SW1":7,8")'], name: 'Coin B', defaultValue: 192, location: '#SW1":7,8"', settings: ['192=1C 2C', '128=1C 3C', '64=1C 5C', '0=1C 6C']};
...
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_chr_palette, FUNC(m62_state::m62_chr), 256)', ownerTag: 'chr_palette', targetClass: 'm62_state', targetMethod: 'm62_chr', entries: 256, sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 947};
MERGE (n:KG {id: 'handler:m62_state.m62_chr'}) SET n:Handler SET n += {method: 'm62_chr', ownerClass: 'm62_state', sourceFile: 'src/mame/irem/m62_v.cpp', sourceLine: 182, sourceColumn: 1, sourceEndLine: 187, sourceParameters: 'palette_device &palette', sourceBody: 'std::vector<rgb_t> rgb;
	compute_res_net_all(rgb, m_chr_color_proms, m62_decode_info, m62_tile_net_info);
	palette.set_pen_colors(0x000, rgb);'};
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_spr_palette, FUNC(m62_state::m62_spr), 256)', ownerTag: 'spr_palette', targetClass: 'm62_state', targetMethod: 'm62_spr', entries: 256, sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 948};
MERGE (n:KG {id: 'handler:m62_state.m62_spr'}) SET n:Handler SET n += {method: 'm62_spr', ownerClass: 'm62_state', sourceFile: 'src/mame/irem/m62_v.cpp', sourceLine: 175, sourceColumn: 1, sourceEndLine: 180, sourceParameters: 'palette_device &palette', sourceBody: 'std::vector<rgb_t> rgb;
...
MATCH (a:KG {id: 'machine:m62_state.kungfum'}), (b:KG {id: 'machine:m62_state.ldrun'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:m62_state.ldrun/chr_palette'}), (b:KG {id: 'device:m62_state.ldrun/chr_palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_state.ldrun/spr_palette'}), (b:KG {id: 'device:m62_state.ldrun/spr_palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_state.ldrun/irem_audio'}), (b:KG {id: 'machine:m62_audio_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:m62_state.ldrun/irem_audio'}), (b:KG {id: 'handler:irem_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m62_state.ldrun/chr_palette/callback:palette_init'}), (b:KG {id: 'handler:m62_state.m62_chr'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_state.ldrun/spr_palette/callback:palette_init'}), (b:KG {id: 'handler:m62_state.m62_spr'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
