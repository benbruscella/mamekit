...
// generated 2026-07-30T09:34:07.464Z
...
MERGE (n:KG {id: 'machine:m62_state.ldrun'}) SET n:MachineConfig SET n += {cls: 'm62_state', name: 'ldrun', calls: [], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 931, sourceColumn: 1, sourceEndLine: 952};
...
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_decode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'spr_decode', clock: null, config: ['GFXDECODE(config, m_spr_decode, m_spr_palette, gfx_m62_sprites)'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 944, sourceColumn: 2, sourceEndLine: 944, clockExpr: 'm_spr_palette, gfx_m62_sprites'};
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_decode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'chr_decode', clock: null, config: ['GFXDECODE(config, m_chr_decode, m_chr_palette, gfx_m62_tiles)'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 945, sourceColumn: 2, sourceEndLine: 945, clockExpr: 'm_chr_palette, gfx_m62_tiles'};
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'chr_palette', clock: null, config: ['PALETTE(config, m_chr_palette, FUNC(m62_state::m62_chr), 256)'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 947, sourceColumn: 2, sourceEndLine: 947, clockExpr: 'FUNC(m62_state::m62_chr), 256'};
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'spr_palette', clock: null, config: ['PALETTE(config, m_spr_palette, FUNC(m62_state::m62_spr), 256)'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 948, sourceColumn: 2, sourceEndLine: 948, clockExpr: 'FUNC(m62_state::m62_spr), 256'};
...
MERGE (n:KG {id: 'machine:m62_state.kungfum'}) SET n:MachineConfig SET n += {cls: 'm62_state', name: 'kungfum', calls: ['ldrun'], devicePatches: ['{"tag":"maincpu","config":["m_maincpu->set_clock(18.432_MHz_XTAL / 6)"],"clock":3072000}', '{"tag":"screen","config":["subdevice<screen_device>(\\"screen\\")->set_raw(18.432_MHz_XTAL / 3, 384, 128, 384, 284, 0, 256)","subdevice<screen_device>(\\"screen\\")->set_screen_update(FUNC(m62_state::screen_update_kungfum))"],"screenRaw":{"pixclock":6144000,"htotal":384,"hbend":128,"hbstart":384,"vtotal":284,"vbend":0,"vbstart":256}}'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 955, sourceColumn: 1, sourceEndLine: 969};
MERGE (n:KG {id: 'machine:m62_state.kungfum/callback0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'subdevice<screen_device>("screen")->set_screen_update(FUNC(m62_state::screen_update_kungfum))', ownerTag: 'screen', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 966, sourceColumn: 2, sourceEndLine: 966, targetClass: 'm62_state', targetMethod: 'screen_update_kungfum'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback0'}) SET n:Callback SET n += {signal: 'in_p1_cb', operation: 'set', raw: 'cpu.in_p1_cb().set(FUNC(m62_audio_device::m6803_port1_r))', ownerTag: 'iremsound', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 405, sourceColumn: 2, sourceEndLine: 405, targetClass: 'm62_audio_device', targetMethod: 'm6803_port1_r'};
MERGE (n:KG {id: 'handler:m62_audio_device.m6803_port1_r'}) SET n:Handler SET n += {method: 'm6803_port1_r', ownerClass: 'm62_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 149, sourceColumn: 1, sourceEndLine: 157, sourceParameters: '', sourceBody: '/* PSG 0 or 1? */
	...
	return 0xff;'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback1'}) SET n:Callback SET n += {signal: 'out_p1_cb', operation: 'set', raw: 'cpu.out_p1_cb().set(FUNC(m62_audio_device::m6803_port1_w))', ownerTag: 'iremsound', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 406, sourceColumn: 2, sourceEndLine: 406, targetClass: 'm62_audio_device', targetMethod: 'm6803_port1_w'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback2'}) SET n:Callback SET n += {signal: 'in_p2_cb', operation: 'set', raw: 'cpu.in_p2_cb().set(FUNC(m62_audio_device::m6803_port2_r))', ownerTag: 'iremsound', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 407, sourceColumn: 2, sourceEndLine: 407, targetClass: 'm62_audio_device', targetMethod: 'm6803_port2_r'};
MERGE (n:KG {id: 'handler:m62_audio_device.m6803_port2_r'}) SET n:Handler SET n += {method: 'm6803_port2_r', ownerClass: 'm62_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 160, sourceColumn: 1, sourceEndLine: 168, sourceParameters: '', sourceBody: '/*
	...
	//printf("port2 read\\n"); // used by 10yard
	return 0x0;'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback3'}) SET n:Callback SET n += {signal: 'out_p2_cb', operation: 'set', raw: 'cpu.out_p2_cb().set(FUNC(m62_audio_device::m6803_port2_w))', ownerTag: 'iremsound', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 408, sourceColumn: 2, sourceEndLine: 408, targetClass: 'm62_audio_device', targetMethod: 'm6803_port2_w'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback0'}) SET n:Callback SET n += {signal: 'port_a_read_callback', operation: 'set', raw: 'm_ay_45M->port_a_read_callback().set(FUNC(irem_audio_device::soundlatch_r))', ownerTag: 'ay_45m', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 416, sourceColumn: 2, sourceEndLine: 416, targetClass: 'irem_audio_device', targetMethod: 'soundlatch_r'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback1'}) SET n:Callback SET n += {signal: 'port_b_write_callback', operation: 'set', raw: 'm_ay_45M->port_b_write_callback().set(FUNC(irem_audio_device::ay8910_45M_portb_w))', ownerTag: 'ay_45m', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 417, sourceColumn: 2, sourceEndLine: 417, targetClass: 'irem_audio_device', targetMethod: 'ay8910_45M_portb_w'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l/callback0'}) SET n:Callback SET n += {signal: 'port_a_write_callback', operation: 'set', raw: 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', ownerTag: 'ay_45l', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 425, sourceColumn: 2, sourceEndLine: 425, targetClass: 'irem_audio_device', targetMethod: 'ay8910_45L_porta_w'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback0'}) SET n:Callback SET n += {signal: 'vck_callback', operation: 'set_inputline', raw: 'm_adpcm1->vck_callback().set_inputline(m_cpu, INPUT_LINE_NMI)', ownerTag: 'msm1', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 431, sourceColumn: 2, sourceEndLine: 431, inputLine: 'INPUT_LINE_NMI', targetTag: 'iremsound'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback1'}) SET n:Callback SET n += {signal: 'vck_callback', operation: 'append', raw: 'm_adpcm1->vck_callback().append(m_adpcm2, FUNC(msm5205_device::vclk_w))', ownerTag: 'msm1', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 432, sourceColumn: 2, sourceEndLine: 432, targetClass: 'msm5205_device', targetMethod: 'vclk_w', targetTag: 'msm2'};
...
MERGE (n:KG {id: 'audioroute:device:m62_audio_device.device_add_mconfig/snd_nl/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: 'mono', gain: 1, raw: 'NETLIST_SOUND(config, "snd_nl", 48000)
		.set_source(netlist_kidniki)
		.add_route(ALL_OUTPUTS, "mono", 1.0)', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 442, sourceColumn: 2, sourceEndLine: 444};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ibd'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ibd', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ibd", "I_BD0.IN", 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 446, sourceColumn: 2, sourceEndLine: 446, clockExpr: '"I_BD0.IN", 0'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:isd'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:isd', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:isd", "I_SD0.IN", 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 447, sourceColumn: 2, sourceEndLine: 447, clockExpr: '"I_SD0.IN", 0'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ich'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ich', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ich", "I_CH0.IN", 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 448, sourceColumn: 2, sourceEndLine: 448, clockExpr: '"I_CH0.IN", 0'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:ioh'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:ioh', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:ioh", "I_OH0.IN", 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 449, sourceColumn: 2, sourceEndLine: 449, clockExpr: '"I_OH0.IN", 0'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:sinh'}) SET n:Device SET n += {type: 'NETLIST_LOGIC_INPUT', tag: 'snd_nl:sinh', clock: null, config: ['NETLIST_LOGIC_INPUT(config, "snd_nl:sinh", "SINH.IN", 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 450, sourceColumn: 2, sourceEndLine: 450, clockExpr: '"SINH.IN", 0'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin0'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin0', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin0", 0, "R_AY45M_A.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 452, sourceColumn: 2, sourceEndLine: 452, clockExpr: '0, "R_AY45M_A.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin1'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin1', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin1", 1, "R_AY45M_B.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 453, sourceColumn: 2, sourceEndLine: 453, clockExpr: '1, "R_AY45M_B.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin2'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin2', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin2", 2, "R_AY45M_C.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 454, sourceColumn: 2, sourceEndLine: 454, clockExpr: '2, "R_AY45M_C.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin3'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin3', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin3", 3, "R_AY45L_A.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 456, sourceColumn: 2, sourceEndLine: 456, clockExpr: '3, "R_AY45L_A.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin4'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin4', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin4", 4, "R_AY45L_B.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 457, sourceColumn: 2, sourceEndLine: 457, clockExpr: '4, "R_AY45L_B.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin5'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin5', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin5", 5, "R_AY45L_C.R")'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 458, sourceColumn: 2, sourceEndLine: 458, clockExpr: '5, "R_AY45L_C.R"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin6'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin6', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin6", 6, "I_MSM2K0.IN").set_mult_offset(10.0, 2.5)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 460, sourceColumn: 2, sourceEndLine: 460, clockExpr: '6, "I_MSM2K0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cin7'}) SET n:Device SET n += {type: 'NETLIST_STREAM_INPUT', tag: 'snd_nl:cin7', clock: null, config: ['NETLIST_STREAM_INPUT(config, "snd_nl:cin7", 7, "I_MSM3K0.IN").set_mult_offset(10.0, 2.5)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 461, sourceColumn: 2, sourceEndLine: 461, clockExpr: '7, "I_MSM3K0.IN"'};
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/snd_nl:cout0'}) SET n:Device SET n += {type: 'NETLIST_STREAM_OUTPUT', tag: 'snd_nl:cout0', clock: null, config: ['NETLIST_STREAM_OUTPUT(config, "snd_nl:cout0", 0, "R26.1").set_mult_offset(30000.0 * 10.0 / 32768.0, 0.0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 463, sourceColumn: 2, sourceEndLine: 463, clockExpr: '0, "R26.1"'};
...
MERGE (n:KG {id: 'inputs:m62_common/DSW2/f5'}) SET n:PortField SET n += {kind: 'service', mask: 128, activeLow: true};
...
MATCH (a:KG {id: 'machine:m62_state.kungfum'}), (b:KG {id: 'machine:m62_state.kungfum/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'machine:m62_state.kungfum/callback0'}), (b:KG {id: 'handler:m62_state.screen_update_kungfum'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m62_state.ldrun/maincpu'}), (b:KG {id: 'device:m62_state.ldrun/maincpu/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m62_state.ldrun/maincpu/callback0'}), (b:KG {id: 'handler:m62_state.irq0_line_hold'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback0'}), (b:KG {id: 'handler:m62_audio_device.m6803_port1_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback1'}), (b:KG {id: 'handler:m62_audio_device.m6803_port1_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback2'}), (b:KG {id: 'handler:m62_audio_device.m6803_port2_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound/callback3'}), (b:KG {id: 'handler:m62_audio_device.m6803_port2_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback0'}), (b:KG {id: 'handler:irem_audio_device.soundlatch_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45m/callback1'}), (b:KG {id: 'handler:irem_audio_device.ay8910_45M_portb_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l/callback0'}), (b:KG {id: 'handler:irem_audio_device.ay8910_45L_porta_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback0'}), (b:KG {id: 'device:m62_audio_device.device_add_mconfig/iremsound'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:m62_audio_device.device_add_mconfig/msm1/callback1'}), (b:KG {id: 'handler:msm5205_device.vclk_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
