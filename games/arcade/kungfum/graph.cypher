...
// generated 2026-09-17T07:12:05.019Z
...
MERGE (n:KG {id: 'device:m62_state.ldrun/chr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'chr_palette', clock: null, config: ['PALETTE(config, m_chr_palette, FUNC(m62_state::m62_chr), 256)'], member: 'm_chr_palette', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 947, sourceColumn: 2, sourceEndLine: 947, clockExpr: 'FUNC(m62_state::m62_chr)'};
MERGE (n:KG {id: 'device:m62_state.ldrun/spr_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'spr_palette', clock: null, config: ['PALETTE(config, m_spr_palette, FUNC(m62_state::m62_spr), 256)'], member: 'm_spr_palette', sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 948, sourceColumn: 2, sourceEndLine: 948, clockExpr: 'FUNC(m62_state::m62_spr)'};
...
MERGE (n:KG {id: 'device:m62_audio_device.device_add_mconfig/ay_45l'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45l', clock: 894886.25, config: ['AY8910(config, m_ay_45L, XTAL(3\'579\'545)/4)', 'm_ay_45L->set_flags(AY8910_RESISTOR_OUTPUT)', 'm_ay_45L->set_resistors_load(2000.0, 2000.0, 2000.0)', 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', 'm_ay_45L->add_route(0, "snd_nl", 1.0, 3)', 'm_ay_45L->add_route(1, "snd_nl", 1.0, 4)', 'm_ay_45L->add_route(2, "snd_nl", 1.0, 5)'], member: 'm_ay_45L', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 422, sourceColumn: 2, sourceEndLine: 422, configCalls: ['set_flags(8)', 'set_resistors_load(2000,2000,2000)']};
