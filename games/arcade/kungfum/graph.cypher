...
// generated 2026-09-05T03:49:47.924Z
...
MERGE (n:KG {id: 'device:m62_state.ldrun/irem_audio'}) SET n:Device SET n += {type: 'IREM_M62_AUDIO', tag: 'irem_audio', clock: 0, config: ['IREM_M62_AUDIO(config, m_audio)'], cls: 'm62_audio_device', clsHierarchy: ['m62_audio_device', 'irem_audio_device'], sourceFile: 'src/mame/irem/m62.cpp', sourceLine: 951, sourceColumn: 2, sourceEndLine: 951};
