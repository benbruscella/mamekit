...
defined.compiledHandlers = {
  ...
  function method_interrupt_vector_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    ...
    let code: any = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((2) * (((attr) & (128)))));
    let color: any = ((attr) & (15));
    let flags: any = ((((((attr) & (64))) ? (1) : (0))) | (((((attr) & (32))) ? (2) : (0))));
