...
// generated 2026-09-24T02:29:52.533Z
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/maincpu'}) SET n:Device SET n += {type: 'KONAMI1', tag: 'maincpu', clock: 1536000, config: ['KONAMI1(config, m_maincpu, XTAL(18\'432\'000) / 3 / 4)', 'm_maincpu->set_addrmap(AS_PROGRAM, &rocnrope_state::main_map)'], member: 'm_maincpu', cls: 'konami1_device', clsHierarchy: ['konami1_device'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 392, sourceColumn: 2, sourceEndLine: 392};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_rocnrope)'], member: 'm_gfxdecode', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 415, sourceColumn: 2, sourceEndLine: 415, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(rocnrope_state::palette), 16*16+16*16, 32)'], member: 'm_palette', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 416, sourceColumn: 2, sourceEndLine: 416, clockExpr: 'FUNC(rocnrope_state::palette)', paletteEntries: 32};
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, "timeplt_audio")'], cls: 'timeplt_audio_device', clsHierarchy: ['timeplt_audio_device'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 419, sourceColumn: 2, sourceEndLine: 419, startHandler: 'timeplt_audio_device.device_start'};
...
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/timeplt_audio'}), (b:KG {id: 'handler:timeplt_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
