...
// generated 2026-07-30T09:34:27.145Z
...
MERGE (n:KG {id: 'machine:rocnrope_state.rocnrope'}) SET n:MachineConfig SET n += {cls: 'rocnrope_state', name: 'rocnrope', calls: [], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 389, sourceColumn: 1, sourceEndLine: 420};
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/maincpu'}) SET n:Device SET n += {type: 'KONAMI1', tag: 'maincpu', clock: 1536000, config: ['KONAMI1(config, m_maincpu, XTAL(18\'432\'000) / 3 / 4)', 'm_maincpu->set_addrmap(AS_PROGRAM, &rocnrope_state::main_map)'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 392, sourceColumn: 2, sourceEndLine: 392};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback0'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<0>().set(FUNC(rocnrope_state::flip_screen_set)).invert()', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 396, sourceColumn: 2, sourceEndLine: 396, slot: '0', transforms: ['invert'], targetClass: 'rocnrope_state', targetMethod: 'flip_screen_set'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback1'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<1>().set("timeplt_audio", FUNC(timeplt_audio_device::sh_irqtrigger_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 397, sourceColumn: 2, sourceEndLine: 397, slot: '1', targetTag: 'timeplt_audio', targetClass: 'timeplt_audio_device', targetMethod: 'sh_irqtrigger_w'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback2'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<2>().set("timeplt_audio", FUNC(timeplt_audio_device::mute_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 398, sourceColumn: 2, sourceEndLine: 398, slot: '2', targetTag: 'timeplt_audio', targetClass: 'timeplt_audio_device', targetMethod: 'mute_w'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback3'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<3>().set(FUNC(rocnrope_state::coin_counter_w<0>))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 399, sourceColumn: 2, sourceEndLine: 399, slot: '3', targetClass: 'rocnrope_state', targetMethod: 'coin_counter_w_0'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback4'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<4>().set(FUNC(rocnrope_state::coin_counter_w<1>))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 400, sourceColumn: 2, sourceEndLine: 400, slot: '4', targetClass: 'rocnrope_state', targetMethod: 'coin_counter_w_1'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback5'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<7>().set(FUNC(rocnrope_state::irq_mask_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 401, sourceColumn: 2, sourceEndLine: 401, slot: '7', targetClass: 'rocnrope_state', targetMethod: 'irq_mask_w'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/screen/callback0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'screen.set_screen_update(FUNC(rocnrope_state::screen_update))', ownerTag: 'screen', sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 411, sourceColumn: 2, sourceEndLine: 411, targetClass: 'rocnrope_state', targetMethod: 'screen_update'};
...
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_rocnrope)'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 415, sourceColumn: 2, sourceEndLine: 415, clockExpr: 'm_palette, gfx_rocnrope'};
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(rocnrope_state::palette), 16*16+16*16, 32)'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 416, sourceColumn: 2, sourceEndLine: 416, clockExpr: 'FUNC(rocnrope_state::palette), 16*16+16*16, 32'};
MERGE (n:KG {id: 'device:rocnrope_state.rocnrope/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, "timeplt_audio")'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 419, sourceColumn: 2, sourceEndLine: 419};
...
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch'}), (b:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/screen'}), (b:KG {id: 'device:rocnrope_state.rocnrope/screen/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/screen'}), (b:KG {id: 'device:rocnrope_state.rocnrope/screen/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback0'}), (b:KG {id: 'handler:rocnrope_state.flip_screen_set'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback1'}), (b:KG {id: 'handler:timeplt_audio_device.sh_irqtrigger_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback2'}), (b:KG {id: 'handler:timeplt_audio_device.mute_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback3'}), (b:KG {id: 'handler:rocnrope_state.coin_counter_w_0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback4'}), (b:KG {id: 'handler:rocnrope_state.coin_counter_w_1'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/mainlatch/callback5'}), (b:KG {id: 'handler:rocnrope_state.irq_mask_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/screen/callback0'}), (b:KG {id: 'handler:rocnrope_state.screen_update'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:rocnrope_state.rocnrope/screen/callback1'}), (b:KG {id: 'handler:rocnrope_state.vblank_irq'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
