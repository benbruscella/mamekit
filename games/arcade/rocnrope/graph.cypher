...
// generated 2026-08-22T05:52:41.875Z
...
MERGE (n:KG {id: 'machine:rocnrope_state.rocnrope'}) SET n:MachineConfig SET n += {cls: 'rocnrope_state', name: 'rocnrope', calls: [], startHandlers: ['rocnrope_state.video_start'], sourceFile: 'src/mame/konami/rocnrope.cpp', sourceLine: 389, sourceColumn: 1, sourceEndLine: 420};
