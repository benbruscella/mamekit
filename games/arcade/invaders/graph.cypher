...
// generated 2026-08-22T05:52:27.475Z
...
MERGE (n:KG {id: 'machine:mw8080bw_state.mw8080bw_root'}) SET n:MachineConfig SET n += {cls: 'mw8080bw_state', name: 'mw8080bw_root', calls: [], resetHandlers: ['mw8080bw_state.machine_reset'], sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 329, sourceColumn: 1, sourceEndLine: 341};
...
MERGE (n:KG {id: 'handler:mw8080bw_state.screen_update_mw8080bw'}) SET n:Handler SET n += {method: 'screen_update_mw8080bw', ownerClass: 'mw8080bw_state', sourceFile: 'src/mame/midw8080/mw8080bw_v.cpp', sourceLine: 14, sourceColumn: 1, sourceEndLine: 58, sourceConstants: ['MW8080BW_VCOUNTER_START_NO_VBLANK=32'], sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: 'uint8_t x = 0;
	...
	return 0;'};
MERGE (n:KG {id: 'machine:invaders_state.invaders'}) SET n:MachineConfig SET n += {cls: 'invaders_state', name: 'invaders', calls: ['mw8080bw_root'], resetHandlers: ['mw8080bw_state.machine_reset'], devicePatches: ['{"tag":"screen","config":["m_screen->set_screen_update(FUNC(invaders_state::screen_update_invaders))"]}'], sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 2683, sourceColumn: 1, sourceEndLine: 2706};
...
MERGE (n:KG {id: 'inputs:invaders/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(invaders_state::direct_coin_count), 0)']};
