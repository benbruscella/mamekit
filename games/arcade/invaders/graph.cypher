...
// generated 2026-09-24T02:28:03.586Z
...
MERGE (n:KG {id: 'callback:timer/mw8080bw_state.interrupt_trigger'}) SET n:Callback SET n += {ownerTag: 'interrupt_timer', signal: 'timer', operation: 'adjust', targetClass: 'mw8080bw_state', targetMethod: 'interrupt_trigger', startClass: 'mw8080bw_state', startMethod: 'machine_start', scanlines: [96, 224], sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 217, sourceColumn: 1, sourceEndLine: 246};
...
MERGE (n:KG {id: 'handler:mw8080bw_state.vpos_to_vysnc_chain_counter'}) SET n:Handler SET n += {method: 'vpos_to_vysnc_chain_counter', ownerClass: 'mw8080bw_state', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 188, sourceColumn: 1, sourceEndLine: 200, sourceConstants: ['MW8080BW_VBSTART=224', 'MW8080BW_VCOUNTER_START_NO_VBLANK=32', 'MW8080BW_VCOUNTER_START_VBLANK=218'], sourceParameters: 'int vpos', sourceBody: '// convert from a vertical position to the actual values on the vertical sync counters
	...
	return counter;'};
MERGE (n:KG {id: 'handler:mw8080bw_state.vysnc_chain_counter_to_vpos'}) SET n:Handler SET n += {method: 'vysnc_chain_counter_to_vpos', ownerClass: 'mw8080bw_state', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 203, sourceColumn: 1, sourceEndLine: 214, sourceConstants: ['MW8080BW_VBSTART=224', 'MW8080BW_VCOUNTER_START_NO_VBLANK=32', 'MW8080BW_VCOUNTER_START_VBLANK=218'], sourceParameters: 'uint8_t counter, int vblank', sourceBody: '// convert from the vertical sync counters to an actual vertical position
	int vpos;
...
MERGE (n:KG {id: 'machine:mw8080bw_state.mw8080bw_root'}) SET n:MachineConfig SET n += {cls: 'mw8080bw_state', name: 'mw8080bw_root', calls: [], stateMembers: ['{"name":"m_phantom2_cloud_counter","bits":16}', '{"name":"m_maze_tone_timing_state","bits":8}', '{"name":"m_int_enable","bits":1,"initial":1}'], driverTimers: ['m_interrupt_timer=mw8080bw_state.interrupt_trigger'], resetHandlers: ['mw8080bw_state.machine_reset'], sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 329, sourceColumn: 1, sourceEndLine: 341};
MERGE (n:KG {id: 'handler:mw8080bw_state.machine_reset'}) SET n:Handler SET n += {method: 'machine_reset', ownerClass: 'mw8080bw_state', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 282, sourceColumn: 1, sourceEndLine: 288, sourceConstants: ['MW8080BW_INT_TRIGGER_COUNT_1=128', 'MW8080BW_INT_TRIGGER_VBLANK_1=0'], sourceParameters: '', sourceBody: 'int vpos = vysnc_chain_counter_to_vpos(MW8080BW_INT_TRIGGER_COUNT_1, MW8080BW_INT_TRIGGER_VBLANK_1);
	m_interrupt_timer->adjust(m_screen->time_until_pos(vpos));

	m_interrupt_time = attotime::zero;'};
MERGE (n:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu'}) SET n:Device SET n += {type: 'I8080', tag: 'maincpu', clock: 1996800, config: ['i8080_cpu_device &maincpu(I8080(config, m_maincpu, MW8080BW_CPU_CLOCK))', 'maincpu.set_addrmap(AS_PROGRAM, &mw8080bw_state::main_map)', 'maincpu.set_irq_acknowledge_callback(FUNC(mw8080bw_state::interrupt_vector))', 'maincpu.out_inte_func().set(FUNC(mw8080bw_state::int_enable_w))'], member: 'm_maincpu', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 332, sourceColumn: 2, sourceEndLine: 332};
MERGE (n:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:0'}) SET n:Callback SET n += {signal: 'set_irq_acknowledge_callback', operation: 'set_irq_acknowledge_callback', raw: 'maincpu.set_irq_acknowledge_callback(FUNC(mw8080bw_state::interrupt_vector))', ownerTag: 'maincpu', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 334, sourceColumn: 2, sourceEndLine: 334, targetClass: 'mw8080bw_state', targetMethod: 'interrupt_vector'};
MERGE (n:KG {id: 'handler:mw8080bw_state.interrupt_vector'}) SET n:Handler SET n += {method: 'interrupt_vector', ownerClass: 'mw8080bw_state', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 255, sourceColumn: 1, sourceEndLine: 266, sourceParameters: 'int irqline', sourceBody: 'int vpos = m_screen->vpos();
	...
	m_maincpu->set_input_line(0, CLEAR_LINE);
	return vector;'};
MERGE (n:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:1'}) SET n:Callback SET n += {signal: 'out_inte_func', operation: 'set', raw: 'maincpu.out_inte_func().set(FUNC(mw8080bw_state::int_enable_w))', ownerTag: 'maincpu', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 335, sourceColumn: 2, sourceEndLine: 335, targetClass: 'mw8080bw_state', targetMethod: 'int_enable_w'};
...
MERGE (n:KG {id: 'device:mw8080bw_state.mw8080bw_root/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MW8080BW_PIXEL_CLOCK, MW8080BW_HTOTAL, MW8080BW_HBEND, MW8080BW_HPIXCOUNT, MW8080BW_VTOTAL, MW8080BW_VBEND, MW8080BW_VBSTART)', 'm_screen->set_screen_update(FUNC(mw8080bw_state::screen_update_mw8080bw))', 'm_screen->set_screen_update(FUNC(invaders_state::screen_update_invaders))'], member: 'm_screen', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 338, sourceColumn: 2, sourceEndLine: 338, configCalls: ['set_raw(4992000,320,0,260,262,0,224)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [4992000, 320, 0, 260, 262, 0, 224], screenRawExpr: ['MW8080BW_PIXEL_CLOCK', 'MW8080BW_HTOTAL', 'MW8080BW_HBEND', 'MW8080BW_HPIXCOUNT', 'MW8080BW_VTOTAL', 'MW8080BW_VBEND', 'MW8080BW_VBSTART']};
MERGE (n:KG {id: 'machine:invaders_state.invaders'}) SET n:MachineConfig SET n += {cls: 'invaders_state', name: 'invaders', calls: ['mw8080bw_root'], stateMembers: ['{"name":"m_phantom2_cloud_counter","bits":16}', '{"name":"m_maze_tone_timing_state","bits":8}', '{"name":"m_int_enable","bits":1,"initial":1}', '{"name":"m_flip_screen","bits":8}'], driverTimers: ['m_interrupt_timer=mw8080bw_state.interrupt_trigger'], resetHandlers: ['mw8080bw_state.machine_reset'], devicePatches: ['{"tag":"screen","config":["m_screen->set_screen_update(FUNC(invaders_state::screen_update_invaders))"]}'], sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 2683, sourceColumn: 1, sourceEndLine: 2706};
MERGE (n:KG {id: 'machine:invaders_state.invaders/callback:screen:0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'm_screen->set_screen_update(FUNC(invaders_state::screen_update_invaders))', ownerTag: 'screen', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 2693, sourceColumn: 2, sourceEndLine: 2693, targetClass: 'invaders_state', targetMethod: 'screen_update_invaders'};
MERGE (n:KG {id: 'handler:invaders_state.screen_update_invaders'}) SET n:Handler SET n += {method: 'screen_update_invaders', ownerClass: 'invaders_state', sourceFile: 'src/mame/midw8080/mw8080bw_v.cpp', sourceLine: 356, sourceColumn: 1, sourceEndLine: 407, sourceConstants: ['MW8080BW_VBSTART=224', 'MW8080BW_VCOUNTER_START_NO_VBLANK=32', 'MW8080BW_HPIXCOUNT=260'], sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: 'uint8_t x = 0;
	...
	return 0;'};
MERGE (n:KG {id: 'device:invaders_state.invaders/watchdog'}) SET n:Device SET n += {type: 'WATCHDOG_TIMER', tag: 'watchdog', clock: null, config: ['WATCHDOG_TIMER(config, m_watchdog).set_time(255 * attotime::from_hz(MW8080BW_60HZ))'], member: 'm_watchdog', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 2690, sourceColumn: 2, sourceEndLine: 2690};
MERGE (n:KG {id: 'device:invaders_state.invaders/mb14241'}) SET n:Device SET n += {type: 'MB14241', tag: 'mb14241', clock: null, config: ['MB14241(config, m_mb14241)'], member: 'm_mb14241', sourceFile: 'src/mame/midw8080/mw8080bw.cpp', sourceLine: 2696, sourceColumn: 2, sourceEndLine: 2696};
MERGE (n:KG {id: 'device:invaders_state.invaders/soundboard'}) SET n:Device SET n += {type: 'INVADERS_AUDIO', tag: 'soundboard', clock: null, config: ['INVADERS_AUDIO(config, "soundboard")
			.flip_screen_out().set(
					...
					})'], cls: 'invaders_audio_device', clsHierarchy: ['invaders_audio_device'], startHandler: 'invaders_audio_device.device_start'};
MERGE (n:KG {id: 'machine:invaders_audio_device.device_add_mconfig'}) SET n:MachineConfig SET n += {cls: 'invaders_audio_device', name: 'device_add_mconfig', calls: [], stateMembers: ['{"name":"m_p2","bits":8}'], sourceFile: 'src/mame/midw8080/mw8080bw_a.cpp', sourceLine: 3279, sourceColumn: 1, sourceEndLine: 3301};
...
MERGE (n:KG {id: 'device:invaders_audio_device.device_add_mconfig/discrete'}) SET n:Device SET n += {type: 'DISCRETE', tag: 'discrete', clock: null, config: ['DISCRETE(config, m_discrete, invaders_discrete)', 'm_discrete->add_route(ALL_OUTPUTS, "mono", 0.5)'], member: 'm_discrete', sourceFile: 'src/mame/midw8080/mw8080bw_a.cpp', sourceLine: 3299, sourceColumn: 2, sourceEndLine: 3299, clockExpr: 'invaders_discrete'};
...
MERGE (n:KG {id: 'handler:invaders_audio_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'invaders_audio_device', sourceFile: 'src/mame/midw8080/mw8080bw_a.cpp', sourceLine: 3303, sourceColumn: 1, sourceEndLine: 3308, sourceParameters: '', sourceBody: 'm_p2 = 0U;
...
MERGE (n:KG {id: 'inputs:invaders/IN0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW:8")'], name: 'Unknown', defaultValue: 0, location: 'SW:8', settings: ['0=Off', '1=On']};
MERGE (n:KG {id: 'inputs:invaders/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 6, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(invaders_state::invaders_sw6_sw7_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:invaders/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNUSED', defaultValue: 8};
MERGE (n:KG {id: 'inputs:invaders/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 112, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(invaders_state::invaders_in0_control_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:invaders/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(invaders_state::invaders_sw5_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:invaders/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_COIN1', modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(invaders_state::direct_coin_count), 0)'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:invaders/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_UNUSED', defaultValue: 8};
MERGE (n:KG {id: 'inputs:invaders/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 112, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(invaders_state::invaders_in1_control_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:invaders/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:invaders/IN2/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SW:3,4")'], name: 'Lives', defaultValue: 0, location: 'SW:3,4', settings: ['0=3', '1=4', '2=5', '3=6']};
MERGE (n:KG {id: 'inputs:invaders/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/IN2/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, modifiers: ['PORT_DIPLOCATION("SW:2")'], name: 'Bonus Life', defaultValue: 0, location: 'SW:2', settings: ['8=1000', '0=1500']};
MERGE (n:KG {id: 'inputs:invaders/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 112, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_CUSTOM_MEMBER(FUNC(invaders_state::invaders_in2_control_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:invaders/IN2/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_DIPLOCATION("SW:1")'], name: 'Display Coinage', defaultValue: 0, location: 'SW:1', settings: ['128=Off', '0=On']};
...
MERGE (n:KG {id: 'inputs:invaders/SW6SW7/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW:7")'], name: 'Unused', defaultValue: 0, location: 'SW:7', settings: ['0=Off', '1=On']};
MERGE (n:KG {id: 'inputs:invaders/SW6SW7/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 2, modifiers: ['PORT_DIPLOCATION("SW:6")'], name: 'Unused', defaultValue: 0, location: 'SW:6', settings: ['0=Off', '2=On']};
MERGE (n:KG {id: 'inputs:invaders/SW6SW7/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 252, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/SW5'}) SET n:Port SET n += {tag: 'SW5', modify: false};
MERGE (n:KG {id: 'inputs:invaders/SW5/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 1, modifiers: ['PORT_DIPLOCATION("SW:5")'], name: 'Unused', defaultValue: 0, location: 'SW:5', settings: ['0=Off', '1=On']};
MERGE (n:KG {id: 'inputs:invaders/SW5/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 254, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP1'}) SET n:Port SET n += {tag: 'CONTP1', modify: false};
MERGE (n:KG {id: 'inputs:invaders/CONTP1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP2'}) SET n:Port SET n += {tag: 'CONTP2', modify: false};
MERGE (n:KG {id: 'inputs:invaders/CONTP2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:invaders/CONTP2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
...
MATCH (a:KG {id: 'machine:invaders_state.invaders'}), (b:KG {id: 'handler:mw8080bw_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'machine:invaders_state.invaders'}), (b:KG {id: 'machine:mw8080bw_state.mw8080bw_root'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'machine:invaders_state.invaders'}), (b:KG {id: 'machine:invaders_state.invaders/callback:screen:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'handler:mw8080bw_state.machine_reset'}), (b:KG {id: 'handler:mw8080bw_state.vysnc_chain_counter_to_vpos'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'machine:mw8080bw_state.mw8080bw_root'}), (b:KG {id: 'handler:mw8080bw_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'machine:invaders_state.invaders/callback:screen:0'}), (b:KG {id: 'handler:invaders_state.screen_update_invaders'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:invaders_state.invaders/soundboard'}), (b:KG {id: 'handler:invaders_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:mw8080bw_state.interrupt_trigger'}), (b:KG {id: 'handler:mw8080bw_state.vysnc_chain_counter_to_vpos'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu'}), (b:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu'}), (b:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:0'}), (b:KG {id: 'handler:mw8080bw_state.interrupt_vector'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:mw8080bw_state.mw8080bw_root/maincpu/callback:maincpu:1'}), (b:KG {id: 'handler:mw8080bw_state.int_enable_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:invaders_state.invaders_sw6_sw7_r'}), (b:KG {id: 'handler:invaders_state.is_cabinet_cocktail'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:invaders_state.invaders_in0_control_r'}), (b:KG {id: 'handler:invaders_state.is_cabinet_cocktail'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:invaders_state.invaders_sw5_r'}), (b:KG {id: 'handler:invaders_state.is_cabinet_cocktail'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
