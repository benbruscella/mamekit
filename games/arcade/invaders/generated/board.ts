...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_vpos_to_vysnc_chain_counter(runtime: any, vpos: any) {
    const members = runtime.members;
    let counter: any = ((0) & 0xff);
    let vblank: any = ((Number(vpos) >= Number(224)) ? 1 : 0);
    if (vblank) {
  ...
  function method_vysnc_chain_counter_to_vpos(runtime: any, counter: any, vblank: any) {
    const members = runtime.members;
    let vpos: any = 0;
    if (vblank) {
  ...
  function method_screen_update_invaders(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
    ...
    while (1) {
      let pen: any = ((((video_data) & (1))) ? ((runtime.calls["rgb_t::white"] ? runtime.calls["rgb_t::white"]() : runtime.macro("rgb_t::white"))) : ((runtime.calls["rgb_t::black"] ? runtime.calls["rgb_t::black"]() : runtime.macro("rgb_t::black"))));
      if (h_m_flip_screen) {
