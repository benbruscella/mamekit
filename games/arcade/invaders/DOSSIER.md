...
**Taito / Midway · 1978** — transpiled from the MAME driver `src/mame/midw8080/mw8080bw.cpp` by mamekit.

![marquee](/artwork/media/marquees/invaders.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/invaders.webp) | ![cabinet](/artwork/media/cabinets/invaders.webp) |

## The machine

| CPU | Type | Clock | Mapped ranges |
| --- | --- | --- | --- |
| `maincpu` | I8080 | 1.997 MHz | 3 |

- **Sound:** discrete @ 1.997 MHz
- **Screen:** 260×224 @ 59.54 Hz · rotated 270°

### ROM chips

| Region | Chip | Offset | Size | CRC |
| --- | --- | --- | --- | --- |
| `maincpu` | `9316b-0869_m739h.h1` | 0x0 | 0x800 | `734f5ad8` |
| `maincpu` | `9316b-0856_m739g.g1` | 0x800 | 0x800 | `6bfaca4a` |
| `maincpu` | `9316b-0855_m739f.f1` | 0x1000 | 0x800 | `0ccead96` |
| `maincpu` | `9316b-0854_m739e.e1` | 0x1800 | 0x800 | `14e538b0` |
...
| 2 | start2 | `IN1` | 0x2 |
| 1 | start1 | `IN1` | 0x4 |
| Space / X | button1 | `CONTP1` | 0x1 |
| Left | joystick left | `CONTP1` | 0x2 |
...
| Unknown | `IN0` | 0x1 | 0x0 |
| Lives | `IN2` | 0x3 | 0x0 |
| Bonus Life | `IN2` | 0x8 | 0x0 |
| Display Coinage | `IN2` | 0x80 | 0x0 |
| Cabinet | `CAB` | 0x1 | 0x0 |
| Unused | `SW6SW7` | 0x1 | 0x0 |
| Unused | `SW6SW7` | 0x2 | 0x0 |
| Unused | `SW5` | 0x1 | 0x0 |

## The MAME driver — the people who reverse-engineered it

- **Driver source:** `src/mame/midw8080/mw8080bw.cpp`
- **Written by:** Nicola Salmoria, Tormod Tjaberg, Mirko Buffoni,Lee Taylor, Valerio Verrando, Zsolt Vasvari
- **License:** BSD-3-Clause
- **Credited by MAMEDEV:** Lee Taylor (driver header); Mirko Buffoni (driver header); Nicola Salmoria (driver header); Tormod Tjaberg (driver header); Valerio Verrando (driver header); Zsolt Vasvari (driver header); Colin Douglas Howell (4 release notes); ClawGrip (1 release note); Colin Howell (1 release note); einstein95 (1 release note); Osso (1 release note); Retromaniacs (1 release note); Roger Parramon Junyent (1 release note); Vas Crabb (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 209 commits by 28 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/31739/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `mw8080bw`. Play it at [../../../app/g/invaders/](../../../app/g/invaders/) or [explore the knowledge graph](viewer.html).*
