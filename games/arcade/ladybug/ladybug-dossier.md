...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Frank Palazzolo (1 release note); hap (1 release note); jkburks (1 release note); Marco Kerstens (1 release note); Sam Grech (1 release note)
