...
// generated 2026-09-24T02:30:39.532Z
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/maincpu'}) SET n:Device SET n += {type: 'KONAMI1', tag: 'maincpu', clock: 1536000, config: ['KONAMI1(config, m_maincpu, MASTER_CLOCK/6/2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &trackfld_state::main_map)'], member: 'm_maincpu', cls: 'konami1_device', clsHierarchy: ['konami1_device'], sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1232, sourceColumn: 2, sourceEndLine: 1232};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/mainlatch'}) SET n:Device SET n += {type: 'LS259', tag: 'mainlatch', clock: null, config: ['LS259(config, m_mainlatch)', 'm_mainlatch->q_out_cb<0>().set(FUNC(trackfld_state::flip_screen_set))', 'm_mainlatch->q_out_cb<1>().set("trackfld_audio", FUNC(trackfld_audio_device::sh_irqtrigger_w))', 'm_mainlatch->q_out_cb<2>().set_nop()', 'm_mainlatch->q_out_cb<3>().set(FUNC(trackfld_state::coin_counter_1_w))', 'm_mainlatch->q_out_cb<4>().set(FUNC(trackfld_state::coin_counter_2_w))', 'm_mainlatch->q_out_cb<5>().set_nop()', 'm_mainlatch->q_out_cb<6>().set_nop()', 'm_mainlatch->q_out_cb<7>().set(FUNC(trackfld_state::irq_mask_w))'], member: 'm_mainlatch', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1238, sourceColumn: 2, sourceEndLine: 1238};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/3, 384, 0, 256, 264, 16, 240)', 'm_screen->set_screen_update(FUNC(trackfld_state::screen_update_trackfld))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set(FUNC(trackfld_state::vblank_irq))'], member: 'm_screen', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1253, sourceColumn: 2, sourceEndLine: 1253, configCalls: ['set_raw(6144000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['MASTER_CLOCK/3', '384', '0', '256', '264', '16', '240']};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_trackfld)'], member: 'm_gfxdecode', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1259, sourceColumn: 2, sourceEndLine: 1259, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:trackfld_state.trackfld/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(trackfld_state::trackfld_palette), 16*16+16*16, 32)'], member: 'm_palette', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1260, sourceColumn: 2, sourceEndLine: 1260, clockExpr: 'FUNC(trackfld_state::trackfld_palette)', paletteEntries: 32};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/trackfld_audio'}) SET n:Device SET n += {type: 'TRACKFLD_AUDIO', tag: 'trackfld_audio', clock: null, config: ['TRACKFLD_AUDIO(config, m_soundbrd, m_audiocpu, m_vlm)'], member: 'm_soundbrd', cls: 'trackfld_audio_device', clsHierarchy: ['trackfld_audio_device'], sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1268, sourceColumn: 2, sourceEndLine: 1268, clockExpr: 'm_audiocpu', startHandler: 'trackfld_audio_device.device_start'};
MERGE (n:KG {id: 'device:trackfld_state.trackfld/dac'}) SET n:Device SET n += {type: 'DAC_8BIT_R2R', tag: 'dac', clock: 0, config: ['DAC_8BIT_R2R(config, m_dac, 0).add_route(ALL_OUTPUTS, "speaker", 0.4)'], member: 'm_dac', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1270, sourceColumn: 2, sourceEndLine: 1270};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/snsnd'}) SET n:Device SET n += {type: 'SN76489A', tag: 'snsnd', clock: 1789772.625, config: ['SN76489A(config, m_sn, SOUND_CLOCK/8)', 'm_sn->add_route(ALL_OUTPUTS, "speaker", 1.0)'], member: 'm_sn', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1272, sourceColumn: 2, sourceEndLine: 1272};
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/vlm'}) SET n:Device SET n += {type: 'VLM5030', tag: 'vlm', clock: 3579545, config: ['VLM5030(config, m_vlm, VLM_CLOCK)', 'm_vlm->set_addrmap(0, &trackfld_state::vlm_map)', 'm_vlm->add_route(ALL_OUTPUTS, "speaker", 1.0)'], member: 'm_vlm', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1275, sourceColumn: 2, sourceEndLine: 1275};
...
MATCH (a:KG {id: 'device:trackfld_state.trackfld/trackfld_audio'}), (b:KG {id: 'handler:trackfld_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
