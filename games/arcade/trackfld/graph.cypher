...
// generated 2026-09-17T07:12:41.129Z
...
MERGE (n:KG {id: 'device:trackfld_state.trackfld/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(trackfld_state::trackfld_palette), 16*16+16*16, 32)'], member: 'm_palette', sourceFile: 'src/mame/konami/trackfld.cpp', sourceLine: 1260, sourceColumn: 2, sourceEndLine: 1260, clockExpr: 'FUNC(trackfld_state::trackfld_palette)'};
