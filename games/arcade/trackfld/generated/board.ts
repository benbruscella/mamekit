...
defined.compiledHandlers = {
  ...
  function method_trackfld_videoram_w(runtime: any, offset: any, data: any): any {
  ...
  function method_trackfld_colorram_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_trackfld_SN76489a_r(runtime: any): any {
    const members = runtime.members;
  ...
  function method_trackfld_sound_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_vlm.st_w"] ? __l["m_vlm.st_w"]((((offset) >>> (8)) & 1)) : (members.m_vlm) != null ? ((runtime.dereference(members.m_vlm)).st_w?.((((offset) >>> (8)) & 1)) ?? 0) : 0);
    (__l["m_vlm.rst_w"] ? __l["m_vlm.rst_w"]((((offset) >>> (9)) & 1)) : (members.m_vlm) != null ? ((runtime.dereference(members.m_vlm)).rst_w?.((((offset) >>> (9)) & 1)) ?? 0) : 0);
  }
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let code: any = ((runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((4) * (((attr) & (192)))))) | 0);
    let color: any = ((((attr) & (15))) | 0);
    let flags: any = ((((((((attr) & (16))) ? (1) : (0))) | (((((attr) & (32))) ? (2) : (0))))) | 0);
...
defined.compiledHandlerLinks = ["m_bg_tilemap.mark_tile_dirty","m_maincpu.set_input_line","m_sn.write","m_vlm.rst_w","m_vlm.st_w","mark_tile_dirty","set","tileinfo.set"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
