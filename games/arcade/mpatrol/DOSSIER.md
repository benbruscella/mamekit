...
![marquee](/artwork/media/marquees/mpatrol.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/mpatrol.webp) | ![cabinet](/artwork/media/cabinets/mpatrol.webp) |
...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Robbbert (2 release notes); couriersud (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 94 commits by 22 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
