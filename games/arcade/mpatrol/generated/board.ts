...
defined.compiledHandlers = {
  ...
  function method_protection_r(runtime: any) {
    const members = runtime.members;
    let popcount: any = 0;
    for (let temp: any = ((runtime.readIndex((members.m_bgxpos ?? runtime.member("m_bgxpos")), 0)) & (127)); ((Number(temp) !== Number(0)) ? 1 : 0); temp = ((temp) >>> (1))) {
  ...
  function method_bgxpos_w_0(runtime: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_bgxpos"), 0, data);
  }

  function method_bgypos_w_0(runtime: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_bgypos"), 0, data);
  }

  function method_bgxpos_w_1(runtime: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_bgxpos"), 1, data);
  }

  function method_bgypos_w_1(runtime: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_bgypos"), 1, data);
  }

  function method_bgcontrol_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = 60; ((Number(offs) <= Number((members.m_spritelimit ?? runtime.member("m_spritelimit")))) ? 1 : 0); offs = ((offs) + (64))) {
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any, initoffs: any) {
    const members = runtime.members;
    const h_m_spriteram = members.m_spriteram ?? runtime.member("m_spriteram");
    for (let offs: any = initoffs; ((Number(offs) >= Number(((initoffs) & (192)))) ? 1 : 0); offs = ((offs) - (4))) {
      let sy: any = ((257) - (runtime.readIndex(h_m_spriteram, offs)));
      let color: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (63));
      let flipx: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (64));
      let flipy: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (128));
      let code: any = runtime.readIndex(h_m_spriteram, ((offs) + (2)));
      let sx: any = runtime.readIndex(h_m_spriteram, ((offs) + (3)));
