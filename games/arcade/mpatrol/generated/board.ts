...
defined.compiledHandlers = {
  ...
  function method_protection_r(runtime: any): any {
    const members = runtime.members;

    let popcount: any = ((0) | 0);
    for (let temp: any = ((((runtime.readIndex((members.m_bgxpos ?? runtime.member("m_bgxpos")), 0)) & (127))) | 0); ((Number(temp) !== Number(0)) ? 1 : 0); temp = ((runtime.shiftRight(temp, 1)) | 0)) {
      popcount = ((((popcount) + (((temp) & (1))))) | 0);
    }
    return ((popcount) ^ (runtime.shiftRight(runtime.readIndex((members.m_bgxpos ?? runtime.member("m_bgxpos")), 0), 7)));
  }
  ...
  function method_bgxpos_w_0(runtime: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_bgxpos"), 0, data);
  }

  function method_bgypos_w_0(runtime: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_bgypos"), 0, data);
  }

  function method_bgxpos_w_1(runtime: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_bgxpos"), 1, data);
  }

  function method_bgypos_w_1(runtime: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_bgypos"), 1, data);
  }

  function method_bgcontrol_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let video: any = ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index)) & 0xff);
    let color: any = ((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & 0xff);
    let flag: any = ((0) | 0);
    let code: any = ((0) | 0);
    code = ((video) | 0);
    if (((color) & (128))) {
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    for (let offs: any = ((60) | 0); ((Number(offs) <= Number((members.m_spritelimit ?? runtime.member("m_spritelimit")))) ? 1 : 0); offs = ((((offs) + (64))) | 0)) {
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any, initoffs: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_spriteram = members.m_spriteram ?? runtime.member("m_spriteram");
    for (let offs: any = ((initoffs) | 0); ((Number(offs) >= Number(((initoffs) & (192)))) ? 1 : 0); offs = ((((offs) - (4))) | 0)) {
      let sy: any = ((((257) - (runtime.readIndex(h_m_spriteram, offs)))) | 0);
      let color: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (63))) | 0);
      let flipx: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (64))) | 0);
      let flipy: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (1)))) & (128))) | 0);
