...
// generated 2026-07-30T09:34:11.632Z
...
MERGE (n:KG {id: 'machine:m52_state.m52'}) SET n:MachineConfig SET n += {cls: 'm52_state', name: 'm52', calls: [], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 945, sourceColumn: 1, sourceEndLine: 969};
...
MERGE (n:KG {id: 'device:m52_state.m52/sp_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'sp_gfxdecode', clock: null, config: ['GFXDECODE(config, m_sp_gfxdecode, m_sp_palette, gfx_m52_sp)'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 955, sourceColumn: 2, sourceEndLine: 955, clockExpr: 'm_sp_palette, gfx_m52_sp'};
...
MERGE (n:KG {id: 'device:m52_state.m52/tx_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'tx_gfxdecode', clock: null, config: ['GFXDECODE(config, m_tx_gfxdecode, m_tx_palette, gfx_m52_tx)'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 958, sourceColumn: 2, sourceEndLine: 958, clockExpr: 'm_tx_palette, gfx_m52_tx'};
...
MERGE (n:KG {id: 'device:m52_state.m52/bg_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'bg_gfxdecode', clock: null, config: ['GFXDECODE(config, m_bg_gfxdecode, m_bg_palette, gfx_m52_bg)'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 961, sourceColumn: 2, sourceEndLine: 961, clockExpr: 'm_bg_palette, gfx_m52_bg'};
MERGE (n:KG {id: 'device:m52_state.m52/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(18.432_MHz_XTAL / 3, 384, 136, 376, 282, 22, 274)', 'm_screen->set_screen_update(FUNC(m52_state::screen_update))'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 963, sourceColumn: 2, sourceEndLine: 963, configCalls: ['set_raw(6144000,384,136,376,282,22,274)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 136, 376, 282, 22, 274]};
MERGE (n:KG {id: 'device:m52_state.m52/screen/callback0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'm_screen->set_screen_update(FUNC(m52_state::screen_update))', ownerTag: 'screen', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 965, sourceColumn: 2, sourceEndLine: 965, targetClass: 'm52_state', targetMethod: 'screen_update'};
MERGE (n:KG {id: 'handler:m52_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'm52_state', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 579, sourceColumn: 1, sourceEndLine: 606, sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: 'const pen_t *paldata = m_sp_palette->pens();
	...
	return 0;'};
MERGE (n:KG {id: 'device:m52_state.m52/irem_audio'}) SET n:Device SET n += {type: 'IREM_M52_SOUNDC_AUDIO', tag: 'irem_audio', clock: 0, config: ['IREM_M52_SOUNDC_AUDIO(config, "irem_audio")'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 968, sourceColumn: 2, sourceEndLine: 968};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback0'}) SET n:Callback SET n += {signal: 'in_p1_cb', operation: 'set', raw: 'cpu.in_p1_cb().set(FUNC(m52_soundc_audio_device::m6803_port1_r))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port1_r'};
MERGE (n:KG {id: 'handler:m52_soundc_audio_device.m6803_port1_r'}) SET n:Handler SET n += {method: 'm6803_port1_r', ownerClass: 'm52_soundc_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 149, sourceColumn: 1, sourceEndLine: 157, sourceParameters: '', sourceBody: '/* PSG 0 or 1? */
	...
	return 0xff;'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback1'}) SET n:Callback SET n += {signal: 'out_p1_cb', operation: 'set', raw: 'cpu.out_p1_cb().set(FUNC(m52_soundc_audio_device::m6803_port1_w))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port1_w'};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback2'}) SET n:Callback SET n += {signal: 'in_p2_cb', operation: 'set', raw: 'cpu.in_p2_cb().set(FUNC(m52_soundc_audio_device::m6803_port2_r))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port2_r'};
MERGE (n:KG {id: 'handler:m52_soundc_audio_device.m6803_port2_r'}) SET n:Handler SET n += {method: 'm6803_port2_r', ownerClass: 'm52_soundc_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 160, sourceColumn: 1, sourceEndLine: 168, sourceParameters: '', sourceBody: '/*
	...
	//printf("port2 read\\n"); // used by 10yard
	return 0x0;'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback3'}) SET n:Callback SET n += {signal: 'out_p2_cb', operation: 'set', raw: 'cpu.out_p2_cb().set(FUNC(m52_soundc_audio_device::m6803_port2_w))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port2_w'};
MERGE (n:KG {id: 'handler:m52_soundc_audio_device.m6803_port2_w'}) SET n:Handler SET n += {method: 'm6803_port2_w', ownerClass: 'm52_soundc_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 115, sourceColumn: 1, sourceEndLine: 139, sourceParameters: 'uint8_t data', sourceBody: '/* write latch */
	...
	m_port2 = data;'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/mono'}) SET n:Device SET n += {type: 'SPEAKER', tag: 'mono', clock: null, config: ['SPEAKER(config, "mono").front_center()'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 411, sourceColumn: 2, sourceEndLine: 411};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45m', clock: 894886.25, config: ['AY8910(config, m_ay_45M, XTAL(3\'579\'545)/4)', 'm_ay_45M->set_flags(AY8910_SINGLE_OUTPUT | AY8910_DISCRETE_OUTPUT)', 'm_ay_45M->set_resistors_load(470, 0, 0)', 'm_ay_45M->port_a_read_callback().set(FUNC(irem_audio_device::soundlatch_r))', 'm_ay_45M->port_b_write_callback().set(FUNC(irem_audio_device::ay8910_45M_portb_w))', 'm_ay_45M->add_route(0, "filtermix", 1.0, 0)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 413, sourceColumn: 2, sourceEndLine: 413, configCalls: ['set_flags(6)', 'set_resistors_load(470,0,0)']};
MERGE (n:KG {id: 'audioroute:device:m52_soundc_audio_device.device_add_mconfig/ay_45m/0'}) SET n:AudioRoute SET n += {output: '0', target: 'filtermix', gain: 1, input: 0, raw: 'm_ay_45M->add_route(0, "filtermix", 1.0, 0)'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback0'}) SET n:Callback SET n += {signal: 'port_a_read_callback', operation: 'set', raw: 'm_ay_45M->port_a_read_callback().set(FUNC(irem_audio_device::soundlatch_r))', ownerTag: 'ay_45m', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 416, sourceColumn: 2, sourceEndLine: 416, targetClass: 'irem_audio_device', targetMethod: 'soundlatch_r'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback1'}) SET n:Callback SET n += {signal: 'port_b_write_callback', operation: 'set', raw: 'm_ay_45M->port_b_write_callback().set(FUNC(irem_audio_device::ay8910_45M_portb_w))', ownerTag: 'ay_45m', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 417, sourceColumn: 2, sourceEndLine: 417, targetClass: 'irem_audio_device', targetMethod: 'ay8910_45M_portb_w'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45l', clock: 894886.25, config: ['AY8910(config, m_ay_45L, XTAL(3\'579\'545)/4)', 'm_ay_45L->set_flags(AY8910_SINGLE_OUTPUT | AY8910_DISCRETE_OUTPUT)', 'm_ay_45L->set_resistors_load(470, 0, 0)', 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', 'm_ay_45L->add_route(0, "filtermix", 1.0, 1)'], sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 422, sourceColumn: 2, sourceEndLine: 422, configCalls: ['set_flags(6)', 'set_resistors_load(470,0,0)']};
MERGE (n:KG {id: 'audioroute:device:m52_soundc_audio_device.device_add_mconfig/ay_45l/0'}) SET n:AudioRoute SET n += {output: '0', target: 'filtermix', gain: 1, input: 1, raw: 'm_ay_45L->add_route(0, "filtermix", 1.0, 1)'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l/callback0'}) SET n:Callback SET n += {signal: 'port_a_write_callback', operation: 'set', raw: 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', ownerTag: 'ay_45l', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 425, sourceColumn: 2, sourceEndLine: 425, targetClass: 'irem_audio_device', targetMethod: 'ay8910_45L_porta_w'};
...
MERGE (n:KG {id: 'audioroute:device:m52_soundc_audio_device.device_add_mconfig/msm1/0'}) SET n:AudioRoute SET n += {output: '0', target: 'filtermix', gain: 1, input: 2, raw: 'm_adpcm1->add_route(0, "filtermix", 1.0, 2)'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/msm1/callback0'}) SET n:Callback SET n += {signal: 'vck_callback', operation: 'set_inputline', raw: 'm_adpcm1->vck_callback().set_inputline(m_cpu, INPUT_LINE_NMI)', ownerTag: 'msm1', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 431, sourceColumn: 2, sourceEndLine: 431, inputLine: 'INPUT_LINE_NMI', targetTag: 'iremsound'};
...
MERGE (n:KG {id: 'audioroute:device:m52_soundc_audio_device.device_add_mconfig/filtermix/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: 'mono', gain: 1, raw: 'DISCRETE(config, "filtermix", m52_sound_c_discrete).add_route(ALL_OUTPUTS, "mono", 1.0)'};
...
MATCH (a:KG {id: 'device:m52_state.m52/maincpu'}), (b:KG {id: 'device:m52_state.m52/maincpu/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_state.m52/screen'}), (b:KG {id: 'device:m52_state.m52/screen/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_state.m52/maincpu/callback0'}), (b:KG {id: 'handler:m52_state.irq0_line_hold'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m52_state.m52/screen/callback0'}), (b:KG {id: 'handler:m52_state.screen_update'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/msm1'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/msm1/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback0'}), (b:KG {id: 'handler:m52_soundc_audio_device.m6803_port1_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback1'}), (b:KG {id: 'handler:m52_soundc_audio_device.m6803_port1_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback2'}), (b:KG {id: 'handler:m52_soundc_audio_device.m6803_port2_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback3'}), (b:KG {id: 'handler:m52_soundc_audio_device.m6803_port2_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback0'}), (b:KG {id: 'handler:irem_audio_device.soundlatch_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45m/callback1'}), (b:KG {id: 'handler:irem_audio_device.ay8910_45M_portb_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l/callback0'}), (b:KG {id: 'handler:irem_audio_device.ay8910_45L_porta_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/msm1/callback0'}), (b:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
