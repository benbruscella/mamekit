...
// generated 2026-08-22T05:52:35.637Z
...
MERGE (n:KG {id: 'machine:m52_state.m52'}) SET n:MachineConfig SET n += {cls: 'm52_state', name: 'm52', calls: [], resetHandlers: ['m52_state.machine_reset'], startHandlers: ['m52_state.video_start'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 945, sourceColumn: 1, sourceEndLine: 969};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback:iremsound:0'}) SET n:Callback SET n += {signal: 'in_p1_cb', operation: 'set', raw: 'cpu.in_p1_cb().set(FUNC(m52_soundc_audio_device::m6803_port1_r))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port1_r'};
MERGE (n:KG {id: 'handler:m52_soundc_audio_device.m6803_port1_r'}) SET n:Handler SET n += {method: 'm6803_port1_r', ownerClass: 'm52_soundc_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 149, sourceColumn: 1, sourceEndLine: 157, sourceParameters: '', sourceBody: '/* PSG 0 or 1? */
	...
	return 0xff;'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback:iremsound:1'}) SET n:Callback SET n += {signal: 'out_p1_cb', operation: 'set', raw: 'cpu.out_p1_cb().set(FUNC(m52_soundc_audio_device::m6803_port1_w))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port1_w'};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback:iremsound:2'}) SET n:Callback SET n += {signal: 'in_p2_cb', operation: 'set', raw: 'cpu.in_p2_cb().set(FUNC(m52_soundc_audio_device::m6803_port2_r))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port2_r'};
MERGE (n:KG {id: 'handler:m52_soundc_audio_device.m6803_port2_r'}) SET n:Handler SET n += {method: 'm6803_port2_r', ownerClass: 'm52_soundc_audio_device', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 160, sourceColumn: 1, sourceEndLine: 168, sourceParameters: '', sourceBody: '/*
	...
	//printf("port2 read\\n"); // used by 10yard
	return 0x0;'};
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/iremsound/callback:iremsound:3'}) SET n:Callback SET n += {signal: 'out_p2_cb', operation: 'set', raw: 'cpu.out_p2_cb().set(FUNC(m52_soundc_audio_device::m6803_port2_w))', ownerTag: 'iremsound', targetClass: 'm52_soundc_audio_device', targetMethod: 'm6803_port2_w'};
...
MERGE (n:KG {id: 'inputs:m52/DSW2/f4'}) SET n:PortField SET n += {kind: 'service', mask: 128, activeLow: true, defaultValue: 128};
