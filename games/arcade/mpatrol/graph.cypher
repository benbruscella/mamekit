...
// generated 2026-09-24T02:28:46.778Z
...
MERGE (n:KG {id: 'device:m52_state.m52/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, 18.432_MHz_XTAL / 6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &m52_state::main_map)', 'm_maincpu->set_addrmap(AS_IO, &m52_state::main_portmap)', 'm_maincpu->set_vblank_int("screen", FUNC(m52_state::irq0_line_hold))'], member: 'm_maincpu', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 948, sourceColumn: 2, sourceEndLine: 948};
...
MERGE (n:KG {id: 'device:m52_state.m52/sp_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'sp_palette', clock: null, config: ['PALETTE(config, m_sp_palette).set_entries(256, 32)'], member: 'm_sp_palette', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 954, sourceColumn: 2, sourceEndLine: 954};
MERGE (n:KG {id: 'device:m52_state.m52/sp_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'sp_gfxdecode', clock: null, config: ['GFXDECODE(config, m_sp_gfxdecode, m_sp_palette, gfx_m52_sp)'], member: 'm_sp_gfxdecode', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 955, sourceColumn: 2, sourceEndLine: 955, clockExpr: 'm_sp_palette'};
MERGE (n:KG {id: 'device:m52_state.m52/tx_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'tx_palette', clock: null, config: ['PALETTE(config, m_tx_palette).set_entries(512)'], member: 'm_tx_palette', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 957, sourceColumn: 2, sourceEndLine: 957, paletteEntries: 512};
MERGE (n:KG {id: 'device:m52_state.m52/tx_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'tx_gfxdecode', clock: null, config: ['GFXDECODE(config, m_tx_gfxdecode, m_tx_palette, gfx_m52_tx)'], member: 'm_tx_gfxdecode', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 958, sourceColumn: 2, sourceEndLine: 958, clockExpr: 'm_tx_palette'};
MERGE (n:KG {id: 'device:m52_state.m52/bg_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'bg_palette', clock: null, config: ['PALETTE(config, m_bg_palette).set_entries(3 * 4, 32)'], member: 'm_bg_palette', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 960, sourceColumn: 2, sourceEndLine: 960};
MERGE (n:KG {id: 'device:m52_state.m52/bg_gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'bg_gfxdecode', clock: null, config: ['GFXDECODE(config, m_bg_gfxdecode, m_bg_palette, gfx_m52_bg)'], member: 'm_bg_gfxdecode', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 961, sourceColumn: 2, sourceEndLine: 961, clockExpr: 'm_bg_palette'};
MERGE (n:KG {id: 'device:m52_state.m52/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(18.432_MHz_XTAL / 3, 384, 136, 376, 282, 22, 274)', 'm_screen->set_screen_update(FUNC(m52_state::screen_update))'], member: 'm_screen', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 963, sourceColumn: 2, sourceEndLine: 963, configCalls: ['set_raw(6144000,384,136,376,282,22,274)'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 136, 376, 282, 22, 274], screenRawExpr: ['18.432_MHz_XTAL / 3', '384', '136', '376', '282', '22', '274']};
...
MERGE (n:KG {id: 'device:m52_state.m52/irem_audio'}) SET n:Device SET n += {type: 'IREM_M52_SOUNDC_AUDIO', tag: 'irem_audio', clock: 0, config: ['IREM_M52_SOUNDC_AUDIO(config, "irem_audio")'], cls: 'm52_soundc_audio_device', clsHierarchy: ['m52_soundc_audio_device', 'irem_audio_device'], sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 968, sourceColumn: 2, sourceEndLine: 968, startHandler: 'irem_audio_device.device_start'};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45l', clock: 894886.25, config: ['AY8910(config, m_ay_45L, XTAL(3\'579\'545)/4)', 'm_ay_45L->set_flags(AY8910_SINGLE_OUTPUT | AY8910_DISCRETE_OUTPUT)', 'm_ay_45L->set_resistors_load(470, 0, 0)', 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', 'm_ay_45L->add_route(0, "filtermix", 1.0, 1)'], member: 'm_ay_45L', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 486, sourceColumn: 2, sourceEndLine: 486, configCalls: ['set_flags(6)', 'set_resistors_load(470,0,0)', 'add_route(0,"filtermix",1,1)']};
...
MATCH (a:KG {id: 'device:m52_state.m52/irem_audio'}), (b:KG {id: 'handler:irem_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
