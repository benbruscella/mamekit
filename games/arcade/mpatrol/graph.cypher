...
// generated 2026-09-17T07:12:09.461Z
...
MERGE (n:KG {id: 'device:m52_state.m52/tx_palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'tx_palette', clock: null, config: ['PALETTE(config, m_tx_palette).set_entries(512)'], member: 'm_tx_palette', sourceFile: 'src/mame/irem/m52.cpp', sourceLine: 957, sourceColumn: 2, sourceEndLine: 957};
...
MERGE (n:KG {id: 'device:m52_soundc_audio_device.device_add_mconfig/ay_45l'}) SET n:Device SET n += {type: 'AY8910', tag: 'ay_45l', clock: 894886.25, config: ['AY8910(config, m_ay_45L, XTAL(3\'579\'545)/4)', 'm_ay_45L->set_flags(AY8910_SINGLE_OUTPUT | AY8910_DISCRETE_OUTPUT)', 'm_ay_45L->set_resistors_load(470, 0, 0)', 'm_ay_45L->port_a_write_callback().set(FUNC(irem_audio_device::ay8910_45L_porta_w))', 'm_ay_45L->add_route(0, "filtermix", 1.0, 1)'], member: 'm_ay_45L', sourceFile: 'src/mame/irem/irem.cpp', sourceLine: 486, sourceColumn: 2, sourceEndLine: 486, configCalls: ['set_flags(6)', 'set_resistors_load(470,0,0)']};
