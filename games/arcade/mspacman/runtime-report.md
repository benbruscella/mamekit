# mspacman source-generation report

Playability: **executable**

Basis: **source-complete**

MAME source coverage: **117/148 nodes (79.1%)**
...
- `mainlatch.q_out_cb<6> -> pacman_state.coin_lockout_global_w` - src/mame/pacman/pacman.cpp:3815
