...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); hap (2 release notes); ClawGrip (1 release note); Darren Olafson (1 release note); Juan Romero (1 release note); Tafoid (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 103 commits by 22 commit authors, 2007–2025 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
