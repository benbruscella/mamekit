...
// generated 2026-09-11T11:44:38.492Z
...
MERGE (n:KG {id: 'device:mrdo_state.mrdo/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(mrdo_state::palette_init), 64*4 + 16*4, 256)'], member: 'm_palette', sourceFile: 'src/mame/universal/mrdo.cpp', sourceLine: 235, sourceColumn: 2, sourceEndLine: 235, clockExpr: 'FUNC(mrdo_state::palette_init)'};
