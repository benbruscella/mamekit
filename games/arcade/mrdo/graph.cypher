...
// generated 2026-09-24T02:28:47.246Z
...
MERGE (n:KG {id: 'device:mrdo_state.mrdo/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(19.6_MHz_XTAL/4, 312, 8, 248, 262, 32, 224)', 'screen.set_screen_update(FUNC(mrdo_state::screen_update_mrdo))', 'screen.set_palette(m_palette)'], sourceFile: 'src/mame/universal/mrdo.cpp', sourceLine: 229, sourceColumn: 2, sourceEndLine: 229, configCalls: ['set_raw(4900000,312,8,248,262,32,224)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [4900000, 312, 8, 248, 262, 32, 224], screenRawExpr: ['19.6_MHz_XTAL/4', '312', '8', '248', '262', '32', '224']};
...
MERGE (n:KG {id: 'device:mrdo_state.mrdo/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_mrdo)'], member: 'm_gfxdecode', sourceFile: 'src/mame/universal/mrdo.cpp', sourceLine: 234, sourceColumn: 2, sourceEndLine: 234, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:mrdo_state.mrdo/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(mrdo_state::palette_init), 64*4 + 16*4, 256)'], member: 'm_palette', sourceFile: 'src/mame/universal/mrdo.cpp', sourceLine: 235, sourceColumn: 2, sourceEndLine: 235, clockExpr: 'FUNC(mrdo_state::palette_init)', paletteEntries: 256};
