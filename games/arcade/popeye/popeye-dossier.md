...
- **Credited by MAMEDEV:** Couriersud (driver header); Nicola Salmoria (driver header); smf (driver header); Alex Jackson (2 release notes); hap (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 172 commits by 26 commit authors, 2007–2024 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
