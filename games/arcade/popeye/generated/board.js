        ...
        const methods = (() => {
            ...
            function method_draw_background(runtime, bitmap, cliprect) {
                ...
                for (let y = cliprect.min_y; ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((y) + (1))) {
                    let rovi = ((runtime.add((((runtime.calls["flip_screen"] ? runtime.calls["flip_screen"]() : runtime.macro("flip_screen"))) ? (((runtime.divide(y, 2)) ^ (255))) : (runtime.divide(y, 2))), runtime.readIndex(h_m_background_scroll, 1))) & 0xffff);
