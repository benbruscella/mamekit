...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            function method_popeye_videoram_w(runtime, offset, data) {
            ...
            function method_popeye_colorram_w(runtime, offset, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                runtime.writeIndex(runtime.writableMember("m_colorram"), offset, data);
                (__l["m_fg_tilemap.mark_tile_dirty"] ? __l["m_fg_tilemap.mark_tile_dirty"](offset) : (members.m_fg_tilemap) != null ? ((runtime.dereference(members.m_fg_tilemap)).mark_tile_dirty?.(offset) ?? 0) : (__l["mark_tile_dirty"]?.(offset) ?? 0));
            }
            function method_background_w(runtime, offset, data) {
                const members = runtime.members;
                let shift = (((((((offset) >>> (12)) & 1)) ? (4) : (0))) | 0);
            ...
            function method_protection_r(runtime, offset) {
                ...
                if (((Number(offset) === Number(0)) ? 1 : 0)) {
                    return (((((((members.m_prot1 ?? runtime.member("m_prot1"))) << ((members.m_prot_shift ?? runtime.member("m_prot_shift"))))) | (runtime.shiftRight((members.m_prot0 ?? runtime.member("m_prot0")), ((8) - ((members.m_prot_shift ?? runtime.member("m_prot_shift")))))))) & (255));
                }
                else {
                    return 0;
                }
            }
            function method_protection_w(runtime, offset, data) {
                const members = runtime.members;
                if (((Number(offset) === Number(0)) ? 1 : 0)) {
            ...
            function method_get_fg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let color = ((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (15))) | 0);
            ...
            function method_refresh_w(runtime, offset, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let nmi_enabled = ((((Number(((runtime.shiftRight(offset, 8)) & (1))) !== Number(0)) ? 1 : 0)) ? 1 : 0);
            ...
            function method_draw_background(runtime, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                ...
                for (let y = ((cliprect.min_y) | 0); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                    let rovi = ((runtime.add((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (((runtime.divide(y, 2)) ^ (255))) : (runtime.divide(y, 2))), runtime.readIndex(h_m_background_scroll, 1))) & 0xffff);
                    for (let x = ((cliprect.min_x) | 0); ((Number(x) <= Number(cliprect.max_x)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                        let roh = ((runtime.add(runtime.add(56, runtime.divide(x, 2)), runtime.readIndex(h_m_background_scroll, 0))) & 0xff);
                        let shift = (((((((rovi) >>> (7)) & 1)) ? (4) : (0))) | 0);
                        bitmap["pix="](y, x, ((runtime.shiftRight(runtime.readIndex((members.m_background_ram ?? runtime.member("m_background_ram")), (((((rovi) >>> (8)) & 1)) ? ((((((((rovi) >>> (1)) & ((1 << (6)) - 1))) << (6))) | ((((roh) >>> (2)) & ((1 << (6)) - 1))))) : (0))), shift)) & (15)));
                    }
                }
            }
            function method_screen_vblank(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                const h_m_background_scroll = members.m_background_scroll ?? runtime.member("m_background_scroll");
                const h_m_dmasource = members.m_dmasource ?? runtime.member("m_dmasource");
                if (state) {
                    (__l["std::copy_n"] ? __l["std::copy_n"]((__l["m_dmasource.target"] ? __l["m_dmasource.target"]() : (members.m_dmasource) != null ? (typeof (runtime.dereference(members.m_dmasource)).target === 'function' ? (runtime.dereference(members.m_dmasource)).target() : typeof (runtime.dereference(members.m_dmasource)).target === 'number' || typeof (runtime.dereference(members.m_dmasource)).target === 'boolean' ? (runtime.dereference(members.m_dmasource)).target : runtime.container(members.m_dmasource, "target")) : (__l["target"]?.() ?? 0)), (members.m_dmasource).length, (__l["m_sprite_ram.begin"] ? __l["m_sprite_ram.begin"]() : (members.m_sprite_ram) != null ? (typeof (runtime.dereference(members.m_sprite_ram)).begin === 'function' ? (runtime.dereference(members.m_sprite_ram)).begin() : typeof (runtime.dereference(members.m_sprite_ram)).begin === 'number' || typeof (runtime.dereference(members.m_sprite_ram)).begin === 'boolean' ? (runtime.dereference(members.m_sprite_ram)).begin : runtime.container(members.m_sprite_ram, "begin")) : (__l["begin"]?.() ?? 0))) : runtime.macro("std::copy_n", (__l["m_dmasource.target"] ? __l["m_dmasource.target"]() : (members.m_dmasource) != null ? (typeof (runtime.dereference(members.m_dmasource)).target === 'function' ? (runtime.dereference(members.m_dmasource)).target() : typeof (runtime.dereference(members.m_dmasource)).target === 'number' || typeof (runtime.dereference(members.m_dmasource)).target === 'boolean' ? (runtime.dereference(members.m_dmasource)).target : runtime.container(members.m_dmasource, "target")) : (__l["target"]?.() ?? 0)), (members.m_dmasource).length, (__l["m_sprite_ram.begin"] ? __l["m_sprite_ram.begin"]() : (members.m_sprite_ram) != null ? (typeof (runtime.dereference(members.m_sprite_ram)).begin === 'function' ? (runtime.dereference(members.m_sprite_ram)).begin() : typeof (runtime.dereference(members.m_sprite_ram)).begin === 'number' || typeof (runtime.dereference(members.m_sprite_ram)).begin === 'boolean' ? (runtime.dereference(members.m_sprite_ram)).begin : runtime.container(members.m_sprite_ram, "begin")) : (__l["begin"]?.() ?? 0))));
                    (__l["std::copy_n"] ? __l["std::copy_n"]((__l["m_dmasource.target"] ? __l["m_dmasource.target"]() : (members.m_dmasource) != null ? (typeof (runtime.dereference(members.m_dmasource)).target === 'function' ? (runtime.dereference(members.m_dmasource)).target() : typeof (runtime.dereference(members.m_dmasource)).target === 'number' || typeof (runtime.dereference(members.m_dmasource)).target === 'boolean' ? (runtime.dereference(members.m_dmasource)).target : runtime.container(members.m_dmasource, "target")) : (__l["target"]?.() ?? 0)), 3, h_m_background_scroll) : runtime.macro("std::copy_n", (__l["m_dmasource.target"] ? __l["m_dmasource.target"]() : (members.m_dmasource) != null ? (typeof (runtime.dereference(members.m_dmasource)).target === 'function' ? (runtime.dereference(members.m_dmasource)).target() : typeof (runtime.dereference(members.m_dmasource)).target === 'number' || typeof (runtime.dereference(members.m_dmasource)).target === 'boolean' ? (runtime.dereference(members.m_dmasource)).target : runtime.container(members.m_dmasource, "target")) : (__l["target"]?.() ?? 0)), 3, h_m_background_scroll));
            ...
            function method_popeye_portB_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                (__l["flip_screen_set"] ? __l["flip_screen_set"](((data) & (1))) : runtime.macro("flip_screen_set", ((data) & (1))));
                members.m_dswbit = ((runtime.shiftRight(((data) & (14)), 1)) & 0xff);
            }
            return {
...
defined.compiledHandlerLinks = ["begin", "flip_screen", "flip_screen_set", "m_dmasource.target", "m_fg_tilemap.mark_tile_dirty", "m_maincpu.set_input_line", "m_sprite_ram.begin", "mark_tile_dirty", "set", "std::copy_n", "target", "tileinfo.set"];
export default {
    machine: defined,
