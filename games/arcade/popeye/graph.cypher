...
// generated 2026-09-11T11:44:44.421Z
...
MERGE (n:KG {id: 'device:tnx1_state.config/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(tnx1_state::tnx1_palette), 16 + 16*2 + 8*4)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 558, sourceColumn: 2, sourceEndLine: 558, clockExpr: 'FUNC(tnx1_state::tnx1_palette)'};
