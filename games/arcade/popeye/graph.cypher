...
// generated 2026-09-24T02:29:32.577Z
...
MERGE (n:KG {id: 'handler:tnx1_state.background_w'}) SET n:Handler SET n += {method: 'background_w', ownerClass: 'tnx1_state', sourceFile: 'src/mame/nintendo/popeye_v.cpp', sourceLine: 199, sourceColumn: 1, sourceEndLine: 197, sourceParameters: 'offs_t offset, uint8_t data', sourceBody: 'int shift = BIT(offset, 12) ? 4 : 0;
	offset = BIT(offset, 0, 12);
	m_background_ram[offset] = (m_background_ram[offset] & ~(0x0f << shift)) | ((data & 0xf) << shift);', dispatchedFrom: 'tpp2_state'};
...
MERGE (n:KG {id: 'machine:tnx1_state.config'}) SET n:MachineConfig SET n += {cls: 'tnx1_state', name: 'config', calls: [], stateMembers: ['{"name":"m_background_scroll","bits":8,"arrayLength":3}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_palette_bank_cache","bits":8}', '{"name":"m_prot0","bits":8}', '{"name":"m_prot1","bits":8}', '{"name":"m_prot_shift","bits":8}', '{"name":"m_dswbit","bits":8}', '{"name":"m_nmi_enabled","bits":1}', '{"name":"m_field","bits":32,"signed":true}'], startHandlers: ['tnx1_state.video_start'], sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 538, sourceColumn: 1, sourceEndLine: 567};
...
MERGE (n:KG {id: 'handler:tnx1_state.draw_background'}) SET n:Handler SET n += {method: 'draw_background', ownerClass: 'tnx1_state', sourceFile: 'src/mame/nintendo/popeye_v.cpp', sourceLine: 384, sourceColumn: 1, sourceEndLine: 367, sourceParameters: 'bitmap_ind16& bitmap, const rectangle& cliprect', sourceBody: 'for (int y = cliprect.min_y; y <= cliprect.max_y; y++)
	{
...
MERGE (n:KG {id: 'device:tnx1_state.config/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_popeye)'], member: 'm_gfxdecode', sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 557, sourceColumn: 2, sourceEndLine: 557, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:tnx1_state.config/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(tnx1_state::tnx1_palette), 16 + 16*2 + 8*4)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 558, sourceColumn: 2, sourceEndLine: 558, clockExpr: 'FUNC(tnx1_state::tnx1_palette)', paletteEntries: 80};
...
MERGE (n:KG {id: 'machine:tpp2_state.config'}) SET n:MachineConfig SET n += {cls: 'tpp2_state', name: 'config', calls: ['tpp1_state::config'], stateMembers: ['{"name":"m_background_scroll","bits":8,"arrayLength":3}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_palette_bank_cache","bits":8}', '{"name":"m_prot0","bits":8}', '{"name":"m_prot1","bits":8}', '{"name":"m_prot_shift","bits":8}', '{"name":"m_dswbit","bits":8}', '{"name":"m_nmi_enabled","bits":1}', '{"name":"m_field","bits":32,"signed":true}', '{"name":"m_watchdog_enabled","bits":1}', '{"name":"m_watchdog_counter","bits":8}'], startHandlers: ['tnx1_state.video_start'], devicePatches: ['{"tag":"aysnd","config":["m_aysnd->reset_routes()","m_aysnd->set_flags(AY8910_RESISTOR_OUTPUT)","m_aysnd->set_resistors_load(2000.0, 2000.0, 2000.0)","m_aysnd->add_route(0, \\"snd_nl\\", 1.0, 0)","m_aysnd->add_route(1, \\"snd_nl\\", 1.0, 1)","m_aysnd->add_route(2, \\"snd_nl\\", 1.0, 2)"]}'], sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 569, sourceColumn: 1, sourceEndLine: 591};
...
MERGE (n:KG {id: 'inputs:popeye/P1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2'}) SET n:Port SET n += {tag: 'P2', modify: false};
MERGE (n:KG {id: 'inputs:popeye/P2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/P2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM'}) SET n:Port SET n += {tag: 'SYSTEM', modify: false};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(tpp1_state::pop_field_r))'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_SERVICE1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/SYSTEM/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/DSW0'}) SET n:Port SET n += {tag: 'DSW0', modify: false};
MERGE (n:KG {id: 'inputs:popeye/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 15, modifiers: ['PORT_DIPLOCATION("SW1:1,2,3,4")'], name: 'Coinage', defaultValue: 15, location: 'SW1:1,2,3,4', settings: ['8=6C 1C', '5=5C 1C', '9=4C 1C', '10=3C 1C', '13=2C 1C', '15=1C 1C', '14=1C 2C', '3=1C 3C', '0=Free Play']};
MERGE (n:KG {id: 'inputs:popeye/DSW0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_UNUSED', defaultValue: 16};
...
MERGE (n:KG {id: 'inputs:popeye/DSW0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_MEMBER(FUNC(tnx1_state::dsw1_read))'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:popeye/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:popeye/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SW2:1,2")'], name: 'Lives', defaultValue: 1, location: 'SW2:1,2', settings: ['3=1', '2=2', '1=3', '0=4']};
MERGE (n:KG {id: 'inputs:popeye/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION("SW2:3,4")'], name: 'Difficulty', defaultValue: 12, location: 'SW2:3,4', settings: ['12=Easy', '8=Medium', '4=Hard', '0=Hardest']};
MERGE (n:KG {id: 'inputs:popeye/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, modifiers: ['PORT_DIPLOCATION("SW2:5,6")'], name: 'Bonus Life', defaultValue: 48, location: 'SW2:5,6', settings: ['48=40000', '32=60000', '16=80000', '0=None']};
MERGE (n:KG {id: 'inputs:popeye/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 64, modifiers: ['PORT_DIPLOCATION("SW2:7")'], name: 'Demo Sounds', defaultValue: 0, location: 'SW2:7', settings: ['64=Off', '0=On']};
MERGE (n:KG {id: 'inputs:popeye/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_DIPLOCATION("SW2:8")'], name: 'Cabinet', defaultValue: 0, location: 'SW2:8', settings: ['0=Upright', '128=Cocktail']};
MERGE (n:KG {id: 'inputs:popeye/MCONF'}) SET n:Port SET n += {tag: 'MCONF', modify: false};
MERGE (n:KG {id: 'inputs:popeye/MCONF/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(tnx1_state::change_il), 0)'], name: 'Interlace mode', defaultValue: 0, settings: ['0=False Progressive', '1=Interlaced (scanline skip)', '2=Interlaced (bitmap)']};
...
MERGE (n:KG {id: 'device:tnx1_state.config/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(tnx1_state::tnx1_palette), 16 + 16*2 + 8*4)', ownerTag: 'palette', targetClass: 'tnx1_state', targetMethod: 'tnx1_palette', entries: 80, sourceFile: 'src/mame/nintendo/popeye.cpp', sourceLine: 558};
MERGE (n:KG {id: 'handler:tnx1_state.tnx1_palette'}) SET n:Handler SET n += {method: 'tnx1_palette', ownerClass: 'tnx1_state', sourceFile: 'src/mame/nintendo/popeye_v.cpp', sourceLine: 139, sourceColumn: 1, sourceEndLine: 151, sourceParameters: 'palette_device &palette', sourceBody: '// Two of the PROM address pins are tied together and one is not connected...
...
MATCH (a:KG {id: 'machine:tpp2_state.config'}), (b:KG {id: 'machine:tnx1_state.config'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:tnx1_state.config/palette'}), (b:KG {id: 'device:tnx1_state.config/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:tnx1_state.config/palette/callback:palette_init'}), (b:KG {id: 'handler:tnx1_state.tnx1_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:tnx1_state.tnx1_palette'}), (b:KG {id: 'handler:tnx1_state.update_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
