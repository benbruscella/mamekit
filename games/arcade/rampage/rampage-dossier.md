...
- **Sound:** dac × 1 @ 8.000 MHz
- **Screen:** 256×480 @ 30.00 Hz
...
| Up | joystick up | `MONO.IP4` | 0x1 |
| Right | joystick right | `MONO.IP4` | 0x2 |
| Down | joystick down | `MONO.IP4` | 0x4 |
| Left | joystick left | `MONO.IP4` | 0x8 |
| Space / X | button1 | `MONO.IP4` | 0x10 |
| Z | button2 | `MONO.IP4` | 0x20 |
