...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_rampage_op6_w(runtime: any, data: any) {
  ...
  function method_mcr_paletteram9_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_mcr_set_color(runtime: any, index: any, data: any) {
    const members = runtime.members;
  ...
  function method_mcr3_videoram_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_mcrmono_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let data: any = ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), ((tile_index) * (2)))) | (((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), runtime.add(((tile_index) * (2)), 1))) << (8))));
    let code: any = ((((data) & (1023))) | (((((data) >>> (4))) & (1024))));
    let color: any = ((((((data) >>> (12))) & (3))) ^ (3));
  ...
  function method_mcr_interrupt(runtime: any, param: any) {
    const members = runtime.members;
  ...
  function method_screen_update_mcr3(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
  ...
  function method_mcr3_update_sprites(runtime: any, screen: any, bitmap: any, cliprect: any, color_mask: any, code_xor: any, dx: any, dy: any, interlaced: any) {
    const members = runtime.members;
    ...
    for (let offs: any = (((members.m_spriteram).length) - (4)); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((offs) - (4))) {
      ...
      let flags: any = runtime.readIndex(h_m_spriteram, ((offs) + (1)));
      let code: any = runtime.add(runtime.readIndex(h_m_spriteram, ((offs) + (2))), ((256) * (((((flags) >>> (3))) & (1)))));
      let color: any = (((~flags)) & (color_mask));
      let flipx: any = ((flags) & (16));
      let flipy: any = ((flags) & (32));
      let sx: any = ((((runtime.readIndex(h_m_spriteram, ((offs) + (3)))) - (3))) * (2));
      let sy: any = ((241) - (runtime.readIndex(h_m_spriteram, offs)));
