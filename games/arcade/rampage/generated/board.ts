...
defined.compiledHandlers = {
  ...
  function method_rampage_op6_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_sounds_good.reset_write"] ? __l["m_sounds_good.reset_write"](((runtime.shiftRight((~data), 5)) & (1))) : (members.m_sounds_good) != null ? ((runtime.dereference(members.m_sounds_good)).reset_write?.(((runtime.shiftRight((~data), 5)) & (1))) ?? 0) : 0);
  ...
  function method_mcrmono_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let data: any = ((((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), ((tile_index) * (2)))) | (((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), runtime.add(((tile_index) * (2)), 1))) << (8))))) | 0);
    let code: any = ((((((data) & (1023))) | (((runtime.shiftRight(data, 4)) & (1024))))) | 0);
    let color: any = ((((((runtime.shiftRight(data, 12)) & (3))) ^ (3))) | 0);
    (__l["tileinfo.set"] ? __l["tileinfo.set"](0, code, color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(data, 10)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(data, 10)))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, code, color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(data, 10)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(data, 10)))) ?? 0) : (__l["set"]?.(0, code, color, (__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(data, 10)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(data, 10)))) ?? 0));
  }
  ...
  function method_screen_update_mcr3(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
