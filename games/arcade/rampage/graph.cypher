...
// generated 2026-09-24T02:29:40.736Z
...
MERGE (n:KG {id: 'game:rampage'}) SET n:Game SET n += {name: 'rampage', year: '1986', company: 'Bally Midway', fullname: 'Rampage (Rev 3, 8/27/86)', monitor: 'ROT0', cls: 'mcr3_state', init: 'init_rampage', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/bally/mcr3.cpp', sourceLine: 1694, sourceColumn: 1, sourceEndLine: 1694, installedHandlers: ['{"space":"AS_IO","kind":"read","target":"m_maincpu","start":4,"end":4,"className":"mcr3_state","method":"rampage_ip4_r","cpu":"maincpu"}', '{"space":"AS_IO","kind":"write","target":"m_maincpu","start":6,"end":6,"className":"mcr3_state","method":"rampage_op6_w","cpu":"maincpu"}']};
...
MERGE (n:KG {id: 'handler:midway_sounds_good_device.read'}) SET n:Handler SET n += {method: 'read', ownerClass: 'midway_sounds_good_device', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 498, sourceColumn: 1, sourceEndLine: 501, sourceParameters: '', sourceBody: 'return m_status;'};
...
MERGE (n:KG {id: 'handler:midway_sounds_good_device.reset_write'}) SET n:Handler SET n += {method: 'reset_write', ownerClass: 'midway_sounds_good_device', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 519, sourceColumn: 1, sourceEndLine: 523, sourceParameters: 'int state', sourceBody: '//if (state) osd_printf_debug("SG Reset\\n");
...
MERGE (n:KG {id: 'device:mcr3_state.mcrmono/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(64)'], member: 'm_palette', sourceFile: 'src/mame/bally/mcr3.cpp', sourceLine: 1115, sourceColumn: 2, sourceEndLine: 1115, paletteEntries: 64};
MERGE (n:KG {id: 'machine:mcr3_state.mono_sg'}) SET n:MachineConfig SET n += {cls: 'mcr3_state', name: 'mono_sg', calls: ['mcrmono'], stateMembers: ['{"name":"m_mcr12_sprite_xoffs_flip","bits":8,"signed":true}', '{"name":"m_input_mux","bits":8}', '{"name":"m_last_op4","bits":8}', '{"name":"m_mcr_cocktail_flip","bits":8}', '{"name":"m_mcr_cpu_board","bits":32}', '{"name":"m_mcr_sprite_board","bits":32}', '{"name":"m_mcr12_sprite_xoffs","bits":8,"signed":true}', '{"name":"m_latched_input","bits":8}', '{"name":"m_spyhunt_sprite_color_mask","bits":8}', '{"name":"m_spyhunt_scroll_offset","bits":16,"signed":true}', '{"name":"m_spyhunt_scrollx","bits":16,"signed":true}', '{"name":"m_spyhunt_scrolly","bits":16,"signed":true}'], resetHandlers: ['mcr_state.machine_reset'], startHandlers: ['mcr3_state.video_start'], sourceFile: 'src/mame/bally/mcr3.cpp', sourceLine: 1146, sourceColumn: 1, sourceEndLine: 1154};
MERGE (n:KG {id: 'device:mcr3_state.mono_sg/sg'}) SET n:Device SET n += {type: 'MIDWAY_SOUNDS_GOOD', tag: 'sg', clock: 16000000, config: ['MIDWAY_SOUNDS_GOOD(config, m_sounds_good)', 'm_sounds_good->add_route(ALL_OUTPUTS, "speaker", 0.75, 0)', 'm_sounds_good->add_route(ALL_OUTPUTS, "speaker", 0.75, 1)'], member: 'm_sounds_good', cls: 'midway_sounds_good_device', clsHierarchy: ['midway_sounds_good_device'], sourceFile: 'src/mame/bally/mcr3.cpp', sourceLine: 1151, sourceColumn: 2, sourceEndLine: 1151, startHandler: 'midway_sounds_good_device.device_start'};
...
MERGE (n:KG {id: 'machine:midway_sounds_good_device.device_add_mconfig'}) SET n:MachineConfig SET n += {cls: 'midway_sounds_good_device', name: 'device_add_mconfig', calls: [], stateMembers: ['{"name":"m_status","bits":8}', '{"name":"m_dacval","bits":16}'], sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 605, sourceColumn: 1, sourceEndLine: 629};
MERGE (n:KG {id: 'device:midway_sounds_good_device.device_add_mconfig/cpu'}) SET n:Device SET n += {type: 'M68000', tag: 'cpu', clock: 8000000, config: ['M68000(config, m_cpu, DERIVED_CLOCK(1, 2))', 'm_cpu->set_addrmap(AS_PROGRAM, &midway_sounds_good_device::soundsgood_map)'], member: 'm_cpu', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 607, sourceColumn: 2, sourceEndLine: 607};
MERGE (n:KG {id: 'device:midway_sounds_good_device.device_add_mconfig/pia'}) SET n:Device SET n += {type: 'PIA6821', tag: 'pia', clock: null, config: ['PIA6821(config, m_pia)', 'm_pia->writepa_handler().set(FUNC(midway_sounds_good_device::porta_w))', 'm_pia->writepb_handler().set(FUNC(midway_sounds_good_device::portb_w))', 'm_pia->irqa_handler().set(FUNC(midway_sounds_good_device::irq_w))', 'm_pia->irqb_handler().set(FUNC(midway_sounds_good_device::irq_w))'], member: 'm_pia', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 610, sourceColumn: 2, sourceEndLine: 610};
...
MERGE (n:KG {id: 'device:midway_sounds_good_device.device_add_mconfig/dac'}) SET n:Device SET n += {type: 'AD7533', tag: 'dac', clock: null, config: ['AD7533(config, m_dac)', 'm_dac->add_route(ALL_OUTPUTS, m_dac_filter[0], 1.0)'], member: 'm_dac', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 616, sourceColumn: 2, sourceEndLine: 616};
...
MERGE (n:KG {id: 'audioroute:device:midway_sounds_good_device.device_add_mconfig/dac_filter2/0'}) SET n:AudioRoute SET n += {output: 'ALL_OUTPUTS', target: '^', gain: 1, raw: 'm_dac_filter[2]->add_route(ALL_OUTPUTS, *this, 1.0)', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 621, sourceColumn: 2, sourceEndLine: 621};
...
MERGE (n:KG {id: 'handler:midway_sounds_good_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'midway_sounds_good_device', sourceFile: 'src/mame/bally/midway_sound.cpp', sourceLine: 636, sourceColumn: 1, sourceEndLine: 640, sourceParameters: '', sourceBody: 'save_item(NAME(m_status));
...
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_COIN1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_COIN2', defaultValue: 2};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 12, activeLow: true, type: 'IPT_UNUSED', defaultValue: 12};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_TILT', defaultValue: 16};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f4'}) SET n:PortField SET n += {kind: 'service', mask: 32, activeLow: true, defaultValue: 32};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_SERVICE1', defaultValue: 64};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_UNUSED', defaultValue: 128};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1'}) SET n:Port SET n += {tag: 'MONO.IP1', modify: false};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_PLAYER(1)'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(1)'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_PLAYER(1)'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(1)'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(1)'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(1)'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED', defaultValue: 192};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2'}) SET n:Port SET n += {tag: 'MONO.IP2', modify: false};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(2)'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(2)'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 192, activeLow: true, type: 'IPT_UNUSED', defaultValue: 192};
...
MERGE (n:KG {id: 'inputs:rampage/MONO.IP3/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_CODE(KEYCODE_F1)'], name: 'Rack Advance (Cheat)', defaultValue: 128, settings: ['128=Off', '0=On']};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4'}) SET n:Port SET n += {tag: 'MONO.IP4', modify: false};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_PLAYER(3)'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(3)'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_PLAYER(3)'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_PLAYER(3)'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(3)'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_BUTTON2', modifiers: ['PORT_PLAYER(3)'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNUSED', defaultValue: 64};
MERGE (n:KG {id: 'inputs:rampage/MONO.IP4/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_CUSTOM', defaultValue: 0};
...
MATCH (a:KG {id: 'machine:mcr3_state.mono_sg'}), (b:KG {id: 'machine:mcr3_state.mcrmono'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'handler:mcr3_state.rampage_ip4_r'}), (b:KG {id: 'handler:midway_sounds_good_device.read'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_sounds_good.read'};
MATCH (a:KG {id: 'handler:mcr3_state.rampage_op6_w'}), (b:KG {id: 'handler:midway_sounds_good_device.reset_write'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_sounds_good.reset_write'};
MATCH (a:KG {id: 'handler:mcr3_state.rampage_op6_w'}), (b:KG {id: 'handler:midway_sounds_good_device.write'}) MERGE (a)-[r:CALLS_HANDLER]->(b) SET r += {finder: 'm_sounds_good.write'};
...
MATCH (a:KG {id: 'device:mcr3_state.mono_sg/sg'}), (b:KG {id: 'handler:midway_sounds_good_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:midway_sounds_good_device.device_add_mconfig/dac_filter2'}), (b:KG {id: 'audioroute:device:midway_sounds_good_device.device_add_mconfig/dac_filter2/0'}) MERGE (a)-[r:HAS_AUDIO_ROUTE]->(b);
