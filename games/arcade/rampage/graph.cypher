...
// generated 2026-09-17T07:12:25.625Z
...
MERGE (n:KG {id: 'device:mcr3_state.mcrmono/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(64)'], member: 'm_palette', sourceFile: 'src/mame/bally/mcr3.cpp', sourceLine: 1115, sourceColumn: 2, sourceEndLine: 1115};
