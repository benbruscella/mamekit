...
// generated 2026-09-24T02:28:12.979Z
...
MERGE (n:KG {id: 'machine:galaxian_state.jumpbugbrf'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'jumpbugbrf', calls: ['galaxian_base'], stateMembers: ['{"name":"m_bullets_base","bits":32,"signed":true}', '{"name":"m_sprites_base","bits":32,"signed":true}', '{"name":"m_numspritegens","bits":32,"signed":true}', '{"name":"m_protection_state","bits":16}', '{"name":"m_protection_result","bits":8}', '{"name":"m_konami_sound_control","bits":8}', '{"name":"m_irq_enabled","bits":8}', '{"name":"m_frogger_adjust","bits":1}', '{"name":"m_x_scale","bits":8}', '{"name":"m_h0_start","bits":8}', '{"name":"m_sfx_adjust","bits":1}', '{"name":"m_flipscreen_x","bits":8}', '{"name":"m_flipscreen_y","bits":8}', '{"name":"m_background_enable","bits":8}', '{"name":"m_background_red","bits":8}', '{"name":"m_background_green","bits":8}', '{"name":"m_background_blue","bits":8}', '{"name":"m_star_rng_origin","bits":32}', '{"name":"m_star_rng_origin_frame","bits":32}', '{"name":"m_stars_enabled","bits":8}', '{"name":"m_stars_blink_state","bits":8}', '{"name":"m_gfxbank","bits":8,"arrayLength":5}'], startHandlers: ['galaxian_state.video_start'], removedDevices: ['watchdog'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7959, sourceColumn: 1, sourceEndLine: 7967};
MERGE (n:KG {id: 'machine:galaxian_state.jumpbug'}) SET n:MachineConfig SET n += {cls: 'galaxian_state', name: 'jumpbug', calls: ['jumpbugbrf'], stateMembers: ['{"name":"m_bullets_base","bits":32,"signed":true}', '{"name":"m_sprites_base","bits":32,"signed":true}', '{"name":"m_numspritegens","bits":32,"signed":true}', '{"name":"m_protection_state","bits":16}', '{"name":"m_protection_result","bits":8}', '{"name":"m_konami_sound_control","bits":8}', '{"name":"m_irq_enabled","bits":8}', '{"name":"m_frogger_adjust","bits":1}', '{"name":"m_x_scale","bits":8}', '{"name":"m_h0_start","bits":8}', '{"name":"m_sfx_adjust","bits":1}', '{"name":"m_flipscreen_x","bits":8}', '{"name":"m_flipscreen_y","bits":8}', '{"name":"m_background_enable","bits":8}', '{"name":"m_background_red","bits":8}', '{"name":"m_background_green","bits":8}', '{"name":"m_background_blue","bits":8}', '{"name":"m_star_rng_origin","bits":32}', '{"name":"m_star_rng_origin_frame","bits":32}', '{"name":"m_stars_enabled","bits":8}', '{"name":"m_stars_blink_state","bits":8}', '{"name":"m_gfxbank","bits":8,"arrayLength":5}'], startHandlers: ['galaxian_state.video_start'], sourceFile: 'src/mame/galaxian/galaxian.cpp', sourceLine: 7969, sourceColumn: 1, sourceEndLine: 7978};
...
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:jumpbug/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:jumpbug/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 240, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
...
MATCH (a:KG {id: 'machine:galaxian_state.jumpbug'}), (b:KG {id: 'machine:galaxian_state.jumpbugbrf'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'machine:galaxian_state.jumpbugbrf'}), (b:KG {id: 'machine:galaxian_state.galaxian_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
