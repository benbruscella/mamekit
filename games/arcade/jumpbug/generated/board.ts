...
defined.compiledHandlers = {
  ...
  function method_galaxian_gfxbank_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_jumpbug_protection_r(runtime: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_jumpbug_draw_background(runtime: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["bitmap.fill"] ? __l["bitmap.fill"]((((members.m_background_enable ?? runtime.member("m_background_enable"))) ? (4283826176) : ((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")))), cliprect) : (bitmap) != null ? ((runtime.dereference(bitmap)).fill?.((((members.m_background_enable ?? runtime.member("m_background_enable"))) ? (4283826176) : ((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")))), cliprect) ?? 0) : (__l["fill"]?.((((members.m_background_enable ?? runtime.member("m_background_enable"))) ? (4283826176) : ((__l["rgb_t::black"] ? __l["rgb_t::black"]() : runtime.macro("rgb_t::black")))), cliprect) ?? 0));
    (runtime.overrides["stars_update_origin"] ? runtime.overrides["stars_update_origin"]() : method_stars_update_origin(runtime));
...
defined.compiledHandlerLinks = ["bitmap.fill","fill","m_bg_tilemap.mark_all_dirty","m_bg_tilemap.mark_tile_dirty","m_bg_tilemap.set_flip","m_bg_tilemap.set_scrollx","m_bg_tilemap.set_scrolly","m_draw_bullet_ptr","m_maincpu.set_input_line","m_screen.frame_number","m_screen.hpos","m_screen.update_partial","m_screen.vpos","mark_all_dirty","mark_tile_dirty","rgb_t::black","screen.visible_area","set_flip","set_scrollx","set_scrolly","visible_area"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
