...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_galaxian_gfxbank_w(runtime, offset, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_jumpbug_protection_r(runtime, offset) {
                const members = runtime.members;
                switch (offset) {
                    case 276:
                        {
            ...
            function method_jumpbug_draw_background(runtime, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
