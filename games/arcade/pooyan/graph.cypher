...
// generated 2026-08-22T05:52:39.552Z
...
MERGE (n:KG {id: 'machine:pooyan_state.pooyan'}) SET n:MachineConfig SET n += {cls: 'pooyan_state', name: 'pooyan', calls: [], startHandlers: ['pooyan_state.video_start'], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 421, sourceColumn: 1, sourceEndLine: 450};
