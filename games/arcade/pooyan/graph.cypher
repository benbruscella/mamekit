...
// generated 2026-07-30T09:34:21.984Z
...
MERGE (n:KG {id: 'machine:pooyan_state.pooyan'}) SET n:MachineConfig SET n += {cls: 'pooyan_state', name: 'pooyan', calls: [], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 421, sourceColumn: 1, sourceEndLine: 450};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback1'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<1>().set("timeplt_audio", FUNC(timeplt_audio_device::sh_irqtrigger_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 429, sourceColumn: 2, sourceEndLine: 429, slot: '1', targetTag: 'timeplt_audio', targetClass: 'timeplt_audio_device', targetMethod: 'sh_irqtrigger_w'};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback2'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<2>().set("timeplt_audio", FUNC(timeplt_audio_device::mute_w))', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 430, sourceColumn: 2, sourceEndLine: 430, slot: '2', targetTag: 'timeplt_audio', targetClass: 'timeplt_audio_device', targetMethod: 'mute_w'};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback5'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set_nop', raw: 'mainlatch.q_out_cb<5>().set_nop()', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 433, sourceColumn: 2, sourceEndLine: 433, slot: '5'};
MERGE (n:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback6'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'mainlatch.q_out_cb<7>().set(FUNC(pooyan_state::flip_screen_set)).invert()', ownerTag: 'mainlatch', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 434, sourceColumn: 2, sourceEndLine: 434, slot: '7', transforms: ['invert'], targetClass: 'pooyan_state', targetMethod: 'flip_screen_set'};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/screen/callback0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'screen.set_screen_update(FUNC(pooyan_state::screen_update))', ownerTag: 'screen', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 441, sourceColumn: 2, sourceEndLine: 441, targetClass: 'pooyan_state', targetMethod: 'screen_update'};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_pooyan)'], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 445, sourceColumn: 2, sourceEndLine: 445, clockExpr: 'm_palette, gfx_pooyan'};
MERGE (n:KG {id: 'device:pooyan_state.pooyan/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(pooyan_state::palette), 16*16+16*16, 32)'], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 446, sourceColumn: 2, sourceEndLine: 446, clockExpr: 'FUNC(pooyan_state::palette), 16*16+16*16, 32'};
MERGE (n:KG {id: 'device:pooyan_state.pooyan/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, "timeplt_audio")'], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 449, sourceColumn: 2, sourceEndLine: 449};
...
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch'}), (b:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/screen'}), (b:KG {id: 'device:pooyan_state.pooyan/screen/callback0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/screen'}), (b:KG {id: 'device:pooyan_state.pooyan/screen/callback1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback0'}), (b:KG {id: 'handler:pooyan_state.irq_enable_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback1'}), (b:KG {id: 'handler:timeplt_audio_device.sh_irqtrigger_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback2'}), (b:KG {id: 'handler:timeplt_audio_device.mute_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback3'}), (b:KG {id: 'handler:pooyan_state.coin_counter_w_0'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback4'}), (b:KG {id: 'handler:pooyan_state.coin_counter_w_1'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/mainlatch/callback6'}), (b:KG {id: 'handler:pooyan_state.flip_screen_set'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/screen/callback0'}), (b:KG {id: 'handler:pooyan_state.screen_update'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:pooyan_state.pooyan/screen/callback1'}), (b:KG {id: 'handler:pooyan_state.vblank_irq'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
