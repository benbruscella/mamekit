...
// generated 2026-09-24T02:29:30.170Z
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, 18.432_MHz_XTAL / 3 / 2)', 'm_maincpu->set_addrmap(AS_PROGRAM, &pooyan_state::main_map)'], member: 'm_maincpu', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 424, sourceColumn: 2, sourceEndLine: 424};
...
MERGE (n:KG {id: 'device:pooyan_state.pooyan/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_pooyan)'], member: 'm_gfxdecode', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 445, sourceColumn: 2, sourceEndLine: 445, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:pooyan_state.pooyan/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(pooyan_state::palette), 16*16+16*16, 32)'], member: 'm_palette', sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 446, sourceColumn: 2, sourceEndLine: 446, clockExpr: 'FUNC(pooyan_state::palette)', paletteEntries: 32};
MERGE (n:KG {id: 'device:pooyan_state.pooyan/timeplt_audio'}) SET n:Device SET n += {type: 'TIMEPLT_AUDIO', tag: 'timeplt_audio', clock: 14318181, config: ['TIMEPLT_AUDIO(config, "timeplt_audio")'], cls: 'timeplt_audio_device', clsHierarchy: ['timeplt_audio_device'], sourceFile: 'src/mame/konami/pooyan.cpp', sourceLine: 449, sourceColumn: 2, sourceEndLine: 449, startHandler: 'timeplt_audio_device.device_start'};
...
MATCH (a:KG {id: 'device:pooyan_state.pooyan/timeplt_audio'}), (b:KG {id: 'handler:timeplt_audio_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
