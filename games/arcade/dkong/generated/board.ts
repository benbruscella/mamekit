...
defined.compiledHandlers = {
  ...
  function method_dkong_voice_status_r(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_dkong_voice_w(runtime: any, data: any): any {
    const members = runtime.members;
...
defined.compiledHandlerLinks = ["m_bg_tilemap.mark_all_dirty","m_bg_tilemap.mark_tile_dirty","m_gfxdecode.gfx","m_maincpu.set_input_line","m_soundcpu.set_input_line","mark_all_dirty","mark_tile_dirty"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
