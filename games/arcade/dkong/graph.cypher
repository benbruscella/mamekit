...
// generated 2026-09-24T02:26:54.245Z
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(dkong_state::dkong2b_palette), DK2B_PALETTE_LENGTH)', 'm_palette->set_entries(DK2B_PALETTE_LENGTH)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1798, sourceColumn: 2, sourceEndLine: 1798, clockExpr: 'FUNC(dkong_state::dkong2b_palette)', paletteEntries: 521};
MERGE (n:KG {id: 'machine:dkong_state.dkong2b'}) SET n:MachineConfig SET n += {cls: 'dkong_state', name: 'dkong2b', calls: ['dkong_base', 'dkong2b_audio'], stateMembers: ['{"name":"m_hardware_type","bits":8}', '{"name":"m_nmi_mask","bits":8}', '{"name":"m_vidhw","bits":8,"signed":true}', '{"name":"m_gfx3_len","bits":32,"signed":true}', '{"name":"m_sig30Hz","bits":8}', '{"name":"m_lfsr_5I","bits":8}', '{"name":"m_grid_sig","bits":8}', '{"name":"m_rflip_sig","bits":8}', '{"name":"m_star_ff","bits":8}', '{"name":"m_blue_level","bits":8}', '{"name":"m_decrypt_counter","bits":8,"signed":true}', '{"name":"m_protect_type","bits":8}', '{"name":"m_hunchloopback","bits":8}', '{"name":"m_prot_cnt","bits":8}', '{"name":"m_main_fo","bits":8}', '{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_grid_on","bits":8}', '{"name":"m_grid_col","bits":16}', '{"name":"m_sprite_bank","bits":8}', '{"name":"m_dma_latch","bits":8}', '{"name":"m_flip","bits":8}', '{"name":"m_pixelcnt","bits":32,"signed":true}', '{"name":"m_counter","bits":32,"signed":true}', '{"name":"m_rev_map","bits":16,"signed":true,"arrayLength":512}'], devicePatches: ['{"tag":"palette","config":["m_palette->set_entries(DK2B_PALETTE_LENGTH)"]}'], sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1846, sourceColumn: 1, sourceEndLine: 1858};
MERGE (n:KG {id: 'device:dkong_state.dkong2b/watchdog'}) SET n:Device SET n += {type: 'WATCHDOG_TIMER', tag: 'watchdog', clock: null, config: ['WATCHDOG_TIMER(config, m_watchdog)'], member: 'm_watchdog', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1857, sourceColumn: 2, sourceEndLine: 1857};
MERGE (n:KG {id: 'machine:dkong_state.dkong2b_audio'}) SET n:MachineConfig SET n += {cls: 'dkong_state', name: 'dkong2b_audio', calls: [], stateMembers: ['{"name":"m_hardware_type","bits":8}', '{"name":"m_nmi_mask","bits":8}', '{"name":"m_vidhw","bits":8,"signed":true}', '{"name":"m_gfx3_len","bits":32,"signed":true}', '{"name":"m_sig30Hz","bits":8}', '{"name":"m_lfsr_5I","bits":8}', '{"name":"m_grid_sig","bits":8}', '{"name":"m_rflip_sig","bits":8}', '{"name":"m_star_ff","bits":8}', '{"name":"m_blue_level","bits":8}', '{"name":"m_decrypt_counter","bits":8,"signed":true}', '{"name":"m_protect_type","bits":8}', '{"name":"m_hunchloopback","bits":8}', '{"name":"m_prot_cnt","bits":8}', '{"name":"m_main_fo","bits":8}', '{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_grid_on","bits":8}', '{"name":"m_grid_col","bits":16}', '{"name":"m_sprite_bank","bits":8}', '{"name":"m_dma_latch","bits":8}', '{"name":"m_flip","bits":8}', '{"name":"m_pixelcnt","bits":32,"signed":true}', '{"name":"m_counter","bits":32,"signed":true}', '{"name":"m_rev_map","bits":16,"signed":true,"arrayLength":512}'], sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1315, sourceColumn: 1, sourceEndLine: 1354};
MERGE (n:KG {id: 'device:dkong_state.dkong2b_audio/ls175.3d'}) SET n:Device SET n += {type: 'LATCH8', tag: 'ls175.3d', clock: null, config: ['LATCH8(config, m_ls175_3d)', 'm_ls175_3d->set_maskout(0xf0)', 'm_ls175_3d->set_xorvalue(0x0f)'], member: 'm_ls175_3d', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1318, sourceColumn: 2, sourceEndLine: 1318, configCalls: ['set_maskout(240)', 'set_xorvalue(15)']};
MERGE (n:KG {id: 'device:dkong_state.dkong2b_audio/ls259.6h'}) SET n:Device SET n += {type: 'LATCH8', tag: 'ls259.6h', clock: null, config: ['LATCH8(config, m_dev_6h)', 'm_dev_6h->write_cb<0>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND0_INP>))', 'm_dev_6h->write_cb<1>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND1_INP>))', 'm_dev_6h->write_cb<2>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND2_INP>))', 'm_dev_6h->write_cb<6>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND6_INP>))', 'm_dev_6h->write_cb<7>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND7_INP>))'], member: 'm_dev_6h', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1322, sourceColumn: 2, sourceEndLine: 1322};
...
MERGE (n:KG {id: 'device:dkong_state.dkong2b_audio/discrete'}) SET n:Device SET n += {type: 'DISCRETE', tag: 'discrete', clock: null, config: ['DISCRETE(config, "discrete", dkong2b_discrete).add_route(ALL_OUTPUTS, "mono", 0.9)'], member: 'm_discrete', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1353, sourceColumn: 2, sourceEndLine: 1353, clockExpr: 'dkong2b_discrete'};
...
MATCH (a:KG {id: 'machine:dkong_state.dkong2b'}), (b:KG {id: 'machine:dkong_state.dkong_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'machine:dkong_state.dkong2b'}), (b:KG {id: 'machine:dkong_state.dkong2b_audio'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
