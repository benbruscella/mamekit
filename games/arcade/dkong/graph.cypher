...
// generated 2026-09-17T07:11:45.545Z
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(dkong_state::dkong2b_palette), DK2B_PALETTE_LENGTH)', 'm_palette->set_entries(DK2B_PALETTE_LENGTH)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1798, sourceColumn: 2, sourceEndLine: 1798, clockExpr: 'FUNC(dkong_state::dkong2b_palette)'};
