...
- **Credited by MAMEDEV:** Couriersud (driver header); hap (machine); kmg (4 release notes); Aaron Giles (2 release notes); David Haywood (2 release notes); aequites7 (1 release note); anonymous (1 release note); Dutchman2000 (1 release note); Gaming Alexandria (1 release note); SynaMax (1 release note); Tafoid (1 release note); xelnia (1 release note)
