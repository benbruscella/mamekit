...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Frank Palazzolo (1 release note); hap (1 release note); jkburks (1 release note); Marco Kerstens (1 release note); Sam Grech (1 release note); Tafoid (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 162 commits by 25 commit authors, 2007–2025 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
