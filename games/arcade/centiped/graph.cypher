...
// generated 2026-09-11T11:44:10.969Z
...
MERGE (n:KG {id: 'device:centiped_state.centiped_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(4+4*4*4*4)'], member: 'm_palette', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1805, sourceColumn: 2, sourceEndLine: 1805};
