...
// generated 2026-09-24T02:26:21.004Z
...
MERGE (n:KG {id: 'device:centiped_state.centiped_base/maincpu'}) SET n:Device SET n += {type: 'M6502', tag: 'maincpu', clock: 1512000, config: ['M6502(config, m_maincpu, 12096000/8)'], member: 'm_maincpu', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1778, sourceColumn: 2, sourceEndLine: 1778};
MERGE (n:KG {id: 'device:centiped_state.centiped_base/earom'}) SET n:Device SET n += {type: 'ER2055', tag: 'earom', clock: null, config: ['ER2055(config, m_earom)'], member: 'm_earom'};
MERGE (n:KG {id: 'device:centiped_state.centiped_base/outlatch'}) SET n:Device SET n += {type: 'LS259', tag: 'outlatch', clock: null, config: ['LS259(config, m_outlatch)', 'm_outlatch->q_out_cb<0>().set(FUNC(centiped_state::coin_counter_left_w))', 'm_outlatch->q_out_cb<1>().set(FUNC(centiped_state::coin_counter_center_w))', 'm_outlatch->q_out_cb<2>().set(FUNC(centiped_state::coin_counter_right_w))', 'm_outlatch->q_out_cb<3>().set_output("led0").invert()', 'm_outlatch->q_out_cb<4>().set_output("led1").invert()', 'm_outlatch->q_out_cb<7>().set(FUNC(centiped_state::flip_screen_w))'], member: 'm_outlatch', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1784, sourceColumn: 2, sourceEndLine: 1784};
...
MERGE (n:KG {id: 'device:centiped_state.centiped_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_refresh_hz(60)', 'm_screen->set_size(32*8, 32*8)', 'm_screen->set_visarea(0*8, 32*8-1, 0*8, 30*8-1)', 'm_screen->set_screen_update(FUNC(centiped_state::screen_update_centiped))', 'm_screen->set_palette(m_palette)'], member: 'm_screen', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1797, sourceColumn: 2, sourceEndLine: 1797, configCalls: ['set_refresh_hz(60)', 'set_size(256,256)', 'set_visarea(0,255,0,239)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRefreshHz: 60, screenSize: [256, 256], screenVisarea: [0, 255, 0, 239]};
...
MERGE (n:KG {id: 'handler:centiped_state.screen_update_centiped'}) SET n:Handler SET n += {method: 'screen_update_centiped', ownerClass: 'centiped_state', sourceFile: 'src/mame/atari/centiped_v.cpp', sourceLine: 414, sourceColumn: 1, sourceEndLine: 440, sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'rectangle spriteclip = cliprect;
	...
	return 0;'};
MERGE (n:KG {id: 'device:centiped_state.centiped_base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_centiped)'], member: 'm_gfxdecode', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1804, sourceColumn: 2, sourceEndLine: 1804, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:centiped_state.centiped_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette).set_entries(4+4*4*4*4)'], member: 'm_palette', sourceFile: 'src/mame/atari/centiped.cpp', sourceLine: 1805, sourceColumn: 2, sourceEndLine: 1805, paletteEntries: 260};
