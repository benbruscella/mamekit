...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); Devin Acker (2 release notes); couriersud (1 release note); Tafoid (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 213 commits by 28 commit authors, 2007–2024 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
