...
defined.compiledHandlers = {
  ...
  function method_centiped_paletteram_w(runtime: any, offset: any, data: any): any {
    ...
    if (((offset) & (4))) {
      let color: any = 0;
      let r: any = ((((255) * ((((((~data)) >>> (0))) & (1))))) | 0);
      let g: any = ((((255) * ((((((~data)) >>> (1))) & (1))))) | 0);
      let b: any = ((((255) * ((((((~data)) >>> (2))) & (1))))) | 0);
      if ((((~data)) & (8))) {
        if (b) {
          b = ((192) | 0);
        } else {
  ...
  function method_screen_update_centiped(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    for (let offs: any = ((0) | 0); ((Number(offs) < Number(16)) ? 1 : 0); offs = ((((offs) + (1))) | 0)) {
      let code: any = ((((((((runtime.readIndex(h_m_spriteram, offs)) & (62))) >>> (1))) | (((((runtime.readIndex(h_m_spriteram, offs)) & (1))) << (6))))) | 0);
      let color: any = ((runtime.readIndex(h_m_spriteram, ((offs) + (48)))) | 0);
      let flipx: any = ((((((runtime.readIndex(h_m_spriteram, offs)) >>> (6))) & (1))) | 0);
      let flipy: any = ((((((runtime.readIndex(h_m_spriteram, offs)) >>> (7))) & (1))) | 0);
