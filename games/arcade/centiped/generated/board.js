    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_centiped_get_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let data = runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index);
            ...
            function method_screen_update_centiped(runtime, screen, bitmap, cliprect) {
                ...
                for (let offs = 0; ((Number(offs) < Number(16)) ? 1 : 0); offs = ((offs) + (1))) {
                    let code = ((((((runtime.readIndex(h_m_spriteram, offs)) & (62))) >>> (1))) | (((((runtime.readIndex(h_m_spriteram, offs)) & (1))) << (6))));
                    let color = runtime.readIndex(h_m_spriteram, ((offs) + (48)));
                    let flipx = ((((runtime.readIndex(h_m_spriteram, offs)) >>> (6))) & (1));
                    let flipy = ((((runtime.readIndex(h_m_spriteram, offs)) >>> (7))) & (1));
                    let x = runtime.readIndex(h_m_spriteram, ((offs) + (32)));
                    let y = ((240) - (runtime.readIndex(h_m_spriteram, ((offs) + (16)))));
