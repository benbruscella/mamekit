    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_playfield_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let lookup = ((runtime.readIndex(h_m_playfield_lookup, ((((((data) >>> (8))) & (127))) | ((((members.m_playfield_tile_bank ?? runtime.member("m_playfield_tile_bank"))) << (7)))))) & 0xffff);
                let gfxindex = ((((((lookup) >>> (8))) & (15))) | 0);
                let code = ((((((((lookup) & (255))) << (8))) | (((data) & (255))))) | 0);
                let color = ((runtime.add(32, ((((((lookup) >>> (12))) & (15))) << (runtime.readIndex((members.m_bank_color_shift ?? runtime.member("m_bank_color_shift")), gfxindex))))) | 0);
