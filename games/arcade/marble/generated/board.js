...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_int3_callback(runtime, param) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_int3off_callback(runtime, param) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_reset_yscroll_callback(runtime, param) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_get_playfield_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let lookup = ((runtime.readIndex(h_m_playfield_lookup, ((((runtime.shiftRight(data, 8)) & (127))) | ((((members.m_playfield_tile_bank ?? runtime.member("m_playfield_tile_bank"))) << (7)))))) & 0xffff);
                let gfxindex = ((((runtime.shiftRight(lookup, 8)) & (15))) | 0);
                let code = ((((((((lookup) & (255))) << (8))) | (((data) & (255))))) | 0);
                let color = ((runtime.add(32, ((((runtime.shiftRight(lookup, 12)) & (15))) << (runtime.readIndex((members.m_bank_color_shift ?? runtime.member("m_bank_color_shift")), gfxindex))))) | 0);
                (__l["tileinfo.set"] ? __l["tileinfo.set"](gfxindex, code, color, ((runtime.shiftRight(data, 15)) & (1))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(gfxindex, code, color, ((runtime.shiftRight(data, 15)) & (1))) ?? 0) : (__l["set"]?.(gfxindex, code, color, ((runtime.shiftRight(data, 15)) & (1))) ?? 0));
            }
            function method_get_alpha_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let color = ((((runtime.shiftRight(data, 10)) & (7))) | 0);
                let opaque = ((((data) & (8192))) | 0);
