...
defined.compiledHandlers = {
  ...
  function method_io_control_w(runtime: any, offset: any, data: any): any {
    ...
    switch (((offset) & (56))) {
      case 0:
      {
        ...
        if (h_m_ctrl2) {
          (__l["m_ctrl2.write_ctrlsel"] ? __l["m_ctrl2.write_ctrlsel"](((((data) >>> (3))) & (7))) : (members.m_ctrl2) != null ? ((runtime.dereference(members.m_ctrl2)).write_ctrlsel?.(((((data) >>> (3))) & (7))) ?? 0) : 0);
        }
        if (h_m_edge) {
  ...
  function method_set_video_control(runtime: any, data: any): any {
    ...
    (__l["m_sprgen.set_auto_animation_speed"] ? __l["m_sprgen.set_auto_animation_speed"](((data) >>> (8))) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).set_auto_animation_speed?.(((data) >>> (8))) ?? 0) : 0);
