...
defined.compiledHandlers = {
  ...
  function method_unmapped_r(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_io_control_w(runtime: any, offset: any, data: any): any {
    ...
    switch (((offset) & (56))) {
      ...
      {
        if (h_m_ctrl1) {
          (__l["m_ctrl1.write_ctrlsel"] ? __l["m_ctrl1.write_ctrlsel"](((data) & (7))) : (members.m_ctrl1) != null ? ((runtime.dereference(members.m_ctrl1)).write_ctrlsel?.(((data) & (7))) ?? 0) : 0);
        }
        if (h_m_ctrl2) {
          (__l["m_ctrl2.write_ctrlsel"] ? __l["m_ctrl2.write_ctrlsel"](((runtime.shiftRight(data, 3)) & (7))) : (members.m_ctrl2) != null ? ((runtime.dereference(members.m_ctrl2)).write_ctrlsel?.(((runtime.shiftRight(data, 3)) & (7))) ?? 0) : 0);
        }
        if (h_m_edge) {
          (__l["m_edge.write_ctrlsel"] ? __l["m_edge.write_ctrlsel"](((data) & (63))) : (members.m_edge) != null ? ((runtime.dereference(members.m_edge)).write_ctrlsel?.(((data) & (63))) ?? 0) : 0);
        }
        break;
      }
      case 8:
  ...
  function method_video_register_r(runtime: any, space: any, offset: any, mem_mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_video_control(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    (__l["m_sprgen.set_auto_animation_speed"] ? __l["m_sprgen.set_auto_animation_speed"](runtime.shiftRight(data, 8)) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).set_auto_animation_speed?.(runtime.shiftRight(data, 8)) ?? 0) : 0);
    (__l["m_sprgen.set_auto_animation_disabled"] ? __l["m_sprgen.set_auto_animation_disabled"]((((data) >>> (3)) & 1)) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).set_auto_animation_disabled?.((((data) >>> (3)) & 1)) ?? 0) : 0);
  ...
  function method_set_display_position_interrupt_control(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_display_position_interrupt_control = ((data) & 0xff);
  }

  function method_set_display_counter_msb(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_paletteram_r(runtime: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_paletteram_w(runtime: any, offset: any, data: any): any {
    ...
    let dark: any = ((runtime.shiftRight(data, 15)) & 0xff);
    let r: any = ((((((runtime.shiftRight(data, 14)) & (1))) | (((runtime.shiftRight(data, 7)) & (30))))) & 0xff);
    let g: any = ((((((runtime.shiftRight(data, 13)) & (1))) | (((runtime.shiftRight(data, 3)) & (30))))) & 0xff);
    let b: any = ((((((runtime.shiftRight(data, 12)) & (1))) | (((((data) << (1))) & (30))))) & 0xff);
    (__l["m_palette.set_pen_color"] ? __l["m_palette.set_pen_color"](offset, runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), r), dark), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), g), dark), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), b), dark)) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).set_pen_color?.(offset, runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), r), dark), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), g), dark), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), b), dark)) ?? 0) : 0);
    (__l["m_palette.set_pen_color"] ? __l["m_palette.set_pen_color"](((offset) + (8192)), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), r), ((dark) + (2))), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), g), ((dark) + (2))), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), b), ((dark) + (2)))) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).set_pen_color?.(((offset) + (8192)), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), r), ((dark) + (2))), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), g), ((dark) + (2))), runtime.readIndex(runtime.readIndex((members.m_palette_lookup ?? runtime.member("m_palette_lookup")), b), ((dark) + (2)))) ?? 0) : 0);
  }

  function method_save_ram_w(runtime: any, offset: any, data: any, mem_mask: any): any {
    const members = runtime.members;

    if ((members.m_save_ram_unlocked ?? runtime.member("m_save_ram_unlocked"))) {
      runtime.combineData(runtime.addressOf((members.m_save_ram ?? runtime.member("m_save_ram")), offset), data, mem_mask);
    }
  }

  function method_audio_cpu_enable_nmi_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_audionmi.in_w_1"] ? __l["m_audionmi.in_w_1"](((((~offset)) >>> (4)) & 1)) : (members.m_audionmi) != null ? ((runtime.dereference(members.m_audionmi)).in_w_1?.(((((~offset)) >>> (4)) & 1)) ?? 0) : 0);
  }

  function method_set_screen_shadow(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_set_pens(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let pen_base: any = runtime.add(runtime.add((__l["m_palette.pens"] ? __l["m_palette.pens"]() : (members.m_palette) != null ? (typeof (runtime.dereference(members.m_palette)).pens === 'function' ? (runtime.dereference(members.m_palette)).pens() : typeof (runtime.dereference(members.m_palette)).pens === 'number' || typeof (runtime.dereference(members.m_palette)).pens === 'boolean' ? (runtime.dereference(members.m_palette)).pens : runtime.container(members.m_palette, "pens")) : 0), (members.m_palette_bank ?? runtime.member("m_palette_bank"))), (((members.m_screen_shadow ?? runtime.member("m_screen_shadow"))) ? (8192) : (0)));
    (__l["m_sprgen.set_pens"] ? __l["m_sprgen.set_pens"](pen_base) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).set_pens?.(pen_base) ?? 0) : 0);
    members.m_bg_pen = runtime.addressOf(pen_base, 4095);
  }

  function method_set_use_cart_vectors(runtime: any, state: any): any {
    const members = runtime.members;

    members.m_use_cart_vectors = ((state) & 0xff);
  }

  function method_set_palette_bank(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    (__l["bitmap.fill"] ? __l["bitmap.fill"](runtime.dereference((members.m_bg_pen ?? runtime.member("m_bg_pen"))), cliprect) : (bitmap) != null ? ((runtime.dereference(bitmap)).fill?.(runtime.dereference((members.m_bg_pen ?? runtime.member("m_bg_pen"))), cliprect) ?? 0) : (__l["fill"]?.(runtime.dereference((members.m_bg_pen ?? runtime.member("m_bg_pen"))), cliprect) ?? 0));
    (__l["m_sprgen.draw_sprites"] ? __l["m_sprgen.draw_sprites"](bitmap, cliprect.min_y) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).draw_sprites?.(bitmap, cliprect.min_y) ?? 0) : 0);
    (__l["m_sprgen.draw_fixed_layer"] ? __l["m_sprgen.draw_fixed_layer"](bitmap, cliprect.min_y) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).draw_fixed_layer?.(bitmap, cliprect.min_y) ?? 0) : 0);
    return 0;
  }

  function method_sprite_on_scanline(runtime: any, scanline: any, y: any, rows: any): any {
    const members = runtime.members;

    return ((((((((Number(rows) === Number(0)) ? 1 : 0)) || (((Number(rows) >= Number(32)) ? 1 : 0))) ? 1 : 0)) || (((Number(((((scanline) - (y))) & (511))) < Number(((rows) * (16)))) ? 1 : 0))) ? 1 : 0);
  }

  function method_draw_fixed_layer_2pixels(runtime: any, pixel_addr: any, offset: any, gfx_base: any, char_pens: any): any {
    const members = runtime.members;
    ...
    pixel_addr.offset += 1;
    if (((data) & (240))) {
      runtime.pointerStore(pixel_addr, runtime.readIndex(char_pens, runtime.shiftRight(((data) & (240)), 4)));
    }
    pixel_addr.offset += 1;
    return pixel_addr;
  }

  function method_memcard_r(runtime: any, offset: any, mem_mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      (__l["m_maincpu.eat_cycles"] ? __l["m_maincpu.eat_cycles"](2) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).eat_cycles?.(2) ?? 0) : 0);
    }
    if (((((((mem_mask) & 0xff00) ? 1 : 0)) && ((__l["m_memcard.present"] ? __l["m_memcard.present"]() : (members.m_memcard) != null ? (typeof (runtime.dereference(members.m_memcard)).present === 'function' ? (runtime.dereference(members.m_memcard)).present() : typeof (runtime.dereference(members.m_memcard)).present === 'number' || typeof (runtime.dereference(members.m_memcard)).present === 'boolean' ? (runtime.dereference(members.m_memcard)).present : runtime.container(members.m_memcard, "present")) : 0))) ? 1 : 0)) {
      return (__l["m_memcard.read"] ? __l["m_memcard.read"]((((((members.m_card_bank ?? runtime.member("m_card_bank"))) << (21))) | (offset))) : (members.m_memcard) != null ? ((runtime.dereference(members.m_memcard)).read?.((((((members.m_card_bank ?? runtime.member("m_card_bank"))) << (21))) | (offset))) ?? 0) : 0);
    } else {
      return 65535;
    }
  }

  function method_memcard_w(runtime: any, offset: any, data: any, mem_mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (__l["m_maincpu.eat_cycles"] ? __l["m_maincpu.eat_cycles"](2) : (members.m_maincpu) != null ? ((runtime.dereference(members.m_maincpu)).eat_cycles?.(2) ?? 0) : 0);
    if (((((((mem_mask) & 0xff00) ? 1 : 0)) && ((__l["m_memcard.present"] ? __l["m_memcard.present"]() : (members.m_memcard) != null ? (typeof (runtime.dereference(members.m_memcard)).present === 'function' ? (runtime.dereference(members.m_memcard)).present() : typeof (runtime.dereference(members.m_memcard)).present === 'number' || typeof (runtime.dereference(members.m_memcard)).present === 'boolean' ? (runtime.dereference(members.m_memcard)).present : runtime.container(members.m_memcard, "present")) : 0))) ? 1 : 0)) {
      (__l["m_memcard.write"] ? __l["m_memcard.write"]((((((members.m_card_bank ?? runtime.member("m_card_bank"))) << (21))) | (offset)), data) : (members.m_memcard) != null ? ((runtime.dereference(members.m_memcard)).write?.((((((members.m_card_bank ?? runtime.member("m_card_bank"))) << (21))) | (offset)), data) ?? 0) : 0);
    }
  }
  return {
    "write": method_write,
  ...
  function method_set_use_cart_audio(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    members.m_use_cart_audio = ((state) & 0xff);
    (__l["m_sprgen.set_fixed_layer_source"] ? __l["m_sprgen.set_fixed_layer_source"](state) : (members.m_sprgen) != null ? ((runtime.dereference(members.m_sprgen)).set_fixed_layer_source?.(state) ?? 0) : 0);
    (__l["m_bank_audio_main.set_entry"] ? __l["m_bank_audio_main.set_entry"]((members.m_use_cart_audio ?? runtime.member("m_use_cart_audio"))) : (members.m_bank_audio_main) != null ? ((runtime.dereference(members.m_bank_audio_main)).set_entry?.((members.m_use_cart_audio ?? runtime.member("m_use_cart_audio"))) ?? 0) : (__l["set_entry"]?.((members.m_use_cart_audio ?? runtime.member("m_use_cart_audio"))) ?? 0));
  }

  function method_set_save_ram_unlock(runtime: any, state: any): any {
    const members = runtime.members;
...
defined.compiledHandlerLinks = ["bitmap.fill","fill","m_audionmi.in_w_1","m_bank_audio_main.set_entry","m_ctrl1.read_ctrl","m_ctrl1.write_ctrlsel","m_ctrl2.read_ctrl","m_ctrl2.write_ctrlsel","m_dsw.read","m_edge.in0_r","m_edge.in1_r","m_edge.write_ctrlsel","m_maincpu.eat_cycles","m_maincpu.pc","m_memcard.present","m_memcard.read","m_memcard.write","m_palette.pens","m_palette.set_pen_color","m_screen.vpos","m_sprgen.draw_fixed_layer","m_sprgen.draw_sprites","m_sprgen.get_auto_animation_counter","m_sprgen.get_videoram_data","m_sprgen.get_videoram_modulo","m_sprgen.set_auto_animation_disabled","m_sprgen.set_auto_animation_speed","m_sprgen.set_fixed_layer_source","m_sprgen.set_pens","machine","machine().side_effects_disabled","read","read_word","set_entry","space.read_word"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
