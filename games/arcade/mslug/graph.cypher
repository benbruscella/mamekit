...
// generated 2026-09-24T02:28:59.445Z
...
MERGE (n:KG {id: 'handler:neogeo_base_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'neogeo_base_state', sourceFile: 'src/mame/snk/neogeo_v.cpp', sourceLine: 157, sourceColumn: 1, sourceEndLine: 167, sourceParameters: 'screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect', sourceBody: '// fill with background color first
	...
	return 0;'};
MERGE (n:KG {id: 'handler:neosprite_base_device.draw_sprites'}) SET n:Handler SET n += {method: 'draw_sprites', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 283, sourceColumn: 1, sourceEndLine: 459, sourceConstants: ['NEOGEO_HBEND=28', 'MAX_SPRITES_PER_LINE=96'], sourceParameters: 'bitmap_rgb32 &bitmap, int scanline', sourceBody: 'int max_sprite_index;
	int y = 0;
	int x = 0;
	int rows = 0;
	int zoom_y = 0;
...
MERGE (n:KG {id: 'handler:neosprite_base_device.draw_fixed_layer_2pixels'}) SET n:Handler SET n += {method: 'draw_fixed_layer_2pixels', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 248, sourceColumn: 1, sourceEndLine: 260, sourceParameters: 'u32*&pixel_addr, int offset, u8* gfx_base, const pen_t* char_pens', sourceBody: 'const u8 data = gfx_base[offset];
	...
	pixel_addr++;'};
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, palette_device::BLACK, 4096*2*2)'], member: 'm_palette', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1946, sourceColumn: 2, sourceEndLine: 1946, clockExpr: 'palette_device::BLACK', paletteEntries: 16384};
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/spritegen'}) SET n:Device SET n += {type: 'NEOGEO_SPRITE_OPTIMZIED', tag: 'spritegen', clock: null, config: ['NEOGEO_SPRITE_OPTIMZIED(config, m_sprgen).set_screen(m_screen)'], member: 'm_sprgen', cls: 'neosprite_optimized_device', clsHierarchy: ['neosprite_optimized_device', 'neosprite_base_device'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1948, sourceColumn: 2, sourceEndLine: 1948, startHandler: 'neosprite_base_device.device_start'};
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/audionmi'}) SET n:Device SET n += {type: 'INPUT_MERGER_ALL_HIGH', tag: 'audionmi', clock: null, config: ['INPUT_MERGER_ALL_HIGH(config, m_audionmi)', 'm_audionmi->output_handler().set_inputline(m_audiocpu, INPUT_LINE_NMI)'], member: 'm_audionmi', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1951, sourceColumn: 2, sourceEndLine: 1951};
...
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/soundlatch'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'soundlatch', clock: null, config: ['GENERIC_LATCH_8(config, m_soundlatch)', 'm_soundlatch->set_separate_acknowledge(false)', 'm_soundlatch->data_pending_callback().set(m_audionmi, FUNC(input_merger_device::in_w<0>))'], member: 'm_soundlatch', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1954, sourceColumn: 2, sourceEndLine: 1954};
...
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/soundlatch2'}) SET n:Device SET n += {type: 'GENERIC_LATCH_8', tag: 'soundlatch2', clock: null, config: ['GENERIC_LATCH_8(config, m_soundlatch2)'], member: 'm_soundlatch2', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1958, sourceColumn: 2, sourceEndLine: 1958};
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_base/ymsnd'}) SET n:Device SET n += {type: 'YM2610', tag: 'ymsnd', clock: 8000000, config: ['YM2610(config, m_ym, NEOGEO_YM2610_CLOCK)', 'm_ym->irq_handler().set_inputline(m_audiocpu, 0)', 'm_ym->add_route(0, "speaker", 0.84, 0)', 'm_ym->add_route(0, "speaker", 0.84, 1)', 'm_ym->add_route(1, "speaker", 0.98, 0)', 'm_ym->add_route(2, "speaker", 0.98, 1)'], member: 'm_ym', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1960, sourceColumn: 2, sourceEndLine: 1960};
...
MERGE (n:KG {id: 'machine:neogeo_base_state.neogeo_stereo'}) SET n:MachineConfig SET n += {cls: 'neogeo_base_state', name: 'neogeo_stereo', calls: [], stateMembers: ['{"name":"m_vblank_level","bits":8}', '{"name":"m_raster_level","bits":8}', '{"name":"m_use_cart_vectors","bits":8}', '{"name":"m_use_cart_audio","bits":8}', '{"name":"m_card_bank","bits":8}', '{"name":"m_bank_base","bits":32}', '{"name":"m_curr_slot","bits":32,"signed":true}', '{"name":"m_recurse","bits":1}', '{"name":"m_display_counter","bits":32}', '{"name":"m_vblank_interrupt_pending","bits":8}', '{"name":"m_display_position_interrupt_pending","bits":8}', '{"name":"m_irq3_pending","bits":8}', '{"name":"m_display_position_interrupt_control","bits":8}', '{"name":"m_screen_shadow","bits":1}', '{"name":"m_palette_bank","bits":32}'], driverTimers: ['m_display_position_interrupt_timer=neogeo_base_state.display_position_interrupt_callback', 'm_display_position_vblank_timer=neogeo_base_state.display_position_vblank_callback', 'm_vblank_interrupt_timer=neogeo_base_state.vblank_interrupt_callback'], resetHandlers: ['neogeo_base_state.machine_reset'], startHandlers: ['neogeo_base_state.video_start'], devicePatches: ['{"tag":"ymsnd","config":["m_ym->add_route(0, \\"speaker\\", 0.84, 0)","m_ym->add_route(0, \\"speaker\\", 0.84, 1)","m_ym->add_route(1, \\"speaker\\", 0.98, 0)","m_ym->add_route(2, \\"speaker\\", 0.98, 1)"]}'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1965, sourceColumn: 1, sourceEndLine: 1973};
...
MERGE (n:KG {id: 'device:neogeo_base_state.neogeo_memcard/memcard'}) SET n:Device SET n += {type: 'NG_MEMCARD', tag: 'memcard', clock: 0, config: ['NG_MEMCARD(config, m_memcard)'], member: 'm_memcard', cls: 'ng_memcard_device', clsHierarchy: ['ng_memcard_device'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1978, sourceColumn: 2, sourceEndLine: 1978, startHandler: 'ng_memcard_device.device_start'};
MERGE (n:KG {id: 'machine:ngarcade_base_state.neogeo_arcade'}) SET n:MachineConfig SET n += {cls: 'ngarcade_base_state', name: 'neogeo_arcade', calls: ['neogeo_base'], stateMembers: ['{"name":"m_vblank_level","bits":8}', '{"name":"m_raster_level","bits":8}', '{"name":"m_use_cart_vectors","bits":8}', '{"name":"m_use_cart_audio","bits":8}', '{"name":"m_card_bank","bits":8}', '{"name":"m_bank_base","bits":32}', '{"name":"m_curr_slot","bits":32,"signed":true}', '{"name":"m_recurse","bits":1}', '{"name":"m_display_counter","bits":32}', '{"name":"m_vblank_interrupt_pending","bits":8}', '{"name":"m_display_position_interrupt_pending","bits":8}', '{"name":"m_irq3_pending","bits":8}', '{"name":"m_display_position_interrupt_control","bits":8}', '{"name":"m_screen_shadow","bits":1}', '{"name":"m_palette_bank","bits":32}', '{"name":"m_save_ram_unlocked","bits":8}'], driverTimers: ['m_display_position_interrupt_timer=neogeo_base_state.display_position_interrupt_callback', 'm_display_position_vblank_timer=neogeo_base_state.display_position_vblank_callback', 'm_vblank_interrupt_timer=neogeo_base_state.vblank_interrupt_callback'], resetHandlers: ['neogeo_base_state.machine_reset', 'ngarcade_base_state.machine_reset'], startHandlers: ['neogeo_base_state.video_start'], installedHandlers: ['{"space":"AS_PROGRAM","kind":"read","start":3145728,"end":3145729,"mirror":130942,"className":"ngarcade_base_state","method":"in0_edge_joy_r"}', '{"space":"AS_PROGRAM","kind":"read","start":3145728,"end":3145729,"mirror":130942,"className":"ngarcade_base_state","method":"in0_edge_r"}', '{"space":"AS_PROGRAM","kind":"read","start":3407872,"end":3407873,"mirror":131070,"className":"ngarcade_base_state","method":"in1_edge_joy_r"}', '{"space":"AS_PROGRAM","kind":"read","start":3407872,"end":3407873,"mirror":131070,"className":"ngarcade_base_state","method":"in1_edge_r"}', '{"space":"AS_PROGRAM","kind":"read","start":8388608,"end":12582911,"className":"ngarcade_base_state","method":"memcard_r"}', '{"space":"AS_PROGRAM","kind":"write","start":8388608,"end":12582911,"className":"ngarcade_base_state","method":"memcard_w"}'], devicePatches: ['{"tag":"systemlatch","config":["m_systemlatch->q_out_cb<5>().set(FUNC(ngarcade_base_state::set_use_cart_audio))","m_systemlatch->q_out_cb<6>().set(FUNC(ngarcade_base_state::set_save_ram_unlock))"]}'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1986, sourceColumn: 1, sourceEndLine: 2000};
...
MERGE (n:KG {id: 'device:ngarcade_base_state.neogeo_arcade/upd4990a'}) SET n:Device SET n += {type: 'UPD4990A', tag: 'upd4990a', clock: null, config: ['UPD4990A(config, m_upd4990a)'], member: 'm_upd4990a', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 1997, sourceColumn: 2, sourceEndLine: 1997};
...
MERGE (n:KG {id: 'machine:mvs_led_state.mv1_fixed'}) SET n:MachineConfig SET n += {cls: 'mvs_led_state', name: 'mv1_fixed', calls: ['neogeo_arcade', 'neogeo_stereo', 'neogeo_memcard'], stateMembers: ['{"name":"m_vblank_level","bits":8}', '{"name":"m_raster_level","bits":8}', '{"name":"m_use_cart_vectors","bits":8}', '{"name":"m_use_cart_audio","bits":8}', '{"name":"m_card_bank","bits":8}', '{"name":"m_bank_base","bits":32}', '{"name":"m_curr_slot","bits":32,"signed":true}', '{"name":"m_recurse","bits":1}', '{"name":"m_display_counter","bits":32}', '{"name":"m_vblank_interrupt_pending","bits":8}', '{"name":"m_display_position_interrupt_pending","bits":8}', '{"name":"m_irq3_pending","bits":8}', '{"name":"m_display_position_interrupt_control","bits":8}', '{"name":"m_screen_shadow","bits":1}', '{"name":"m_palette_bank","bits":32}', '{"name":"m_save_ram_unlocked","bits":8}', '{"name":"m_output_data","bits":8}', '{"name":"m_output_latch","bits":8}', '{"name":"m_led1_value","bits":8}', '{"name":"m_led2_value","bits":8}'], driverTimers: ['m_display_position_interrupt_timer=neogeo_base_state.display_position_interrupt_callback', 'm_display_position_vblank_timer=neogeo_base_state.display_position_vblank_callback', 'm_vblank_interrupt_timer=neogeo_base_state.vblank_interrupt_callback'], resetHandlers: ['neogeo_base_state.machine_reset', 'ngarcade_base_state.machine_reset'], startHandlers: ['neogeo_base_state.video_start'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 2110, sourceColumn: 1, sourceEndLine: 2120};
...
MERGE (n:KG {id: 'device:mvs_led_state.mv1_fixed/edge'}) SET n:Device SET n += {type: 'NEOGEO_CTRL_EDGE_CONNECTOR', tag: 'edge', clock: null, config: ['NEOGEO_CTRL_EDGE_CONNECTOR(config, m_edge, neogeo_arc_edge, "joy", true)'], member: 'm_edge', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 2116, sourceColumn: 2, sourceEndLine: 2116, slotOptions: 'neogeo_arc_edge', slotDefault: 'joy'};
MERGE (n:KG {id: 'device:mvs_led_state.mv1_fixed/ctrl1'}) SET n:Device SET n += {type: 'NEOGEO_CONTROL_PORT', tag: 'ctrl1', clock: null, config: ['NEOGEO_CONTROL_PORT(config, m_ctrl1, neogeo_arc_pin15, nullptr, true)'], member: 'm_ctrl1', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 2118, sourceColumn: 2, sourceEndLine: 2118, clockExpr: 'neogeo_arc_pin15'};
MERGE (n:KG {id: 'device:mvs_led_state.mv1_fixed/ctrl2'}) SET n:Device SET n += {type: 'NEOGEO_CONTROL_PORT', tag: 'ctrl2', clock: null, config: ['NEOGEO_CONTROL_PORT(config, m_ctrl2, neogeo_arc_pin15, nullptr, true)'], member: 'm_ctrl2', sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 2119, sourceColumn: 2, sourceEndLine: 2119, clockExpr: 'neogeo_arc_pin15'};
MERGE (n:KG {id: 'machine:mvs_led_state.neobase'}) SET n:MachineConfig SET n += {cls: 'mvs_led_state', name: 'neobase', calls: ['mv1_fixed'], stateMembers: ['{"name":"m_vblank_level","bits":8}', '{"name":"m_raster_level","bits":8}', '{"name":"m_use_cart_vectors","bits":8}', '{"name":"m_use_cart_audio","bits":8}', '{"name":"m_card_bank","bits":8}', '{"name":"m_bank_base","bits":32}', '{"name":"m_curr_slot","bits":32,"signed":true}', '{"name":"m_recurse","bits":1}', '{"name":"m_display_counter","bits":32}', '{"name":"m_vblank_interrupt_pending","bits":8}', '{"name":"m_display_position_interrupt_pending","bits":8}', '{"name":"m_irq3_pending","bits":8}', '{"name":"m_display_position_interrupt_control","bits":8}', '{"name":"m_screen_shadow","bits":1}', '{"name":"m_palette_bank","bits":32}', '{"name":"m_save_ram_unlocked","bits":8}', '{"name":"m_output_data","bits":8}', '{"name":"m_output_latch","bits":8}', '{"name":"m_led1_value","bits":8}', '{"name":"m_led2_value","bits":8}'], driverTimers: ['m_display_position_interrupt_timer=neogeo_base_state.display_position_interrupt_callback', 'm_display_position_vblank_timer=neogeo_base_state.display_position_vblank_callback', 'm_vblank_interrupt_timer=neogeo_base_state.vblank_interrupt_callback'], resetHandlers: ['neogeo_base_state.machine_reset', 'ngarcade_base_state.machine_reset'], startHandlers: ['neogeo_base_state.video_start'], sourceFile: 'src/mame/snk/neogeo.cpp', sourceLine: 2448, sourceColumn: 1, sourceEndLine: 2452};
...
MERGE (n:KG {id: 'device:mvs_led_state.neobase/cslot1'}) SET n:Device SET n += {type: 'NEOGEO_CART_SLOT', tag: 'cslot1', clock: null, config: ['NEOGEO_CART_SLOT(config, m_slots[0], neogeo_cart, "rom").set_user_loadable(false)'], clockExpr: 'neogeo_cart'};
MERGE (n:KG {id: 'handler:neosprite_base_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 27, sourceColumn: 1, sourceEndLine: 58, sourceParameters: '', sourceBody: 'm_videoram = std::make_unique<u16[]>(0x8000 + 0x800);
...
MERGE (n:KG {id: 'handler:neosprite_base_device.create_sprite_line_timer'}) SET n:Handler SET n += {method: 'create_sprite_line_timer', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 530, sourceColumn: 1, sourceEndLine: 533, sourceParameters: '', sourceBody: 'm_sprite_line_timer = timer_alloc(FUNC(neosprite_base_device::sprite_line_timer_callback), this);'};
MERGE (n:KG {id: 'handler:neosprite_base_device.sprite_line_timer_callback'}) SET n:Handler SET n += {method: 'sprite_line_timer_callback', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 512, sourceColumn: 1, sourceEndLine: 527, sourceConstants: ['NEOGEO_VTOTAL=264'], sourceParameters: 'int param', sourceBody: 'int scanline = param;
...
MERGE (n:KG {id: 'handler:neosprite_base_device.parse_sprites'}) SET n:Handler SET n += {method: 'parse_sprites', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 462, sourceColumn: 1, sourceEndLine: 509, sourceConstants: ['MAX_SPRITES_PER_SCREEN=381', 'MAX_SPRITES_PER_LINE=96'], sourceParameters: 'int scanline', sourceBody: 'int y = 0;
	int rows = 0;
	u16 *sprite_list;
...
MERGE (n:KG {id: 'handler:neosprite_base_device.create_auto_animation_timer'}) SET n:Handler SET n += {method: 'create_auto_animation_timer', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 150, sourceColumn: 1, sourceEndLine: 153, sourceParameters: '', sourceBody: 'm_auto_animation_timer = timer_alloc(FUNC(neosprite_base_device::auto_animation_timer_callback), this);'};
MERGE (n:KG {id: 'handler:neosprite_base_device.auto_animation_timer_callback'}) SET n:Handler SET n += {method: 'auto_animation_timer_callback', ownerClass: 'neosprite_base_device', sourceFile: 'src/mame/snk/neogeo_spr.cpp', sourceLine: 136, sourceColumn: 1, sourceEndLine: 147, sourceConstants: ['NEOGEO_VSSTART=256'], sourceParameters: 'int param', sourceBody: 'if (m_auto_animation_frame_counter == 0)
	{
...
MERGE (n:KG {id: 'handler:ng_memcard_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'ng_memcard_device', sourceFile: 'src/mame/snk/ng_memcard.cpp', sourceLine: 51, sourceColumn: 1, sourceEndLine: 57, sourceParameters: '', sourceBody: 'save_item(NAME(m_memcard_data));
...
MATCH (a:KG {id: 'machine:mvs_led_state.neobase'}), (b:KG {id: 'device:mvs_led_state.neobase/cslot1'}) MERGE (a)-[r:HAS_DEVICE]->(b);
...
MATCH (a:KG {id: 'device:neogeo_base_state.neogeo_memcard/memcard'}), (b:KG {id: 'handler:ng_memcard_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:neogeo_base_state.neogeo_base/spritegen'}), (b:KG {id: 'handler:neosprite_base_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:neosprite_base_device.device_start'}), (b:KG {id: 'handler:neosprite_base_device.create_sprite_line_timer'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:neosprite_base_device.device_start'}), (b:KG {id: 'handler:neosprite_base_device.create_auto_animation_timer'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:neosprite_base_device.create_sprite_line_timer'}), (b:KG {id: 'handler:neosprite_base_device.sprite_line_timer_callback'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:neosprite_base_device.create_auto_animation_timer'}), (b:KG {id: 'handler:neosprite_base_device.auto_animation_timer_callback'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:neosprite_base_device.sprite_line_timer_callback'}), (b:KG {id: 'handler:neosprite_base_device.parse_sprites'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:neosprite_base_device.parse_sprites'}), (b:KG {id: 'handler:neosprite_base_device.sprite_on_scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
