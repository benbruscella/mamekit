...
- **Credited by MAMEDEV:** Andrew Prime (driver header); Bryan McPhail (driver header); Ernesto Corvi (driver header); Zsolt Vasvari (driver header); Aaron Giles (6 release notes); AJR (2 release notes); Angelo Salese (2 release notes); Abadede (1 release note); ajrhacker (1 release note); cam900 (1 release note); CanoeHope (1 release note); Carl (1 release note); David Haywood (1 release note); Dr.Venom (1 release note); J.J.Boy (1 release note); JimCarlTay (1 release note); Vas Crabb (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 402 commits by 41 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
