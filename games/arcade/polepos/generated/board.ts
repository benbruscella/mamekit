...
defined.compiledHandlers = {
  ...
  function method_sprite_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return ((runtime.readIndex((members.m_sprite16_memory ?? runtime.member("m_sprite16_memory")), offset)) & (255));
  }

  function method_sprite_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_road_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return ((runtime.readIndex((members.m_road16_memory ?? runtime.member("m_road16_memory")), offset)) & (255));
  }

  function method_road_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_alpha_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return ((runtime.readIndex((members.m_alpha16_memory ?? runtime.member("m_alpha16_memory")), offset)) & (255));
  }

  function method_alpha_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_view_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return ((runtime.readIndex((members.m_view16_memory ?? runtime.member("m_view16_memory")), offset)) & (255));
  }

  function method_view_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_view16_w(runtime: any, offset: any, data: any, mem_mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_bg_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let word: any = ((runtime.readIndex((members.m_view16_memory ?? runtime.member("m_view16_memory")), tile_index)) & 0xffff);
    let code: any = ((((((word) & (255))) | (runtime.shiftRight(((word) & (16384)), 6)))) | 0);
    let color: any = ((runtime.shiftRight(((word) & (16128)), 8)) | 0);
    (__l["tileinfo.set"] ? __l["tileinfo.set"](1, code, color, 0) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(1, code, color, 0) ?? 0) : (__l["set"]?.(1, code, color, 0) ?? 0));
  }
  ...
  function method_tx_get_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    if (((Number((members.m_chacl ?? runtime.member("m_chacl"))) === Number(0)) ? 1 : 0)) {
      code = ((runtime.andAssign(code, 255)) | 0);
      color = ((0) | 0);
    }
    if (((Number(tile_index) >= Number(512)) ? 1 : 0)) {
      color = ((((color) | (64))) | 0);
    }
  ...
  function method_namco_52xx_si_r(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_namco_53xx_k_r(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_steering_changed_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      let steer_new: any = (((__l["m_steer_io.read"] ? __l["m_steer_io.read"]() : (members.m_steer_io) != null ? (typeof (runtime.dereference(members.m_steer_io)).read === 'function' ? (runtime.dereference(members.m_steer_io)).read() : typeof (runtime.dereference(members.m_steer_io)).read === 'number' || typeof (runtime.dereference(members.m_steer_io)).read === 'boolean' ? (runtime.dereference(members.m_steer_io)).read : runtime.container(members.m_steer_io, "read")) : (__l["read"]?.() ?? 0))) & 0xff);
  ...
  function method_steering_delta_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_steer_delta ?? runtime.member("m_steer_delta"));
  }

  function method_gasel_w(runtime: any, state: any): any {
    const members = runtime.members;

    members.m_adc_input = ((state) & 0xff);
  }

  function method_sb0_w(runtime: any, state: any): any {
    const members = runtime.members;

    members.m_auto_start_mask = ((((state) ? 0 : 1)) << 24 >> 24);
  }

  function method_chacl_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    members.m_chacl = ((state) & 0xff);
    (__l["m_tx_tilemap.mark_all_dirty"] ? __l["m_tx_tilemap.mark_all_dirty"]() : (members.m_tx_tilemap) != null ? (typeof (runtime.dereference(members.m_tx_tilemap)).mark_all_dirty === 'function' ? (runtime.dereference(members.m_tx_tilemap)).mark_all_dirty() : typeof (runtime.dereference(members.m_tx_tilemap)).mark_all_dirty === 'number' || typeof (runtime.dereference(members.m_tx_tilemap)).mark_all_dirty === 'boolean' ? (runtime.dereference(members.m_tx_tilemap)).mark_all_dirty : runtime.container(members.m_tx_tilemap, "mark_all_dirty")) : (__l["mark_all_dirty"]?.() ?? 0));
  }

  function method_analog_r(runtime: any): any {
    const members = runtime.members;
...
defined.compiledHandlerLinks = ["m_adc.intr_r","m_bg_tilemap.mark_tile_dirty","m_screen.vpos","m_steer_io.read","m_tx_tilemap.mark_all_dirty","m_tx_tilemap.mark_tile_dirty","machine","machine().side_effects_disabled","mark_all_dirty","mark_tile_dirty","read","set","tileinfo.set"];
export default {
  machine: defined,
  createBoard: (
    config: BoardConfig,
