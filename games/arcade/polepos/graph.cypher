...
// generated 2026-09-24T02:29:19.736Z
...
MERGE (n:KG {id: 'handler:polepos_state.z8002_nvi_enable_w_0'}) SET n:Handler SET n += {method: 'z8002_nvi_enable_w_0', ownerClass: 'polepos_state', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 314, sourceColumn: 1, sourceEndLine: 321, sourceConstants: ['NVI_LINE=0', 'z8002_device::NVI_LINE=0'], sourceParameters: 'uint16_t data', sourceBody: 'data &= 1;
...
MERGE (n:KG {id: 'handler:polepos_state.z8002_nvi_enable_w_1'}) SET n:Handler SET n += {method: 'z8002_nvi_enable_w_1', ownerClass: 'polepos_state', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 314, sourceColumn: 1, sourceEndLine: 321, sourceConstants: ['NVI_LINE=0', 'z8002_device::NVI_LINE=0'], sourceParameters: 'uint16_t data', sourceBody: 'data &= 1;
...
MERGE (n:KG {id: 'device:polepos_state.polepos/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, MASTER_CLOCK/8)', 'm_maincpu->set_addrmap(AS_PROGRAM, &polepos_state::z80_map)', 'm_maincpu->set_addrmap(AS_IO, &polepos_state::z80_io)'], member: 'm_maincpu', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 877, sourceColumn: 2, sourceEndLine: 877};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/51xx/callback:51xx:5'}) SET n:Callback SET n += {signal: 'lockout_callback', member: 'm_lockout', operation: 'set', raw: 'n51xx.lockout_callback().set(FUNC(polepos_state::lockout))', ownerTag: '51xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 893, sourceColumn: 2, sourceEndLine: 893, targetClass: 'polepos_state', targetMethod: 'lockout'};
...
MERGE (n:KG {id: 'handler:polepos_state.namco_53xx_k_r'}) SET n:Handler SET n += {method: 'namco_53xx_k_r', ownerClass: 'polepos_state', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 356, sourceColumn: 1, sourceEndLine: 360, sourceParameters: '', sourceBody: '/* hardwired to 0 */
	return 0;'};
MERGE (n:KG {id: 'device:polepos_state.polepos/53xx/callback:53xx:1'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set', raw: 'n53xx.input_callback<0>().set(FUNC(polepos_state::steering_changed_r))', ownerTag: '53xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 903, sourceColumn: 2, sourceEndLine: 903, slot: '0', targetClass: 'polepos_state', targetMethod: 'steering_changed_r'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/53xx/callback:53xx:2'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set', raw: 'n53xx.input_callback<1>().set(FUNC(polepos_state::steering_delta_r))', ownerTag: '53xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 904, sourceColumn: 2, sourceEndLine: 904, slot: '1', targetClass: 'polepos_state', targetMethod: 'steering_delta_r'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:1'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 914, sourceColumn: 2, sourceEndLine: 914, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:2'}) SET n:Callback SET n += {signal: 'rw_callback', member: 'm_rw', operation: 'set', raw: 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 915, sourceColumn: 2, sourceEndLine: 915, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'rw'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:3'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 916, sourceColumn: 2, sourceEndLine: 916, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'read'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:4'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 917, sourceColumn: 2, sourceEndLine: 917, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'write'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:5'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<1>().set("53xx", FUNC(namco_53xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 918, sourceColumn: 2, sourceEndLine: 918, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'read'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:6'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<1>().set("53xx", FUNC(namco_53xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 919, sourceColumn: 2, sourceEndLine: 919, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:7'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<2>().set("52xx", FUNC(namco_52xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 920, sourceColumn: 2, sourceEndLine: 920, slot: '2', targetTag: '52xx', targetClass: 'namco_52xx_device', targetMethod: 'write'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:8'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<2>().set("52xx", FUNC(namco_52xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 921, sourceColumn: 2, sourceEndLine: 921, slot: '2', targetTag: '52xx', targetClass: 'namco_52xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:9'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<3>().set("54xx", FUNC(namco_54xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 922, sourceColumn: 2, sourceEndLine: 922, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'write'};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/06xx/callback:06xx:10'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<3>().set("54xx", FUNC(namco_54xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 923, sourceColumn: 2, sourceEndLine: 923, slot: '3', targetTag: '54xx', targetClass: 'namco_54xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'handler:polepos_state.scanline'}) SET n:Handler SET n += {method: 'scanline', ownerClass: 'polepos_state', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 392, sourceColumn: 1, sourceEndLine: 404, sourceConstants: ['NVI_LINE=0', 'z8002_device::NVI_LINE=0', 'z8002_device::NVI_LINE=0'], sourceParameters: 'int param', sourceBody: 'int const scanline = param;
...
MERGE (n:KG {id: 'device:polepos_state.polepos/adc'}) SET n:Device SET n += {type: 'ADC0804', tag: 'adc', clock: 384000, config: ['ADC0804(config, m_adc, MASTER_CLOCK/8/8)', 'm_adc->vin_callback().set(FUNC(polepos_state::analog_r))'], member: 'm_adc', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 945, sourceColumn: 2, sourceEndLine: 945};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/4, 384, 0, 256, 264, 16, 224+16)', 'm_screen->set_screen_update(FUNC(polepos_state::screen_update))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set("51xx", FUNC(namco_51xx_device::vblank))'], member: 'm_screen', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 949, sourceColumn: 2, sourceEndLine: 949, configCalls: ['set_raw(6144000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['MASTER_CLOCK/4', '384', '0', '256', '264', '16', '224+16']};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_polepos)'], member: 'm_gfxdecode', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 955, sourceColumn: 2, sourceEndLine: 955, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:polepos_state.polepos/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(polepos_state::polepos_palette), 0x0f00, 128)'], member: 'm_palette', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 956, sourceColumn: 2, sourceEndLine: 956, clockExpr: 'FUNC(polepos_state::polepos_palette)', paletteEntries: 128};
...
MERGE (n:KG {id: 'device:polepos_state.polepos/namco'}) SET n:Device SET n += {type: 'POLEPOS_WSG', tag: 'namco', clock: 48000, config: ['POLEPOS_WSG(config, m_namco_sound, MASTER_CLOCK/512)', 'm_namco_sound->add_route(0, "speaker", 0.80, 0)', 'm_namco_sound->add_route(1, "speaker", 0.80, 1)', 'm_namco_sound->add_route(2, "rspeaker", 0.80, 0)', 'm_namco_sound->add_route(3, "rspeaker", 0.80, 1)'], member: 'm_namco_sound', sourceFile: 'src/mame/namco/polepos.cpp', sourceLine: 964, sourceColumn: 2, sourceEndLine: 964, configCalls: ['add_route(0,"speaker",0.8,0)', 'add_route(1,"speaker",0.8,1)', 'add_route(2,"rspeaker",0.8,0)', 'add_route(3,"rspeaker",0.8,1)']};
...
MERGE (n:KG {id: 'device:namco_54xx_device.device_add_mconfig/mcu'}) SET n:Device SET n += {type: 'MB8844', tag: 'mcu', clock: 1536000, config: ['MB8844(config, m_cpu, DERIVED_CLOCK(1,1))', 'm_cpu->read_k().set(FUNC(namco_54xx_device::K_r))', 'm_cpu->write_o().set(FUNC(namco_54xx_device::O_w))', 'm_cpu->read_r<0>().set(FUNC(namco_54xx_device::R0_r))', 'm_cpu->write_r<1>().set(FUNC(namco_54xx_device::R1_w))'], member: 'm_cpu', sourceFile: 'src/mame/namco/namco54.cpp', sourceLine: 138, sourceColumn: 2, sourceEndLine: 138};
...
MERGE (n:KG {id: 'handler:namco_51xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_51xx_device', sourceFile: 'src/mame/namco/namco51.cpp', sourceLine: 158, sourceColumn: 1, sourceEndLine: 162, sourceParameters: '', sourceBody: 'save_item(NAME(m_portO));
	save_item(NAME(m_rw));'};
MERGE (n:KG {id: 'handler:namco_52xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_52xx_device', sourceFile: 'src/mame/namco/namco52.cpp', sourceLine: 151, sourceColumn: 1, sourceEndLine: 162, sourceParameters: '', sourceBody: '/* start the external clock */
	if (m_extclock != 0)
	{
...
MERGE (n:KG {id: 'handler:namco_52xx_device.external_clock_pulse'}) SET n:Handler SET n += {method: 'external_clock_pulse', ownerClass: 'namco_52xx_device', sourceFile: 'src/mame/namco/namco52.cpp', sourceLine: 116, sourceColumn: 1, sourceEndLine: 119, sourceConstants: ['MB88XX_TC_LINE=1'], sourceParameters: 'int param', sourceBody: 'm_cpu->pulse_input_line(MB88XX_TC_LINE, attotime::zero);'};
...
MERGE (n:KG {id: 'handler:namco_54xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_54xx_device', sourceFile: 'src/mame/namco/namco54.cpp', sourceLine: 127, sourceColumn: 1, sourceEndLine: 130, sourceParameters: '', sourceBody: 'save_item(NAME(m_latched_cmd));'};
...
MERGE (n:KG {id: 'handler:polepos_sound_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'polepos_sound_device', sourceFile: 'src/mame/namco/polepos_a.cpp', sourceLine: 229, sourceColumn: 1, sourceEndLine: 257, sourceConstants: ['OUTPUT_RATE=24000', 'FILTER_HIGHPASS=1'], sourceParameters: '', sourceBody: 'm_stream = stream_alloc(0, 1, OUTPUT_RATE);
...
MERGE (n:KG {id: 'handler:polepos_sound_device::filter2_context.opamp_m_bandpass_setup'}) SET n:Handler SET n += {method: 'opamp_m_bandpass_setup', ownerClass: 'polepos_sound_device::filter2_context', sourceFile: 'src/mame/namco/polepos_a.cpp', sourceLine: 171, sourceColumn: 1, sourceEndLine: 197, sourceConstants: ['FILTER_BANDPASS=2'], sourceParameters: 'device_t *device, double r1, double r2, double r3, double c1, double c2', sourceBody: 'if (r1 == 0)
	{
...
MERGE (n:KG {id: 'handler:polepos_sound_device::filter2_context.setup'}) SET n:Handler SET n += {method: 'setup', ownerClass: 'polepos_sound_device::filter2_context', sourceFile: 'src/mame/namco/polepos_a.cpp', sourceLine: 83, sourceColumn: 1, sourceEndLine: 124, sourceConstants: ['FILTER_LOWPASS=0', 'FILTER_HIGHPASS=1', 'FILTER_BANDPASS=2'], sourceParameters: 'device_t *device, int type, double fc, double d, double gain', sourceBody: 'int const sample_rate = device->machine().sample_rate();
...
MATCH (a:KG {id: 'device:polepos_state.polepos/51xx'}), (b:KG {id: 'handler:namco_51xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:polepos_state.polepos/52xx'}), (b:KG {id: 'handler:namco_52xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:polepos_state.polepos/53xx'}), (b:KG {id: 'handler:namco_53xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:polepos_state.polepos/54xx'}), (b:KG {id: 'machine:namco_54xx_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:polepos_state.polepos/54xx'}), (b:KG {id: 'handler:namco_54xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:polepos_state.polepos/06xx'}), (b:KG {id: 'handler:namco_06xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:polepos_state.polepos/engine'}), (b:KG {id: 'handler:polepos_sound_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:namco_52xx_device.device_start'}), (b:KG {id: 'handler:namco_52xx_device.external_clock_pulse'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:polepos_sound_device.device_start'}), (b:KG {id: 'handler:polepos_sound_device::filter2_context.opamp_m_bandpass_setup'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:polepos_sound_device.device_start'}), (b:KG {id: 'handler:polepos_sound_device::filter2_context.setup'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:polepos_sound_device::filter2_context.opamp_m_bandpass_setup'}), (b:KG {id: 'handler:polepos_sound_device::filter2_context.setup'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
