...
- **Credited by MAMEDEV:** Aaron Giles (driver header); Alex Pasadyn (driver header); Ernesto Corvi (driver header); Juergen Buchmueller (driver header); Nicola Salmoria (driver header); Andrew Welburn (machine); The Dumping Union (machine); cam900 (1 release note); Cow (1 release note); hap (1 release note); Robbbert (1 release note)
- **Credit source:** MAME driver header (copyright-holders) and MAMEDEV release notes, release notes 0.100–0.289
- **Commit activity:** 262 commits by 33 commit authors, 2007–2026 (git log --follow over the driver file at MAME f34f02505e32; not a statement of authorship)
