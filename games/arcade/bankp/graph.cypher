...
// generated 2026-09-24T02:25:49.907Z
...
MERGE (n:KG {id: 'handler:bankp_state.video_control_w'}) SET n:Handler SET n += {method: 'video_control_w', ownerClass: 'bankp_state', sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 257, sourceColumn: 1, sourceEndLine: 280, sourceParameters: 'uint8_t data', sourceBody: '// bits 0-1 are playfield priority
	...
	// bits 6-7 N/C'};
MERGE (n:KG {id: 'machine:bankp_state.bankp'}) SET n:MachineConfig SET n += {cls: 'bankp_state', name: 'bankp', calls: [], stateMembers: ['{"name":"m_scroll_x","bits":8}', '{"name":"m_priority","bits":8}', '{"name":"m_color_hi","bits":8}', '{"name":"m_display_on","bits":8}', '{"name":"m_nmi_mask","bits":8}'], resetHandlers: ['bankp_state.machine_reset'], startHandlers: ['bankp_state.video_start'], sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 531, sourceColumn: 1, sourceEndLine: 568};
...
MERGE (n:KG {id: 'handler:bankp_state.screen_update'}) SET n:Handler SET n += {method: 'screen_update', ownerClass: 'bankp_state', sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 318, sourceColumn: 1, sourceEndLine: 359, sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'if (!m_display_on)
	...
	return 0;'};
MERGE (n:KG {id: 'device:bankp_state.bankp/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_bankp)'], member: 'm_gfxdecode', sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 558, sourceColumn: 2, sourceEndLine: 558, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:bankp_state.bankp/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(bankp_state::palette), 512, 32)'], member: 'm_palette', sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 559, sourceColumn: 2, sourceEndLine: 559, clockExpr: 'FUNC(bankp_state::palette)', paletteEntries: 32};
...
MERGE (n:KG {id: 'inputs:bankp/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_SERVICE1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_BUTTON2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:bankp/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_BUTTON2', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:bankp/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_BUTTON3', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_BUTTON3', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 248, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:bankp/DSW1'}) SET n:Port SET n += {tag: 'DSW1', modify: false};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SW1:1,2")'], name: 'Coin Switch 1', defaultValue: 0, location: 'SW1:1,2', settings: ['3=3C 1C', '2=2C 1C', '0=1C 1C', '1=1C 2C']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, modifiers: ['PORT_DIPLOCATION("SW1:3")'], name: 'Coin Switch 2', defaultValue: 0, location: 'SW1:3', settings: ['4=2C 1C', '0=1C 1C']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, modifiers: ['PORT_DIPLOCATION("SW1:4")'], name: 'Lives', defaultValue: 0, location: 'SW1:4', settings: ['0=3', '8=4']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 16, modifiers: ['PORT_DIPLOCATION("SW1:5")'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:5', settings: ['0=70K 200K 500K', '16=100K 400K 800K']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 32, modifiers: ['PORT_DIPLOCATION("SW1:6")'], name: 'Difficulty', defaultValue: 0, location: 'SW1:6', settings: ['0=Easy', '32=Hard']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 64, modifiers: ['PORT_DIPLOCATION("SW1:7")'], name: 'Demo Sounds', defaultValue: 64, location: 'SW1:7', settings: ['0=Off', '64=On']};
MERGE (n:KG {id: 'inputs:bankp/DSW1/f6'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_DIPLOCATION("SW1:8")'], name: 'Cabinet', defaultValue: 128, location: 'SW1:8', settings: ['128=Upright', '0=Cocktail']};
...
MERGE (n:KG {id: 'device:bankp_state.bankp/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(bankp_state::palette), 512, 32)', ownerTag: 'palette', targetClass: 'bankp_state', targetMethod: 'palette', entries: 32, sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 559};
MERGE (n:KG {id: 'handler:bankp_state.palette'}) SET n:Handler SET n += {method: 'palette', ownerClass: 'bankp_state', sourceFile: 'src/mame/sanritsu/bankp.cpp', sourceLine: 190, sourceColumn: 1, sourceEndLine: 229, sourceParameters: 'palette_device &palette', sourceBody: 'const uint8_t *color_prom = memregion("proms")->base();
...
MATCH (a:KG {id: 'device:bankp_state.bankp/palette'}), (b:KG {id: 'device:bankp_state.bankp/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:bankp_state.bankp/palette/callback:palette_init'}), (b:KG {id: 'handler:bankp_state.palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
