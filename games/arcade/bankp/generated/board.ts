...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_videoram_w_0(runtime: any, offset: any, data: any) {
  ...
  function method_colorram_w_0(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_videoram_w_1(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_colorram_w_1(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let code: any = runtime.add(runtime.readIndex(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), 0), tile_index), ((256) * (((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 0), tile_index)) & (3)))));
    let color: any = ((((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 0), tile_index)) >>> (3))) | ((((members.m_color_hi ?? runtime.member("m_color_hi"))) << (5))));
    let flags: any = ((((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 0), tile_index)) & (4))) ? (1) : (0));
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let code: any = runtime.add(runtime.readIndex(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), 1), tile_index), ((256) * (((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 1), tile_index)) & (7)))));
    let color: any = ((((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 1), tile_index)) >>> (4))) | ((((members.m_color_hi ?? runtime.member("m_color_hi"))) << (4))));
    let flags: any = ((((runtime.readIndex(runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), 1), tile_index)) & (8))) ? (1) : (0));
  ...
  function method_vblank_interrupt(runtime: any, device: any) {
    const members = runtime.members;
