...
defined.compiledHandlers = {
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let code: any = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (16))) << (4)));
    let color: any = ((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (15));
    let flags: any = ((((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (64))) ? (1) : (0))) | (((((runtime.readIndex((members.m_colorram ?? runtime.member("m_colorram")), tile_index)) & (128))) ? (2) : (0))));
  ...
  function method_vblank_irq(runtime: any, device: any) {
    const members = runtime.members;
  ...
  function method_portb_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_portb_w(runtime: any, offset: any, data: any, mem_mask: any) {
    const members = runtime.members;
