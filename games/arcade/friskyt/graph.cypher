...
// generated 2026-09-24T02:26:58.449Z
...
MERGE (n:KG {id: 'machine:seicross_state.no_nvram'}) SET n:MachineConfig SET n += {cls: 'seicross_state', name: 'no_nvram', calls: [], stateMembers: ['{"name":"m_portb","bits":8}', '{"name":"m_irq_mask","bits":8}'], resetHandlers: ['seicross_state.machine_reset'], startHandlers: ['seicross_state.video_start'], sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 621, sourceColumn: 1, sourceEndLine: 654};
...
MERGE (n:KG {id: 'device:seicross_state.no_nvram/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_seicross)'], member: 'm_gfxdecode', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 642, sourceColumn: 2, sourceEndLine: 642, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:seicross_state.no_nvram/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(seicross_state::palette), 64)'], member: 'm_palette', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 643, sourceColumn: 2, sourceEndLine: 643, clockExpr: 'FUNC(seicross_state::palette)', paletteEntries: 64};
...
MERGE (n:KG {id: 'handler:seicross_state.portb_w'}) SET n:Handler SET n += {method: 'portb_w', ownerClass: 'seicross_state', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 318, sourceColumn: 1, sourceEndLine: 339, sourceParameters: 'offs_t offset, uint8_t data, uint8_t mem_mask', sourceBody: '// ignore if high-impedance (seicross relies on it)
	...
	// other bits unused
	m_portb = data;'};
MERGE (n:KG {id: 'device:seicross_state.no_nvram/dac'}) SET n:Device SET n += {type: 'DAC_4BIT_R2R', tag: 'dac', clock: 0, config: ['DAC_4BIT_R2R(config, m_dac, 0).add_route(ALL_OUTPUTS, "speaker", 0.12)'], member: 'm_dac', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 653, sourceColumn: 2, sourceEndLine: 653};
...
MERGE (n:KG {id: 'machine:seicross_state.nvram'}) SET n:MachineConfig SET n += {cls: 'seicross_state', name: 'nvram', calls: ['no_nvram'], stateMembers: ['{"name":"m_portb","bits":8}', '{"name":"m_irq_mask","bits":8}'], resetHandlers: ['seicross_state.machine_reset'], startHandlers: ['seicross_state.video_start'], sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 657, sourceColumn: 1, sourceEndLine: 665};
MERGE (n:KG {id: 'device:seicross_state.nvram/nvram'}) SET n:Device SET n += {type: 'NVRAM', tag: 'nvram', clock: null, config: ['NVRAM(config, "nvram").set_custom_handler(FUNC(seicross_state::nvram_init))'], member: 'm_nvram', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 664, sourceColumn: 2, sourceEndLine: 664};
...
MERGE (n:KG {id: 'inputs:friskyt/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_8WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_SERVICE1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f5'}) SET n:PortField SET n += {kind: 'service', mask: 32, activeLow: false, defaultValue: 0};
MERGE (n:KG {id: 'inputs:friskyt/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:friskyt/TEST/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 252, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
...
MERGE (n:KG {id: 'device:seicross_state.no_nvram/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(seicross_state::palette), 64)', ownerTag: 'palette', targetClass: 'seicross_state', targetMethod: 'palette', entries: 64, sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 643};
MERGE (n:KG {id: 'handler:seicross_state.palette'}) SET n:Handler SET n += {method: 'palette', ownerClass: 'seicross_state', sourceFile: 'src/mame/nichibutsu/seicross.cpp', sourceLine: 207, sourceColumn: 1, sourceEndLine: 232, sourceParameters: 'palette_device &palette', sourceBody: 'uint8_t const *const color_prom = memregion("proms")->base();
...
MATCH (a:KG {id: 'machine:seicross_state.nvram'}), (b:KG {id: 'machine:seicross_state.no_nvram'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:seicross_state.no_nvram/palette'}), (b:KG {id: 'device:seicross_state.no_nvram/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:seicross_state.no_nvram/palette/callback:palette_init'}), (b:KG {id: 'handler:seicross_state.palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
