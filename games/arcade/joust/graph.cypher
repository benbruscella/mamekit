...
// generated 2026-09-17T07:12:02.801Z
...
MERGE (n:KG {id: 'game:joust'}) SET n:Game SET n += {name: 'joust', year: '1982', company: 'Williams', fullname: 'Joust (Green label)', monitor: 'ROT0', cls: 'williams_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 4013, sourceColumn: 1, sourceEndLine: 4013};
MERGE (n:KG {id: 'romset:joust'}) SET n:RomSet SET n += {name: 'joust', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3006, sourceColumn: 1, sourceEndLine: 3006};
MERGE (n:KG {id: 'region:joust/maincpu'}) SET n:RomRegion SET n += {tag: 'maincpu', size: 65536, flags: '0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1986, sourceColumn: 2, sourceEndLine: 1986};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_1b_3006-13.e4'}) SET n:Rom SET n += {file: 'joust_rom_1b_3006-13.e4', offset: 0, size: 4096, crc: 'fe41b2af', sha1: '0443e00ae2eb3e66cf805562ee04309487bb0ba4', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3008, sourceColumn: 2, sourceEndLine: 3008};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_2b_3006-14.c4'}) SET n:Rom SET n += {file: 'joust_rom_2b_3006-14.c4', offset: 4096, size: 4096, crc: '501c143c', sha1: '5fda266d43cbbf42eeae1a078b5209d9408ab99f', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3009, sourceColumn: 2, sourceEndLine: 3009};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_3b_3006-15.a4'}) SET n:Rom SET n += {file: 'joust_rom_3b_3006-15.a4', offset: 8192, size: 4096, crc: '43f7161d', sha1: '686da120aa4bd4a41f3d93e8c79ebb343977851a', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3010, sourceColumn: 2, sourceEndLine: 3010};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_4b_3006-16.e5'}) SET n:Rom SET n += {file: 'joust_rom_4b_3006-16.e5', offset: 12288, size: 4096, crc: 'db5571b6', sha1: 'cb1c3285344e2cfbe0a81ab9b51758c40da8a23f', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3011, sourceColumn: 2, sourceEndLine: 3011};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_5b_3006-17.c5'}) SET n:Rom SET n += {file: 'joust_rom_5b_3006-17.c5', offset: 16384, size: 4096, crc: 'c686bb6b', sha1: 'd9cac4c46820e1a451a145864bca7a35cfab7d37', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3012, sourceColumn: 2, sourceEndLine: 3012};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_6b_3006-18.a5'}) SET n:Rom SET n += {file: 'joust_rom_6b_3006-18.a5', offset: 20480, size: 4096, crc: 'fac5f2cf', sha1: 'febaa8cf5c3a0af901cd12d0b7909f6fec3beadd', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3013, sourceColumn: 2, sourceEndLine: 3013};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_7b_3006-19.e6'}) SET n:Rom SET n += {file: 'joust_rom_7b_3006-19.e6', offset: 24576, size: 4096, crc: '81418240', sha1: '5ad14aa65e71c3856dcdb04c99edda92e406a3e3', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3014, sourceColumn: 2, sourceEndLine: 3014};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_8b_3006-20.c6'}) SET n:Rom SET n += {file: 'joust_rom_8b_3006-20.c6', offset: 28672, size: 4096, crc: 'ba5359ba', sha1: 'f4ee13d5a95ed3e1050a3927a3a0ccf86ed7752d', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3015, sourceColumn: 2, sourceEndLine: 3015};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_9b_3006-21.a6'}) SET n:Rom SET n += {file: 'joust_rom_9b_3006-21.a6', offset: 32768, size: 4096, crc: '39643147', sha1: 'd95d3b746133eac9dcc9ee05eabecb797023f1a5', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3016, sourceColumn: 2, sourceEndLine: 3016};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_10b_3006-22.a7'}) SET n:Rom SET n += {file: 'joust_rom_10b_3006-22.a7', offset: 53248, size: 4096, crc: '3f1c4f89', sha1: '90864a8ab944df45287bf0f68ad3a85194077a82', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3017, sourceColumn: 2, sourceEndLine: 3017};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_11b_3006-23.c7'}) SET n:Rom SET n += {file: 'joust_rom_11b_3006-23.c7', offset: 57344, size: 4096, crc: 'ea48b359', sha1: '6d38003d56bebeb1f5b4d2287d587342847aa195', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3018, sourceColumn: 2, sourceEndLine: 3018};
MERGE (n:KG {id: 'rom:joust/maincpu/joust_rom_12b_3006-24.e7'}) SET n:Rom SET n += {file: 'joust_rom_12b_3006-24.e7', offset: 61440, size: 4096, crc: 'c710717b', sha1: '7d01764e8251c60b3cab96f7dc6dcc1c624f9d12', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3019, sourceColumn: 2, sourceEndLine: 3019};
MERGE (n:KG {id: 'region:joust/soundcpu'}) SET n:RomRegion SET n += {tag: 'soundcpu', size: 65536, flags: '0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2001, sourceColumn: 2, sourceEndLine: 2001};
MERGE (n:KG {id: 'rom:joust/soundcpu/video_sound_rom_4_std_780.ic12'}) SET n:Rom SET n += {file: 'video_sound_rom_4_std_780.ic12', offset: 61440, size: 4096, crc: 'f1835bdd', sha1: 'af7c066d2949d36b87ea8c425ca7d12f82b5c653', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3022, sourceColumn: 2, sourceEndLine: 3022};
MERGE (n:KG {id: 'region:joust/proms'}) SET n:RomRegion SET n += {tag: 'proms', size: 1024, flags: '0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2004, sourceColumn: 2, sourceEndLine: 2004};
MERGE (n:KG {id: 'rom:joust/proms/decoder_rom_4.3g'}) SET n:Rom SET n += {file: 'decoder_rom_4.3g', offset: 0, size: 512, crc: 'e6631c23', sha1: '9988723269367fb44ef83f627186a1c88cf7877e', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2605, sourceColumn: 2, sourceEndLine: 2605};
MERGE (n:KG {id: 'rom:joust/proms/decoder_rom_6.3c'}) SET n:Rom SET n += {file: 'decoder_rom_6.3c', offset: 512, size: 512, crc: '83faf25e', sha1: '30002643d08ed983a6701a7c4b5ee74a2f4a1adb', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 2749, sourceColumn: 2, sourceEndLine: 2749};
...
MERGE (n:KG {id: 'device:williams_state.williams_base/pia_0'}) SET n:Device SET n += {type: 'PIA6821', tag: 'pia_0', clock: null, config: ['PIA6821(config, m_pia[0])', 'm_pia[0]->readpa_handler().set_ioport("IN0")', 'm_pia[0]->readpb_handler().set_ioport("IN1")', 'm_pia[0]->readpa_handler().set_ioport("IN0").mask(0x30)', 'm_pia[0]->readpa_handler().append("mux_0", FUNC(ls157_device::output_r)).mask(0x0f)', 'm_pia[0]->readpa_handler().append("mux_1", FUNC(ls157_device::output_r)).lshift(6).mask(0xc0)', 'm_pia[0]->readpb_handler().set_ioport("IN1").mask(0xfc)', 'm_pia[0]->readpb_handler().append("mux_1", FUNC(ls157_device::output_r)).rshift(2).mask(0x03)', 'm_pia[0]->cb2_handler().set("mux_0", FUNC(ls157_device::select_w))', 'm_pia[0]->cb2_handler().append("mux_1", FUNC(ls157_device::select_w))'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1570, sourceColumn: 2, sourceEndLine: 1570};
...
MERGE (n:KG {id: 'device:williams_state.williams_b1/blitter'}) SET n:Device SET n += {type: 'WILLIAMS_BLITTER_SC1', tag: 'blitter', clock: 49152, config: ['WILLIAMS_BLITTER_SC1(config, m_blitter, 0xc000, m_maincpu, m_videoram)'], member: 'm_blitter', cls: 'williams_blitter_sc1_device', clsHierarchy: ['williams_blitter_sc1_device', 'williams_blitter_device'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1589, sourceColumn: 2, sourceEndLine: 1589, startHandler: 'williams_blitter_device.device_start'};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed'}) SET n:MachineConfig SET n += {cls: 'williams_state', name: 'williams_muxed', calls: [], stateMembers: ['{"name":"m_cocktail","bits":8}'], resetHandlers: ['williams_state.machine_reset'], startHandlers: ['williams_state.video_start'], devicePatches: ['{"tag":"pia_0","config":["m_pia[0]->readpa_handler().set_ioport(\\"IN0\\").mask(0x30)","m_pia[0]->readpa_handler().append(\\"mux_0\\", FUNC(ls157_device::output_r)).mask(0x0f)","m_pia[0]->readpa_handler().append(\\"mux_1\\", FUNC(ls157_device::output_r)).lshift(6).mask(0xc0)","m_pia[0]->readpb_handler().set_ioport(\\"IN1\\").mask(0xfc)","m_pia[0]->readpb_handler().append(\\"mux_1\\", FUNC(ls157_device::output_r)).rshift(2).mask(0x03)","m_pia[0]->cb2_handler().set(\\"mux_0\\", FUNC(ls157_device::select_w))","m_pia[0]->cb2_handler().append(\\"mux_1\\", FUNC(ls157_device::select_w))"]}'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1636, sourceColumn: 1, sourceEndLine: 1654};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:0'}) SET n:Callback SET n += {signal: 'readpa_handler', operation: 'set_ioport', raw: 'm_pia[0]->readpa_handler().set_ioport("IN0").mask(0x30)', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1639, sourceColumn: 2, sourceEndLine: 1639, transforms: ['mask(0x30)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:1'}) SET n:Callback SET n += {signal: 'readpa_handler', operation: 'append', raw: 'm_pia[0]->readpa_handler().append("mux_0", FUNC(ls157_device::output_r)).mask(0x0f)', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1640, sourceColumn: 2, sourceEndLine: 1640, transforms: ['mask(0x0f)'], targetTag: 'mux_0', targetClass: 'ls157_device', targetMethod: 'output_r'};
MERGE (n:KG {id: 'handler:ls157_device.output_r'}) SET n:Handler SET n += {method: 'output_r', ownerClass: 'ls157_device', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1957, sourceColumn: 2, sourceEndLine: 1957};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:2'}) SET n:Callback SET n += {signal: 'readpa_handler', operation: 'append', raw: 'm_pia[0]->readpa_handler().append("mux_1", FUNC(ls157_device::output_r)).lshift(6).mask(0xc0)', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1641, sourceColumn: 2, sourceEndLine: 1641, transforms: ['lshift(6)', 'mask(0xc0)'], targetTag: 'mux_1', targetClass: 'ls157_device', targetMethod: 'output_r'};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:3'}) SET n:Callback SET n += {signal: 'readpb_handler', operation: 'set_ioport', raw: 'm_pia[0]->readpb_handler().set_ioport("IN1").mask(0xfc)', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1642, sourceColumn: 2, sourceEndLine: 1642, transforms: ['mask(0xfc)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:4'}) SET n:Callback SET n += {signal: 'readpb_handler', operation: 'append', raw: 'm_pia[0]->readpb_handler().append("mux_1", FUNC(ls157_device::output_r)).rshift(2).mask(0x03)', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1643, sourceColumn: 2, sourceEndLine: 1643, transforms: ['rshift(2)', 'mask(0x03)'], targetTag: 'mux_1', targetClass: 'ls157_device', targetMethod: 'output_r'};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:5'}) SET n:Callback SET n += {signal: 'cb2_handler', operation: 'set', raw: 'm_pia[0]->cb2_handler().set("mux_0", FUNC(ls157_device::select_w))', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1644, sourceColumn: 2, sourceEndLine: 1644, targetTag: 'mux_0', targetClass: 'ls157_device', targetMethod: 'select_w'};
MERGE (n:KG {id: 'handler:ls157_device.select_w'}) SET n:Handler SET n += {method: 'select_w', ownerClass: 'ls157_device', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1958, sourceColumn: 2, sourceEndLine: 1958};
MERGE (n:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:6'}) SET n:Callback SET n += {signal: 'cb2_handler', operation: 'append', raw: 'm_pia[0]->cb2_handler().append("mux_1", FUNC(ls157_device::select_w))', ownerTag: 'pia_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1645, sourceColumn: 2, sourceEndLine: 1645, targetTag: 'mux_1', targetClass: 'ls157_device', targetMethod: 'select_w'};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_0'}) SET n:Device SET n += {type: 'LS157', tag: 'mux_0', clock: null, config: ['ls157_device &mux0(LS157(config, "mux_0"))', 'mux0.a_in_callback().set_ioport("INP2")', 'mux0.b_in_callback().set_ioport("INP1")'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1647, sourceColumn: 2, sourceEndLine: 1647};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_0/callback:mux_0:0'}) SET n:Callback SET n += {signal: 'a_in_callback', operation: 'set_ioport', raw: 'mux0.a_in_callback().set_ioport("INP2")', ownerTag: 'mux_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1648, sourceColumn: 2, sourceEndLine: 1648, targetTag: 'INP2', targetPort: 'INP2'};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_0/callback:mux_0:1'}) SET n:Callback SET n += {signal: 'b_in_callback', operation: 'set_ioport', raw: 'mux0.b_in_callback().set_ioport("INP1")', ownerTag: 'mux_0', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1649, sourceColumn: 2, sourceEndLine: 1649, targetTag: 'INP1', targetPort: 'INP1'};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_1'}) SET n:Device SET n += {type: 'LS157', tag: 'mux_1', clock: null, config: ['ls157_device &mux1(LS157(config, "mux_1"))', 'mux1.a_in_callback().set_ioport("INP2A")', 'mux1.b_in_callback().set_ioport("INP1A")'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1651, sourceColumn: 2, sourceEndLine: 1651};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_1/callback:mux_1:0'}) SET n:Callback SET n += {signal: 'a_in_callback', operation: 'set_ioport', raw: 'mux1.a_in_callback().set_ioport("INP2A")', ownerTag: 'mux_1', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1652, sourceColumn: 2, sourceEndLine: 1652, targetTag: 'INP2A', targetPort: 'INP2A'};
MERGE (n:KG {id: 'device:williams_state.williams_muxed/mux_1/callback:mux_1:1'}) SET n:Callback SET n += {signal: 'b_in_callback', operation: 'set_ioport', raw: 'mux1.b_in_callback().set_ioport("INP1A")', ownerTag: 'mux_1', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1653, sourceColumn: 2, sourceEndLine: 1653, targetTag: 'INP1A', targetPort: 'INP1A'};
MERGE (n:KG {id: 'machine:williams_state.joust'}) SET n:MachineConfig SET n += {cls: 'williams_state', name: 'joust', calls: ['williams_b1', 'williams_muxed'], stateMembers: ['{"name":"m_cocktail","bits":8}'], resetHandlers: ['williams_state.machine_reset'], startHandlers: ['williams_state.video_start'], sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1656, sourceColumn: 1, sourceEndLine: 1660};
...
MERGE (n:KG {id: 'inputs:joust'}) SET n:InputPorts SET n += {name: 'joust', sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 969, sourceColumn: 8, sourceEndLine: 969};
MERGE (n:KG {id: 'inputs:joust/IN0'}) SET n:Port SET n += {tag: 'IN0', modify: false};
MERGE (n:KG {id: 'inputs:joust/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:joust/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 252, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2'}) SET n:Port SET n += {tag: 'IN2', modify: false};
MERGE (n:KG {id: 'inputs:joust/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE1', modifiers: ['PORT_NAME("Auto Up / Manual Down")', 'PORT_TOGGLE'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_SERVICE', modifiers: ['PORT_NAME("Advance")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_COIN3', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_MEMORY_RESET', modifiers: ['PORT_NAME("High Score Reset")'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_COIN2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_TILT', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP2'}) SET n:Port SET n += {tag: 'INP2', modify: false};
MERGE (n:KG {id: 'inputs:joust/INP2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(2)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP1'}) SET n:Port SET n += {tag: 'INP1', modify: false};
MERGE (n:KG {id: 'inputs:joust/INP1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_2WAY', 'PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_PLAYER(1)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP2A'}) SET n:Port SET n += {tag: 'INP2A', modify: false};
MERGE (n:KG {id: 'inputs:joust/INP2A/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 15, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
MERGE (n:KG {id: 'inputs:joust/INP1A'}) SET n:Port SET n += {tag: 'INP1A', modify: false};
MERGE (n:KG {id: 'inputs:joust/INP1A/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 15, activeLow: false, type: 'IPT_UNUSED', defaultValue: 0};
...
MATCH (a:KG {id: 'game:joust'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 4013, sourceColumn: 1, sourceEndLine: 4013};
MATCH (a:KG {id: 'game:joust'}), (b:KG {id: 'machine:williams_state.joust'}) MERGE (a)-[r:USES_MACHINE]->(b);
MATCH (a:KG {id: 'game:joust'}), (b:KG {id: 'inputs:joust'}) MERGE (a)-[r:USES_INPUTS]->(b);
MATCH (a:KG {id: 'game:joust'}), (b:KG {id: 'romset:joust'}) MERGE (a)-[r:USES_ROMSET]->(b);
...
MATCH (a:KG {id: 'machine:williams_state.joust'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1656, sourceColumn: 1, sourceEndLine: 1660};
MATCH (a:KG {id: 'machine:williams_state.joust'}), (b:KG {id: 'handler:williams_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.joust'}), (b:KG {id: 'handler:williams_state.video_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.joust'}), (b:KG {id: 'machine:williams_state.williams_b1'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'machine:williams_state.joust'}), (b:KG {id: 'machine:williams_state.williams_muxed'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 969, sourceColumn: 8, sourceEndLine: 969};
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/IN0'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/IN1'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/IN2'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/INP2'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/INP1'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/INP2A'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'inputs:joust'}), (b:KG {id: 'inputs:joust/INP1A'}) MERGE (a)-[r:HAS_PORT]->(b);
MATCH (a:KG {id: 'romset:joust'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 3006, sourceColumn: 1, sourceEndLine: 3006};
MATCH (a:KG {id: 'romset:joust'}), (b:KG {id: 'region:joust/maincpu'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:joust'}), (b:KG {id: 'region:joust/soundcpu'}) MERGE (a)-[r:HAS_REGION]->(b);
MATCH (a:KG {id: 'romset:joust'}), (b:KG {id: 'region:joust/proms'}) MERGE (a)-[r:HAS_REGION]->(b);
...
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'file:src/mame/williams/williams.cpp'}) MERGE (a)-[r:DEFINED_IN]->(b) SET r += {sourceFile: 'src/mame/williams/williams.cpp', sourceLine: 1636, sourceColumn: 1, sourceEndLine: 1654};
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'handler:williams_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'handler:williams_state.video_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_0'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_1'}) MERGE (a)-[r:HAS_DEVICE]->(b);
MATCH (a:KG {id: 'inputs:joust/IN0'}), (b:KG {id: 'inputs:joust/IN0/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN0'}), (b:KG {id: 'inputs:joust/IN0/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN1'}), (b:KG {id: 'inputs:joust/IN1/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f2'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f3'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f4'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f5'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f6'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/IN2'}), (b:KG {id: 'inputs:joust/IN2/f7'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP2'}), (b:KG {id: 'inputs:joust/INP2/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP2'}), (b:KG {id: 'inputs:joust/INP2/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP2'}), (b:KG {id: 'inputs:joust/INP2/f2'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP2'}), (b:KG {id: 'inputs:joust/INP2/f3'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP1'}), (b:KG {id: 'inputs:joust/INP1/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP1'}), (b:KG {id: 'inputs:joust/INP1/f1'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP1'}), (b:KG {id: 'inputs:joust/INP1/f2'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP1'}), (b:KG {id: 'inputs:joust/INP1/f3'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP2A'}), (b:KG {id: 'inputs:joust/INP2A/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'inputs:joust/INP1A'}), (b:KG {id: 'inputs:joust/INP1A/f0'}) MERGE (a)-[r:HAS_FIELD]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_1b_3006-13.e4'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_2b_3006-14.c4'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_3b_3006-15.a4'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_4b_3006-16.e5'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_5b_3006-17.c5'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_6b_3006-18.a5'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_7b_3006-19.e6'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_8b_3006-20.c6'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_9b_3006-21.a6'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_10b_3006-22.a7'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_11b_3006-23.c7'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/maincpu'}), (b:KG {id: 'rom:joust/maincpu/joust_rom_12b_3006-24.e7'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/soundcpu'}), (b:KG {id: 'rom:joust/soundcpu/video_sound_rom_4_std_780.ic12'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/proms'}), (b:KG {id: 'rom:joust/proms/decoder_rom_4.3g'}) MERGE (a)-[r:LOADS]->(b);
MATCH (a:KG {id: 'region:joust/proms'}), (b:KG {id: 'rom:joust/proms/decoder_rom_6.3c'}) MERGE (a)-[r:LOADS]->(b);
...
MATCH (a:KG {id: 'device:williams_state.williams_b1/blitter'}), (b:KG {id: 'handler:williams_blitter_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:1'}), (b:KG {id: 'handler:ls157_device.output_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:2'}), (b:KG {id: 'handler:ls157_device.output_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:4'}), (b:KG {id: 'handler:ls157_device.output_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:5'}), (b:KG {id: 'handler:ls157_device.select_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:williams_state.williams_muxed/callback:pia_0:6'}), (b:KG {id: 'handler:ls157_device.select_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:williams_state.williams_muxed/mux_0'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_0/callback:mux_0:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:williams_state.williams_muxed/mux_0'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_0/callback:mux_0:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:williams_state.williams_muxed/mux_1'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_1/callback:mux_1:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:williams_state.williams_muxed/mux_1'}), (b:KG {id: 'device:williams_state.williams_muxed/mux_1/callback:mux_1:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
