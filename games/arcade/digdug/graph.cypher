...
// generated 2026-09-24T02:26:53.915Z
...
MERGE (n:KG {id: 'game:digdug'}) SET n:Game SET n += {name: 'digdug', year: '1982', company: 'Namco', fullname: 'Dig Dug (rev 2)', monitor: 'ROT90', cls: 'digdug_state', init: 'empty_init', flags: 'MACHINE_SUPPORTS_SAVE', kind: 'arcade', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 3587, sourceColumn: 1, sourceEndLine: 3587, classConstants: '{"m_galaga_gfxbank":0,"m_main_irq_mask":0,"m_sub_irq_mask":0,"m_sub2_nmi_mask":0}'};
...
MERGE (n:KG {id: 'handler:digdug_state.video_start'}) SET n:Handler SET n += {method: 'video_start', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 154, sourceColumn: 1, sourceEndLine: 170, sourceParameters: '', sourceBody: 'm_bg_select = 0;
	m_tx_color_mode = 0;
	m_bg_disable = 0;
	m_bg_color_bank = 0;
...
MERGE (n:KG {id: 'handler:digdug_state.bg_get_tile_info'}) SET n:Handler SET n += {method: 'bg_get_tile_info', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 103, sourceColumn: 1, sourceEndLine: 118, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'uint8_t *rom = memregion("gfx4")->base();
	...
	tileinfo.set(2,
			...
			0);'};
MERGE (n:KG {id: 'handler:digdug_state.tilemap_scan'}) SET n:Handler SET n += {method: 'tilemap_scan', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 92, sourceColumn: 1, sourceEndLine: 100, sourceParameters: 'u32 col, u32 row, u32 num_cols, u32 num_rows', sourceBody: 'row += 2;
	col -= 2;
	if (col & 0x20)
		return row + ((col & 0x1f) << 5);
	else
		return col + (row << 5);'};
MERGE (n:KG {id: 'handler:digdug_state.tx_get_tile_info'}) SET n:Handler SET n += {method: 'tx_get_tile_info', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 120, sourceColumn: 1, sourceEndLine: 144, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'uint8_t code = m_videoram[tile_index];
	int color;
...
MERGE (n:KG {id: 'machine:digdug_state.digdug'}) SET n:MachineConfig SET n += {cls: 'digdug_state', name: 'digdug', calls: [], stateMembers: ['{"name":"m_galaga_gfxbank","bits":32,"initial":0}', '{"name":"m_main_irq_mask","bits":8,"initial":0}', '{"name":"m_sub_irq_mask","bits":8,"initial":0}', '{"name":"m_sub2_nmi_mask","bits":8,"initial":0}', '{"name":"m_bg_select","bits":8}', '{"name":"m_tx_color_mode","bits":8}', '{"name":"m_bg_disable","bits":8}', '{"name":"m_bg_color_bank","bits":8}'], driverTimers: ['m_cpu3_interrupt_timer=galaga_state.cpu3_interrupt_callback'], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['digdug_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1875, sourceColumn: 1, sourceEndLine: 1952};
MERGE (n:KG {id: 'device:digdug_state.digdug/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, MASTER_CLOCK/6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &digdug_state::digdug_map)'], member: 'm_maincpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1878, sourceColumn: 2, sourceEndLine: 1878};
MERGE (n:KG {id: 'device:digdug_state.digdug/sub'}) SET n:Device SET n += {type: 'Z80', tag: 'sub', clock: 3072000, config: ['Z80(config, m_subcpu, MASTER_CLOCK/6)', 'm_subcpu->set_addrmap(AS_PROGRAM, &digdug_state::digdug_map)'], member: 'm_subcpu', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1881, sourceColumn: 2, sourceEndLine: 1881};
MERGE (n:KG {id: 'device:digdug_state.digdug/sub2'}) SET n:Device SET n += {type: 'Z80', tag: 'sub2', clock: 3072000, config: ['Z80(config, m_subcpu2, MASTER_CLOCK/6)', 'm_subcpu2->set_addrmap(AS_PROGRAM, &digdug_state::digdug_map)'], member: 'm_subcpu2', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1884, sourceColumn: 2, sourceEndLine: 1884};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:1'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'misclatch.q_out_cb<1>().set(FUNC(galaga_state::irq2_clear_w))', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1889, sourceColumn: 2, sourceEndLine: 1889, slot: '1', targetClass: 'galaga_state', targetMethod: 'irq2_clear_w'};
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:2'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'misclatch.q_out_cb<2>().set(FUNC(galaga_state::nmion_w))', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1890, sourceColumn: 2, sourceEndLine: 1890, slot: '2', targetClass: 'galaga_state', targetMethod: 'nmion_w'};
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:3'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set_inputline', raw: 'misclatch.q_out_cb<3>().set_inputline("sub", INPUT_LINE_RESET).invert()', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1891, sourceColumn: 2, sourceEndLine: 1891, slot: '3', transforms: ['invert'], targetTag: 'sub', inputLine: 'INPUT_LINE_RESET'};
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:4'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'append_inputline', raw: 'misclatch.q_out_cb<3>().append_inputline("sub2", INPUT_LINE_RESET).invert()', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1892, sourceColumn: 2, sourceEndLine: 1892, slot: '3', transforms: ['invert'], targetTag: 'sub2', inputLine: 'INPUT_LINE_RESET'};
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:5'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'append', raw: 'misclatch.q_out_cb<3>().append("51xx", FUNC(namco_51xx_device::reset))', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1893, sourceColumn: 2, sourceEndLine: 1893, slot: '3', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'reset'};
MERGE (n:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:6'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'append', raw: 'misclatch.q_out_cb<3>().append("53xx", FUNC(namco_53xx_device::reset))', ownerTag: 'misclatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1894, sourceColumn: 2, sourceEndLine: 1894, slot: '3', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'reset'};
MERGE (n:KG {id: 'handler:namco_53xx_device.reset'}) SET n:Handler SET n += {method: 'reset', ownerClass: 'namco_53xx_device', sourceFile: 'src/mame/namco/namco53.cpp', sourceLine: 63, sourceColumn: 1, sourceEndLine: 67, sourceParameters: 'int state', sourceBody: '// The incoming signal is active low
	m_cpu->set_input_line(INPUT_LINE_RESET, state ? CLEAR_LINE : ASSERT_LINE);'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx'}) SET n:Device SET n += {type: 'NAMCO_51XX', tag: '51xx', clock: 1536000, config: ['namco_51xx_device &n51xx(NAMCO_51XX(config, "51xx", MASTER_CLOCK/6/2))', 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', 'n51xx.output_callback().set(FUNC(galaga_state::out))', 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))'], cls: 'namco_51xx_device', clsHierarchy: ['namco_51xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1897, sourceColumn: 2, sourceEndLine: 1897, startHandler: 'namco_51xx_device.device_start'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:0'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1898, sourceColumn: 2, sourceEndLine: 1898, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:1'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1899, sourceColumn: 2, sourceEndLine: 1899, slot: '1', transforms: ['rshift(4)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:2'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1900, sourceColumn: 2, sourceEndLine: 1900, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:3'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1901, sourceColumn: 2, sourceEndLine: 1901, slot: '3', transforms: ['rshift(4)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:4'}) SET n:Callback SET n += {signal: 'output_callback', member: 'm_out', operation: 'set', raw: 'n51xx.output_callback().set(FUNC(galaga_state::out))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1902, sourceColumn: 2, sourceEndLine: 1902, targetClass: 'galaga_state', targetMethod: 'out'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:5'}) SET n:Callback SET n += {signal: 'lockout_callback', member: 'm_lockout', operation: 'set', raw: 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1903, sourceColumn: 2, sourceEndLine: 1903, targetClass: 'galaga_state', targetMethod: 'lockout'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx'}) SET n:Device SET n += {type: 'NAMCO_53XX', tag: '53xx', clock: 1536000, config: ['namco_53xx_device &n53xx(NAMCO_53XX(config, "53xx", MASTER_CLOCK/6/2))', 'n53xx.k_port_callback().set("misclatch", FUNC(ls259_device::q7_r)).lshift(3)', 'n53xx.k_port_callback().append("misclatch", FUNC(ls259_device::q6_r)).lshift(2)', 'n53xx.k_port_callback().append("misclatch", FUNC(ls259_device::q5_r)).lshift(1)', 'n53xx.input_callback<0>().set_ioport("DSWA").mask(0x0f)', 'n53xx.input_callback<1>().set_ioport("DSWA").rshift(4)', 'n53xx.input_callback<2>().set_ioport("DSWB").mask(0x0f)', 'n53xx.input_callback<3>().set_ioport("DSWB").rshift(4)'], cls: 'namco_53xx_device', clsHierarchy: ['namco_53xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1905, sourceColumn: 2, sourceEndLine: 1905, startHandler: 'namco_53xx_device.device_start'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:0'}) SET n:Callback SET n += {signal: 'k_port_callback', member: 'm_k', operation: 'set', raw: 'n53xx.k_port_callback().set("misclatch", FUNC(ls259_device::q7_r)).lshift(3)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1906, sourceColumn: 2, sourceEndLine: 1906, transforms: ['lshift(3)'], targetTag: 'misclatch', targetClass: 'ls259_device', targetMethod: 'q7_r'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:3'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n53xx.input_callback<0>().set_ioport("DSWA").mask(0x0f)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1910, sourceColumn: 2, sourceEndLine: 1910, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'DSWA', targetPort: 'DSWA'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:4'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n53xx.input_callback<1>().set_ioport("DSWA").rshift(4)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1911, sourceColumn: 2, sourceEndLine: 1911, slot: '1', transforms: ['rshift(4)'], targetTag: 'DSWA', targetPort: 'DSWA'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:5'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n53xx.input_callback<2>().set_ioport("DSWB").mask(0x0f)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1912, sourceColumn: 2, sourceEndLine: 1912, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'DSWB', targetPort: 'DSWB'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:6'}) SET n:Callback SET n += {signal: 'input_callback', member: 'm_in', operation: 'set_ioport', raw: 'n53xx.input_callback<3>().set_ioport("DSWB").rshift(4)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1913, sourceColumn: 2, sourceEndLine: 1913, slot: '3', transforms: ['rshift(4)'], targetTag: 'DSWB', targetPort: 'DSWB'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx'}) SET n:Device SET n += {type: 'NAMCO_06XX', tag: '06xx', clock: 48000, config: ['namco_06xx_device &n06xx(NAMCO_06XX(config, "06xx", MASTER_CLOCK/6/64))', 'n06xx.set_maincpu(m_maincpu)', 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', 'n06xx.chip_select_callback<1>().set("53xx", FUNC(namco_53xx_device::chip_select))', 'n06xx.read_callback<1>().set("53xx", FUNC(namco_53xx_device::read))'], cls: 'namco_06xx_device', clsHierarchy: ['namco_06xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1915, sourceColumn: 2, sourceEndLine: 1915, configCalls: ['set_maincpu("maincpu")'], startHandler: 'namco_06xx_device.device_start', deviceTimers: ['m_nmi_timer=namco_06xx_device.nmi_generate']};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:0'}) SET n:Callback SET n += {signal: 'nmi', operation: 'set_maincpu', raw: 'n06xx.set_maincpu(m_maincpu)', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1916, sourceColumn: 2, sourceEndLine: 1916, inputLine: 'INPUT_LINE_NMI', targetTag: 'maincpu'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:1'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1917, sourceColumn: 2, sourceEndLine: 1917, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:2'}) SET n:Callback SET n += {signal: 'rw_callback', member: 'm_rw', operation: 'set', raw: 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1918, sourceColumn: 2, sourceEndLine: 1918, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'rw'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:3'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1919, sourceColumn: 2, sourceEndLine: 1919, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'read'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:4'}) SET n:Callback SET n += {signal: 'write_callback', member: 'm_write', operation: 'set', raw: 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1920, sourceColumn: 2, sourceEndLine: 1920, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:5'}) SET n:Callback SET n += {signal: 'chip_select_callback', member: 'm_chipsel', operation: 'set', raw: 'n06xx.chip_select_callback<1>().set("53xx", FUNC(namco_53xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1921, sourceColumn: 2, sourceEndLine: 1921, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:6'}) SET n:Callback SET n += {signal: 'read_callback', member: 'm_read', operation: 'set', raw: 'n06xx.read_callback<1>().set("53xx", FUNC(namco_53xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1922, sourceColumn: 2, sourceEndLine: 1922, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'read'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/videolatch'}) SET n:Device SET n += {type: 'LS259', tag: 'videolatch', clock: null, config: ['LS259(config, m_videolatch)', 'm_videolatch->parallel_out_cb().set(FUNC(digdug_state::bg_select_w)).mask(0x33)', 'm_videolatch->q_out_cb<2>().set(FUNC(digdug_state::tx_color_mode_w))', 'm_videolatch->q_out_cb<3>().set(FUNC(digdug_state::bg_disable_w))', 'm_videolatch->q_out_cb<7>().set(FUNC(digdug_state::flip_screen_set))'], member: 'm_videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1924, sourceColumn: 2, sourceEndLine: 1924};
MERGE (n:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:0'}) SET n:Callback SET n += {signal: 'parallel_out_cb', operation: 'set', raw: 'm_videolatch->parallel_out_cb().set(FUNC(digdug_state::bg_select_w)).mask(0x33)', ownerTag: 'videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1925, sourceColumn: 2, sourceEndLine: 1925, transforms: ['mask(0x33)'], targetClass: 'digdug_state', targetMethod: 'bg_select_w'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:1'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'm_videolatch->q_out_cb<2>().set(FUNC(digdug_state::tx_color_mode_w))', ownerTag: 'videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1926, sourceColumn: 2, sourceEndLine: 1926, slot: '2', targetClass: 'digdug_state', targetMethod: 'tx_color_mode_w'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:2'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'm_videolatch->q_out_cb<3>().set(FUNC(digdug_state::bg_disable_w))', ownerTag: 'videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1927, sourceColumn: 2, sourceEndLine: 1927, slot: '3', targetClass: 'digdug_state', targetMethod: 'bg_disable_w'};
MERGE (n:KG {id: 'handler:digdug_state.bg_disable_w'}) SET n:Handler SET n += {method: 'bg_disable_w', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 210, sourceColumn: 1, sourceEndLine: 215, sourceParameters: 'int state', sourceBody: '// "disable" background (see bg_get_tile_info)
	m_bg_disable = state;
	m_bg_tilemap->mark_all_dirty();'};
MERGE (n:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:3'}) SET n:Callback SET n += {signal: 'q_out_cb', operation: 'set', raw: 'm_videolatch->q_out_cb<7>().set(FUNC(digdug_state::flip_screen_set))', ownerTag: 'videolatch', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1928, sourceColumn: 2, sourceEndLine: 1928, slot: '7', targetClass: 'digdug_state', targetMethod: 'flip_screen_set'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/earom'}) SET n:Device SET n += {type: 'ER2055', tag: 'earom', clock: null, config: ['ER2055(config, m_earom)'], member: 'm_earom', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1930, sourceColumn: 2, sourceEndLine: 1930};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(MASTER_CLOCK/3, 384, 0, 288, 264, 0, 224)', 'm_screen->set_screen_update(FUNC(digdug_state::screen_update_digdug))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set(FUNC(galaga_state::vblank_irq))', 'm_screen->screen_vblank().append("51xx", FUNC(namco_51xx_device::vblank))'], member: 'm_screen', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1937, sourceColumn: 2, sourceEndLine: 1937, configCalls: ['set_raw(6144000,384,0,288,264,0,224)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 0, 288, 264, 0, 224], screenRawExpr: ['MASTER_CLOCK/3', '384', '0', '288', '264', '0', '224']};
MERGE (n:KG {id: 'device:digdug_state.digdug/screen/callback:screen:0'}) SET n:Callback SET n += {signal: 'set_screen_update', operation: 'set_screen_update', raw: 'm_screen->set_screen_update(FUNC(digdug_state::screen_update_digdug))', ownerTag: 'screen', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1939, sourceColumn: 2, sourceEndLine: 1939, targetClass: 'digdug_state', targetMethod: 'screen_update_digdug'};
MERGE (n:KG {id: 'handler:digdug_state.screen_update_digdug'}) SET n:Handler SET n += {method: 'screen_update_digdug', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 287, sourceColumn: 1, sourceEndLine: 293, sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'm_bg_tilemap->draw(screen, bitmap, cliprect, 0,0);
	...
	return 0;'};
MERGE (n:KG {id: 'device:digdug_state.digdug/screen/callback:screen:1'}) SET n:Callback SET n += {signal: 'screen_vblank', operation: 'set', raw: 'm_screen->screen_vblank().set(FUNC(galaga_state::vblank_irq))', ownerTag: 'screen', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1941, sourceColumn: 2, sourceEndLine: 1941, targetClass: 'galaga_state', targetMethod: 'vblank_irq'};
MERGE (n:KG {id: 'device:digdug_state.digdug/screen/callback:screen:2'}) SET n:Callback SET n += {signal: 'screen_vblank', operation: 'append', raw: 'm_screen->screen_vblank().append("51xx", FUNC(namco_51xx_device::vblank))', ownerTag: 'screen', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1942, sourceColumn: 2, sourceEndLine: 1942, targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'vblank'};
MERGE (n:KG {id: 'device:digdug_state.digdug/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_digdug)'], member: 'm_gfxdecode', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1944, sourceColumn: 2, sourceEndLine: 1944, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:digdug_state.digdug/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(digdug_state::digdug_palette), 16*2 + 64*4 + 64*4, 32)'], member: 'm_palette', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1945, sourceColumn: 2, sourceEndLine: 1945, clockExpr: 'FUNC(digdug_state::digdug_palette)', paletteEntries: 32};
...
MERGE (n:KG {id: 'handler:namco_51xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_51xx_device', sourceFile: 'src/mame/namco/namco51.cpp', sourceLine: 158, sourceColumn: 1, sourceEndLine: 162, sourceParameters: '', sourceBody: 'save_item(NAME(m_portO));
	save_item(NAME(m_rw));'};
MERGE (n:KG {id: 'handler:namco_06xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_06xx_device', sourceFile: 'src/mame/namco/namco06.cpp', sourceLine: 256, sourceColumn: 1, sourceEndLine: 264, sourceParameters: '', sourceBody: '/* allocate a timer */
...
MERGE (n:KG {id: 'handler:namco_06xx_device.nmi_generate'}) SET n:Handler SET n += {method: 'nmi_generate', ownerClass: 'namco_06xx_device', sourceFile: 'src/mame/namco/namco06.cpp', sourceLine: 102, sourceColumn: 1, sourceEndLine: 133, sourceParameters: 'int param', sourceBody: '// This timer runs at twice the clock, since we do work on both the
...
MERGE (n:KG {id: 'handler:namco_53xx_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'namco_53xx_device', sourceFile: 'src/mame/namco/namco53.cpp', sourceLine: 125, sourceColumn: 1, sourceEndLine: 128, sourceParameters: '', sourceBody: 'save_item(NAME(m_portO));'};
...
MERGE (n:KG {id: 'inputs:digdug/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY'], defaultValue: 1};
MERGE (n:KG {id: 'inputs:digdug/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:digdug/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY'], defaultValue: 4};
MERGE (n:KG {id: 'inputs:digdug/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY'], defaultValue: 8};
MERGE (n:KG {id: 'inputs:digdug/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 16};
MERGE (n:KG {id: 'inputs:digdug/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 32};
MERGE (n:KG {id: 'inputs:digdug/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 64};
MERGE (n:KG {id: 'inputs:digdug/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 128};
MERGE (n:KG {id: 'inputs:digdug/IN1'}) SET n:Port SET n += {tag: 'IN1', modify: false};
MERGE (n:KG {id: 'inputs:digdug/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_BUTTON1', defaultValue: 1};
MERGE (n:KG {id: 'inputs:digdug/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 2};
MERGE (n:KG {id: 'inputs:digdug/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_START1', defaultValue: 4};
MERGE (n:KG {id: 'inputs:digdug/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_START2', defaultValue: 8};
MERGE (n:KG {id: 'inputs:digdug/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: true, type: 'IPT_COIN1', defaultValue: 16};
MERGE (n:KG {id: 'inputs:digdug/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: true, type: 'IPT_COIN2', defaultValue: 32};
MERGE (n:KG {id: 'inputs:digdug/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_SERVICE1', defaultValue: 64};
MERGE (n:KG {id: 'inputs:digdug/IN1/f7'}) SET n:PortField SET n += {kind: 'service', mask: 128, activeLow: true, defaultValue: 128};
MERGE (n:KG {id: 'inputs:digdug/DSWA'}) SET n:Port SET n += {tag: 'DSWA', modify: false};
MERGE (n:KG {id: 'inputs:digdug/DSWA/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, modifiers: ['PORT_DIPLOCATION("SWA:1,2,3")'], name: 'Coin B', defaultValue: 1, location: 'SWA:1,2,3', settings: ['7=3C 1C', '3=2C 1C', '1=1C 1C', '5=2C 3C', '6=1C 2C', '2=1C 3C', '4=1C 6C', '0=1C 7C']};
MERGE (n:KG {id: 'inputs:digdug/DSWA/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 56, modifiers: ['PORT_DIPLOCATION("SWA:4,5,6")'], name: 'Bonus Life', defaultValue: 24, location: 'SWA:4,5,6', settings: ['32=10K, 40K, Every 40K [if "DSWA",0xc0,NOTEQUALS,0xc0]', '16=10K, 50K, Every 50K [if "DSWA",0xc0,NOTEQUALS,0xc0]', '48=20K, 60K, Every 60K [if "DSWA",0xc0,NOTEQUALS,0xc0]', '8=20K, 70K, Every 70K [if "DSWA",0xc0,NOTEQUALS,0xc0]', '40=10K and 40K Only [if "DSWA",0xc0,NOTEQUALS,0xc0]', '24=20K and 60K Only [if "DSWA",0xc0,NOTEQUALS,0xc0]', '56=10K Only [if "DSWA",0xc0,NOTEQUALS,0xc0]', '0=None [if "DSWA",0xc0,NOTEQUALS,0xc0]', '32=20K, 60K, Every 60K [if "DSWA",0xc0,EQUALS,0xc0]', '16=30K, 80K, Every 80K [if "DSWA",0xc0,EQUALS,0xc0]', '48=20K and 50K Only [if "DSWA",0xc0,EQUALS,0xc0]', '8=20K and 60K Only [if "DSWA",0xc0,EQUALS,0xc0]', '40=30K and 70K Only [if "DSWA",0xc0,EQUALS,0xc0]', '24=20K Only [if "DSWA",0xc0,EQUALS,0xc0]', '56=30K Only [if "DSWA",0xc0,EQUALS,0xc0]', '0=None [if "DSWA",0xc0,EQUALS,0xc0]']};
MERGE (n:KG {id: 'inputs:digdug/DSWA/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("SWA:7,8")'], name: 'Lives', defaultValue: 128, location: 'SWA:7,8', settings: ['0=1', '64=2', '128=3', '192=5']};
MERGE (n:KG {id: 'inputs:digdug/DSWB'}) SET n:Port SET n += {tag: 'DSWB', modify: false};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 192, modifiers: ['PORT_DIPLOCATION("SWB:1,2")'], name: 'Coin A', defaultValue: 0, location: 'SWB:1,2', settings: ['64=2C 1C', '0=1C 1C', '192=2C 3C', '128=1C 2C']};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 32, modifiers: ['PORT_DIPLOCATION("SWB:3")'], name: 'Freeze', defaultValue: 32, location: 'SWB:3', settings: ['32=Off', '0=On']};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 16, modifiers: ['PORT_DIPLOCATION("SWB:4")'], name: 'Demo Sounds', defaultValue: 0, location: 'SWB:4', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 8, modifiers: ['PORT_DIPLOCATION("SWB:5")'], name: 'Allow Continue', defaultValue: 0, location: 'SWB:5', settings: ['8=No', '0=Yes']};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 4, modifiers: ['PORT_DIPLOCATION("SWB:6")'], name: 'Cabinet', defaultValue: 4, location: 'SWB:6', settings: ['4=Upright', '0=Cocktail']};
MERGE (n:KG {id: 'inputs:digdug/DSWB/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION("SWB:7,8")'], name: 'Difficulty', defaultValue: 0, location: 'SWB:7,8', settings: ['0=Easy', '2=Medium', '1=Hard', '3=Hardest']};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(digdug_state::digdug_palette), 16*2 + 64*4 + 64*4, 32)', ownerTag: 'palette', targetClass: 'digdug_state', targetMethod: 'digdug_palette', entries: 32, sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1945};
MERGE (n:KG {id: 'handler:digdug_state.digdug_palette'}) SET n:Handler SET n += {method: 'digdug_palette', ownerClass: 'digdug_state', sourceFile: 'src/mame/namco/digdug.cpp', sourceLine: 29, sourceColumn: 1, sourceEndLine: 81, sourceParameters: 'palette_device &palette', sourceBody: 'const uint8_t *color_prom = memregion("proms")->base();
...
MATCH (a:KG {id: 'machine:digdug_state.digdug'}), (b:KG {id: 'handler:galaga_state.machine_reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'machine:digdug_state.digdug'}), (b:KG {id: 'handler:digdug_state.video_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:digdug_state.video_start'}), (b:KG {id: 'handler:digdug_state.bg_get_tile_info'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:digdug_state.video_start'}), (b:KG {id: 'handler:digdug_state.tilemap_scan'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'handler:digdug_state.video_start'}), (b:KG {id: 'handler:digdug_state.tx_get_tile_info'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch'}), (b:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'machine:namco_51xx_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx'}), (b:KG {id: 'handler:namco_51xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'machine:namco_53xx_device.device_add_mconfig'}) MERGE (a)-[r:CALLS]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx'}), (b:KG {id: 'handler:namco_53xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:4'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:5'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:6'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx'}), (b:KG {id: 'handler:namco_06xx_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch'}), (b:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch'}), (b:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch'}), (b:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch'}), (b:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:3'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen'}), (b:KG {id: 'device:digdug_state.digdug/screen/callback:screen:0'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen'}), (b:KG {id: 'device:digdug_state.digdug/screen/callback:screen:1'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen'}), (b:KG {id: 'device:digdug_state.digdug/screen/callback:screen:2'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/palette'}), (b:KG {id: 'device:digdug_state.digdug/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:0'}), (b:KG {id: 'handler:galaga_state.irq1_clear_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:1'}), (b:KG {id: 'handler:galaga_state.irq2_clear_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:2'}), (b:KG {id: 'handler:galaga_state.nmion_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:3'}), (b:KG {id: 'device:digdug_state.digdug/sub'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:4'}), (b:KG {id: 'device:digdug_state.digdug/sub2'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:5'}), (b:KG {id: 'handler:namco_51xx_device.reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/misclatch/callback:misclatch:6'}), (b:KG {id: 'handler:namco_53xx_device.reset'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:4'}), (b:KG {id: 'handler:galaga_state.out'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:5'}), (b:KG {id: 'handler:galaga_state.lockout'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:0'}), (b:KG {id: 'handler:ls259_device.q7_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:0'}), (b:KG {id: 'device:digdug_state.digdug/misclatch'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:1'}), (b:KG {id: 'handler:ls259_device.q6_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:1'}), (b:KG {id: 'device:digdug_state.digdug/misclatch'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:2'}), (b:KG {id: 'handler:ls259_device.q5_r'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:2'}), (b:KG {id: 'device:digdug_state.digdug/misclatch'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:0'}), (b:KG {id: 'device:digdug_state.digdug/maincpu'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:1'}), (b:KG {id: 'handler:namco_51xx_device.chip_select'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:1'}), (b:KG {id: 'device:digdug_state.digdug/51xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:2'}), (b:KG {id: 'handler:namco_51xx_device.rw'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:2'}), (b:KG {id: 'device:digdug_state.digdug/51xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:3'}), (b:KG {id: 'handler:namco_51xx_device.read'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:3'}), (b:KG {id: 'device:digdug_state.digdug/51xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:4'}), (b:KG {id: 'handler:namco_51xx_device.write'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:4'}), (b:KG {id: 'device:digdug_state.digdug/51xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:5'}), (b:KG {id: 'handler:namco_53xx_device.chip_select'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:5'}), (b:KG {id: 'device:digdug_state.digdug/53xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:6'}), (b:KG {id: 'handler:namco_53xx_device.read'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:6'}), (b:KG {id: 'device:digdug_state.digdug/53xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
MATCH (a:KG {id: 'handler:namco_06xx_device.device_start'}), (b:KG {id: 'handler:namco_06xx_device.nmi_generate'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:0'}), (b:KG {id: 'handler:digdug_state.bg_select_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:1'}), (b:KG {id: 'handler:digdug_state.tx_color_mode_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:2'}), (b:KG {id: 'handler:digdug_state.bg_disable_w'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/videolatch/callback:videolatch:3'}), (b:KG {id: 'handler:digdug_state.flip_screen_set'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen/callback:screen:0'}), (b:KG {id: 'handler:digdug_state.screen_update_digdug'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen/callback:screen:1'}), (b:KG {id: 'handler:galaga_state.vblank_irq'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen/callback:screen:2'}), (b:KG {id: 'handler:namco_51xx_device.vblank'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
MATCH (a:KG {id: 'device:digdug_state.digdug/screen/callback:screen:2'}), (b:KG {id: 'device:digdug_state.digdug/51xx'}) MERGE (a)-[r:TARGETS_DEVICE]->(b);
...
MATCH (a:KG {id: 'device:digdug_state.digdug/palette/callback:palette_init'}), (b:KG {id: 'handler:digdug_state.digdug_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:namco_06xx_device.nmi_generate'}), (b:KG {id: 'handler:namco_06xx_device.set_nmi'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
