...
// generated 2026-09-11T11:44:15.502Z
...
MERGE (n:KG {id: 'handler:namco_53xx_device.reset'}) SET n:Handler SET n += {method: 'reset', ownerClass: 'namco_53xx_device', sourceFile: 'src/mame/namco/namco53.cpp', sourceLine: 63, sourceColumn: 1, sourceEndLine: 67, sourceParameters: 'int state', sourceBody: '// The incoming signal is active low
	m_cpu->set_input_line(INPUT_LINE_RESET, state ? CLEAR_LINE : ASSERT_LINE);'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx'}) SET n:Device SET n += {type: 'NAMCO_51XX', tag: '51xx', clock: 1536000, config: ['namco_51xx_device &n51xx(NAMCO_51XX(config, "51xx", MASTER_CLOCK/6/2))', 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', 'n51xx.output_callback().set(FUNC(galaga_state::out))', 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))'], cls: 'namco_51xx_device', clsHierarchy: ['namco_51xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1897, sourceColumn: 2, sourceEndLine: 1897};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:0'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n51xx.input_callback<0>().set_ioport("IN0").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1898, sourceColumn: 2, sourceEndLine: 1898, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:1'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n51xx.input_callback<1>().set_ioport("IN0").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1899, sourceColumn: 2, sourceEndLine: 1899, slot: '1', transforms: ['rshift(4)'], targetTag: 'IN0', targetPort: 'IN0'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:2'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n51xx.input_callback<2>().set_ioport("IN1").mask(0x0f)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1900, sourceColumn: 2, sourceEndLine: 1900, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:3'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n51xx.input_callback<3>().set_ioport("IN1").rshift(4)', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1901, sourceColumn: 2, sourceEndLine: 1901, slot: '3', transforms: ['rshift(4)'], targetTag: 'IN1', targetPort: 'IN1'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:4'}) SET n:Callback SET n += {signal: 'output_callback', operation: 'set', raw: 'n51xx.output_callback().set(FUNC(galaga_state::out))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1902, sourceColumn: 2, sourceEndLine: 1902, targetClass: 'galaga_state', targetMethod: 'out'};
MERGE (n:KG {id: 'device:digdug_state.digdug/51xx/callback:51xx:5'}) SET n:Callback SET n += {signal: 'lockout_callback', operation: 'set', raw: 'n51xx.lockout_callback().set(FUNC(galaga_state::lockout))', ownerTag: '51xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1903, sourceColumn: 2, sourceEndLine: 1903, targetClass: 'galaga_state', targetMethod: 'lockout'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:3'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n53xx.input_callback<0>().set_ioport("DSWA").mask(0x0f)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1910, sourceColumn: 2, sourceEndLine: 1910, slot: '0', transforms: ['mask(0x0f)'], targetTag: 'DSWA', targetPort: 'DSWA'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:4'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n53xx.input_callback<1>().set_ioport("DSWA").rshift(4)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1911, sourceColumn: 2, sourceEndLine: 1911, slot: '1', transforms: ['rshift(4)'], targetTag: 'DSWA', targetPort: 'DSWA'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:5'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n53xx.input_callback<2>().set_ioport("DSWB").mask(0x0f)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1912, sourceColumn: 2, sourceEndLine: 1912, slot: '2', transforms: ['mask(0x0f)'], targetTag: 'DSWB', targetPort: 'DSWB'};
MERGE (n:KG {id: 'device:digdug_state.digdug/53xx/callback:53xx:6'}) SET n:Callback SET n += {signal: 'input_callback', operation: 'set_ioport', raw: 'n53xx.input_callback<3>().set_ioport("DSWB").rshift(4)', ownerTag: '53xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1913, sourceColumn: 2, sourceEndLine: 1913, slot: '3', transforms: ['rshift(4)'], targetTag: 'DSWB', targetPort: 'DSWB'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx'}) SET n:Device SET n += {type: 'NAMCO_06XX', tag: '06xx', clock: 48000, config: ['namco_06xx_device &n06xx(NAMCO_06XX(config, "06xx", MASTER_CLOCK/6/64))', 'n06xx.set_maincpu(m_maincpu)', 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', 'n06xx.chip_select_callback<1>().set("53xx", FUNC(namco_53xx_device::chip_select))', 'n06xx.read_callback<1>().set("53xx", FUNC(namco_53xx_device::read))'], cls: 'namco_06xx_device', clsHierarchy: ['namco_06xx_device'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1915, sourceColumn: 2, sourceEndLine: 1915};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:1'}) SET n:Callback SET n += {signal: 'chip_select_callback', operation: 'set', raw: 'n06xx.chip_select_callback<0>().set("51xx", FUNC(namco_51xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1917, sourceColumn: 2, sourceEndLine: 1917, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'chip_select'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:2'}) SET n:Callback SET n += {signal: 'rw_callback', operation: 'set', raw: 'n06xx.rw_callback<0>().set("51xx", FUNC(namco_51xx_device::rw))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1918, sourceColumn: 2, sourceEndLine: 1918, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'rw'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:3'}) SET n:Callback SET n += {signal: 'read_callback', operation: 'set', raw: 'n06xx.read_callback<0>().set("51xx", FUNC(namco_51xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1919, sourceColumn: 2, sourceEndLine: 1919, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'read'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:4'}) SET n:Callback SET n += {signal: 'write_callback', operation: 'set', raw: 'n06xx.write_callback<0>().set("51xx", FUNC(namco_51xx_device::write))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1920, sourceColumn: 2, sourceEndLine: 1920, slot: '0', targetTag: '51xx', targetClass: 'namco_51xx_device', targetMethod: 'write'};
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:5'}) SET n:Callback SET n += {signal: 'chip_select_callback', operation: 'set', raw: 'n06xx.chip_select_callback<1>().set("53xx", FUNC(namco_53xx_device::chip_select))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1921, sourceColumn: 2, sourceEndLine: 1921, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'chip_select'};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/06xx/callback:06xx:6'}) SET n:Callback SET n += {signal: 'read_callback', operation: 'set', raw: 'n06xx.read_callback<1>().set("53xx", FUNC(namco_53xx_device::read))', ownerTag: '06xx', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1922, sourceColumn: 2, sourceEndLine: 1922, slot: '1', targetTag: '53xx', targetClass: 'namco_53xx_device', targetMethod: 'read'};
