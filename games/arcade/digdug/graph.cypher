...
// generated 2026-09-05T03:49:27.042Z
...
MERGE (n:KG {id: 'machine:digdug_state.digdug'}) SET n:MachineConfig SET n += {cls: 'digdug_state', name: 'digdug', calls: [], stateMembers: ['{"name":"m_galaga_gfxbank","bits":32}', '{"name":"m_main_irq_mask","bits":8}', '{"name":"m_sub_irq_mask","bits":8}', '{"name":"m_sub2_nmi_mask","bits":8}', '{"name":"m_bg_select","bits":8}', '{"name":"m_tx_color_mode","bits":8}', '{"name":"m_bg_disable","bits":8}', '{"name":"m_bg_color_bank","bits":8}'], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['digdug_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1875, sourceColumn: 1, sourceEndLine: 1952};
...
MERGE (n:KG {id: 'device:digdug_state.digdug/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_digdug)'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1944, sourceColumn: 2, sourceEndLine: 1944, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:digdug_state.digdug/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(digdug_state::digdug_palette), 16*2 + 64*4 + 64*4, 32)'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1945, sourceColumn: 2, sourceEndLine: 1945, clockExpr: 'FUNC(digdug_state::digdug_palette)'};
