...
// generated 2026-08-22T05:52:14.694Z
...
MERGE (n:KG {id: 'machine:digdug_state.digdug'}) SET n:MachineConfig SET n += {cls: 'digdug_state', name: 'digdug', calls: [], resetHandlers: ['galaga_state.machine_reset'], startHandlers: ['digdug_state.video_start'], sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1875, sourceColumn: 1, sourceEndLine: 1952};
