...
// generated 2026-09-17T07:11:45.162Z
...
MERGE (n:KG {id: 'device:digdug_state.digdug/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(digdug_state::digdug_palette), 16*2 + 64*4 + 64*4, 32)'], member: 'm_palette', sourceFile: 'src/mame/namco/galaga.cpp', sourceLine: 1945, sourceColumn: 2, sourceEndLine: 1945, clockExpr: 'FUNC(digdug_state::digdug_palette)'};
