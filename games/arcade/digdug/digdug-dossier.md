...
![marquee](/artwork/media/marquees/digdug.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/digdug.webp) | ![cabinet](/artwork/media/cabinets/digdug.webp) |
...
- **Credited by MAMEDEV:** Nicola Salmoria (driver header); hap (6 release notes); hackbar (4 release notes); Osso (2 release notes); Aaron Giles (1 release note); AJR (1 release note); Angelo Salese (1 release note); ClawGrip (1 release note); neSneSgB (1 release note); Recreativas.org (1 release note); s.ronco (1 release note); Xavier Panadero (1 release note)
