...
MAME source coverage: **180/215 nodes (83.7%)**

| Stage | Count | Meaning |
|---|---:|---|
| Executable | 19 | Hardware lowered from MAME source to executable IR |
| Generated | 56 | Wiring, handlers, schedules and composition emitted from source/KG |
...
- `palette.palette_init -> digdug_state.digdug_palette` - src/mame/namco/galaga.cpp:1945
