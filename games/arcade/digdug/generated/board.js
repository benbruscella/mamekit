...
defined.compiledHandlers = {
    ...(() => {
        const methods = (() => {
            ...
            function method_digdug_videoram_w(runtime, offset, data) {
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                let spriteram = runtime.addressOf(h_m_digdug_objram, 896);
                let spriteram_2 = runtime.addressOf(h_m_digdug_posram, 896);
                let spriteram_3 = runtime.addressOf(h_m_digdug_flpram, 896);
                let offs = ((0) | 0);
                let visarea = Object.assign(Object.create(Object.getPrototypeOf(cliprect)), cliprect);
                visarea.min_x = 16;
                visarea.max_x = 271;
                for (offs = ((0) | 0); ((Number(offs) < Number(128)) ? 1 : 0); offs = ((((offs) + (2))) | 0)) {
                    let sprite = ((runtime.readIndex(spriteram, offs)) | 0);
                    let color = ((((runtime.readIndex(spriteram, ((offs) + (1)))) & (63))) | 0);
                    let sx = ((runtime.add(((runtime.readIndex(spriteram_2, ((offs) + (1)))) - (40)), 1)) | 0);
                    let sy = ((runtime.add(((256) - (runtime.readIndex(spriteram_2, offs))), 1)) | 0);
                    let flipx = ((((runtime.readIndex(spriteram_3, offs)) & (1))) | 0);
                    let flipy = ((runtime.shiftRight(((runtime.readIndex(spriteram_3, offs)) & (2)), 1)) | 0);
                    let size = ((runtime.shiftRight(((sprite) & (128)), 7)) | 0);
                    let x = ((0) | 0);
                    let y = ((0) | 0);
                    if (size) {
                        sprite = ((((((sprite) & (192))) | (((((sprite) & (-193))) << (2))))) | 0);
                    }
                    sy = ((((sy) - (((16) * (size))))) | 0);
                    sy = ((((((sy) & (255))) - (32))) | 0);
                    ...
                    for (y = ((0) | 0); ((Number(y) <= Number(size)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
                        for (x = ((0) | 0); ((Number(x) <= Number(size)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                            let transmask = (((__l["m_palette.transpen_mask"] ? __l["m_palette.transpen_mask"](runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : 0)), color, 31) : (members.m_palette) != null ? ((runtime.dereference(members.m_palette)).transpen_mask?.(runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : 0)), color, 31) ?? 0) : 0)) >>> 0);
                            ((runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : 0))).transmask?.(bitmap, visarea, ((sprite) + ((__mame_table_0[(((runtime.add(((((y) ^ (((size) * (flipy))))) * (2)), ((x) ^ (((size) * (flipx)))))) % 4) + 4) % 4] ?? 0))), color, flipx, flipy, ((((sx) + (((16) * (x))))) & (255)), ((sy) + (((16) * (y)))), transmask) ?? 0);
                            ((runtime.dereference((__l["m_gfxdecode.gfx"] ? __l["m_gfxdecode.gfx"](1) : (members.m_gfxdecode) != null ? ((runtime.dereference(members.m_gfxdecode)).gfx?.(1) ?? 0) : 0))).transmask?.(bitmap, visarea, ((sprite) + ((__mame_table_0[(((runtime.add(((((y) ^ (((size) * (flipy))))) * (2)), ((x) ^ (((size) * (flipx)))))) % 4) + 4) % 4] ?? 0))), color, flipx, flipy, runtime.add(((((sx) + (((16) * (x))))) & (255)), 256), ((sy) + (((16) * (y)))), transmask) ?? 0);
                        }
                    }
                }
            }
    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_tx_get_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                let code = ((runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index)) & 0xff);
                let color = ((0) | 0);
                if ((members.m_tx_color_mode ?? runtime.member("m_tx_color_mode"))) {
                    color = ((((code) & (15))) | 0);
                }
                else {
                    color = ((((((runtime.shiftRight(code, 4)) & (14))) | (((runtime.shiftRight(code, 3)) & (2))))) | 0);
                }
                (__l["tileinfo.set"] ? __l["tileinfo.set"](0, ((((code) & (127))) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (128) : (0)))), color, (((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))) : (tileinfo) != null ? ((runtime.dereference(tileinfo)).set?.(0, ((((code) & (127))) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (128) : (0)))), color, (((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))) ?? 0) : (__l["set"]?.(0, ((((code) & (127))) | ((((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (128) : (0)))), color, (((__l["flip_screen"] ? __l["flip_screen"]() : runtime.macro("flip_screen"))) ? (1) : (0))) ?? 0));
            }
            function method_draw_sprites(runtime, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_bg_select_w(runtime, data) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_tx_color_mode_w(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
            ...
            function method_bg_disable_w(runtime, state) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                members.m_bg_disable = ((state) & 0xff);
                (__l["m_bg_tilemap.mark_all_dirty"] ? __l["m_bg_tilemap.mark_all_dirty"]() : (members.m_bg_tilemap) != null ? (typeof (runtime.dereference(members.m_bg_tilemap)).mark_all_dirty === 'function' ? (runtime.dereference(members.m_bg_tilemap)).mark_all_dirty() : typeof (runtime.dereference(members.m_bg_tilemap)).mark_all_dirty === 'number' || typeof (runtime.dereference(members.m_bg_tilemap)).mark_all_dirty === 'boolean' ? (runtime.dereference(members.m_bg_tilemap)).mark_all_dirty : runtime.container(members.m_bg_tilemap, "mark_all_dirty")) : (__l["mark_all_dirty"]?.() ?? 0));
            }
            function method_screen_update_digdug(runtime, screen, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
...
defined.compiledHandlerLinks = ["draw", "flip_screen", "m_bg_tilemap.draw", "m_bg_tilemap.mark_all_dirty", "m_earom.data", "m_earom.set_address", "m_earom.set_clk", "m_earom.set_control", "m_earom.set_data", "m_fg_tilemap.draw", "m_fg_tilemap.mark_all_dirty", "m_fg_tilemap.mark_tile_dirty", "m_gfxdecode.gfx", "m_maincpu.set_input_line", "m_palette.transpen_mask", "m_subcpu.set_input_line", "mark_all_dirty", "mark_tile_dirty", "set", "tileinfo.set"];
export default {
    machine: defined,
