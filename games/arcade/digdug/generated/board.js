        ...
        const methods = (() => {
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (offs = 0; ((Number(offs) < Number(128)) ? 1 : 0); offs = ((offs) + (2))) {
                    let sprite = runtime.readIndex(spriteram, offs);
                    let color = ((runtime.readIndex(spriteram, ((offs) + (1)))) & (63));
                    let sx = runtime.add(((runtime.readIndex(spriteram_2, ((offs) + (1)))) - (40)), 1);
