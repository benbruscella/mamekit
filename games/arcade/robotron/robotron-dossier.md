# Robotron: 2084 (Release 5, solid blue label)

**Williams / Vid Kidz · 1982** — transpiled from the MAME driver `src/mame/williams/williams.cpp` by mamekit.

![marquee](/artwork/media/marquees/robotron.webp)

| Cover | Cabinet |
| --- | --- |
| ![flyer](/artwork/covers/robotron.webp) | ![cabinet](/artwork/media/cabinets/robotron.webp) |
...
| --- | --- | --- | --- | --- |
| `maincpu` | `2084_rom_1b_3005-13.e4` | 0x0 | 0x1000 | `66c7d3ef` |
| `maincpu` | `2084_rom_2b_3005-14.c4` | 0x1000 | 0x1000 | `5bc6c614` |
| `maincpu` | `2084_rom_3b_3005-15.a4` | 0x2000 | 0x1000 | `e99a82be` |
| `maincpu` | `2084_rom_4b_3005-16.e5` | 0x3000 | 0x1000 | `afb1c561` |
| `maincpu` | `2084_rom_5b_3005-17.c5` | 0x4000 | 0x1000 | `62691e77` |
| `maincpu` | `2084_rom_6b_3005-18.a5` | 0x5000 | 0x1000 | `bd2c853d` |
| `maincpu` | `2084_rom_7b_3005-19.e6` | 0x6000 | 0x1000 | `49ac400c` |
| `maincpu` | `2084_rom_8b_3005-20.c6` | 0x7000 | 0x1000 | `3a96e88c` |
| `maincpu` | `2084_rom_9b_3005-21.a6` | 0x8000 | 0x1000 | `b124367b` |
| `maincpu` | `2084_rom_10b_3005-22.a7` | 0xd000 | 0x1000 | `13797024` |
| `maincpu` | `2084_rom_11b_3005-23.c7` | 0xe000 | 0x1000 | `7e3c1b87` |
| `maincpu` | `2084_rom_12b_3005-24.e7` | 0xf000 | 0x1000 | `645d543e` |
| `soundcpu` | `video_sound_rom_3_std_767.ic12` | 0xf000 | 0x1000 | `c56c1d28` |
...
| S | move down | `IN0` | 0x2 |
| A | move left | `IN0` | 0x4 |
| D | move right | `IN0` | 0x8 |
| 1 | start1 | `IN0` | 0x10 |
| 2 | start2 | `IN0` | 0x20 |
| I | fire up | `IN0` | 0x40 |
| K | fire down | `IN0` | 0x80 |
| J | fire left | `IN1` | 0x1 |
| L | fire right | `IN1` | 0x2 |
...
### Contribute
Edit this entry: https://www.arcade-history.com/game/2243/?o=2

*Story courtesy of Gaming History (arcade-history.com).*

---

*Generated by [mamekit](https://github.com/benbruscella/mamekit) from the knowledge graph of MAME driver `williams`. Play it at [../../../app/g/robotron/](../../../app/g/robotron/) or [explore the knowledge graph](viewer.html).*
