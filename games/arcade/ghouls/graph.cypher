...
// generated 2026-08-22T05:52:24.296Z
...
MERGE (n:KG {id: 'inputs:cps1_2b/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_UNKNOWN'};
MERGE (n:KG {id: 'inputs:cps1_2b/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 16384, activeLow: true, type: 'IPT_UNKNOWN'};
...
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_PLAYER(1)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_PLAYER(1)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_PLAYER(1)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_PLAYER(1)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 256, activeLow: true, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 512, activeLow: true, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 1024, activeLow: true, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_PLAYER(2)']};
MERGE (n:KG {id: 'inputs:cps1_2b_4way/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 2048, activeLow: true, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_PLAYER(2)']};
...
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, name: 'Lives', defaultValue: 3, location: 'SW(C):1,2', settings: ['3=3', '2=4', '1=5', '0=6']};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 4, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 16, name: 'Flip Screen', defaultValue: 16, location: 'SW(C):5', settings: ['16=Off', '0=On']};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 32, name: 'Demo Sounds', defaultValue: 32, location: 'SW(C):6', settings: ['32=On', '0=Off']};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f5'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Allow Continue', defaultValue: 64, location: 'SW(C):7', settings: ['0=No', '64=Yes']};
MERGE (n:KG {id: 'inputs:ghouls/DSWC/f6'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Game Mode', defaultValue: 128, location: 'SW(C):8', settings: ['128=Game', '0=Test']};
MERGE (n:KG {id: 'inputs:ghouls/DSWB'}) SET n:Port SET n += {tag: 'DSWB', modify: false};
MERGE (n:KG {id: 'inputs:ghouls/DSWB/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, name: 'Difficulty', defaultValue: 5, location: 'SW(B):1,2,3', settings: ['4=1 (Easiest)', '5=2', '6=3', '7=4 (Normal)', '3=5', '2=6', '1=7', '0=8 (Hardest)']};
MERGE (n:KG {id: 'inputs:ghouls/DSWB/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 8, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ghouls/DSWB/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 48, name: 'Bonus Life', defaultValue: 48, location: 'SW(B):5,6', settings: ['32=10K, 30K and every 30K', '16=20K, 50K and every 70K', '48=30K, 60K and every 70K', '0=40K, 70K and every 80K']};
MERGE (n:KG {id: 'inputs:ghouls/DSWB/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 64, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ghouls/DSWB/f4'}) SET n:PortField SET n += {kind: 'dip', mask: 128, name: 'Unused'};
MERGE (n:KG {id: 'inputs:ghouls/DSWA'}) SET n:Port SET n += {tag: 'DSWA', modify: false};
MERGE (n:KG {id: 'inputs:ghouls/DSWA/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 7, name: 'Coin A', defaultValue: 7, location: 'SW(A)" ":1,2,3', settings: ['0=4C 1C', '1=3C 1C', '2=2C 1C', '7=1C 1C', '6=1C 2C', '5=1C 3C', '4=1C 4C', '3=1C 6C']};
MERGE (n:KG {id: 'inputs:ghouls/DSWA/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 56, name: 'Coin B', defaultValue: 56, location: 'SW(A)" ":4,5,6', settings: ['0=4C 1C', '8=3C 1C', '16=2C 1C', '56=1C 1C', '48=1C 2C', '40=1C 3C', '32=1C 4C', '24=1C 6C']};
MERGE (n:KG {id: 'inputs:ghouls/DSWA/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 192, name: 'Cabinet', defaultValue: 192, location: 'SW(A):7,8', settings: ['192=Upright 1 Player', '128=Upright 2 Players', '0=Cocktail']};
