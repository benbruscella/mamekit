...
defined.compiledHandlers = {
  ...
  function method_layer_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_get_fg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    ...
    let code: any = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((attr) & (224))) << (2)));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = (((members.m_spriteram).length) - (32)); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((offs) - (32))) {
      let attr: any = runtime.readIndex(spriteram, ((offs) + (1)));
      let bank: any = ((((attr) & (192))) >>> (6));
      let code: any = runtime.readIndex(spriteram, offs);
      let color: any = ((attr) & (15));
      let flipx: any = 0;
      let flipy: any = ((attr) & (16));
      let sx: any = ((runtime.readIndex(spriteram, ((offs) + (3)))) - (((((attr) & (32))) << (3))));
