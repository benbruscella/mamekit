    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_fg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let code = ((runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((attr) & (224))) << (2)))) | 0);
                let color = ((((attr) & (31))) | 0);
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (let offs = (((((members.m_spriteram).length) - (32))) | 0); ((Number(offs) >= Number(0)) ? 1 : 0); offs = ((((offs) - (32))) | 0)) {
                    let attr = ((runtime.readIndex(spriteram, ((offs) + (1)))) | 0);
                    let bank = ((runtime.shiftRight(((attr) & (192)), 6)) | 0);
                    let code = ((runtime.readIndex(spriteram, offs)) | 0);
                    let color = ((((attr) & (15))) | 0);
                    let flipx = ((0) | 0);
                    let flipy = ((((attr) & (16))) | 0);
                    let sx = ((((runtime.readIndex(spriteram, ((offs) + (3)))) - (((((attr) & (32))) << (3))))) | 0);
