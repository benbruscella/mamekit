...
// generated 2026-09-24T02:27:34.146Z
...
MERGE (n:KG {id: 'device:gunsmoke_state.gunsmoke/spriteram'}) SET n:Device SET n += {type: 'BUFFERED_SPRITERAM8', tag: 'spriteram', clock: null, config: ['BUFFERED_SPRITERAM8(config, m_spriteram)'], member: 'm_spriteram', sourceFile: 'src/mame/capcom/gunsmoke.cpp', sourceLine: 574, sourceColumn: 2, sourceEndLine: 574};
MERGE (n:KG {id: 'device:gunsmoke_state.gunsmoke/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(12_MHz_XTAL / 2, 384, 0, 256, 262, 16, 240)', 'screen.set_screen_update(FUNC(gunsmoke_state::screen_update))', 'screen.set_palette(m_palette)'], sourceFile: 'src/mame/capcom/gunsmoke.cpp', sourceLine: 576, sourceColumn: 2, sourceEndLine: 576, configCalls: ['set_raw(6000000,384,0,256,262,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6000000, 384, 0, 256, 262, 16, 240], screenRawExpr: ['12_MHz_XTAL / 2', '384', '0', '256', '262', '16', '240']};
...
MERGE (n:KG {id: 'device:gunsmoke_state.gunsmoke/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_gunsmoke)'], member: 'm_gfxdecode', sourceFile: 'src/mame/capcom/gunsmoke.cpp', sourceLine: 581, sourceColumn: 2, sourceEndLine: 581, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:gunsmoke_state.gunsmoke/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(gunsmoke_state::palette), 32*4 + 16*16 + 16*16, 256)'], member: 'm_palette', sourceFile: 'src/mame/capcom/gunsmoke.cpp', sourceLine: 583, sourceColumn: 2, sourceEndLine: 583, clockExpr: 'FUNC(gunsmoke_state::palette)', paletteEntries: 256};
