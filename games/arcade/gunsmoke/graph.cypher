...
// generated 2026-09-11T11:44:27.121Z
...
MERGE (n:KG {id: 'device:gunsmoke_state.gunsmoke/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(gunsmoke_state::palette), 32*4 + 16*16 + 16*16, 256)'], member: 'm_palette', sourceFile: 'src/mame/capcom/gunsmoke.cpp', sourceLine: 583, sourceColumn: 2, sourceEndLine: 583, clockExpr: 'FUNC(gunsmoke_state::palette)'};
