...
MAME source coverage: **156/202 nodes (77.2%)**

| Stage | Count | Meaning |
|---|---:|---|
| Executable | 15 | Hardware lowered from MAME source to executable IR |
| Generated | 36 | Wiring, handlers, schedules and composition emitted from source/KG |
...
- `virtual_p2.read_cb<6> -> ls259.4h.bit1_r` - src/mame/nintendo/dkong_a.cpp:1409
...
- `soundcpu.p2_in_cb -> virtual_p2.read` - src/mame/nintendo/dkong_a.cpp:1418
