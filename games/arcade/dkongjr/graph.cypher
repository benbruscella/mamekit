...
// generated 2026-09-24T02:26:55.444Z
...
MERGE (n:KG {id: 'handler:latch8_device.read'}) SET n:Handler SET n += {method: 'read', ownerClass: 'latch8_device', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1418, sourceColumn: 2, sourceEndLine: 1418};
...
MERGE (n:KG {id: 'machine:dkong_state.dkong_base'}) SET n:MachineConfig SET n += {cls: 'dkong_state', name: 'dkong_base', calls: [], stateMembers: ['{"name":"m_hardware_type","bits":8}', '{"name":"m_nmi_mask","bits":8}', '{"name":"m_vidhw","bits":8,"signed":true}', '{"name":"m_gfx3_len","bits":32,"signed":true}', '{"name":"m_sig30Hz","bits":8}', '{"name":"m_lfsr_5I","bits":8}', '{"name":"m_grid_sig","bits":8}', '{"name":"m_rflip_sig","bits":8}', '{"name":"m_star_ff","bits":8}', '{"name":"m_blue_level","bits":8}', '{"name":"m_decrypt_counter","bits":8,"signed":true}', '{"name":"m_protect_type","bits":8}', '{"name":"m_hunchloopback","bits":8}', '{"name":"m_prot_cnt","bits":8}', '{"name":"m_main_fo","bits":8}', '{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_grid_on","bits":8}', '{"name":"m_grid_col","bits":16}', '{"name":"m_sprite_bank","bits":8}', '{"name":"m_dma_latch","bits":8}', '{"name":"m_flip","bits":8}', '{"name":"m_pixelcnt","bits":32,"signed":true}', '{"name":"m_counter","bits":32,"signed":true}', '{"name":"m_rev_map","bits":16,"signed":true,"arrayLength":512}'], startHandlers: ['dkong_state.video_start_dkong'], sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1770, sourceColumn: 1, sourceEndLine: 1801};
MERGE (n:KG {id: 'handler:dkong_state.video_start_dkong'}) SET n:Handler SET n += {method: 'video_start_dkong', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 933, sourceColumn: 1, sourceEndLine: 963, sourceConstants: ['HARDWARE_TKG04=0', 'HARDWARE_TRS01=1', 'HARDWARE_TRS02=2', 'HARDWARE_TKG02=3'], sourceParameters: '', sourceBody: 'VIDEO_START_CALL_MEMBER(dkong_base);
...
MERGE (n:KG {id: 'handler:dkong_state.scanline_callback'}) SET n:Handler SET n += {method: 'scanline_callback', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 852, sourceColumn: 1, sourceEndLine: 866, sourceConstants: ['VTOTAL=264', 'HARDWARE_TRS01=1', 'HARDWARE_TRS02=2'], sourceParameters: 'int param', sourceBody: 'int scanline = param;
...
MERGE (n:KG {id: 'handler:dkong_state.radarscp_scanline'}) SET n:Handler SET n += {method: 'radarscp_scanline', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 819, sourceColumn: 1, sourceEndLine: 850, sourceConstants: ['RADARSCP_BCK_COL_OFFSET=256', 'RADARSCP_GRID_COL_OFFSET=512', 'RADARSCP_STAR_COL=520'], sourceParameters: 'int scanline', sourceBody: 'uint8_t const *const table = m_gfx3;
	...
	while ((m_counter < table_len) && (x < 4 * (table[m_counter|offset] & 0x7f)))
		m_counter++;'};
MERGE (n:KG {id: 'handler:dkong_state.radarscp_step'}) SET n:Handler SET n += {method: 'radarscp_step', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 670, sourceColumn: 1, sourceEndLine: 792, sourceConstants: ['B=81', 'HTOTAL=384', 'VTOTAL=264', 'HARDWARE_TRS01=1'], sourceParameters: 'int line_cnt', sourceBody: '/* Condensator is illegible in schematics for TRS2 board.
...
MERGE (n:KG {id: 'handler:dkong_state.radarscp1_bg_tile_info'}) SET n:Handler SET n += {method: 'radarscp1_bg_tile_info', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 439, sourceColumn: 1, sourceEndLine: 446, sourceParameters: 'tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index', sourceBody: 'int code = m_video_ram[tile_index] + 256 * m_gfx_bank;
	...
	tileinfo.set(0, code, color, 0);'};
MERGE (n:KG {id: 'device:dkong_state.dkong_base/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, CLOCK_1H)', 'm_maincpu->set_addrmap(AS_PROGRAM, &dkong_state::dkong_map)', 'downcast<z80_device &>(*m_maincpu).busack_cb().set(m_dma8257, FUNC(i8257_device::hlda_w))'], member: 'm_maincpu', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1773, sourceColumn: 2, sourceEndLine: 1773};
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/dma8257'}) SET n:Device SET n += {type: 'I8257', tag: 'dma8257', clock: 3072000, config: ['I8257(config, m_dma8257, CLOCK_1H)', 'm_dma8257->out_hrq_cb().set_inputline(m_maincpu, Z80_INPUT_LINE_BUSREQ)', 'm_dma8257->in_memr_cb().set(FUNC(dkong_state::memory_read_byte))', 'm_dma8257->out_memw_cb().set(FUNC(dkong_state::memory_write_byte))', 'm_dma8257->in_ior_cb<1>().set(FUNC(dkong_state::p8257_ctl_r))', 'm_dma8257->out_iow_cb<0>().set(FUNC(dkong_state::p8257_ctl_w))', 'm_dma8257->set_reverse_rw_mode(true)'], member: 'm_dma8257'};
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['SCREEN(config, m_screen, SCREEN_TYPE_RASTER)', 'm_screen->set_raw(PIXEL_CLOCK, HTOTAL, HBEND, HBSTART, VTOTAL, VBEND, VBSTART)', 'm_screen->set_screen_update(FUNC(dkong_state::screen_update_dkong))', 'm_screen->set_palette(m_palette)', 'm_screen->screen_vblank().set(FUNC(dkong_state::vblank_irq))'], member: 'm_screen', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1791, sourceColumn: 2, sourceEndLine: 1791, configCalls: ['set_raw(6144000,384,0,256,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 0, 256, 264, 16, 240], screenRawExpr: ['PIXEL_CLOCK', 'HTOTAL', 'HBEND', 'HBSTART', 'VTOTAL', 'VBEND', 'VBSTART']};
...
MERGE (n:KG {id: 'handler:dkong_state.screen_update_dkong'}) SET n:Handler SET n += {method: 'screen_update_dkong', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 965, sourceColumn: 1, sourceEndLine: 987, sourceConstants: ['HARDWARE_TKG04=0', 'HARDWARE_TRS01=1', 'HARDWARE_TRS02=2', 'HARDWARE_TKG02=3'], sourceParameters: 'screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'machine().tilemap().set_flip_all(m_flip ? TILEMAP_FLIPX | TILEMAP_FLIPY : 0);
	...
	return 0;'};
MERGE (n:KG {id: 'handler:dkong_state.check_palette'}) SET n:Handler SET n += {method: 'check_palette', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 868, sourceColumn: 1, sourceEndLine: 891, sourceConstants: ['DKONG_RADARSCP_CONVERSION=0', 'DKONG_BOARD=1'], sourceParameters: '', sourceBody: 'ioport_port *port;
	int newset;
...
MERGE (n:KG {id: 'handler:dkong_state.radarscp_palette'}) SET n:Handler SET n += {method: 'radarscp_palette', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 261, sourceColumn: 1, sourceEndLine: 319, sourceConstants: ['RADARSCP_BCK_COL_OFFSET=256', 'RADARSCP_GRID_COL_OFFSET=512', 'RADARSCP_STAR_COL=520', 'DKONG_RADARSCP_CONVERSION=0'], sourceParameters: 'palette_device &palette', sourceBody: 'const uint8_t *color_prom = memregion("proms")->base();
...
MERGE (n:KG {id: 'handler:dkong_state.radarscp_draw_background'}) SET n:Handler SET n += {method: 'radarscp_draw_background', ownerClass: 'dkong_state', sourceFile: 'src/mame/nintendo/dkong_v.cpp', sourceLine: 794, sourceColumn: 1, sourceEndLine: 817, sourceConstants: ['HARDWARE_TRS01=1'], sourceParameters: 'bitmap_ind16 &bitmap, const rectangle &cliprect', sourceBody: 'const uint8_t     *htable = nullptr;
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_dkong)'], member: 'm_gfxdecode', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1797, sourceColumn: 2, sourceEndLine: 1797, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:dkong_state.dkong_base/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(dkong_state::dkong2b_palette), DK2B_PALETTE_LENGTH)'], member: 'm_palette', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1798, sourceColumn: 2, sourceEndLine: 1798, clockExpr: 'FUNC(dkong_state::dkong2b_palette)', paletteEntries: 521};
MERGE (n:KG {id: 'machine:dkong_state.dkongjr'}) SET n:MachineConfig SET n += {cls: 'dkong_state', name: 'dkongjr', calls: ['dkong_base', 'dkongjr_audio'], stateMembers: ['{"name":"m_hardware_type","bits":8}', '{"name":"m_nmi_mask","bits":8}', '{"name":"m_vidhw","bits":8,"signed":true}', '{"name":"m_gfx3_len","bits":32,"signed":true}', '{"name":"m_sig30Hz","bits":8}', '{"name":"m_lfsr_5I","bits":8}', '{"name":"m_grid_sig","bits":8}', '{"name":"m_rflip_sig","bits":8}', '{"name":"m_star_ff","bits":8}', '{"name":"m_blue_level","bits":8}', '{"name":"m_decrypt_counter","bits":8,"signed":true}', '{"name":"m_protect_type","bits":8}', '{"name":"m_hunchloopback","bits":8}', '{"name":"m_prot_cnt","bits":8}', '{"name":"m_main_fo","bits":8}', '{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_grid_on","bits":8}', '{"name":"m_grid_col","bits":16}', '{"name":"m_sprite_bank","bits":8}', '{"name":"m_dma_latch","bits":8}', '{"name":"m_flip","bits":8}', '{"name":"m_pixelcnt","bits":32,"signed":true}', '{"name":"m_counter","bits":32,"signed":true}', '{"name":"m_rev_map","bits":16,"signed":true,"arrayLength":512}'], sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1921, sourceColumn: 1, sourceEndLine: 1931};
MERGE (n:KG {id: 'device:dkong_state.dkongjr/watchdog'}) SET n:Device SET n += {type: 'WATCHDOG_TIMER', tag: 'watchdog', clock: null, config: ['WATCHDOG_TIMER(config, m_watchdog)'], member: 'm_watchdog', sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1930, sourceColumn: 2, sourceEndLine: 1930};
...
MERGE (n:KG {id: 'machine:dkong_state.dkongjr_audio'}) SET n:MachineConfig SET n += {cls: 'dkong_state', name: 'dkongjr_audio', calls: [], stateMembers: ['{"name":"m_hardware_type","bits":8}', '{"name":"m_nmi_mask","bits":8}', '{"name":"m_vidhw","bits":8,"signed":true}', '{"name":"m_gfx3_len","bits":32,"signed":true}', '{"name":"m_sig30Hz","bits":8}', '{"name":"m_lfsr_5I","bits":8}', '{"name":"m_grid_sig","bits":8}', '{"name":"m_rflip_sig","bits":8}', '{"name":"m_star_ff","bits":8}', '{"name":"m_blue_level","bits":8}', '{"name":"m_decrypt_counter","bits":8,"signed":true}', '{"name":"m_protect_type","bits":8}', '{"name":"m_hunchloopback","bits":8}', '{"name":"m_prot_cnt","bits":8}', '{"name":"m_main_fo","bits":8}', '{"name":"m_gfx_bank","bits":8}', '{"name":"m_palette_bank","bits":8}', '{"name":"m_grid_on","bits":8}', '{"name":"m_grid_col","bits":16}', '{"name":"m_sprite_bank","bits":8}', '{"name":"m_dma_latch","bits":8}', '{"name":"m_flip","bits":8}', '{"name":"m_pixelcnt","bits":32,"signed":true}', '{"name":"m_counter","bits":32,"signed":true}', '{"name":"m_rev_map","bits":16,"signed":true,"arrayLength":512}'], sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1391, sourceColumn: 1, sourceEndLine: 1426};
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/ls174.3d'}) SET n:Device SET n += {type: 'LATCH8', tag: 'ls174.3d', clock: null, config: ['LATCH8(config, "ls174.3d").set_maskout(0xe0)'], sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1394, sourceColumn: 2, sourceEndLine: 1394};
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/ls259.6h'}) SET n:Device SET n += {type: 'LATCH8', tag: 'ls259.6h', clock: null, config: ['LATCH8(config, m_dev_6h)', 'm_dev_6h->write_cb<0>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND0_INP>))', 'm_dev_6h->write_cb<1>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND1_INP>))', 'm_dev_6h->write_cb<2>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND2_INP>))', 'm_dev_6h->write_cb<7>().set("discrete", FUNC(discrete_device::write_line<DS_SOUND7_INP>))'], member: 'm_dev_6h', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1396, sourceColumn: 2, sourceEndLine: 1396};
...
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/virtual_p2'}) SET n:Device SET n += {type: 'LATCH8', tag: 'virtual_p2', clock: null, config: ['LATCH8(config, m_dev_vp2)', 'm_dev_vp2->set_xorvalue(0x70)', 'm_dev_vp2->read_cb<6>().set("ls259.4h", FUNC(latch8_device::bit1_r))', 'm_dev_vp2->read_cb<5>().set(m_dev_6h, FUNC(latch8_device::bit3_r))', 'm_dev_vp2->read_cb<4>().set(m_dev_6h, FUNC(latch8_device::bit6_r))', 'm_dev_vp2->write_cb<7>().set("discrete", FUNC(discrete_device::write_line<DS_DISCHARGE_INV>))'], member: 'm_dev_vp2', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1407, sourceColumn: 2, sourceEndLine: 1407, configCalls: ['set_xorvalue(112)']};
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/virtual_p2/callback:virtual_p2:0'}) SET n:Callback SET n += {signal: 'read_cb', operation: 'set', raw: 'm_dev_vp2->read_cb<6>().set("ls259.4h", FUNC(latch8_device::bit1_r))', ownerTag: 'virtual_p2', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1409, sourceColumn: 2, sourceEndLine: 1409, slot: '6', targetTag: 'ls259.4h', targetClass: 'latch8_device', targetMethod: 'bit1_r'};
MERGE (n:KG {id: 'handler:latch8_device.bit1_r'}) SET n:Handler SET n += {method: 'bit1_r', ownerClass: 'latch8_device', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1409, sourceColumn: 2, sourceEndLine: 1409};
...
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/soundcpu/callback:soundcpu:1'}) SET n:Callback SET n += {signal: 'p2_in_cb', operation: 'set', raw: 'm_soundcpu->p2_in_cb().set(m_dev_vp2, FUNC(latch8_device::read))', ownerTag: 'soundcpu', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1418, sourceColumn: 2, sourceEndLine: 1418, targetClass: 'latch8_device', targetMethod: 'read', targetTag: 'virtual_p2'};
...
MERGE (n:KG {id: 'device:dkong_state.dkongjr_audio/discrete'}) SET n:Device SET n += {type: 'DISCRETE', tag: 'discrete', clock: null, config: ['DISCRETE(config, "discrete", dkongjr_discrete).add_route(ALL_OUTPUTS, "mono", 0.5)'], member: 'm_discrete', sourceFile: 'src/mame/nintendo/dkong_a.cpp', sourceLine: 1425, sourceColumn: 2, sourceEndLine: 1425, clockExpr: 'dkongjr_discrete'};
...
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in0_4/IN0/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_JOYSTICK_RIGHT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_JOYSTICK_LEFT', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_JOYSTICK_UP', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_JOYSTICK_DOWN', modifiers: ['PORT_4WAY', 'PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_BUTTON1', modifiers: ['PORT_COCKTAIL'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in1_4/IN1/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f2'}) SET n:PortField SET n += {kind: 'bit', mask: 4, activeLow: false, type: 'IPT_START1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f3'}) SET n:PortField SET n += {kind: 'bit', mask: 8, activeLow: false, type: 'IPT_START2', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f4'}) SET n:PortField SET n += {kind: 'bit', mask: 16, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f5'}) SET n:PortField SET n += {kind: 'bit', mask: 32, activeLow: false, type: 'IPT_UNKNOWN', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f6'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: false, type: 'IPT_CUSTOM', modifiers: ['PORT_READ_LINE_DEVICE_MEMBER("virtual_p2", FUNC(latch8_device::bit4_q_r))'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/IN2/f7'}) SET n:PortField SET n += {kind: 'bit', mask: 128, activeLow: false, type: 'IPT_COIN1', defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkong_in2/SERVICE1'}) SET n:Port SET n += {tag: 'SERVICE1', modify: false};
MERGE (n:KG {id: 'inputs:dkong_in2/SERVICE1/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_SERVICE1', defaultValue: 0};
...
MERGE (n:KG {id: 'inputs:dkong_dsw0/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 3, modifiers: ['PORT_DIPLOCATION( "SW1:!1,!2" )'], name: 'Lives', defaultValue: 0, location: 'SW1:!1,!2', settings: ['0=3', '1=4', '2=5', '3=6']};
MERGE (n:KG {id: 'inputs:dkong_dsw0/DSW0/f1'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION( "SW1:!3,!4" )'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:!3,!4', settings: ['0=7000', '4=10000', '8=15000', '12=20000']};
MERGE (n:KG {id: 'inputs:dkong_dsw0/DSW0/f2'}) SET n:PortField SET n += {kind: 'dip', mask: 112, modifiers: ['PORT_DIPLOCATION( "SW1:!5,!6,!7" )'], name: 'Coinage', defaultValue: 0, location: 'SW1:!5,!6,!7', settings: ['112=5C 1C', '80=4C 1C', '48=3C 1C', '16=2C 1C', '0=1C 1C', '32=1C 2C', '64=1C 3C', '96=1C 4C']};
MERGE (n:KG {id: 'inputs:dkong_dsw0/DSW0/f3'}) SET n:PortField SET n += {kind: 'dip', mask: 128, modifiers: ['PORT_DIPLOCATION( "SW1:!8" )'], name: 'Cabinet', defaultValue: 128, location: 'SW1:!8', settings: ['128=Upright', '0=Cocktail']};
...
MERGE (n:KG {id: 'inputs:dkongjr/IN2/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 64, activeLow: true, type: 'IPT_CUSTOM', defaultValue: 64};
MERGE (n:KG {id: 'inputs:dkongjr/DSW0'}) SET n:Port SET n += {tag: 'DSW0', modify: true};
MERGE (n:KG {id: 'inputs:dkongjr/DSW0/f0'}) SET n:PortField SET n += {kind: 'dip', mask: 12, modifiers: ['PORT_DIPLOCATION( "SW1:!3,!4" )'], name: 'Bonus Life', defaultValue: 0, location: 'SW1:!3,!4', settings: ['0=10000', '4=15000', '8=20000', '12=25000']};
MERGE (n:KG {id: 'inputs:dkongjr/TST'}) SET n:Port SET n += {tag: 'TST', modify: false};
MERGE (n:KG {id: 'inputs:dkongjr/TST/f0'}) SET n:PortField SET n += {kind: 'bit', mask: 1, activeLow: false, type: 'IPT_OTHER', modifiers: ['PORT_CODE(KEYCODE_A)'], defaultValue: 0};
MERGE (n:KG {id: 'inputs:dkongjr/TST/f1'}) SET n:PortField SET n += {kind: 'bit', mask: 2, activeLow: false, type: 'IPT_OTHER', modifiers: ['PORT_CODE(KEYCODE_B)'], defaultValue: 0};
...
MERGE (n:KG {id: 'device:dkong_state.dkong_base/palette/callback:palette_init'}) SET n:Callback SET n += {signal: 'palette_init', operation: 'palette_init', raw: 'PALETTE(config, m_palette, FUNC(dkong_state::dkong2b_palette), DK2B_PALETTE_LENGTH)', ownerTag: 'palette', targetClass: 'dkong_state', targetMethod: 'dkong2b_palette', entries: 521, sourceFile: 'src/mame/nintendo/dkong.cpp', sourceLine: 1798};
...
MATCH (a:KG {id: 'machine:dkong_state.dkongjr'}), (b:KG {id: 'machine:dkong_state.dkong_base'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
MATCH (a:KG {id: 'machine:dkong_state.dkongjr'}), (b:KG {id: 'machine:dkong_state.dkongjr_audio'}) MERGE (a)-[r:CALLS]->(b) SET r += {order: 0};
...
MATCH (a:KG {id: 'device:dkong_state.dkong_base/palette'}), (b:KG {id: 'device:dkong_state.dkong_base/palette/callback:palette_init'}) MERGE (a)-[r:HAS_CALLBACK]->(b);
...
MATCH (a:KG {id: 'device:dkong_state.dkong_base/palette/callback:palette_init'}), (b:KG {id: 'handler:dkong_state.dkong2b_palette'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
