...
defined.compiledHandlers = {
  ...
  function method_dkong_videoram_w(runtime: any, offset: any, data: any): any {
  ...
  function method_radarscp_grid_color_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_grid_col = ((((((data) & (7))) ^ (7))) & 0xffff);
  }

  function method_dkong_audio_irq_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_radarscp_grid_enable_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_grid_on = ((((data) & (1))) & 0xff);
  }

  function method_dkong_flipscreen_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_flip = ((((data) & (1))) & 0xff);
  }

  function method_dkong_spritebank_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_sprite_bank = ((((data) & (1))) & 0xff);
  }

  function method_nmi_mask_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dkong_palettebank_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dkongjr_gfxbank_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dkong_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let code: any = ((runtime.add(runtime.readIndex((members.m_video_ram ?? runtime.member("m_video_ram")), tile_index), ((256) * ((members.m_gfx_bank ?? runtime.member("m_gfx_bank")))))) | 0);
    let color: any = ((runtime.add(((runtime.readIndex((members.m_color_codes ?? runtime.member("m_color_codes")), runtime.add(((tile_index) % (32)), ((32) * (runtime.divide(runtime.divide(tile_index, 32), 4)))))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))))) | 0);
  ...
  function method_p8257_ctl_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_dma_latch ?? runtime.member("m_dma_latch"));
  }

  function method_p8257_ctl_w(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_dma_latch = ((data) & 0xff);
  }

  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any, mask_bank: any, shift_bits: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    const h_m_sprite_ram = members.m_sprite_ram ?? runtime.member("m_sprite_ram");
    let offs: any = ((0) | 0);
    let scanline_vf: any = ((0) | 0);
    let scanline_vfc: any = ((0) | 0);
    let scanline: any = ((0) | 0);
    let add_y: any = ((0) | 0);
    let add_x: any = ((0) | 0);
    let num_sprt: any = ((0) | 0);
    ...
    for (offs = (((((members.m_sprite_bank ?? runtime.member("m_sprite_bank"))) << (9))) | 0), num_sprt = ((0) | 0); (((((Number(num_sprt) < Number(16)) ? 1 : 0)) && (((Number(offs) < Number(runtime.add((((members.m_sprite_bank ?? runtime.member("m_sprite_bank"))) << (9)), 512))) ? 1 : 0))) ? 1 : 0); offs = ((((offs) + (4))) | 0)) {
      let y: any = ((runtime.readIndex(h_m_sprite_ram, offs)) | 0);
      let do_draw: any = ((((((Number(((((runtime.add(((y) + (add_y)), 1)) + (scanline_vf))) & (240))) === Number(240)) ? 1 : 0)) ? (1) : (0))) | 0);
      if (do_draw) {
        let code: any = ((runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (1)))) & (127)), ((((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (mask_bank))) << (shift_bits)))) | 0);
        let color: any = ((runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))))) | 0);
        let flipx: any = ((((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (128))) | 0);
        let flipy: any = ((((runtime.readIndex(h_m_sprite_ram, ((offs) + (1)))) & (128))) | 0);
        let x: any = ((((runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (3)))) + (add_x)), 1)) & (255))) | 0);
        if ((members.m_flip ?? runtime.member("m_flip"))) {
          x = ((((((x) ^ (255))) - (15))) | 0);
          flipx = ((((flipx) ? 0 : 1)) | 0);
        }
