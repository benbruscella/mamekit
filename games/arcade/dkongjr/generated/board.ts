...
defined.compiledHandlers = {
  ...(() => {
    const methods = (() => {
  function method_dkong_videoram_w(runtime: any, offset: any, data: any) {
  ...
  function method_radarscp_grid_color_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_grid_col = ((((((data) & (7))) ^ (7))) & 0xffff);
  }

  function method_dkong_audio_irq_w(runtime: any, data: any) {
    const members = runtime.members;
    if (data) {
  ...
  function method_radarscp_grid_enable_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_grid_on = ((((data) & (1))) & 0xff);
  }

  function method_dkong_flipscreen_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_flip = ((((data) & (1))) & 0xff);
  }

  function method_dkong_spritebank_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_sprite_bank = ((((data) & (1))) & 0xff);
  }

  function method_nmi_mask_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_dkong_palettebank_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    let newbank: any = 0;
  ...
  function method_dkongjr_gfxbank_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_dkong_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    const members = runtime.members;
    let code: any = runtime.add(runtime.readIndex((members.m_video_ram ?? runtime.member("m_video_ram")), tile_index), ((256) * ((members.m_gfx_bank ?? runtime.member("m_gfx_bank")))));
    let color: any = runtime.add(((runtime.readIndex((members.m_color_codes ?? runtime.member("m_color_codes")), runtime.add(((tile_index) % (32)), ((32) * (runtime.divide(runtime.divide(tile_index, 32), 4)))))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))));
  ...
  function method_p8257_ctl_r(runtime: any) {
    const members = runtime.members;
    return (members.m_dma_latch ?? runtime.member("m_dma_latch"));
  }

  function method_p8257_ctl_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_dma_latch = ((data) & 0xff);
  }

  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any, mask_bank: any, shift_bits: any) {
    const members = runtime.members;
    const h_m_sprite_ram = members.m_sprite_ram ?? runtime.member("m_sprite_ram");
    let offs: any = 0;
    let scanline_vf: any = 0;
    let scanline_vfc: any = 0;
    let scanline: any = 0;
    let add_y: any = 0;
    let add_x: any = 0;
    let num_sprt: any = 0;
    ...
    for (offs = (((members.m_sprite_bank ?? runtime.member("m_sprite_bank"))) << (9)), num_sprt = 0; (((((Number(num_sprt) < Number(16)) ? 1 : 0)) && (((Number(offs) < Number(runtime.add((((members.m_sprite_bank ?? runtime.member("m_sprite_bank"))) << (9)), 512))) ? 1 : 0))) ? 1 : 0); offs = ((offs) + (4))) {
      let y: any = runtime.readIndex(h_m_sprite_ram, offs);
      let do_draw: any = ((((Number(((((runtime.add(((y) + (add_y)), 1)) + (scanline_vf))) & (240))) === Number(240)) ? 1 : 0)) ? (1) : (0));
      if (do_draw) {
        let code: any = runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (1)))) & (127)), ((((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (mask_bank))) << (shift_bits)));
        let color: any = runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))));
        let flipx: any = ((runtime.readIndex(h_m_sprite_ram, ((offs) + (2)))) & (128));
        let flipy: any = ((runtime.readIndex(h_m_sprite_ram, ((offs) + (1)))) & (128));
        let x: any = ((runtime.add(((runtime.readIndex(h_m_sprite_ram, ((offs) + (3)))) + (add_x)), 1)) & (255));
        if ((members.m_flip ?? runtime.member("m_flip"))) {
          x = ((((x) ^ (255))) - (15));
          flipx = ((flipx) ? 0 : 1);
        }
