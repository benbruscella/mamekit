    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_dkong_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                const members = runtime.members;
                let code = runtime.add(runtime.readIndex((members.m_video_ram ?? runtime.member("m_video_ram")), tile_index), ((256) * ((members.m_gfx_bank ?? runtime.member("m_gfx_bank")))));
                let color = runtime.add(((runtime.readIndex((members.m_color_codes ?? runtime.member("m_color_codes")), runtime.add(((tile_index) % (32)), ((32) * (runtime.divide(runtime.divide(tile_index, 32), 4)))))) & (15)), ((16) * ((members.m_palette_bank ?? runtime.member("m_palette_bank")))));
