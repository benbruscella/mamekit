...
// generated 2026-09-24T02:27:31.495Z
...
MERGE (n:KG {id: 'device:gberet_state.gberet/maincpu'}) SET n:Device SET n += {type: 'Z80', tag: 'maincpu', clock: 3072000, config: ['Z80(config, m_maincpu, 18.432_MHz_XTAL / 6)', 'm_maincpu->set_addrmap(AS_PROGRAM, &gberet_state::prg_map)'], member: 'm_maincpu', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 735, sourceColumn: 2, sourceEndLine: 735};
...
MERGE (n:KG {id: 'device:gberet_state.gberet/k005849/callback:k005849:1'}) SET n:Callback SET n += {signal: 'set_firq_cb', member: 'm_firq_cb', operation: 'set', raw: 'm_k005849->set_firq_cb().set("mainirq", FUNC(input_merger_any_high_device::in_w<1>))', ownerTag: 'k005849', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 743, sourceColumn: 2, sourceEndLine: 743, targetTag: 'mainirq', targetClass: 'input_merger_any_high_device', targetMethod: 'in_w_1'};
...
MERGE (n:KG {id: 'device:gberet_state.gberet/k005849/callback:k005849:2'}) SET n:Callback SET n += {signal: 'set_nmi_cb', member: 'm_nmi_cb', operation: 'set_inputline', raw: 'm_k005849->set_nmi_cb().set_inputline(m_maincpu, INPUT_LINE_NMI)', ownerTag: 'k005849', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 744, sourceColumn: 2, sourceEndLine: 744, inputLine: 'INPUT_LINE_NMI', targetTag: 'maincpu'};
MERGE (n:KG {id: 'device:gberet_state.gberet/k005849/callback:k005849:3'}) SET n:Callback SET n += {signal: 'set_flipscreen_cb', member: 'm_flipscreen_cb', operation: 'set', raw: 'm_k005849->set_flipscreen_cb().set(FUNC(gberet_state::flip_screen_set))', ownerTag: 'k005849', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 745, sourceColumn: 2, sourceEndLine: 745, targetClass: 'gberet_state', targetMethod: 'flip_screen_set'};
...
MERGE (n:KG {id: 'device:gberet_state.gberet/screen'}) SET n:Device SET n += {type: 'SCREEN', tag: 'screen', clock: null, config: ['screen_device &screen(SCREEN(config, "screen", SCREEN_TYPE_RASTER))', 'screen.set_raw(18.432_MHz_XTAL / 3, 384, 0+8, 256-8, 264, 16, 240)', 'screen.set_screen_update(FUNC(gberet_state::screen_update))', 'screen.set_palette(m_palette)'], sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 750, sourceColumn: 2, sourceEndLine: 750, configCalls: ['set_raw(6144000,384,8,248,264,16,240)', 'set_palette("palette")'], clockExpr: 'SCREEN_TYPE_RASTER', screenRaw: [6144000, 384, 8, 248, 264, 16, 240], screenRawExpr: ['18.432_MHz_XTAL / 3', '384', '0+8', '256-8', '264', '16', '240']};
...
MERGE (n:KG {id: 'device:gberet_state.gberet/gfxdecode'}) SET n:Device SET n += {type: 'GFXDECODE', tag: 'gfxdecode', clock: null, config: ['GFXDECODE(config, m_gfxdecode, m_palette, gfx_gberet)'], member: 'm_gfxdecode', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 755, sourceColumn: 2, sourceEndLine: 755, clockExpr: 'm_palette'};
MERGE (n:KG {id: 'device:gberet_state.gberet/palette'}) SET n:Device SET n += {type: 'PALETTE', tag: 'palette', clock: null, config: ['PALETTE(config, m_palette, FUNC(gberet_state::palette), 2*16*16, 32)'], member: 'm_palette', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 756, sourceColumn: 2, sourceEndLine: 756, clockExpr: 'FUNC(gberet_state::palette)', paletteEntries: 32};
...
MERGE (n:KG {id: 'device:gberet_state.gberet/snsnd'}) SET n:Device SET n += {type: 'SN76489A', tag: 'snsnd', clock: 1536000, config: ['SN76489A(config, m_sn, 18.432_MHz_XTAL / 12).add_route(ALL_OUTPUTS, "mono", 1.0)'], member: 'm_sn', sourceFile: 'src/mame/konami/gberet.cpp', sourceLine: 761, sourceColumn: 2, sourceEndLine: 761};
...
MERGE (n:KG {id: 'handler:k005849_device.device_start'}) SET n:Handler SET n += {method: 'device_start', ownerClass: 'k005849_device', sourceFile: 'src/mame/konami/k005849.cpp', sourceLine: 58, sourceColumn: 1, sourceEndLine: 69, sourceParameters: '', sourceBody: 'save_item(NAME(m_ctrlram));
...
MERGE (n:KG {id: 'handler:k005849_device.scanline'}) SET n:Handler SET n += {method: 'scanline', ownerClass: 'k005849_device', sourceFile: 'src/mame/konami/k005849.cpp', sourceLine: 118, sourceColumn: 1, sourceEndLine: 143, sourceParameters: 'int param', sourceBody: 'int scanline = param;
...
MATCH (a:KG {id: 'device:gberet_state.gberet/k005849'}), (b:KG {id: 'handler:k005849_device.device_start'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
...
MATCH (a:KG {id: 'handler:k005849_device.device_start'}), (b:KG {id: 'handler:k005849_device.scanline'}) MERGE (a)-[r:CALLS_HANDLER]->(b);
