    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_screen_update(runtime, screen, bitmap, cliprect) {
                const members = runtime.members;
                const __l = runtime.links ?? runtime.calls;
                for (let i = ((0) | 0); ((Number(i) < Number(32)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
            ...
            function method_draw_sprites(runtime, bitmap, cliprect) {
                ...
                for (let offs = ((0) | 0); ((Number(offs) < Number(192)) ? 1 : 0); offs = ((((offs) + (4))) | 0)) {
                    if (runtime.readIndex(sr, ((offs) + (3)))) {
                        let attr = ((runtime.readIndex(sr, ((offs) + (1)))) | 0);
                        let code = ((runtime.add(runtime.readIndex(sr, ((offs) + (0))), ((((attr) & (64))) << (2)))) | 0);
                        let color = ((((attr) & (15))) | 0);
                        let sx = ((((runtime.readIndex(sr, ((offs) + (2)))) - (((2) * (((attr) & (128))))))) | 0);
                        let sy = ((runtime.readIndex(sr, ((offs) + (3)))) | 0);
                        let flipx = ((((attr) & (16))) | 0);
                        let flipy = ((((attr) & (32))) | 0);
    ...
    ...(() => {
        const methods = (() => {
            ...
            function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
                ...
                let code = ((runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((attr) & (64))) << (2)))) | 0);
                let color = ((((attr) & (15))) | 0);
                let flags = (((__l["TILE_FLIPYX"] ? __l["TILE_FLIPYX"](runtime.shiftRight(((attr) & (48)), 4)) : runtime.macro("TILE_FLIPYX", runtime.shiftRight(((attr) & (48)), 4)))) | 0);
