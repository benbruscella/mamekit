...
defined.compiledHandlers = {
  ...
  function method_scroll_r(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_ctrl_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_sound_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any) {
    const members = runtime.members;
    for (let i: any = 0; ((Number(i) < Number(32)) ? 1 : 0); i = ((i) + (1))) {
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any) {
    ...
    for (let offs: any = 0; ((Number(offs) < Number(192)) ? 1 : 0); offs = ((offs) + (4))) {
      if (runtime.readIndex(sr, ((offs) + (3)))) {
        let attr: any = runtime.readIndex(sr, ((offs) + (1)));
        let code: any = runtime.add(runtime.readIndex(sr, ((offs) + (0))), ((((attr) & (64))) << (2)));
        let color: any = ((attr) & (15));
        let sx: any = ((runtime.readIndex(sr, ((offs) + (2)))) - (((2) * (((attr) & (128))))));
        let sy: any = runtime.readIndex(sr, ((offs) + (3)));
        let flipx: any = ((attr) & (16));
        let flipy: any = ((attr) & (32));
  ...
  function method_ctrl_r(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any) {
    ...
    let code: any = runtime.add(runtime.readIndex((members.m_videoram ?? runtime.member("m_videoram")), tile_index), ((((attr) & (64))) << (2)));
    let color: any = ((attr) & (15));
