...
/**
 * MSM5205 and DAC_8BIT_R2R are claimed only alongside an AY: on a board with
 * no AY there is no worklet to mix them into, and extraction says so.
 */
export const AY8910_MAME_TYPES = ['AY8910', 'MSM5205', 'DAC_8BIT_R2R'];
