...
export async function runMenu() {
    ...
    let activeTab = new URLSearchParams(location.search).get('tab') === 'consoles' ? 'console' : 'arcade';
    ...
    async function openLearnModal(entry) {
      ...
      display:flex;flex-direction:column;overflow:hidden`);
        ...
        scroller.appendChild(img(`../artwork/media/marquees/${game}.png`, `width:100%;max-height:140px;object-fit:contain;border-radius:10px 10px 0 0;
       ...
       box-shadow:inset 0 -12px 24px rgba(0,0,0,.5)`));
        ...
        const flyer = img(`../artwork/covers/${game}.png`, 'width:170px;border-radius:6px;box-shadow:0 10px 30px rgba(0,0,0,.65);flex-shrink:0;transform:rotate(-1.5deg)');
        ...
        const cab = img(`../artwork/media/cabinets/${game}.png`, 'width:120px;border-radius:6px;box-shadow:0 10px 30px rgba(0,0,0,.65);flex-shrink:0;transform:rotate(1.5deg)');
