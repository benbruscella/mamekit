 ...
 */
async function fetchRomSet(game, category = 'arcade') {
...
function waitForZip(ui, zone, specs, critical, game, category) {
    return new Promise(resolve => {
        ...
        zone.search.button.addEventListener('click', () => {
            ...
            Promise.allSettled(sets.map(async (set) => ({ set, raw: await fetchRomSet(set, category) }))).then(results => finish(() => {
