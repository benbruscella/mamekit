...
export { executeGeneratedCallbackHandler, executeGeneratedHandler, executeGeneratedMachineHandler, executeGeneratedMachineProgram, executeGeneratedProgram, generatedPeriodicLines, } from "../ir/execute.js";
/**
...
function makeWriteHandler(machine, handler, bindings) {
    ...
    return (addr, offset, data) => {
        executeGeneratedMachineHandler(machine, handler, bindings, { addr, offset, data, state: data });
    };
}
/**
