// GENERATED from src/devices/sound/gb.cpp, src/devices/sound/gb.h; do not edit.
// Carries no register model and no DSP: the chip runs as a generated device
// (device_start, device_clock_changed, device_reset, gameboy_sound_device::device_reset, tick_length, calculate_next_sweep, apply_next_sweep, tick_sweep, tick_envelope, dac_enabled, update_square_channel, update_noise_channel, update_state, noise_period_cycles, sound_r, sound_w_internal, sound_stream_update, timer_callback, imperfect_features, corrupt_wave_ram, gameboy_sound_device::imperfect_features, gameboy_sound_device::corrupt_wave_ram, update_wave_channel, wave_r, wave_w, sound_w, apu_power_off, convert_output) and posts its samples here.
/**
...
registerProcessor('gameboy', GeneratedStreamProcessor);
