...
export class GeneratedAy8910Mixer {
    ...
    deviceTags;
    muted = false;
    constructor(clock, chips, outputRate, routes = [], auxiliaryDevices = [], discreteMixer, deviceTags = []) {
    ...
    constructor() {
        ...
        this.port.onmessage = (event) => {
            ...
            if (message.type === 'init') {
                this.mixer = new GeneratedAy8910Mixer(message.clock ?? 1_789_772, message.chips ?? 1, sampleRate, message.routes, message.auxiliaryDevices, message.discreteMixer, message.deviceTags);
