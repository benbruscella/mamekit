...
class GeneratedRP2A03 implements Cpu {
  ...
  reset(): void {
    (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff);
    (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff);
    (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
    this.method_dec_SP();
    (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
    this.method_dec_SP();
    (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
    ...
    this.m_PC = (((++this.cycles, this.readMemory((65532) & 0xffff) & 0xff)) & 0xffff);
    this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65533) & 0xffff) & 0xff))) & 0xffff);
  }
  ...
  step(): number {
    ...
    while (true) {
      ...
      case 0x0000: {
        ...
        (++this.cycles, this.writeMemory((this.m_SP) & 0xffff, (((this.m_PC) >> (8))) & 0xff), 0);
        this.method_dec_SP();
        (++this.cycles, this.writeMemory((this.m_SP) & 0xffff, (this.m_PC) & 0xff), 0);
        this.method_dec_SP();
        (++this.cycles, this.writeMemory((this.m_SP) & 0xffff, (((this.m_irq_taken) ? (((this.m_P) & ((~16)))) : (this.m_P))) & 0xff), 0);
        this.method_dec_SP();
        if (this.m_nmi_pending) {
          this.acknowledgeIrq();
          this.m_PC = (((++this.cycles, this.readMemory((65530) & 0xffff) & 0xff)) & 0xffff);
          this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65531) & 0xffff) & 0xff))) & 0xffff);
          this.m_nmi_pending = ((0) ? 1 : 0);
        } else {
          if (this.m_irq_taken) {
            this.acknowledgeIrq();
          }
          this.m_PC = (((++this.cycles, this.readMemory((65534) & 0xffff) & 0xff)) & 0xffff);
          this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65535) & 0xffff) & 0xff))) & 0xffff);
        }
      ...
      case 0x0100: {
        this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP2) & 0xffff) & 0xff);
        this.m_TMP2 = ((((this.m_TMP2) + (this.m_X))) & 0xff);
        this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 0xffff) & 0xff)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff);
        this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0x0200: {
        (++this.cycles, this.readMemory((65535) & 0xffff) & 0xff);
      ...
      case 0x0300: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff);
        (++this.cycles, this.writeMemory((this.m_TMP) & 0xffff, (this.m_TMP2) & 0xff), 0);
      ...
      case 0x0400: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        return this.cycles;
      }
      case 0x0500: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x0800: {
        (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((this.m_SP) & 0xffff, (this.m_P) & 0xff), 0);
        this.method_dec_SP();
        return this.cycles;
      }
      case 0x0900: {
      ...
      case 0x0c00: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff))) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        return this.cycles;
      }
      ...
      case 0x1000: {
        ...
        if (((((this.m_P) & (128))) ? 0 : 1)) {
          ...
          if (this.method_page_changing(this.m_PC, (((this.m_TMP) << 24) >> 24))) {
            (++this.cycles, this.readMemory((this.method_set_l(this.m_PC, ((this.m_PC) + ((((this.m_TMP) << 24) >> 24))))) & 0xffff) & 0xff);
          }
      ...
      case 0x1100: {
        this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_TMP2) & 0xffff) & 0xff)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        if (this.method_page_changing(this.m_TMP, this.m_Y)) {
          (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y)))) & 0xffff) & 0xff);
        }
        this.m_TMP2 = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 0xffff) & 0xff)) & 0xff);
        this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0x1400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        (++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff) & 0xff);
        return this.cycles;
      }
      case 0x1500: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        this.m_TMP2 = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff) & 0xff)) & 0xff);
        this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0x1c00: {
        ...
        if (this.method_page_changing(this.m_TMP, this.m_X)) {
          (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X)))) & 0xffff) & 0xff);
        }
        (++this.cycles, this.readMemory((((this.m_TMP) + (this.m_X))) & 0xffff) & 0xff);
        return this.cycles;
      }
      case 0x1d00: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x2800: {
        ...
        (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
        this.method_inc_SP();
        this.m_TMP = (((((++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff)) | (((16) | (32))))) & 0xffff);
      ...
      case 0x4000: {
        ...
        (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
        this.method_inc_SP();
        this.m_P = (((((++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff)) | (((16) | (32))))) & 0xff);
        this.method_inc_SP();
        this.m_PC = (((++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff)) & 0xffff);
        this.method_inc_SP();
        this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff))) & 0xffff);
        return this.cycles;
      }
      case 0x4100: {
        this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
      ...
      case 0x4800: {
        (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((this.m_SP) & 0xffff, (this.m_A) & 0xff), 0);
        this.method_dec_SP();
        return this.cycles;
      }
      case 0x4900: {
      ...
      case 0x6800: {
        ...
        (++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff);
        this.method_inc_SP();
        this.m_A = (((++this.cycles, this.readMemory((this.m_SP) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0x6900: {
      ...
      case 0x6c00: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff))) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_PC = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (1)))) & 0xffff) & 0xff))) & 0xffff);
        return this.cycles;
      }
      case 0x6d00: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x8100: {
        ...
        this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 0xffff) & 0xff)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        (++this.cycles, this.writeMemory((this.m_TMP) & 0xffff, (this.m_A) & 0xff), 0);
        return this.cycles;
      }
      case 0x8200: {
        (++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff);
      ...
      case 0x8400: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.writeMemory((this.m_TMP) & 0xffff, (this.m_Y) & 0xff), 0);
        return this.cycles;
      }
      case 0x8500: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x8600: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.writeMemory((this.m_TMP) & 0xffff, (this.m_X) & 0xff), 0);
        return this.cycles;
      }
      case 0x8700: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x9100: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y)))) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((((this.m_TMP) + (this.m_Y))) & 0xffff, (this.m_A) & 0xff), 0);
        return this.cycles;
      }
      case 0x9200: {
        (++this.cycles, this.readMemory((65535) & 0xffff) & 0xff);
      ...
      case 0x9400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff, (this.m_Y) & 0xff), 0);
        return this.cycles;
      }
      case 0x9500: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff, (this.m_A) & 0xff), 0);
        return this.cycles;
      }
      case 0x9600: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_Y))) & 0xff)) & 0xffff, (this.m_X) & 0xff), 0);
        return this.cycles;
      }
      case 0x9700: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0x9d00: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X)))) & 0xffff) & 0xff);
        (++this.cycles, this.writeMemory((((this.m_TMP) + (this.m_X))) & 0xffff, (this.m_A) & 0xff), 0);
        return this.cycles;
      }
      case 0x9e00: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
      ...
      case 0xa000: {
        this.m_Y = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xa100: {
        ...
        this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 0xffff) & 0xff)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        this.m_A = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xa200: {
        this.m_X = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
      ...
      case 0xa300: {
        ...
        this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 0xffff) & 0xff)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 0xffff) & 0xff))) & 0xffff);
        this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xa400: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_Y = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xa500: {
      ...
      case 0xa600: {
        this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_X = (((++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xa700: {
      ...
      case 0xa900: {
        this.m_A = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0xab00: {
        this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((this.m_PC) & 0xffff) & 0xff)) & 0xff))) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0xb100: {
        ...
        this.m_A = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb200: {
      ...
      case 0xb300: {
        ...
        this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 0xffff) & 0xff)) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        this.m_Y = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xb500: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        this.m_A = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb600: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        (++this.cycles, this.readMemory((this.m_TMP) & 0xffff) & 0xff);
        this.m_X = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_Y))) & 0xff)) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xb700: {
      ...
      case 0xbd00: {
        ...
        this.m_A = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_X))) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xbe00: {
        ...
        this.m_X = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 0xffff) & 0xff)) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xbf00: {
  ...
  private method_do_adc_nd(val: number): number {
    let sum = 0;
  ...
  private method_do_cmp(val1: number, val2: number): number {
  ...
  private method_do_sbc_nd(val: number): number {
  ...
  private method_do_bit(val: number): number {
  ...
  private method_do_asl(v: number): number {
    this.m_P = ((((this.m_P) & ((~((((128) | (2))) | (1)))))) & 0xff);
    let r = ((((v) << (1))) & 0xff);
    if (((r) ? 0 : 1)) {
      this.m_P = ((((this.m_P) | (2))) & 0xff);
  ...
  private method_do_lsr(v: number): number {
    this.m_P = ((((this.m_P) & ((~((((128) | (2))) | (1)))))) & 0xff);
    if (((v) & (1))) {
      this.m_P = ((((this.m_P) | (1))) & 0xff);
    }
  ...
  private method_do_ror(v: number): number {
    let c = ((((this.m_P) & (1))) ? 1 : 0);
    this.m_P = ((((this.m_P) & ((~((((128) | (2))) | (1)))))) & 0xff);
    if (((v) & (1))) {
      this.m_P = ((((this.m_P) | (1))) & 0xff);
  ...
  private method_do_rol(v: number): number {
    let c = ((((this.m_P) & (1))) ? 1 : 0);
    this.m_P = ((((this.m_P) & ((~((((128) | (2))) | (1)))))) & 0xff);
    if (((v) & (128))) {
      this.m_P = ((((this.m_P) | (1))) & 0xff);
  ...
  private method_do_asr(v: number): number {
    this.m_P = ((((this.m_P) & ((~((((128) | (2))) | (1)))))) & 0xff);
    if (((v) & (1))) {
      this.m_P = ((((this.m_P) | (1))) & 0xff);
    }
  ...
  private method_set_nz(v: number): number {
  ...
  private method_set_l(base: number, val: number): number {
    return ((((base) & (65280))) | (val));
    return 0;
  }

  private method_set_h(base: number, val: number): number {
    return ((((base) & (255))) | (((val) << (8))));
    return 0;
  }

  private method_page_changing(base: number, delta: number): number {
