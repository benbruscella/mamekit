...
class GeneratedZ80 {
    ...
    method_data_read(addr) {
        return (this.readMemory((addr) & 0xffff) & 0xff);
        return 0;
    }
    method_data_write(addr, value) {
    ...
    method_res(bit, value) {
        return ((value) & ((~((1) << (bit)))));
        return 0;
    }
    method_set(bit, value) {
        return ((value) | (((1) << (bit))));
        return 0;
    }
    ...
    method_z80_set_m1_cycles(m1_cycles) {
        this.m_m1_cycles = ((m1_cycles) & 0xff);
        return 0;
    }
    method_z80_set_mreq_cycles(mreq_cycles) {
        this.m_mreq_cycles = ((mreq_cycles) & 0xff);
        return 0;
    }
    method_z80_set_iorq_cycles(iorq_cycles) {
    ...
    method_execute_default_irq_vector(inputnum) {
        return 255;
        return 0;
    }
    method_execute_input_edge_triggered(inputnum) {
        return ((Number(inputnum) === Number(-1)) ? 1 : 0);
        return 0;
    }
    method_set_service_attention(Bit, State) {
        if (State) {
    ...
    method_get_service_attention(Bit) {
        return ((this.m_service_attention) & (((1) << (Bit))));
        return 0;
    }
    method_stack_read(addr) {
        return this.method_data_read(addr);
        return 0;
    }
    method_stack_write(addr, value) {
