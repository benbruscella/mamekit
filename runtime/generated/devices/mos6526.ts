...
definition.compiledMethods = (() => {
  ...
  function method_update_pa(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let pa: any = (((((members.m_pra ?? runtime.member("m_pra"))) | ((((members.m_pa_in ?? runtime.member("m_pa_in"))) & ((~(members.m_ddra ?? runtime.member("m_ddra")))))))) & 0xff);
  ...
  function method_update_pb(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let pb: any = (((((members.m_prb ?? runtime.member("m_prb"))) | ((((members.m_pb_in ?? runtime.member("m_pb_in"))) & ((~(members.m_ddrb ?? runtime.member("m_ddrb")))))))) & 0xff);
    if (((((members.m_cra ?? runtime.member("m_cra"))) >>> (1)) & 1)) {
      let pb6: any = ((((((((members.m_cra ?? runtime.member("m_cra"))) >>> (2)) & 1)) ? ((members.m_ta_pb6 ?? runtime.member("m_ta_pb6"))) : ((members.m_ta_out ?? runtime.member("m_ta_out"))))) | 0);
      pb = ((runtime.andAssign(pb, -65)) & 0xff);
      pb = ((((pb) | (((pb6) << (6))))) & 0xff);
    }
    if (((((members.m_crb ?? runtime.member("m_crb"))) >>> (1)) & 1)) {
      let pb7: any = ((((((((members.m_crb ?? runtime.member("m_crb"))) >>> (2)) & 1)) ? ((members.m_tb_pb7 ?? runtime.member("m_tb_pb7"))) : ((members.m_tb_out ?? runtime.member("m_tb_out"))))) | 0);
  ...
  function method_set_cra(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_crb(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bcd_increment(runtime: any, value: any): any {
    const members = runtime.members;
  ...
  function method_clock_tod(runtime: any): any {
    const members = runtime.members;

    let subsecond: any = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 0)) & 0xff)) & 0xff);
    let second: any = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 8)) & 0xff)) & 0xff);
    let minute: any = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 16)) & 0xff)) & 0xff);
    let hour: any = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 24)) & 0xff)) & 0xff);
  ...
  function method_read_tod(runtime: any, offset: any): any {
    const members = runtime.members;

    let shift: any = ((((8) * (offset))) | 0);
    if ((members.m_tod_latched ?? runtime.member("m_tod_latched"))) {
      return runtime.shiftRight((members.m_tod_latch ?? runtime.member("m_tod_latch")), shift);
    } else {
      return runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), shift);
    }
  }

  function method_write_tod(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_serial_input(runtime: any): any {
    const members = runtime.members;
  ...
  function method_clock_ta(runtime: any): any {
    const members = runtime.members;
  ...
  function method_serial_output(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_clock_tb(runtime: any): any {
    const members = runtime.members;
  ...
  function method_update_interrupt(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_clock_pipeline(runtime: any): any {
    const members = runtime.members;
    ...
    switch (runtime.shiftRight((((members.m_crb ?? runtime.member("m_crb"))) & (96)), 5)) {
      case 0:
      {
  ...
  function method_synchronize(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_read(runtime: any, offset: any): any {
    ...
    switch (((offset) & (15))) {
      ...
      case 5:
      {
        data = ((runtime.shiftRight((members.m_ta ?? runtime.member("m_ta")), 8)) & 0xff);
        break;
      }
      case 6:
      {
      ...
      case 7:
      {
        data = ((runtime.shiftRight((members.m_tb ?? runtime.member("m_tb")), 8)) & 0xff);
        break;
      }
      case 8:
      {
  ...
  function method_mos6526_device__read(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_mos6526_device__write(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_sp_w(runtime: any, state: any): any {
    const members = runtime.members;

    members.m_sp = ((state) | 0);
  }

  function method_cnt_w(runtime: any, state: any): any {
    const members = runtime.members;
    ...
    if (((((((members.m_cnt ?? runtime.member("m_cnt"))) ? 0 : 1)) && (state)) ? 1 : 0)) {
      ...
      if (((Number(runtime.shiftRight((((members.m_crb ?? runtime.member("m_crb"))) & (96)), 5)) === Number(1)) ? 1 : 0)) {
        members.m_tb = ((((members.m_tb) - (1))) & 0xffff);
      }
    }
  ...
  function method_flag_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_tod_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_advance_tod_clock(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_set_tod_clock(runtime: any, clock: any): any {
    const members = runtime.members;

    members.m_tod_clock = ((clock) | 0);
  }

  function method_irq_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_cnt_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_sp_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pa_rd_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pa_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pb_rd_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pb_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pc_wr_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pa_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_pa ?? runtime.member("m_pa"));
  }

  function method_pb_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_pb ?? runtime.member("m_pb"));
  }

  function method_sp_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_sp ?? runtime.member("m_sp"));
  }

  function method_cnt_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_cnt ?? runtime.member("m_cnt"));
  }

  function method_irq_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_irq ?? runtime.member("m_irq"));
  }

  function method_mos6526_device__set_tod_clock(runtime: any, clock: any): any {
    const members = runtime.members;

    members.m_tod_clock = ((clock) | 0);
  }

  function method_mos6526_device__irq_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_irq)).bind === 'function' ? (runtime.dereference(members.m_write_irq)).bind() : typeof (runtime.dereference(members.m_write_irq)).bind === 'number' || typeof (runtime.dereference(members.m_write_irq)).bind === 'boolean' ? (runtime.dereference(members.m_write_irq)).bind : runtime.container(members.m_write_irq, "bind"));
  }

  function method_mos6526_device__cnt_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_cnt)).bind === 'function' ? (runtime.dereference(members.m_write_cnt)).bind() : typeof (runtime.dereference(members.m_write_cnt)).bind === 'number' || typeof (runtime.dereference(members.m_write_cnt)).bind === 'boolean' ? (runtime.dereference(members.m_write_cnt)).bind : runtime.container(members.m_write_cnt, "bind"));
  }

  function method_mos6526_device__sp_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_sp)).bind === 'function' ? (runtime.dereference(members.m_write_sp)).bind() : typeof (runtime.dereference(members.m_write_sp)).bind === 'number' || typeof (runtime.dereference(members.m_write_sp)).bind === 'boolean' ? (runtime.dereference(members.m_write_sp)).bind : runtime.container(members.m_write_sp, "bind"));
  }

  function method_mos6526_device__pa_rd_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_read_pa)).bind === 'function' ? (runtime.dereference(members.m_read_pa)).bind() : typeof (runtime.dereference(members.m_read_pa)).bind === 'number' || typeof (runtime.dereference(members.m_read_pa)).bind === 'boolean' ? (runtime.dereference(members.m_read_pa)).bind : runtime.container(members.m_read_pa, "bind"));
  }

  function method_mos6526_device__pa_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_pa)).bind === 'function' ? (runtime.dereference(members.m_write_pa)).bind() : typeof (runtime.dereference(members.m_write_pa)).bind === 'number' || typeof (runtime.dereference(members.m_write_pa)).bind === 'boolean' ? (runtime.dereference(members.m_write_pa)).bind : runtime.container(members.m_write_pa, "bind"));
  }

  function method_mos6526_device__pb_rd_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_read_pb)).bind === 'function' ? (runtime.dereference(members.m_read_pb)).bind() : typeof (runtime.dereference(members.m_read_pb)).bind === 'number' || typeof (runtime.dereference(members.m_read_pb)).bind === 'boolean' ? (runtime.dereference(members.m_read_pb)).bind : runtime.container(members.m_read_pb, "bind"));
  }

  function method_mos6526_device__pb_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_pb)).bind === 'function' ? (runtime.dereference(members.m_write_pb)).bind() : typeof (runtime.dereference(members.m_write_pb)).bind === 'number' || typeof (runtime.dereference(members.m_write_pb)).bind === 'boolean' ? (runtime.dereference(members.m_write_pb)).bind : runtime.container(members.m_write_pb, "bind"));
  }

  function method_mos6526_device__pc_wr_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_pc)).bind === 'function' ? (runtime.dereference(members.m_write_pc)).bind() : typeof (runtime.dereference(members.m_write_pc)).bind === 'number' || typeof (runtime.dereference(members.m_write_pc)).bind === 'boolean' ? (runtime.dereference(members.m_write_pc)).bind : runtime.container(members.m_write_pc, "bind"));
  }

  function method_mos6526_device__pa_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_pa ?? runtime.member("m_pa"));
  }

  function method_mos6526_device__pb_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_pb ?? runtime.member("m_pb"));
  }

  function method_mos6526_device__sp_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_sp ?? runtime.member("m_sp"));
  }

  function method_mos6526_device__cnt_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_cnt ?? runtime.member("m_cnt"));
  }

  function method_mos6526_device__irq_r(runtime: any): any {
    const members = runtime.members;
