...
definition.compiledMethods = (() => {
  ...
  function method_k053247_r(runtime: any, offset: any): any {
    ...
    let offs: any = ((runtime.shiftRight(offset, 1)) | 0);
    if (((offset) & (1))) {
      return ((runtime.readIndex((members.m_ram ?? runtime.member("m_ram")), offs)) & (255));
    } else {
      return runtime.shiftRight(runtime.readIndex((members.m_ram ?? runtime.member("m_ram")), offs), 8);
    }
  }
  ...
  function method_k055673_5bpp_rom_word_r(runtime: any, offset: any): any {
    ...
    let ROM8: any = runtime.addressOf((members.m_gfxrom ?? runtime.member("m_gfxrom")), 0);
    let ROM: any = runtime.packedView(runtime.addressOf((members.m_gfxrom ?? runtime.member("m_gfxrom")), 0), false);
  ...
  function method_k055673_rom_word_r(runtime: any, offset: any): any {
    ...
    let romofs: any = ((0) | 0);
    romofs = (((((((((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[6]) << (16))) | ((((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[7]) << (8))))) | ((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[4]))) | 0);
    romofs = ((((runtime.shiftRight(romofs, 2)) * ((members.m_bpp ?? runtime.member("m_bpp"))))) | 0);
    if (((Number(((offset) & (4))) === Number(0)) ? 1 : 0)) {
      romofs = ((((romofs) + (runtime.shiftRight((members.m_bpp ?? runtime.member("m_bpp")), 1)))) | 0);
    }
  ...
  function method_k055673_ps_rom_word_r(runtime: any, offset: any): any {
    ...
    let ROM: any = runtime.addressOf((members.m_gfxrom ?? runtime.member("m_gfxrom")), 0);
    let romofs: any = ((0) | 0);
    let magic: any = ((((offset) & (1))) | 0);
    romofs = (((((((((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[6]) << (16))) | ((((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[7]) << (8))))) | ((members.m_kx46_regs ?? runtime.member("m_kx46_regs"))[4]))) | 0);
    offset = runtime.shiftRight(((offset) & (4)), 1);
  ...
  function method_k053246_r(runtime: any, offset: any): any {
    ...
    if (((Number((members.m_objcha_line ?? runtime.member("m_objcha_line"))) === Number(1)) ? 1 : 0)) {
      ...
      return runtime.readIndex((members.m_gfxrom ?? runtime.member("m_gfxrom")), addr);
    } else {
      return 0;
    }
  }
  ...
  function method_k053247_draw_single_sprite_gxcore(runtime: any, bitmap: any, cliprect: any, gx_objzbuf: any, gx_shdzbuf: any, code: any, gx_spriteram: any, offs: any, color: any, alpha: any, drawmode: any, zcode: any, pri: any, primask: any, shadow: any, drawmode_table: any, shadowmode_table: any, shdmask: any): any {
    ...
    if (zoomy) {
      zoomy = ((runtime.divide(runtime.add(4194304, runtime.shiftRight(zoomy, 1)), zoomy)) | 0);
    } else {
      zoomy = ((8388608) | 0);
    }
    if (((((temp4) & (16384))) ? 0 : 1)) {
      ...
      if (zoomx) {
        zoomx = ((runtime.divide(runtime.add(4194304, runtime.shiftRight(zoomx, 1)), zoomx)) | 0);
      } else {
        zoomx = ((8388608) | 0);
      }
    } else {
    ...
    if (((objset1) & (8))) {
      ...
      zoomx = ((runtime.shiftRight(zoomx, 1)) | 0);
      ox = ((runtime.add(runtime.shiftRight(ox, 1), 1)) | 0);
      if (flipscreenx) {
        ox = ((((ox) + (screenwidth))) | 0);
      }
      nozoom = ((0) | 0);
    ...
    temp = ((((runtime.shiftRight(temp4, 8)) & (15))) | 0);
    let width: any = ((((1) << (((temp) & (3))))) | 0);
    let height: any = ((((1) << (((runtime.shiftRight(temp, 2)) & (3))))) | 0);
    if ((((((gx_objzbuf) && (gx_shdzbuf)) ? 1 : 0)) ? 0 : 1)) {
      ox = ((((ox) + ((members.m_dx ?? runtime.member("m_dx"))))) | 0);
      oy = ((((oy) - ((members.m_dy ?? runtime.member("m_dy"))))) | 0);
    }
    ox = ((((ox) - (runtime.shiftRight(((zoomx) * (width)), 13)))) | 0);
    oy = ((((oy) - (runtime.shiftRight(((zoomy) * (height)), 13)))) | 0);
    if ((((gx_objzbuf) && (gx_shdzbuf)) ? 1 : 0)) {
      ...
      if (((Number(color) === Number(-1)) ? 1 : 0)) {
        ...
        if (((Number(shdmask) >= Number(0)) ? 1 : 0)) {
          shadow = ((((((color) & (536870912))) ? (runtime.shiftRight(color, 20)) : (runtime.shiftRight(shadow, 10)))) | 0);
