...
definition.compiledMethods = (() => {
    ...
    function method_draw(runtime, screen, bitmap, cliprect, flip) {
        ...
        for (let offs = 0; ((Number(offs) < Number(32)) ? 1 : 0); offs = ((offs) + (1))) {
            let scroll = ((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((((((offs) & (3))) << (5))) | (runtime.shiftRight(offs, 2))))) | 0);
    ...
    function method_draw_sprites(runtime, bitmap, cliprect) {
        const members = runtime.members;
        for (let offs = ((896) | 0); ((Number(128) <= Number(offs)) ? 1 : 0); offs = ((((offs) - (64))) | 0)) {
            let i = ((0) | 0);
            ...
            while (((Number(0) < Number(i)) ? 1 : 0)) {
                ...
                if (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (128))) {
                    ...
                    let code = ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 1))) | ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 2))) >>> (4)) & 1)) << (8))))) | 0)) | 0);
                    let color = ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 2))) & (15))) | 0)) | 0);
                    let xpos = ((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 3))) | 0)) | 0);
                    let ypos = ((((((runtime.shiftRight(offs, 2)) | (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (15))))) | 0)) | 0);
                    if (big) {
    ...
    function method_get_bg_tile_info(runtime, tilemap, tileinfo, tile_index) {
        const members = runtime.members;
        let code = ((runtime.add(runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), tile_index), (((((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((1024) | (tile_index)))) >>> (3)) & 1)) << (8)))) | 0);
        let color = ((((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((1024) | (tile_index)))) & (7))) | 0);
