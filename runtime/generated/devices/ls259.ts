...
definition.compiledMethods = (() => {
  function method_write_bit(runtime: any, offset: any, d: any) {
  ...
  function method_write_abcd(runtime: any, a: any, d: any) {
    const members = runtime.members;
  ...
  function method_clear_outputs(runtime: any, new_q: any) {
    const members = runtime.members;
    ...
    for (let bit: any = 0; ((Number(bit) < Number(8)) ? 1 : 0); bit = ((bit) + (1))) {
  ...
  function method_update_bit(runtime: any) {
    const members = runtime.members;
  ...
  function method_enable_w(runtime: any, state: any) {
    const members = runtime.members;
  ...
  function method_write_d0(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_write_d1(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_write_d7(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_write_a0(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    method_write_bit(runtime, ((offset) >>> (1)), ((offset) & (1)));
  }

  function method_write_a3(runtime: any, offset: any, data: any) {
    const members = runtime.members;
