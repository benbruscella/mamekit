...
class GeneratedI8039 {
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('I8039 dispatch loop exceeded 8');
            switch ((this.m_ref >>> 8) & 0xffff) {
                ...
                default:
                    throw new Error('I8039 has no generated opcode ' +
    ...
    invoke(name, ...args) {
        switch (name) {
            ...
            default: throw new Error('I8039 has no generated method "' + name + '"');
        }
    }
    generatedStart() {
...
export const cpu = {
    ...
    create: (bus) => new GeneratedI8039(bus),
};
export default cpu;
