...
definition.compiledMethods = (() => {
    ...
    function method_clock_tod(runtime) {
        const members = runtime.members;
        let subsecond = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 0)) & 0xff)) & 0xff);
        let second = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 8)) & 0xff)) & 0xff);
        let minute = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 16)) & 0xff)) & 0xff);
        let hour = ((((runtime.shiftRight((members.m_tod ?? runtime.member("m_tod")), 24)) & 0xff)) & 0xff);
