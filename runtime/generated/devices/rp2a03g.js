...
class GeneratedRP2A03 {
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('RP2A03 dispatch loop exceeded 8');
    ...
    method_set_l(base, val) {
        return ((((base) & (65280))) | (val));
        return 0;
    }
    method_set_h(base, val) {
        return ((((base) & (255))) | (((val) << (8))));
        return 0;
    }
    method_page_changing(base, delta) {
...
export const cpu = {
    ...
    create: (bus) => new GeneratedRP2A03(bus),
};
export default cpu;
