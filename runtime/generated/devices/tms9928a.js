...
definition.compiledMethods = (() => {
    ...
    function method_vram_read(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let data = (((members.m_ReadAhead ?? runtime.member("m_ReadAhead"))) & 0xff);
    ...
    function method_register_read(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let data = (((members.m_StatusReg ?? runtime.member("m_StatusReg"))) & 0xff);
        if ((__l["machine().side_effects_disabled"]?.() ?? 0)) {
            return data;
        }
    ...
    function method_check_interrupt(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let b = ((((((((((members.m_StatusReg ?? runtime.member("m_StatusReg"))) & (128))) && ((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (32)))) ? 1 : 0)) ? (1) : (0))) & 0xff);
    ...
    function method_vram_write(runtime, data) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
    ...
    function method_register_write(runtime, data) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        if ((__l["machine().side_effects_disabled"]?.() ?? 0)) {
            return;
    ...
    function method_change_register(runtime, reg, val) {
        const members = runtime.members;
        let modes = ["Mode 0 (GRAPHIC 1)", "Mode 1 (TEXT 1)", "Mode 2 (GRAPHIC 2)", "Mode 1+2 (TEXT 1 variation)", "Mode 3 (MULTICOLOR)", "Mode 1+3 (BOGUS)", "Mode 2+3 (MULTICOLOR variation)", "Mode 1+2+3 (BOGUS)"];
        let prev = (((members.m_Regs ?? runtime.member("m_Regs"))[reg]) & 0xff);
            ...
            case 0:
                {
                    ...
                    members.m_mode = ((((((((1) ? ((((members.m_Regs ?? runtime.member("m_Regs"))[0]) & (2))) : (0))) | (runtime.shiftRight((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (16)), 4)))) | (runtime.shiftRight((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (8)), 1)))) & 0xff);
                    if (((((val) ^ (prev))) & (1))) {
    ...
    function method_update_table_masks(runtime) {
        const members = runtime.members;
    ...
    function method_update_backdrop(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
    ...
    function method_clock_grom(runtime, param) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
    ...
    function method_update_line(runtime, param) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        const h_m_tmpbmp = members.m_tmpbmp ?? runtime.member("m_tmpbmp");
        let raw_vpos = (((__l["screen().vpos"]?.() ?? 0)) | 0);
        let vpos = ((runtime.divide(((raw_vpos) * ((members.m_vertical_size ?? runtime.member("m_vertical_size")))), (__l["screen().height"]?.() ?? 0))) | 0);
        let BackColour = (((((members.m_Regs ?? runtime.member("m_Regs"))[7]) & (15))) & 0xffff);
        let p = h_m_tmpbmp["pix&"](vpos);
        let y = ((((vpos) - ((members.m_top_border ?? runtime.member("m_top_border"))))) | 0);
        if (((((((((Number(y) < Number(0)) ? 1 : 0)) || (((Number(y) >= Number(192)) ? 1 : 0))) ? 1 : 0)) || ((((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (64))) ? 0 : 1))) ? 1 : 0)) {
            for (let i = ((0) | 0); ((Number(i) < Number(342)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
            ...
            for (let i = ((0) | 0); ((Number(i) < Number(37)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                runtime.writeIndex(p, i, (__l["pen"] ? __l["pen"](BackColour) : runtime.macro("pen", BackColour)));
            }
            switch ((members.m_mode ?? runtime.member("m_mode"))) {
                case 0:
                    {
                        let addr = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((((y) & (248))) << (2))))) & 0xffff);
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_colour ?? runtime.member("m_colour"))) + (runtime.shiftRight(charcode, 3)))) ?? 0)) & 0xff);
                            let fg = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
                            let bg = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                            for (let i = ((0) | 0); ((Number(i) < Number(8)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
                ...
                case 1:
                    {
                        let addr = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((runtime.shiftRight(y, 3)) * (40))))) & 0xffff);
                        let fg = (__l["pen"] ? __l["pen"](((runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) ? (runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) ? (runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) : (BackColour))));
                        let bg = (__l["pen"] ? __l["pen"](BackColour) : runtime.macro("pen", BackColour));
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 6))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                            runtime.writeIndex(p, x, bg);
                        }
                        for (let x = ((runtime.add(37, 6)) | 0); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((((x) + (6))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xffff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            for (let i = ((0) | 0); ((Number(i) < Number(6)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
                                runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
                            }
                        }
                        for (let x = ((runtime.add(37, 246)) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (1))) | 0)) {
                            runtime.writeIndex(p, x, bg);
                        }
                        break;
                    }
                case 2:
                    {
                        let addr = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((runtime.shiftRight(y, 3)) * (32))))) & 0xffff);
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((runtime.shiftRight(y, 6)) << (8)))) & 0xffff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((((charcode) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_colour ?? runtime.member("m_colour"))) + (((((charcode) & ((members.m_colourmask ?? runtime.member("m_colourmask"))))) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            let fg = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
                            let bg = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                            for (let i = ((0) | 0); ((Number(i) < Number(8)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
                                runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
                ...
                case 3:
                    {
                        ...
                        for (let x = ((runtime.add(37, 6)) | 0); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((((x) + (6))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((runtime.shiftRight(y, 6)) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) & 0xffff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            for (let i = ((0) | 0); ((Number(i) < Number(6)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
                                runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
                            }
                ...
                case 4:
                    {
                        ...
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((runtime.shiftRight(y, 2)) & (7)))) ?? 0)) & 0xff);
                            let fg = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
                            let bg = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                ...
                case 7:
                    {
                        ...
                        for (let x = ((runtime.add(37, 6)) | 0); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((((x) + (6))) | 0)) {
                            runtime.writeIndex(p, ((x) + (0)), (runtime.writeIndex(p, ((x) + (1)), (runtime.writeIndex(p, ((x) + (2)), (runtime.writeIndex(p, ((x) + (3)), fg)))))));
                ...
                case 6:
                    {
                        ...
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_pattern ?? runtime.member("m_pattern"))) + (((((runtime.add(((charcode) + (((runtime.shiftRight(y, 2)) & (7)))), ((runtime.shiftRight(y, 6)) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) << (3))))) ?? 0)) & 0xff);
                            let fg = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
                            let bg = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                            runtime.writeIndex(p, ((x) + (0)), (runtime.writeIndex(p, ((x) + (1)), (runtime.writeIndex(p, ((x) + (2)), (runtime.writeIndex(p, ((x) + (3)), fg)))))));
                            runtime.writeIndex(p, ((x) + (4)), (runtime.writeIndex(p, ((x) + (5)), (runtime.writeIndex(p, ((x) + (6)), (runtime.writeIndex(p, ((x) + (7)), bg)))))));
            ...
            if (((Number((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (80))) !== Number(64)) ? 1 : 0)) {
                ...
                let sprite_size = (((((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (2))) ? (16) : (8))) & 0xff);
                let sprite_mag = (((((members.m_Regs ?? runtime.member("m_Regs"))[1]) & (1))) & 0xff);
                let sprite_height = ((((sprite_size) * (((sprite_mag) + (1))))) & 0xff);
                let spr_drawn = [0];
                let num_sprites = ((0) & 0xff);
                let fifth_encountered = ((0) ? 1 : 0);
                for (let sprattr = ((0) & 0xffff); ((Number(sprattr) < Number(128)) ? 1 : 0); sprattr = ((((sprattr) + (4))) & 0xffff)) {
                    let spr_y = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 0)) ?? 0)) | 0);
                    ...
                    if ((((((Number(spr_y) <= Number(y)) ? 1 : 0)) && (((Number(y) < Number(((spr_y) + (sprite_height)))) ? 1 : 0))) ? 1 : 0)) {
                        let spr_x = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 1)) ?? 0)) | 0);
                        let sprcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 2)) ?? 0)) & 0xff);
                        let sprcol = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 3)) ?? 0)) & 0xff);
                        let pataddr = (((((members.m_spritepattern ?? runtime.member("m_spritepattern"))) + (((((((Number(sprite_size) === Number(16)) ? 1 : 0)) ? (((sprcode) & (-4))) : (sprcode))) * (8))))) & 0xffff);
                        ...
                        if (sprite_mag) {
                            pataddr = ((((pataddr) + (runtime.shiftRight(((((y) - (spr_y))) & (31)), 1)))) & 0xffff);
                        }
                        else {
                            pataddr = ((((pataddr) + (((((y) - (spr_y))) & (15))))) & 0xffff);
                        }
                        let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(pataddr) ?? 0)) & 0xff);
                        if (((sprcol) & (128))) {
                            spr_x = ((((spr_x) - (32))) | 0);
                        }
                        sprcol = ((runtime.andAssign(sprcol, 15)) & 0xff);
                        for (let s = ((0) | 0); ((Number(s) < Number(sprite_size)) ? 1 : 0); s = ((((s) + (8))) | 0)) {
                            for (let i = ((0) | 0); ((Number(i) < Number(8)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
                                let colission_index = ((runtime.add(((spr_x) + (((sprite_mag) ? (((i) * (2))) : (i)))), 32)) | 0);
                                for (let z = ((0) | 0); ((Number(z) <= Number(sprite_mag)) ? 1 : 0); colission_index = ((((colission_index) + (1))) | 0), z = ((((z) + (1))) | 0)) {
                                    if (((pattern) & (128))) {
            ...
            for (let i = ((runtime.add(37, 256)) | 0); ((Number(i) < Number(342)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                runtime.writeIndex(p, i, (__l["pen"] ? __l["pen"](BackColour) : runtime.macro("pen", BackColour)));
            }
        }
