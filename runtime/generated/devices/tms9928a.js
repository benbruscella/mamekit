...
definition.compiledMethods = (() => {
    ...
    function method_check_interrupt(runtime) {
        const members = runtime.members;
        let b = ((((((((((members.m_StatusReg ?? runtime.member("m_StatusReg"))) & (128))) && (((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 1)) & (32)))) ? 1 : 0)) ? (1) : (0))) & 0xff);
    ...
    function method_change_register(runtime, reg, val) {
        ...
        let prev = ((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), reg)) & 0xff);
    ...
    function method_update_line(runtime, param) {
        ...
        let raw_vpos = (runtime.calls["screen().vpos"]?.() ?? 0);
        let vpos = runtime.divide(((raw_vpos) * ((members.m_vertical_size ?? runtime.member("m_vertical_size")))), (runtime.calls["screen().height"]?.() ?? 0));
        let BackColour = ((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 7)) & (15))) & 0xffff);
        let p = h_m_tmpbmp["pix&"](vpos);
        let y = ((vpos) - ((members.m_top_border ?? runtime.member("m_top_border"))));
        if (((((((((Number(y) < Number(0)) ? 1 : 0)) || (((Number(y) >= Number(192)) ? 1 : 0))) ? 1 : 0)) || (((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 1)) & (64))) ? 0 : 1))) ? 1 : 0)) {
            for (let i = 0; ((Number(i) < Number(h_m_total_horz)) ? 1 : 0); i = ((i) + (1))) {
            ...
            for (let i = 0; ((Number(i) < Number(37)) ? 1 : 0); i = ((i) + (1))) {
                runtime.writeIndex(p, i, (runtime.calls["pen"] ? runtime.calls["pen"](BackColour) : runtime.macro("pen", BackColour)));
            }
            switch ((members.m_mode ?? runtime.member("m_mode"))) {
                case 0:
                    {
                        ...
                        for (let x = 37; ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((x) + (8)), addr = ((((addr) + (1))) & 0xffff)) {
                            ...
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_colour ?? runtime.member("m_colour"))) + (((charcode) >>> (3))))) ?? 0)) & 0xff);
                            let fg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))) : runtime.macro("pen", ((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))));
                            let bg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                            for (let i = 0; ((Number(i) < Number(8)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((i) + (1))) {
                ...
                case 1:
                    {
                        let addr = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((((y) >>> (3))) * (40))))) & 0xffff);
                        let fg = (runtime.calls["pen"] ? runtime.calls["pen"](((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 7)) >>> (4))) ? (((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 7)) >>> (4))) : (BackColour))) : runtime.macro("pen", ((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 7)) >>> (4))) ? (((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 7)) >>> (4))) : (BackColour))));
                        let bg = (runtime.calls["pen"] ? runtime.calls["pen"](BackColour) : runtime.macro("pen", BackColour));
                        for (let x = 37; ((Number(x) < Number(runtime.add(37, 6))) ? 1 : 0); x = ((x) + (1))) {
                            runtime.writeIndex(p, x, bg);
                        }
                        for (let x = runtime.add(37, 6); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((x) + (6)), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xffff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            for (let i = 0; ((Number(i) < Number(6)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((i) + (1))) {
                                runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
                            }
                        }
                        for (let x = runtime.add(37, 246); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((x) + (1))) {
                            runtime.writeIndex(p, x, bg);
                        }
                        break;
                    }
                case 2:
                    {
                        let addr = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((((y) >>> (3))) * (32))))) & 0xffff);
                        for (let x = 37; ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((x) + (8)), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((((y) >>> (6))) << (8)))) & 0xffff);
                ...
                case 3:
                    {
                        ...
                        for (let x = runtime.add(37, 6); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((x) + (6)), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((((y) >>> (6))) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) & 0xffff);
                            let pattern = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
                            for (let i = 0; ((Number(i) < Number(6)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((i) + (1))) {
                                runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
                            }
                ...
                case 4:
                    {
                        ...
                        for (let x = 37; ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((x) + (8)), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((((y) >>> (2))) & (7)))) ?? 0)) & 0xff);
                            let fg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))) : runtime.macro("pen", ((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))));
                            let bg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                ...
                case 7:
                    {
                        ...
                        for (let x = runtime.add(37, 6); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((x) + (6))) {
                            runtime.writeIndex(p, ((x) + (0)), (runtime.writeIndex(p, ((x) + (1)), (runtime.writeIndex(p, ((x) + (2)), (runtime.writeIndex(p, ((x) + (3)), fg)))))));
                ...
                case 6:
                    {
                        ...
                        for (let x = 37; ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((x) + (8)), addr = ((((addr) + (1))) & 0xffff)) {
                            let charcode = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
                            let colour = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_pattern ?? runtime.member("m_pattern"))) + (((((runtime.add(((charcode) + (((((y) >>> (2))) & (7)))), ((((y) >>> (6))) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) << (3))))) ?? 0)) & 0xff);
                            let fg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))) : runtime.macro("pen", ((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))));
                            let bg = (runtime.calls["pen"] ? runtime.calls["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
                            runtime.writeIndex(p, ((x) + (0)), (runtime.writeIndex(p, ((x) + (1)), (runtime.writeIndex(p, ((x) + (2)), (runtime.writeIndex(p, ((x) + (3)), fg)))))));
                            runtime.writeIndex(p, ((x) + (4)), (runtime.writeIndex(p, ((x) + (5)), (runtime.writeIndex(p, ((x) + (6)), (runtime.writeIndex(p, ((x) + (7)), bg)))))));
            ...
            if (((Number(((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 1)) & (80))) !== Number(64)) ? 1 : 0)) {
                ...
                let sprite_size = ((((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 1)) & (2))) ? (16) : (8))) & 0xff);
                let sprite_mag = ((((runtime.readIndex((members.m_Regs ?? runtime.member("m_Regs")), 1)) & (1))) & 0xff);
                ...
                for (let sprattr = ((0) & 0xffff); ((Number(sprattr) < Number(128)) ? 1 : 0); sprattr = ((((sprattr) + (4))) & 0xffff)) {
                    let spr_y = ((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 0)) ?? 0);
                    ...
                    if ((((((Number(spr_y) <= Number(y)) ? 1 : 0)) && (((Number(y) < Number(((spr_y) + (sprite_height)))) ? 1 : 0))) ? 1 : 0)) {
                        let spr_x = ((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_spriteattribute ?? runtime.member("m_spriteattribute"))) + (sprattr)), 1)) ?? 0);
                        ...
                        let pataddr = (((((members.m_spritepattern ?? runtime.member("m_spritepattern"))) + (((((((Number(sprite_size) === Number(16)) ? 1 : 0)) ? (((sprcode) & ((~3)))) : (sprcode))) * (8))))) & 0xffff);
                        ...
                        for (let s = 0; ((Number(s) < Number(sprite_size)) ? 1 : 0); s = ((s) + (8))) {
                            for (let i = 0; ((Number(i) < Number(8)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((i) + (1))) {
                                let colission_index = runtime.add(((spr_x) + (((sprite_mag) ? (((i) * (2))) : (i)))), 32);
                                for (let z = 0; ((Number(z) <= Number(sprite_mag)) ? 1 : 0); colission_index = ((colission_index) + (1)), z = ((z) + (1))) {
                                    if (((pattern) & (128))) {
            ...
            for (let i = runtime.add(37, 256); ((Number(i) < Number(h_m_total_horz)) ? 1 : 0); i = ((i) + (1))) {
                runtime.writeIndex(p, i, (runtime.calls["pen"] ? runtime.calls["pen"](BackColour) : runtime.macro("pen", BackColour)));
            }
        }
