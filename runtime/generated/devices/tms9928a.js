                ...
                case 0:
                    {
                        ...
                        for (let x = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
                            ...
                            let fg = (__l["pen"] ? __l["pen"](((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))) : runtime.macro("pen", ((((colour) >>> (4))) ? (((colour) >>> (4))) : (BackColour))));
                ...
                case 1:
                    {
                        ...
                        let fg = (__l["pen"] ? __l["pen"]((((((members.m_Regs ?? runtime.member("m_Regs"))[7]) >>> (4))) ? ((((members.m_Regs ?? runtime.member("m_Regs"))[7]) >>> (4))) : (BackColour))) : runtime.macro("pen", (((((members.m_Regs ?? runtime.member("m_Regs"))[7]) >>> (4))) ? ((((members.m_Regs ?? runtime.member("m_Regs"))[7]) >>> (4))) : (BackColour))));
