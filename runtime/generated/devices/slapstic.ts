...
definition.compiledMethods = (() => {
  ...
  function method_tmatch(runtime: any, slot: any, addr: any): any {
  ...
  function method_test(runtime: any, addr: any): any {
    const members = runtime.members;
          ...
          if (((Number((members.m_state ?? runtime.member("m_state"))) === Number(3)) ? 1 : 0)) {
            if (method_tmatch(runtime, 0, addr)) {
              ...
              if (method_tmatch(runtime, 11, addr)) {
                members.m_loaded_bank = ((((runtime.shiftRight(addr, (members.m_alt_shift ?? runtime.member("m_alt_shift")))) & (3))) & 0xff);
                members.m_state = 4;
              } else {
                members.m_state = 1;
              }
                    ...
                    if (method_tmatch(runtime, 14, addr)) {
                      ...
                      if (method_tmatch(runtime, 15, addr)) {
                        ...
                        if (method_tmatch(runtime, 16, addr)) {
                          members.m_loaded_bank = (((((members.m_loaded_bank ?? runtime.member("m_loaded_bank"))) & (-3))) & 0xff);
                          members.m_state = 7;
                        } else {
  ...
  function method_change_bank(runtime: any, bank: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    members.m_current_bank = ((bank) & 0xff);
    (__l["set_bank_entry"] ? __l["set_bank_entry"]((members.m_current_bank ?? runtime.member("m_current_bank"))) : runtime.macro("set_bank_entry", (members.m_current_bank ?? runtime.member("m_current_bank"))));
  }

  function method_commit_bank(runtime: any): any {
    const members = runtime.members;
...
definition.compiledMethodLinks = ["set_bank_entry"];
