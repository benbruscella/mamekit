...
class GeneratedSEGA_315_5177 implements Cpu {
  ...
  private m_af2 = new Pair16(0);
  private m_bc = new Pair16(0);
  private m_bc2 = new Pair16(0);
  private m_busack_state = ((0) & 0xff);
  private m_busreq_state = ((0) >>> 0);
  private m_de = new Pair16(0);
  private m_de2 = new Pair16(0);
  private m_ea = ((0) & 0xffff);
  private m_f = { s_val: 0, z_val: 0, yx_val: 0, h_val: 0, pv_val: 0, n: 0, c: 0, q: 0, qtemp: 0 };
  private m_halt = ((0) & 0xff);
  private m_hl = new Pair16(0);
  private m_hl2 = new Pair16(0);
  private m_i = ((0) & 0xff);
  private m_icount = ((0) >>> 0);
  private m_iff1 = ((0) ? 1 : 0);
  private m_iff2 = ((0) ? 1 : 0);
  private m_im = ((0) & 0xff);
  private m_iorq_cycles = ((4) & 0xff);
  private m_irq_state = ((0) & 0xff);
  private m_ix = new Pair16(0);
  private m_iy = new Pair16(0);
  private m_m1_cycles = ((4) & 0xff);
  private m_mreq_cycles = ((3) & 0xff);
  private m_nmi_state = ((0) & 0xff);
  private m_pc = new Pair16(0);
  private m_prvpc = new Pair16(0);
  private m_r = ((0) & 0xff);
  private m_r2 = ((0) & 0xff);
  private m_ref = ((0) >>> 0);
  private m_rtemp = ((0) & 0xff);
  private m_service_attention = ((0) & 0xff);
  private m_shared_data = new Pair16(0);
  private m_shared_data2 = new Pair16(0);
  private m_sp = new Pair16(0);
  private m_tmp_irq_vector = ((0) >>> 0);
  private m_wait_state = ((0) >>> 0);
  private m_wz = new Pair16(0);
  private get PRVPC(): number { return this.m_prvpc.w; }
  private set PRVPC(value: number) { this.m_prvpc.w = ((value) & 0xffff); }
  ...
  private get Q(): number { return this.m_f.q; }
  private set Q(value: number) { this.m_f.q = ((value) & 0xff); }
  private get QT(): number { return this.m_f.qtemp; }
  private set QT(value: number) { this.m_f.qtemp = ((value) & 0xff); }
  private get I(): number { return this.m_i; }
  private set I(value: number) { this.m_i = ((value) & 0xff); }
  private get R(): number { return this.m_r; }
  private set R(value: number) { this.m_r = ((value) & 0xff); }
  private get R2(): number { return this.m_r2; }
  private set R2(value: number) { this.m_r2 = ((value) & 0xff); }
  ...
  private get IX(): number { return this.m_ix.w; }
  private set IX(value: number) { this.m_ix.w = ((value) & 0xffff); }
  private get HX(): number { return this.m_ix.b.h; }
  private set HX(value: number) { this.m_ix.b.h = ((value) & 0xff); }
  private get LX(): number { return this.m_ix.b.l; }
  private set LX(value: number) { this.m_ix.b.l = ((value) & 0xff); }
  private get IY(): number { return this.m_iy.w; }
  private set IY(value: number) { this.m_iy.w = ((value) & 0xffff); }
  private get HY(): number { return this.m_iy.b.h; }
  private set HY(value: number) { this.m_iy.b.h = ((value) & 0xff); }
  private get LY(): number { return this.m_iy.b.l; }
  private set LY(value: number) { this.m_iy.b.l = ((value) & 0xff); }
  private get WZ(): number { return this.m_wz.w; }
  private set WZ(value: number) { this.m_wz.w = ((value) & 0xffff); }
  private get WZ_H(): number { return this.m_wz.b.h; }
  private set WZ_H(value: number) { this.m_wz.b.h = ((value) & 0xff); }
  private get WZ_L(): number { return this.m_wz.b.l; }
  private set WZ_L(value: number) { this.m_wz.b.l = ((value) & 0xff); }
  private get TDAT(): number { return this.m_shared_data.w; }
  private set TDAT(value: number) { this.m_shared_data.w = ((value) & 0xffff); }
  private get TDAT2(): number { return this.m_shared_data2.w; }
  private set TDAT2(value: number) { this.m_shared_data2.w = ((value) & 0xffff); }
  private get TDAT_H(): number { return this.m_shared_data.b.h; }
  private set TDAT_H(value: number) { this.m_shared_data.b.h = ((value) & 0xff); }
  private get TDAT_L(): number { return this.m_shared_data.b.l; }
  private set TDAT_L(value: number) { this.m_shared_data.b.l = ((value) & 0xff); }
  private get TDAT8(): number { return this.m_shared_data.b.l; }
  private set TDAT8(value: number) { this.m_shared_data.b.l = ((value) & 0xff); }
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('SEGA_315_5177 dispatch loop exceeded 8');
      ...
      case 0xfeff: {
        ...
        default:
          throw new Error('SEGA_315_5177 has no generated opcode ' +
  ...
  set(name: string, value: number): void {
    switch (name) {
      case "PRVPC": this.PRVPC = ((value) & 0xffff); return;
      case "PC": this.PC = ((value) & 0xffff); return;
      case "SP": this.SP = ((value) & 0xffff); return;
      case "Q": this.Q = ((value) & 0xff); return;
      case "QT": this.QT = ((value) & 0xff); return;
      case "I": this.I = ((value) & 0xff); return;
      case "R": this.R = ((value) & 0xff); return;
      case "R2": this.R2 = ((value) & 0xff); return;
      ...
      case "IX": this.IX = ((value) & 0xffff); return;
      case "HX": this.HX = ((value) & 0xff); return;
      case "LX": this.LX = ((value) & 0xff); return;
      case "IY": this.IY = ((value) & 0xffff); return;
      case "HY": this.HY = ((value) & 0xff); return;
      case "LY": this.LY = ((value) & 0xff); return;
      case "WZ": this.WZ = ((value) & 0xffff); return;
      case "WZ_H": this.WZ_H = ((value) & 0xff); return;
      case "WZ_L": this.WZ_L = ((value) & 0xff); return;
      case "TDAT": this.TDAT = ((value) & 0xffff); return;
      case "TDAT2": this.TDAT2 = ((value) & 0xffff); return;
      case "TDAT_H": this.TDAT_H = ((value) & 0xff); return;
      case "TDAT_L": this.TDAT_L = ((value) & 0xff); return;
      case "TDAT8": this.TDAT8 = ((value) & 0xff); return;
      ...
      case "m_af2":
      case "m_af2.w": this.m_af2.w = value; return;
      case "m_af2.b.h": this.m_af2.b.h = value; return;
      case "m_af2.b.l": this.m_af2.b.l = value; return;
      case "m_bc":
      case "m_bc.w": this.m_bc.w = value; return;
      case "m_bc.b.h": this.m_bc.b.h = value; return;
      case "m_bc.b.l": this.m_bc.b.l = value; return;
      case "m_bc2":
      case "m_bc2.w": this.m_bc2.w = value; return;
      case "m_bc2.b.h": this.m_bc2.b.h = value; return;
      case "m_bc2.b.l": this.m_bc2.b.l = value; return;
      case "m_busack_state": this.m_busack_state = ((value) & 0xff); return;
      ...
      case "m_de2":
      case "m_de2.w": this.m_de2.w = value; return;
      case "m_de2.b.h": this.m_de2.b.h = value; return;
      case "m_de2.b.l": this.m_de2.b.l = value; return;
      case "m_ea": this.m_ea = ((value) & 0xffff); return;
      case "m_f.s_val": this.m_f.s_val = ((value) & 0xff); return;
      case "m_f.z_val": this.m_f.z_val = ((value) & 0xff); return;
      case "m_f.yx_val": this.m_f.yx_val = ((value) & 0xff); return;
      case "m_f.h_val": this.m_f.h_val = ((value) & 0xff); return;
      case "m_f.pv_val": this.m_f.pv_val = ((value) & 0xff); return;
      case "m_f.n": this.m_f.n = ((value) ? 1 : 0); return;
      case "m_f.c": this.m_f.c = ((value) ? 1 : 0); return;
      case "m_f.q": this.m_f.q = ((value) & 0xff); return;
      case "m_f.qtemp": this.m_f.qtemp = ((value) & 0xff); return;
      ...
      case "m_hl2":
      case "m_hl2.w": this.m_hl2.w = value; return;
      case "m_hl2.b.h": this.m_hl2.b.h = value; return;
      case "m_hl2.b.l": this.m_hl2.b.l = value; return;
      case "m_i": this.m_i = ((value) & 0xff); return;
      case "m_icount": this.m_icount = ((value) >>> 0); return;
      case "m_iff1": this.m_iff1 = ((value) ? 1 : 0); return;
      case "m_iff2": this.m_iff2 = ((value) ? 1 : 0); return;
      case "m_im": this.m_im = ((value) & 0xff); return;
      case "m_iorq_cycles": this.m_iorq_cycles = ((value) & 0xff); return;
      case "m_irq_state": this.m_irq_state = ((value) & 0xff); return;
      case "m_ix":
      case "m_ix.w": this.m_ix.w = value; return;
      case "m_ix.b.h": this.m_ix.b.h = value; return;
      case "m_ix.b.l": this.m_ix.b.l = value; return;
      case "m_iy":
      case "m_iy.w": this.m_iy.w = value; return;
      case "m_iy.b.h": this.m_iy.b.h = value; return;
      case "m_iy.b.l": this.m_iy.b.l = value; return;
      case "m_m1_cycles": this.m_m1_cycles = ((value) & 0xff); return;
      case "m_mreq_cycles": this.m_mreq_cycles = ((value) & 0xff); return;
      ...
      case "m_prvpc":
      case "m_prvpc.w": this.m_prvpc.w = value; return;
      case "m_prvpc.b.h": this.m_prvpc.b.h = value; return;
      case "m_prvpc.b.l": this.m_prvpc.b.l = value; return;
      case "m_r": this.m_r = ((value) & 0xff); return;
      case "m_r2": this.m_r2 = ((value) & 0xff); return;
      case "m_ref": this.m_ref = ((value) >>> 0); return;
      case "m_rtemp": this.m_rtemp = ((value) & 0xff); return;
      case "m_service_attention": this.m_service_attention = ((value) & 0xff); return;
      case "m_shared_data":
      case "m_shared_data.w": this.m_shared_data.w = value; return;
      case "m_shared_data.b.h": this.m_shared_data.b.h = value; return;
      case "m_shared_data.b.l": this.m_shared_data.b.l = value; return;
      case "m_shared_data2":
      case "m_shared_data2.w": this.m_shared_data2.w = value; return;
      case "m_shared_data2.b.h": this.m_shared_data2.b.h = value; return;
      case "m_shared_data2.b.l": this.m_shared_data2.b.l = value; return;
      case "m_sp":
      case "m_sp.w": this.m_sp.w = value; return;
      case "m_sp.b.h": this.m_sp.b.h = value; return;
      case "m_sp.b.l": this.m_sp.b.l = value; return;
      case "m_tmp_irq_vector": this.m_tmp_irq_vector = ((value) >>> 0); return;
      case "m_wait_state": this.m_wait_state = ((value) >>> 0); return;
      case "m_wz":
  ...
  invoke(name: string, ...args: number[]): number {
    switch (name) {
      ...
      default: throw new Error('SEGA_315_5177 has no generated method "' + name + '"');
    }
  }
  ...
  private method_set_f(f: number = 0): number {
  ...
  private method_leave_halt(): number {
    if (this.m_halt) {
      this.m_halt = ((0) & 0xff);
  ...
  private method_data_read(addr: number = 0): number {
    return (this.readMemory((addr) & 0xffff) & 0xff);
    return 0;
  }

  private method_data_write(addr: number = 0, value: number = 0): number {
    (this.writeMemory((addr) & 0xffff, (value) & 0xff), 0);
    return 0;
  }

  private method_opcode_read(): number {
    return ((this.bus.readOpcode?.((this.PC) & 0xffff) ?? this.readMemory((this.PC) & 0xffff)) & 0xff);
    return 0;
  }

  private method_arg_read(): number {
    return (this.readMemory((this.PC) & 0xffff) & 0xff);
    return 0;
  }

  private method_inc(r: number = 0): number {
    r = ((((r) + (1))) & 0xff);
    this.QT = ((0) & 0xff);
  ...
  private method_dec(r: number = 0): number {
    r = ((((r) - (1))) & 0xff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.yx_val = ((r) & 0xff))) & 0xff))) & 0xff);
  ...
  private method_add_a(value: number = 0): number {
  ...
  private method_adc_a(value: number = 0): number {
    let c = ((this.m_f.c) | 0);
  ...
  private method_sub_a(value: number = 0): number {
    let res = ((((this.A) - (value))) & 0xffff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.yx_val = ((res) & 0xff))) & 0xff))) & 0xff);
    this.m_f.c = ((((res) & (256))) ? 1 : 0);
  ...
  private method_sbc_a(value: number = 0): number {
    let c = ((this.m_f.c) | 0);
    let res = ((((((this.A) - (value))) - (c))) & 0xffff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.yx_val = ((res) & 0xff))) & 0xff))) & 0xff);
  ...
  private method_and_a(value: number = 0): number {
  ...
  private method_or_a(value: number = 0): number {
    this.A = ((((this.A) | (value))) & 0xff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = (((this.m_f.yx_val = ((this.A) & 0xff))) & 0xff))) & 0xff))) & 0xff);
  ...
  private method_xor_a(value: number = 0): number {
    this.A = ((((this.A) ^ (value))) & 0xff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = (((this.m_f.yx_val = ((this.A) & 0xff))) & 0xff))) & 0xff))) & 0xff);
    this.m_f.h_val = (((this.m_f.n = (((this.m_f.c = ((0) ? 1 : 0))) ? 1 : 0))) & 0xff);
  ...
  private method_cp(value: number = 0): number {
    let res = ((((this.A) - (value))) & 0xffff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = ((res) & 0xff))) & 0xff);
  ...
  private method_rlc(value: number = 0): number {
  ...
  private method_rrc(value: number = 0): number {
    let res = ((((((((value) >>> (1))) | (((value) << (7))))) & (255))) & 0xff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = (((this.m_f.yx_val = ((res) & 0xff))) & 0xff))) & 0xff))) & 0xff);
    this.m_f.h_val = (((this.m_f.n = ((0) ? 1 : 0))) & 0xff);
  ...
  private method_rl(value: number = 0): number {
  ...
  private method_rr(value: number = 0): number {
  ...
  private method_sla(value: number = 0): number {
  ...
  private method_sra(value: number = 0): number {
  ...
  private method_sll(value: number = 0): number {
  ...
  private method_srl(value: number = 0): number {
    let res = ((((((value) >>> (1))) & (255))) & 0xff);
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = (((this.m_f.yx_val = ((res) & 0xff))) & 0xff))) & 0xff))) & 0xff);
    this.m_f.h_val = (((this.m_f.n = ((0) ? 1 : 0))) & 0xff);
  ...
  private method_bit(bit: number = 0, value: number = 0): number {
    this.QT = ((0) & 0xff);
  ...
  private method_bit_hl(bit: number = 0, value: number = 0): number {
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = ((((value) & (((1) << (bit))))) & 0xff))) & 0xff))) & 0xff);
    this.m_f.h_val = ((16) & 0xff);
    this.m_f.n = ((0) ? 1 : 0);
  ...
  private method_bit_xy(bit: number = 0, value: number = 0): number {
    this.QT = ((0) & 0xff);
    this.m_f.s_val = (((this.m_f.z_val = (((this.m_f.pv_val = ((((value) & (((1) << (bit))))) & 0xff))) & 0xff))) & 0xff);
    this.m_f.h_val = ((16) & 0xff);
    this.m_f.n = ((0) ? 1 : 0);
  ...
  private method_res(bit: number = 0, value: number = 0): number {
    return ((value) & ((~((1) << (bit)))));
    return 0;
  }

  private method_set(bit: number = 0, value: number = 0): number {
    return ((value) | (((1) << (bit))));
    return 0;
  }

  private method_block_io_interrupted_flags(): number {
    this.m_f.yx_val = ((((this.PC) >>> (8))) & 0xff);
  ...
  private method_ei(): number {
    this.m_iff1 = (((this.m_iff2 = ((1) ? 1 : 0))) ? 1 : 0);
    this.method_set_service_attention(4, 1);
    return 0;
  }

  private method_illegal_1(): number {
    0;
    return 0;
  }

  private method_illegal_2(): number {
    0;
    return 0;
  }

  private method_m_f_s(): number {
    return ((this.m_f.s_val) & (128));
    return 0;
  }

  private method_m_f_z(): number {
    return ((this.m_f.z_val) ? (0) : (64));
    return 0;
  }

  private method_m_f_yx(): number {
    return ((this.m_f.yx_val) & (40));
    return 0;
  }

  private method_m_f_h(): number {
    return ((this.m_f.h_val) & (16));
    return 0;
  }

  private method_m_f_pv(): number {
  ...
  private method_z80_set_m1_cycles(m1_cycles: number = 0): number {
    this.m_m1_cycles = ((m1_cycles) & 0xff);
    return 0;
  }

  private method_z80_set_mreq_cycles(mreq_cycles: number = 0): number {
    this.m_mreq_cycles = ((mreq_cycles) & 0xff);
    return 0;
  }

  private method_z80_set_iorq_cycles(iorq_cycles: number = 0): number {
    this.m_iorq_cycles = ((iorq_cycles) & 0xff);
    return 0;
  }

  private method_irqack_cb(): number {
    return 0;
    return 0;
  }

  private method_refresh_cb(): number {
    return 0;
    return 0;
  }

  private method_nomreq_cb(): number {
    return 0;
    return 0;
  }

  private method_halt_cb(): number {
    return 0;
    return 0;
  }

  private method_busack_cb(): number {
    return 0;
    return 0;
  }

  private method_halt_r(): number {
    return this.m_halt;
    return 0;
  }

  private method_busack_r(): number {
    return this.m_busack_state;
    return 0;
  }

  private method_device_pre_save(): number {
    this.m_af.b.l = ((this.method_get_f()) & 0xff);
    return 0;
  }

  private method_device_post_load(): number {
    this.method_set_f(this.m_af.b.l);
    return 0;
  }

  private method_cpu_is_interruptible(): number {
    return 1;
    return 0;
  }

  private method_execute_min_cycles(): number {
    return 1;
    return 0;
  }

  private method_execute_max_cycles(): number {
    return 16;
    return 0;
  }

  private method_execute_default_irq_vector(inputnum: number = 0): number {
    return 255;
    return 0;
  }

  private method_execute_input_edge_triggered(inputnum: number = 0): number {
    return ((Number(inputnum) === Number(-1)) ? 1 : 0);
    return 0;
  }

  private method_set_service_attention(Bit: number = 0, State: number = 0): number {
    if (State) {
  ...
  private method_get_service_attention(Bit: number = 0): number {
    return ((this.m_service_attention) & (((1) << (Bit))));
    return 0;
  }

  private method_stack_read(addr: number = 0): number {
    return this.method_data_read(addr);
    return 0;
  }

  private method_stack_write(addr: number = 0, value: number = 0): number {
...
export const cpu: GeneratedCpuExecutable = {
  ...
  create: (bus: CpuBus): Cpu => new GeneratedSEGA_315_5177(bus),
};
