...
definition.compiledMethods = (() => {
  ...
  function method_draw_fixed_layer(runtime: any, bitmap: any, scanline: any): any {
    ...
    let video_data: any = runtime.packedView(runtime.addressOf((members.m_videoram_drawsource ?? runtime.member("m_videoram_drawsource")), ((28672) | (runtime.shiftRight(scanline, 3)))), false);
    let pixel_addr: any = bitmap["pix&"](scanline, 28);
    for (let x: any = ((0) | 0); ((Number(x) < Number(40)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
      let code_and_palette: any = ((runtime.dereference(video_data)) & 0xffff);
      let code: any = ((((code_and_palette) & (4095))) & 0xffff);
      let gfx_offset: any = ((((((((code) << (5))) | (((scanline) & (7))))) & (addr_mask))) | 0);
      let char_pens: any = runtime.addressOf((members.m_pens ?? runtime.member("m_pens")), ((runtime.shiftRight(code_and_palette, 12)) << (h_m_bppshift)));
  ...
  function method_draw_sprites(runtime: any, bitmap: any, scanline: any): any {
    const members = runtime.members;

    const h_m_region_zoomy = members.m_region_zoomy ?? runtime.member("m_region_zoomy");
    const h_m_bppshift = members.m_bppshift ?? runtime.member("m_bppshift");
    let max_sprite_index: any = ((0) | 0);
    let y: any = ((0) | 0);
    let x: any = ((0) | 0);
    let rows: any = ((0) | 0);
    let zoom_y: any = ((0) | 0);
    let zoom_x: any = ((0) | 0);
    let sprite_list: any = runtime.packedView(0, false);
    if ((((scanline) >>> (0)) & 1)) {
    ...
    for (let sprite_index: any = ((0) | 0); ((Number(sprite_index) <= Number(max_sprite_index)) ? 1 : 0); sprite_index = ((((sprite_index) + (1))) | 0)) {
      ...
      if (method_sprite_on_scanline(runtime, scanline, y, rows)) {
        let sprite_line: any = ((((((scanline) - (y))) & (511))) | 0);
        let zoom_line: any = ((((sprite_line) & (255))) | 0);
        ...
        let sprite_y: any = ((((sprite_y_and_tile) & (15))) | 0);
        let tile: any = ((runtime.shiftRight(sprite_y_and_tile, 4)) | 0);
        if (invert) {
        ...
        let zoom_x_table: any = (((__mame_table_0[((zoom_x) & 15)] ?? 0)) & 0xffff);
        let gfx_base: any = ((((((((code) << (8))) | (((sprite_y) << (4))))) & ((members.m_sprite_gfx_address_mask ?? runtime.member("m_sprite_gfx_address_mask"))))) | 0);
        let line_pens: any = runtime.addressOf((members.m_pens ?? runtime.member("m_pens")), ((runtime.shiftRight(attr, 8)) << (h_m_bppshift)));
        let x_inc: any = ((0) | 0);
        if ((((attr) >>> (0)) & 1)) {
  ...
  function method_draw_pixel(runtime: any, romaddr: any, dst: any, line_pens: any): any {
    const members = runtime.members;

    let src: any = runtime.addressOf((members.m_region_sprites ?? runtime.member("m_region_sprites")), ((((runtime.shiftRight(((romaddr) & (-256)), 1)) | (((((((romaddr) & (8))) ^ (8))) << (3))))) | (runtime.shiftRight(((romaddr) & (240)), 2))));
    let x: any = ((((romaddr) & (7))) | 0);
  ...
  function method_auto_animation_timer_callback(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_parse_sprites(runtime: any, scanline: any): any {
    const members = runtime.members;

    let y: any = ((0) | 0);
    let rows: any = ((0) | 0);
    let sprite_list: any = runtime.packedView(0, false);
    let active_sprite_count: any = ((0) | 0);
    if ((((scanline) >>> (0)) & 1)) {
      sprite_list = runtime.packedView(runtime.addressOf((members.m_videoram_drawsource ?? runtime.member("m_videoram_drawsource")), 34432), false);
    } else {
      sprite_list = runtime.packedView(runtime.addressOf((members.m_videoram_drawsource ?? runtime.member("m_videoram_drawsource")), 34304), false);
  ...
  function method_optimize_helper(runtime: any, spritegfx: any, region_sprites: any, region_sprites_size: any): any {
    const members = runtime.members;
  ...
  function method_get_region_mask(runtime: any, rgn: any, rgn_size: any): any {
    const members = runtime.members;

    let mask: any = ((4294967295) >>> 0);
    let len: any = ((rgn_size) >>> 0);
    for (let bit: any = ((2147483648) >>> 0); ((Number(bit) !== Number(0)) ? 1 : 0); bit = ((runtime.shiftRight(bit, 1)) >>> 0)) {
      if (((((((len) * (2))) - (1))) & (bit))) {
        break;
      }
