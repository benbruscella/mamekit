...
definition.compiledMethods = (() => {
  ...
  function method_set_num_inputs(runtime: any, i: any): any {
    const members = runtime.members;

    members.m_inputs = ((i) >>> 0);
  }

  function method_set_num_outputs(runtime: any, o: any): any {
    const members = runtime.members;

    members.m_outputs = ((o) >>> 0);
  }

  function method_set_num_terms(runtime: any, t: any): any {
    const members = runtime.members;

    members.m_terms = ((t) >>> 0);
  }

  function method_read(runtime: any, input: any): any {
    const members = runtime.members;
    ...
    for (let __range0: any = (members.m_cache2 ?? runtime.member("m_cache2")), __range0_index: any = 0; ((Number(__range0_index) < Number(__range0.length)) ? 1 : 0); __range0_index = ((__range0_index) + (1))) {
    ...
    let inputs: any = runtime.wide("&", runtime.wide("|", runtime.wide("<<", runtime.wide("^", input, 18446744073709551615n), 32), input), (members.m_input_mask ?? runtime.member("m_input_mask")));
    let s: any = 0;
    for (let i: any = ((0) | 0); ((Number(i) < Number((members.m_terms ?? runtime.member("m_terms")))) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      let term: any = runtime.addressOf((members.m_term ?? runtime.member("m_term")), i);
    ...
    let __mame_assignment_128: any = ((8) - (1));
  ...
  function method_set_inputmask(runtime: any, mask: any): any {
    const members = runtime.members;

    members.m_input_mask = mask;
  }

  function method_set_format(runtime: any, format: any): any {
    const members = runtime.members;

    members.m_format = format;
  }

  function method_inputs(runtime: any): any {
    const members = runtime.members;

    return (members.m_inputs ?? runtime.member("m_inputs"));
  }

  function method_outputs(runtime: any): any {
    const members = runtime.members;

    return (members.m_outputs ?? runtime.member("m_outputs"));
  }

  function method_pla_device__set_num_inputs(runtime: any, i: any): any {
    const members = runtime.members;

    members.m_inputs = ((i) >>> 0);
  }

  function method_pla_device__set_num_outputs(runtime: any, o: any): any {
    const members = runtime.members;

    members.m_outputs = ((o) >>> 0);
  }

  function method_pla_device__set_num_terms(runtime: any, t: any): any {
    const members = runtime.members;

    members.m_terms = ((t) >>> 0);
  }

  function method_pla_device__set_inputmask(runtime: any, mask: any): any {
    const members = runtime.members;

    members.m_input_mask = mask;
  }

  function method_pla_device__set_format(runtime: any, format: any): any {
    const members = runtime.members;

    members.m_format = format;
  }

  function method_pla_device__inputs(runtime: any): any {
    const members = runtime.members;

    return (members.m_inputs ?? runtime.member("m_inputs"));
  }

  function method_pla_device__outputs(runtime: any): any {
    const members = runtime.members;
