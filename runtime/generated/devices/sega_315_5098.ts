...
class GeneratedSEGA_315_5098 implements Cpu {
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('SEGA_315_5098 dispatch loop exceeded 8');
      ...
      case 0xfeff: {
        ...
        default:
          throw new Error('SEGA_315_5098 has no generated opcode ' +
  ...
  invoke(name: string, ...args: number[]): number {
    switch (name) {
      ...
      default: throw new Error('SEGA_315_5098 has no generated method "' + name + '"');
    }
  }
...
export const cpu: GeneratedCpuExecutable = {
  ...
  create: (bus: CpuBus): Cpu => new GeneratedSEGA_315_5098(bus),
};
