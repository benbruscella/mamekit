...
definition.compiledMethods = (() => {
    ...
    function method_init_palette_tables(runtime) {
        ...
        let entry = ((0) | 0);
        for (let color_emphasis = ((0) | 0); ((Number(color_emphasis) < Number(8)) ? 1 : 0); color_emphasis = ((((color_emphasis) + (1))) | 0)) {
            for (let color_intensity = ((0) | 0); ((Number(color_intensity) < Number(4)) ? 1 : 0); color_intensity = ((((color_intensity) + (1))) | 0)) {
                for (let color_num = ((0) | 0); ((Number(color_num) < Number(16)) ? 1 : 0); color_num = ((((color_num) + (1))) | 0)) {
    ...
    function method_draw_background(runtime, line_priority) {
        ...
        let scroll_y_coarse = ((runtime.shiftRight((((members.m_refresh_data ?? runtime.member("m_refresh_data"))) & (992)), 5)) & 0xff);
        let nametable = (((((members.m_refresh_data ?? runtime.member("m_refresh_data"))) & (3072))) & 0xffff);
        let scroll_y_fine = ((runtime.shiftRight((((members.m_refresh_data ?? runtime.member("m_refresh_data"))) & (28672)), 12)) & 0xff);
        let x = ((scroll_x_coarse) | 0);
        let tile_index = ((runtime.add(((nametable) | (8192)), ((scroll_y_coarse) * (32)))) | 0);
        let start_x = (((((((members.m_x_fine ?? runtime.member("m_x_fine"))) ^ (7))) - (7))) | 0);
        ...
        while (((Number((members.m_tilecount ?? runtime.member("m_tilecount"))) < Number(34)) ? 1 : 0)) {
            let index1 = ((((tile_index) + (x))) | 0);
            let page2 = ((method_readbyte(runtime, index1)) | 0);
            let pos = ((((runtime.shiftRight(((index1) & (896)), 4)) | (runtime.shiftRight(((index1) & (31)), 2)))) | 0);
            let page = ((runtime.shiftRight(((index1) & (3072)), 10)) | 0);
            let address = ((((960) + (pos))) | 0);
            let color_byte = ((method_readbyte(runtime, runtime.add(((((((page) * (1024))) + (address))) & (4095)), 8192))) | 0);
            let color_bits = ((runtime.add(runtime.shiftRight(((index1) & (64)), 4), ((index1) & (2)))) | 0);
    ...
    function method_draw_tile(runtime, line_priority, color_byte, color_bits, address, start_x, back_pen, dest) {
        const members = runtime.members;
        let color = ((((runtime.shiftRight(color_byte, color_bits)) & (3))) | 0);
    ...
    function method_draw_sprites(runtime, line_priority) {
        ...
        const __l = runtime.links ?? runtime.calls;
        const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
        let sprite_count = ((0) | 0);
        let size = ((((((runtime.readIndex((members.m_regs ?? runtime.member("m_regs")), 0)) & (32))) ? (16) : (8))) | 0);
        let first_pixel = ((((((runtime.readIndex((members.m_regs ?? runtime.member("m_regs")), 1)) & (4))) ? (0) : (8))) | 0);
        for (let sprite_index = ((0) | 0); ((Number(sprite_index) < Number(256)) ? 1 : 0); sprite_index = ((((sprite_index) + (4))) | 0)) {
            let sprite_ypos = ((runtime.add(runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), sprite_index), 1)) | 0);
            let sprite_xpos = ((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (3)))) | 0);
            ...
            let tile = ((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (1)))) | 0);
            let color = ((runtime.add(((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (2)))) & (3)), 4)) | 0);
            ...
            let sprite_line = (((((members.m_scanline ?? runtime.member("m_scanline"))) - (sprite_ypos))) | 0);
            if (flipy) {
            ...
            if (pri) {
                for (let pixel = ((0) | 0); ((Number(pixel) < Number(8)) ? 1 : 0); pixel = ((((pixel) + (1))) | 0)) {
    ...
    function method_write(runtime, offset, data) {
        ...
        switch (((offset) & (7))) {
            ...
            case 7:
                {
                    let tempAddr = (((((members.m_videomem_addr ?? runtime.member("m_videomem_addr"))) & (h_m_videoram_addr_mask))) | 0);
                    if ((((__l["m_latch.isnull"]?.() ?? 0)) ? 0 : 1)) {
                        (__l["m_latch"] ? __l["m_latch"](({ generatedLValue: true, get: () => tempAddr, set: (value) => { tempAddr = ((value) | 0); } })) : runtime.macro("m_latch", ({ generatedLValue: true, get: () => tempAddr, set: (value) => { tempAddr = ((value) | 0); } })));
                    }
    ...
    function method_draw_background_pen(runtime) {
        const members = runtime.members;
        const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
        for (let i = ((0) | 0); ((Number(i) < Number((typeof (members.m_bitmap).width === 'function' ? (members.m_bitmap).width() : typeof (members.m_bitmap).width === 'number' || typeof (members.m_bitmap).width === 'boolean' ? (members.m_bitmap).width : runtime.container(members.m_bitmap, "width")))) ? 1 : 0); i = ((((i) + (1))) | 0)) {
    ...
    function method_hblank_tick(runtime, param) {
        ...
        if ((((__l["m_hblank_callback_proc.isnull"]?.() ?? 0)) ? 0 : 1)) {
            (__l["m_hblank_callback_proc"] ? __l["m_hblank_callback_proc"](({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value) => { blanked = ((value) ? 1 : 0); } })) : runtime.macro("m_hblank_callback_proc", ({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value) => { blanked = ((value) ? 1 : 0); } })));
        }
    ...
    function method_scanline_tick(runtime, param) {
        ...
        if ((((__l["m_scanline_callback_proc.isnull"]?.() ?? 0)) ? 0 : 1)) {
            (__l["m_scanline_callback_proc"] ? __l["m_scanline_callback_proc"](({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value) => { blanked = ((value) ? 1 : 0); } })) : runtime.macro("m_scanline_callback_proc", ({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value) => { blanked = ((value) ? 1 : 0); } })));
        }
        method_update_scanline(runtime);
        ...
        let next_scanline = (((((members.m_scanline ?? runtime.member("m_scanline"))) + (1))) | 0);
