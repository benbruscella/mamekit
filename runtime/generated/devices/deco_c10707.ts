...
// - src/mame/dataeast/deco222.cpp
// - src/mame/dataeast/deco222.h
import type {
  Cpu,
  CpuBus,
...
class GeneratedDECO_C10707 implements Cpu {
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('DECO_C10707 dispatch loop exceeded 8');
      ...
      case 0xff00: {
        ...
        default:
          throw new Error('DECO_C10707 has no generated opcode ' +
  ...
  get(name: string): number {
    switch (name) {
      ...
      case "had_written": return this.had_written;
      default: return 0;
    }
  }
  ...
  set(name: string, value: number): void {
    switch (name) {
      ...
      case "had_written": this.had_written = ((value) ? 1 : 0); return;
      default: return;
    }
  }
  ...
  invoke(name: string, ...args: number[]): number {
    switch (name) {
      ...
      default: throw new Error('DECO_C10707 has no generated method "' + name + '"');
    }
  }
  ...
  private method_memory_opcode(adr: number = 0): number {
    return bitswap((++this.cycles, this.readOpcode((adr) & 0xffff) & 0xff), 7, 5, 6, 4, 3, 2, 1, 0);
    return 0;
  }
...
export const cpu: GeneratedCpuExecutable = {
  ...
  create: (bus: CpuBus): Cpu => new GeneratedDECO_C10707(bus),
};
