...
definition.compiledMethods = (() => {
    function method_tia_sound_w(runtime, offset, data) {
        ...
        if ((((((Number(runtime.readIndex((members.AUDC ?? runtime.member("AUDC")), chan)) === Number(0)) ? 1 : 0)) || (((Number(runtime.readIndex((members.AUDC ?? runtime.member("AUDC")), chan)) === Number(11)) ? 1 : 0))) ? 1 : 0)) {
            ...
            new_val = ((((runtime.readIndex((members.AUDF ?? runtime.member("AUDF")), chan)) + (1))) & 0xffff);
    ...
    function method_sound_stream_update(runtime, samples) {
        const members = runtime.members;
        ...
        let audc0 = ((0) & 0xff);
        let audc1 = ((0) & 0xff);
        let div_n_cnt0 = ((0) & 0xff);
        let div_n_cnt1 = ((0) & 0xff);
        let p5_0 = ((0) & 0xff);
        let p5_1 = ((0) & 0xff);
        let audv0 = ((0) << 16 >> 16);
        let audv1 = ((0) << 16 >> 16);
        let outvol_0 = ((0) << 16 >> 16);
        let outvol_1 = ((0) << 16 >> 16);
        ...
        for (let sampindex = ((0) | 0); ((Number(sampindex) < Number(samples)) ? 1 : 0);) {
            if (((Number(div_n_cnt0) > Number(1)) ? 1 : 0)) {
                div_n_cnt0 = ((((div_n_cnt0) - (1))) & 0xff);
            }
            else {
                if (((Number(div_n_cnt0) === Number(1)) ? 1 : 0)) {
                    let prev_bit5 = ((runtime.readIndex(h_Bit5, p5_0)) | 0);
            ...
            if (((Number(div_n_cnt1) > Number(1)) ? 1 : 0)) {
                ...
                if (((Number(div_n_cnt1) === Number(1)) ? 1 : 0)) {
                    let prev_bit5 = ((runtime.readIndex(h_Bit5, p5_1)) | 0);
            ...
            if ((((members.oversampling ?? runtime.member("oversampling"))) ? 0 : 1)) {
                ...
                if (((Number((members.Samp_n_cnt ?? runtime.member("Samp_n_cnt"))) < Number(256)) ? 1 : 0)) {
                    ...
                    (__l["stream_put_int"] ? __l["stream_put_int"]((() => { const previous = sampindex; sampindex = ((((sampindex) + (1))) | 0); return previous; })(), ((outvol_0) + (outvol_1)), 32768) : runtime.macro("stream_put_int", (() => { const previous = sampindex; sampindex = ((((sampindex) + (1))) | 0); return previous; })(), ((outvol_0) + (outvol_1)), 32768));
                }
            }
            else {
                do {
    ...
    function method_poly_init(runtime, poly, size, f0, f1) {
        const members = runtime.members;
        let mask = ((((((1) << (size))) - (1))) | 0);
        let x = ((mask) | 0);
        for (let i = ((0) | 0); ((Number(i) < Number(mask)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
            let bit0 = ((((((((size) - (f0))) ? (runtime.shiftRight(x, ((size) - (f0)))) : (x))) & (1))) | 0);
            let bit1 = ((((((((size) - (f1))) ? (runtime.shiftRight(x, ((size) - (f1)))) : (x))) & (1))) | 0);
            runtime.writeIndex(poly, i, ((x) & (1)));
            x = ((((runtime.shiftRight(x, 1)) | (((((bit0) ^ (bit1))) << (((size) - (1))))))) | 0);
        }
    }
    return {
...
definition.compiledMethodLinks = ["stream_put_int"];
