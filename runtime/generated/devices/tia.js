...
definition.compiledMethods = (() => {
    ...
    function method_sound_stream_update(runtime, samples) {
        ...
        for (let sampindex = 0; ((Number(sampindex) < Number(samples)) ? 1 : 0);) {
            if (((Number(div_n_cnt0) > Number(1)) ? 1 : 0)) {
                div_n_cnt0 = ((((div_n_cnt0) - (1))) & 0xff);
            }
            else {
                if (((Number(div_n_cnt0) === Number(1)) ? 1 : 0)) {
                    let prev_bit5 = runtime.readIndex(h_Bit5, p5_0);
            ...
            if (((Number(div_n_cnt1) > Number(1)) ? 1 : 0)) {
                ...
                if (((Number(div_n_cnt1) === Number(1)) ? 1 : 0)) {
                    let prev_bit5 = runtime.readIndex(h_Bit5, p5_1);
    ...
    function method_poly_init(runtime, poly, size, f0, f1) {
        ...
        let mask = ((((1) << (size))) - (1));
        let x = mask;
        for (let i = 0; ((Number(i) < Number(mask)) ? 1 : 0); i = ((i) + (1))) {
            let bit0 = ((((((size) - (f0))) ? (((x) >>> (((size) - (f0))))) : (x))) & (1));
            let bit1 = ((((((size) - (f1))) ? (((x) >>> (((size) - (f1))))) : (x))) & (1));
