...
definition.compiledMethods = (() => {
    ...
    function method_pic8259_device__write(runtime, offset, data) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        switch (offset) {
            case 0:
    ...
    function method_irq_timer_tick(runtime, param) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        for (let n = ((0) | 0), irq = (((members.m_prio ?? runtime.member("m_prio"))) | 0); ((Number(n) < Number(8)) ? 1 : 0); n = ((((n) + (1))) | 0), irq = ((((((irq) + (1))) & (7))) | 0)) {
            let mask = ((((1) << (irq))) & 0xff);
