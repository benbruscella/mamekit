...
definition.compiledMethods = (() => {
  function method_program_9bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 511) ?? 0).rom();
  }

  function method_program_10bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 1023) ?? 0).rom();
  }

  function method_program_11bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 2047) ?? 0).rom();
  }

  function method_data_4bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 15) ?? 0).ram();
  }

  function method_data_5bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 31) ?? 0).ram();
  }

  function method_data_6bit(runtime: any, map: any) {
    const members = runtime.members;
    (runtime.calls["map"]?.(0, 63) ?? 0).ram();
  }

  function method_data_7bit(runtime: any, map: any) {
    const members = runtime.members;
