...
definition.compiledMethods = (() => {
  function method_sound_r(runtime: any, offset: any) {
  ...
  function method_wave_r(runtime: any, offset: any) {
    const members = runtime.members;
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    method_update_state(runtime);
  ...
  function method_update_state(runtime: any) {
    ...
    if (h_m_snd_control.on) {
      let cycles: any = (runtime.calls["attotime_to_clocks"] ? runtime.calls["attotime_to_clocks"](((now) - ((members.m_last_updated ?? runtime.member("m_last_updated"))))) : runtime.macro("attotime_to_clocks", ((now) - ((members.m_last_updated ?? runtime.member("m_last_updated"))))));
  ...
  function method_update_square_channel(runtime: any, snd: any, cycles: any) {
    const members = runtime.members;
    if (snd.on) {
  ...
  function method_update_wave_channel(runtime: any, snd: any, cycles: any) {
    const members = runtime.members;
    if (snd.on) {
      snd.cycles_left = ((((snd.cycles_left) + (cycles))) | 0);
  ...
  function method_update_noise_channel(runtime: any, snd: any, cycles: any) {
    const members = runtime.members;
    snd.cycles_left = ((((snd.cycles_left) + (cycles))) | 0);
  ...
  function method_tick_sweep(runtime: any, snd: any) {
    const members = runtime.members;
  ...
  function method_apply_next_sweep(runtime: any, snd: any) {
    const members = runtime.members;
  ...
  function method_calculate_next_sweep(runtime: any, snd: any) {
    const members = runtime.members;
  ...
  function method_tick_envelope(runtime: any, snd: any) {
    const members = runtime.members;
  ...
  function method_sound_stream_update(runtime: any, stream: any) {
    const members = runtime.members;
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
    const h_m_snd_control = members.m_snd_control ?? runtime.member("m_snd_control");
    for (let sampindex: any = 0; ((Number(sampindex) < Number((typeof (runtime.dereference(stream)).samples === 'function' ? (runtime.dereference(stream)).samples() : typeof (runtime.dereference(stream)).samples === 'number' || typeof (runtime.dereference(stream)).samples === 'boolean' ? (runtime.dereference(stream)).samples : runtime.container(stream, "samples")))) ? 1 : 0); sampindex = ((sampindex) + (1))) {
      let sample: any = ((0) | 0);
      let left: any = ((0) | 0);
      let right: any = ((0) | 0);
  ...
  function method_convert_output(runtime: any, sample: any) {
    const members = runtime.members;
    return ((15) - (((sample) * (2))));
  }

  function method_timer_callback(runtime: any, param: any) {
    const members = runtime.members;
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    method_update_state(runtime);
  }

  function method_wave_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    method_update_state(runtime);
  ...
  function method_sound_w(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    const h_m_snd_control = members.m_snd_control ?? runtime.member("m_snd_control");
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    method_update_state(runtime);
  ...
  function method_sound_w_internal(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    const h_m_snd_control = members.m_snd_control ?? runtime.member("m_snd_control");
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
    let old_data: any = ((runtime.readIndex((members.m_snd_regs ?? runtime.member("m_snd_regs")), offset)) & 0xff);
    if (h_m_snd_control.on) {
    ...
    switch (offset) {
      ...
      case 4:
      {
        ...
        let length_was_enabled: any = ((runtime.readIndex(h_m_snd, 0).length_enabled) ? 1 : 0);
      ...
      case 9:
      {
        ...
        let length_was_enabled: any = ((runtime.readIndex(h_m_snd, 1).length_enabled) ? 1 : 0);
      ...
      case 14:
      {
        ...
        let length_was_enabled: any = ((runtime.readIndex(h_m_snd, 2).length_enabled) ? 1 : 0);
      ...
      case 19:
      {
        ...
        let length_was_enabled: any = ((runtime.readIndex(h_m_snd, 3).length_enabled) ? 1 : 0);
  ...
  function method_dac_enabled(runtime: any, snd: any) {
    const members = runtime.members;
    return ((((Number(snd.channel) !== Number(3)) ? 1 : 0)) ? (((snd.reg[2]) & (248))) : (((snd.reg[0]) & (128))));
  }

  function method_corrupt_wave_ram(runtime: any) {
    const members = runtime.members;
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
  ...
  function method_apu_power_off(runtime: any) {
    const members = runtime.members;
    const h_m_snd = members.m_snd ?? runtime.member("m_snd");
    const h_m_snd_control = members.m_snd_control ?? runtime.member("m_snd_control");
    ...
    for (let i: any = runtime.add(19, 1); ((Number(i) < Number(22)) ? 1 : 0); i = ((i) + (1))) {
