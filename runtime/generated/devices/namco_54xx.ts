...
definition.compiledMethods = (() => {
  ...
  function method_O_w(runtime: any, offset: any, data: any, mem_mask: any) {
    ...
    if (((Number(mem_mask) === Number(15)) ? 1 : 0)) {
      ((runtime.dereference(members.m_discrete)).write?.((runtime.calls["NAMCO_54XX_0_DATA"] ? runtime.calls["NAMCO_54XX_0_DATA"]((members.m_basenode ?? runtime.member("m_basenode"))) : runtime.macro("NAMCO_54XX_0_DATA", (members.m_basenode ?? runtime.member("m_basenode")))), ((data) & (15))) ?? 0);
    } else {
      ((runtime.dereference(members.m_discrete)).write?.((runtime.calls["NAMCO_54XX_1_DATA"] ? runtime.calls["NAMCO_54XX_1_DATA"]((members.m_basenode ?? runtime.member("m_basenode"))) : runtime.macro("NAMCO_54XX_1_DATA", (members.m_basenode ?? runtime.member("m_basenode")))), ((data) >>> (4))) ?? 0);
    }
  }

  function method_R1_w(runtime: any, data: any) {
    const members = runtime.members;
    ((runtime.dereference(members.m_discrete)).write?.((runtime.calls["NAMCO_54XX_2_DATA"] ? runtime.calls["NAMCO_54XX_2_DATA"]((members.m_basenode ?? runtime.member("m_basenode"))) : runtime.macro("NAMCO_54XX_2_DATA", (members.m_basenode ?? runtime.member("m_basenode")))), ((data) & (15))) ?? 0);
  }
