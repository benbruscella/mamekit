...
definition.compiledMethods = (() => {
  ...
  function method_draw(runtime: any, screen: any, bitmap: any, cliprect: any, flip: any): any {
    ...
    for (let offs: any = 0; ((Number(offs) < Number(32)) ? 1 : 0); offs = ((offs) + (1))) {
      let scroll: any = ((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((((((offs) & (3))) << (5))) | (((offs) >>> (2)))))) | 0);
    ...
    for (let offs: any = ((896) | 0); ((Number(128) <= Number(offs)) ? 1 : 0); offs = ((((offs) - (64))) | 0)) {
      ...
      while (((Number(0) < Number(i)) ? 1 : 0)) {
        ...
        if (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (128))) {
          ...
          let ypos: any = ((((((((offs) >>> (2))) | (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (15))))) | 0)) | 0);
          if (big) {
            ((runtime.dereference(((members.m_gfxdecode)?.gfx?.(1) ?? 0))).transpen?.(bitmap, cliprect, ((code) >>> (2)), color, xflip, yflip, xpos, ((ypos) - (8)), 0) ?? 0);
          } else {
