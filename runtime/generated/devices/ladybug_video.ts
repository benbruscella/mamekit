...
definition.compiledMethods = (() => {
  ...
  function method_bg_w(runtime: any, offset: any, data: any): any {
  ...
  function method_draw(runtime: any, screen: any, bitmap: any, cliprect: any, flip: any): any {
    const members = runtime.members;

    for (let offs: any = 0; ((Number(offs) < Number(32)) ? 1 : 0); offs = ((offs) + (1))) {
      let scroll: any = ((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((((((offs) & (3))) << (5))) | (runtime.shiftRight(offs, 2))))) | 0);
  ...
  function method_draw_sprites(runtime: any, bitmap: any, cliprect: any): any {
    ...
    for (let offs: any = ((896) | 0); ((Number(128) <= Number(offs)) ? 1 : 0); offs = ((((offs) - (64))) | 0)) {
      let i: any = ((0) | 0);
      ...
      while (((Number(0) < Number(i)) ? 1 : 0)) {
        ...
        if (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (128))) {
          ...
          let code: any = ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 1))) | ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 2))) >>> (4)) & 1)) << (8))))) | 0)) | 0);
          let color: any = ((((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 2))) & (15))) | 0)) | 0);
          let xpos: any = ((((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), runtime.add(((offs) + (i)), 3))) | 0)) | 0);
          let ypos: any = ((((((runtime.shiftRight(offs, 2)) | (((runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offs) + (i)))) & (15))))) | 0)) | 0);
          if (big) {
            ((runtime.dereference(((members.m_gfxdecode)?.gfx?.(1) ?? 0))).transpen?.(bitmap, cliprect, runtime.shiftRight(code, 2), color, xflip, yflip, xpos, ((ypos) - (8)), 0) ?? 0);
          } else {
            ((runtime.dereference(((members.m_gfxdecode)?.gfx?.(2) ?? 0))).transpen?.(bitmap, cliprect, code, color, xflip, yflip, xpos, ypos, 0) ?? 0);
          }
        }
      }
    }
  ...
  function method_get_bg_tile_info(runtime: any, tilemap: any, tileinfo: any, tile_index: any): any {
    ...
    let code: any = ((runtime.add(runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), tile_index), (((((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((1024) | (tile_index)))) >>> (3)) & 1)) << (8)))) | 0);
    let color: any = ((((runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((1024) | (tile_index)))) & (7))) | 0);
    ((runtime.dereference(tileinfo)).set?.(0, code, color, 0) ?? 0);
  }

  function method_spr_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offset) & (1023)));
  }

  function method_spr_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_spr_ram"), ((offset) & (1023)), data);
  }

  function method_bg_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return runtime.readIndex((members.m_bg_ram ?? runtime.member("m_bg_ram")), ((offset) & (2047)));
  }

  function method_ladybug_video_device__spr_r(runtime: any, offset: any): any {
    const members = runtime.members;

    return runtime.readIndex((members.m_spr_ram ?? runtime.member("m_spr_ram")), ((offset) & (1023)));
  }

  function method_ladybug_video_device__spr_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    runtime.writeIndex(runtime.writableMember("m_spr_ram"), ((offset) & (1023)), data);
  }

  function method_ladybug_video_device__bg_r(runtime: any, offset: any): any {
    const members = runtime.members;
