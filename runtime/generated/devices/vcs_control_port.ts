...
definition.slot!.options["joy"]!.compiledMethods = (() => {
  function method_trigger_w(runtime: any, state: any) {
...
definition.slot!.options["cx85"]!.children![0]!.definition.compiledMethods = (() => {
  function method_perform_scan(runtime: any, param: any) {
    const members = runtime.members;
  ...
  function method_change_output_lines(runtime: any) {
    const members = runtime.members;
  ...
  function method_clock_scan_counters(runtime: any) {
    const members = runtime.members;
  ...
  function method_detect_keypress(runtime: any) {
    const members = runtime.members;
    ...
    if ((members.m_inhibit ?? runtime.member("m_inhibit"))) {
      ...
      for (let y: any = 0; ((Number(y) < Number(h_m_max_y)) ? 1 : 0); y = ((y) + (1))) {
        if ((((((data) >>> (y)) & 1)) ? 0 : 1)) {
