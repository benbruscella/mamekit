...
definition.compiledMethods = (() => {
    ...
    function method_vblank_callback(runtime, screen, state) {
    ...
    function method_update_scroll(runtime) {
        const members = runtime.members;
        for (let tmap = ((0) | 0); ((Number(tmap) < Number(2)) ? 1 : 0); tmap = ((((tmap) + (1))) | 0)) {
            let scrollctrl = ((((runtime.shiftRight((members.m_scrollctrl ?? runtime.member("m_scrollctrl")), ((tmap) * (3)))) & (7))) & 0xff);
            let rows = (((__mame_table_0[(((((scrollctrl) & (3))) % 4) + 4) % 4] ?? 0)) | 0);
            let cols = (((((((scrollctrl) >>> (2)) & 1)) ? (64) : (1))) | 0);
            let tmap_mask = ((((tmap) ? (8192) : (0))) | 0);
            let scrollram_y = runtime.addressOf((members.m_ram ?? runtime.member("m_ram")), ((6144) | (tmap_mask)));
            let scrollram_x = runtime.addressOf((members.m_ram ?? runtime.member("m_ram")), ((6656) | (tmap_mask)));
            let t = ((((tmap) + (1))) | 0);
            if ((((((Number(rows) === Number(1)) ? 1 : 0)) && (((Number(cols) === Number(1)) ? 1 : 0))) ? 1 : 0)) {
                ...
                let xscroll = ((runtime.add(runtime.readIndex(scrollram_x, 0), ((256) * (runtime.readIndex(scrollram_x, 1))))) | 0);
                let yscroll = ((runtime.readIndex(scrollram_y, 12)) | 0);
                ...
                if (((Number(cols) === Number(1)) ? 1 : 0)) {
                    ...
                    let yscroll = ((runtime.readIndex(scrollram_y, 12)) | 0);
                    ((runtime.dereference((members.m_tilemap ?? runtime.member("m_tilemap"))[t])).set_scrolly?.(0, yscroll) ?? 0);
                    let offs_mask = ((((((Number(rows) === Number(256)) ? 1 : 0)) ? (255) : (248))) | 0);
                    for (let offs = ((0) | 0); ((Number(offs) < Number(256)) ? 1 : 0); offs = ((((offs) + (1))) | 0)) {
                        let xscroll = ((runtime.add(runtime.readIndex(scrollram_x, ((2) * (((offs) & (offs_mask))))), ((256) * (runtime.readIndex(scrollram_x, runtime.add(((2) * (((offs) & (offs_mask)))), 1)))))) | 0);
                    ...
                    if (((Number(rows) === Number(1)) ? 1 : 0)) {
                        ...
                        ((runtime.dereference((members.m_tilemap ?? runtime.member("m_tilemap"))[t])).set_scrollx?.(0, xscroll) ?? 0);
                        xscroll = ((((xscroll) / (8))) | 0);
                        for (let offs = ((0) | 0); ((Number(offs) < Number(64)) ? 1 : 0); offs = ((((offs) + (1))) | 0)) {
                            let yscroll = ((runtime.readIndex(scrollram_y, offs)) | 0);
                        ...
                        ((runtime.dereference((members.m_tilemap ?? runtime.member("m_tilemap"))[t])).set_scroll_cols?.(64) ?? 0);
                        let offs_step = ((((((Number(rows) === Number(256)) ? 1 : 0)) ? (2) : (16))) | 0);
                        for (let offs = ((0) | 0); ((Number(offs) < Number(rows)) ? 1 : 0); offs = ((((offs) + (1))) | 0)) {
                            let xscroll = ((runtime.add(runtime.readIndex(scrollram_x, ((offs_step) * (offs))), ((256) * (runtime.readIndex(scrollram_x, runtime.add(((offs_step) * (offs)), 1)))))) | 0);
    ...
    function method_read(runtime, offset) {
        ...
        if (((Number((members.m_rmrd_line ?? runtime.member("m_rmrd_line"))) === Number(0)) ? 1 : 0)) {
            ...
            let code = ((runtime.shiftRight(((offset) & (8191)), 5)) | 0);
            let color = (((members.m_romsubbank ?? runtime.member("m_romsubbank"))) | 0);
            let flags = ((0) | 0);
            let priority = ((0) | 0);
            let bank = ((runtime.shiftRight((members.m_charrombank ?? runtime.member("m_charrombank"))[runtime.shiftRight(((color) & (12)), 2)], 2)) | 0);
            let addr = ((0) | 0);
            bank = ((((bank) | (runtime.shiftRight((members.m_charrombank_2 ?? runtime.member("m_charrombank_2"))[runtime.shiftRight(((color) & (12)), 2)], 2)))) | 0);
            if ((members.m_has_extra_video_ram ?? runtime.member("m_has_extra_video_ram"))) {
                code = ((((code) | (((color) << (8))))) | 0);
            }
            else {
                (__l["m_k052109_cb"] ? __l["m_k052109_cb"](0, ({ generatedLValue: true, get: () => bank, set: (value) => { bank = ((value) | 0); } }), ({ generatedLValue: true, get: () => code, set: (value) => { code = ((value) | 0); } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = ((value) | 0); } }), ({ generatedLValue: true, get: () => flags, set: (value) => { flags = ((value) | 0); } }), ({ generatedLValue: true, get: () => priority, set: (value) => { priority = ((value) | 0); } })) : runtime.macro("m_k052109_cb", 0, ({ generatedLValue: true, get: () => bank, set: (value) => { bank = ((value) | 0); } }), ({ generatedLValue: true, get: () => code, set: (value) => { code = ((value) | 0); } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = ((value) | 0); } }), ({ generatedLValue: true, get: () => flags, set: (value) => { flags = ((value) | 0); } }), ({ generatedLValue: true, get: () => priority, set: (value) => { priority = ((value) | 0); } })));
            }
    ...
    function method_tilemap_draw(runtime, screen, bitmap, cliprect, tmap_num, flags, priority, priority_mask) {
        const members = runtime.members;
