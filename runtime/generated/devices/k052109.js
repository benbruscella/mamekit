...
definition.compiledMethods = (() => {
    ...
    function method_update_scroll(runtime) {
        const members = runtime.members;
        for (let tmap = 0; ((Number(tmap) < Number(2)) ? 1 : 0); tmap = ((tmap) + (1))) {
            let scrollctrl = (((((((members.m_scrollctrl ?? runtime.member("m_scrollctrl"))) >>> (((tmap) * (3))))) & (7))) & 0xff);
            let rows = ([1, 1, 32, 256][(((((scrollctrl) & (3))) % 4) + 4) % 4] ?? 0);
            let cols = (((((scrollctrl) >>> (2)) & 1)) ? (64) : (1));
            let tmap_mask = ((tmap) ? (8192) : (0));
            ...
            if ((((((Number(rows) === Number(1)) ? 1 : 0)) && (((Number(cols) === Number(1)) ? 1 : 0))) ? 1 : 0)) {
                ...
                let xscroll = runtime.add(runtime.readIndex(scrollram_x, 0), ((256) * (runtime.readIndex(scrollram_x, 1))));
                let yscroll = runtime.readIndex(scrollram_y, 12);
                ...
                if (((Number(cols) === Number(1)) ? 1 : 0)) {
                    ...
                    let yscroll = runtime.readIndex(scrollram_y, 12);
                    ((runtime.dereference(runtime.readIndex((members.m_tilemap ?? runtime.member("m_tilemap")), t))).set_scrolly?.(0, yscroll) ?? 0);
                    let offs_mask = ((((Number(rows) === Number(256)) ? 1 : 0)) ? (255) : (248));
                    for (let offs = 0; ((Number(offs) < Number(256)) ? 1 : 0); offs = ((offs) + (1))) {
                        let xscroll = runtime.add(runtime.readIndex(scrollram_x, ((2) * (((offs) & (offs_mask))))), ((256) * (runtime.readIndex(scrollram_x, runtime.add(((2) * (((offs) & (offs_mask)))), 1)))));
                    ...
                    if (((Number(rows) === Number(1)) ? 1 : 0)) {
                        ...
                        ((runtime.dereference(runtime.readIndex((members.m_tilemap ?? runtime.member("m_tilemap")), t))).set_scrollx?.(0, xscroll) ?? 0);
                        xscroll = ((xscroll) / (8));
                        for (let offs = 0; ((Number(offs) < Number(64)) ? 1 : 0); offs = ((offs) + (1))) {
                            let yscroll = runtime.readIndex(scrollram_y, offs);
                        ...
                        ((runtime.dereference(runtime.readIndex((members.m_tilemap ?? runtime.member("m_tilemap")), t))).set_scroll_cols?.(64) ?? 0);
                        let offs_step = ((((Number(rows) === Number(256)) ? 1 : 0)) ? (2) : (16));
                        for (let offs = 0; ((Number(offs) < Number(rows)) ? 1 : 0); offs = ((offs) + (1))) {
                            let xscroll = runtime.add(runtime.readIndex(scrollram_x, ((offs_step) * (offs))), ((256) * (runtime.readIndex(scrollram_x, runtime.add(((offs_step) * (offs)), 1)))));
    ...
    function method_read(runtime, offset) {
        ...
        if (((Number((members.m_rmrd_line ?? runtime.member("m_rmrd_line"))) === Number(0)) ? 1 : 0)) {
            ...
            let code = ((((offset) & (8191))) >>> (5));
            let color = (members.m_romsubbank ?? runtime.member("m_romsubbank"));
            let flags = 0;
            let priority = 0;
            let bank = ((runtime.readIndex((members.m_charrombank ?? runtime.member("m_charrombank")), ((((color) & (12))) >>> (2)))) >>> (2));
            let addr = 0;
            ...
            if ((members.m_has_extra_video_ram ?? runtime.member("m_has_extra_video_ram"))) {
                ...
                (runtime.calls["m_k052109_cb"] ? runtime.calls["m_k052109_cb"](0, ({ generatedLValue: true, get: () => bank, set: (value) => { bank = value; } }), ({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => flags, set: (value) => { flags = value; } }), ({ generatedLValue: true, get: () => priority, set: (value) => { priority = value; } })) : runtime.macro("m_k052109_cb", 0, ({ generatedLValue: true, get: () => bank, set: (value) => { bank = value; } }), ({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => flags, set: (value) => { flags = value; } }), ({ generatedLValue: true, get: () => priority, set: (value) => { priority = value; } })));
            }
