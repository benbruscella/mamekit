...
definition.compiledMethods = (() => {
    function method_parse_frame(runtime) {
        ...
        for (let i = ((0) | 0); ((Number(i) <= Number(9)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
            (members.m_old_k ?? runtime.member("m_old_k"))[i] = (members.m_new_k ?? runtime.member("m_new_k"))[i];
        }
        let cmd = (((__l["read_byte"] ? __l["read_byte"]((members.m_address ?? runtime.member("m_address"))) : runtime.macro("read_byte", (members.m_address ?? runtime.member("m_address"))))) & 0xff);
        if (((cmd) & (1))) {
            ...
            if (((cmd) & (2))) {
                ...
                let nums = ((((runtime.add(runtime.shiftRight(cmd, 2), 1)) * (2))) | 0);
                return ((nums) * (4));
            }
        }
    ...
    function method_get_bits(runtime, sbit, bits) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let offset = (((((members.m_address ?? runtime.member("m_address"))) + (runtime.shiftRight(sbit, 3)))) | 0);
        let data = (((((__l["read_byte"] ? __l["read_byte"](offset) : runtime.macro("read_byte", offset))) | ((((__l["read_byte"] ? __l["read_byte"](((offset) + (1))) : runtime.macro("read_byte", ((offset) + (1))))) << (8))))) | 0);
