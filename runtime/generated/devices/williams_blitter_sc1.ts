    ...
    for (let y: any = ((0) | 0); ((Number(y) < Number(h)) ? 1 : 0); y = ((((y) + (1))) | 0)) {
      ...
      for (let x: any = ((0) | 0); ((Number(x) < Number(w)) ? 1 : 0); x = ((((x) + (1))) | 0)) {
        ...
        if (shift) {
          ...
          method_blit_pixel(runtime, space, dest, ((runtime.shiftRight(pixdata, 4)) & (255)));
        } else {
