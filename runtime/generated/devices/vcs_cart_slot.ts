...
definition.slot!.options["a26_f4"]!.compiledMethods = (() => {
  ...
  function method_switch_bank(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["a26_fe"]!.compiledMethods = (() => {
  ...
  function method_switch_bank(runtime: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["a26_3f"]!.compiledMethods = (() => {
  ...
  function method_select_bank(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["a26_e0"]!.compiledMethods = (() => {
  ...
  function method_switch_bank_0(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    const h_m_bank = members.m_bank ?? runtime.member("m_bank");
    ((runtime.dereference(h_m_bank[0])).set_entry?.(((offset) & (7))) ?? 0);
  }

  function method_switch_bank_1(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    const h_m_bank = members.m_bank ?? runtime.member("m_bank");
    ((runtime.dereference(h_m_bank[1])).set_entry?.(((offset) & (7))) ?? 0);
  }

  function method_switch_bank_2(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    const h_m_bank = members.m_bank ?? runtime.member("m_bank");
    ((runtime.dereference(h_m_bank[2])).set_entry?.(((offset) & (7))) ?? 0);
  }
  return {
    "read_ram": method_read_ram,
    "write_ram": method_write_ram,
...
definition.slot!.options["a26_e7"]!.compiledMethods = (() => {
  ...
  function method_switch_rom_bank(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_switch_ram_bank(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["a26_ua"]!.compiledMethods = (() => {
  ...
  function method_change_bank(runtime: any, offset: any): any {
    const members = runtime.members;

    ((runtime.dereference(members.m_bank)).set_entry?.(((runtime.shiftRight(offset, 6)) & (1))) ?? 0);
  }
  return {
    "read_ram": method_read_ram,
    "write_ram": method_write_ram,
...
definition.slot!.options["a26_dc"]!.compiledMethods = (() => {
  ...
  function method_read_current_bank(runtime: any, offset: any): any {
    const members = runtime.members;
...
definition.slot!.options["a26_ss"]!.compiledMethods = (() => {
  ...
  function method_read_lo(runtime: any, offset: any): any {
    const members = runtime.members;
    ...
    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      if ((members.m_ram_write_enabled ?? runtime.member("m_ram_write_enabled"))) {
        if (((Number((members.m_address_bus_changes ?? runtime.member("m_address_bus_changes"))) === Number(5)) ? 1 : 0)) {
          0;
          runtime.writeIndex(runtime.writableMember("m_ram"), ((offset) + ((((members.m_base_banks ?? runtime.member("m_base_banks"))[0]) * (2048)))), (members.m_data ?? runtime.member("m_data")));
        } else {
    ...
    return runtime.readIndex((members.m_ram ?? runtime.member("m_ram")), ((offset) + ((((members.m_base_banks ?? runtime.member("m_base_banks"))[0]) * (2048)))));
  }

  function method_read_hi(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      if ((members.m_ram_write_enabled ?? runtime.member("m_ram_write_enabled"))) {
        if (((Number((members.m_address_bus_changes ?? runtime.member("m_address_bus_changes"))) === Number(5)) ? 1 : 0)) {
          if (((Number((members.m_base_banks ?? runtime.member("m_base_banks"))[1]) !== Number(3)) ? 1 : 0)) {
            0;
            runtime.writeIndex(runtime.writableMember("m_ram"), ((offset) + ((((members.m_base_banks ?? runtime.member("m_base_banks"))[1]) * (2048)))), (members.m_data ?? runtime.member("m_data")));
          }
        }
      }
    }
    if (((Number((members.m_base_banks ?? runtime.member("m_base_banks"))[1]) !== Number(3)) ? 1 : 0)) {
      return runtime.readIndex((members.m_ram ?? runtime.member("m_ram")), ((offset) + ((((members.m_base_banks ?? runtime.member("m_base_banks"))[1]) * (2048)))));
    } else {
  ...
  function method_read_cass(runtime: any, offset: any): any {
    const members = runtime.members;

    members.m_address_bus_changes = ((runtime.add(5, 1)) >>> 0);
    if (((Number(((members.m_cassette)?.input?.() ?? 0)) < Number(0)) ? 1 : 0)) {
      return 0;
    } else {
      return 1;
    }
...
definition.slot!.options["a26_ss"]!.compiledMethodLinks = ["machine","machine().side_effects_disabled"];
...
definition.slot!.options["a26_dpc"]!.children![0]!.definition.compiledMethods = (() => {
  ...
  function method_read(runtime: any, offset: any): any {
    ...
    if (((Number(offset) < Number(8)) ? 1 : 0)) {
      switch (((offset) & (6))) {
        ...
        case 2:
        {
          members.m_shift_reg = (((((((members.m_shift_reg ?? runtime.member("m_shift_reg"))) << (1))) | ((((~((((runtime.shiftRight((members.m_shift_reg ?? runtime.member("m_shift_reg")), 7)) ^ (runtime.shiftRight((members.m_shift_reg ?? runtime.member("m_shift_reg")), 5)))) ^ (((runtime.shiftRight((members.m_shift_reg ?? runtime.member("m_shift_reg")), 4)) ^ (runtime.shiftRight((members.m_shift_reg ?? runtime.member("m_shift_reg")), 3))))))) & (1))))) & 0xff);
        ...
        case 6:
        {
          members.m_latch_64 = (((((members.m_latch_62 ?? runtime.member("m_latch_62"))) + (h_m_df[4].top))) & 0xff);
          members.m_dlc = ((((((Number((((members.m_latch_62 ?? runtime.member("m_latch_62"))) + (h_m_df[4].top))) > Number(255)) ? 1 : 0)) ? (1) : (0))) & 0xff);
          data = ((0) & 0xff);
          if ((((h_m_df[5].music_mode) && (h_m_df[5].flag)) ? 1 : 0)) {
            data = ((((data) | (1))) & 0xff);
          }
          if ((((h_m_df[6].music_mode) && (h_m_df[6].flag)) ? 1 : 0)) {
            data = ((((data) | (2))) & 0xff);
          }
          if ((((h_m_df[7].music_mode) && (h_m_df[7].flag)) ? 1 : 0)) {
            data = ((((data) | (4))) & 0xff);
          }
          return (((((members.m_dlc ?? runtime.member("m_dlc"))) ? ((((members.m_movamt ?? runtime.member("m_movamt"))) & (240))) : (0))) | ((__mame_table_0[((data) & 7)] ?? 0)));
        }
      }
    } else {
      let display_data: any = ((runtime.readIndex((members.m_displaydata ?? runtime.member("m_displaydata")), (((~((h_m_df[data_fetcher].low) | (((h_m_df[data_fetcher].high) << (8)))))) & (2047)))) & 0xff);
      switch (((offset) & (56))) {
        case 8:
        {
        ...
        case 16:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (display_data) : (0))) & 0xff);
          break;
        }
        case 24:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (((((display_data) >>> (3)) & 1) << 7 | (((display_data) >>> (2)) & 1) << 6 | (((display_data) >>> (1)) & 1) << 5 | (((display_data) >>> (0)) & 1) << 4 | (((display_data) >>> (7)) & 1) << 3 | (((display_data) >>> (6)) & 1) << 2 | (((display_data) >>> (5)) & 1) << 1 | (((display_data) >>> (4)) & 1) << 0)) : (0))) & 0xff);
          break;
        }
        case 32:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (((((display_data) >>> (0)) & 1) << 7 | (((display_data) >>> (1)) & 1) << 6 | (((display_data) >>> (2)) & 1) << 5 | (((display_data) >>> (3)) & 1) << 4 | (((display_data) >>> (4)) & 1) << 3 | (((display_data) >>> (5)) & 1) << 2 | (((display_data) >>> (6)) & 1) << 1 | (((display_data) >>> (7)) & 1) << 0)) : (0))) & 0xff);
          break;
        }
        case 40:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (runtime.shiftRight(display_data, 1)) : (0))) & 0xff);
          break;
        }
        case 48:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (((display_data) << (1))) : (0))) & 0xff);
          break;
        }
        case 56:
        {
          data = ((((h_m_df[data_fetcher].flag) ? (255) : (0))) & 0xff);
          break;
        }
      }
      if ((((((Number(data_fetcher) < Number(5)) ? 1 : 0)) || (((h_m_df[data_fetcher].osc_clk) ? 0 : 1))) ? 1 : 0)) {
  ...
  function method_decrement_counter(runtime: any, data_fetcher: any): any {
    const members = runtime.members;

    const h_m_df = members.m_df ?? runtime.member("m_df");
    h_m_df[data_fetcher].low = ((((h_m_df[data_fetcher].low) - (1))) & 0xff);
    if (((Number(h_m_df[data_fetcher].low) === Number(255)) ? 1 : 0)) {
      h_m_df[data_fetcher].high = ((((h_m_df[data_fetcher].high) - (1))) & 0xff);
      if ((((((Number(data_fetcher) > Number(4)) ? 1 : 0)) && (h_m_df[data_fetcher].music_mode)) ? 1 : 0)) {
        h_m_df[data_fetcher].low = ((h_m_df[data_fetcher].top) & 0xff);
      }
    }
    method_check_flag(runtime, data_fetcher);
  }

  function method_check_flag(runtime: any, data_fetcher: any): any {
    const members = runtime.members;

    const h_m_df = members.m_df ?? runtime.member("m_df");
    if (((Number(h_m_df[data_fetcher].low) === Number(h_m_df[data_fetcher].top)) ? 1 : 0)) {
      h_m_df[data_fetcher].flag = ((1) & 0xff);
    }
    if (((Number(h_m_df[data_fetcher].low) === Number(h_m_df[data_fetcher].bottom)) ? 1 : 0)) {
      h_m_df[data_fetcher].flag = ((0) & 0xff);
    }
  }
  ...
  function method_write(runtime: any, offset: any, data: any): any {
    ...
    switch (((offset) & (56))) {
      case 0:
      {
        h_m_df[data_fetcher].top = ((data) & 0xff);
        h_m_df[data_fetcher].flag = ((0) & 0xff);
        method_check_flag(runtime, data_fetcher);
        break;
      }
      case 8:
      {
        h_m_df[data_fetcher].bottom = ((data) & 0xff);
        method_check_flag(runtime, data_fetcher);
        break;
      }
      case 16:
      {
        h_m_df[data_fetcher].low = ((data) & 0xff);
      ...
      case 24:
      {
        h_m_df[data_fetcher].high = ((data) & 0xff);
        h_m_df[data_fetcher].music_mode = ((((data) & (16))) & 0xff);
        h_m_df[data_fetcher].osc_clk = ((((data) & (32))) & 0xff);
        if (((((((((Number(data_fetcher) > Number(4)) ? 1 : 0)) && (h_m_df[data_fetcher].music_mode)) ? 1 : 0)) && (((Number(h_m_df[data_fetcher].low) === Number(255)) ? 1 : 0))) ? 1 : 0)) {
          h_m_df[data_fetcher].low = ((h_m_df[data_fetcher].top) & 0xff);
          method_check_flag(runtime, data_fetcher);
        }
        break;
  ...
  function method_oscillator_tick(runtime: any, param: any): any {
    const members = runtime.members;

    const h_m_df = members.m_df ?? runtime.member("m_df");
    for (let data_fetcher: any = ((5) | 0); ((Number(data_fetcher) < Number(8)) ? 1 : 0); data_fetcher = ((((data_fetcher) + (1))) | 0)) {
      if (h_m_df[data_fetcher].osc_clk) {
        method_decrement_counter(runtime, data_fetcher);
      }
    }
  }
...
definition.slot!.options["a26_harmony"]!.compiledMethods = (() => {
  ...
  function method_read(runtime: any, offset: any): any {
    ...
    let retvalue: any = ((method_read8_r(runtime, ((offset) + (3072)))) & 0xff);
