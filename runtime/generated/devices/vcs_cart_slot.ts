...
definition.slot!.options["a26_f4"]!.compiledMethods = (() => {
  ...
  function method_switch_bank(runtime: any, offset: any, data: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_fe"]!.compiledMethods = (() => {
  ...
  function method_switch_bank(runtime: any, data: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_3f"]!.compiledMethods = (() => {
  ...
  function method_select_bank(runtime: any, offset: any, data: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_e7"]!.compiledMethods = (() => {
  ...
  function method_switch_rom_bank(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_switch_ram_bank(runtime: any, offset: any, data: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_ua"]!.compiledMethods = (() => {
  ...
  function method_change_bank(runtime: any, offset: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_dc"]!.compiledMethods = (() => {
  ...
  function method_read_current_bank(runtime: any, offset: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_ss"]!.compiledMethods = (() => {
  ...
  function method_read_lo(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_read_hi(runtime: any, offset: any) {
    const members = runtime.members;
    if ((((runtime.calls["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      if ((members.m_ram_write_enabled ?? runtime.member("m_ram_write_enabled"))) {
        if (((Number((members.m_address_bus_changes ?? runtime.member("m_address_bus_changes"))) === Number(5)) ? 1 : 0)) {
  ...
  function method_read_cass(runtime: any, offset: any) {
    const members = runtime.members;
...
definition.slot!.options["a26_dpc"]!.children![0]!.definition.compiledMethods = (() => {
  function method_read(runtime: any, offset: any) {
    ...
    if (((Number(offset) < Number(8)) ? 1 : 0)) {
      ...
      let display_data: any = ((runtime.readIndex((members.m_displaydata ?? runtime.member("m_displaydata")), (((~((runtime.readIndex(h_m_df, data_fetcher).low) | (((runtime.readIndex(h_m_df, data_fetcher).high) << (8)))))) & (2047)))) & 0xff);
      switch (((offset) & (56))) {
        case 8:
        {
  ...
  function method_decrement_counter(runtime: any, data_fetcher: any) {
    const members = runtime.members;
    const h_m_df = members.m_df ?? runtime.member("m_df");
  ...
  function method_check_flag(runtime: any, data_fetcher: any) {
    const members = runtime.members;
    const h_m_df = members.m_df ?? runtime.member("m_df");
  ...
  function method_oscillator_tick(runtime: any, param: any) {
    const members = runtime.members;
    const h_m_df = members.m_df ?? runtime.member("m_df");
    for (let data_fetcher: any = 5; ((Number(data_fetcher) < Number(8)) ? 1 : 0); data_fetcher = ((data_fetcher) + (1))) {
