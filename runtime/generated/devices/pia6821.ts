...
definition.compiledMethods = (() => {
  ...
  function method_output_selected(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (2)) & 1)) ? 1 : 0);
  }

  function method_port_a_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_get_in_a_value(runtime: any) {
    const members = runtime.members;
  ...
  function method_update_interrupts(runtime: any) {
    const members = runtime.members;
    let new_state: any = (((((((members.m_irq_a1 ?? runtime.member("m_irq_a1"))) && (method_irq1_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0)) || (((((members.m_irq_a2 ?? runtime.member("m_irq_a2"))) && (method_irq2_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0))) ? 1 : 0);
  ...
  function method_irq1_enabled(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (0)) & 1)) ? 1 : 0);
  }

  function method_irq2_enabled(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_c2_output(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (5)) & 1)) ? 1 : 0);
  }

  function method_c2_strobe_mode(runtime: any, c: any) {
    const members = runtime.members;
    return (((((((c) >>> (4)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_set_out_ca2(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_strobe_e_reset(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_ddr_a_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_control_a_r(runtime: any) {
    const members = runtime.members;
    let ret: any = ((0) & 0xff);
    if ((((runtime.calls["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
  ...
  function method_ca1_w(runtime: any, state: any) {
    const members = runtime.members;
    0;
  ...
  function method_c1_low_to_high(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (1)) & 1)) ? 1 : 0);
  }

  function method_c1_high_to_low(runtime: any, c: any) {
    const members = runtime.members;
    return (((((((c) >>> (1)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_strobe_c1_reset(runtime: any, c: any) {
    const members = runtime.members;
    return (((((((c) >>> (3)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_ca2_w(runtime: any, state: any) {
    const members = runtime.members;
    0;
  ...
  function method_c2_input(runtime: any, c: any) {
    const members = runtime.members;
    return (((((((c) >>> (5)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_c2_low_to_high(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (4)) & 1)) ? 1 : 0);
  }

  function method_c2_high_to_low(runtime: any, c: any) {
    const members = runtime.members;
    return (((((((c) >>> (4)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_port_b_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_get_in_b_value(runtime: any) {
    const members = runtime.members;
    let ret: any = ((0) & 0xff);
  ...
  function method_set_out_cb2(runtime: any, data: any) {
    const members = runtime.members;
    let z: any = method_cb2_output_z(runtime);
  ...
  function method_cb2_output_z(runtime: any) {
    const members = runtime.members;
    return ((method_c2_output(runtime, (members.m_ctl_b ?? runtime.member("m_ctl_b")))) ? 0 : 1);
  }

  function method_ddr_b_r(runtime: any) {
    const members = runtime.members;
  ...
  function method_control_b_r(runtime: any) {
    const members = runtime.members;
    let ret: any = ((0) & 0xff);
    if ((((runtime.calls["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
  ...
  function method_cb1_w(runtime: any, state: any) {
    const members = runtime.members;
    0;
  ...
  function method_port_a_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_send_to_out_a_func(runtime: any, message: any) {
    const members = runtime.members;
  ...
  function method_get_out_a_value(runtime: any) {
    const members = runtime.members;
    let ret: any = ((0) & 0xff);
  ...
  function method_ddr_a_w(runtime: any, data: any) {
    const members = runtime.members;
    0;
  ...
  function method_control_a_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_c2_set_mode(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (4)) & 1)) ? 1 : 0);
  }

  function method_c2_set(runtime: any, c: any) {
    const members = runtime.members;
    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_port_b_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_send_to_out_b_func(runtime: any, message: any) {
    const members = runtime.members;
  ...
  function method_get_out_b_value(runtime: any) {
    const members = runtime.members;
  ...
  function method_ddr_b_w(runtime: any, data: any) {
    const members = runtime.members;
    0;
  ...
  function method_control_b_w(runtime: any, data: any) {
    const members = runtime.members;
    data = ((runtime.andAssign(data, 63)) & 0xff);
    0;
    0;
  ...
  function method_pia6821_device__read_alt(runtime: any, offset: any) {
    const members = runtime.members;
    return method_read(runtime, ((((((offset) << (1))) & (2))) | (((((offset) >>> (1))) & (1)))));
  }

  function method_pia6821_device__write_alt(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    method_write(runtime, ((((((offset) << (1))) & (2))) | (((((offset) >>> (1))) & (1)))), data);
  }
  return {
