...
definition.compiledMethods = (() => {
  ...
  function method_output_selected(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (2)) & 1)) ? 1 : 0);
  }

  function method_port_a_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let ret: any = ((method_get_in_a_value(runtime)) & 0xff);
  ...
  function method_get_in_a_value(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let port_a_data: any = ((0) & 0xff);
    let ret: any = ((0) & 0xff);
    if ((((typeof (runtime.dereference(members.m_in_a_handler)).isunset === 'function' ? (runtime.dereference(members.m_in_a_handler)).isunset() : typeof (runtime.dereference(members.m_in_a_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_in_a_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_in_a_handler)).isunset : runtime.container(members.m_in_a_handler, "isunset"))) ? 0 : 1)) {
      port_a_data = (((__l["m_in_a_handler"] ? __l["m_in_a_handler"](Number(0)) : typeof members.m_in_a_handler === 'function' ? members.m_in_a_handler(0) : runtime.invoke("m_in_a_handler", 0))) & 0xff);
    } else {
      if ((members.m_in_a_pushed ?? runtime.member("m_in_a_pushed"))) {
        ...
        if ((((((((((members.m_logged_port_a_not_connected ?? runtime.member("m_logged_port_a_not_connected"))) ? 0 : 1)) && (((Number((members.m_ddr_a ?? runtime.member("m_ddr_a"))) !== Number(255)) ? 1 : 0))) ? 1 : 0)) && ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1))) ? 1 : 0)) {
          0;
  ...
  function method_update_interrupts(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let new_state: any = (((((((((members.m_irq_a1 ?? runtime.member("m_irq_a1"))) && (method_irq1_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0)) || (((((members.m_irq_a2 ?? runtime.member("m_irq_a2"))) && (method_irq2_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0))) ? 1 : 0)) | 0);
    if (((Number(new_state) !== Number((members.m_irq_a_state ?? runtime.member("m_irq_a_state")))) ? 1 : 0)) {
      members.m_irq_a_state = ((new_state) & 0xff);
      (__l["m_irqa_handler"] ? __l["m_irqa_handler"](Number((((members.m_irq_a_state ?? runtime.member("m_irq_a_state"))) ? (1) : (0)))) : typeof members.m_irqa_handler === 'function' ? members.m_irqa_handler((((members.m_irq_a_state ?? runtime.member("m_irq_a_state"))) ? (1) : (0))) : runtime.invoke("m_irqa_handler", (((members.m_irq_a_state ?? runtime.member("m_irq_a_state"))) ? (1) : (0))));
    }
    new_state = (((((((((members.m_irq_b1 ?? runtime.member("m_irq_b1"))) && (method_irq1_enabled(runtime, (members.m_ctl_b ?? runtime.member("m_ctl_b"))))) ? 1 : 0)) || (((((members.m_irq_b2 ?? runtime.member("m_irq_b2"))) && (method_irq2_enabled(runtime, (members.m_ctl_b ?? runtime.member("m_ctl_b"))))) ? 1 : 0))) ? 1 : 0)) | 0);
    if (((Number(new_state) !== Number((members.m_irq_b_state ?? runtime.member("m_irq_b_state")))) ? 1 : 0)) {
      members.m_irq_b_state = ((new_state) & 0xff);
      (__l["m_irqb_handler"] ? __l["m_irqb_handler"](Number((((members.m_irq_b_state ?? runtime.member("m_irq_b_state"))) ? (1) : (0)))) : typeof members.m_irqb_handler === 'function' ? members.m_irqb_handler((((members.m_irq_b_state ?? runtime.member("m_irq_b_state"))) ? (1) : (0))) : runtime.invoke("m_irqb_handler", (((members.m_irq_b_state ?? runtime.member("m_irq_b_state"))) ? (1) : (0))));
    }
  }

  function method_irq1_enabled(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (0)) & 1)) ? 1 : 0);
  }

  function method_irq2_enabled(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_c2_output(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (5)) & 1)) ? 1 : 0);
  }

  function method_c2_strobe_mode(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((((c) >>> (4)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_set_out_ca2(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((((typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'function' ? (runtime.dereference(members.m_ca2_handler)).isunset() : typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_ca2_handler)).isunset : runtime.container(members.m_ca2_handler, "isunset"))) ? 0 : 1)) {
      (__l["m_ca2_handler"] ? __l["m_ca2_handler"](Number((members.m_out_ca2 ?? runtime.member("m_out_ca2")))) : typeof members.m_ca2_handler === 'function' ? members.m_ca2_handler((members.m_out_ca2 ?? runtime.member("m_out_ca2"))) : runtime.invoke("m_ca2_handler", (members.m_out_ca2 ?? runtime.member("m_out_ca2"))));
    } else {
  ...
  function method_strobe_e_reset(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_ddr_a_r(runtime: any): any {
    const members = runtime.members;

    let ret: any = (((members.m_ddr_a ?? runtime.member("m_ddr_a"))) & 0xff);
    0;
    return ret;
  }

  function method_control_a_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      if ((((typeof (runtime.dereference(members.m_in_ca1_handler)).isunset === 'function' ? (runtime.dereference(members.m_in_ca1_handler)).isunset() : typeof (runtime.dereference(members.m_in_ca1_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_in_ca1_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_in_ca1_handler)).isunset : runtime.container(members.m_in_ca1_handler, "isunset"))) ? 0 : 1)) {
        method_ca1_w(runtime, (__l["m_in_ca1_handler"] ? __l["m_in_ca1_handler"]() : typeof members.m_in_ca1_handler === 'function' ? members.m_in_ca1_handler() : runtime.invoke("m_in_ca1_handler")));
      } else {
      ...
      if ((((typeof (runtime.dereference(members.m_in_ca2_handler)).isunset === 'function' ? (runtime.dereference(members.m_in_ca2_handler)).isunset() : typeof (runtime.dereference(members.m_in_ca2_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_in_ca2_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_in_ca2_handler)).isunset : runtime.container(members.m_in_ca2_handler, "isunset"))) ? 0 : 1)) {
        method_ca2_w(runtime, (__l["m_in_ca2_handler"] ? __l["m_in_ca2_handler"]() : typeof members.m_in_ca2_handler === 'function' ? members.m_in_ca2_handler() : runtime.invoke("m_in_ca2_handler")));
      } else {
  ...
  function method_ca1_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_c1_low_to_high(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (1)) & 1)) ? 1 : 0);
  }

  function method_c1_high_to_low(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((((c) >>> (1)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_strobe_c1_reset(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((((c) >>> (3)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_ca2_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_c2_input(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((((c) >>> (5)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_c2_low_to_high(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (4)) & 1)) ? 1 : 0);
  }

  function method_c2_high_to_low(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((((c) >>> (4)) & 1)) ? 1 : 0)) ? 0 : 1);
  }

  function method_port_b_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let ret: any = ((method_get_in_b_value(runtime)) & 0xff);
    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
  ...
  function method_get_in_b_value(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if (((Number((members.m_ddr_b ?? runtime.member("m_ddr_b"))) === Number(255)) ? 1 : 0)) {
      ...
      let port_b_data: any = ((0) & 0xff);
      if ((((typeof (runtime.dereference(members.m_in_b_handler)).isunset === 'function' ? (runtime.dereference(members.m_in_b_handler)).isunset() : typeof (runtime.dereference(members.m_in_b_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_in_b_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_in_b_handler)).isunset : runtime.container(members.m_in_b_handler, "isunset"))) ? 0 : 1)) {
        port_b_data = (((__l["m_in_b_handler"] ? __l["m_in_b_handler"](Number(0)) : typeof members.m_in_b_handler === 'function' ? members.m_in_b_handler(0) : runtime.invoke("m_in_b_handler", 0))) & 0xff);
      } else {
        if ((members.m_in_b_pushed ?? runtime.member("m_in_b_pushed"))) {
          port_b_data = (((members.m_in_b ?? runtime.member("m_in_b"))) & 0xff);
        } else {
          if ((((((((((members.m_logged_port_b_not_connected ?? runtime.member("m_logged_port_b_not_connected"))) ? 0 : 1)) && (((Number((members.m_ddr_b ?? runtime.member("m_ddr_b"))) !== Number(255)) ? 1 : 0))) ? 1 : 0)) && ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1))) ? 1 : 0)) {
            0;
  ...
  function method_set_out_cb2(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let z: any = ((method_cb2_output_z(runtime)) | 0);
    if ((((((Number(data) !== Number((members.m_out_cb2 ?? runtime.member("m_out_cb2")))) ? 1 : 0)) || (((Number(z) !== Number((members.m_last_out_cb2_z ?? runtime.member("m_last_out_cb2_z")))) ? 1 : 0))) ? 1 : 0)) {
      ...
      if ((((typeof (runtime.dereference(members.m_cb2_handler)).isunset === 'function' ? (runtime.dereference(members.m_cb2_handler)).isunset() : typeof (runtime.dereference(members.m_cb2_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_cb2_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_cb2_handler)).isunset : runtime.container(members.m_cb2_handler, "isunset"))) ? 0 : 1)) {
        (__l["m_cb2_handler"] ? __l["m_cb2_handler"](Number((members.m_out_cb2 ?? runtime.member("m_out_cb2")))) : typeof members.m_cb2_handler === 'function' ? members.m_cb2_handler((members.m_out_cb2 ?? runtime.member("m_out_cb2"))) : runtime.invoke("m_cb2_handler", (members.m_out_cb2 ?? runtime.member("m_out_cb2"))));
      } else {
  ...
  function method_cb2_output_z(runtime: any): any {
    const members = runtime.members;

    return ((method_c2_output(runtime, (members.m_ctl_b ?? runtime.member("m_ctl_b")))) ? 0 : 1);
  }

  function method_ddr_b_r(runtime: any): any {
    const members = runtime.members;

    let ret: any = (((members.m_ddr_b ?? runtime.member("m_ddr_b"))) & 0xff);
    0;
    return ret;
  }

  function method_control_b_r(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((((__l["machine().side_effects_disabled"]?.() ?? 0)) ? 0 : 1)) {
      if ((((typeof (runtime.dereference(members.m_in_cb1_handler)).isunset === 'function' ? (runtime.dereference(members.m_in_cb1_handler)).isunset() : typeof (runtime.dereference(members.m_in_cb1_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_in_cb1_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_in_cb1_handler)).isunset : runtime.container(members.m_in_cb1_handler, "isunset"))) ? 0 : 1)) {
        method_cb1_w(runtime, (__l["m_in_cb1_handler"] ? __l["m_in_cb1_handler"]() : typeof members.m_in_cb1_handler === 'function' ? members.m_in_cb1_handler() : runtime.invoke("m_in_cb1_handler")));
      } else {
  ...
  function method_cb1_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_port_a_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_send_to_out_a_func(runtime: any, message: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let data: any = ((method_get_out_a_value(runtime)) & 0xff);
    0;
    if ((((typeof (runtime.dereference(members.m_out_a_handler)).isunset === 'function' ? (runtime.dereference(members.m_out_a_handler)).isunset() : typeof (runtime.dereference(members.m_out_a_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_out_a_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_out_a_handler)).isunset : runtime.container(members.m_out_a_handler, "isunset"))) ? 0 : 1)) {
      (__l["m_out_a_handler"] ? __l["m_out_a_handler"](Number(0), Number(data)) : typeof members.m_out_a_handler === 'function' ? members.m_out_a_handler(0, data) : runtime.invoke("m_out_a_handler", 0, data));
    } else {
  ...
  function method_get_out_a_value(runtime: any): any {
    const members = runtime.members;
  ...
  function method_ddr_a_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_control_a_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    0;
    0;
    let ca2_was_output: any = ((method_c2_output(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a")))) ? 1 : 0);
    ...
    if (method_c2_output(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a")))) {
      if (method_c2_set_mode(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a")))) {
        let set: any = ((method_c2_set(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a")))) ? 1 : 0);
        0;
      ...
      if (ca2_was_output) {
        0;
        if ((((typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'function' ? (runtime.dereference(members.m_ca2_handler)).isunset() : typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_ca2_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_ca2_handler)).isunset : runtime.container(members.m_ca2_handler, "isunset"))) ? 0 : 1)) {
          (__l["m_ca2_handler"] ? __l["m_ca2_handler"](Number(1)) : typeof members.m_ca2_handler === 'function' ? members.m_ca2_handler(1) : runtime.invoke("m_ca2_handler", 1));
        }
      }
    }
    method_update_interrupts(runtime);
  ...
  function method_c2_set_mode(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (4)) & 1)) ? 1 : 0);
  }

  function method_c2_set(runtime: any, c: any): any {
    const members = runtime.members;

    return (((((c) >>> (3)) & 1)) ? 1 : 0);
  }

  function method_port_b_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_send_to_out_b_func(runtime: any, message: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let data: any = ((method_get_out_b_value(runtime)) & 0xff);
    0;
    if ((((typeof (runtime.dereference(members.m_out_b_handler)).isunset === 'function' ? (runtime.dereference(members.m_out_b_handler)).isunset() : typeof (runtime.dereference(members.m_out_b_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_out_b_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_out_b_handler)).isunset : runtime.container(members.m_out_b_handler, "isunset"))) ? 0 : 1)) {
      (__l["m_out_b_handler"] ? __l["m_out_b_handler"](Number(0), Number(data), Number((members.m_ddr_b ?? runtime.member("m_ddr_b")))) : typeof members.m_out_b_handler === 'function' ? members.m_out_b_handler(0, data, (members.m_ddr_b ?? runtime.member("m_ddr_b"))) : runtime.invoke("m_out_b_handler", 0, data, (members.m_ddr_b ?? runtime.member("m_ddr_b"))));
    } else {
  ...
  function method_get_out_b_value(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let ret: any = (((((members.m_out_b ?? runtime.member("m_out_b"))) & ((members.m_ddr_b ?? runtime.member("m_ddr_b"))))) & 0xff);
    if ((((((Number((members.m_ddr_b ?? runtime.member("m_ddr_b"))) !== Number(255)) ? 1 : 0)) && ((((typeof (runtime.dereference(members.m_ts_b_handler)).isunset === 'function' ? (runtime.dereference(members.m_ts_b_handler)).isunset() : typeof (runtime.dereference(members.m_ts_b_handler)).isunset === 'number' || typeof (runtime.dereference(members.m_ts_b_handler)).isunset === 'boolean' ? (runtime.dereference(members.m_ts_b_handler)).isunset : runtime.container(members.m_ts_b_handler, "isunset"))) ? 0 : 1))) ? 1 : 0)) {
      ret = ((((ret) | ((((__l["m_ts_b_handler"] ? __l["m_ts_b_handler"]() : typeof members.m_ts_b_handler === 'function' ? members.m_ts_b_handler() : runtime.invoke("m_ts_b_handler"))) & ((~(members.m_ddr_b ?? runtime.member("m_ddr_b")))))))) & 0xff);
    }
    return ret;
  }

  function method_ddr_b_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_control_b_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_read_alt(runtime: any, offset: any): any {
    const members = runtime.members;

    return method_read(runtime, ((((((offset) << (1))) & (2))) | (((runtime.shiftRight(offset, 1)) & (1)))));
  }

  function method_write_alt(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    method_write(runtime, ((((((offset) << (1))) & (2))) | (((runtime.shiftRight(offset, 1)) & (1)))), data);
  }

  function method_pia6821_device__read_alt(runtime: any, offset: any): any {
    const members = runtime.members;

    return method_read(runtime, ((((((offset) << (1))) & (2))) | (((runtime.shiftRight(offset, 1)) & (1)))));
  }

  function method_pia6821_device__write_alt(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.compiledMethodLinks = ["m_ca2_handler","m_cb2_handler","m_in_a_handler","m_in_b_handler","m_in_ca1_handler","m_in_ca2_handler","m_in_cb1_handler","m_irqa_handler","m_irqb_handler","m_out_a_handler","m_out_b_handler","m_ts_b_handler","machine","machine().side_effects_disabled"];
