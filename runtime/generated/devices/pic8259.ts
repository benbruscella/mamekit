...
definition.compiledMethods = (() => {
    ...
    switch (offset) {
      case 0:
      {
        if (((data) & (16))) {
          ...
          (__l["m_out_int_func"] ? __l["m_out_int_func"](Number(0)) : typeof members.m_out_int_func === 'function' ? members.m_out_int_func(0) : runtime.invoke("m_out_int_func", 0));
        } else {
            ...
            if (((Number(((data) & (152))) === Number(8)) ? 1 : 0)) {
              ...
              if (((Number(((data) & (24))) === Number(0)) ? 1 : 0)) {
                ...
                switch (((data) & (224))) {
                  ...
                  case 32:
                  {
                    for (n = ((0) | 0), mask = ((((1) << ((members.m_prio ?? runtime.member("m_prio"))))) & 0xff); ((Number(n) < Number(8)) ? 1 : 0); n = ((((n) + (1))) | 0), mask = ((((((mask) << (1))) | (runtime.shiftRight(mask, 7)))) & 0xff)) {
      ...
      case 1:
      {
        switch ((members.m_state ?? runtime.member("m_state"))) {
          ...
          case 3:
          {
            ...
            members.m_mode = ((((runtime.shiftRight(data, 2)) & (3))) & 0xff);
  ...
  function method_pic8259_device__write(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_irq_timer_tick(runtime: any, param: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    for (let n: any = ((0) | 0), irq: any = (((members.m_prio ?? runtime.member("m_prio"))) | 0); ((Number(n) < Number(8)) ? 1 : 0); n = ((((n) + (1))) | 0), irq = ((((((irq) + (1))) & (7))) | 0)) {
      ...
      if (((((((((Number((members.m_state ?? runtime.member("m_state"))) === Number(4)) ? 1 : 0)) && ((((members.m_irr ?? runtime.member("m_irr"))) & (mask)))) ? 1 : 0)) && ((((((members.m_imr ?? runtime.member("m_imr"))) & (mask))) ? 0 : 1))) ? 1 : 0)) {
        ...
        (__l["m_out_int_func"] ? __l["m_out_int_func"](Number(1)) : typeof members.m_out_int_func === 'function' ? members.m_out_int_func(1) : runtime.invoke("m_out_int_func", 1));
        return;
      }
...
definition.compiledMethodLinks = ["m_out_int_func","machine","machine().side_effects_disabled"];
