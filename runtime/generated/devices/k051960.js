...
definition.compiledMethods = (() => {
    function method_k051960_fetchromdata(runtime, offset) {
        ...
        let addr = runtime.add((((members.m_romoffset ?? runtime.member("m_romoffset"))) + (((runtime.readIndex((members.m_spriterombank ?? runtime.member("m_spriterombank")), 0)) << (8)))), ((((runtime.readIndex((members.m_spriterombank ?? runtime.member("m_spriterombank")), 1)) & (3))) << (16)));
        let code = ((((addr) & (262112))) >>> (5));
        let off1 = ((addr) & (31));
        let color = runtime.add(((((runtime.readIndex((members.m_spriterombank ?? runtime.member("m_spriterombank")), 1)) & (252))) >>> (2)), ((((runtime.readIndex((members.m_spriterombank ?? runtime.member("m_spriterombank")), 2)) & (3))) << (6)));
        let pri = 0;
        let shadow = ((0) ? 1 : 0);
        (runtime.calls["m_k051960_cb"] ? runtime.calls["m_k051960_cb"](({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => pri, set: (value) => { pri = value; } }), ({ generatedLValue: true, get: () => shadow, set: (value) => { shadow = ((value) ? 1 : 0); } })) : runtime.macro("m_k051960_cb", ({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => pri, set: (value) => { pri = value; } }), ({ generatedLValue: true, get: () => shadow, set: (value) => { shadow = ((value) ? 1 : 0); } })));
    ...
    function method_k051960_sprites_draw(runtime, bitmap, cliprect, priority_bitmap, min_priority, max_priority) {
        ...
        let shadow_mode = ((((((((members.m_priority_shadows ?? runtime.member("m_priority_shadows"))) || ((runtime.calls["palette().shadow_mode"]?.() ?? 0))) ? 1 : 0)) ? (3) : (2))) >>> 0);
        ...
        for (pri_code = 0; ((Number(pri_code) < Number(NUM_SPRITES)) ? 1 : 0); pri_code = ((pri_code) + (1))) {
            ...
            let code = runtime.add(runtime.readIndex(h_m_buffer, ((offs) + (2))), ((((runtime.readIndex(h_m_buffer, ((offs) + (1)))) & (31))) << (8)));
            let color = ((runtime.readIndex(h_m_buffer, ((offs) + (3)))) & (255));
            let pri = 0;
