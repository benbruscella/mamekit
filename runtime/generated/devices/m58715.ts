...
class GeneratedM58715 implements Cpu {
  ...
  private m_ref = ((0) >>> 0);
  private m_rom_size = ((2048) & 0xffff);
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('M58715 dispatch loop exceeded 8');
...
export const cpu: GeneratedCpuExecutable = {
  ...
  create: (bus: CpuBus): Cpu => new GeneratedM58715(bus),
};
