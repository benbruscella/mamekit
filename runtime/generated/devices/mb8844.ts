...
definition.compiledMethods = (() => {
  function method_burn_cycles(runtime: any, cycles: any) {
    ...
    if ((((((members.m_in_irq) ? 0 : 1)) && (((members.m_pending_irq) & (members.m_pio)))) ? 1 : 0)) {
      ...
      let intpc: any = (((runtime.calls["GETPC"]?.() ?? 0)) & 0xffff);
      members.m_SP[members.m_SI] = intpc;
      members.m_SP[members.m_SI] = ((members.m_SP[members.m_SI]) | ((((runtime.calls["TEST_CF"]?.() ?? 0)) << (15))));
      members.m_SP[members.m_SI] = ((members.m_SP[members.m_SI]) | ((((runtime.calls["TEST_ZF"]?.() ?? 0)) << (14))));
      members.m_SP[members.m_SI] = ((members.m_SP[members.m_SI]) | ((((runtime.calls["TEST_ST"]?.() ?? 0)) << (13))));
    ...
    while (((Number(members.m_icount) > Number(0)) ? 1 : 0)) {
      ...
      switch (opcode) {
        ...
        case 1:
          ...
          break;
        case 2:
          (runtime.calls["m_write_p"]?.(members.m_A) ?? 0);
          members.m_st = ((1) & 0xff);
          break;
        case 3:
          arg = ((members.m_Y) & 0xff);
          members.m_write_r[((arg) & (3))](members.m_A);
          members.m_st = ((1) & 0xff);
          break;
        case 4:
        ...
        case 17:
          ...
          break;
        case 18:
          members.m_A = (((((runtime.calls["m_read_k"]?.() ?? 0)) & (15))) & 0xff);
          (runtime.calls["UPDATE_ZF"]?.(members.m_A) ?? 0);
          members.m_st = ((1) & 0xff);
          break;
        case 19:
          arg = ((members.m_Y) & 0xff);
          members.m_A = ((((members.m_read_r[((arg) & (3))]()) & (15))) & 0xff);
          (runtime.calls["UPDATE_ZF"]?.(members.m_A) ?? 0);
          members.m_st = ((1) & 0xff);
          break;
        case 20:
        ...
        case 31:
          ...
          break;
        case 32:
          arg = ((((members.m_read_r[((members.m_Y) >>> (2))]()) & (15))) & 0xff);
          members.m_write_r[((members.m_Y) >>> (2))](((arg) | (((1) << (((members.m_Y) & (3)))))));
          members.m_st = ((1) & 0xff);
          break;
        case 33:
          members.m_cf = ((1) & 0xff);
        ...
        case 44:
          members.m_SI = ((((((members.m_SI) - (1))) & (3))) & 0xff);
          members.m_PC = ((((members.m_SP[members.m_SI]) & (63))) & 0xff);
          members.m_PA = ((((((members.m_SP[members.m_SI]) >>> (6))) & (31))) & 0xff);
          members.m_st = ((1) & 0xff);
          break;
        case 45:
          members.m_A = (((((~members.m_A)) + (1))) & 0xff);
        ...
        case 60:
          ...
          members.m_PC = ((((members.m_SP[members.m_SI]) & (63))) & 0xff);
          members.m_PA = ((((((members.m_SP[members.m_SI]) >>> (6))) & (31))) & 0xff);
          members.m_st = ((((((members.m_SP[members.m_SI]) >>> (13))) & (1))) & 0xff);
          members.m_zf = ((((((members.m_SP[members.m_SI]) >>> (14))) & (1))) & 0xff);
          members.m_cf = ((((((members.m_SP[members.m_SI]) >>> (15))) & (1))) & 0xff);
          break;
        case 61:
        ...
        case 66:
        case 67:
          arg = ((((members.m_read_r[0]()) & (15))) & 0xff);
          arg = ((((arg) | (((1) << (((opcode) & (3))))))) & 0xff);
          members.m_write_r[0](arg);
          members.m_st = ((1) & 0xff);
          break;
        case 68:
        case 69:
        ...
        case 74:
        case 75:
          arg = ((((members.m_read_r[2]()) & (15))) & 0xff);
          members.m_st = ((((((arg) & (((1) << (((opcode) & (3))))))) ? (0) : (1))) & 0xff);
          break;
        case 76:
        case 77:
        ...
        case 103:
          ...
          if ((runtime.calls["TEST_ST"]?.() ?? 0)) {
            members.m_SP[members.m_SI] = (runtime.calls["GETPC"]?.() ?? 0);
            members.m_SI = ((((((members.m_SI) + (1))) & (3))) & 0xff);
  ...
  function method_write_pla(runtime: any, index: any) {
    ...
    if (((Number(members.m_pla_bits) === Number(8)) ? 1 : 0)) {
      ...
      if (members.m_pla_data) {
        members.m_o_output = ((members.m_pla_data[index]) & 0xff);
      } else {
        members.m_o_output = ((index) & 0xff);
      }
    }
    (runtime.calls["m_write_o"]?.(0, members.m_o_output, mask) ?? 0);
  }
  ...
  function method_serial_timer(runtime: any, param: any) {
    ...
    if (((members.m_sf) ? 0 : 1)) {
      members.m_SB = ((((((members.m_SB) >>> (1))) | ((((runtime.calls["m_read_si"]?.() ?? 0)) ? (8) : (0))))) & 0xff);
