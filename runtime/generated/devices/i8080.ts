...
class GeneratedI8080 implements Cpu {
  ...
  private method_execute_set_input(irqline: number, state: number): number {
    let newstate = ((((Number(state) !== Number(0)) ? 1 : 0)) | 0);
  ...
  private method_set_sod(state: number): number {
  ...
  private method_set_inte(state: number): number {
  ...
  private method_set_status(status: number): number {
  ...
  private method_read_mem(a: number): number {
    this.method_set_status(130);
    return (this.readMemory((a) & 0xffff) & 0xff);
    return 0;
  }

  private method_write_mem(a: number, v: number): number {
    this.method_set_status(0);
    (this.writeMemory((a) & 0xffff, (v) & 0xff), 0);
    return 0;
  }

  private method_op_push(p: number): number {
  ...
  private method_op_ora(v: number): number {
    this.m_AF.b.h = ((((this.m_AF.b.h) | (v))) & 0xff);
    this.m_AF.b.l = ((this.lut_zsp[this.m_AF.b.h]) & 0xff);
    return 0;
  }

  private method_op_xra(v: number): number {
    this.m_AF.b.h = ((((this.m_AF.b.h) ^ (v))) & 0xff);
    this.m_AF.b.l = ((this.lut_zsp[this.m_AF.b.h]) & 0xff);
    return 0;
  }

  private method_op_ana(v: number): number {
  ...
  private method_op_inr(v: number): number {
  ...
  private method_op_dcr(v: number): number {
  ...
  private method_op_add(v: number): number {
  ...
  private method_op_adc(v: number): number {
  ...
  private method_op_sub(v: number): number {
    let q = ((((this.m_AF.b.h) - (v))) | 0);
  ...
  private method_op_sbb(v: number): number {
    let q = ((((((this.m_AF.b.h) - (v))) - (((this.m_AF.b.l) & (1))))) | 0);
    this.m_AF.b.l = ((((((((this.lut_zsp[((q) & (255))]) | (((((q) >> (8))) & (1))))) | ((((~((((this.m_AF.b.h) ^ (q))) ^ (v)))) & (16))))) | (2))) & 0xff);
    this.m_AF.b.h = ((q) & 0xff);
    return 0;
  ...
  private method_op_cmp(v: number): number {
    let q = ((((this.m_AF.b.h) - (v))) | 0);
    this.m_AF.b.l = ((((((((this.lut_zsp[((q) & (255))]) | (((((q) >> (8))) & (1))))) | ((((~((((this.m_AF.b.h) ^ (q))) ^ (v)))) & (16))))) | (2))) & 0xff);
    return 0;
  }

  private method_op_dad(v: number): number {
  ...
  private method_op_jmp(cond: number): number {
    if (cond) {
  ...
  private method_op_call(cond: number): number {
    if (cond) {
  ...
  private method_op_ret(cond: number): number {
    if (cond) {
  ...
  private method_op_rst(v: number): number {
    this.method_op_push(this.m_PC.w);
    this.m_PC.w = ((((8) * (v))) & 0xffff);
    return 0;
  }

  private method_execute_one(opcode: number): number {
