...
function bitswap(value, ...bits) {
    let swapped = 0;
    for (const bit of bits)
        swapped = (swapped << 1) | ((value >>> bit) & 1);
    return swapped >>> 0;
}
...
class Pair32Words {
    pair;
    constructor(pair) { this.pair = pair; }
    get h() { return (this.pair.value >>> 16) & 0xffff; }
    set h(next) {
        this.pair.value = (((this.pair.value & 0x0000ffff) | ((next & 0xffff) << 16))) >>> 0;
    }
    get l() { return this.pair.value & 0xffff; }
    set l(next) {
...
class Pair32 {
    ...
    set d(value) { this.value = value >>> 0; }
}
...
class XyHalves {
    cells;
    index;
    constructor(cells, index) { this.cells = cells; this.index = index; }
    get x() { return (this.cells[this.index] << 16) >> 16; }
    set x(value) {
        this.cells[this.index] = (this.cells[this.index] & ~0xffff) | (value & 0xffff);
    }
    get y() { return this.cells[this.index] >> 16; }
    set y(value) {
...
class XyRegister {
    ...
    get reg() { return this.cells[this.index]; }
    set reg(value) { this.cells[this.index] = value; }
}
...
class XyValue {
    ...
    set x(value) { this.px = (value << 16) >> 16; }
    get y() { return this.py; }
    set y(value) { this.py = (value << 16) >> 16; }
}
...
class GeneratedM6510 {
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('M6510 dispatch loop exceeded 8');
    ...
    set(name, value) {
        switch (name) {
            ...
            case "m_icount":
                ...
                return;
            case "m_pullup":
                this.m_pullup = ((value) & 0xff);
                return;
            case "m_floating":
                this.m_floating = ((value) & 0xff);
                return;
            case "m_dir":
                this.m_dir = ((value) & 0xff);
                return;
            case "m_port":
                this.m_port = ((value) & 0xff);
                return;
            case "m_drive":
                this.m_drive = ((value) & 0xff);
                return;
            default: return;
        }
    }
    ...
    method_set_pulls(_pullup = 0, _floating = 0) {
    ...
    method_port_w(data = 0) {
        this.m_port = ((data) & 0xff);
        this.method_update_port();
        return 0;
    }
    method_memory_read(adr = 0) {
    ...
    method_memory_write(adr = 0, val = 0) {
...
export const cpu = {
    ...
    create: (bus) => new GeneratedM6510(bus),
};
export default cpu;
