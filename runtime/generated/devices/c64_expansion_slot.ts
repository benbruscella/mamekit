...
definition.compiledMethods = (() => {
  ...
  function method_is_readable(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_is_writeable(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_is_creatable(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_image_type_name(runtime: any): any {
    const members = runtime.members;

    return "cartridge";
  }

  function method_image_brief_type_name(runtime: any): any {
    const members = runtime.members;

    return "cart";
  }

  function method_get_software_list_loader(runtime: any): any {
    const members = runtime.members;
  ...
  function method_device_rom_image_interface__is_readable(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_device_rom_image_interface__is_writeable(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_device_rom_image_interface__is_creatable(runtime: any): any {
    const members = runtime.members;

    return 0;
  }

  function method_device_rom_image_interface__image_type_name(runtime: any): any {
    const members = runtime.members;

    return "romimage";
  }

  function method_device_rom_image_interface__image_brief_type_name(runtime: any): any {
    const members = runtime.members;

    return "rom";
  }

  function method_device_cartrom_image_interface__image_type_name(runtime: any): any {
    const members = runtime.members;

    return "cartridge";
  }

  function method_device_cartrom_image_interface__image_brief_type_name(runtime: any): any {
    const members = runtime.members;
  ...
  function method_cd_r(runtime: any, offset: any, data: any, sphi2: any, ba: any, roml: any, romh: any, io1: any, io2: any): any {
    const members = runtime.members;
  ...
  function method_cd_w(runtime: any, offset: any, data: any, sphi2: any, ba: any, roml: any, romh: any, io1: any, io2: any): any {
    const members = runtime.members;
  ...
  function method_game_r(runtime: any, offset: any, sphi2: any, ba: any, rw: any, loram: any, hiram: any): any {
    const members = runtime.members;
  ...
  function method_exrom_r(runtime: any, offset: any, sphi2: any, ba: any, rw: any, loram: any, hiram: any): any {
    const members = runtime.members;
  ...
  function method_nmi_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_cd_input_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_cd_output_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_dma_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_c64_expansion_slot_device(runtime: any, mconfig: any, tag: any, owner: any, clock: any, opts: any, dflt: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dma_cd_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dma_cd_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_irq_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_nmi_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dma_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_reset_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_phi2(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_dotclock(runtime: any): any {
    const members = runtime.members;

    return ((method_phi2(runtime)) * (8));
  }

  function method_hiram(runtime: any): any {
    const members = runtime.members;

    return (members.m_hiram ?? runtime.member("m_hiram"));
  }

  function method_loram(runtime: any): any {
    const members = runtime.members;

    return (members.m_loram ?? runtime.member("m_loram"));
  }

  function method_is_reset_on_load(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_c64_expansion_slot_device__c64_expansion_slot_device(runtime: any, mconfig: any, tag: any, owner: any, clock: any, opts: any, dflt: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__irq_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_irq)).bind === 'function' ? (runtime.dereference(members.m_write_irq)).bind() : typeof (runtime.dereference(members.m_write_irq)).bind === 'number' || typeof (runtime.dereference(members.m_write_irq)).bind === 'boolean' ? (runtime.dereference(members.m_write_irq)).bind : runtime.container(members.m_write_irq, "bind"));
  }

  function method_c64_expansion_slot_device__nmi_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_nmi)).bind === 'function' ? (runtime.dereference(members.m_write_nmi)).bind() : typeof (runtime.dereference(members.m_write_nmi)).bind === 'number' || typeof (runtime.dereference(members.m_write_nmi)).bind === 'boolean' ? (runtime.dereference(members.m_write_nmi)).bind : runtime.container(members.m_write_nmi, "bind"));
  }

  function method_c64_expansion_slot_device__reset_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_reset)).bind === 'function' ? (runtime.dereference(members.m_write_reset)).bind() : typeof (runtime.dereference(members.m_write_reset)).bind === 'number' || typeof (runtime.dereference(members.m_write_reset)).bind === 'boolean' ? (runtime.dereference(members.m_write_reset)).bind : runtime.container(members.m_write_reset, "bind"));
  }

  function method_c64_expansion_slot_device__cd_input_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_read_dma_cd)).bind === 'function' ? (runtime.dereference(members.m_read_dma_cd)).bind() : typeof (runtime.dereference(members.m_read_dma_cd)).bind === 'number' || typeof (runtime.dereference(members.m_read_dma_cd)).bind === 'boolean' ? (runtime.dereference(members.m_read_dma_cd)).bind : runtime.container(members.m_read_dma_cd, "bind"));
  }

  function method_c64_expansion_slot_device__cd_output_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_dma_cd)).bind === 'function' ? (runtime.dereference(members.m_write_dma_cd)).bind() : typeof (runtime.dereference(members.m_write_dma_cd)).bind === 'number' || typeof (runtime.dereference(members.m_write_dma_cd)).bind === 'boolean' ? (runtime.dereference(members.m_write_dma_cd)).bind : runtime.container(members.m_write_dma_cd, "bind"));
  }

  function method_c64_expansion_slot_device__dma_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_dma)).bind === 'function' ? (runtime.dereference(members.m_write_dma)).bind() : typeof (runtime.dereference(members.m_write_dma)).bind === 'number' || typeof (runtime.dereference(members.m_write_dma)).bind === 'boolean' ? (runtime.dereference(members.m_write_dma)).bind : runtime.container(members.m_write_dma, "bind"));
  }

  function method_c64_expansion_slot_device__dma_cd_r(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__dma_cd_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__irq_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__nmi_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__dma_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__reset_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__phi2(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_c64_expansion_slot_device__dotclock(runtime: any): any {
    const members = runtime.members;

    return ((method_phi2(runtime)) * (8));
  }

  function method_c64_expansion_slot_device__hiram(runtime: any): any {
    const members = runtime.members;

    return (members.m_hiram ?? runtime.member("m_hiram"));
  }

  function method_c64_expansion_slot_device__loram(runtime: any): any {
    const members = runtime.members;

    return (members.m_loram ?? runtime.member("m_loram"));
  }

  function method_c64_expansion_slot_device__is_reset_on_load(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_c64_expansion_slot_device__image_interface(runtime: any): any {
    const members = runtime.members;

    return "c64_cart,vic10_cart";
  }

  function method_c64_expansion_slot_device__file_extensions(runtime: any): any {
    const members = runtime.members;
