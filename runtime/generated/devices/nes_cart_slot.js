...
definition.compiledMethods = (() => {
    function method_read_l(runtime, offset) {
        ...
        if (members.m_cart) {
            let val = ((members.m_cart.read_l(offset)) & 0xff);
    ...
    function method_read_m(runtime, offset) {
        const members = runtime.members;
        if (members.m_cart) {
            let val = ((members.m_cart.read_m(offset)) & 0xff);
...
definition.slot.options["4"].compiledMethods = (() => {
    ...
    function method_set_prg(runtime, prg_base, prg_mask) {
        const members = runtime.members;
        let prg_flip = ((((((members.m_latch) & (64))) ? (2) : (0))) & 0xff);
    ...
    function method_set_chr(runtime, chr, chr_base, chr_mask) {
        const members = runtime.members;
        let chr_page = ((((((members.m_latch) & (128))) >>> (5))) & 0xff);
