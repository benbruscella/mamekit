...
definition.compiledMethods = (() => {
  ...
  function method_group_mode(runtime: any, group: any): any {
    const members = runtime.members;
    ...
    switch (group) {
      case 0:
      {
        switch (runtime.shiftRight((((members.m_control ?? runtime.member("m_control"))) & (96)), 5)) {
          case 0:
          {
            mode = ((0) | 0);
            break;
      ...
      case 1:
      {
        mode = (((((((members.m_control ?? runtime.member("m_control"))) & (4))) ? (1) : (0))) | 0);
        break;
      }
    }
    return mode;
  ...
  function method_read_mode0(runtime: any, port: any): any {
    const members = runtime.members;
    ...
    if (((Number(method_port_mode(runtime, port)) === Number(0)) ? 1 : 0)) {
      ...
      data = ((((((Number(port) === Number(0)) ? 1 : 0)) ? ((__l["m_in_pa_cb"] ? __l["m_in_pa_cb"](Number(0)) : typeof members.m_in_pa_cb === 'function' ? members.m_in_pa_cb(0) : runtime.invoke("m_in_pa_cb", 0))) : (((((Number(port) === Number(1)) ? 1 : 0)) ? ((__l["m_in_pb_cb"] ? __l["m_in_pb_cb"](Number(0)) : typeof members.m_in_pb_cb === 'function' ? members.m_in_pb_cb(0) : runtime.invoke("m_in_pb_cb", 0))) : ((__l["m_in_pc_cb"] ? __l["m_in_pc_cb"](Number(0)) : typeof members.m_in_pc_cb === 'function' ? members.m_in_pc_cb(0) : runtime.invoke("m_in_pc_cb", 0))))))) & 0xff);
    }
    return data;
  }

  function method_port_mode(runtime: any, port: any): any {
    const members = runtime.members;
    ...
    switch (port) {
      case 0:
      {
        mode = (((((((members.m_control ?? runtime.member("m_control"))) & (16))) ? (1) : (0))) | 0);
        break;
      }
      case 1:
      {
        mode = (((((((members.m_control ?? runtime.member("m_control"))) & (2))) ? (1) : (0))) | 0);
        break;
      }
    }
    return mode;
  ...
  function method_read_mode1(runtime: any, port: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_ibf(runtime: any, port: any, state: any): any {
    const members = runtime.members;
  ...
  function method_check_interrupt(runtime: any, port: any): any {
    const members = runtime.members;
  ...
  function method_set_intr(runtime: any, port: any, state: any): any {
    const members = runtime.members;
  ...
  function method_output_pc(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch (method_group_mode(runtime, 0)) {
      case 0:
      {
        if (((Number(method_port_c_upper_mode(runtime)) === Number(0)) ? 1 : 0)) {
          ...
          data = ((((data) | ((((__l["m_tri_pc_cb"] ? __l["m_tri_pc_cb"](Number(0)) : typeof members.m_tri_pc_cb === 'function' ? members.m_tri_pc_cb(0) : runtime.invoke("m_tri_pc_cb", 0))) & (240))))) & 0xff);
        }
        break;
      }
      case 1:
    ...
    switch (method_group_mode(runtime, 1)) {
      case 0:
      {
        if (((Number(method_port_c_lower_mode(runtime)) === Number(0)) ? 1 : 0)) {
          ...
          data = ((((data) | ((((__l["m_tri_pc_cb"] ? __l["m_tri_pc_cb"](Number(0)) : typeof members.m_tri_pc_cb === 'function' ? members.m_tri_pc_cb(0) : runtime.invoke("m_tri_pc_cb", 0))) & (b_mask))))) & 0xff);
        }
        break;
      }
      case 1:
    ...
    (__l["m_out_pc_cb"] ? __l["m_out_pc_cb"](Number(0), Number(data)) : typeof members.m_out_pc_cb === 'function' ? members.m_out_pc_cb(0, data) : runtime.invoke("m_out_pc_cb", 0, data));
  }

  function method_port_c_upper_mode(runtime: any): any {
    const members = runtime.members;

    return (((((members.m_control ?? runtime.member("m_control"))) & (8))) ? (1) : (0));
  }

  function method_port_c_lower_mode(runtime: any): any {
    const members = runtime.members;

    return (((((members.m_control ?? runtime.member("m_control"))) & (1))) ? (1) : (0));
  }

  function method_read_mode2(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_read_pc(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if (mask) {
      data = ((((data) | ((((__l["m_in_pc_cb"] ? __l["m_in_pc_cb"](Number(0)) : typeof members.m_in_pc_cb === 'function' ? members.m_in_pc_cb(0) : runtime.invoke("m_in_pc_cb", 0))) & (mask))))) & 0xff);
    }
    return data;
  }
    ...
    switch (((offset) & (3))) {
      ...
      case 3:
      {
        if (((data) & (128))) {
          ...
          let bit: any = ((((runtime.shiftRight(data, 1)) & (7))) | 0);
          let state: any = (((((data) >>> (0)) & 1)) | 0);
          0;
  ...
  function method_write_mode0(runtime: any, port: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if (((Number(method_port_mode(runtime, port)) === Number(0)) ? 1 : 0)) {
      ...
      if (((Number(port) === Number(0)) ? 1 : 0)) {
        (__l["m_out_pa_cb"] ? __l["m_out_pa_cb"](Number(0), Number((members.m_output ?? runtime.member("m_output"))[port])) : typeof members.m_out_pa_cb === 'function' ? members.m_out_pa_cb(0, (members.m_output ?? runtime.member("m_output"))[port]) : runtime.invoke("m_out_pa_cb", 0, (members.m_output ?? runtime.member("m_output"))[port]));
      } else {
        (__l["m_out_pb_cb"] ? __l["m_out_pb_cb"](Number(0), Number((members.m_output ?? runtime.member("m_output"))[port])) : typeof members.m_out_pb_cb === 'function' ? members.m_out_pb_cb(0, (members.m_output ?? runtime.member("m_output"))[port]) : runtime.invoke("m_out_pb_cb", 0, (members.m_output ?? runtime.member("m_output"))[port]));
      }
    }
  }

  function method_write_mode1(runtime: any, port: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_obf(runtime: any, port: any, state: any): any {
    const members = runtime.members;
  ...
  function method_write_mode2(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (members.m_output ?? runtime.member("m_output"))[0] = data;
    (__l["m_out_pa_cb"] ? __l["m_out_pa_cb"](Number(0), Number(data)) : typeof members.m_out_pa_cb === 'function' ? members.m_out_pa_cb(0, data) : runtime.invoke("m_out_pa_cb", 0, data));
    method_set_obf(runtime, 0, 0);
    method_set_intr(runtime, 0, 0);
  }

  function method_set_mode(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    members.m_inte2 = ((0) | 0);
    if (((Number(method_port_mode(runtime, 0)) === Number(0)) ? 1 : 0)) {
      (__l["m_out_pa_cb"] ? __l["m_out_pa_cb"](Number(0), Number((members.m_output ?? runtime.member("m_output"))[0])) : typeof members.m_out_pa_cb === 'function' ? members.m_out_pa_cb(0, (members.m_output ?? runtime.member("m_output"))[0]) : runtime.invoke("m_out_pa_cb", 0, (members.m_output ?? runtime.member("m_output"))[0]));
      (members.m_ibf ?? runtime.member("m_ibf"))[0] = 1;
    } else {
      (__l["m_out_pa_cb"] ? __l["m_out_pa_cb"](Number(0), Number((__l["m_tri_pa_cb"] ? __l["m_tri_pa_cb"](Number(0)) : typeof members.m_tri_pa_cb === 'function' ? members.m_tri_pa_cb(0) : runtime.invoke("m_tri_pa_cb", 0)))) : typeof members.m_out_pa_cb === 'function' ? members.m_out_pa_cb(0, (__l["m_tri_pa_cb"] ? __l["m_tri_pa_cb"](Number(0)) : typeof members.m_tri_pa_cb === 'function' ? members.m_tri_pa_cb(0) : runtime.invoke("m_tri_pa_cb", 0))) : runtime.invoke("m_out_pa_cb", 0, (__l["m_tri_pa_cb"] ? __l["m_tri_pa_cb"](Number(0)) : typeof members.m_tri_pa_cb === 'function' ? members.m_tri_pa_cb(0) : runtime.invoke("m_tri_pa_cb", 0))));
    }
    0;
    0;
    0;
    ...
    if (((Number(method_port_mode(runtime, 1)) === Number(0)) ? 1 : 0)) {
      (__l["m_out_pb_cb"] ? __l["m_out_pb_cb"](Number(0), Number((members.m_output ?? runtime.member("m_output"))[1])) : typeof members.m_out_pb_cb === 'function' ? members.m_out_pb_cb(0, (members.m_output ?? runtime.member("m_output"))[1]) : runtime.invoke("m_out_pb_cb", 0, (members.m_output ?? runtime.member("m_output"))[1]));
    } else {
      (__l["m_out_pb_cb"] ? __l["m_out_pb_cb"](Number(0), Number((__l["m_tri_pb_cb"] ? __l["m_tri_pb_cb"](Number(0)) : typeof members.m_tri_pb_cb === 'function' ? members.m_tri_pb_cb(0) : runtime.invoke("m_tri_pb_cb", 0)))) : typeof members.m_out_pb_cb === 'function' ? members.m_out_pb_cb(0, (__l["m_tri_pb_cb"] ? __l["m_tri_pb_cb"](Number(0)) : typeof members.m_tri_pb_cb === 'function' ? members.m_tri_pb_cb(0) : runtime.invoke("m_tri_pb_cb", 0))) : runtime.invoke("m_out_pb_cb", 0, (__l["m_tri_pb_cb"] ? __l["m_tri_pb_cb"](Number(0)) : typeof members.m_tri_pb_cb === 'function' ? members.m_tri_pb_cb(0) : runtime.invoke("m_tri_pb_cb", 0))));
    }
    if (((0) ? 0 : 1)) {
  ...
  function method_set_pc_bit(runtime: any, bit: any, state: any): any {
    const members = runtime.members;
  ...
  function method_set_inte(runtime: any, port: any, state: any): any {
    const members = runtime.members;
  ...
  function method_set_inte2(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_set_inte1(runtime: any, state: any): any {
    const members = runtime.members;
...
definition.compiledMethodLinks = ["m_in_pa_cb","m_in_pb_cb","m_in_pc_cb","m_out_pa_cb","m_out_pb_cb","m_out_pc_cb","m_tri_pa_cb","m_tri_pb_cb","m_tri_pc_cb","machine","machine().side_effects_disabled"];
