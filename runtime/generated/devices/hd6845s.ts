...
import deviceData from './hd6845s.device.ir.json' with { type: 'json' };

const definition = deviceData as unknown as GeneratedDeviceDefinition;
definition.compiledMethods = (() => {

  function method_draw_scanline(runtime: any, y: any, bitmap: any, cliprect: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let ra: any = ((((y) % ((((members.m_max_ras_addr ?? runtime.member("m_max_ras_addr"))) + (((((Number((((members.m_mode_control ?? runtime.member("m_mode_control"))) & (3))) === Number(3)) ? 1 : 0)) ? ((members.m_interlace_adjust ?? runtime.member("m_interlace_adjust"))) : ((members.m_noninterlace_adjust ?? runtime.member("m_noninterlace_adjust"))))))))) & 0xff);
    let cursor_visible: any = ((method_check_cursor_visible(runtime, ra, (members.m_current_disp_addr ?? runtime.member("m_current_disp_addr")))) | 0);
    let cursor_x: any = ((((cursor_visible) ? ((((members.m_cursor_addr ?? runtime.member("m_cursor_addr"))) - ((members.m_current_disp_addr ?? runtime.member("m_current_disp_addr"))))) : (-1))) << 24 >> 24);
    let de: any = ((((((Number(y) <= Number((members.m_max_visible_y ?? runtime.member("m_max_visible_y")))) ? 1 : 0)) ? (1) : (0))) | 0);
    let vbp: any = (((((members.m_vert_pix_total ?? runtime.member("m_vert_pix_total"))) - ((members.m_vsync_off_pos ?? runtime.member("m_vsync_off_pos"))))) | 0);
    if (((Number(vbp) < Number(0)) ? 1 : 0)) {
      vbp = ((0) | 0);
    }
    let hbp: any = (((((members.m_horiz_pix_total ?? runtime.member("m_horiz_pix_total"))) - ((members.m_hsync_off_pos ?? runtime.member("m_hsync_off_pos"))))) | 0);
    if (((Number(hbp) < Number(0)) ? 1 : 0)) {
      hbp = ((0) | 0);
    }
    if (((Number((((members.m_mode_control ?? runtime.member("m_mode_control"))) & (4))) !== Number(0)) ? 1 : 0)) {
      let cc: any = ((0) & 0xff);
      let cr: any = ((runtime.divide(y, (((members.m_max_ras_addr ?? runtime.member("m_max_ras_addr"))) + (((((Number((((members.m_mode_control ?? runtime.member("m_mode_control"))) & (3))) === Number(3)) ? 1 : 0)) ? ((members.m_interlace_adjust ?? runtime.member("m_interlace_adjust"))) : ((members.m_noninterlace_adjust ?? runtime.member("m_noninterlace_adjust")))))))) & 0xff);
      let ma: any = ((((((cr) << (8))) | (cc))) & 0xffff);
      (__l["m_update_row_cb"] ? __l["m_update_row_cb"](({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } }), ((ma) + ((members.m_disp_start_addr ?? runtime.member("m_disp_start_addr")))), ({ generatedLValue: true, get: () => ra, set: (value: any) => { ra = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => y, set: (value: any) => { y = ((value) | 0); } }), ({ generatedLValue: true, get: () => (members.m_horiz_disp ?? runtime.member("m_horiz_disp")), set: (value: any) => { members.m_horiz_disp = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => cursor_x, set: (value: any) => { cursor_x = ((value) << 24 >> 24); } }), ({ generatedLValue: true, get: () => de, set: (value: any) => { de = ((value) | 0); } }), ({ generatedLValue: true, get: () => hbp, set: (value: any) => { hbp = ((value) | 0); } }), ({ generatedLValue: true, get: () => vbp, set: (value: any) => { vbp = ((value) | 0); } })) : runtime.macro("m_update_row_cb", ({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } }), ((ma) + ((members.m_disp_start_addr ?? runtime.member("m_disp_start_addr")))), ({ generatedLValue: true, get: () => ra, set: (value: any) => { ra = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => y, set: (value: any) => { y = ((value) | 0); } }), ({ generatedLValue: true, get: () => (members.m_horiz_disp ?? runtime.member("m_horiz_disp")), set: (value: any) => { members.m_horiz_disp = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => cursor_x, set: (value: any) => { cursor_x = ((value) << 24 >> 24); } }), ({ generatedLValue: true, get: () => de, set: (value: any) => { de = ((value) | 0); } }), ({ generatedLValue: true, get: () => hbp, set: (value: any) => { hbp = ((value) | 0); } }), ({ generatedLValue: true, get: () => vbp, set: (value: any) => { vbp = ((value) | 0); } })));
    } else {
      (__l["m_update_row_cb"] ? __l["m_update_row_cb"](({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } }), ({ generatedLValue: true, get: () => (members.m_current_disp_addr ?? runtime.member("m_current_disp_addr")), set: (value: any) => { members.m_current_disp_addr = ((value) & 0xffff); } }), ({ generatedLValue: true, get: () => ra, set: (value: any) => { ra = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => y, set: (value: any) => { y = ((value) | 0); } }), ({ generatedLValue: true, get: () => (members.m_horiz_disp ?? runtime.member("m_horiz_disp")), set: (value: any) => { members.m_horiz_disp = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => cursor_x, set: (value: any) => { cursor_x = ((value) << 24 >> 24); } }), ({ generatedLValue: true, get: () => de, set: (value: any) => { de = ((value) | 0); } }), ({ generatedLValue: true, get: () => hbp, set: (value: any) => { hbp = ((value) | 0); } }), ({ generatedLValue: true, get: () => vbp, set: (value: any) => { vbp = ((value) | 0); } })) : runtime.macro("m_update_row_cb", ({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } }), ({ generatedLValue: true, get: () => (members.m_current_disp_addr ?? runtime.member("m_current_disp_addr")), set: (value: any) => { members.m_current_disp_addr = ((value) & 0xffff); } }), ({ generatedLValue: true, get: () => ra, set: (value: any) => { ra = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => y, set: (value: any) => { y = ((value) | 0); } }), ({ generatedLValue: true, get: () => (members.m_horiz_disp ?? runtime.member("m_horiz_disp")), set: (value: any) => { members.m_horiz_disp = ((value) & 0xff); } }), ({ generatedLValue: true, get: () => cursor_x, set: (value: any) => { cursor_x = ((value) << 24 >> 24); } }), ({ generatedLValue: true, get: () => de, set: (value: any) => { de = ((value) | 0); } }), ({ generatedLValue: true, get: () => hbp, set: (value: any) => { hbp = ((value) | 0); } }), ({ generatedLValue: true, get: () => vbp, set: (value: any) => { vbp = ((value) | 0); } })));
    }
  ...
  function method_check_cursor_visible(runtime: any, ra: any, line_addr: any): any {
    const members = runtime.members;
    ...
    let cursor_start_ras: any = (((((members.m_cursor_start_ras ?? runtime.member("m_cursor_start_ras"))) & (31))) & 0xffff);
    let max_ras_addr: any = (((((((members.m_max_ras_addr ?? runtime.member("m_max_ras_addr"))) + (((((Number((((members.m_mode_control ?? runtime.member("m_mode_control"))) & (3))) === Number(3)) ? 1 : 0)) ? ((members.m_interlace_adjust ?? runtime.member("m_interlace_adjust"))) : ((members.m_noninterlace_adjust ?? runtime.member("m_noninterlace_adjust"))))))) - (1))) & 0xffff);
    if ((((((Number(cursor_start_ras) > Number(max_ras_addr)) ? 1 : 0)) || (((Number(cursor_start_ras) > Number((members.m_cursor_end_ras ?? runtime.member("m_cursor_end_ras")))) ? 1 : 0))) ? 1 : 0)) {
      return 0;
    }
  ...
  function method_screen_update(runtime: any, screen: any, bitmap: any, cliprect: any): any {
    ...
    if ((members.m_has_valid_parameters ?? runtime.member("m_has_valid_parameters"))) {
      ...
      (__l["m_begin_update_cb"] ? __l["m_begin_update_cb"](({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } })) : runtime.macro("m_begin_update_cb", ({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } })));
      ...
      for (let y: any = ((cliprect.min_y) & 0xffff); ((Number(y) <= Number(cliprect.max_y)) ? 1 : 0); y = ((((y) + (1))) & 0xffff)) {
        ((runtime.dereference((members.this ?? runtime.member("this")))).draw_scanline?.(y, bitmap, cliprect) ?? 0);
      }
      (__l["m_end_update_cb"] ? __l["m_end_update_cb"](({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } })) : runtime.macro("m_end_update_cb", ({ generatedLValue: true, get: () => bitmap, set: (value: any) => { bitmap = value; } }), ({ generatedLValue: true, get: () => cliprect, set: (value: any) => { cliprect = value; } })));
    } else {
  ...
  function method_match_line(runtime: any): any {
    const members = runtime.members;
  ...
  function method_update_cursor_state(runtime: any): any {
    const members = runtime.members;

    let last_cursor_blink_count: any = (((members.m_cursor_blink_count ?? runtime.member("m_cursor_blink_count"))) & 0xff);
  ...
  function method_cclks_to_attotime(runtime: any, clocks: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_vsync(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_set_de(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_update_upd_adr_timer(runtime: any): any {
    const members = runtime.members;
  ...
  function method_de_off_tick(runtime: any, param: any): any {
    const members = runtime.members;

    method_set_de(runtime, 0);
  }

  function method_cursor_on(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_set_cur(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_cursor_off(runtime: any, param: any): any {
    const members = runtime.members;

    method_set_cur(runtime, 0);
  }

  function method_hsync_on(runtime: any, param: any): any {
    const members = runtime.members;

    let hsync_width: any = (((((((members.m_sync_width ?? runtime.member("m_sync_width"))) & (15))) ? ((((members.m_sync_width ?? runtime.member("m_sync_width"))) & (15))) : (16))) & 0xff);
  ...
  function method_set_hsync(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_hsync_off(runtime: any, param: any): any {
    const members = runtime.members;

    method_set_hsync(runtime, 0);
  }

  function method_latch_light_pen(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_get_ma(runtime: any): any {
    const members = runtime.members;
  ...
  function method_update_counters(runtime: any): any {
    const members = runtime.members;
  ...
  function method_attotime_to_cclks(runtime: any, duration: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_adr_update_tick(runtime: any, param: any): any {
    const members = runtime.members;

    method_call_on_update_address(runtime, ((Number((((members.m_mode_control ?? runtime.member("m_mode_control"))) & (64))) !== Number(0)) ? 1 : 0));
  }

  function method_call_on_update_address(runtime: any, strobe: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_transparent_update_tick(runtime: any, param: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let addr: any = ((runtime.shiftRight(param, 8)) | 0);
    let strobe: any = ((((param) & (255))) | 0);
    (__l["m_on_update_addr_changed_cb"] ? __l["m_on_update_addr_changed_cb"](({ generatedLValue: true, get: () => addr, set: (value: any) => { addr = ((value) | 0); } }), ({ generatedLValue: true, get: () => strobe, set: (value: any) => { strobe = ((value) | 0); } })) : runtime.macro("m_on_update_addr_changed_cb", ({ generatedLValue: true, get: () => addr, set: (value: any) => { addr = ((value) | 0); } }), ({ generatedLValue: true, get: () => strobe, set: (value: any) => { strobe = ((value) | 0); } })));
