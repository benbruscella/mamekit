...
definition.compiledMethods = (() => {
  ...
  function method_tia_sound_w(runtime: any, offset: any, data: any): any {
  ...
  function method_sound_stream_update(runtime: any, samples: any): any {
    const members = runtime.members;
    ...
    for (let sampindex: any = ((0) | 0); ((Number(sampindex) < Number(samples)) ? 1 : 0); ) {
      if (((Number(div_n_cnt0) > Number(1)) ? 1 : 0)) {
        div_n_cnt0 = ((((div_n_cnt0) - (1))) & 0xff);
      } else {
        if (((Number(div_n_cnt0) === Number(1)) ? 1 : 0)) {
          let prev_bit5: any = ((runtime.readIndex(h_Bit5, p5_0)) | 0);
      ...
      if (((Number(div_n_cnt1) > Number(1)) ? 1 : 0)) {
        ...
        if (((Number(div_n_cnt1) === Number(1)) ? 1 : 0)) {
          let prev_bit5: any = ((runtime.readIndex(h_Bit5, p5_1)) | 0);
  ...
  function method_poly_init(runtime: any, poly: any, size: any, f0: any, f1: any): any {
    const members = runtime.members;

    let mask: any = ((((((1) << (size))) - (1))) | 0);
    let x: any = ((mask) | 0);
    for (let i: any = ((0) | 0); ((Number(i) < Number(mask)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      let bit0: any = ((((((((size) - (f0))) ? (runtime.shiftRight(x, ((size) - (f0)))) : (x))) & (1))) | 0);
      let bit1: any = ((((((((size) - (f1))) ? (runtime.shiftRight(x, ((size) - (f1)))) : (x))) & (1))) | 0);
