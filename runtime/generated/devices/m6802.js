...
class GeneratedM6802 {
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('M6802 dispatch loop exceeded 8');
            switch ((this.m_ref >>> 8) & 0xffff) {
                ...
                default:
                    throw new Error('M6802 has no generated opcode ' +
    ...
    invoke(name, ...args) {
        switch (name) {
            ...
            default: throw new Error('M6802 has no generated method "' + name + '"');
        }
    }
    generatedStart() {
    }
...
export const cpu = {
    ...
    create: (bus) => new GeneratedM6802(bus),
};
export default cpu;
