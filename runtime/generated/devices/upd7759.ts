...
definition.compiledMethods = (() => {
  function method_internal_start_w(runtime: any, state: any) {
  ...
  function method_internal_reset_w(runtime: any, param: any) {
    const members = runtime.members;
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
  ...
  function method_upd775x_device__device_reset(runtime: any) {
    const members = runtime.members;
    members.m_pos = ((0) >>> 0);
  ...
  function method_internal_port_w(runtime: any, param: any) {
    const members = runtime.members;
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    members.m_fifo_in = ((param) & 0xff);
  }

  function method_drq_update(runtime: any, param: any) {
    const members = runtime.members;
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    let olddrq: any = (((members.m_drq ?? runtime.member("m_drq"))) & 0xff);
    let old_state: any = (members.m_state ?? runtime.member("m_state"));
  ...
  function method_advance_state(runtime: any) {
    const members = runtime.members;
  ...
  function method_update_adpcm(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_internal_md_w(runtime: any, param: any) {
    const members = runtime.members;
    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
