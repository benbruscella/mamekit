...
definition.compiledMethods = (() => {
  const __mame_table_0 = [0, 0, 1, 2, 3, 5, 7, 10, 0, 0, -1, -2, -3, -5, -7, -10, 0, 1, 2, 3, 4, 6, 8, 13, 0, -1, -2, -3, -4, -6, -8, -13, 0, 1, 2, 4, 5, 7, 10, 15, 0, -1, -2, -4, -5, -7, -10, -15, 0, 1, 3, 4, 6, 9, 13, 19, 0, -1, -3, -4, -6, -9, -13, -19, 0, 2, 3, 5, 8, 11, 15, 23, 0, -2, -3, -5, -8, -11, -15, -23, 0, 2, 4, 7, 10, 14, 19, 29, 0, -2, -4, -7, -10, -14, -19, -29, 0, 3, 5, 8, 12, 16, 22, 33, 0, -3, -5, -8, -12, -16, -22, -33, 1, 4, 7, 10, 15, 20, 29, 43, -1, -4, -7, -10, -15, -20, -29, -43, 1, 4, 8, 13, 18, 25, 35, 53, -1, -4, -8, -13, -18, -25, -35, -53, 1, 6, 10, 16, 22, 31, 43, 64, -1, -6, -10, -16, -22, -31, -43, -64, 2, 7, 12, 19, 27, 37, 51, 76, -2, -7, -12, -19, -27, -37, -51, -76, 2, 9, 16, 24, 34, 46, 64, 96, -2, -9, -16, -24, -34, -46, -64, -96, 3, 11, 19, 29, 41, 57, 79, 117, -3, -11, -19, -29, -41, -57, -79, -117, 4, 13, 24, 36, 50, 69, 96, 143, -4, -13, -24, -36, -50, -69, -96, -143, 4, 16, 29, 44, 62, 85, 118, 175, -4, -16, -29, -44, -62, -85, -118, -175, 6, 20, 36, 54, 76, 104, 144, 214, -6, -20, -36, -54, -76, -104, -144, -214];
  const __mame_table_1 = [-1, -1, 0, 0, 1, 2, 2, 3, -1, -1, 0, 0, 1, 2, 2, 3];
  function method_internal_start_w(runtime: any, state: any): any {
    ...
    let oldstart: any = (((members.m_start ?? runtime.member("m_start"))) & 0xff);
  ...
  function method_internal_reset_w(runtime: any, param: any): any {
    const members = runtime.members;

    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    let oldreset: any = (((members.m_reset ?? runtime.member("m_reset"))) & 0xff);
  ...
  function method_device_reset(runtime: any): any {
    ...
    if ((members.m_drq ?? runtime.member("m_drq"))) {
      ...
      (__l["m_drqcallback"] ? __l["m_drqcallback"](Number((members.m_drq ?? runtime.member("m_drq")))) : typeof members.m_drqcallback === 'function' ? members.m_drqcallback((members.m_drq ?? runtime.member("m_drq"))) : runtime.invoke("m_drqcallback", (members.m_drq ?? runtime.member("m_drq"))));
    }
  }

  function method_upd775x_device__device_reset(runtime: any): any {
    const members = runtime.members;
  ...
  function method_internal_port_w(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_drq_update(runtime: any, param: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    let olddrq: any = (((members.m_drq ?? runtime.member("m_drq"))) & 0xff);
    let old_state: any = (((members.m_state ?? runtime.member("m_state"))) | 0);
  ...
  function method_advance_state(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch ((members.m_state ?? runtime.member("m_state"))) {
      ...
      case 4:
      {
        members.m_last_sample = ((((((Number((members.m_mode ?? runtime.member("m_mode"))) === Number(1)) ? 1 : 0)) ? ((__l["read_byte"] ? __l["read_byte"](0) : runtime.macro("read_byte", 0))) : ((members.m_fifo_in ?? runtime.member("m_fifo_in"))))) & 0xff);
        0;
        members.m_drq = ((1) & 0xff);
      ...
      case 6:
      {
        members.m_offset = ((((((((Number((members.m_mode ?? runtime.member("m_mode"))) === Number(1)) ? 1 : 0)) ? ((__l["read_byte"] ? __l["read_byte"](runtime.add((((members.m_req_sample ?? runtime.member("m_req_sample"))) * (2)), 5)) : runtime.macro("read_byte", runtime.add((((members.m_req_sample ?? runtime.member("m_req_sample"))) * (2)), 5)))) : ((members.m_fifo_in ?? runtime.member("m_fifo_in"))))) << (((8) + ((members.m_sample_offset_shift ?? runtime.member("m_sample_offset_shift"))))))) >>> 0);
        0;
        members.m_drq = ((1) & 0xff);
        members.m_clocks_left = ((44) | 0);
      ...
      case 7:
      {
        members.m_offset = ((((members.m_offset) | (((((((Number((members.m_mode ?? runtime.member("m_mode"))) === Number(1)) ? 1 : 0)) ? ((__l["read_byte"] ? __l["read_byte"](runtime.add((((members.m_req_sample ?? runtime.member("m_req_sample"))) * (2)), 6)) : runtime.macro("read_byte", runtime.add((((members.m_req_sample ?? runtime.member("m_req_sample"))) * (2)), 6)))) : ((members.m_fifo_in ?? runtime.member("m_fifo_in"))))) << ((members.m_sample_offset_shift ?? runtime.member("m_sample_offset_shift"))))))) >>> 0);
        0;
        members.m_drq = ((1) & 0xff);
      ...
      case 9:
      {
        ...
        members.m_block_header = ((((((Number((members.m_mode ?? runtime.member("m_mode"))) === Number(1)) ? 1 : 0)) ? ((__l["read_byte"] ? __l["read_byte"]((() => { const previous = members.m_offset; members.m_offset = ((((members.m_offset) + (1))) >>> 0); return previous; })()) : runtime.macro("read_byte", (() => { const previous = members.m_offset; members.m_offset = ((((members.m_offset) + (1))) >>> 0); return previous; })()))) : ((members.m_fifo_in ?? runtime.member("m_fifo_in"))))) & 0xff);
        0;
        members.m_drq = ((1) & 0xff);
      ...
      case 10:
      {
        members.m_nibbles_left = ((runtime.add(((((Number((members.m_mode ?? runtime.member("m_mode"))) === Number(1)) ? 1 : 0)) ? ((__l["read_byte"] ? __l["read_byte"]((() => { const previous = members.m_offset; members.m_offset = ((((members.m_offset) + (1))) >>> 0); return previous; })()) : runtime.macro("read_byte", (() => { const previous = members.m_offset; members.m_offset = ((((members.m_offset) + (1))) >>> 0); return previous; })()))) : ((members.m_fifo_in ?? runtime.member("m_fifo_in")))), 1)) & 0xffff);
        0;
        members.m_drq = ((1) & 0xff);
        members.m_clocks_left = ((36) | 0);
        members.m_state = ((11) << 24 >> 24);
      ...
      case 11:
      {
        ...
        method_update_adpcm(runtime, runtime.shiftRight((members.m_adpcm_data ?? runtime.member("m_adpcm_data")), 4));
        members.m_drq = ((1) & 0xff);
  ...
  function method_update_adpcm(runtime: any, data: any): any {
    const members = runtime.members;

    members.m_sample = ((((members.m_sample) + ((__mame_table_0[((((((((members.m_adpcm_state ?? runtime.member("m_adpcm_state"))) * (16))) + (data))) % 256) + 256) % 256] ?? 0)))) << 16 >> 16);
    members.m_adpcm_state = ((((members.m_adpcm_state) + ((__mame_table_1[((data) & 15)] ?? 0)))) << 24 >> 24);
  ...
  function method_internal_md_w(runtime: any, param: any): any {
    const members = runtime.members;

    (typeof (runtime.dereference(members.m_channel)).update === 'function' ? (runtime.dereference(members.m_channel)).update() : typeof (runtime.dereference(members.m_channel)).update === 'number' || typeof (runtime.dereference(members.m_channel)).update === 'boolean' ? (runtime.dereference(members.m_channel)).update : runtime.container(members.m_channel, "update"));
    let old_md: any = (((members.m_md ?? runtime.member("m_md"))) & 0xff);
...
definition.compiledMethodLinks = ["m_drqcallback","read_byte"];
