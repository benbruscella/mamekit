...
definition.compiledMethods = (() => {
  ...
  function method_read(runtime: any): any {
    const members = runtime.members;
  ...
  function method_write(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_sense_r(runtime: any): any {
    const members = runtime.members;
  ...
  function method_motor_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_read_w(runtime: any, state: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_pet_datassette_port_device(runtime: any, mconfig: any, tag: any, owner: any, opts: any, dflt: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_read_handler(runtime: any): any {
    const members = runtime.members;
  ...
  function method_pet_datassette_port_device__pet_datassette_port_device(runtime: any, mconfig: any, tag: any, owner: any, opts: any, dflt: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_pet_datassette_port_device__read_handler(runtime: any): any {
    const members = runtime.members;
...
definition.slot!.options["c2n"]!.compiledMethods = (() => {
  ...
  function method_datassette_read(runtime: any): any {
    const members = runtime.members;

    return ((((Number(((members.m_cassette)?.input?.() ?? 0)) > Number((+0))) ? 1 : 0)) ? (1) : (0));
  }

  function method_datassette_write(runtime: any, state: any): any {
    const members = runtime.members;

    ((members.m_cassette)?.output?.(((state) ? (-11599) : (11599))) ?? 0);
  }

  function method_datassette_sense(runtime: any): any {
    const members = runtime.members;

    return ((Number(((((members.m_cassette)?.get_state?.() ?? 0)) & (3))) === Number(0)) ? 1 : 0);
  }

  function method_datassette_motor(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_device_pet_datassette_port_interface__datassette_read(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_device_pet_datassette_port_interface__datassette_write(runtime: any, state: any): any {
    const members = runtime.members;


  }

  function method_device_pet_datassette_port_interface__datassette_sense(runtime: any): any {
    const members = runtime.members;

    return 1;
  }

  function method_device_pet_datassette_port_interface__datassette_motor(runtime: any, state: any): any {
    const members = runtime.members;


  }

  function method_read_tick(runtime: any, param: any): any {
    const members = runtime.members;
...
definition.slot!.options["c2n"]!.children![0]!.definition.compiledMethods = (() => {
  ...
  function method_update(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let cur_time: any = ((runtime.dereference((__l["machine().time"]?.() ?? 0))).as_double?.() ?? runtime.container((__l["machine().time"]?.() ?? 0), "as_double"));
    if ((((((method_is_stopped(runtime)) ? 0 : 1)) && (method_motor_on(runtime))) ? 1 : 0)) {
      let new_position: any = (((members.m_position ?? runtime.member("m_position"))) + (((((((cur_time) - ((members.m_position_time ?? runtime.member("m_position_time"))))) * ((members.m_speed ?? runtime.member("m_speed"))))) * ((members.m_direction ?? runtime.member("m_direction"))))));
      switch ((((members.m_state ?? runtime.member("m_state"))) & (3))) {
        ...
        case 1:
        {
          if ((members.m_cassette ?? runtime.member("m_cassette"))) {
            ((runtime.dereference(members.m_cassette)).get_sample?.((members.m_channel ?? runtime.member("m_channel")), new_position, 0, ({ generatedPointer: true, target: ({ generatedLValue: true, get: () => (members.m_value ?? runtime.member("m_value")), set: (value: any) => { members.m_value = ((value) | 0); } }), offset: 0 })) ?? 0);
            let length: any = method_get_length(runtime);
  ...
  function method_input(runtime: any): any {
    const members = runtime.members;

    method_update(runtime);
    let value: any = (((members.m_value ?? runtime.member("m_value"))) / (2147483647));
    0;
    return value;
  }

  function method_output(runtime: any, value: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_get_position(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let position: any = (members.m_position ?? runtime.member("m_position"));
    if ((((((method_is_stopped(runtime)) ? 0 : 1)) && (method_motor_on(runtime))) ? 1 : 0)) {
  ...
  function method_set_channel(runtime: any, channel: any): any {
    const members = runtime.members;

    members.m_channel = ((channel) | 0);
  }

  function method_set_speed(runtime: any, speed: any): any {
    const members = runtime.members;

    members.m_speed = speed;
  }

  function method_go_forward(runtime: any): any {
    const members = runtime.members;

    members.m_direction = ((1) | 0);
  }

  function method_go_reverse(runtime: any): any {
    const members = runtime.members;

    members.m_direction = ((-1) | 0);
  }

  function method_seek(runtime: any, time: any, origin: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_get_state(runtime: any): any {
    const members = runtime.members;

    return (members.m_state ?? runtime.member("m_state"));
  }

  function method_is_playing(runtime: any): any {
    const members = runtime.members;

    return ((Number((((members.m_state ?? runtime.member("m_state"))) & (3))) === Number(1)) ? 1 : 0);
  }

  function method_is_recording(runtime: any): any {
    const members = runtime.members;

    return ((Number((((members.m_state ?? runtime.member("m_state"))) & (3))) === Number(2)) ? 1 : 0);
  }

  function method_set_motor(runtime: any, state: any): any {
    const members = runtime.members;

    method_change_state(runtime, ((state) ? (0) : (4)), 4);
  }

  function method_set_speaker(runtime: any, state: any): any {
    const members = runtime.members;

    method_change_state(runtime, ((state) ? (0) : (8)), 8);
  }

  function method_speaker_on(runtime: any): any {
    const members = runtime.members;

    return ((Number((((members.m_state ?? runtime.member("m_state"))) & (8))) === Number(0)) ? 1 : 0);
  }

  function method_mount_image(runtime: any, image: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
...
definition.slot!.options["c2n"]!.children![0]!.definition.imageFormats![0]!.definition.compiledMethods = (() => {
  ...
  function method_tap_data_to_samplecount(runtime: any, data: any, frequency: any): any {
    const members = runtime.members;

    return ((((0.5) * (((((44100) / (frequency))) * (((data) + (0.5))))))) | 0);
  }

  function method_toggle_wave_data(runtime: any): any {
    const members = runtime.members;

    members.wave_data = ((((((Number((members.wave_data ?? runtime.member("wave_data"))) === Number(11599)) ? 1 : 0)) ? (-11599) : (11599))) << 16 >> 16);
  }

  function method_cbm_output_wave(runtime: any, buffer: any, length: any): any {
    const members = runtime.members;
  ...
  function method_cbm_tap_do_work(runtime: any, buffer: any, length: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    let version: any = ((0) | 0);
    let system: any = ((0) | 0);
    let video_standard: any = ((0) | 0);
    let tap_frequency: any = ((0) | 0);
    let byte_samples: any = ((0) | 0);
    let over_pulse_bytes: any = [0, 0, 0];
    let over_pulse_length: any = ((0) | 0);
    ...
    for (i = ((20) | 0); ((Number(i) < Number(length)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      let byte: any = ((runtime.readIndex(data, i)) & 0xff);
      if (((version) ? 0 : 1)) {
          ...
          if (((Number(((((length) - (i))) + (j))) >= Number(4)) ? 1 : 0)) {
            if (((Number(j) > Number(0)) ? 1 : 0)) {
              ...
              if (((Number(j) >= Number(4)) ? 1 : 0)) {
                over_pulse_length = ((runtime.shiftRight((__l["get_u24le"] ? __l["get_u24le"](over_pulse_bytes) : runtime.macro("get_u24le", over_pulse_bytes)), 3)) | 0);
  ...
  function method_cbm_tap_to_wav_size(runtime: any, tapdata: any, taplen: any): any {
    const members = runtime.members;

    let size: any = ((method_cbm_tap_do_work(runtime, 0, taplen, tapdata)) | 0);
