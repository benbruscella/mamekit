...
const GENERATED_METHOD_NAMES = new Set(["do_adc", "do_adc_d", "do_adc_nd", "do_arr", "do_arr_d", "do_arr_nd", "do_sbc", "do_sbc_d", "do_sbc_nd", "do_cmp", "do_bit", "do_asl", "do_lsr", "do_ror", "do_rol", "do_asr", "set_nz", "set_l", "set_h", "page_changing", "dec_SP", "inc_SP"]);
class GeneratedM6507 {
    bus;
    irqData = 0xff;
    irqHold = false;
    ...
    reset() {
        this.resetInternal();
        (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff);
        (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff);
        (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
        this.method_dec_SP();
        (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
        this.method_dec_SP();
        (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
        ...
        this.m_PC = (((++this.cycles, this.readMemory((65532) & 8191) & 0xff)) & 0xffff);
        this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65533) & 8191) & 0xff))) & 0xffff);
    }
    step() {
        this.cycles = 0;
        this.m_icount = 1;
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('M6507 dispatch loop exceeded 8');
            switch ((this.m_ref >>> 8) & 0xffff) {
                case 0x0000: {
                    ...
                    (++this.cycles, this.writeMemory((this.m_SP) & 8191, (((this.m_PC) >>> (8))) & 0xff), 0);
                    this.method_dec_SP();
                    (++this.cycles, this.writeMemory((this.m_SP) & 8191, (this.m_PC) & 0xff), 0);
                    this.method_dec_SP();
                    (++this.cycles, this.writeMemory((this.m_SP) & 8191, (((this.m_irq_taken) ? (((this.m_P) & ((~16)))) : (this.m_P))) & 0xff), 0);
                    this.method_dec_SP();
                    if (this.m_nmi_pending) {
                        this.acknowledgeIrq(-1);
                        this.m_PC = (((++this.cycles, this.readMemory((65530) & 8191) & 0xff)) & 0xffff);
                        this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65531) & 8191) & 0xff))) & 0xffff);
                        ...
                        this.m_PC = (((++this.cycles, this.readMemory((65534) & 8191) & 0xff)) & 0xffff);
                        this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((65535) & 8191) & 0xff))) & 0xffff);
                    }
                ...
                case 0x0100: {
                    this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP2) & 8191) & 0xff);
                    this.m_TMP2 = ((((this.m_TMP2) + (this.m_X))) & 0xff);
                    this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 8191) & 0xff)) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff);
                    this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0x0200: {
                    (++this.cycles, this.readMemory((65535) & 8191) & 0xff);
                ...
                case 0x0300: {
                    ...
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff);
                    (++this.cycles, this.writeMemory((this.m_TMP) & 8191, (this.m_TMP2) & 0xff), 0);
                ...
                case 0x0400: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    return this.cycles;
                }
                case 0x0500: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x0800: {
                    (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((this.m_SP) & 8191, (this.m_P) & 0xff), 0);
                    this.method_dec_SP();
                    return this.cycles;
                }
                case 0x0900: {
                ...
                case 0x0c00: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff))) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    return this.cycles;
                }
                ...
                case 0x1000: {
                    ...
                    if (((((this.m_P) & (128))) ? 0 : 1)) {
                        ...
                        if (this.method_page_changing(this.m_PC, (((this.m_TMP) << 24) >> 24))) {
                            (++this.cycles, this.readMemory((this.method_set_l(this.m_PC, ((this.m_PC) + ((((this.m_TMP) << 24) >> 24))))) & 8191) & 0xff);
                        }
                ...
                case 0x1100: {
                    this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_TMP2) & 8191) & 0xff)) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    if (this.method_page_changing(this.m_TMP, this.m_Y)) {
                        (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y)))) & 8191) & 0xff);
                    }
                    this.m_TMP2 = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 8191) & 0xff)) & 0xff);
                    this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                ...
                case 0x1400: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    (++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191) & 0xff);
                    return this.cycles;
                }
                case 0x1500: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    this.m_TMP2 = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191) & 0xff)) & 0xff);
                    this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                ...
                case 0x1c00: {
                    ...
                    if (this.method_page_changing(this.m_TMP, this.m_X)) {
                        (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X)))) & 8191) & 0xff);
                    }
                    (++this.cycles, this.readMemory((((this.m_TMP) + (this.m_X))) & 8191) & 0xff);
                    return this.cycles;
                }
                case 0x1d00: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x2800: {
                    ...
                    (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
                    this.method_inc_SP();
                    this.m_TMP = (((((++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff)) | (((16) | (32))))) & 0xffff);
                ...
                case 0x4000: {
                    ...
                    (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
                    this.method_inc_SP();
                    this.m_P = (((((++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff)) | (((16) | (32))))) & 0xff);
                    this.method_inc_SP();
                    this.m_PC = (((++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff)) & 0xffff);
                    this.method_inc_SP();
                    this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff))) & 0xffff);
                    return this.cycles;
                }
                case 0x4100: {
                    this.m_TMP2 = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                ...
                case 0x4800: {
                    (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((this.m_SP) & 8191, (this.m_A) & 0xff), 0);
                    this.method_dec_SP();
                    return this.cycles;
                }
                case 0x4900: {
                ...
                case 0x6800: {
                    ...
                    (++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff);
                    this.method_inc_SP();
                    this.m_A = (((++this.cycles, this.readMemory((this.m_SP) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0x6900: {
                ...
                case 0x6c00: {
                    ...
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff))) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.m_PC = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((this.method_set_h(this.m_PC, (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (1)))) & 8191) & 0xff))) & 0xffff);
                    return this.cycles;
                }
                case 0x6d00: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x8100: {
                    ...
                    this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 8191) & 0xff)) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    (++this.cycles, this.writeMemory((this.m_TMP) & 8191, (this.m_A) & 0xff), 0);
                    return this.cycles;
                }
                case 0x8200: {
                    (++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff);
                ...
                case 0x8400: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.writeMemory((this.m_TMP) & 8191, (this.m_Y) & 0xff), 0);
                    return this.cycles;
                }
                case 0x8500: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x8600: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.writeMemory((this.m_TMP) & 8191, (this.m_X) & 0xff), 0);
                    return this.cycles;
                }
                case 0x8700: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x9100: {
                    ...
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y)))) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((((this.m_TMP) + (this.m_Y))) & 8191, (this.m_A) & 0xff), 0);
                    return this.cycles;
                }
                case 0x9200: {
                    (++this.cycles, this.readMemory((65535) & 8191) & 0xff);
                ...
                case 0x9400: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191, (this.m_Y) & 0xff), 0);
                    return this.cycles;
                }
                case 0x9500: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191, (this.m_A) & 0xff), 0);
                    return this.cycles;
                }
                case 0x9600: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((((((this.m_TMP) + (this.m_Y))) & 0xff)) & 8191, (this.m_X) & 0xff), 0);
                    return this.cycles;
                }
                case 0x9700: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0x9d00: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X)))) & 8191) & 0xff);
                    (++this.cycles, this.writeMemory((((this.m_TMP) + (this.m_X))) & 8191, (this.m_A) & 0xff), 0);
                    return this.cycles;
                }
                case 0x9e00: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                ...
                case 0xa000: {
                    this.m_Y = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.method_set_nz(this.m_Y);
                    return this.cycles;
                }
                case 0xa100: {
                    ...
                    this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 8191) & 0xff)) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    this.m_A = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xa200: {
                    this.m_X = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                ...
                case 0xa300: {
                    ...
                    this.m_TMP = (((++this.cycles, this.readMemory((((this.m_TMP2) & (255))) & 8191) & 0xff)) & 0xffff);
                    this.m_TMP = ((this.method_set_h(this.m_TMP, (++this.cycles, this.readMemory((((((this.m_TMP2) + (1))) & (255))) & 8191) & 0xff))) & 0xffff);
                    this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff))) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xa400: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.m_Y = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_Y);
                    return this.cycles;
                }
                case 0xa500: {
                ...
                case 0xa600: {
                    this.m_TMP = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xffff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.m_X = (((++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_X);
                    return this.cycles;
                }
                case 0xa700: {
                ...
                case 0xa900: {
                    this.m_A = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                ...
                case 0xab00: {
                    this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((this.m_PC) & 8191) & 0xff)) & 0xff))) & 0xff);
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                ...
                case 0xb100: {
                    ...
                    this.m_A = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xb200: {
                ...
                case 0xb300: {
                    ...
                    this.m_A = (((this.m_X = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 8191) & 0xff)) & 0xff))) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xb400: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    this.m_Y = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_Y);
                    return this.cycles;
                }
                case 0xb500: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    this.m_A = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_X))) & 0xff)) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xb600: {
                    ...
                    this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
                    (++this.cycles, this.readMemory((this.m_TMP) & 8191) & 0xff);
                    this.m_X = (((++this.cycles, this.readMemory((((((this.m_TMP) + (this.m_Y))) & 0xff)) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_X);
                    return this.cycles;
                }
                case 0xb700: {
                ...
                case 0xbd00: {
                    ...
                    this.m_A = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_X))) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_A);
                    return this.cycles;
                }
                case 0xbe00: {
                    ...
                    this.m_X = (((++this.cycles, this.readMemory((((this.m_TMP) + (this.m_Y))) & 8191) & 0xff)) & 0xff);
                    this.method_set_nz(this.m_X);
                    return this.cycles;
                }
                case 0xbf00: {
                ...
                default:
                    throw new Error('M6507 has no generated opcode ' +
    ...
    invoke(name, ...args) {
        switch (name) {
            ...
            default: throw new Error('M6507 has no generated method "' + name + '"');
        }
    }
    generatedStart() {
        this.m_PPC = ((0) & 0xffff);
...
export const cpu = {
    ...
    create: (bus) => new GeneratedM6507(bus),
};
export default cpu;
