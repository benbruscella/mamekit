...
class GeneratedKONAMI {
    ...
    m_cc = ((0) & 0xff);
    m_opcode = ((0) & 0xff);
    m_addressing_mode = ((0) & 0xff);
    m_reg8 = ((0) & 0xff);
    m_reg16 = ((0) & 0xff);
    m_cond = ((0) & 0xff);
    m_nmi_line = ((0) & 0xff);
    m_nmi_asserted = ((0) & 0xff);
    m_firq_line = ((0) & 0xff);
    m_irq_line = ((0) & 0xff);
    m_lds_encountered = ((0) & 0xff);
    m_free_run = ((0) & 0xff);
    m_bcount = ((0) & 0xff);
    m_sync_wait = ((0) & 0xff);
    m_cwai_wait = ((0) & 0xff);
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('KONAMI dispatch loop exceeded 8');
    ...
    set(name, value) {
        switch (name) {
            ...
            case "m_temp.w":
                ...
                return;
            case "m_temp.b.h":
                this.m_temp.b.h = value;
                return;
            case "m_temp.b.l":
                this.m_temp.b.l = value;
                return;
            case "m_ea":
            case "m_ea.w":
                this.m_ea.w = value;
            ...
            case "m_ea.b.l":
                ...
                return;
            case "m_dp":
                this.m_dp = ((value) & 0xff);
                return;
            case "m_cc":
                this.m_cc = ((value) & 0xff);
                return;
            case "m_opcode":
                this.m_opcode = ((value) & 0xff);
                return;
            case "m_addressing_mode":
                this.m_addressing_mode = ((value) & 0xff);
                return;
            case "m_reg8":
                this.m_reg8 = ((value) & 0xff);
                return;
            case "m_reg16":
                this.m_reg16 = ((value) & 0xff);
                return;
            case "m_cond":
                this.m_cond = ((value) & 0xff);
                return;
            case "m_nmi_line":
                this.m_nmi_line = ((value) & 0xff);
                return;
            case "m_nmi_asserted":
                this.m_nmi_asserted = ((value) & 0xff);
                return;
            case "m_firq_line":
                this.m_firq_line = ((value) & 0xff);
                return;
            case "m_irq_line":
                this.m_irq_line = ((value) & 0xff);
                return;
            case "m_lds_encountered":
                this.m_lds_encountered = ((value) & 0xff);
                return;
            case "m_free_run":
                this.m_free_run = ((value) & 0xff);
                return;
            case "m_bcount":
                this.m_bcount = ((value) & 0xff);
                return;
            case "m_sync_wait":
                this.m_sync_wait = ((value) & 0xff);
                return;
            case "m_cwai_wait":
                this.m_cwai_wait = ((value) & 0xff);
                return;
            case "m_halt":
    ...
    method_read_tfr_exg_816_register(reg = 0) {
        let result = 0;
        switch (((reg) & (15))) {
            case 0:
                {
    ...
    method_read_exg_168_register(reg = 0) {
        let result = 0;
        switch (((reg) & (15))) {
            case 0:
                {
    ...
    method_write_exgtfr_register(reg = 0, value = 0) {
        switch (((reg) & (7))) {
            case 0:
                {
    ...
    method_read_operand1(ordinal = 0) {
        switch (this.m_addressing_mode) {
            case 1:
                {
    ...
    method_write_operand1(ordinal = 0, data = 0) {
        switch (this.m_addressing_mode) {
            case 0:
                {
                    break;
    ...
    method_set_ea_h(ea_h = 0) {
        this.m_ea.b.h = ((ea_h) & 0xff);
        return 0;
    }
    method_set_ea_l(ea_l = 0) {
    ...
    method_firq_saves_entire_state() {
        return 0;
        return 0;
    }
    method_partial_state_registers() {
        return 129;
        return 0;
    }
    method_entire_state_registers() {
        return 255;
        return 0;
    }
    method_is_ea_addressing_mode() {
        return ((Number(this.m_addressing_mode) === Number(1)) ? 1 : 0);
        return 0;
    }
    method_eat_remaining() {
        this.cycles = ((this.cycles) + (this.m_icount));
        return 0;
    }
    method_is_register_addressing_mode() {
        return (((((Number(this.m_addressing_mode) !== Number(0)) ? 1 : 0)) && (((Number(this.m_addressing_mode) !== Number(1)) ? 1 : 0))) ? 1 : 0);
        return 0;
    }
    method_get_pending_interrupt() {
        if (this.m_nmi_asserted) {
            return 65532;
        }
        else {
    ...
    method_set_flags8(mask = 0, a = 0, b = 0, r = 0) {
    ...
    method_set_flags8r(mask = 0, r = 0) {
        return this.method_set_flags8(mask, ((0) & 0xff), r, r);
        return 0;
    }
    method_set_flags16(mask = 0, a = 0, b = 0, r = 0) {
    ...
    method_set_flags16r(mask = 0, r = 0) {
        return this.method_set_flags16(mask, ((0) & 0xffff), r, r);
        return 0;
    }
    method_rotate_right8(value = 0) {
    ...
    method_read_exgtfr_register(reg = 0) {
        let result = ((0) & 0xffff);
        switch (((reg) & (7))) {
            case 0:
                {
...
export const cpu = {
    ...
    create: (bus) => new GeneratedKONAMI(bus),
};
export default cpu;
