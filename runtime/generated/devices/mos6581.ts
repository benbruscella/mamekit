...
definition.compiledMethods = (() => {
  ...
  function method_syncEm(runtime: any): any {
    const members = runtime.members;

    let sync: any = new Uint8Array(Math.max(0, Number(3)));
    for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
      runtime.writeIndex(sync, v, ((Number(runtime.dereference((members.optr ?? runtime.member("optr"))[v].modulator).cycleLenCount) <= Number(0)) ? 1 : 0));
      (members.optr ?? runtime.member("optr"))[v].cycleLenCount = (((((members.optr ?? runtime.member("optr"))[v].cycleLenCount) - (1))) | 0);
    }
    for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
      if (((((members.optr ?? runtime.member("optr"))[v].sync) && (runtime.readIndex(sync, v))) ? 1 : 0)) {
        (members.optr ?? runtime.member("optr"))[v].cycleLenCount = ((0) | 0);
        (members.optr ?? runtime.member("optr"))[v].outProc = method_sidOperator_wave_calc_normal.bind(undefined, runtime);
        (members.optr ?? runtime.member("optr"))[v].waveStep = ((((members.optr ?? runtime.member("optr"))[v].waveStepPnt = ((0) >>> 0))) & 0xffff);
      }
    }
  }

  function method_fill_buffer(runtime: any, stream: any): any {
    const members = runtime.members;
    ...
    for (let sampindex: any = ((0) | 0); ((Number(sampindex) < Number((typeof (runtime.dereference(stream)).samples === 'function' ? (runtime.dereference(stream)).samples() : typeof (runtime.dereference(stream)).samples === 'number' || typeof (runtime.dereference(stream)).samples === 'boolean' ? (runtime.dereference(stream)).samples : runtime.container(stream, "samples")))) ? 1 : 0); sampindex = ((((sampindex) + (1))) | 0)) {
      ((runtime.dereference(stream)).put?.(0, sampindex, method_mix_mono(runtime, runtime.add(runtime.add(runtime.add(runtime.dereference((members.optr ?? runtime.member("optr"))[0].outProc)(runtime.addressOf((members.optr ?? runtime.member("optr")), 0)), runtime.dereference((members.optr ?? runtime.member("optr"))[1].outProc)(runtime.addressOf((members.optr ?? runtime.member("optr")), 1))), ((runtime.dereference((members.optr ?? runtime.member("optr"))[2].outProc)(runtime.addressOf((members.optr ?? runtime.member("optr")), 2))) & ((members.optr3_outputmask ?? runtime.member("optr3_outputmask"))))), (((members.masterVolume ?? runtime.member("masterVolume"))) << (2))))) ?? 0);
      method_syncEm(runtime);
    }
  }

  function method_mix_mono(runtime: any, usum: any): any {
    const members = runtime.members;

    return ((((((usum) - (512))) << 16 >> 16)) * (((1) / (1024))));
  }

  function method_reset(runtime: any): any {
    const members = runtime.members;

    const h_filter = members.filter ?? runtime.member("filter");
    for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
      method_sidOperator_clear(runtime, runtime.addressOf((members.optr ?? runtime.member("optr")), v));
      method_enveEmuResetOperator(runtime, runtime.addressOf((members.optr ?? runtime.member("optr")), v));
    }
    ...
    for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
      method_sidOperator_set(runtime, runtime.addressOf((members.optr ?? runtime.member("optr")), v));
      method_sidOperator_set2(runtime, runtime.addressOf((members.optr ?? runtime.member("optr")), v));
    }
    return 1;
  }

  function method_sidOperator_clear(runtime: any, voice: any): any {
    const members = runtime.members;
  ...
  function method_enveEmuResetOperator(runtime: any, pVoice: any): any {
    const members = runtime.members;
  ...
  function method_sidOperator_set(runtime: any, voice: any): any {
    const members = runtime.members;
    const __pointee_voice = runtime.dereference(voice);
    ...
    let oldWave: any = ((__pointee_voice.SIDctrl) & 0xff);
    let newWave: any = ((((__pointee_voice.reg[4]) | (((__pointee_voice.reg[5]) << (8))))) & 0xff);
    let enveTemp: any = ((__pointee_voice.ADSRctrl) & 0xff);
    ...
    let ADtemp: any = ((__pointee_voice.reg[5]) & 0xff);
    let SRtemp: any = ((__pointee_voice.reg[6]) & 0xff);
    ...
    let tmpSusVol: any = ((h_masterVolumeLevels[runtime.shiftRight(SRtemp, 4)]) & 0xff);
    ...
    __pointee_voice.ADSRproc = (members.enveModeTable ?? runtime.member("enveModeTable"))[runtime.shiftRight(enveTemp, 1)];
  ...
  function method_sidOperator_set2(runtime: any, voice: any): any {
    const members = runtime.members;
    const __pointee_voice = runtime.dereference(voice);
    ...
    if ((((((Number(__pointee_voice.SIDfreq) < Number(16)) ? 1 : 0)) || (((__pointee_voice.SIDctrl) & (8)))) ? 1 : 0)) {
      ...
      if ((((((__pointee_voice.SIDctrl) & (128))) && (((Number(__pointee_voice.curNoiseFreq) !== Number(__pointee_voice.SIDfreq)) ? 1 : 0))) ? 1 : 0)) {
        ...
        __pointee_voice.noiseStepAdd = ((runtime.shiftRight(((runtime.dereference(__pointee_voice.sid).PCMsidNoise) * (__pointee_voice.SIDfreq)), 8)) >>> 0);
      ...
      if ((((((Number(((__pointee_voice.SIDctrl) & (20))) === Number(20)) ? 1 : 0)) && (runtime.dereference(__pointee_voice.modulator).SIDfreq)) ? 1 : 0)) {
        __pointee_voice.waveProc = (members.sidModeRingTable ?? runtime.member("sidModeRingTable"))[runtime.shiftRight(__pointee_voice.SIDctrl, 4)];
      } else {
        __pointee_voice.waveProc = (members.sidModeNormalTable ?? runtime.member("sidModeNormalTable"))[runtime.shiftRight(__pointee_voice.SIDctrl, 4)];
      }
    }
  }

  function method_sidOperator_wave_calc_cycle_len(runtime: any, voice: any): any {
    const members = runtime.members;
    const __pointee_voice = runtime.dereference(voice);
    ...
    let diff: any = ((((__pointee_voice.cycleLenCount) - (__pointee_voice.cycleLen))) & 0xffff);
  ...
  function method_postload(runtime: any): any {
    const members = runtime.members;
  ...
  function method_init(runtime: any): any {
    const members = runtime.members;

    const h_filter = members.filter ?? runtime.member("filter");
    for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
      (members.optr ?? runtime.member("optr"))[v].sid = (members.this ?? runtime.member("this"));
      let mod_voi: any = ((((((((v) + (3))) - (1))) % (3))) & 0xff);
      (members.optr ?? runtime.member("optr"))[v].modulator = runtime.addressOf((members.optr ?? runtime.member("optr")), mod_voi);
      (members.optr ?? runtime.member("optr"))[mod_voi].carrier = runtime.addressOf((members.optr ?? runtime.member("optr")), v);
      (members.optr ?? runtime.member("optr"))[v].filtVoiceMask = ((((1) << (v))) << 24 >> 24);
    }
  ...
  function method_sidInitMixerEngine(runtime: any, machine: any): any {
    const members = runtime.members;

    let filterAmpl: any = 0.7;
    let uk: any = ((0) & 0xffff);
    for (let si: any = ((0) | 0); ((Number(si) < Number(256)) ? 1 : 0); si = ((((si) + (1))) | 0)) {
      for (let sj: any = ((-128) | 0); ((Number(sj) < Number(128)) ? 1 : 0); sj = ((((sj) + (1))) | 0), uk = ((((uk) + (1))) & 0xffff)) {
        (members.ampMod1x8 ?? runtime.member("ampMod1x8"))[uk] = ((((runtime.divide(((si) * (sj)), 255)) * (filterAmpl))) << 24 >> 24);
      }
    }
  }

  function method_filterTableInit(runtime: any, machine: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let sample_rate: any = (((typeof (runtime.dereference(machine)).sample_rate === 'function' ? (runtime.dereference(machine)).sample_rate() : typeof (runtime.dereference(machine)).sample_rate === 'number' || typeof (runtime.dereference(machine)).sample_rate === 'boolean' ? (runtime.dereference(machine)).sample_rate : runtime.container(machine, "sample_rate"))) | 0);
    let uk: any = ((0) & 0xffff);
    let filterRefFreq: any = 44100;
    let yMax: any = 1;
    let yMin: any = 0.01;
    let yAdd: any = 0;
    let yTmp: any = 0;
  ...
  function method_sidInitWaveformTables(runtime: any, type: any): any {
    const members = runtime.members;
    ...
    for (ni = ((0) >>> 0); ((Number(ni) < Number(256)) ? 1 : 0); ni = ((((ni) + (1))) >>> 0)) {
      (members.noiseTableLSB ?? runtime.member("noiseTableLSB"))[ni] = ((((((((runtime.shiftRight(ni, 5)) & (4))) | (((runtime.shiftRight(ni, 3)) & (2))))) | (((runtime.shiftRight(ni, 2)) & (1))))) & 0xff);
    }
    for (ni = ((0) >>> 0); ((Number(ni) < Number(256)) ? 1 : 0); ni = ((((ni) + (1))) >>> 0)) {
      (members.noiseTableMID ?? runtime.member("noiseTableMID"))[ni] = ((((((runtime.shiftRight(ni, 1)) & (16))) | (((((ni) << (0))) & (8))))) & 0xff);
    }
    for (ni = ((0) >>> 0); ((Number(ni) < Number(256)) ? 1 : 0); ni = ((((ni) + (1))) >>> 0)) {
  ...
  function method_enveEmuInit(runtime: any, updateFreq: any, measuredValues: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    for (i = ((0) >>> 0); ((Number(i) < Number(16)) ? 1 : 0); i = ((((i) + (1))) >>> 0)) {
      let scaledenvelen: any = ((((runtime.divide(((h_attackTimes[i]) * (updateFreq)), 1000)) >>> 0)) >>> 0);
  ...
  function method_port_w(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    ...
    switch (offset) {
      ...
      case 24:
      {
        ...
        if (((((((members.reg ?? runtime.member("reg"))[24]) & (128))) && ((((((members.reg ?? runtime.member("reg"))[23]) & ((members.optr ?? runtime.member("optr"))[2].filtVoiceMask))) ? 0 : 1))) ? 1 : 0)) {
        ...
        if (((Number(h_filter.Type) !== Number(h_filter.CurType)) ? 1 : 0)) {
          ...
          for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
            (members.optr ?? runtime.member("optr"))[v].filtLow = ((members.optr ?? runtime.member("optr"))[v].filtRef = 0);
          }
        }
        if (h_filter.Enabled) {
          ...
          h_filter.ResDy = (((members.filterResTable ?? runtime.member("filterResTable"))[runtime.shiftRight((members.reg ?? runtime.member("reg"))[23], 4)]) - (h_filter.Dy));
      ...
      default:
      {
        ...
        if (((Number(offset) < Number(7)) ? 1 : 0)) {
          (members.optr ?? runtime.member("optr"))[0].reg[offset] = data;
        } else {
          if (((Number(offset) < Number(14)) ? 1 : 0)) {
            (members.optr ?? runtime.member("optr"))[1].reg[((offset) - (7))] = data;
          } else {
            if (((Number(offset) < Number(21)) ? 1 : 0)) {
              (members.optr ?? runtime.member("optr"))[2].reg[((offset) - (14))] = data;
            }
          }
        }
        for (let v: any = ((0) | 0); ((Number(v) < Number(3)) ? 1 : 0); v = ((((v) + (1))) | 0)) {
  ...
  function method_port_r(runtime: any, machine: any, offset: any): any {
    const members = runtime.members;
    ...
    switch (offset) {
      ...
      {
        (typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'function' ? (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update() : typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'number' || typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'boolean' ? (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update : runtime.container((members.mixer_channel ?? runtime.member("mixer_channel")), "update"));
        data = (((members.optr ?? runtime.member("optr"))[2].output) | 0);
        break;
      }
      case 28:
      {
        (typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'function' ? (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update() : typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'number' || typeof (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update === 'boolean' ? (runtime.dereference((members.mixer_channel ?? runtime.member("mixer_channel")))).update : runtime.container((members.mixer_channel ?? runtime.member("mixer_channel")), "update"));
        data = (((members.optr ?? runtime.member("optr"))[2].enveVol) | 0);
        break;
      }
      default:
      {
  ...
  function method_sidOperator_wave_calc_normal(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_waveCalcFilter(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
            ...
            if (((Number(runtime.dereference(__pointee_pVoice.sid).filter.Type) === Number(16)) ? 1 : 0)) {
              ...
              if (((Number(runtime.dereference(__pointee_pVoice.sid).filter.Type) === Number(48)) ? 1 : 0)) {
                ...
                if (((Number(runtime.dereference(__pointee_pVoice.sid).filter.Type) === Number(80)) ? 1 : 0)) {
                  __pointee_pVoice.filtIO = ((((((sample) - (runtime.shiftRight(tmp, 1)))) << 24 >> 24)) << 24 >> 24);
                } else {
  ...
  function method_waveAdvance(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_noiseAdvance(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    ...
    if (((Number(__pointee_pVoice.noiseStep) >= Number(1048576)) ? 1 : 0)) {
      ...
      __pointee_pVoice.noiseReg = ((((((__pointee_pVoice.noiseReg) << (1))) | (((((runtime.shiftRight(__pointee_pVoice.noiseReg, 22)) ^ (runtime.shiftRight(__pointee_pVoice.noiseReg, 17)))) & (1))))) >>> 0);
      __pointee_pVoice.noiseOutput = (((((((members.noiseTableLSB ?? runtime.member("noiseTableLSB"))[((__pointee_pVoice.noiseReg) & (255))]) | ((members.noiseTableMID ?? runtime.member("noiseTableMID"))[((runtime.shiftRight(__pointee_pVoice.noiseReg, 8)) & (255))]))) | ((members.noiseTableMSB ?? runtime.member("noiseTableMSB"))[((runtime.shiftRight(__pointee_pVoice.noiseReg, 16)) & (255))]))) & 0xff);
    }
  }

  function method_noiseAdvanceHp(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let tmp: any = ((__pointee_pVoice.noiseStepAdd) >>> 0);
  ...
  function method_sidMode00(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode10(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode20(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode30(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode40(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode50(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode60(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode70(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode80(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode80hp(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    __pointee_pVoice.output = ((__pointee_pVoice.noiseOutput) & 0xff);
    method_waveAdvance(runtime, pVoice);
  ...
  function method_sidModeLock(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode14(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_sidMode34(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    if (((Number(runtime.dereference(__pointee_pVoice.modulator).waveStep) < Number(2048)) ? 1 : 0)) {
      __pointee_pVoice.output = ((runtime.readIndex((members.waveform30 ?? runtime.member("waveform30")), __pointee_pVoice.waveStep)) & 0xff);
  ...
  function method_sidMode54(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    if (((Number(runtime.dereference(__pointee_pVoice.modulator).waveStep) < Number(2048)) ? 1 : 0)) {
      __pointee_pVoice.output = ((runtime.readIndex((members.waveform50 ?? runtime.member("waveform50")), ((__pointee_pVoice.waveStep) + (__pointee_pVoice.SIDpulseWidth)))) & 0xff);
  ...
  function method_sidMode74(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    if (((Number(runtime.dereference(__pointee_pVoice.modulator).waveStep) < Number(2048)) ? 1 : 0)) {
      __pointee_pVoice.output = ((runtime.readIndex((members.waveform70 ?? runtime.member("waveform70")), ((__pointee_pVoice.waveStep) + (__pointee_pVoice.SIDpulseWidth)))) & 0xff);
  ...
  function method_waveCalcMute(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_waveCalcRangeCheck(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuEnveAdvance(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuMute(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    return 0;
  }

  function method_enveEmuRelease(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    const h_releaseTab = members.releaseTab ?? runtime.member("releaseTab");
  ...
  function method_enveEmuAlterRelease(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let release: any = ((((__pointee_pVoice.SIDSR) & (15))) & 0xff);
  ...
  function method_enveEmuStartRelease(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuSustain(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    return (members.masterAmplModTable ?? runtime.member("masterAmplModTable"))[((runtime.dereference(__pointee_pVoice.sid).masterVolumeAmplIndex) + (__pointee_pVoice.enveVol))];
  }

  function method_enveEmuSustainDecay(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    const h_releaseTab = members.releaseTab ?? runtime.member("releaseTab");
    if (((Number(__pointee_pVoice.enveStep) >= Number((members.releaseTabLen ?? runtime.member("releaseTabLen")))) ? 1 : 0)) {
  ...
  function method_enveEmuAlterSustain(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    if (((Number(__pointee_pVoice.enveVol) > Number(__pointee_pVoice.enveSusVol)) ? 1 : 0)) {
  ...
  function method_enveEmuAlterSustainDecay(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let decay: any = ((((__pointee_pVoice.SIDAD) & (15))) & 0xff);
  ...
  function method_enveEmuDecay(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    const h_releaseTab = members.releaseTab ?? runtime.member("releaseTab");
    if (((Number(__pointee_pVoice.enveStep) >= Number((members.releaseTabLen ?? runtime.member("releaseTabLen")))) ? 1 : 0)) {
  ...
  function method_enveEmuAlterDecay(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let decay: any = ((((__pointee_pVoice.SIDAD) & (15))) & 0xff);
    __pointee_pVoice.enveStepAdd = (((members.decayReleaseRates ?? runtime.member("decayReleaseRates"))[decay]) & 0xffff);
  ...
  function method_enveEmuStartDecay(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuAlterAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let attack: any = ((runtime.shiftRight(__pointee_pVoice.SIDAD, 4)) & 0xff);
  ...
  function method_enveEmuStartAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuShortAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
  ...
  function method_enveEmuAlterShortAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
    let attack: any = ((runtime.shiftRight(__pointee_pVoice.SIDAD, 4)) & 0xff);
    __pointee_pVoice.enveStepAdd = (((members.attackRates ?? runtime.member("attackRates"))[attack]) & 0xffff);
  ...
  function method_enveEmuStartShortAttack(runtime: any, pVoice: any): any {
    const members = runtime.members;
    const __pointee_pVoice = runtime.dereference(pVoice);
