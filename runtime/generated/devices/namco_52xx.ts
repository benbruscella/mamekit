...
definition.compiledMethods = (() => {
  ...
  function method_SI_r(runtime: any) {
    const members = runtime.members;
    return ((runtime.invoke("m_si", 0)) ? (1) : (0));
  }

  function method_R0_r(runtime: any) {
    const members = runtime.members;
    return ((runtime.invoke("m_romread", (members.m_address ?? runtime.member("m_address")))) & (15));
  }

  function method_R1_r(runtime: any) {
    const members = runtime.members;
    return ((runtime.invoke("m_romread", (members.m_address ?? runtime.member("m_address")))) >>> (4));
  }

  function method_P_w(runtime: any, data: any) {
    const members = runtime.members;
    ((runtime.dereference(members.m_discrete)).write?.((runtime.calls["NAMCO_52XX_P_DATA"] ? runtime.calls["NAMCO_52XX_P_DATA"]((members.m_basenode ?? runtime.member("m_basenode"))) : runtime.macro("NAMCO_52XX_P_DATA", (members.m_basenode ?? runtime.member("m_basenode")))), ((data) & (15))) ?? 0);
  }

  function method_R2_w(runtime: any, data: any) {
    const members = runtime.members;
    members.m_address = (((((((members.m_address ?? runtime.member("m_address"))) & (65520))) | (((((data) & (15))) << (0))))) >>> 0);
  }

  function method_R3_w(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_external_clock_pulse(runtime: any, param: any) {
    const members = runtime.members;
    ((runtime.dereference(members.m_cpu)).pulse_input_line?.(1, 0) ?? 0);
  }
  return {
    "K_r": method_K_r,
    "SI_r": method_SI_r,
...
definition.children![0]!.definition.compiledMethods = (() => {
  function method_burn_cycles(runtime: any, cycles: any) {
    const members = runtime.members;
    ...
    if (((((((members.m_in_irq ?? runtime.member("m_in_irq"))) ? 0 : 1)) && ((((members.m_pending_irq ?? runtime.member("m_pending_irq"))) & ((members.m_pio ?? runtime.member("m_pio")))))) ? 1 : 0)) {
      ...
      let intpc: any = (((runtime.calls["GETPC"] ? runtime.calls["GETPC"]() : runtime.macro("GETPC"))) & 0xffff);
  ...
  function method_increment_timer(runtime: any) {
    const members = runtime.members;
  ...
  function method_write_pla(runtime: any, index: any) {
    const members = runtime.members;
  ...
  function method_pio_enable(runtime: any, newpio: any) {
    const members = runtime.members;
  ...
  function method_serial_timer(runtime: any, param: any) {
    const members = runtime.members;
