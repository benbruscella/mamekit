...
definition.compiledMethods = (() => {
    function method_read(runtime, offset, _8000, _a000, _c000, _e000) {
    ...
    function method_write(runtime, offset, data, _8000, _a000, _c000, _e000) {
        const members = runtime.members;
        if ((members.m_card ?? runtime.member("m_card"))) {
...
definition.slot.options["activision"].compiledMethods = (() => {
        ...
        if ((((((((((((_8000) ? 0 : 1)) || (((_a000) ? 0 : 1))) ? 1 : 0)) || (((_c000) ? 0 : 1))) ? 1 : 0)) || (((_e000) ? 0 : 1))) ? 1 : 0)) {
            if (((Number(offset) < Number(16384)) ? 1 : 0)) {
                ...
                if (((Number(offset) === Number(32640)) ? 1 : 0)) {
                    if (((members.m_eeprom)?.found?.() ?? 0)) {
                        data = ((((members.m_eeprom)?.read_sda?.() ?? 0)) & 0xff);
                    }
                    else {
                        data = ((255) & 0xff);
                    }
    ...
    function method_write(runtime, offset, data, _8000, _a000, _c000, _e000) {
        ...
        switch (offset) {
            ...
            case 32688:
                {
                    members.m_active_bank = ((((runtime.shiftRight(offset, 4)) & (3))) & 0xff);
                    break;
                }
            case 32704:
            case 32720:
                {
                    if (((members.m_eeprom)?.found?.() ?? 0)) {
                        ((members.m_eeprom)?.write_scl?.((((offset) >>> (4)) & 1)) ?? 0);
                    }
                    break;
                }
            case 32736:
            case 32752:
                {
                    if (((members.m_eeprom)?.found?.() ?? 0)) {
                        ((members.m_eeprom)?.write_sda?.((((offset) >>> (4)) & 1)) ?? 0);
                    }
                    break;
                }
        }
    }
    function method_device_colecovision_cartridge_interface__read(runtime, offset, _8000, _a000, _c000, _e000) {
        const members = runtime.members;
        return 255;
    }
    function method_device_colecovision_cartridge_interface__write(runtime, offset, data, _8000, _a000, _c000, _e000) {
        const members = runtime.members;
    }
    return {
        "read": method_read,
...
definition.slot.options["activision_256b"].children[0].definition.compiledMethods = {};
...
definition.slot.options["activision_32k"].children[0].definition.compiledMethods = {};
...
definition.slot.options["sgc_1mbit"].compiledMethods = (() => {
    function method_read(runtime, offset, _8000, _a000, _c000, _e000) {
        const members = runtime.members;
        return ((members.m_flash)?.read?.(method_banked_address(runtime, ((32768) | (offset)))) ?? 0);
    }
    function method_banked_address(runtime, offset) {
        const members = runtime.members;
    ...
    function method_write(runtime, offset, data, _8000, _a000, _c000, _e000) {
        const members = runtime.members;
        offset = ((offset) | (32768));
        let max_banks = ((runtime.divide((members.m_rom_size ?? runtime.member("m_rom_size")), 8192)) & 0xff);
        0;
        switch (offset) {
            case 65532:
                {
            ...
            default:
                {
                    let addr = ((((((((members.m_flash_a16 ?? runtime.member("m_flash_a16"))) >>> (0)) & 1)) << (16))) | (method_banked_address(runtime, offset)));
                    0;
                    ((members.m_flash)?.write?.(addr, data) ?? 0);
                    break;
                }
        }
    }
...
definition.slot.options["sgc_1mbit"].children[0].definition.compiledMethods = (() => {
    function method_delay_tick(runtime, param) {
        const members = runtime.members;
    ...
    function method_read_full(runtime, address) {
        const members = runtime.members;
        ...
        switch ((members.m_flash_mode ?? runtime.member("m_flash_mode"))) {
            ...
            case 9:
                {
                    if (((((((((((Number(h_m_maker_id) === Number(4)) ? 1 : 0)) && (((Number(h_m_device_id) === Number(173)) ? 1 : 0))) ? 1 : 0)) ? 0 : 1)) && ((((((Number(address) < Number((members.m_erase_sector ?? runtime.member("m_erase_sector")))) ? 1 : 0)) || (((Number(address) >= Number((((members.m_erase_sector ?? runtime.member("m_erase_sector"))) + (65536)))) ? 1 : 0))) ? 1 : 0))) ? 1 : 0)) {
                        switch (h_m_bits) {
                            case 8:
                                {
                                    data = ((runtime.readIndex((members.m_data ?? runtime.member("m_data")), address)) >>> 0);
                        ...
                        members.m_status = ((((members.m_status) ^ (68))) & 0xff);
                        data = (((members.m_status ?? runtime.member("m_status"))) >>> 0);
                    }
                    break;
                }
    ...
    function method_read_raw(runtime, offset) {
        const members = runtime.members;
        return runtime.readIndex((members.m_data ?? runtime.member("m_data")), offset);
    }
    function method_write_raw(runtime, offset, data) {
        const members = runtime.members;
        runtime.writeIndex(runtime.writableMember("m_data"), offset, data);
    }
    function method_intelfsh8_device__read(runtime, offset) {
        const members = runtime.members;
        return method_read_full(runtime, offset);
    }
    function method_intelfsh8_device__read_raw(runtime, offset) {
        const members = runtime.members;
        return runtime.readIndex((members.m_data ?? runtime.member("m_data")), offset);
    }
    function method_intelfsh8_device__write_raw(runtime, offset, data) {
        const members = runtime.members;
        runtime.writeIndex(runtime.writableMember("m_data"), offset, data);
    }
    return {
...
definition.slot.options["sgc_1mbit"].children[0].definition.compiledMethodLinks = ["machine", "machine().side_effects_disabled"];
...
definition.slot.options["sgc_2mbit"].children[0].definition.compiledMethodLinks = ["machine", "machine().side_effects_disabled"];
...
definition.slot.options["sgc_4mbit"].children[0].definition.compiledMethodLinks = ["machine", "machine().side_effects_disabled"];
