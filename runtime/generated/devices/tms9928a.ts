      ...
      switch ((members.m_mode ?? runtime.member("m_mode"))) {
        case 0:
        {
          ...
          for (let x: any = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
            ...
            let colour: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_colour ?? runtime.member("m_colour"))) + (runtime.shiftRight(charcode, 3)))) ?? 0)) & 0xff);
            let fg: any = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
        ...
        case 1:
        {
          let addr: any = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((runtime.shiftRight(y, 3)) * (40))))) & 0xffff);
          let fg: any = (__l["pen"] ? __l["pen"](((runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) ? (runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) ? (runtime.shiftRight((members.m_Regs ?? runtime.member("m_Regs"))[7], 4)) : (BackColour))));
        ...
        case 2:
        {
          let addr: any = (((((members.m_nametbl ?? runtime.member("m_nametbl"))) + (((runtime.shiftRight(y, 3)) * (32))))) & 0xffff);
          for (let x: any = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
            let charcode: any = ((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((runtime.shiftRight(y, 6)) << (8)))) & 0xffff);
        ...
        case 3:
        {
          ...
          for (let x: any = ((runtime.add(37, 6)) | 0); ((Number(x) < Number(runtime.add(37, 246))) ? 1 : 0); x = ((((x) + (6))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
            let charcode: any = ((((runtime.add(((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0), ((runtime.shiftRight(y, 6)) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) & 0xffff);
            let pattern: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((y) & (7)))) ?? 0)) & 0xff);
            for (let i: any = ((0) | 0); ((Number(i) < Number(6)) ? 1 : 0); pattern = ((((pattern) << (1))) & 0xff), i = ((((i) + (1))) | 0)) {
              runtime.writeIndex(p, ((x) + (i)), ((((pattern) & (128))) ? (fg) : (bg)));
            }
        ...
        case 4:
        {
          ...
          for (let x: any = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
            let charcode: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
            let colour: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.(runtime.add((((members.m_pattern ?? runtime.member("m_pattern"))) + (((charcode) << (3)))), ((runtime.shiftRight(y, 2)) & (7)))) ?? 0)) & 0xff);
            let fg: any = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
            let bg: any = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
        ...
        case 6:
        {
          ...
          for (let x: any = ((37) | 0); ((Number(x) < Number(runtime.add(37, 256))) ? 1 : 0); x = ((((x) + (8))) | 0), addr = ((((addr) + (1))) & 0xffff)) {
            let charcode: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.(addr) ?? 0)) & 0xff);
            let colour: any = ((((runtime.dereference(members.m_vram_space)).read_byte?.((((members.m_pattern ?? runtime.member("m_pattern"))) + (((((runtime.add(((charcode) + (((runtime.shiftRight(y, 2)) & (7)))), ((runtime.shiftRight(y, 6)) << (8)))) & ((members.m_patternmask ?? runtime.member("m_patternmask"))))) << (3))))) ?? 0)) & 0xff);
            let fg: any = (__l["pen"] ? __l["pen"](((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))) : runtime.macro("pen", ((runtime.shiftRight(colour, 4)) ? (runtime.shiftRight(colour, 4)) : (BackColour))));
            let bg: any = (__l["pen"] ? __l["pen"](((((colour) & (15))) ? (((colour) & (15))) : (BackColour))) : runtime.macro("pen", ((((colour) & (15))) ? (((colour) & (15))) : (BackColour))));
            runtime.writeIndex(p, ((x) + (0)), (runtime.writeIndex(p, ((x) + (1)), (runtime.writeIndex(p, ((x) + (2)), (runtime.writeIndex(p, ((x) + (3)), fg)))))));
            runtime.writeIndex(p, ((x) + (4)), (runtime.writeIndex(p, ((x) + (5)), (runtime.writeIndex(p, ((x) + (6)), (runtime.writeIndex(p, ((x) + (7)), bg)))))));
