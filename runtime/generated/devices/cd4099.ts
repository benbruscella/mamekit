...
import deviceData from './cd4099.device.ir.json' with { type: 'json' };

const definition = deviceData as unknown as GeneratedDeviceDefinition;
definition.compiledMethods = (() => {

  function method_write_bit(runtime: any, offset: any, d: any): any {
  ...
  function method_write_abcd(runtime: any, a: any, d: any): any {
    const members = runtime.members;
  ...
  function method_clear_outputs(runtime: any, new_q: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    let bits_changed: any = (((((members.m_q ?? runtime.member("m_q"))) ^ (new_q))) & 0xff);
    if (((Number(bits_changed) === Number(0)) ? 1 : 0)) {
      return;
    }
    members.m_q = ((new_q) & 0xff);
    for (let bit: any = ((0) | 0); ((Number(bit) < Number(8)) ? 1 : 0); bit = ((((bit) + (1))) | 0)) {
      if ((((bits_changed) >>> (bit)) & 1)) {
        (members.m_q_out_cb ?? runtime.member("m_q_out_cb"))[bit]((((new_q) >>> (bit)) & 1));
      }
    }
    (__l["m_parallel_out_cb"] ? __l["m_parallel_out_cb"](Number(0), Number(new_q), Number(bits_changed)) : typeof members.m_parallel_out_cb === 'function' ? members.m_parallel_out_cb(0, new_q, bits_changed) : runtime.invoke("m_parallel_out_cb", 0, new_q, bits_changed));
  }

  function method_update_bit(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    (__l["m_parallel_out_cb"] ? __l["m_parallel_out_cb"](Number(0), Number((members.m_q ?? runtime.member("m_q"))), Number(((1) << ((members.m_address ?? runtime.member("m_address")))))) : typeof members.m_parallel_out_cb === 'function' ? members.m_parallel_out_cb(0, (members.m_q ?? runtime.member("m_q")), ((1) << ((members.m_address ?? runtime.member("m_address"))))) : runtime.invoke("m_parallel_out_cb", 0, (members.m_q ?? runtime.member("m_q")), ((1) << ((members.m_address ?? runtime.member("m_address"))))));
  ...
  function method_enable_w(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_write_d0(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_write_d1(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_write_d7(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_write_a0(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    method_write_bit(runtime, runtime.shiftRight(offset, 1), ((offset) & (1)));
  }

  function method_write_a3(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    method_write_bit(runtime, ((offset) & (7)), runtime.shiftRight(((offset) & (8)), 3));
  }
  return {
...
definition.compiledMethodLinks = ["m_parallel_out_cb"];
