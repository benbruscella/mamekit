...
import deviceData from './mos6569.device.ir.json' with { type: 'json' };
...
definition.compiledMethods = (() => {
  ...
  function method_set_interrupt(runtime: any, mask: any): any {
  ...
  function method_clear_interrupt(runtime: any, mask: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_read_videoram(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_read_colorram(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_idle_access(runtime: any): any {
    const members = runtime.members;

    method_read_videoram(runtime, 16383);
  }

  function method_spr_ptr_access(runtime: any, num: any): any {
    const members = runtime.members;
  ...
  function method_spr_ba(runtime: any, num: any): any {
    const members = runtime.members;
  ...
  function method_set_ba(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_spr_data_access(runtime: any, num: any, bytenum: any): any {
    const members = runtime.members;
  ...
  function method_display_if_bad_line(runtime: any): any {
    const members = runtime.members;
  ...
  function method_set_aec(runtime: any, state: any): any {
    const members = runtime.members;
  ...
  function method_bad_line_ba(runtime: any): any {
    const members = runtime.members;
  ...
  function method_refresh_access(runtime: any): any {
    const members = runtime.members;
  ...
  function method_fetch_if_bad_line(runtime: any): any {
    const members = runtime.members;
  ...
  function method_rc_if_bad_line(runtime: any): any {
    const members = runtime.members;
  ...
  function method_sample_border(runtime: any): any {
    const members = runtime.members;
  ...
  function method_check_sprite_dma(runtime: any): any {
    const members = runtime.members;
  ...
  function method_matrix_access(runtime: any): any {
    const members = runtime.members;

    if ((((members.m_is_bad_line ?? runtime.member("m_is_bad_line"))) ? 0 : 1)) {
      return;
    }
    let adr: any = (((((((members.m_vc ?? runtime.member("m_vc"))) & (1023))) | ((((((members.m_reg ?? runtime.member("m_reg"))[24]) & (240))) << (6))))) & 0xffff);
    members.m_phi0 = ((1) | 0);
  ...
  function method_draw_background(runtime: any): any {
    const members = runtime.members;

    if ((members.m_draw_this_line ?? runtime.member("m_draw_this_line"))) {
      let c: any = ((0) & 0xff);
      switch (runtime.shiftRight((((((members.m_reg ?? runtime.member("m_reg"))[17]) & (96))) | ((((members.m_reg ?? runtime.member("m_reg"))[22]) & (16)))), 4)) {
        case 0:
        case 1:
        case 3:
        {
      ...
      ((members.m_bitmap).plot_box?.((members.m_graphic_x ?? runtime.member("m_graphic_x")), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), 8, 1, (__mame_table_0[((c) & 15)] ?? 0)) ?? 0);
    }
  }

  function method_draw_mono(runtime: any, p: any, c0: any, c1: any): any {
    const members = runtime.members;

    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    let c: any = [c0, c1];
    let data: any = (((members.m_gfx_data ?? runtime.member("m_gfx_data"))) & 0xff);
    for (let i: any = 0; ((Number(i) < Number(8)) ? 1 : 0); i = ((i) + (1))) {
      h_m_bitmap["pix="](((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), ((((p) + (7))) - (i)), (__mame_table_0[(((runtime.readIndex(c, ((data) & (1)))) % 16) + 16) % 16] ?? 0));
      (members.m_fore_coll_buf ?? runtime.member("m_fore_coll_buf"))[((((p) + (7))) - (i))] = ((data) & (1));
      data = ((runtime.shiftRight(data, 1)) & 0xff);
    }
  }

  function method_draw_multi(runtime: any, p: any, c0: any, c1: any, c2: any, c3: any): any {
    const members = runtime.members;

    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    let c: any = [c0, c1, c2, c3];
    let data: any = (((members.m_gfx_data ?? runtime.member("m_gfx_data"))) & 0xff);
    ...
    data = ((runtime.shiftRight(data, 2)) & 0xff);
  ...
  function method_device_reset(runtime: any): any {
    ...
    (() => { const target = (members.m_reg ?? runtime.member("m_reg")); const bytes = Number(128); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    for (let __range0: any = (members.m_mc ?? runtime.member("m_mc")), __range0_index: any = 0; ((Number(__range0_index) < Number(__range0.length)) ? 1 : 0); __range0_index = ((__range0_index) + (1))) {
    ...
    (() => { const target = (members.m_matrix_line ?? runtime.member("m_matrix_line")); const bytes = Number(40); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    (() => { const target = (members.m_color_line ?? runtime.member("m_color_line")); const bytes = Number(40); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    (() => { const target = (members.m_spr_coll_buf ?? runtime.member("m_spr_coll_buf")); const bytes = Number(1024); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    (() => { const target = (members.m_fore_coll_buf ?? runtime.member("m_fore_coll_buf")); const bytes = Number(1024); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    (() => { const target = (members.m_border_on_sample ?? runtime.member("m_border_on_sample")); const bytes = Number(5); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    (() => { const target = (members.m_border_color_sample ?? runtime.member("m_border_color_sample")); const bytes = Number(128); if (target?.generatedPointer) { const width = target.source.BYTES_PER_ELEMENT ?? 1; target.source.fill(0, target.offset, target.offset + Math.ceil(bytes / width)); return target; } target.fill(0, 0, bytes); return target; })();
    for (let i: any = ((0) | 0); ((Number(i) < Number(8)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
      ...
      for (let j: any = ((0) | 0); ((Number(j) < Number(4)) ? 1 : 0); j = ((((j) + (1))) | 0)) {
  ...
  function method_execute_run(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    do {
      let cpu_cycles: any = ((((((members.m_cpu)?.total_cycles?.() ?? 0)) & (255))) & 0xff);
      let vic_cycles: any = (((((__l["total_cycles"] ? __l["total_cycles"]() : runtime.macro("total_cycles"))) & (255))) & 0xff);
      members.m_phi0 = ((0) | 0);
      ...
      let i: any = ((0) | 0);
      let mask: any = ((0) & 0xff);
      if ((((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) === Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (48) : (48)))) ? 1 : 0)) && ((((members.m_bad_lines_enabled ?? runtime.member("m_bad_lines_enabled"))) ? 0 : 1))) ? 1 : 0)) {
        members.m_bad_lines_enabled = (((((members.m_reg ?? runtime.member("m_reg"))[17]) & (16))) & 0xff);
      }
      members.m_is_bad_line = (((((((((((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (48) : (48)))) ? 1 : 0)) && (((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) <= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (247) : (247)))) ? 1 : 0))) ? 1 : 0)) && (((Number((((members.m_rasterline ?? runtime.member("m_rasterline"))) & (7))) === Number((((members.m_reg ?? runtime.member("m_reg"))[17]) & (7)))) ? 1 : 0))) ? 1 : 0)) && ((members.m_bad_lines_enabled ?? runtime.member("m_bad_lines_enabled")))) ? 1 : 0)) & 0xff);
      switch ((members.m_cycle ?? runtime.member("m_cycle"))) {
        case 1:
        {
          if (((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) === Number(((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (312) : (263))) - (1)))) ? 1 : 0)) {
            members.m_vblanking = ((1) & 0xff);
          } else {
            members.m_rasterline = ((((members.m_rasterline) + (1))) | 0);
            members.m_draw_this_line = (((((((Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222))))))) >= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (16) : (41))) - (16))) : (((((Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (16) : (41))) >= Number(41)) ? 1 : 0)) ? (((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (16) : (41))) - (41))) : (runtime.add(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (16) : (41)), 222))))))) ? 1 : 0)) && (((Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222))))))) <= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (299) : (275))) - (16))) : (((((Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (299) : (275))) >= Number(41)) ? 1 : 0)) ? (((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (299) : (275))) - (41))) : (runtime.add(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (299) : (275)), 222))))))) ? 1 : 0))) ? 1 : 0)) & 0xff);
          }
        ...
        case 2:
        {
          ...
          members.m_graphic_x = ((((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (0) : (0))) & 0xffff);
          ...
          if ((members.m_draw_this_line ?? runtime.member("m_draw_this_line"))) {
            ...
            if ((members.m_border_on_sample ?? runtime.member("m_border_on_sample"))[0]) {
              for (i = ((0) | 0); ((Number(i) < Number(4)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                ((members.m_bitmap).plot_box?.(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (((i) * (8))) : (((i) * (8)))), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), 8, 1, (__mame_table_0[((runtime.readIndex((members.m_border_color_sample ?? runtime.member("m_border_color_sample")), i)) & 15)] ?? 0)) ?? 0);
              }
            }
            if ((members.m_border_on_sample ?? runtime.member("m_border_on_sample"))[1]) {
              ((members.m_bitmap).plot_box?.(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (32) : (32)), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), 8, 1, (__mame_table_0[((runtime.readIndex((members.m_border_color_sample ?? runtime.member("m_border_color_sample")), 4)) & 15)] ?? 0)) ?? 0);
            }
            ...
            if ((members.m_border_on_sample ?? runtime.member("m_border_on_sample"))[3]) {
              ((members.m_bitmap).plot_box?.(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (344) : (344)), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), 8, 1, (__mame_table_0[((runtime.readIndex((members.m_border_color_sample ?? runtime.member("m_border_color_sample")), 43)) & 15)] ?? 0)) ?? 0);
            }
            if ((members.m_border_on_sample ?? runtime.member("m_border_on_sample"))[4]) {
              for (i = ((44) | 0); ((Number(i) < Number(48)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
                ((members.m_bitmap).plot_box?.(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (((i) * (8))) : (((i) * (8)))), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (16))) : (((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(41)) ? 1 : 0)) ? ((((members.m_rasterline ?? runtime.member("m_rasterline"))) - (41))) : ((((members.m_rasterline ?? runtime.member("m_rasterline"))) + (222)))))), 8, 1, (__mame_table_0[((runtime.readIndex((members.m_border_color_sample ?? runtime.member("m_border_color_sample")), i)) & 15)] ?? 0)) ?? 0);
              }
              for (i = ((48) | 0); ((Number(i) < Number(51)) ? 1 : 0); i = ((((i) + (1))) | 0)) {
  ...
  function method_draw_graphics(runtime: any): any {
    const members = runtime.members;

    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    if (((Number((members.m_draw_this_line ?? runtime.member("m_draw_this_line"))) === Number(0)) ? 1 : 0)) {
      let p: any = (((((members.m_graphic_x ?? runtime.member("m_graphic_x"))) + ((((members.m_reg ?? runtime.member("m_reg"))[22]) & (7))))) & 0xffff);
      ...
      if ((members.m_ud_border_on ?? runtime.member("m_ud_border_on"))) {
        ...
        switch (runtime.shiftRight((((((members.m_reg ?? runtime.member("m_reg"))[17]) & (96))) | ((((members.m_reg ?? runtime.member("m_reg"))[22]) & (16)))), 4)) {
          ...
          case 2:
          {
            method_draw_mono(runtime, p, (((members.m_char_data ?? runtime.member("m_char_data"))) & (15)), runtime.shiftRight((members.m_char_data ?? runtime.member("m_char_data")), 4));
            break;
          }
          case 3:
          {
            method_draw_multi(runtime, p, (members.m_colors ?? runtime.member("m_colors"))[0], runtime.shiftRight((members.m_char_data ?? runtime.member("m_char_data")), 4), (((members.m_char_data ?? runtime.member("m_char_data"))) & (15)), (((members.m_color_data ?? runtime.member("m_color_data"))) & (15)));
            break;
          }
          case 4:
          {
  ...
  function method_draw_sprites(runtime: any): any {
    const members = runtime.members;
    ...
    let snum: any = ((0) & 0xff);
    let sbit: any = ((0) & 0xff);
    let spr_coll: any = ((0) & 0xff);
    let gfx_coll: any = ((0) & 0xff);
    let plane0_l: any = ((0) >>> 0);
    let plane0_r: any = ((0) >>> 0);
    let plane1_l: any = ((0) >>> 0);
    let plane1_r: any = ((0) >>> 0);
    let sdata_l: any = ((0) >>> 0);
    let sdata_r: any = ((0) >>> 0);
    ...
    for (snum = ((0) & 0xff), sbit = ((1) & 0xff); ((Number(snum) < Number(8)) ? 1 : 0); snum = ((((snum) + (1))) & 0xff), sbit = ((((sbit) << (1))) & 0xff)) {
      if (((((((members.m_spr_draw ?? runtime.member("m_spr_draw"))) & (sbit))) && (((Number((((members.m_reg ?? runtime.member("m_reg"))[((snum) * (2))]) | ((((((members.m_reg ?? runtime.member("m_reg"))[16]) & (((1) << (snum))))) ? (256) : (0))))) <= Number(((403) - (runtime.add(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (50) : (50)), 1))))) ? 1 : 0))) ? 1 : 0)) {
        let p: any = ((runtime.add(runtime.add((((members.m_reg ?? runtime.member("m_reg"))[((snum) * (2))]) | ((((((members.m_reg ?? runtime.member("m_reg"))[16]) & (((1) << (snum))))) ? (256) : (0)))), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (0) : (0))), 8)) & 0xffff);
        let color: any = (((((members.m_reg ?? runtime.member("m_reg"))[((39) + (snum))]) & (15))) & 0xff);
        let sdata: any = ((((((((runtime.readIndex((members.m_spr_draw_data ?? runtime.member("m_spr_draw_data"))[snum], 0)) << (24))) | (((runtime.readIndex((members.m_spr_draw_data ?? runtime.member("m_spr_draw_data"))[snum], 1)) << (16))))) | (((runtime.readIndex((members.m_spr_draw_data ?? runtime.member("m_spr_draw_data"))[snum], 2)) << (8))))) >>> 0);
        if ((((members.m_reg ?? runtime.member("m_reg"))[29]) & (((1) << (snum))))) {
          if (((Number((((members.m_reg ?? runtime.member("m_reg"))[((snum) * (2))]) | ((((((members.m_reg ?? runtime.member("m_reg"))[16]) & (((1) << (snum))))) ? (256) : (0))))) > Number(((379) - (runtime.add(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (50) : (50)), 1))))) ? 1 : 0)) {
            continue;
          }
          if ((((members.m_reg ?? runtime.member("m_reg"))[28]) & (((1) << (snum))))) {
            sdata_l = (((((((members.m_expandx_multi ?? runtime.member("m_expandx_multi"))[((runtime.shiftRight(sdata, 24)) & (255))]) << (16))) | ((members.m_expandx_multi ?? runtime.member("m_expandx_multi"))[((runtime.shiftRight(sdata, 16)) & (255))]))) >>> 0);
            sdata_r = (((((members.m_expandx_multi ?? runtime.member("m_expandx_multi"))[((runtime.shiftRight(sdata, 8)) & (255))]) << (16))) >>> 0);
            plane0_l = ((((((sdata_l) & (1431655765))) | (((((sdata_l) & (1431655765))) << (1))))) >>> 0);
            plane1_l = ((((((sdata_l) & (2863311530))) | (runtime.shiftRight(((sdata_l) & (2863311530)), 1)))) >>> 0);
            plane0_r = ((((((sdata_r) & (1431655765))) | (((((sdata_r) & (1431655765))) << (1))))) >>> 0);
            plane1_r = ((((((sdata_r) & (2863311530))) | (runtime.shiftRight(((sdata_r) & (2863311530)), 1)))) >>> 0);
            ...
            sdata_l = (((((((members.m_expandx ?? runtime.member("m_expandx"))[((runtime.shiftRight(sdata, 24)) & (255))]) << (16))) | ((members.m_expandx ?? runtime.member("m_expandx"))[((runtime.shiftRight(sdata, 16)) & (255))]))) >>> 0);
            sdata_r = (((((members.m_expandx ?? runtime.member("m_expandx"))[((runtime.shiftRight(sdata, 8)) & (255))]) << (16))) >>> 0);
          ...
          if ((((members.m_reg ?? runtime.member("m_reg"))[28]) & (((1) << (snum))))) {
            let plane0: any = ((((((sdata) & (1431655765))) | (((((sdata) & (1431655765))) << (1))))) >>> 0);
            let plane1: any = ((((((sdata) & (2863311530))) | (runtime.shiftRight(((sdata) & (2863311530)), 1)))) >>> 0);
  ...
  function method_read(runtime: any, offset: any): any {
    ...
    switch (offset) {
      case 17:
      {
        val = (((((((members.m_reg ?? runtime.member("m_reg"))[offset]) & (-129))) | (runtime.shiftRight((((members.m_rasterline ?? runtime.member("m_rasterline"))) & (256)), 1)))) & 0xff);
      ...
      case 48:
      {
        if (((((((((Number(4) === Number(3)) ? 1 : 0)) || (((Number(4) === Number(8)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) {
          val = (((members.m_reg ?? runtime.member("m_reg"))[offset]) & 0xff);
          do {
            if (((Number(0) >= Number(2)) ? 1 : 0)) {
              if (Boolean("vic read")) {
  ...
  function method_lp_w(runtime: any, state: any): any {
    const members = runtime.members;

    if ((((((((members.m_lp ?? runtime.member("m_lp"))) && (((state) ? 0 : 1))) ? 1 : 0)) && ((((((members.m_reg ?? runtime.member("m_reg"))[25]) & (8))) ? 0 : 1))) ? 1 : 0)) {
      (members.m_reg ?? runtime.member("m_reg"))[19] = runtime.shiftRight((members.m_raster_x ?? runtime.member("m_raster_x")), 1);
  ...
  function method_set_cpu(runtime: any, tag: any): any {
    const members = runtime.members;

    ((members.m_cpu)?.set_tag?.(tag) ?? 0);
  }

  function method_irq_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_ba_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_aec_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_k_callback(runtime: any): any {
    const members = runtime.members;
  ...
  function method_phi0_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_phi0 ?? runtime.member("m_phi0"));
  }

  function method_ba_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_ba ?? runtime.member("m_ba"));
  }

  function method_aec_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_aec ?? runtime.member("m_aec"));
  }

  function method_bus_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_last_data ?? runtime.member("m_last_data"));
  }

  function method_mos6566_device__set_cpu(runtime: any, tag: any): any {
    const members = runtime.members;

    ((members.m_cpu)?.set_tag?.(tag) ?? 0);
  }

  function method_mos6566_device__irq_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_irq)).bind === 'function' ? (runtime.dereference(members.m_write_irq)).bind() : typeof (runtime.dereference(members.m_write_irq)).bind === 'number' || typeof (runtime.dereference(members.m_write_irq)).bind === 'boolean' ? (runtime.dereference(members.m_write_irq)).bind : runtime.container(members.m_write_irq, "bind"));
  }

  function method_mos6566_device__ba_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_ba)).bind === 'function' ? (runtime.dereference(members.m_write_ba)).bind() : typeof (runtime.dereference(members.m_write_ba)).bind === 'number' || typeof (runtime.dereference(members.m_write_ba)).bind === 'boolean' ? (runtime.dereference(members.m_write_ba)).bind : runtime.container(members.m_write_ba, "bind"));
  }

  function method_mos6566_device__aec_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_aec)).bind === 'function' ? (runtime.dereference(members.m_write_aec)).bind() : typeof (runtime.dereference(members.m_write_aec)).bind === 'number' || typeof (runtime.dereference(members.m_write_aec)).bind === 'boolean' ? (runtime.dereference(members.m_write_aec)).bind : runtime.container(members.m_write_aec, "bind"));
  }

  function method_mos6566_device__k_callback(runtime: any): any {
    const members = runtime.members;

    return (typeof (runtime.dereference(members.m_write_k)).bind === 'function' ? (runtime.dereference(members.m_write_k)).bind() : typeof (runtime.dereference(members.m_write_k)).bind === 'number' || typeof (runtime.dereference(members.m_write_k)).bind === 'boolean' ? (runtime.dereference(members.m_write_k)).bind : runtime.container(members.m_write_k, "bind"));
  }

  function method_mos6566_device__phi0_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_phi0 ?? runtime.member("m_phi0"));
  }

  function method_mos6566_device__ba_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_ba ?? runtime.member("m_ba"));
  }

  function method_mos6566_device__aec_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_aec ?? runtime.member("m_aec"));
  }

  function method_mos6566_device__bus_r(runtime: any): any {
    const members = runtime.members;

    return (members.m_last_data ?? runtime.member("m_last_data"));
  }

  function method_mos6566_device__execute_run(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    do {
      ...
      let i: any = ((0) | 0);
      let mask: any = ((0) & 0xff);
      if (((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) === Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (48) : (48)))) ? 1 : 0)) {
        members.m_bad_lines_enabled = (((((members.m_reg ?? runtime.member("m_reg"))[17]) & (16))) & 0xff);
      }
      members.m_is_bad_line = (((((((((((((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) >= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (48) : (48)))) ? 1 : 0)) && (((Number((members.m_rasterline ?? runtime.member("m_rasterline"))) <= Number(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (247) : (247)))) ? 1 : 0))) ? 1 : 0)) && (((Number((((members.m_rasterline ?? runtime.member("m_rasterline"))) & (7))) === Number((((members.m_reg ?? runtime.member("m_reg"))[17]) & (7)))) ? 1 : 0))) ? 1 : 0)) && ((members.m_bad_lines_enabled ?? runtime.member("m_bad_lines_enabled")))) ? 1 : 0)) & 0xff);
      switch ((members.m_cycle ?? runtime.member("m_cycle"))) {
  ...
  return {
    ...
    "mos6566_device::execute_run": method_mos6566_device__execute_run
  };
