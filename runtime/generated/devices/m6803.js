...
class GeneratedM6803 {
    bus;
    irqData = 0xff;
    irqHold = false;
    internalRam = new Uint8Array(0x10000);
    portData = new Uint8Array(2);
    portDirection = new Uint8Array(2);
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('M6803 dispatch loop exceeded 8');
            switch ((this.m_ref >>> 8) & 0xffff) {
                ...
                default:
                    throw new Error('M6803 has no generated opcode ' +
    ...
    invoke(name, ...args) {
        switch (name) {
            ...
            default: throw new Error('M6803 has no generated method "' + name + '"');
        }
    }
    generatedStart() {
    }
...
export const cpu = {
    ...
    create: (bus) => new GeneratedM6803(bus),
};
export default cpu;
