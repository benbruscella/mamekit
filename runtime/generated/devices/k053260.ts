...
definition.compiledMethods = (() => {
  function method_main_read(runtime: any, offset: any) {
    const members = runtime.members;
    return runtime.readIndex((members.m_portdata ?? runtime.member("m_portdata")), runtime.add(2, ((offset) & (1))));
  }

  function method_main_write(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_portdata"), ((offset) & (1)), data);
  }

  function method_update_state_outputs(runtime: any, param: any) {
    const members = runtime.members;
  ...
  function method_tim2_count(runtime: any) {
    const members = runtime.members;
