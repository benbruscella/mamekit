...
definition.slot.options["rom_lasama"].compiledMethods = (() => {
    ...
    function method_bank_rom_entry_high(runtime) {
        const members = runtime.members;
        let coarse = ((((((runtime.readIndex((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom")), 0)) & (runtime.readIndex((members.m_bank_rom_coarse_mask ?? runtime.member("m_bank_rom_coarse_mask")), 1)))) & 0xffff)) & 0xffff);
