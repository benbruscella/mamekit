...
definition.compiledMethods = (() => {
    ...
    function method_draw_sprites(runtime) {
        ...
        for (snum = ((0) & 0xff), sbit = ((1) & 0xff); ((Number(snum) < Number(8)) ? 1 : 0); snum = ((((snum) + (1))) & 0xff), sbit = ((((sbit) << (1))) & 0xff)) {
            if (((((((members.m_spr_draw ?? runtime.member("m_spr_draw"))) & (sbit))) && (((Number((((members.m_reg ?? runtime.member("m_reg"))[((snum) * (2))]) | ((((((members.m_reg ?? runtime.member("m_reg"))[16]) & (((1) << (snum))))) ? (256) : (0))))) <= Number(((403) - (runtime.add(((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (50) : (50)), 1))))) ? 1 : 0))) ? 1 : 0)) {
                let p = ((runtime.add(runtime.add((((members.m_reg ?? runtime.member("m_reg"))[((snum) * (2))]) | ((((((members.m_reg ?? runtime.member("m_reg"))[16]) & (((1) << (snum))))) ? (256) : (0)))), ((((((((((((((((Number(4) === Number(4)) ? 1 : 0)) || (((Number(4) === Number(5)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(6)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(7)) ? 1 : 0))) ? 1 : 0)) || (((Number(4) === Number(9)) ? 1 : 0))) ? 1 : 0)) ? (0) : (0))), 8)) & 0xffff);
                ...
                if ((((members.m_reg ?? runtime.member("m_reg"))[29]) & (((1) << (snum))))) {
                    ...
                    if ((((members.m_reg ?? runtime.member("m_reg"))[28]) & (((1) << (snum))))) {
                        ...
                        let plane1 = ((((((sdata) & (2863311530))) | (runtime.shiftRight(((sdata) & (2863311530)), 1)))) >>> 0);
    ...
    function method_mos6566_device__execute_run(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        do {
            let cpu_cycles = ((((((members.m_cpu)?.total_cycles?.() ?? 0)) & (255))) & 0xff);
