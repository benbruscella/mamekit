...
definition.compiledMethods = (() => {
    ...
    function method_update_sprites(runtime) {
        ...
        for (let i = (((members.m_sprCount ?? runtime.member("m_sprCount"))) - (1)); ((Number(i) >= Number(0)) ? 1 : 0); i = ((i) - (1))) {
            let oam_address = ((runtime.readIndex((members.m_sprite ?? runtime.member("m_sprite")), i)) * (4));
            ...
            let xindex = ((runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((oam_address) + (1)))) - (8));
            let adr = ((((runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((oam_address) + (2)))) & (tilemask))) * (16));
            ...
            switch (((runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((oam_address) + (3)))) & (160))) {
                case 160:
                    {
                        for (let bit = 0; ((Number(bit) < Number(8)) ? 1 : 0); bit = ((bit) + (1)), xindex = ((xindex) + (1))) {
                            let colour = ((((((data) & (256))) ? (2) : (0))) | (((((data) & (1))) ? (1) : (0))));
                ...
                case 128:
                    {
                        for (let bit = 0; (((((Number(bit) < Number(8)) ? 1 : 0)) && (((Number(xindex) < Number(160)) ? 1 : 0))) ? 1 : 0); bit = ((bit) + (1)), xindex = ((xindex) + (1))) {
                            let colour = ((((((data) & (32768))) ? (2) : (0))) | (((((data) & (128))) ? (1) : (0))));
                            if ((((((((((colour) && (((runtime.readIndex((members.m_bg_zbuf ?? runtime.member("m_bg_zbuf")), xindex)) ? 0 : 1))) ? 1 : 0)) && (((Number(xindex) >= Number(0)) ? 1 : 0))) ? 1 : 0)) && (((Number(xindex) < Number(160)) ? 1 : 0))) ? 1 : 0)) {
                                method_plot_pixel(runtime, xindex, yindex, runtime.readIndex(spal, colour));
                            }
                            data = ((((data) << (1))) & 0xffff);
        ...
        if (((Number(((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 1)) & (3))) === Number(3)) ? 1 : 0)) {
            ...
            if (((Number((members.m_start_x ?? runtime.member("m_start_x"))) < Number(0)) ? 1 : 0)) {
                ...
                if (runtime.readIndex(h_m_layer, 1).enabled) {
                    let xpos = (((members.m_window_x ?? runtime.member("m_window_x"))) - (7));
            ...
            if (((Number(cycles_to_go) < Number(160)) ? 1 : 0)) {
                ...
                if (((((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 0)) & (1))) ? 0 : 1)) {
                    let r = (runtime.calls["rectangle"] ? runtime.calls["rectangle"]((members.m_start_x ?? runtime.member("m_start_x")), (((members.m_end_x ?? runtime.member("m_end_x"))) - (1)), (members.m_current_line ?? runtime.member("m_current_line")), (members.m_current_line ?? runtime.member("m_current_line"))) : runtime.macro("rectangle", (members.m_start_x ?? runtime.member("m_start_x")), (((members.m_end_x ?? runtime.member("m_end_x"))) - (1)), (members.m_current_line ?? runtime.member("m_current_line")), (members.m_current_line ?? runtime.member("m_current_line"))));
    ...
    function method_update_state(runtime) {
        ...
        0;
        let cycles = ((runtime.dereference(members.m_lr35902)).attotime_to_cycles?.(((now) - ((members.m_last_updated ?? runtime.member("m_last_updated"))))) ?? 0);
        ...
        if (((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 0)) & (128))) {
            ...
            while (((Number((members.m_cycles_left ?? runtime.member("m_cycles_left"))) === Number(0)) ? 1 : 0)) {
                ...
                switch ((members.m_state ?? runtime.member("m_state"))) {
                    ...
                    case 1:
                        {
                            for (let i = 0; ((Number(i) < Number(((h_m_line.window_start_y)?.length ?? 0))) ? 1 : 0); i = ((i) + (1))) {
                            ...
                            for (let i = 0; ((Number(i) < Number(((h_m_line.window_enable)?.length ?? 0))) ? 1 : 0); i = ((i) + (1))) {
        ...
        let next_cycles = (members.m_cycles_left ?? runtime.member("m_cycles_left"));
    ...
    function method_update_oam_dma_state(runtime, cycles) {
        ...
        if (((Number((members.m_oam_dma_start_cycles ?? runtime.member("m_oam_dma_start_cycles"))) > Number(0)) ? 1 : 0)) {
            if (((Number(cycles) >= Number((members.m_oam_dma_start_cycles ?? runtime.member("m_oam_dma_start_cycles")))) ? 1 : 0)) {
                for (let i = 0; ((Number(i) < Number(160)) ? 1 : 0); i = ((i) + (1))) {
    ...
    function method_clear_line_state(runtime) {
        ...
        const h_m_line = members.m_line ?? runtime.member("m_line");
        const h_m_enable_experimental_engine = members.m_enable_experimental_engine ?? runtime.member("m_enable_experimental_engine");
        for (let i = 0; ((Number(i) < Number(10)) ? 1 : 0); i = ((i) + (1))) {
    ...
    function method_select_sprites(runtime) {
        ...
        if ((((((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 0)) & (128))) && (((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 0)) & (2)))) ? 1 : 0)) {
            ...
            let height = ((((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 0)) & (4))) ? (16) : (8));
            let line = (((members.m_current_line ?? runtime.member("m_current_line"))) + (16));
            for (let i = 0; ((Number(i) < Number(160)) ? 1 : 0); i = ((i) + (4))) {
                if ((((((Number(line) >= Number(runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), i))) ? 1 : 0)) && (((Number(line) < Number(((runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), i)) + (height)))) ? 1 : 0))) ? 1 : 0)) {
                    if (((Number((members.m_sprCount ?? runtime.member("m_sprCount"))) < Number(10)) ? 1 : 0)) {
                        ...
                        if (((Number(runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((i) + (1)))) < Number(168)) ? 1 : 0)) {
                            ...
                            let spr_x = ((runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((i) + (1)))) ? (runtime.add(runtime.readIndex((members.m_oam ?? runtime.member("m_oam")), ((i) + (1))), ((runtime.readIndex((members.m_vid_regs ?? runtime.member("m_vid_regs")), 3)) & (7)))) : (0));
            ...
            if (((Number((members.m_sprCount ?? runtime.member("m_sprCount"))) > Number(0)) ? 1 : 0)) {
                for (let i = 0; ((Number(i) < Number(22)) ? 1 : 0); i = ((i) + (1))) {
