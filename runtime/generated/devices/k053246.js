...
definition.compiledMethods = (() => {
    ...
    function method_k055673_5bpp_rom_word_r(runtime, offset) {
        ...
        let size4 = runtime.divide(runtime.divide((members.m_gfxrom).length, ((1024) * (1024))), 5);
        let romofs = 0;
    ...
    function method_k055673_ps_rom_word_r(runtime, offset) {
        ...
        romofs = ((((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 6)) << (16))) | (((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 7)) << (8))))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 4)));
        offset = ((((offset) & (4))) >>> (1));
        let finoffs = ((runtime.add(((romofs) * (2)), ((offset) * (2)))) + (magic));
    ...
    function method_k055673_gr_rom_word_r(runtime, offset) {
        ...
        const h_m_gfxrom = members.m_gfxrom ?? runtime.member("m_gfxrom");
        let ROM = runtime.addressOf(h_m_gfxrom, 0);
        let romofs = ((((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 6)) << (16))) | (((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 7)) << (8))))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 4)));
        offset = ((((offset) & (4))) >>> (1));
        let finoffs = runtime.add(((romofs) * (2)), ((offset) * (2)));
    ...
    function method_k053246_r(runtime, offset) {
        ...
        if (((Number((members.m_objcha_line ?? runtime.member("m_objcha_line"))) === Number(1)) ? 1 : 0)) {
            let addr = ((((((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 6)) << (17))) | (((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 7)) << (9))))) | (((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 4)) << (1))))) | (((((offset) & (1))) ^ (1))));
    ...
    function method_k053247_sprites_draw_common(runtime, bitmap, cliprect) {
        ...
        for (; ((Number(count) >= Number(0)) ? 1 : 0); count = ((count) - (1))) {
            ...
            primask = 0;
            (runtime.calls["m_k053247_cb"] ? runtime.calls["m_k053247_cb"](({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => primask, set: (value) => { primask = value; } })) : runtime.macro("m_k053247_cb", ({ generatedLValue: true, get: () => code, set: (value) => { code = value; } }), ({ generatedLValue: true, get: () => color, set: (value) => { color = value; } }), ({ generatedLValue: true, get: () => primask, set: (value) => { primask = value; } })));
    ...
    function method_k053247_draw_single_sprite_gxcore(runtime, bitmap, cliprect, gx_objzbuf, gx_shdzbuf, code, gx_spriteram, offs, color, alpha, drawmode, zcode, pri, primask, shadow, drawmode_table, shadowmode_table, shdmask) {
        ...
        let temp = 0;
        let temp4 = 0;
        let flipscreenx = ((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 5)) & (1));
        let flipscreeny = ((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 5)) & (2));
        xa = (ya = 0);
        if (((code) & (1))) {
            xa = ((xa) + (1));
        }
        ...
        mirrory = ((temp) & (32768));
        let objset1 = method_k053246_read_register(runtime, 5);
        if (((objset1) & (8))) {
            let screenwidth = (runtime.calls["screen().width"]?.() ?? 0);
            zoomx = ((zoomx) >>> (1));
        ...
        let k053247_opset = method_k053247_read_register(runtime, runtime.divide(12, 2));
        let wrapsize = 0;
        let xwraplim = 0;
        let ywraplim = 0;
        if (((k053247_opset) & (64))) {
        ...
        let offx = (runtime.calls["short"] ? runtime.calls["short"](((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 0)) << (8))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 1)))) : runtime.macro("short", ((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 0)) << (8))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 1)))));
        let offy = (runtime.calls["short"] ? runtime.calls["short"](((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 2)) << (8))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 3)))) : runtime.macro("short", ((((runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 2)) << (8))) | (runtime.readIndex((members.m_kx46_regs ?? runtime.member("m_kx46_regs")), 3)))));
        temp = ((wrapsize) - (1));
    ...
    function method_k053247_draw_yxloop_gx(runtime, bitmap, cliprect, code, color, height, width, zoomx, zoomy, flipx, flipy, ox, oy, xa, ya, mirrorx, mirrory, nozoom, pri, zcode, alpha, drawmode, gx_objzbuf, gx_shdzbuf, primask, whichtable) {
        ...
        let sy = 0;
        let tempcode = 0;
        for (let y = 0; ((Number(y) < Number(height)) ? 1 : 0); y = ((y) + (1))) {
            sy = ((oy) + (((runtime.add(((zoomy) * (y)), ((1) << (11)))) >>> (12))));
            zh = ((((oy) + (((runtime.add(((zoomy) * (((y) + (1)))), ((1) << (11)))) >>> (12))))) - (sy));
            for (let x = 0; ((Number(x) < Number(width)) ? 1 : 0); x = ((x) + (1))) {
