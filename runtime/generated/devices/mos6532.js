...
definition.compiledMethods = (() => {
    function method_pa_data_r(runtime) {
        ...
        let data = ((((((members.m_pa_out) & (members.m_pa_ddr))) | ((($in) & ((~members.m_pa_ddr)))))) & 0xff);
    ...
    function method_update_pa(runtime) {
        const members = runtime.members;
        let data = ((((((members.m_pa_out) & (members.m_pa_ddr))) | (((members.m_pa_ddr) ^ (255))))) & 0xff);
    ...
    function method_edge_detect(runtime) {
        const members = runtime.members;
        let data = ((((((members.m_pa_out) & (members.m_pa_ddr))) | (((members.m_pa_in) & ((~members.m_pa_ddr)))))) & 0xff);
        let state = (((data) >>> (7)) & 1);
    ...
    function method_pb_data_r(runtime) {
        ...
        let data = ((((((members.m_pb_out) & (members.m_pb_ddr))) | ((($in) & ((~members.m_pb_ddr)))))) & 0xff);
        (runtime.calls["TRACE_NOOP"]?.() ?? 0);
        return data;
    }
    ...
    function method_update_pb(runtime) {
        const members = runtime.members;
        let data = ((((((members.m_pb_out) & (members.m_pb_ddr))) | (((members.m_pb_ddr) ^ (255))))) & 0xff);
    ...
    function method_get_timer(runtime) {
        const members = runtime.members;
        let shift = ((((((Number(members.m_timerstate) === Number(0)) ? 1 : 0)) ? (members.m_timershift) : (0))) & 0xff);
        let remain = members.m_timer.remaining().as_ticks((runtime.calls["clock"]?.() ?? 0));
    ...
    function method_timer_start(runtime, data) {
        ...
        let curtime = (runtime.calls["machine"]?.() ?? 0).time();
        let target = ((((curtime.as_ticks((runtime.calls["clock"]?.() ?? 0))) + (1))) + (((data) << (members.m_timershift))));
