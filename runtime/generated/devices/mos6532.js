...
definition.compiledMethods = (() => {
    ...
    function method_get_timer(runtime) {
        ...
        let val = ((runtime.shiftRight(remain, shift)) & 0xff);
    ...
    function method_timer_start(runtime, data) {
        ...
        let curtime = (__l["machine().time"]?.() ?? 0);
        let target = runtime.add(runtime.add(((runtime.dereference(curtime)).as_ticks?.((__l["clock"] ? __l["clock"]() : runtime.macro("clock"))) ?? 0), 1), ((data) << ((members.m_timershift ?? runtime.member("m_timershift")))));
