...
definition.compiledMethods = (() => {
    ...
    function method_update_interrupts(runtime) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let new_state = (((((((((members.m_irq_a1 ?? runtime.member("m_irq_a1"))) && (method_irq1_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0)) || (((((members.m_irq_a2 ?? runtime.member("m_irq_a2"))) && (method_irq2_enabled(runtime, (members.m_ctl_a ?? runtime.member("m_ctl_a"))))) ? 1 : 0))) ? 1 : 0)) | 0);
    ...
    function method_set_out_cb2(runtime, data) {
        const members = runtime.members;
        const __l = runtime.links ?? runtime.calls;
        let z = ((method_cb2_output_z(runtime)) | 0);
