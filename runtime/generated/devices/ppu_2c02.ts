...
definition.compiledMethods = (() => {
  function method_init_palette_tables(runtime: any) {
    ...
    let is_pal: any = ((((Number(members.m_scanlines_per_frame) !== Number(262)) ? 1 : 0)) ? 1 : 0);
    let entry: any = 0;
  ...
  function method_nespal_to_RGB(runtime: any, color_intensity: any, color_num: any, color_emphasis: any, is_pal_or_dendy: any) {
    ...
    let G: any = ((((y) - (((((((((Kb) * (Ku))) * (u))) + (((((Kr) * (Kv))) * (v))))) / (((((1) - (Kb))) - (Kr))))))) * (255));
    let B: any = ((((y) + (((Ku) * (u))))) * (255));
    method_apply_color_emphasis_and_clamp(runtime, is_pal_or_dendy, color_emphasis, ({ get: () => R, set: (value: any) => { R = value; } }), ({ get: () => G, set: (value: any) => { G = value; } }), ({ get: () => B, set: (value: any) => { B = value; } }));
  ...
  function method_draw_background(runtime: any, line_priority: any) {
    const members = runtime.members;
    let scroll_x_coarse: any = ((((members.m_refresh_data) & (31))) & 0xff);
    let scroll_y_coarse: any = ((((((members.m_refresh_data) & (992))) >>> (5))) & 0xff);
    let nametable: any = ((((members.m_refresh_data) & (3072))) & 0xffff);
    let scroll_y_fine: any = ((((((members.m_refresh_data) & (28672))) >>> (12))) & 0xff);
    let x: any = scroll_x_coarse;
    let tile_index: any = ((((nametable) | (8192))) + (((scroll_y_coarse) * (32))));
    let start_x: any = ((((members.m_x_fine) ^ (7))) - (7));
    let dest: any = members.m_bitmap["pix&"](members.m_scanline, start_x);
    ...
    while (((Number(members.m_tilecount) < Number(34)) ? 1 : 0)) {
      ...
      let color_byte: any = method_readbyte(runtime, ((((((((page) * (1024))) + (address))) & (4095))) + (8192)));
      let color_bits: any = ((((((index1) & (64))) >>> (4))) + (((index1) & (2))));
  ...
  function method_draw_tile_pixel(runtime: any, pix: any, color: any, back_pen: any, dest: any) {
    const members = runtime.members;
    let palval: any = ((((pix) ? (members.m_palette_ram[((((((4) * (color))) + (pix))) & (31))]) : (back_pen))) & 0xffff);
  ...
  function method_draw_sprites(runtime: any, line_priority: any) {
    ...
    let size: any = ((((members.m_regs[0]) & (32))) ? (16) : (8));
    let first_pixel: any = ((((members.m_regs[1]) & (4))) ? (0) : (8));
    for (let sprite_index: any = 0; ((Number(sprite_index) < Number(256)) ? 1 : 0); sprite_index = ((sprite_index) + (4))) {
      let sprite_ypos: any = ((members.m_spriteram[sprite_index]) + (1));
      let sprite_xpos: any = members.m_spriteram[((sprite_index) + (3))];
      ...
      let tile: any = members.m_spriteram[((sprite_index) + (1))];
      let color: any = ((((members.m_spriteram[((sprite_index) + (2))]) & (3))) + (4));
      let pri: any = (((((members.m_spriteram[((sprite_index) + (2))]) >>> (5)) & 1)) ? 1 : 0);
      let flipx: any = (((((members.m_spriteram[((sprite_index) + (2))]) >>> (6)) & 1)) ? 1 : 0);
      let flipy: any = (((((members.m_spriteram[((sprite_index) + (2))]) >>> (7)) & 1)) ? 1 : 0);
      ...
      let sprite_line: any = ((members.m_scanline) - (sprite_ypos));
      if (flipy) {
  ...
  function method_draw_sprite_pixel(runtime: any, sprite_xpos: any, color: any, pixel: any, pixel_data: any, bitmap: any) {
    const members = runtime.members;
    let palval: any = ((members.m_palette_ram[((((((4) * (color))) | (pixel_data))) & (31))]) & 0xffff);
  ...
  function method_hblank_tick(runtime: any, param: any) {
    const members = runtime.members;
    let blanked: any = ((((Number(((members.m_regs[1]) & (((8) | (16))))) === Number(0)) ? 1 : 0)) ? 1 : 0);
    let vblank: any = (((((((Number(members.m_scanline) >= Number(((members.m_vblank_first_scanline) - (1)))) ? 1 : 0)) && (((Number(members.m_scanline) < Number(((members.m_scanlines_per_frame) - (1)))) ? 1 : 0))) ? 1 : 0)) ? 1 : 0);
  ...
  function method_scanline_tick(runtime: any, param: any) {
    const members = runtime.members;
    let blanked: any = ((((Number(((members.m_regs[1]) & (((8) | (16))))) === Number(0)) ? 1 : 0)) ? 1 : 0);
    let vblank: any = (((((((((Number(members.m_scanline) >= Number(((members.m_vblank_first_scanline) - (1)))) ? 1 : 0)) && (((Number(members.m_scanline) < Number(((members.m_scanlines_per_frame) - (1)))) ? 1 : 0))) ? 1 : 0)) ? (1) : (0))) ? 1 : 0);
    ...
    let next_scanline: any = ((members.m_scanline) + (1));
  ...
  function method_draw_background_pen(runtime: any) {
    const members = runtime.members;
    for (let i: any = 0; ((Number(i) < Number(members.m_bitmap.width())) ? 1 : 0); i = ((i) + (1))) {
  ...
  function method_update_visible_disabled_scanline(runtime: any) {
    const members = runtime.members;
    let back_pen: any = ((members.m_back_color) >>> 0);
  ...
  function method_scanline_increment_fine_ycounter(runtime: any) {
    ...
    if (((members.m_refresh_data) & (32768))) {
      let tmp: any = ((((((members.m_refresh_data) & (992))) + (32))) & 0xffff);
