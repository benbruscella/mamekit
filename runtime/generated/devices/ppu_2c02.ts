...
definition.compiledMethods = (() => {
  function method_init_palette_tables(runtime: any) {
    const members = runtime.members;
    let is_pal: any = ((((Number((members.m_scanlines_per_frame ?? runtime.member("m_scanlines_per_frame"))) !== Number(262)) ? 1 : 0)) ? 1 : 0);
    let entry: any = 0;
    for (let color_emphasis: any = 0; ((Number(color_emphasis) < Number(8)) ? 1 : 0); color_emphasis = ((color_emphasis) + (1))) {
      for (let color_intensity: any = 0; ((Number(color_intensity) < Number(4)) ? 1 : 0); color_intensity = ((color_intensity) + (1))) {
        for (let color_num: any = 0; ((Number(color_num) < Number(16)) ? 1 : 0); color_num = ((color_num) + (1))) {
  ...
  function method_nespal_to_RGB(runtime: any, color_intensity: any, color_num: any, color_emphasis: any, is_pal_or_dendy: any) {
    const members = runtime.members;
    let tint: any = 0.22;
    let hue: any = 287;
    let Kr: any = 0.2989;
  ...
  function method_apply_color_emphasis_and_clamp(runtime: any, is_pal_or_dendy: any, color_emphasis: any, R: any, G: any, B: any) {
    const members = runtime.members;
    if (is_pal_or_dendy) {
  ...
  function method_draw_background(runtime: any, line_priority: any) {
    const members = runtime.members;
    ...
    let x: any = scroll_x_coarse;
    let tile_index: any = runtime.add(((nametable) | (8192)), ((scroll_y_coarse) * (32)));
    let start_x: any = (((((members.m_x_fine ?? runtime.member("m_x_fine"))) ^ (7))) - (7));
    ...
    while (((Number((members.m_tilecount ?? runtime.member("m_tilecount"))) < Number(34)) ? 1 : 0)) {
      let index1: any = ((tile_index) + (x));
      let page2: any = method_readbyte(runtime, index1);
      let pos: any = ((((((index1) & (896))) >>> (4))) | (((((index1) & (31))) >>> (2))));
      let page: any = ((((index1) & (3072))) >>> (10));
      let address: any = ((960) + (pos));
      let color_byte: any = method_readbyte(runtime, runtime.add(((((((page) * (1024))) + (address))) & (4095)), 8192));
      let color_bits: any = runtime.add(((((index1) & (64))) >>> (4)), ((index1) & (2)));
  ...
  function method_readbyte(runtime: any, address: any) {
    const members = runtime.members;
    return (runtime.calls["space().read_byte"]?.(address) ?? 0);
  }

  function method_draw_tile(runtime: any, line_priority: any, color_byte: any, color_bits: any, address: any, start_x: any, back_pen: any, dest: any) {
    const members = runtime.members;
    let color: any = ((((color_byte) >>> (color_bits))) & (3));
  ...
  function method_read_tile_plane_data(runtime: any, address: any, color: any) {
    const members = runtime.members;
  ...
  function method_shift_tile_plane_data(runtime: any, pix: any) {
    const members = runtime.members;
  ...
  function method_draw_tile_pixel(runtime: any, pix: any, color: any, back_pen: any, dest: any) {
    const members = runtime.members;
  ...
  function method_apply_grayscale_and_emphasis(runtime: any, color: any) {
    const members = runtime.members;
  ...
  function method_draw_back_pen(runtime: any, dest: any, back_pen: any) {
    const members = runtime.members;
    runtime.pointerStore(dest, (runtime.palette[method_apply_grayscale_and_emphasis(runtime, back_pen)] ?? 0xff000000));
  }

  function method_ppu2c0x_device__draw_background(runtime: any, line_priority: any) {
    const members = runtime.members;
    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    let scroll_x_coarse: any = (((((members.m_refresh_data ?? runtime.member("m_refresh_data"))) & (31))) & 0xff);
    let scroll_y_coarse: any = (((((((members.m_refresh_data ?? runtime.member("m_refresh_data"))) & (992))) >>> (5))) & 0xff);
  ...
  function method_draw_sprite_pixel(runtime: any, sprite_xpos: any, color: any, pixel: any, pixel_data: any, bitmap: any) {
    const members = runtime.members;
  ...
  function method_draw_sprite_pixel_low(runtime: any, bitmap: any, pixel_data: any, pixel: any, sprite_xpos: any, color: any, sprite_index: any, line_priority: any) {
    const members = runtime.members;
  ...
  function method_is_spritepixel_opaque(runtime: any, pixel_data: any, color: any) {
    const members = runtime.members;
    if (pixel_data) {
      return 1;
    } else {
  ...
  function method_draw_sprite_pixel_high(runtime: any, bitmap: any, pixel_data: any, pixel: any, sprite_xpos: any, color: any, sprite_index: any, line_priority: any) {
    const members = runtime.members;
    if (method_is_spritepixel_opaque(runtime, pixel_data, color)) {
      if (((Number(((sprite_xpos) + (pixel))) < Number(256)) ? 1 : 0)) {
        if (((((~runtime.readIndex(line_priority, ((sprite_xpos) + (pixel))))) >>> (0)) & 1)) {
  ...
  function method_draw_sprites(runtime: any, line_priority: any) {
    const members = runtime.members;
    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    let sprite_count: any = 0;
    let size: any = ((((runtime.readIndex((members.m_regs ?? runtime.member("m_regs")), 0)) & (32))) ? (16) : (8));
    let first_pixel: any = ((((runtime.readIndex((members.m_regs ?? runtime.member("m_regs")), 1)) & (4))) ? (0) : (8));
    for (let sprite_index: any = 0; ((Number(sprite_index) < Number(256)) ? 1 : 0); sprite_index = ((sprite_index) + (4))) {
      let sprite_ypos: any = runtime.add(runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), sprite_index), 1);
      let sprite_xpos: any = runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (3)));
      ...
      let tile: any = runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (1)));
      let color: any = runtime.add(((runtime.readIndex((members.m_spriteram ?? runtime.member("m_spriteram")), ((sprite_index) + (2)))) & (3)), 4);
      ...
      let sprite_line: any = (((members.m_scanline ?? runtime.member("m_scanline"))) - (sprite_ypos));
      if (flipy) {
      ...
      if (pri) {
        for (let pixel: any = 0; ((Number(pixel) < Number(8)) ? 1 : 0); pixel = ((pixel) + (1))) {
  ...
  function method_read_extra_sprite_bits(runtime: any, sprite_index: any) {
    const members = runtime.members;

  }

  function method_apply_sprite_pattern_page(runtime: any, index1: any, size: any) {
    const members = runtime.members;
  ...
  function method_read_sprite_plane_data(runtime: any, address: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_planebuf"), 0, method_readbyte(runtime, ((address) & (8191))));
    runtime.writeIndex(runtime.writableMember("m_planebuf"), 1, method_readbyte(runtime, ((((address) + (8))) & (8191))));
  }

  function method_make_sprite_pixel_data(runtime: any, pixel_data: any, flipx: any) {
    const members = runtime.members;
    if (flipx) {
  ...
  function method_ppu2c0x_device__draw_sprites(runtime: any, line_priority: any) {
    const members = runtime.members;
    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
    let sprite_count: any = 0;
    let size: any = ((((runtime.readIndex((members.m_regs ?? runtime.member("m_regs")), 0)) & (32))) ? (16) : (8));
  ...
  function method_palette_write(runtime: any, offset: any, data: any) {
    const members = runtime.members;
  ...
  function method_palette_read(runtime: any, offset: any) {
    const members = runtime.members;
  ...
  function method_ppu2c0x_device__read(runtime: any, offset: any) {
    const members = runtime.members;
    const h_m_security_value = members.m_security_value ?? runtime.member("m_security_value");
    const h_m_paletteram_in_ppuspace = members.m_paletteram_in_ppuspace ?? runtime.member("m_paletteram_in_ppuspace");
    if (((Number(offset) >= Number(8)) ? 1 : 0)) {
  ...
  function method_write(runtime: any, offset: any, data: any) {
    ...
    switch (((offset) & (7))) {
      ...
      case 7:
      {
        let tempAddr: any = (((members.m_videomem_addr ?? runtime.member("m_videomem_addr"))) & (h_m_videoram_addr_mask));
        if ((((runtime.calls["m_latch.isnull"]?.() ?? 0)) ? 0 : 1)) {
          (runtime.calls["m_latch"] ? runtime.calls["m_latch"](({ generatedLValue: true, get: () => tempAddr, set: (value: any) => { tempAddr = value; } })) : runtime.macro("m_latch", ({ generatedLValue: true, get: () => tempAddr, set: (value: any) => { tempAddr = value; } })));
        }
  ...
  function method_write_to_spriteram_with_increment(runtime: any, data: any) {
    const members = runtime.members;
  ...
  function method_writebyte(runtime: any, address: any, data: any) {
    const members = runtime.members;
    (runtime.calls["space().write_byte"]?.(address, data) ?? 0);
  }

  function method_ppu2c0x_device__write(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    const h_m_security_value = members.m_security_value ?? runtime.member("m_security_value");
    const h_m_line_write_increment_large = members.m_line_write_increment_large ?? runtime.member("m_line_write_increment_large");
    const h_m_global_refresh_mask = members.m_global_refresh_mask ?? runtime.member("m_global_refresh_mask");
  ...
  function method_render(runtime: any, bitmap: any, flipx: any, flipy: any, sx: any, sy: any, cliprect: any) {
    const members = runtime.members;
    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
  ...
  function method_update_scanline(runtime: any) {
    const members = runtime.members;
  ...
  function method_update_visible_scanline(runtime: any) {
    const members = runtime.members;
  ...
  function method_update_visible_enabled_scanline(runtime: any) {
    const members = runtime.members;
    if (((Number((typeof (runtime.dereference(members.m_scanline_timer)).remaining === 'function' ? (runtime.dereference(members.m_scanline_timer)).remaining() : typeof (runtime.dereference(members.m_scanline_timer)).remaining === 'number' || typeof (runtime.dereference(members.m_scanline_timer)).remaining === 'boolean' ? (runtime.dereference(members.m_scanline_timer)).remaining : runtime.container(members.m_scanline_timer, "remaining"))) === Number(0)) ? 1 : 0)) {
  ...
  function method_render_scanline(runtime: any) {
    const members = runtime.members;
  ...
  function method_update_visible_disabled_scanline(runtime: any) {
    const members = runtime.members;
    const h_m_paletteram_in_ppuspace = members.m_paletteram_in_ppuspace ?? runtime.member("m_paletteram_in_ppuspace");
    const h_m_bitmap = members.m_bitmap ?? runtime.member("m_bitmap");
  ...
  function method_scanline_increment_fine_ycounter(runtime: any) {
    const members = runtime.members;
  ...
  function method_hblank_tick(runtime: any, param: any) {
    const members = runtime.members;
    ...
    if ((((runtime.calls["m_hblank_callback_proc.isnull"]?.() ?? 0)) ? 0 : 1)) {
      (runtime.calls["m_hblank_callback_proc"] ? runtime.calls["m_hblank_callback_proc"](({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value: any) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value: any) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value: any) => { blanked = ((value) ? 1 : 0); } })) : runtime.macro("m_hblank_callback_proc", ({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value: any) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value: any) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value: any) => { blanked = ((value) ? 1 : 0); } })));
    }
    ((runtime.dereference(members.m_hblank_timer)).adjust?.(Infinity) ?? 0);
  }

  function method_nmi_tick(runtime: any, param: any) {
    const members = runtime.members;
  ...
  function method_scanline_tick(runtime: any, param: any) {
    const members = runtime.members;
    const h_m_vblank_first_scanline = members.m_vblank_first_scanline ?? runtime.member("m_vblank_first_scanline");
    ...
    if ((((runtime.calls["m_scanline_callback_proc.isnull"]?.() ?? 0)) ? 0 : 1)) {
      (runtime.calls["m_scanline_callback_proc"] ? runtime.calls["m_scanline_callback_proc"](({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value: any) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value: any) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value: any) => { blanked = ((value) ? 1 : 0); } })) : runtime.macro("m_scanline_callback_proc", ({ generatedLValue: true, get: () => (members.m_scanline ?? runtime.member("m_scanline")), set: (value: any) => { members.m_scanline = ((value) | 0); } }), ({ generatedLValue: true, get: () => vblank, set: (value: any) => { vblank = ((value) ? 1 : 0); } }), ({ generatedLValue: true, get: () => blanked, set: (value: any) => { blanked = ((value) ? 1 : 0); } })));
    }
    method_update_scanline(runtime);
    ...
    let next_scanline: any = (((members.m_scanline ?? runtime.member("m_scanline"))) + (1));
  ...
  function method_set_spriteram_value(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_spriteram"), offset, data);
  }

  function method_ppu2c0x_device__set_spriteram_value(runtime: any, offset: any, data: any) {
    const members = runtime.members;
    runtime.writeIndex(runtime.writableMember("m_spriteram"), offset, data);
  }
  return {
