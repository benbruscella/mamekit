...
definition.slot!.options["rom_huc3"]!.compiledMethods = (() => {
  ...
  function method_write_12bit(runtime: any, offset: any, data: any): any {
    ...
    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (0))) & (255))] = ((((data) >>> (0))) & (15));
    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (1))) & (255))] = ((((data) >>> (4))) & (15));
    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (2))) & (255))] = ((((data) >>> (8))) & (15));
  }
