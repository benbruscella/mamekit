...
definition.slot!.options["rom_wisdom"]!.compiledMethods = (() => {
  ...
  function method_bank_rom_switch(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    method_set_bank_rom(runtime, offset);
  }

  function method_set_bank_rom(runtime: any, entry: any): any {
    const members = runtime.members;
  ...
  function method_wisdom_device__bank_rom_switch(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_yong"]!.compiledMethods = (() => {
  ...
  function method_bank_rom_switch(runtime: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_sachen1"]!.compiledMethods = (() => {
  ...
  function method_rom_read(runtime: any, offset: any, spoof: any): any {
    const members = runtime.members;
  ...
  function method_bank_rom_high_base(runtime: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    return (typeof (runtime.dereference(h_m_bank_rom[1])).base === 'function' ? (runtime.dereference(h_m_bank_rom[1])).base() : typeof (runtime.dereference(h_m_bank_rom[1])).base === 'number' || typeof (runtime.dereference(h_m_bank_rom[1])).base === 'boolean' ? (runtime.dereference(h_m_bank_rom[1])).base : runtime.container(h_m_bank_rom[1], "base"));
  }

  function method_bank_rom_low_base(runtime: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    return (typeof (runtime.dereference(h_m_bank_rom[0])).base === 'function' ? (runtime.dereference(h_m_bank_rom[0])).base() : typeof (runtime.dereference(h_m_bank_rom[0])).base === 'number' || typeof (runtime.dereference(h_m_bank_rom[0])).base === 'boolean' ? (runtime.dereference(h_m_bank_rom[0])).base : runtime.container(h_m_bank_rom[0], "base"));
  }

  function method_bank_rom_switch_outer(runtime: any, data: any): any {
    const members = runtime.members;

    if (((Number(48) === Number((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1]) & (48)))) ? 1 : 0)) {
      (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0] = data;
      method_update_banks(runtime);
    }
  }

  function method_update_banks(runtime: any): any {
    const members = runtime.members;
  ...
  function method_bank_rom_entry_low(runtime: any): any {
    const members = runtime.members;

    return (((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0]) & ((members.m_bank_mux_rom ?? runtime.member("m_bank_mux_rom"))));
  }

  function method_bank_rom_entry_high(runtime: any): any {
    const members = runtime.members;

    return (((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0]) & ((members.m_bank_mux_rom ?? runtime.member("m_bank_mux_rom"))))) | ((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1]) & ((~(members.m_bank_mux_rom ?? runtime.member("m_bank_mux_rom")))))));
  }

  function method_set_bank_rom_low(runtime: any, entry: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    entry = ((runtime.andAssign(entry, (members.m_bank_mask_rom ?? runtime.member("m_bank_mask_rom")))) & 0xffff);
    0;
    ((runtime.dereference(h_m_bank_rom[0])).set_entry?.(entry) ?? 0);
  }

  function method_set_bank_rom_high(runtime: any, entry: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    entry = ((runtime.andAssign(entry, (members.m_bank_mask_rom ?? runtime.member("m_bank_mask_rom")))) & 0xffff);
    0;
    ((runtime.dereference(h_m_bank_rom[1])).set_entry?.(entry) ?? 0);
  }

  function method_bank_rom_switch_inner(runtime: any, data: any): any {
    const members = runtime.members;

    (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1] = ((data) ? (data) : (1));
    let hi: any = ((((method_bank_rom_entry_high(runtime)) & 0xffff)) & 0xffff);
    0;
    method_set_bank_rom_high(runtime, hi);
  }

  function method_bank_rom_mux(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_sachen_mmc_device_base__rom_read(runtime: any, offset: any, spoof: any): any {
    const members = runtime.members;
  ...
  function method_read_rom(runtime: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_sachen_mmc1_device__read_rom(runtime: any, offset: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
...
definition.slot!.options["rom_sachen1"]!.compiledMethodLinks = ["machine","machine().side_effects_disabled"];
definition.slot!.options["rom_lasama"]!.compiledMethods = (() => {

  function method_ctrl_2080_w(runtime: any, data: any): any {
    const members = runtime.members;

    method_set_bank_rom_fine(runtime, ((data) & (3)));
  }

  function method_set_bank_rom_fine(runtime: any, entry: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1] = entry;
    let hi: any = ((((method_bank_rom_entry_high(runtime)) & 0xffff)) & 0xffff);
    0;
    ((runtime.dereference(h_m_bank_rom[1])).set_entry?.(hi) ?? 0);
  }

  function method_bank_rom_entry_high(runtime: any): any {
    const members = runtime.members;

    let coarse: any = (((((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0]) & ((members.m_bank_rom_coarse_mask ?? runtime.member("m_bank_rom_coarse_mask"))[1]))) & 0xffff)) & 0xffff);
    return (((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1]) | (((coarse) << ((members.m_bank_bits_rom ?? runtime.member("m_bank_bits_rom"))[1]))))) & ((members.m_bank_mask_rom ?? runtime.member("m_bank_mask_rom"))[1]));
  }

  function method_ctrl_6000_w(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_set_bank_rom_coarse(runtime: any, entry: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0] = entry;
    let lo: any = ((((method_bank_rom_entry_low(runtime)) & 0xffff)) & 0xffff);
    let hi: any = ((((method_bank_rom_entry_high(runtime)) & 0xffff)) & 0xffff);
    0;
    ((runtime.dereference(h_m_bank_rom[0])).set_entry?.(lo) ?? 0);
    ((runtime.dereference(h_m_bank_rom[1])).set_entry?.(hi) ?? 0);
  }
  ...
  function method_bank_rom_entry_low(runtime: any): any {
    ...
    return (((((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[0]) & ((members.m_bank_rom_coarse_mask ?? runtime.member("m_bank_rom_coarse_mask"))[0]))) & ((members.m_bank_mask_rom ?? runtime.member("m_bank_mask_rom"))[0]));
  }
  return {
...
definition.slot!.options["rom_mbc1"]!.compiledMethods = (() => {
  ...
  function method_bank_switch_coarse(runtime: any, data: any): any {
    const members = runtime.members;

    method_set_bank_rom_coarse(runtime, ((data) & ((members.m_bank_lines ?? runtime.member("m_bank_lines"))[1])));
    method_set_bank_ram(runtime, ((data) & ((members.m_bank_lines ?? runtime.member("m_bank_lines"))[1])));
  }
  ...
  function method_set_bank_ram(runtime: any, entry: any): any {
    const members = runtime.members;
  ...
  function method_bank_ram_entry(runtime: any): any {
    const members = runtime.members;
  ...
  function method_enable_ram(runtime: any, data: any): any {
    const members = runtime.members;

    method_set_ram_enable(runtime, ((Number(10) === Number(((data) & (15)))) ? 1 : 0));
  }

  function method_set_ram_enable(runtime: any, enable: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_fine(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_set_bank_rom_fine(runtime: any, entry: any): any {
    ...
    method_mbc_dual_device_base__set_bank_rom_fine(runtime, ((entry) & ((members.m_bank_lines ?? runtime.member("m_bank_lines"))[0])));
  }

  function method_mbc_dual_device_base__set_bank_rom_fine(runtime: any, entry: any): any {
    const members = runtime.members;
  ...
  function method_bank_low_mask(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_set_bank_rom_low_coarse_mask(runtime: any, mask: any): any {
    const members = runtime.members;

    const h_m_bank_rom = members.m_bank_rom ?? runtime.member("m_bank_rom");
    (members.m_bank_rom_coarse_mask ?? runtime.member("m_bank_rom_coarse_mask"))[0] = mask;
    let lo: any = ((((method_bank_rom_entry_low(runtime)) & 0xffff)) & 0xffff);
    0;
    ((runtime.dereference(h_m_bank_rom[0])).set_entry?.(lo) ?? 0);
  }

  function method_set_bank_ram_mask(runtime: any, mask: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_mbc2"]!.compiledMethods = (() => {
  ...
  function method_ram_mbc_read(runtime: any, space: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_ram_mbc_write(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_ram_mbc_enable(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_rom_switch(runtime: any, data: any): any {
    ...
    (__l["set_bank_rom"] ? __l["set_bank_rom"](((data) ? (data) : (1))) : runtime.macro("set_bank_rom", ((data) ? (data) : (1))));
  }
  return {
...
definition.slot!.options["rom_mbc2"]!.compiledMethodLinks = ["set_bank_rom"];
definition.slot!.options["rom_mbc3"]!.compiledMethods = (() => {

  function method_enable_ram_rtc(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_rtc_select(runtime: any): any {
    const members = runtime.members;
  ...
  function method_select_ram_rtc(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_latch_rtc(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    if ((((((((((members.m_rtc_latch ?? runtime.member("m_rtc_latch"))) >>> (0)) & 1)) ? 0 : 1)) && ((((data) >>> (0)) & 1))) ? 1 : 0)) {
      0;
      (__l["std::copy"] ? __l["std::copy"]((__l["std::begin"] ? __l["std::begin"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0)) : runtime.macro("std::begin", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0))), (__l["std::end"] ? __l["std::end"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0)) : runtime.macro("std::end", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0))), (__l["std::begin"] ? __l["std::begin"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 1)) : runtime.macro("std::begin", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 1)))) : runtime.macro("std::copy", (__l["std::begin"] ? __l["std::begin"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0)) : runtime.macro("std::begin", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0))), (__l["std::end"] ? __l["std::end"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0)) : runtime.macro("std::end", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 0))), (__l["std::begin"] ? __l["std::begin"](runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 1)) : runtime.macro("std::begin", runtime.readIndex((members.m_rtc_regs ?? runtime.member("m_rtc_regs")), 1)))));
    }
    members.m_rtc_latch = ((data) & 0xff);
  }

  function method_read_rtc(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_rtc_register(runtime: any): any {
    const members = runtime.members;

    return (((members.m_rtc_select ?? runtime.member("m_rtc_select"))) & (7));
  }

  function method_write_rtc(runtime: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_mbc3"]!.compiledMethodLinks = ["std::begin","std::copy","std::end"];
definition.slot!.options["rom_mbc5"]!.compiledMethods = (() => {

  function method_rom_mbc_device_base__bank_switch_coarse(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_fine_low(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_rom_fine(runtime: any): any {
    const members = runtime.members;

    return (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))[1];
  }

  function method_bank_switch_fine_high(runtime: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_m161"]!.compiledMethods = (() => {
  ...
  function method_m161_device__bank_rom_switch(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_mmm01"]!.compiledMethods = (() => {
  ...
  function method_enable_ram(runtime: any, data: any): any {
    ...
    if ((members.m_config ?? runtime.member("m_config"))) {
      (members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[0] = (((data) >>> (4)) & ((1 << (2)) - 1));
      0;
      if ((((data) >>> (6)) & 1)) {
        0;
  ...
  function method_update_bank_rom_low(runtime: any): any {
    const members = runtime.members;

    let entry: any = ((0) & 0xffff);
    if ((((members.m_config ?? runtime.member("m_config"))) ? 0 : 1)) {
      entry = (((((((((members.m_bank_sel_rom_coarse ?? runtime.member("m_bank_sel_rom_coarse"))) & 0xffff)) << (7))) | ((((members.m_bank_sel_rom_fine ?? runtime.member("m_bank_sel_rom_fine"))) & ((members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[1]))))) & 0xffff);
      if ((((members.m_mode_large_prg ?? runtime.member("m_mode_large_prg"))) ? 0 : 1)) {
        entry = ((((entry) | ((((members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[1]) << (5))))) & 0xffff);
      } else {
        if ((members.m_bank_low_mid ?? runtime.member("m_bank_low_mid"))) {
          entry = ((((entry) | ((((members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[0]) << (5))))) & 0xffff);
        }
      }
    } else {
      entry = ((510) & 0xffff);
  ...
  function method_update_bank_rom_high(runtime: any): any {
    const members = runtime.members;
    ...
    if ((((((members.m_bank_sel_rom_fine ?? runtime.member("m_bank_sel_rom_fine"))) & ((~(members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[1])))) ? 0 : 1)) {
  ...
  function method_bank_switch_fine(runtime: any, data: any): any {
    ...
    members.m_bank_sel_rom_fine = (((((((members.m_bank_sel_rom_fine ?? runtime.member("m_bank_sel_rom_fine"))) & ((members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[1]))) | ((((((data) >>> (0)) & ((1 << (5)) - 1))) & ((~(members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[1])))))) & 0xff);
    0;
    if ((members.m_config ?? runtime.member("m_config"))) {
      (members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[1] = (((data) >>> (5)) & ((1 << (2)) - 1));
      0;
    }
    method_update_bank_rom_high(runtime);
  ...
  function method_update_bank_ram(runtime: any): any {
    const members = runtime.members;
    ...
    if ((members.m_mode_large_prg ?? runtime.member("m_mode_large_prg"))) {
      entry = ((((entry) | ((members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[1]))) & 0xff);
    } else {
      if ((members.m_bank_low_mid ?? runtime.member("m_bank_low_mid"))) {
        entry = ((((entry) | ((members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[0]))) & 0xff);
      }
    }
  ...
  function method_bank_switch_coarse(runtime: any, data: any): any {
    ...
    (members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[0] = (((((members.m_bank_sel_mid ?? runtime.member("m_bank_sel_mid"))[0]) & ((members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[0]))) | ((((((data) >>> (0)) & ((1 << (2)) - 1))) & ((~(members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[0])))));
    0;
    if ((members.m_config ?? runtime.member("m_config"))) {
  ...
  function method_enable_bank_low_mid(runtime: any, data: any): any {
    const members = runtime.members;
    ...
    if ((members.m_config ?? runtime.member("m_config"))) {
      (members.m_bank_prot_sel ?? runtime.member("m_bank_prot_sel"))[1] = (((((data) >>> (2)) & ((1 << (4)) - 1))) << (1));
...
definition.slot!.options["rom_camera"]!.compiledMethods = (() => {
  ...
  function method_mbc_ram_device_base__device_start(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;

    method_mbc_device_base__device_start(runtime);
    ((runtime.dereference((members.this ?? runtime.member("this")))).save_item?.((__l["NAME"] ? __l["NAME"]((members.m_bank_sel_ram ?? runtime.member("m_bank_sel_ram"))) : runtime.macro("NAME", (members.m_bank_sel_ram ?? runtime.member("m_bank_sel_ram"))))) ?? 0);
    ((runtime.dereference((members.this ?? runtime.member("this")))).save_item?.((__l["NAME"] ? __l["NAME"]((members.m_bank_mask_ram ?? runtime.member("m_bank_mask_ram"))) : runtime.macro("NAME", (members.m_bank_mask_ram ?? runtime.member("m_bank_mask_ram"))))) ?? 0);
  }

  function method_mbc_device_base__device_start(runtime: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_rom(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_ram(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_write_ram(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_read_camera(runtime: any, offset: any): any {
    const members = runtime.members;
  ...
  function method_write_camera(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch (offset) {
      case 0:
      {
        ...
        if ((((data) >>> (0)) & 1)) {
          if ((((members.m_busy ?? runtime.member("m_busy"))) ? 0 : 1)) {
            (__l["start_capture"] ? __l["start_capture"]() : runtime.macro("start_capture"));
          } else {
            0;
          }
        }
      ...
      case 1:
      {
        (members.m_n ?? runtime.member("m_n"))[0] = (((data) >>> (7)) & 1);
        (members.m_vh ?? runtime.member("m_vh"))[0] = (((data) >>> (5)) & ((1 << (2)) - 1));
        (members.m_g ?? runtime.member("m_g"))[0] = (((data) >>> (0)) & ((1 << (5)) - 1));
        0;
        break;
      }
      case 2:
      {
        (members.m_c ?? runtime.member("m_c"))[0] = (((((members.m_c ?? runtime.member("m_c"))[0]) & (255))) | (((((data) & 0xffff)) << (8))));
        0;
        break;
      }
      case 3:
      {
        (members.m_c ?? runtime.member("m_c"))[0] = (((((members.m_c ?? runtime.member("m_c"))[0]) & (65280))) | (data));
        0;
        break;
      }
      case 4:
      {
        (members.m_e ?? runtime.member("m_e"))[0] = (((data) >>> (4)) & ((1 << (4)) - 1));
        (members.m_i ?? runtime.member("m_i"))[0] = (((data) >>> (3)) & 1);
        (members.m_v ?? runtime.member("m_v"))[0] = (((data) >>> (0)) & ((1 << (3)) - 1));
        0;
        break;
      }
      case 5:
      {
        (members.m_z ?? runtime.member("m_z"))[0] = (((data) >>> (6)) & ((1 << (2)) - 1));
        (members.m_o ?? runtime.member("m_o"))[0] = (((data) >>> (0)) & ((1 << (6)) - 1));
        0;
        break;
      }
    }
  ...
  function method_bank_ram(runtime: any): any {
    const members = runtime.members;

    return (members.m_bank_sel_ram ?? runtime.member("m_bank_sel_ram"));
  }
  return {
    "mbc_ram_device_base::device_start": method_mbc_ram_device_base__device_start,
...
definition.slot!.options["rom_camera"]!.compiledMethodLinks = ["NAME","start_capture"];
...
definition.slot!.options["rom_huc1"]!.compiledMethods = (() => {
  ...
  function method_infrared_select(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_read_ir(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_write_ir(runtime: any, data: any): any {
    const members = runtime.members;
...
definition.slot!.options["rom_huc3"]!.compiledMethods = (() => {
  ...
  function method_io_select(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_write_command(runtime: any, data: any): any {
    const members = runtime.members;
  ...
  function method_read_command(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_read_status(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_write_control(runtime: any, data: any): any {
    const members = runtime.members;
    ...
    if ((((((data) >>> (0)) & 1)) ? 0 : 1)) {
      switch ((members.m_ctrl_cmd ?? runtime.member("m_ctrl_cmd"))) {
        ...
        {
          0;
          members.m_ctrl_data = (((((members.m_registers ?? runtime.member("m_registers"))[(() => { const previous = members.m_ctrl_addr; members.m_ctrl_addr = ((((members.m_ctrl_addr) + (1))) & 0xff); return previous; })()]) & (15))) & 0xff);
          break;
        }
        case 3:
        {
          0;
          (members.m_registers ?? runtime.member("m_registers"))[(() => { const previous = members.m_ctrl_addr; members.m_ctrl_addr = ((((members.m_ctrl_addr) + (1))) & 0xff); return previous; })()] = (((members.m_ctrl_data ?? runtime.member("m_ctrl_data"))) & (15));
          break;
        }
        case 4:
        {
  ...
  function method_execute_instruction(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch ((((members.m_ctrl_data ?? runtime.member("m_ctrl_data"))) & (15))) {
      ...
      case 1:
      {
        ...
        while (((Number(1440) <= Number(((eventminutes) + (minutesdelta)))) ? 1 : 0)) {
          minutesdelta = ((((minutesdelta) - (1440))) << 16 >> 16);
  ...
  function method_read_12bit(runtime: any, offset: any): any {
    const members = runtime.members;

    return (((((((((((members.m_registers ?? runtime.member("m_registers"))[((((offset) + (0))) & (255))]) & (15))) & 0xffff)) << (0))) | ((((((((members.m_registers ?? runtime.member("m_registers"))[((((offset) + (1))) & (255))]) & (15))) & 0xffff)) << (4))))) | ((((((((members.m_registers ?? runtime.member("m_registers"))[((((offset) + (2))) & (255))]) & (15))) & 0xffff)) << (8))));
  }

  function method_write_12bit(runtime: any, offset: any, data: any): any {
    const members = runtime.members;

    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (0))) & (255))] = ((runtime.shiftRight(data, 0)) & (15));
    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (1))) & (255))] = ((runtime.shiftRight(data, 4)) & (15));
    (members.m_registers ?? runtime.member("m_registers"))[((((offset) + (2))) & (255))] = ((runtime.shiftRight(data, 8)) & (15));
  }
  ...
  function method_rtc_advance_seconds(runtime: any, param: any): any {
    const members = runtime.members;

    if (((Number(59) > Number((members.m_seconds ?? runtime.member("m_seconds")))) ? 1 : 0)) {
    ...
    if (((Number(1439) > Number(minutes)) ? 1 : 0)) {
  ...
  function method_huc3_device__execute_instruction(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
...
definition.slot!.options["rom_huc3"]!.compiledMethodLinks = ["std::copy_n"];
definition.slot!.options["rom_tama5"]!.compiledMethods = (() => {

  function method_data_r(runtime: any, space: any): any {
    const members = runtime.members;
  ...
  function method_data_w(runtime: any, data: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
    ...
    switch ((members.m_command ?? runtime.member("m_command"))) {
      case 0:
      {
        ...
        (__l["set_bank_rom"] ? __l["set_bank_rom"]((members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))) : runtime.macro("set_bank_rom", (members.m_bank_sel_rom ?? runtime.member("m_bank_sel_rom"))));
        break;
      }
      case 1:
      {
      ...
      case 7:
      {
        ...
        switch ((((members.m_address ?? runtime.member("m_address"))) & (224))) {
          ...
          {
            0;
            (members.m_registers ?? runtime.member("m_registers"))[(((members.m_address ?? runtime.member("m_address"))) & (31))] = (members.m_data ?? runtime.member("m_data"));
            break;
          }
          case 32:
          {
            0;
            members.m_data = (((members.m_registers ?? runtime.member("m_registers"))[(((members.m_address ?? runtime.member("m_address"))) & (31))]) & 0xff);
            break;
          }
          case 64:
          {
  ...
  function method_command_w(runtime: any, data: any): any {
    const members = runtime.members;
    ...
    switch (data) {
      ...
      case 13:
      {
        members.m_response = ((runtime.shiftRight((members.m_data ?? runtime.member("m_data")), 4)) & 0xff);
        break;
      }
      default:
      {
...
definition.slot!.options["rom_tama5"]!.compiledMethodLinks = ["set_bank_rom"];
definition.slot!.options["rom_liebao"]!.compiledMethods = (() => {

  function method_enable_ram(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_rom(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
  ...
  function method_bank_switch_rom_high(runtime: any, offset: any, data: any): any {
    const members = runtime.members;
