...
const GENERATED_METHOD_NAMES = new Set(["cycles_passed", "mem_read_byte", "mem_write_byte", "mem_read_word", "mem_write_word", "check_interrupts", "execute_set_input", "get_speed", "set_speed", "set_halt_bug", "get_ie", "set_ie", "get_if", "set_if", "dma_cycles_to_burn"]);
class GeneratedLR35902 {
    bus;
    irqData = 0xff;
    irqHold = false;
    ...
    m_C = ((0) & 0xff);
    m_D = ((0) & 0xff);
    m_dma_cycles_to_burn = ((0) >>> 0);
    m_E = ((0) & 0xff);
    m_enable = ((0) >>> 0);
    m_entering_halt = ((0) ? 1 : 0);
    m_execution_state = ((0) >>> 0);
    m_F = ((0) & 0xff);
    m_gb_speed = ((0) >>> 0);
    m_gb_speed_change_pending = ((0) >>> 0);
    m_H = ((0) & 0xff);
    m_handle_ei_delay = ((0) ? 1 : 0);
    m_has_halt_bug = ((0) ? 1 : 0);
    m_icount = 0;
    m_IE = ((0) & 0xff);
    m_IF = ((0) & 0xff);
    m_irq_state = ((0) >>> 0);
    ...
    m_PC = ((0) & 0xffff);
    m_SP = ((0) & 0xffff);
    get PC() { return this.m_PC; }
    set PC(value) { this.m_PC = ((value) & 0xffff); }
    get SP() { return this.m_SP; }
    set SP(value) { this.m_SP = ((value) & 0xffff); }
    get A() { return this.m_A; }
    set A(value) { this.m_A = ((value) & 0xff); }
    get F() { return this.m_F; }
    set F(value) { this.m_F = ((value) & 0xff); }
    get B() { return this.m_B; }
    set B(value) { this.m_B = ((value) & 0xff); }
    get C() { return this.m_C; }
    set C(value) { this.m_C = ((value) & 0xff); }
    get D() { return this.m_D; }
    set D(value) { this.m_D = ((value) & 0xff); }
    get E() { return this.m_E; }
    set E(value) { this.m_E = ((value) & 0xff); }
    get H() { return this.m_H; }
    set H(value) { this.m_H = ((value) & 0xff); }
    get L() { return this.m_L; }
    set L(value) { this.m_L = ((value) & 0xff); }
    get IRQ() { return this.m_enable; }
    set IRQ(value) { this.m_enable = ((value) >>> 0); }
    get IE() { return this.m_IE; }
    set IE(value) { this.m_IE = ((value) & 0xff); }
    get IF() { return this.m_IF; }
    set IF(value) { this.m_IF = ((value) & 0xff); }
    get GENPC() { return this.m_PC; }
    set GENPC(value) { this.m_PC = ((value) & 0xffff); }
    get CURPC() { return this.m_PC; }
    set CURPC(value) { this.m_PC = ((value) & 0xffff); }
    get GENFLAGS() { return this.m_F; }
    set GENFLAGS(value) { this.m_F = ((value) & 0xff); }
    constructor(bus) {
        this.bus = bus;
        this.generatedStart();
        this.reset();
    ...
    set(name, value) {
        switch (name) {
            ...
            case "m_D":
                this.m_D = ((value) & 0xff);
                return;
            case "m_dma_cycles_to_burn":
                this.m_dma_cycles_to_burn = ((value) >>> 0);
                return;
            case "m_E":
                this.m_E = ((value) & 0xff);
                return;
            case "m_enable":
                this.m_enable = ((value) >>> 0);
                return;
            case "m_entering_halt":
                this.m_entering_halt = ((value) ? 1 : 0);
                return;
            case "m_execution_state":
                this.m_execution_state = ((value) >>> 0);
                return;
            case "m_F":
                this.m_F = ((value) & 0xff);
                return;
            case "m_gb_speed":
                this.m_gb_speed = ((value) >>> 0);
                return;
            case "m_gb_speed_change_pending":
                this.m_gb_speed_change_pending = ((value) >>> 0);
                return;
            case "m_H":
                this.m_H = ((value) & 0xff);
                return;
            case "m_handle_ei_delay":
                this.m_handle_ei_delay = ((value) ? 1 : 0);
                return;
            case "m_has_halt_bug":
                this.m_has_halt_bug = ((value) ? 1 : 0);
                return;
            case "m_icount":
                this.m_icount = value;
                return;
            case "m_IE":
                this.m_IE = ((value) & 0xff);
                return;
            case "m_IF":
                this.m_IF = ((value) & 0xff);
                return;
            case "m_irq_state":
                this.m_irq_state = ((value) >>> 0);
                return;
            case "m_L":
                this.m_L = ((value) & 0xff);
                return;
            case "m_op":
                this.m_op = ((value) & 0xff);
                return;
            case "m_PC":
    ...
    method_execute_set_input(inptnum = 0, state = 0) {
        this.m_irq_state = ((state) >>> 0);
        if (((Number(state) === Number(1)) ? 1 : 0)) {
    ...
    method_set_speed(speed_request = 0) {
        this.m_gb_speed_change_pending = ((((speed_request) & (1))) >>> 0);
        return 0;
    }
    method_set_halt_bug(has_halt_bug = 0) {
    ...
    method_set_if(data = 0) {
        this.m_IF = ((data) & 0xff);
        return 0;
    }
    method_dma_cycles_to_burn(cycles_to_burn = 0) {
...
export const cpu = {
    ...
    create: (bus) => new GeneratedLR35902(bus),
};
export default cpu;
