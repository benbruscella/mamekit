...
// - src/devices/cpu/m6502/m6510.cpp
// - src/devices/cpu/m6502/m6510.h
// - src/devices/cpu/m6502/om6502.lst
// - src/devices/cpu/m6502/om6510.lst
// - src/devices/cpu/m6502/dm6510.lst
import type {
  Cpu,
  CpuBus,
...
const GENERATED_METHOD_NAMES = new Set<string>(["do_adc","do_adc_d","do_adc_nd","do_arr","do_arr_d","do_arr_nd","do_sbc","do_sbc_d","do_sbc_nd","do_cmp","do_bit","do_asl","do_lsr","do_ror","do_rol","do_asr","set_nz","set_l","set_h","page_changing","dec_SP","inc_SP","set_pulls","update_port","get_port","dir_r","port_r","dir_w","port_w","memory_read","memory_opcode","memory_arg","memory_write"]);

class GeneratedM6510 implements Cpu {
  ...
  private m_sync = ((0) ? 1 : 0);
  private m_ref = ((0) >>> 0);
  private cycles = 0;
  private m_icount = 0;
  private m_pullup = ((0) & 0xff);
  private m_floating = ((0) & 0xff);
  private m_dir = ((0) & 0xff);
  private m_port = ((0) & 0xff);
  private m_drive = ((0) & 0xff);
  ...
  reset(): void {
    this.resetInternal();
    this.m_dir = ((255) & 0xff);
    this.m_port = ((255) & 0xff);
    this.m_drive = ((255) & 0xff);
    this.method_update_port();
    this.method_memory_arg(this.m_PC);
    this.method_memory_arg(this.m_PC);
    this.method_memory_read(this.m_SP);
    this.method_dec_SP();
    this.method_memory_read(this.m_SP);
    this.method_dec_SP();
    this.method_memory_read(this.m_SP);
    ...
    this.m_PC = ((this.method_memory_arg(65532)) & 0xffff);
    this.m_PC = ((this.method_set_h(this.m_PC, this.method_memory_arg(65533))) & 0xffff);
  }
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('M6510 dispatch loop exceeded 8');
      ...
      case 0x0000: {
        ...
        this.method_memory_write(this.m_SP, ((this.m_PC) >>> (8)));
        this.method_dec_SP();
        this.method_memory_write(this.m_SP, this.m_PC);
        this.method_dec_SP();
        this.method_memory_write(this.m_SP, ((this.m_irq_taken) ? (((this.m_P) & ((~16)))) : (this.m_P)));
        this.method_dec_SP();
        if (this.m_nmi_pending) {
          this.acknowledgeIrq(-1);
          this.m_PC = ((this.method_memory_arg(65530)) & 0xffff);
          this.m_PC = ((this.method_set_h(this.m_PC, this.method_memory_arg(65531))) & 0xffff);
          this.m_nmi_pending = ((0) ? 1 : 0);
        } else {
          if (this.m_irq_taken) {
            this.acknowledgeIrq(0);
          }
          this.m_PC = ((this.method_memory_arg(65534)) & 0xffff);
          this.m_PC = ((this.method_set_h(this.m_PC, this.method_memory_arg(65535))) & 0xffff);
        }
      ...
      case 0x0100: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP2);
        this.m_TMP2 = ((((this.m_TMP2) + (this.m_X))) & 0xff);
        this.m_TMP = ((this.method_memory_read(((this.m_TMP2) & (255)))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.m_TMP2 = ((this.method_memory_read(this.m_TMP)) & 0xff);
      ...
      case 0x0300: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.m_TMP2 = ((this.method_memory_read(this.m_TMP)) & 0xff);
        this.method_memory_write(this.m_TMP, this.m_TMP2);
      ...
      case 0x0400: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        return this.cycles;
      }
      case 0x0500: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x0800: {
        this.method_memory_arg(this.m_PC);
        this.method_memory_write(this.m_SP, this.m_P);
        this.method_dec_SP();
        return this.cycles;
      }
      case 0x0900: {
      ...
      case 0x0c00: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_arg(this.m_PC))) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        return this.cycles;
      }
      ...
      case 0x1000: {
        ...
        if (((((this.m_P) & (128))) ? 0 : 1)) {
          ...
          if (this.method_page_changing(this.m_PC, (((this.m_TMP) << 24) >> 24))) {
            this.method_memory_arg(this.method_set_l(this.m_PC, ((this.m_PC) + ((((this.m_TMP) << 24) >> 24)))));
          }
      ...
      case 0x1100: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_TMP = ((this.method_memory_read(this.m_TMP2)) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        if (this.method_page_changing(this.m_TMP, this.m_Y)) {
          this.method_memory_read(this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y))));
        }
        this.m_TMP2 = ((this.method_memory_read(((this.m_TMP) + (this.m_Y)))) & 0xff);
        this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0x1400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.method_memory_read(((((this.m_TMP) + (this.m_X))) & 0xff));
        return this.cycles;
      }
      case 0x1500: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.m_TMP2 = ((this.method_memory_read(((((this.m_TMP) + (this.m_X))) & 0xff))) & 0xff);
        this.m_A = ((((this.m_A) | (this.m_TMP2))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0x1c00: {
        ...
        if (this.method_page_changing(this.m_TMP, this.m_X)) {
          this.method_memory_read(this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X))));
        }
        this.method_memory_read(((this.m_TMP) + (this.m_X)));
        return this.cycles;
      }
      case 0x1d00: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x2800: {
        ...
        this.method_memory_read(this.m_SP);
        this.method_inc_SP();
        this.m_TMP = ((((this.method_memory_read(this.m_SP)) | (((16) | (32))))) & 0xffff);
      ...
      case 0x4000: {
        ...
        this.method_memory_read(this.m_SP);
        this.method_inc_SP();
        this.m_P = ((((this.method_memory_read(this.m_SP)) | (((16) | (32))))) & 0xff);
        this.method_inc_SP();
        this.m_PC = ((this.method_memory_read(this.m_SP)) & 0xffff);
        this.method_inc_SP();
        this.m_PC = ((this.method_set_h(this.m_PC, this.method_memory_read(this.m_SP))) & 0xffff);
        return this.cycles;
      }
      case 0x4100: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
      ...
      case 0x4800: {
        this.method_memory_arg(this.m_PC);
        this.method_memory_write(this.m_SP, this.m_A);
        this.method_dec_SP();
        return this.cycles;
      }
      case 0x4900: {
      ...
      case 0x4b00: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_A = ((this.method_do_lsr(((this.m_A) & (this.m_TMP2)))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0x4c00: {
      ...
      case 0x6800: {
        ...
        this.method_memory_read(this.m_SP);
        this.method_inc_SP();
        this.m_A = ((this.method_memory_read(this.m_SP)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0x6900: {
      ...
      case 0x6c00: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_arg(this.m_PC))) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_PC = ((this.method_memory_read(this.m_TMP)) & 0xffff);
        this.m_PC = ((this.method_set_h(this.m_PC, this.method_memory_read(this.method_set_l(this.m_TMP, ((this.m_TMP) + (1)))))) & 0xffff);
        return this.cycles;
      }
      case 0x6d00: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x8100: {
        ...
        this.m_TMP = ((this.method_memory_read(((this.m_TMP2) & (255)))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.method_memory_write(this.m_TMP, this.m_A);
        return this.cycles;
      }
      case 0x8200: {
        this.method_memory_arg(this.m_PC);
      ...
      case 0x8400: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_write(this.m_TMP, this.m_Y);
        return this.cycles;
      }
      case 0x8500: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x8600: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_write(this.m_TMP, this.m_X);
        return this.cycles;
      }
      case 0x8700: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x8b00: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_A = ((((((((this.m_A) | (238))) & (this.m_TMP2))) & (this.m_X))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0x8c00: {
      ...
      case 0x9100: {
        ...
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.method_memory_read(this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_Y))));
        this.method_memory_write(((this.m_TMP) + (this.m_Y)), this.m_A);
        return this.cycles;
      }
      case 0x9200: {
        (++this.cycles, this.readMemory((65535) & 65535) & 0xff);
      ...
      case 0x9400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.method_memory_write(((((this.m_TMP) + (this.m_X))) & 0xff), this.m_Y);
        return this.cycles;
      }
      case 0x9500: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.method_memory_write(((((this.m_TMP) + (this.m_X))) & 0xff), this.m_A);
        return this.cycles;
      }
      case 0x9600: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.method_memory_write(((((this.m_TMP) + (this.m_Y))) & 0xff), this.m_X);
        return this.cycles;
      }
      case 0x9700: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0x9d00: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.method_set_l(this.m_TMP, ((this.m_TMP) + (this.m_X))));
        this.method_memory_write(((this.m_TMP) + (this.m_X)), this.m_A);
        return this.cycles;
      }
      case 0x9e00: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
      ...
      case 0xa000: {
        this.m_Y = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xa100: {
        ...
        this.m_TMP = ((this.method_memory_read(((this.m_TMP2) & (255)))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.m_A = ((this.method_memory_read(this.m_TMP)) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xa200: {
        this.m_X = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
      ...
      case 0xa300: {
        ...
        this.m_TMP = ((this.method_memory_read(((this.m_TMP2) & (255)))) & 0xffff);
        this.m_TMP = ((this.method_set_h(this.m_TMP, this.method_memory_read(((((this.m_TMP2) + (1))) & (255))))) & 0xffff);
        this.m_A = (((this.m_X = ((this.method_memory_read(this.m_TMP)) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xa400: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_Y = ((this.method_memory_read(this.m_TMP)) & 0xff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xa500: {
      ...
      case 0xa600: {
        this.m_TMP = ((this.method_memory_arg(this.m_PC)) & 0xffff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_X = ((this.method_memory_read(this.m_TMP)) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xa700: {
      ...
      case 0xa900: {
        this.m_A = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      ...
      case 0xab00: {
        this.m_TMP2 = ((this.method_memory_arg(this.m_PC)) & 0xff);
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.m_A = (((this.m_X = ((((((this.m_A) | (238))) & (this.m_TMP2))) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xac00: {
      ...
      case 0xb100: {
        ...
        this.m_A = ((this.method_memory_read(((this.m_TMP) + (this.m_Y)))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb200: {
      ...
      case 0xb300: {
        ...
        this.m_A = (((this.m_X = ((this.method_memory_read(((this.m_TMP) + (this.m_Y)))) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb400: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.m_Y = ((this.method_memory_read(((((this.m_TMP) + (this.m_X))) & 0xff))) & 0xff);
        this.method_set_nz(this.m_Y);
        return this.cycles;
      }
      case 0xb500: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.m_A = ((this.method_memory_read(((((this.m_TMP) + (this.m_X))) & 0xff))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xb600: {
        ...
        this.m_PC = ((((this.m_PC) + (1))) & 0xffff);
        this.method_memory_read(this.m_TMP);
        this.m_X = ((this.method_memory_read(((((this.m_TMP) + (this.m_Y))) & 0xff))) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xb700: {
      ...
      case 0xbb00: {
        ...
        this.m_TMP2 = ((this.method_memory_read(((this.m_TMP) + (this.m_Y)))) & 0xff);
        this.m_A = (((this.m_X = ((((this.m_TMP2) & (this.m_SP))) & 0xff))) & 0xff);
        this.m_SP = ((this.method_set_l(this.m_SP, this.m_A)) & 0xffff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xbc00: {
      ...
      case 0xbd00: {
        ...
        this.m_A = ((this.method_memory_read(((this.m_TMP) + (this.m_X)))) & 0xff);
        this.method_set_nz(this.m_A);
        return this.cycles;
      }
      case 0xbe00: {
        ...
        this.m_X = ((this.method_memory_read(((this.m_TMP) + (this.m_Y)))) & 0xff);
        this.method_set_nz(this.m_X);
        return this.cycles;
      }
      case 0xbf00: {
      ...
      case 0xff00: {
        ...
        default:
          throw new Error('M6510 has no generated opcode ' +
  ...
  get(name: string): number {
    switch (name) {
      ...
      case "m_sync": return this.m_sync;
      case "m_ref": return this.m_ref;
      case "cycles": return this.cycles;
      case "m_icount": return this.m_icount;
      case "m_pullup": return this.m_pullup;
      case "m_floating": return this.m_floating;
      case "m_dir": return this.m_dir;
      case "m_port": return this.m_port;
      case "m_drive": return this.m_drive;
      default: return 0;
    }
  }
  ...
  set(name: string, value: number): void {
    switch (name) {
      ...
      case "m_sync": this.m_sync = ((value) ? 1 : 0); return;
      case "m_ref": this.m_ref = ((value) >>> 0); return;
      case "cycles": this.cycles = value; return;
      case "m_icount": this.m_icount = value; return;
      case "m_pullup": this.m_pullup = ((value) & 0xff); return;
      case "m_floating": this.m_floating = ((value) & 0xff); return;
      case "m_dir": this.m_dir = ((value) & 0xff); return;
      case "m_port": this.m_port = ((value) & 0xff); return;
      case "m_drive": this.m_drive = ((value) & 0xff); return;
      default: return;
    }
  }
  ...
  invoke(name: string, ...args: number[]): number {
    switch (name) {
      ...
      case "set_pulls": return this.method_set_pulls(args[0] ?? 0, args[1] ?? 0);
      case "update_port": return this.method_update_port();
      case "get_port": return this.method_get_port();
      case "dir_r": return this.method_dir_r();
      case "port_r": return this.method_port_r();
      case "dir_w": return this.method_dir_w(args[0] ?? 0);
      case "port_w": return this.method_port_w(args[0] ?? 0);
      case "memory_read": return this.method_memory_read(args[0] ?? 0);
      case "memory_opcode": return this.method_memory_opcode(args[0] ?? 0);
      case "memory_arg": return this.method_memory_arg(args[0] ?? 0);
      case "memory_write": return this.method_memory_write(args[0] ?? 0, args[1] ?? 0);
      default: throw new Error('M6510 has no generated method "' + name + '"');
    }
  }
  ...
  private generatedFetch(): void {
    this.m_sync = ((1) ? 1 : 0);
    if ((((this.bus.signal ? 0 : 1)) ? 0 : 1)) {
      (this.bus.signal?.("sync_cb", 1) ?? 0);
    }
    this.m_NPC = ((this.m_PC) & 0xffff);
    this.m_IR = ((this.method_memory_opcode(this.m_PC)) & 0xff);
    this.m_sync = ((0) ? 1 : 0);
    if ((((this.bus.signal ? 0 : 1)) ? 0 : 1)) {
      (this.bus.signal?.("sync_cb", 0) ?? 0);
    }
    if (((((((this.m_nmi_pending) || (((((((this.m_irq_state) || (this.m_apu_irq_state)) ? 1 : 0)) && (((((this.m_P) & (4))) ? 0 : 1))) ? 1 : 0))) ? 1 : 0)) && (((this.m_inhibit_interrupts) ? 0 : 1))) ? 1 : 0)) {
  ...
  private method_do_adc(val: number = 0): number {
    if (((this.m_P) & (8))) {
  ...
  private method_do_adc_d(val: number = 0): number {
  ...
  private method_do_arr_d(): number {
  ...
  private method_do_sbc(val: number = 0): number {
    if (((this.m_P) & (8))) {
  ...
  private method_do_sbc_d(val: number = 0): number {
  ...
  private method_set_pulls(_pullup: number = 0, _floating: number = 0): number {
    this.m_pullup = ((_pullup) & 0xff);
    this.m_floating = ((_floating) & 0xff);
    return 0;
  }

  private method_update_port(): number {
    this.m_drive = ((((((this.m_port) & (this.m_dir))) | (((this.m_drive) & ((~this.m_dir)))))) & 0xff);
    (this.bus.signal?.("write_callback", ((((this.m_port) & (this.m_dir))) | (((this.m_pullup) & ((~this.m_dir)))))) ?? 0);
    return 0;
  }

  private method_get_port(): number {
    return ((((this.m_port) & (this.m_dir))) | (((this.m_pullup) & ((~this.m_dir)))));
    return 0;
  }

  private method_dir_r(): number {
    return this.m_dir;
    return 0;
  }

  private method_port_r(): number {
    return (((((((this.bus.signal?.("read_callback", 0) ?? 0)) | (((this.m_floating) & (this.m_drive))))) & ((~this.m_dir)))) | (((this.m_port) & (this.m_dir))));
    return 0;
  }

  private method_dir_w(data: number = 0): number {
    this.m_dir = ((data) & 0xff);
    this.method_update_port();
    return 0;
  }

  private method_port_w(data: number = 0): number {
    this.m_port = ((data) & 0xff);
    this.method_update_port();
    return 0;
  }

  private method_memory_read(adr: number = 0): number {
    let res = (((++this.cycles, this.readMemory((adr) & 65535) & 0xff)) & 0xff);
    if (((Number(adr) === Number(0)) ? 1 : 0)) {
      res = ((this.method_dir_r()) & 0xff);
    } else {
      if (((Number(adr) === Number(1)) ? 1 : 0)) {
        res = ((this.method_port_r()) & 0xff);
      }
    }
    return res;
    return 0;
  ...
  private method_memory_opcode(adr: number = 0): number {
    let res = (((++this.cycles, this.readOpcode((adr) & 0xffff) & 0xff)) & 0xff);
    if (((Number(adr) === Number(0)) ? 1 : 0)) {
      res = ((this.method_dir_r()) & 0xff);
    } else {
      if (((Number(adr) === Number(1)) ? 1 : 0)) {
  ...
  private method_memory_arg(adr: number = 0): number {
    let res = (((++this.cycles, this.readMemory((adr) & 65535) & 0xff)) & 0xff);
    if (((Number(adr) === Number(0)) ? 1 : 0)) {
      res = ((this.method_dir_r()) & 0xff);
    } else {
  ...
  private method_memory_write(adr: number = 0, val: number = 0): number {
    (++this.cycles, this.writeMemory((adr) & 65535, (val) & 0xff), 0);
    if (((Number(adr) === Number(0)) ? 1 : 0)) {
      this.method_dir_w(val);
    } else {
      if (((Number(adr) === Number(1)) ? 1 : 0)) {
        this.method_port_w(val);
      }
    }
    return 0;
  }
...
export const cpu: GeneratedCpuExecutable = {
  type: "M6510",
  summary: {"opcodes":256,"compiledOpcodes":256,"methods":33,"compiledMethods":33,"diagnostics":0},
  accessors: {"get_sync":"m_sync"},
  create: (bus: CpuBus): Cpu => new GeneratedM6510(bus),
};
