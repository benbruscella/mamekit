...
const GENERATED_METHOD_NAMES = new Set(["do_adc", "do_adc_d", "do_adc_nd", "do_arr", "do_arr_d", "do_arr_nd", "do_sbc", "do_sbc_d", "do_sbc_nd", "do_cmp", "do_bit", "do_asl", "do_lsr", "do_ror", "do_rol", "do_asr", "set_nz", "set_l", "set_h", "page_changing", "dec_SP", "inc_SP", "memory_read", "memory_opcode", "memory_arg", "memory_write"]);
class GeneratedDECO_CPU7 {
    bus;
    irqData = 0xff;
    irqHold = false;
    ...
    step() {
        ...
        while (true) {
            if (++dispatches > 8)
                throw new Error('DECO_CPU7 dispatch loop exceeded 8');
...
export const cpu = {
    ...
    create: (bus) => new GeneratedDECO_CPU7(bus),
};
export default cpu;
