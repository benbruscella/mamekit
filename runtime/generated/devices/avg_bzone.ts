...
definition.compiledMethods = (() => {
  ...
  function method_vg_set_halt_callback(runtime: any, param: any): any {
    const members = runtime.members;

    method_vg_set_halt(runtime, param);
  }

  function method_vg_set_halt(runtime: any, dummy: any): any {
    const members = runtime.members;
  ...
  function method_run_state_machine(runtime: any, param: any): any {
    const members = runtime.members;
  ...
  function method_state_addr(runtime: any): any {
    const members = runtime.members;
  ...
  function method_ST3(runtime: any): any {
    const members = runtime.members;

    return ((((members.m_state_latch ?? runtime.member("m_state_latch"))) >>> (3)) & 1);
  }

  function method_update_databus(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_0(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_1(runtime: any): any {
    const members = runtime.members;
  ...
  function method_vg_add_clip(runtime: any, xmin: any, ymin: any, xmax: any, ymax: any): any {
    const members = runtime.members;
  ...
  function method_avg_device__handler_1(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_2(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_3(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_4(runtime: any): any {
    const members = runtime.members;
  ...
  function method_OP0(runtime: any): any {
    const members = runtime.members;

    return ((((members.m_op ?? runtime.member("m_op"))) >>> (0)) & 1);
  }

  function method_OP1(runtime: any): any {
    const members = runtime.members;

    return ((((members.m_op ?? runtime.member("m_op"))) >>> (1)) & 1);
  }

  function method_handler_5(runtime: any): any {
    const members = runtime.members;

    if (((method_OP2(runtime)) ? 0 : 1)) {
      for (let i: any = (((members.m_bin_scale ?? runtime.member("m_bin_scale"))) | 0); ((Number(i) > Number(0)) ? 1 : 0); i = ((((i) - (1))) | 0)) {
        members.m_timer = ((runtime.shiftRight(members.m_timer, 1)) & 0xffff);
        members.m_timer = ((((members.m_timer) | (((16384) | (((method_OP1(runtime)) << (7))))))) & 0xffff);
      }
      if (method_OP1(runtime)) {
  ...
  function method_OP2(runtime: any): any {
    const members = runtime.members;

    return ((((members.m_op ?? runtime.member("m_op"))) >>> (2)) & 1);
  }

  function method_avg_common_strobe1(runtime: any): any {
    const members = runtime.members;
  ...
  function method_handler_6(runtime: any): any {
    const members = runtime.members;
  ...
  function method_avg_common_strobe2(runtime: any): any {
    const members = runtime.members;
  ...
  function method_vg_flush(runtime: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
  ...
  function method_handler_7(runtime: any): any {
    const members = runtime.members;

    let cycles: any = ((method_avg_common_strobe3(runtime)) | 0);
  ...
  function method_avg_common_strobe3(runtime: any): any {
    const members = runtime.members;
  ...
  function method_vg_add_point_buf(runtime: any, x: any, y: any, color: any, intensity: any): any {
    const members = runtime.members;
  ...
  function method_vector_device__color111(runtime: any, c: any): any {
    const members = runtime.members;
    const __l = runtime.links ?? runtime.calls;
