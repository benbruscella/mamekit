...
const GENERATED_METHOD_NAMES = new Set<string>(["do_adc","do_adc_d","do_adc_nd","do_arr","do_arr_d","do_arr_nd","do_sbc","do_sbc_d","do_sbc_nd","do_cmp","do_bit","do_asl","do_lsr","do_ror","do_rol","do_asr","set_nz","set_l","set_h","page_changing","dec_SP","inc_SP"]);

class GeneratedM6507 implements Cpu {
  ...
  step(): number {
    ...
    let dispatches = 0;
    while (true) {
      if (++dispatches > 8) throw new Error('M6507 dispatch loop exceeded 8');
...
export const cpu: GeneratedCpuExecutable = {
  ...
  create: (bus: CpuBus): Cpu => new GeneratedM6507(bus),
};
