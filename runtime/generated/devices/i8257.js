...
definition.compiledMethods = (() => {
    ...
    function method_next_channel(runtime) {
        ...
        for (let step = 0; ((Number(step) < Number(4)) ? 1 : 0); step = ((step) + (1))) {
            let channel = (((((members.m_transfer_mode) >>> (4)) & 1)) ? (((((((members.m_last_channel) + (step))) + (1))) & (3))) : (step));
    ...
    function method_dma_read(runtime) {
        const members = runtime.members;
        let offset = members.m_channel[members.m_current_channel].m_address;
    ...
    function method_advance(runtime) {
        const members = runtime.members;
        let tc = ((members.m_tc) ? 1 : 0);
        let al = ((((((((members.m_transfer_mode) >>> (7)) & 1)) && (((Number(members.m_current_channel) === Number(2)) ? 1 : 0))) ? 1 : 0)) ? 1 : 0);
        method_set_tc(runtime, 0);
        if (tc) {
