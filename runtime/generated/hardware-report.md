...
Source methods lowered to IR: **3677/3734**

MAME opcode/operation DSL files: **11**

## Hardware

| Type | Status | MAME implementation | Games |
|---|---|---|---|
| AD7524 | source-resolved | ad7524_device (src/devices/sound/dac.h:201) | mk, nbajam |
| AD7533 | source-resolved | ad7533_device (src/devices/sound/dac.h:203) | rampage, spyhunt |
| ADC0804 | source-resolved | adc0804_device (src/devices/machine/adc0804.cpp:47) | polepos, spyhunt |
| ADDRESS_MAP_BANK | source-resolved | address_map_bank_device (src/devices/machine/bankdev.cpp:7) | missile |
| ARKANOID_68705P5 | source-resolved | arkanoid_68705p5_device (src/mame/shared/taito68705.cpp:51) | arkanoid |
| ATARI_MOTION_OBJECTS | source-resolved | atari_motion_objects_device (src/mame/atari/atarimo.cpp:121) | gauntlet, marble |
| AVG_BZONE | source-resolved | avg_bzone_device (src/devices/video/avgdvg.cpp:1504) | bzone |
| AY8910 | source-resolved | ay8910_device (src/devices/sound/ay8910.cpp:1551) | 1942, bnj, bombjack, btime, elevator, friskyt, frogger, gyruss, jumpbug, junglek, junofrst, kungfum, matmania, mpatrol, pooyan, popeye, rocnrope, scramble, spyhunt, timeplt, travrusa, tutankhm, zigzagb |
...
| BUFFERED_SPRITERAM8 | source-resolved | buffered_spriteram8_device (src/devices/video/bufsprite.cpp:20) | commando, gng, gunsmoke, wardner |
| C64_EXPANSION_SLOT | source-resolved | c64_expansion_slot_device (src/devices/bus/c64/exp.cpp:22) | c64, c64p |
| CBM_IEC | source-resolved | cbm_iec_device (src/devices/bus/cbmiec/cbmiec.cpp:212) | c64, c64p |
| CBM_IEC_SLOT | source-resolved | cbm_iec_slot_device (src/devices/bus/cbmiec/cbmiec.cpp:213) | c64, c64p |
| CD4099 | source-resolved | cd4099_device (src/devices/machine/74259.cpp:99) | spyhunt |
...
| DAC_8BIT_R2R | source-resolved | dac_8bit_r2r_device (src/devices/sound/dac.h:237) | elevator, hyperspt, junglek, junofrst, matmania, shinobi, trackfld |
| DECO_C10707 | source-resolved | deco_c10707_device (src/mame/dataeast/deco222.cpp:12) | bnj |
| DECO_CPU7 | source-resolved | deco_cpu7_device (src/mame/dataeast/decocpu7.cpp:7) | btime |
| DISCRETE | declarative-host | discrete_sound_device (src/devices/sound/discrete.cpp:50) | asteroid, bnj, btime, bzone, dkong, dkongjr, elevator, galaga, galaxian, gyruss, invaders, junglek, mpatrol, phoenix, polepos, qix, travrusa, xevious |
...
| EEPROM_2804 | declarative-host | - | gauntlet, marble |
...
| GENERIC_LATCH_8 | source-resolved | generic_latch_8_device (src/devices/machine/gen_latch.cpp:23) | 1942, bnj, bombjack, btime, bublbobl, commando, congo, ddragon, ffight, frogger, gauntlet, ghouls, gng, gunsmoke, gyruss, hyperspt, junofrst, marble, mario, matmania, mslug, pooyan, rocnrope, rtype, rygar, scramble, sf2, sf2ce, shinobi, timeplt, tmnt, trackfld, tutankhm, upndown, wboy |
| GFXDECODE | declarative-host | - | 1942, arkanoid, bankp, bnj, bombjack, btime, bublbobl, cavenger, centiped, commando, congo, crush, ddragon, digdug, dkong, dkongjr, elevator, ffight, friskyt, frogger, galaga, galaxian, gameboy, gauntlet, gberet, ghouls, gng, gunsmoke, gyruss, hyperspt, jumpbug, junglek, kungfum, ladybug, marble, mario, matmania, mpatrol, mrdo, mspacman, pacman, panic, pengo, phoenix, polepos, pooyan, popeye, qbert, rampage, rocnrope, rtype, rygar, scramble, sf2, sf2ce, shinobi, spyhunt, timeplt, trackfld, travrusa, upndown, venture, wardner, wboy, xevious, zaxxon, zigzagb |
...
| HC55516 | source-resolved | hc55516_device (src/devices/sound/hc55516.cpp:212) | sinistar |
...
| HD6845S | source-resolved | hd6845s_device (src/devices/video/mc6845.cpp:68) | wardner |
...
| INPUT_MERGER_ALL_HIGH | source-resolved | input_merger_all_high_device (src/devices/machine/input_merger.cpp:44) | bnj, btime, bublbobl, elevator, junglek, mslug |
| INPUT_MERGER_ANY_HIGH | source-resolved | input_merger_any_high_device (src/devices/machine/input_merger.cpp:43) | bublbobl, c64, c64p, defender, elevator, gberet, joust, junglek, qbert, qix, robotron, sinistar, venture |
...
| KONAMI1 | source-resolved | konami1_device (src/mame/konami/konami1.cpp:12) | gyruss, hyperspt, junofrst, rocnrope, trackfld |
...
| LS259 | source-resolved | ls259_device (src/devices/machine/74259.cpp:95) | asteroid, cavenger, centiped, congo, crush, digdug, galaga, gauntlet, gng, gyruss, hyperspt, junofrst, ladybug, marble, mario, mspacman, pacman, pengo, polepos, pooyan, rocnrope, timeplt, trackfld, tutankhm, wardner, xevious, zaxxon |
| M58715 | source-resolved | m58715_device (src/devices/cpu/mcs48/mcs48.cpp:204) | mario |
| M6502 | source-resolved | m6502_device (src/devices/cpu/m6502/m6502.cpp:15) | asteroid, bnj, btime, bzone, centiped, gauntlet, marble, matmania, missile, qbert, venture |
| M6507 | source-resolved | m6507_device (src/devices/cpu/m6502/m6507.cpp:16) | a2600 |
| M6510 | source-resolved | m6510_device (src/devices/cpu/m6502/m6510.cpp:18) | c64, c64p |
| M68000 | source-resolved | m68000_device (src/devices/cpu/m68000/m68000.cpp:8) | ffight, ghouls, mslug, rampage, sf2, sf2ce, shinobi, spyhunt, tmnt |
| M68010 | source-resolved | m68010_device (src/devices/cpu/m68000/m68010.cpp:8) | gauntlet, marble |
...
| M6808 | source-resolved | m6808_cpu_device (src/devices/cpu/m6800/m6800.cpp:371) | defender, joust, robotron, sinistar |
| M68705P5 | source-resolved | m68705p5_device (src/devices/cpu/m6805/m68705.cpp:113) | arkanoid, elevator |
| MATHBOX | source-resolved | mathbox_device (src/mame/atari/mathbox.cpp:40) | bzone |
...
| MC1408 | source-resolved | mc1408_device (src/devices/sound/dac.h:210) | defender, joust, qbert, robotron, sinistar |
| MC6809 | source-resolved | mc6809_device (src/devices/cpu/m6809/m6809.cpp:136) | ddragon, gng |
| MC6809E | source-resolved | mc6809e_device (src/devices/cpu/m6809/m6809.cpp:137) | defender, joust, mk, nbajam, qix, robotron, sinistar, tutankhm |
| MC6845 | source-resolved | mc6845_device (src/devices/video/mc6845.cpp:61) | qix |
| MIDTUNIT_VIDEO | source-resolved | midtunit_video_device (src/mame/williams/midtunit_v.cpp:30) | mk, nbajam |
| MIDWAY_CHEAP_SQUEAK_DELUXE | source-resolved | midway_cheap_squeak_deluxe_device (src/mame/bally/csd.cpp:17) | spyhunt |
| MIDWAY_SOUNDS_GOOD | source-resolved | midway_sounds_good_device (src/mame/bally/midway_sound.cpp:33) | rampage |
| MIDWAY_SSIO | source-resolved | midway_ssio_device (src/mame/bally/midway_sound.cpp:32) | spyhunt |
| MOS6526 | source-resolved | mos6526_device (src/devices/machine/mos6526.cpp:118) | c64, c64p |
| MOS6532 | source-resolved | mos6532_device (src/devices/machine/mos6530.cpp:29) | a2600, qbert, venture |
| MOS6567 | source-resolved | mos6567_device (src/devices/video/mos6566.cpp:219) | c64 |
| MOS6569 | source-resolved | mos6569_device (src/devices/video/mos6566.cpp:222) | c64p |
| MOS6581 | source-resolved | mos6581_device (src/devices/sound/mos6581.cpp:28) | c64, c64p |
...
| NEOGEO_CART_SLOT | source-resolved | neogeo_cart_slot_device (src/devices/bus/neogeo/slot.cpp:16) | mslug |
...
| NVRAM | declarative-host | nvram_device (src/devices/machine/nvram.cpp:19) | berzerk, defender, friskyt, hyperspt, joust, mario, mk, mslug, nbajam, polepos, qbert, qix, rampage, robotron, shinobi, sinistar, spyhunt, trackfld |
| OKIM6295 | source-resolved | okim6295_device (src/devices/sound/okim6295.cpp:54) | ffight, ghouls, mk, nbajam, sf2, sf2ce |
| OUTPUT_LATCH | source-resolved | output_latch_device (src/devices/machine/output_latch.cpp:6) | asteroid |
| PALETTE | declarative-host | - | 1942, arkanoid, bankp, bnj, bombjack, btime, bublbobl, cavenger, centiped, commando, congo, crush, ddragon, defender, digdug, dkong, dkongjr, elevator, ffight, friskyt, frogger, galaga, galaxian, gameboy, gauntlet, gberet, ghouls, gng, gunsmoke, gyruss, hyperspt, joust, jumpbug, junglek, junofrst, kungfum, ladybug, marble, mario, matmania, missile, mk, mpatrol, mrdo, mslug, mspacman, nbajam, pacman, panic, pengo, phoenix, polepos, pooyan, popeye, qbert, qix, rampage, robotron, rocnrope, rtype, rygar, scramble, sf2, sf2ce, shinobi, simpsons, sinistar, spyhunt, timeplt, tmnt, trackfld, travrusa, tutankhm, upndown, venture, wardner, wboy, xevious, zaxxon, zigzagb |
| PET_DATASSETTE_PORT | source-resolved | pet_datassette_port_device (src/devices/bus/pet/cass.cpp:18) | c64, c64p |
| PET_USER_PORT | source-resolved | pet_user_port_device (src/devices/bus/pet/user.cpp:14) | c64, c64p |
| PHOENIX_SOUND | source-resolved | phoenix_sound_device (src/mame/phoenix/phoenix_a.cpp:51) | phoenix |
| PIA6821 | source-resolved | pia6821_device (src/devices/machine/6821pia.cpp:41) | defender, joust, qix, rampage, robotron, sinistar, spyhunt, venture |
...
| PLS100 | source-resolved | pls100_device (src/devices/machine/pla.cpp:20) | c64, c64p |
| POKEY | source-resolved | pokey_device (src/devices/sound/pokey.cpp:193) | bzone, centiped, gauntlet, marble, missile |
...
| QUICKLOAD | source-resolved | quickload_image_device (src/devices/imagedev/snapquik.cpp:119) | c64, c64p |
| RAM | source-resolved | ram_device (src/devices/machine/ram.cpp:116) | c64, c64p |
...
| SCREEN | declarative-host | - | 1942, a2600, arkanoid, asteroid, bankp, berzerk, bnj, bombjack, btime, bublbobl, bzone, c64, c64p, carnival, cavenger, centiped, coleco, commando, congo, crush, ddragon, defender, digdug, dkong, dkongjr, elevator, ffight, friskyt, frogger, galaga, galaxian, gameboy, gauntlet, gberet, ghouls, gng, gunsmoke, gyruss, hyperspt, invaders, joust, jumpbug, junglek, junofrst, kungfum, ladybug, marble, mario, matmania, missile, mk, mpatrol, mrdo, mslug, mspacman, nbajam, nes, pacman, panic, pengo, phoenix, polepos, pooyan, popeye, qbert, qix, rampage, robotron, rocnrope, rtype, rygar, scramble, sf2, sf2ce, shinobi, simpsons, sinistar, spyhunt, timeplt, tmnt, trackfld, travrusa, tutankhm, upndown, venture, wardner, wboy, xevious, zaxxon, zigzagb |
...
| SLAPSTIC | source-resolved | atari_slapstic_device (src/mame/atari/slapstic.cpp:204) | gauntlet, marble |
...
| SN76489A | source-resolved | sn76489a_device (src/devices/sound/sn76496.cpp:474) | bankp, coleco, congo, gberet, hyperspt, trackfld, upndown, wboy |
...
| TILEMAP | unresolved | - | gauntlet, marble |
| TIMEPLT_AUDIO | source-resolved | timeplt_audio_device (src/mame/shared/timeplt_a.cpp:22) | pooyan, rocnrope, timeplt, tutankhm |
| TIMER | declarative-host | timer_device (src/devices/machine/timer.cpp:30) | 1942, bnj, btime, carnival, centiped, coleco, commando, ddragon, defender, gauntlet, joust, marble, matmania, panic, polepos, rampage, robotron, scramble, sinistar, spyhunt, tutankhm, upndown, wboy |
| TMS320C10 | source-resolved | tms320c10_device (src/devices/cpu/tms320c1x/tms320c1x.cpp:35) | wardner |
| TMS34010 | source-resolved | tms34010_device (src/devices/cpu/tms34010/tms34010.cpp:55) | mk, nbajam |
...
| TOAPLAN_DSP | source-resolved | toaplan_dsp_device (src/mame/toaplan/toaplan_dsp.cpp:13) | wardner |
| TOAPLAN_SCU | source-resolved | toaplan_scu_device (src/mame/toaplan/toaplan_scu.cpp:39) | wardner |
| TRACKFLD_AUDIO | source-resolved | trackfld_audio_device (src/mame/konami/trackfld_a.cpp:9) | hyperspt, trackfld |
...
| VCS_CONTROL_PORT | source-resolved | vcs_control_port_device (src/devices/bus/vcs_ctrl/ctrl.cpp:18) | a2600, c64, c64p |
| VECTOR | source-resolved | vector_device (src/devices/video/vector.cpp:53) | asteroid, bzone |
| VLM5030 | source-resolved | vlm5030_device (src/devices/sound/vlm5030.cpp:160) | hyperspt, trackfld |
| VOTRAX_SC01 | source-resolved | votrax_sc01_device (src/devices/sound/votrax.cpp:40) | qbert |
| WATCHDOG_TIMER | declarative-host | watchdog_timer_device (src/devices/machine/watchdog.cpp:20) | arkanoid, asteroid, bombjack, bublbobl, bzone, centiped, crush, defender, digdug, dkong, dkongjr, elevator, friskyt, frogger, galaga, galaxian, gauntlet, gberet, hyperspt, invaders, joust, junglek, junofrst, marble, missile, mk, mslug, mspacman, nbajam, pacman, pengo, polepos, pooyan, qbert, rampage, robotron, rocnrope, rygar, scramble, shinobi, simpsons, sinistar, spyhunt, timeplt, tmnt, trackfld, tutankhm, xevious, zigzagb |
| WILLIAMS_ADPCM_SOUND | source-resolved | williams_adpcm_sound_device (src/mame/shared/williamssound.cpp:63) | mk, nbajam |
| WILLIAMS_BLITTER_SC1 | source-resolved | williams_blitter_sc1_device (src/mame/williams/williamsblitter.cpp:27) | joust, robotron, sinistar |
| YM2149 | source-resolved | ym2149_device (src/devices/sound/ay8910.cpp:1652) | arkanoid |
| YM2151 | source-resolved | ym2151_device (src/devices/sound/ymopm.cpp:12) | ddragon, ffight, gauntlet, ghouls, marble, mk, nbajam, rtype, sf2, sf2ce, shinobi, simpsons, tmnt |
...
| YM3812 | source-resolved | ym3812_device (src/devices/sound/ymopl.cpp:86) | wardner |
| Z80 | source-resolved | z80_device (src/devices/cpu/z80/z80.cpp:940) | 1942, arkanoid, bankp, berzerk, bombjack, bublbobl, carnival, cavenger, coleco, commando, congo, crush, digdug, dkong, dkongjr, elevator, ffight, friskyt, frogger, galaga, galaxian, gberet, ghouls, gng, gunsmoke, gyruss, hyperspt, jumpbug, junglek, junofrst, kungfum, ladybug, mario, mpatrol, mrdo, mslug, mspacman, pacman, panic, pengo, polepos, pooyan, popeye, rampage, rocnrope, rtype, rygar, scramble, sf2, sf2ce, shinobi, simpsons, spyhunt, timeplt, tmnt, trackfld, travrusa, tutankhm, upndown, wardner, wboy, xevious, zaxxon, zigzagb |
| Z8002 | source-resolved | z8002_device (src/devices/cpu/z8000/z8000.cpp:23) | polepos |
| Z80CTC | source-resolved | z80ctc_device (src/devices/machine/z80ctc.cpp:72) | rampage, spyhunt |
