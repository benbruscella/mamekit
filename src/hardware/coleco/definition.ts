...
export const COLECO_PORTS: readonly PortDeclaration[] = [
...
export function colecoDeviceIrArtifact(type: string): string {
  return `devices/${type.toLowerCase()}.device.ir.json`;
}

export function colecoDeviceModuleArtifact(type: string): string {
