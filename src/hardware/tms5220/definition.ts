...
export const TMS5220_MAME_TYPES = ['TMS5220C', 'TMS5220'] as const;
export const TMS5220_MASTER_GAIN = 1;
export const TMS5220_PORTS: readonly PortDeclaration[] = [
...
export function tms5220IrArtifact(type: string): string {
  return `devices/${type.toLowerCase()}.device.ir.json`;
}

export function tms5220ModuleArtifact(type: string): string {
