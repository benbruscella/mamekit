...
export const digdug: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      600: { video: '21864713', state: '545e21b4' },
      1200: { video: '5f67b8d1', state: 'fb426a4a' },
      1800: { video: 'a8f7bc6b', state: 'd832c2c2' },
      2000: { video: '4d111900', state: '1b6ecc8f' },
      2200: { video: 'f5c41445', state: 'b017c8bd' },
      2400: { video: '8fa821dc', state: 'f32de3c9' },
    },
    audio: {
      writes: 78964,
      nonzeroWrites: 10918,
