...
export const digdug: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      600: { video: '21864713', state: '0344b2ee' },
      1200: { video: '9417a472', state: '07d16601' },
      1800: { video: 'c96ac5af', state: '34078fc7' },
      2000: { video: '092c8b6e', state: '1c168df7' },
      2200: { video: '9912afd4', state: '21feb702' },
      2400: { video: '72ec44c9', state: '1c878d0b' },
    },
    audio: {
      writes: 78964,
      nonzeroWrites: 10891,
