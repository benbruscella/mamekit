...
export const digdug: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      600: { video: '21864713', state: 'f880315c' },
      1200: { video: '9417a472', state: '4af81ab8' },
      1800: { video: 'c96ac5af', state: '35ae2626' },
      2000: { video: '092c8b6e', state: '7551a7d7' },
      2200: { video: '9912afd4', state: '95ddf1ed' },
      2400: { video: '72ec44c9', state: '02676c0e' },
    },
    audio: {
      writes: 78964,
      nonzeroWrites: 10891,
