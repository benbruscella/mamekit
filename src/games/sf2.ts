...
export const sf2 = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      1200: { video: '42d4cf93', state: '9ea2616d' },
      1800: { video: '42d4cf93', state: '4be02a2f' },
      2400: { video: '943a3b53', state: 'e5057f3b' },
      3000: { video: '4fe3acf5', state: 'cc3f3915' },
      3600: { video: '5648d627', state: 'dd6c130f' },
    },
    audio: {
      writes: 122153,
