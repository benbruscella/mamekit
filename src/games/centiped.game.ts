...
export const centiped = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      60: { video: '50bc4209', state: 'b2434a04' },
      180: { video: '1354f253', state: 'f7694de4' },
      300: { video: '50ceeb42', state: '66011398' },
      600: { video: 'df0b58ec', state: '4c388438' },
      900: { video: '7880c0be', state: 'f30c7959' },
