...
export const galaga: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      720: { video: '972b5194', state: 'e60e4613' },
      760: { video: '21864713', state: '0ed3b6dd' },
      900: { video: 'd4ed5a0c', state: '47ba70c0' },
      1050: { video: 'b12321a8', state: '0bf57282' },
      1300: { video: '7796e201', state: 'c060705b' },
      1600: { video: 'c29772a9', state: '52beebc9' },
      2456: { video: '7f49a527', state: '15f43766' },
      2600: { video: '920de88e', state: 'e084e423' },
    },
    audio: {
      writes: 552037,
      nonzeroWrites: 32336,
