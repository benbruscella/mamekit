...
export const galaga: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      720: { video: '972b5194', state: 'e58f12c9' },
      760: { video: '21864713', state: '9d805f30' },
      900: { video: 'd4ed5a0c', state: 'c738ec03' },
      1050: { video: 'b12321a8', state: '5a1b299e' },
      1300: { video: '7796e201', state: '8601853f' },
      1600: { video: 'c29772a9', state: '5e7d8578' },
      2456: { video: '7f49a527', state: '12826e76' },
      2600: { video: '920de88e', state: '635eea83' },
    },
    audio: {
      writes: 552025,
      nonzeroWrites: 32373,
