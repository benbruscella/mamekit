...
export const ladybug = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      1: { video: '43757903', state: 'f256b4b2' },
      60: { video: '43757903', state: '24c9f3ee' },
      180: { video: '43757903', state: 'da9526f3' },
      300: { video: 'ab371dbe', state: '797cea5e' },
      600: { video: '1a4b96cd', state: '4cbe90bb' },
      900: { video: 'a2ef401c', state: '3f29742c' },
      1200: { video: '9779d75b', state: '652bf801' },
    },
    audio: {
      writes: 801,
      nonzeroWrites: 801,
