...
export const gng: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      480: { video: '5b5e30a1', state: '78d8f383' },
      900: { video: '008a572c', state: '2c040ebd' },
      1200: { video: '88e2d337', state: '378f443d' },
      1800: { video: 'e0bee347', state: '483975ca' },
      2400: { video: 'cd6e8432', state: 'ff91cee5' },
      3000: { video: '4c7abb46', state: '3e764391' },
    },
    audio: {
      writes: 478544,
