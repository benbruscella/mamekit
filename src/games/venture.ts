...
export const venture = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      1200: { video: '81872b36', state: '0c455bbe' },
      2400: { video: '1c482054', state: 'e4ac6a43' },
      3000: { video: '5be91ecc', state: '99c7f489' },
      3600: { video: '78606640', state: 'd67e63d1' },
      4200: { video: '9d5ee40b', state: '35a3bc7a' },
      4800: { video: 'bdec40a2', state: '3518cf55' },
      5400: { video: 'fba02168', state: 'c91fdf58' },
      6000: { video: '5be91ecc', state: '1ea54265' },
      6200: { video: '66c70f82', state: '0376ae8d' },
    },
    audio: {
      writes: 8029,
      nonzeroWrites: 5861,
