...
export const venture = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      1200: { video: '81872b36', state: '4ef4b3b8' },
      2400: { video: '1c482054', state: '9bc3467b' },
      3000: { video: '5be91ecc', state: 'ff2650a4' },
      3600: { video: '78606640', state: '38290f6d' },
      4200: { video: 'c1786a63', state: '31d84ade' },
      4800: { video: 'bdec40a2', state: 'cf370148' },
      5400: { video: 'eff1ea0b', state: 'b321331e' },
      6000: { video: '5be91ecc', state: 'b355b604' },
      6200: { video: '31544105', state: 'e0164968' },
    },
    audio: {
      writes: 7950,
      nonzeroWrites: 5816,
