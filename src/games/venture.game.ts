...
export const venture = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      1200: { video: '81872b36', state: '6b3c399a' },
      2400: { video: '1c482054', state: '89da87e6' },
      3000: { video: '5be91ecc', state: 'c37342ee' },
      3600: { video: '0ee78c0e', state: 'c5eb7d37' },
      4200: { video: '5741148c', state: 'e2cf3b30' },
      4800: { video: 'e5148176', state: '91ef984e' },
      5400: { video: 'f8fd6fb6', state: 'd79bef54' },
      6000: { video: '5be91ecc', state: 'b8b30b91' },
      6200: { video: '5be91ecc', state: 'c22b79c8' },
    },
    audio: {
      writes: 7782,
      nonzeroWrites: 5744,
