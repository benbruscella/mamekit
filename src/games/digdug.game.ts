...
export const digdug = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      1200: { video: '9417a472', state: 'b8b6e6e5' },
      1800: { video: 'c96ac5af', state: 'a7c601b8' },
      2000: { video: '092c8b6e', state: '68e22bfe' },
      2200: { video: '9912afd4', state: '042b416f' },
      2400: { video: '72ec44c9', state: '9e309414' },
    },
    audio: {
      writes: 78964,
      nonzeroWrites: 10891,
