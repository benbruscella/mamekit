...
export const polepos = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      300: { video: '9bbefd2e', state: 'e3c2c0f5' },
      600: { video: 'b8a3cea9', state: '64a397ca' },
      900: { video: '5fb07a52', state: 'f5c35211' },
      1200: { video: '03b28e84', state: 'ee356db3' },
    },
    audio: {
      writes: 387202,
      nonzeroWrites: 151192,
      writeHash: 'b2e0e6f1',
      pcmHash: '35f026bd',
      rms: 0.185858,
    },
