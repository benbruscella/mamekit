...
export const bublbobl: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      '120': { video: '6e3865a5', state: '5fb6544f' },
      '240': { video: '54af37b3', state: '615d283b' },
      '360': { video: 'ce8d144a', state: '401132dd' },
      '600': { video: '890bfd69', state: '4d0ff4c9' },
      '900': { video: '98c0cff6', state: '5c927816' },
      '1200': { video: '5fe25948', state: '08e7129f' },
      '1800': { video: 'f29fdd1d', state: '982deea7' },
    },
    audio: {
      writes: 52218,
      nonzeroWrites: 50497,
