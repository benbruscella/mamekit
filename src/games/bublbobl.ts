...
export const bublbobl: GameTestContract = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      120: { video: 'ccf08ecd', state: '523e9d98' },
      240: { video: '447910f6', state: '64c54738' },
      360: { video: '1a7e6a9e', state: '2576c45a' },
      600: { video: '92c0413d', state: 'a9102a5f' },
      900: { video: 'e52a2cdb', state: '0094974c' },
      1200: { video: '8fe8bb8b', state: '0b46f458' },
      1800: { video: '70ead11c', state: 'a0491c13' },
    },
    audio: {
      writes: 52214,
      nonzeroWrites: 50491,
