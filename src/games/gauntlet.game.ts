...
export const gauntlet = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      500: { video: '08927f09', state: '864948cb' },
      700: { video: '22f0dedd', state: 'eff2606a' },
      1000: { video: '01f2f0bd', state: 'a3b2924a' },
      1400: { video: '37757ff1', state: '77dc8755' },
      1800: { video: '3cb8c59e', state: 'cf43d77c' },
    },
    audio: {
      writes: 284441,
