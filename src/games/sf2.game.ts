...
export const sf2 = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      300: { video: 'f61d0b33', state: 'b6f1f685' },
      1200: { video: '42d4cf93', state: 'f53f0ffd' },
      1800: { video: '42d4cf93', state: 'b6b728dd' },
      2400: { video: '943a3b53', state: '8f5f465c' },
      3000: { video: '80058112', state: '50e3e577' },
      3600: { video: 'e4f15ad9', state: '2791e32f' },
    },
    audio: {
      writes: 122216,
      nonzeroWrites: 103954,
      writeHash: 'cbacc3a7',
      pcmHash: '2820101a',
      rms: 0.104749,
    },
