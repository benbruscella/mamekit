...
export const mario = {
  ...
  golden: {
    ...
    checkpoints: {
      1: { video: 'e808ed50', state: '78fb7055' },
      300: { video: '3bd56fa2', state: '3026ed82' },
      600: { video: 'f5c13508', state: '8d0d272e' },
      900: { video: 'b92fbea5', state: 'b4097b06' },
      1200: { video: 'd599f18f', state: '302c1cfd' },
      1500: { video: 'e57b1c9a', state: '32024970' },
      1650: { video: 'e57b1c9a', state: 'ee9d8ccf' },
      1840: { video: 'cfc85252', state: '1a24d8f0' },
    },
    audio: {
      writes: 375780,
      nonzeroWrites: 6260,
