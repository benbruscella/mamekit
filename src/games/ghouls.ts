...
export const ghouls = {
  ...
  golden: {
    ...
    checkpoints: {
      ...
      600: { video: '7d0b9182', state: 'c24455e1' },
      1200: { video: '24a3a263', state: 'be3a1cc9' },
      1400: { video: 'ccf6015f', state: '622782d4' },
      1800: { video: 'ac7f3d18', state: '5ada1da6' },
      2100: { video: '8d3f7e4f', state: 'c26bb77c' },
      2160: { video: '6c66700a', state: '199cb9e8' },
      2300: { video: '7bd41995', state: '6b63a727' },
    },
    audio: {
      writes: 98354,
      nonzeroWrites: 88593,
