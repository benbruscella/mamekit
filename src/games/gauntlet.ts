...
export const gauntlet = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      500: { video: '08927f09', state: '13c67d46' },
      700: { video: '22f0dedd', state: '12d80f8c' },
      1000: { video: 'd8e5fdc2', state: '35d770f1' },
      1400: { video: '0b354dfc', state: '4641e49c' },
      1800: { video: '1431540d', state: 'cf9ba8c6' },
    },
    audio: {
      writes: 284459,
