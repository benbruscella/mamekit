...
export const xevious = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      1: { video: '736aaed2', state: '0b870596' },
      300: { video: 'd8784d83', state: '6cdd9783' },
      600: { video: 'f0f984e0', state: 'c5bb0a54' },
      1200: { video: '89a17883', state: '9acaeca0' },
      1800: { video: 'dd65e861', state: 'a774a935' },
      2100: { video: '804bf70c', state: '2cfe0bac' },
      2400: { video: '58ce0ea5', state: '973b574e' },
      2700: { video: '6334ee74', state: '0ec2d79b' },
      3000: { video: '7d9b0c62', state: '5fa6adac' },
    },
    audio: {
      writes: 506041,
      nonzeroWrites: 22195,
