...
export const mslug = sourceTarget({
  ...
  golden: {
    ...
    checkpoints: {
      ...
      300: { video: 'b3458424', state: 'b0f29966' },
      900: { video: '53fabdcd', state: 'e2a6846a' },
      1200: { video: '281b191a', state: '17ea123b' },
      1800: { video: 'd997243f', state: '53c65a13' },
      2400: { video: 'd5f860a0', state: '1ce36b91' },
      2800: { video: '5a332ea9', state: '09633036' },
      3000: { video: '111cd69c', state: '337b9b08' },
    },
    audio: {
      writes: 87128,
      nonzeroWrites: 79468,
